 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Iv;function $E(){if(Iv)return le;Iv=1;var o=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),e=Symbol.for("react.fragment"),a=Symbol.for("react.strict_mode"),r=Symbol.for("react.profiler"),l=Symbol.for("react.consumer"),c=Symbol.for("react.context"),f=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),h=Symbol.for("react.memo"),m=Symbol.for("react.lazy"),g=Symbol.iterator;function v(N){return N===null||typeof N!="object"?null:(N=g&&N[g]||N["@@iterator"],typeof N=="function"?N:null)}var x={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},E=Object.assign,M={};function S(N,Q,mt){this.props=N,this.context=Q,this.refs=M,this.updater=mt||x}S.prototype.isReactComponent={},S.prototype.setState=function(N,Q){if(typeof N!="object"&&typeof N!="function"&&N!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,N,Q,"setState")},S.prototype.forceUpdate=function(N){this.updater.enqueueForceUpdate(this,N,"forceUpdate")};function y(){}y.prototype=S.prototype;function D(N,Q,mt){this.props=N,this.context=Q,this.refs=M,this.updater=mt||x}var U=D.prototype=new y;U.constructor=D,E(U,S.prototype),U.isPureReactComponent=!0;var A=Array.isArray,L={H:null,A:null,T:null,S:null,V:null},P=Object.prototype.hasOwnProperty;function z(N,Q,mt,yt,bt,Nt){return mt=Nt.ref,{$$typeof:o,type:N,key:Q,ref:mt!==void 0?mt:null,props:Nt}}function F(N,Q){return z(N.type,Q,void 0,void 0,void 0,N.props)}function b(N){return typeof N=="object"&&N!==null&&N.$$typeof===o}function O(N){var Q={"=":"=0",":":"=2"};return"$"+N.replace(/[=:]/g,function(mt){return Q[mt]})}var V=/\/+/g;function j(N,Q){return typeof N=="object"&&N!==null&&N.key!=null?O(""+N.key):Q.toString(36)}function tt(){}function ct(N){switch(N.status){case"fulfilled":return N.value;case"rejected":throw N.reason;default:switch(typeof N.status=="string"?N.then(tt,tt):(N.status="pending",N.then(function(Q){N.status==="pending"&&(N.status="fulfilled",N.value=Q)},function(Q){N.status==="pending"&&(N.status="rejected",N.reason=Q)})),N.status){case"fulfilled":return N.value;case"rejected":throw N.reason}}throw N}function rt(N,Q,mt,yt,bt){var Nt=typeof N;(Nt==="undefined"||Nt==="boolean")&&(N=null);var nt=!1;if(N===null)nt=!0;else switch(Nt){case"bigint":case"string":case"number":nt=!0;break;case"object":switch(N.$$typeof){case o:case t:nt=!0;break;case m:return nt=N._init,rt(nt(N._payload),Q,mt,yt,bt)}}if(nt)return bt=bt(N),nt=yt===""?"."+j(N,0):yt,A(bt)?(mt="",nt!=null&&(mt=nt.replace(V,"$&/")+"/"),rt(bt,Q,mt,"",function(Kt){return Kt})):bt!=null&&(b(bt)&&(bt=F(bt,mt+(bt.key==null||N&&N.key===bt.key?"":(""+bt.key).replace(V,"$&/")+"/")+nt)),Q.push(bt)),1;nt=0;var vt=yt===""?".":yt+":";if(A(N))for(var At=0;At<N.length;At++)yt=N[At],Nt=vt+j(yt,At),nt+=rt(yt,Q,mt,Nt,bt);else if(At=v(N),typeof At=="function")for(N=At.call(N),At=0;!(yt=N.next()).done;)yt=yt.value,Nt=vt+j(yt,At++),nt+=rt(yt,Q,mt,Nt,bt);else if(Nt==="object"){if(typeof N.then=="function")return rt(ct(N),Q,mt,yt,bt);throw Q=String(N),Error("Objects are not valid as a React child (found: "+(Q==="[object Object]"?"object with keys {"+Object.keys(N).join(", ")+"}":Q)+"). If you meant to render a collection of children, use an array instead.")}return nt}function B(N,Q,mt){if(N==null)return N;var yt=[],bt=0;return rt(N,yt,"","",function(Nt){return Q.call(mt,Nt,bt++)}),yt}function k(N){if(N._status===-1){var Q=N._result;Q=Q(),Q.then(function(mt){(N._status===0||N._status===-1)&&(N._status=1,N._result=mt)},function(mt){(N._status===0||N._status===-1)&&(N._status=2,N._result=mt)}),N._status===-1&&(N._status=0,N._result=Q)}if(N._status===1)return N._result.default;throw N._result}var X=typeof reportError=="function"?reportError:function(N){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var Q=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof N=="object"&&N!==null&&typeof N.message=="string"?String(N.message):String(N),error:N});if(!window.dispatchEvent(Q))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",N);return}console.error(N)};function ft(){}return le.Children={map:B,forEach:function(N,Q,mt){B(N,function(){Q.apply(this,arguments)},mt)},count:function(N){var Q=0;return B(N,function(){Q++}),Q},toArray:function(N){return B(N,function(Q){return Q})||[]},only:function(N){if(!b(N))throw Error("React.Children.only expected to receive a single React element child.");return N}},le.Component=S,le.Fragment=e,le.Profiler=r,le.PureComponent=D,le.StrictMode=a,le.Suspense=p,le.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=L,le.__COMPILER_RUNTIME={__proto__:null,c:function(N){return L.H.useMemoCache(N)}},le.cache=function(N){return function(){return N.apply(null,arguments)}},le.cloneElement=function(N,Q,mt){if(N==null)throw Error("The argument must be a React element, but you passed "+N+".");var yt=E({},N.props),bt=N.key,Nt=void 0;if(Q!=null)for(nt in Q.ref!==void 0&&(Nt=void 0),Q.key!==void 0&&(bt=""+Q.key),Q)!P.call(Q,nt)||nt==="key"||nt==="__self"||nt==="__source"||nt==="ref"&&Q.ref===void 0||(yt[nt]=Q[nt]);var nt=arguments.length-2;if(nt===1)yt.children=mt;else if(1<nt){for(var vt=Array(nt),At=0;At<nt;At++)vt[At]=arguments[At+2];yt.children=vt}return z(N.type,bt,void 0,void 0,Nt,yt)},le.createContext=function(N){return N={$$typeof:c,_currentValue:N,_currentValue2:N,_threadCount:0,Provider:null,Consumer:null},N.Provider=N,N.Consumer={$$typeof:l,_context:N},N},le.createElement=function(N,Q,mt){var yt,bt={},Nt=null;if(Q!=null)for(yt in Q.key!==void 0&&(Nt=""+Q.key),Q)P.call(Q,yt)&&yt!=="key"&&yt!=="__self"&&yt!=="__source"&&(bt[yt]=Q[yt]);var nt=arguments.length-2;if(nt===1)bt.children=mt;else if(1<nt){for(var vt=Array(nt),At=0;At<nt;At++)vt[At]=arguments[At+2];bt.children=vt}if(N&&N.defaultProps)for(yt in nt=N.defaultProps,nt)bt[yt]===void 0&&(bt[yt]=nt[yt]);return z(N,Nt,void 0,void 0,null,bt)},le.createRef=function(){return{current:null}},le.forwardRef=function(N){return{$$typeof:f,render:N}},le.isValidElement=b,le.lazy=function(N){return{$$typeof:m,_payload:{_status:-1,_result:N},_init:k}},le.memo=function(N,Q){return{$$typeof:h,type:N,compare:Q===void 0?null:Q}},le.startTransition=function(N){var Q=L.T,mt={};L.T=mt;try{var yt=N(),bt=L.S;bt!==null&&bt(mt,yt),typeof yt=="object"&&yt!==null&&typeof yt.then=="function"&&yt.then(ft,X)}catch(Nt){X(Nt)}finally{L.T=Q}},le.unstable_useCacheRefresh=function(){return L.H.useCacheRefresh()},le.use=function(N){return L.H.use(N)},le.useActionState=function(N,Q,mt){return L.H.useActionState(N,Q,mt)},le.useCallback=function(N,Q){return L.H.useCallback(N,Q)},le.useContext=function(N){return L.H.useContext(N)},le.useDebugValue=function(){},le.useDeferredValue=function(N,Q){return L.H.useDeferredValue(N,Q)},le.useEffect=function(N,Q,mt){var yt=L.H;if(typeof mt=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return yt.useEffect(N,Q)},le.useId=function(){return L.H.useId()},le.useImperativeHandle=function(N,Q,mt){return L.H.useImperativeHandle(N,Q,mt)},le.useInsertionEffect=function(N,Q){return L.H.useInsertionEffect(N,Q)},le.useLayoutEffect=function(N,Q){return L.H.useLayoutEffect(N,Q)},le.useMemo=function(N,Q){return L.H.useMemo(N,Q)},le.useOptimistic=function(N,Q){return L.H.useOptimistic(N,Q)},le.useReducer=function(N,Q,mt){return L.H.useReducer(N,Q,mt)},le.useRef=function(N){return L.H.useRef(N)},le.useState=function(N){return L.H.useState(N)},le.useSyncExternalStore=function(N,Q,mt){return L.H.useSyncExternalStore(N,Q,mt)},le.useTransition=function(){return L.H.useTransition()},le.version="19.1.1",le}var Bv;function Um(){return Bv||(Bv=1,Od.exports=$E()),Od.exports}var $l=Um(),Nd={exports:{}},Il={},Pd={exports:{}},zd={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Fv;function tT(){return Fv||(Fv=1,(function(o){function t(B,k){var X=B.length;B.push(k);t:for(;0<X;){var ft=X-1>>>1,N=B[ft];if(0<r(N,k))B[ft]=k,B[X]=N,X=ft;else break t}}function e(B){return B.length===0?null:B[0]}function a(B){if(B.length===0)return null;var k=B[0],X=B.pop();if(X!==k){B[0]=X;t:for(var ft=0,N=B.length,Q=N>>>1;ft<Q;){var mt=2*(ft+1)-1,yt=B[mt],bt=mt+1,Nt=B[bt];if(0>r(yt,X))bt<N&&0>r(Nt,yt)?(B[ft]=Nt,B[bt]=X,ft=bt):(B[ft]=yt,B[mt]=X,ft=mt);else if(bt<N&&0>r(Nt,X))B[ft]=Nt,B[bt]=X,ft=bt;else break t}}return k}function r(B,k){var X=B.sortIndex-k.sortIndex;return X!==0?X:B.id-k.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var l=performance;o.unstable_now=function(){return l.now()}}else{var c=Date,f=c.now();o.unstable_now=function(){return c.now()-f}}var p=[],h=[],m=1,g=null,v=3,x=!1,E=!1,M=!1,S=!1,y=typeof setTimeout=="function"?setTimeout:null,D=typeof clearTimeout=="function"?clearTimeout:null,U=typeof setImmediate<"u"?setImmediate:null;function A(B){for(var k=e(h);k!==null;){if(k.callback===null)a(h);else if(k.startTime<=B)a(h),k.sortIndex=k.expirationTime,t(p,k);else break;k=e(h)}}function L(B){if(M=!1,A(B),!E)if(e(p)!==null)E=!0,P||(P=!0,j());else{var k=e(h);k!==null&&rt(L,k.startTime-B)}}var P=!1,z=-1,F=5,b=-1;function O(){return S?!0:!(o.unstable_now()-b<F)}function V(){if(S=!1,P){var B=o.unstable_now();b=B;var k=!0;try{t:{E=!1,M&&(M=!1,D(z),z=-1),x=!0;var X=v;try{e:{for(A(B),g=e(p);g!==null&&!(g.expirationTime>B&&O());){var ft=g.callback;if(typeof ft=="function"){g.callback=null,v=g.priorityLevel;var N=ft(g.expirationTime<=B);if(B=o.unstable_now(),typeof N=="function"){g.callback=N,A(B),k=!0;break e}g===e(p)&&a(p),A(B)}else a(p);g=e(p)}if(g!==null)k=!0;else{var Q=e(h);Q!==null&&rt(L,Q.startTime-B),k=!1}}break t}finally{g=null,v=X,x=!1}k=void 0}}finally{k?j():P=!1}}}var j;if(typeof U=="function")j=function(){U(V)};else if(typeof MessageChannel<"u"){var tt=new MessageChannel,ct=tt.port2;tt.port1.onmessage=V,j=function(){ct.postMessage(null)}}else j=function(){y(V,0)};function rt(B,k){z=y(function(){B(o.unstable_now())},k)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(B){B.callback=null},o.unstable_forceFrameRate=function(B){0>B||125<B?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):F=0<B?Math.floor(1e3/B):5},o.unstable_getCurrentPriorityLevel=function(){return v},o.unstable_next=function(B){switch(v){case 1:case 2:case 3:var k=3;break;default:k=v}var X=v;v=k;try{return B()}finally{v=X}},o.unstable_requestPaint=function(){S=!0},o.unstable_runWithPriority=function(B,k){switch(B){case 1:case 2:case 3:case 4:case 5:break;default:B=3}var X=v;v=B;try{return k()}finally{v=X}},o.unstable_scheduleCallback=function(B,k,X){var ft=o.unstable_now();switch(typeof X=="object"&&X!==null?(X=X.delay,X=typeof X=="number"&&0<X?ft+X:ft):X=ft,B){case 1:var N=-1;break;case 2:N=250;break;case 5:N=1073741823;break;case 4:N=1e4;break;default:N=5e3}return N=X+N,B={id:m++,callback:k,priorityLevel:B,startTime:X,expirationTime:N,sortIndex:-1},X>ft?(B.sortIndex=X,t(h,B),e(p)===null&&B===e(h)&&(M?(D(z),z=-1):M=!0,rt(L,X-ft))):(B.sortIndex=N,t(p,B),E||x||(E=!0,P||(P=!0,j()))),B},o.unstable_shouldYield=O,o.unstable_wrapCallback=function(B){var k=v;return function(){var X=v;v=k;try{return B.apply(this,arguments)}finally{v=X}}}})(zd)),zd}var Hv;function eT(){return Hv||(Hv=1,Pd.exports=tT()),Pd.exports}var Id={exports:{}},Fn={};/**
 * @license React
...
void main() {
	...
	#include <colorspace_fragment>
	#include <fog_fragment>
}`,de={alphahash_fragment:G1,alphahash_pars_fragment:V1,alphamap_fragment:k1,alphamap_pars_fragment:X1,alphatest_fragment:W1,alphatest_pars_fragment:q1,aomap_fragment:Y1,aomap_pars_fragment:j1,batching_pars_vertex:Z1,batching_vertex:K1,begin_vertex:Q1,beginnormal_vertex:J1,bsdfs:$1,iridescence_fragment:tb,bumpmap_pars_fragment:eb,clipping_planes_fragment:nb,clipping_planes_pars_fragment:ib,clipping_planes_pars_vertex:ab,clipping_planes_vertex:rb,color_fragment:sb,color_pars_fragment:ob,color_pars_vertex:lb,color_vertex:ub,common:cb,cube_uv_reflection_fragment:fb,defaultnormal_vertex:hb,displacementmap_pars_vertex:db,displacementmap_vertex:pb,emissivemap_fragment:mb,emissivemap_pars_fragment:_b,colorspace_fragment:gb,colorspace_pars_fragment:vb,envmap_fragment:xb,envmap_common_pars_fragment:yb,envmap_pars_fragment:Sb,envmap_pars_vertex:Mb,envmap_physical_pars_fragment:Ob,envmap_vertex:Eb,fog_vertex:Tb,fog_pars_vertex:bb,fog_fragment:Ab,fog_pars_fragment:Rb,gradientmap_pars_fragment:wb,lightmap_pars_fragment:Cb,lights_lambert_fragment:Db,lights_lambert_pars_fragment:Ub,lights_pars_begin:Lb,lights_toon_fragment:Nb,lights_toon_pars_fragment:Pb,lights_phong_fragment:zb,lights_phong_pars_fragment:Ib,lights_physical_fragment:Bb,lights_physical_pars_fragment:Fb,lights_fragment_begin:Hb,lights_fragment_maps:Gb,lights_fragment_end:Vb,logdepthbuf_fragment:kb,logdepthbuf_pars_fragment:Xb,logdepthbuf_pars_vertex:Wb,logdepthbuf_vertex:qb,map_fragment:Yb,map_pars_fragment:jb,map_particle_fragment:Zb,map_particle_pars_fragment:Kb,metalnessmap_fragment:Qb,metalnessmap_pars_fragment:Jb,morphinstance_vertex:$b,morphcolor_vertex:tA,morphnormal_vertex:eA,morphtarget_pars_vertex:nA,morphtarget_vertex:iA,normal_fragment_begin:aA,normal_fragment_maps:rA,normal_pars_fragment:sA,normal_pars_vertex:oA,normal_vertex:lA,normalmap_pars_fragment:uA,clearcoat_normal_fragment_begin:cA,clearcoat_normal_fragment_maps:fA,clearcoat_pars_fragment:hA,iridescence_pars_fragment:dA,opaque_fragment:pA,packing:mA,premultiplied_alpha_fragment:_A,project_vertex:gA,dithering_fragment:vA,dithering_pars_fragment:xA,roughnessmap_fragment:yA,roughnessmap_pars_fragment:SA,shadowmap_pars_fragment:MA,shadowmap_pars_vertex:EA,shadowmap_vertex:TA,shadowmask_pars_fragment:bA,skinbase_vertex:AA,skinning_pars_vertex:RA,skinning_vertex:wA,skinnormal_vertex:CA,specularmap_fragment:DA,specularmap_pars_fragment:UA,tonemapping_fragment:LA,tonemapping_pars_fragment:OA,transmission_fragment:NA,transmission_pars_fragment:PA,uv_pars_fragment:zA,uv_pars_vertex:IA,uv_vertex:BA,worldpos_vertex:FA,background_vert:HA,background_frag:GA,backgroundCube_vert:VA,backgroundCube_frag:kA,cube_vert:XA,cube_frag:WA,depth_vert:qA,depth_frag:YA,distanceRGBA_vert:jA,distanceRGBA_frag:ZA,equirect_vert:KA,equirect_frag:QA,linedashed_vert:JA,linedashed_frag:$A,meshbasic_vert:tR,meshbasic_frag:eR,meshlambert_vert:nR,meshlambert_frag:iR,meshmatcap_vert:aR,meshmatcap_frag:rR,meshnormal_vert:sR,meshnormal_frag:oR,meshphong_vert:lR,meshphong_frag:uR,meshphysical_vert:cR,meshphysical_frag:fR,meshtoon_vert:hR,meshtoon_frag:dR,points_vert:pR,points_frag:mR,shadow_vert:_R,shadow_frag:gR,sprite_vert:vR,sprite_frag:xR},Ot={common:{diffuse:{value:new ce(16777215)},opacity:{value:1},map:{value:null},mapTransform:{value:new ue},alphaMap:{value:null},alphaMapTransform:{value:new ue},alphaTest:{value:0}},specularmap:{specularMap:{value:null},specularMapTransform:{value:new ue}},envmap:{envMap:{value:null},envMapRotation:{value:new ue},flipEnvMap:{value:-1},reflectivity:{value:1},ior:{value:1.5},refractionRatio:{value:.98}},aomap:{aoMap:{value:null},aoMapIntensity:{value:1},aoMapTransform:{value:new ue}},lightmap:{lightMap:{value:null},lightMapIntensity:{value:1},lightMapTransform:{value:new ue}},bumpmap:{bumpMap:{value:null},bumpMapTransform:{value:new ue},bumpScale:{value:1}},normalmap:{normalMap:{value:null},normalMapTransform:{value:new ue},normalScale:{value:new Te(1,1)}},displacementmap:{displacementMap:{value:null},displacementMapTransform:{value:new ue},displacementScale:{value:1},displacementBias:{value:0}},emissivemap:{emissiveMap:{value:null},emissiveMapTransform:{value:new ue}},metalnessmap:{metalnessMap:{value:null},metalnessMapTransform:{value:new ue}},roughnessmap:{roughnessMap:{value:null},roughnessMapTransform:{value:new ue}},gradientmap:{gradientMap:{value:null}},fog:{fogDensity:{value:25e-5},fogNear:{value:1},fogFar:{value:2e3},fogColor:{value:new ce(16777215)}},lights:{ambientLightColor:{value:[]},lightProbe:{value:[]},directionalLights:{value:[],properties:{direction:{},color:{}}},directionalLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},directionalShadowMap:{value:[]},directionalShadowMatrix:{value:[]},spotLights:{value:[],properties:{color:{},position:{},direction:{},distance:{},coneCos:{},penumbraCos:{},decay:{}}},spotLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},spotLightMap:{value:[]},spotShadowMap:{value:[]},spotLightMatrix:{value:[]},pointLights:{value:[],properties:{color:{},position:{},decay:{},distance:{}}},pointLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{},shadowCameraNear:{},shadowCameraFar:{}}},pointShadowMap:{value:[]},pointShadowMatrix:{value:[]},hemisphereLights:{value:[],properties:{direction:{},skyColor:{},groundColor:{}}},rectAreaLights:{value:[],properties:{color:{},position:{},width:{},height:{}}},ltc_1:{value:null},ltc_2:{value:null}},points:{diffuse:{value:new ce(16777215)},opacity:{value:1},size:{value:1},scale:{value:1},map:{value:null},alphaMap:{value:null},alphaMapTransform:{value:new ue},alphaTest:{value:0},uvTransform:{value:new ue}},sprite:{diffuse:{value:new ce(16777215)},opacity:{value:1},center:{value:new Te(.5,.5)},rotation:{value:0},map:{value:null},mapTransform:{value:new ue},alphaMap:{value:null},alphaMapTransform:{value:new ue},alphaTest:{value:0}}},oa={basic:{uniforms:Yn([Ot.common,Ot.specularmap,Ot.envmap,Ot.aomap,Ot.lightmap,Ot.fog]),vertexShader:de.meshbasic_vert,fragmentShader:de.meshbasic_frag},lambert:{uniforms:Yn([Ot.common,Ot.specularmap,Ot.envmap,Ot.aomap,Ot.lightmap,Ot.emissivemap,Ot.bumpmap,Ot.normalmap,Ot.displacementmap,Ot.fog,Ot.lights,{emissive:{value:new ce(0)}}]),vertexShader:de.meshlambert_vert,fragmentShader:de.meshlambert_frag},phong:{uniforms:Yn([Ot.common,Ot.specularmap,Ot.envmap,Ot.aomap,Ot.lightmap,Ot.emissivemap,Ot.bumpmap,Ot.normalmap,Ot.displacementmap,Ot.fog,Ot.lights,{emissive:{value:new ce(0)},specular:{value:new ce(1118481)},shininess:{value:30}}]),vertexShader:de.meshphong_vert,fragmentShader:de.meshphong_frag},standard:{uniforms:Yn([Ot.common,Ot.envmap,Ot.aomap,Ot.lightmap,Ot.emissivemap,Ot.bumpmap,Ot.normalmap,Ot.displacementmap,Ot.roughnessmap,Ot.metalnessmap,Ot.fog,Ot.lights,{emissive:{value:new ce(0)},roughness:{value:1},metalness:{value:0},envMapIntensity:{value:1}}]),vertexShader:de.meshphysical_vert,fragmentShader:de.meshphysical_frag},toon:{uniforms:Yn([Ot.common,Ot.aomap,Ot.lightmap,Ot.emissivemap,Ot.bumpmap,Ot.normalmap,Ot.displacementmap,Ot.gradientmap,Ot.fog,Ot.lights,{emissive:{value:new ce(0)}}]),vertexShader:de.meshtoon_vert,fragmentShader:de.meshtoon_frag},matcap:{uniforms:Yn([Ot.common,Ot.bumpmap,Ot.normalmap,Ot.displacementmap,Ot.fog,{matcap:{value:null}}]),vertexShader:de.meshmatcap_vert,fragmentShader:de.meshmatcap_frag},points:{uniforms:Yn([Ot.points,Ot.fog]),vertexShader:de.points_vert,fragmentShader:de.points_frag},dashed:{uniforms:Yn([Ot.common,Ot.fog,{scale:{value:1},dashSize:{value:1},totalSize:{value:2}}]),vertexShader:de.linedashed_vert,fragmentShader:de.linedashed_frag},depth:{uniforms:Yn([Ot.common,Ot.displacementmap]),vertexShader:de.depth_vert,fragmentShader:de.depth_frag},normal:{uniforms:Yn([Ot.common,Ot.bumpmap,Ot.normalmap,Ot.displacementmap,{opacity:{value:1}}]),vertexShader:de.meshnormal_vert,fragmentShader:de.meshnormal_frag},sprite:{uniforms:Yn([Ot.sprite,Ot.fog]),vertexShader:de.sprite_vert,fragmentShader:de.sprite_frag},background:{uniforms:{uvTransform:{value:new ue},t2D:{value:null},backgroundIntensity:{value:1}},vertexShader:de.background_vert,fragmentShader:de.background_frag},backgroundCube:{uniforms:{envMap:{value:null},flipEnvMap:{value:-1},backgroundBlurriness:{value:0},backgroundIntensity:{value:1},backgroundRotation:{value:new ue}},vertexShader:de.backgroundCube_vert,fragmentShader:de.backgroundCube_frag},cube:{uniforms:{tCube:{value:null},tFlip:{value:-1},opacity:{value:1}},vertexShader:de.cube_vert,fragmentShader:de.cube_frag},equirect:{uniforms:{tEquirect:{value:null}},vertexShader:de.equirect_vert,fragmentShader:de.equirect_frag},distanceRGBA:{uniforms:Yn([Ot.common,Ot.displacementmap,{referencePosition:{value:new it},nearDistance:{value:1},farDistance:{value:1e3}}]),vertexShader:de.distanceRGBA_vert,fragmentShader:de.distanceRGBA_frag},shadow:{uniforms:Yn([Ot.lights,Ot.fog,{color:{value:new ce(0)},opacity:{value:1}}]),vertexShader:de.shadow_vert,fragmentShader:de.shadow_frag}};oa.physical={uniforms:Yn([oa.standard.uniforms,{clearcoat:{value:0},clearcoatMap:{value:null},clearcoatMapTransform:{value:new ue},clearcoatNormalMap:{value:null},clearcoatNormalMapTransform:{value:new ue},clearcoatNormalScale:{value:new Te(1,1)},clearcoatRoughness:{value:0},clearcoatRoughnessMap:{value:null},clearcoatRoughnessMapTransform:{value:new ue},dispersion:{value:0},iridescence:{value:0},iridescenceMap:{value:null},iridescenceMapTransform:{value:new ue},iridescenceIOR:{value:1.3},iridescenceThicknessMinimum:{value:100},iridescenceThicknessMaximum:{value:400},iridescenceThicknessMap:{value:null},iridescenceThicknessMapTransform:{value:new ue},sheen:{value:0},sheenColor:{value:new ce(0)},sheenColorMap:{value:null},sheenColorMapTransform:{value:new ue},sheenRoughness:{value:1},sheenRoughnessMap:{value:null},sheenRoughnessMapTransform:{value:new ue},transmission:{value:0},transmissionMap:{value:null},transmissionMapTransform:{value:new ue},transmissionSamplerSize:{value:new Te},transmissionSamplerMap:{value:null},thickness:{value:0},thicknessMap:{value:null},thicknessMapTransform:{value:new ue},attenuationDistance:{value:0},attenuationColor:{value:new ce(0)},specularColor:{value:new ce(1,1,1)},specularColorMap:{value:null},specularColorMapTransform:{value:new ue},specularIntensity:{value:1},specularIntensityMap:{value:null},specularIntensityMapTransform:{value:new ue},anisotropyVector:{value:new Te},anisotropyMap:{value:null},anisotropyMapTransform:{value:new ue}}]),vertexShader:de.meshphysical_vert,fragmentShader:de.meshphysical_frag};const Kc={r:0,b:0,g:0},ts=new Ji,yR=new $e;function SR(o,t,e,a,r,l,c){const f=new ce(0);let p=l===!0?0:1,h,m,g=null,v=0,x=null;function E(U){let A=U.isScene===!0?U.background:null;return A&&A.isTexture&&(A=(U.backgroundBlurriness>0?e:t).get(A)),A}function M(U){let A=!1;const L=E(U);L===null?y(f,p):L&&L.isColor&&(y(L,1),A=!0);const P=o.xr.getEnvironmentBlendMode();P==="additive"?a.buffers.color.setClear(0,0,0,1,c):P==="alpha-blend"&&a.buffers.color.setClear(0,0,0,0,c),(o.autoClear||A)&&(a.buffers.depth.setTest(!0),a.buffers.depth.setMask(!0),a.buffers.color.setMask(!0),o.clear(o.autoClearColor,o.autoClearDepth,o.autoClearStencil))}function S(U,A){const L=E(A);L&&(L.isCubeTexture||L.mapping===bf)?(m===void 0&&(m=new yi(new vs(1,1,1),new ka({name:"BackgroundCubeMaterial",uniforms:Oo(oa.backgroundCube.uniforms),vertexShader:oa.backgroundCube.vertexShader,fragmentShader:oa.backgroundCube.fragmentShader,side:ii,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),m.geometry.deleteAttribute("normal"),m.geometry.deleteAttribute("uv"),m.onBeforeRender=function(P,z,F){this.matrixWorld.copyPosition(F.matrixWorld)},Object.defineProperty(m.material,"envMap",{get:function(){return this.uniforms.envMap.value}}),r.update(m)),ts.copy(A.backgroundRotation),ts.x*=-1,ts.y*=-1,ts.z*=-1,L.isCubeTexture&&L.isRenderTargetTexture===!1&&(ts.y*=-1,ts.z*=-1),m.material.uniforms.envMap.value=L,m.material.uniforms.flipEnvMap.value=L.isCubeTexture&&L.isRenderTargetTexture===!1?-1:1,m.material.uniforms.backgroundBlurriness.value=A.backgroundBlurriness,m.material.uniforms.backgroundIntensity.value=A.backgroundIntensity,m.material.uniforms.backgroundRotation.value.setFromMatrix4(yR.makeRotationFromEuler(ts)),m.material.toneMapped=ye.getTransfer(L.colorSpace)!==Ie,(g!==L||v!==L.version||x!==o.toneMapping)&&(m.material.needsUpdate=!0,g=L,v=L.version,x=o.toneMapping),m.layers.enableAll(),U.unshift(m,m.geometry,m.material,0,0,null)):L&&L.isTexture&&(h===void 0&&(h=new yi(new Af(2,2),new ka({name:"BackgroundMaterial",uniforms:Oo(oa.background.uniforms),vertexShader:oa.background.vertexShader,fragmentShader:oa.background.fragmentShader,side:Va,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),h.geometry.deleteAttribute("normal"),Object.defineProperty(h.material,"map",{get:function(){return this.uniforms.t2D.value}}),r.update(h)),h.material.uniforms.t2D.value=L,h.material.uniforms.backgroundIntensity.value=A.backgroundIntensity,h.material.toneMapped=ye.getTransfer(L.colorSpace)!==Ie,L.matrixAutoUpdate===!0&&L.updateMatrix(),h.material.uniforms.uvTransform.value.copy(L.matrix),(g!==L||v!==L.version||x!==o.toneMapping)&&(h.material.needsUpdate=!0,g=L,v=L.version,x=o.toneMapping),h.layers.enableAll(),U.unshift(h,h.geometry,h.material,0,0,null))}function y(U,A){U.getRGB(Kc,Ny(o)),a.buffers.color.setClear(Kc.r,Kc.g,Kc.b,A,c)}function D(){m!==void 0&&(m.geometry.dispose(),m.material.dispose(),m=void 0),h!==void 0&&(h.geometry.dispose(),h.material.dispose(),h=void 0)}return{getClearColor:function(){return f},setClearColor:function(U,A=1){f.set(U),p=A,y(f,p)},getClearAlpha:function(){return p},setClearAlpha:function(U){p=U,y(f,p)},render:M,addToRenderList:S,dispose:D}}function MR(o,t){const e=o.getParameter(o.MAX_VERTEX_ATTRIBS),a={},r=v(null);let l=r,c=!1;function f(O,V,j,tt,ct){let rt=!1;const B=g(tt,j,V);l!==B&&(l=B,h(l.object)),rt=x(O,tt,j,ct),rt&&E(O,tt,j,ct),ct!==null&&t.update(ct,o.ELEMENT_ARRAY_BUFFER),(rt||c)&&(c=!1,A(O,V,j,tt),ct!==null&&o.bindBuffer(o.ELEMENT_ARRAY_BUFFER,t.get(ct).buffer))}function p(){return o.createVertexArray()}function h(O){return o.bindVertexArray(O)}function m(O){return o.deleteVertexArray(O)}function g(O,V,j){const tt=j.wireframe===!0;let ct=a[O.id];ct===void 0&&(ct={},a[O.id]=ct);let rt=ct[V.id];rt===void 0&&(rt={},ct[V.id]=rt);let B=rt[tt];return B===void 0&&(B=v(p()),rt[tt]=B),B}function v(O){const V=[],j=[],tt=[];for(let ct=0;ct<e;ct++)V[ct]=0,j[ct]=0,tt[ct]=0;return{geometry:null,program:null,wireframe:!1,newAttributes:V,enabledAttributes:j,attributeDivisors:tt,object:O,attributes:{},index:null}}function x(O,V,j,tt){const ct=l.attributes,rt=V.attributes;let B=0;const k=j.getAttributes();for(const X in k)if(k[X].location>=0){const N=ct[X];let Q=rt[X];if(Q===void 0&&(X==="instanceMatrix"&&O.instanceMatrix&&(Q=O.instanceMatrix),X==="instanceColor"&&O.instanceColor&&(Q=O.instanceColor)),N===void 0||N.attribute!==Q||Q&&N.data!==Q.data)return!0;B++}return l.attributesNum!==B||l.index!==tt}function E(O,V,j,tt){const ct={},rt=V.attributes;let B=0;const k=j.getAttributes();for(const X in k)if(k[X].location>=0){let N=rt[X];N===void 0&&(X==="instanceMatrix"&&O.instanceMatrix&&(N=O.instanceMatrix),X==="instanceColor"&&O.instanceColor&&(N=O.instanceColor));const Q={};Q.attribute=N,N&&N.data&&(Q.data=N.data),ct[X]=Q,B++}l.attributes=ct,l.attributesNum=B,l.index=tt}function M(){const O=l.newAttributes;for(let V=0,j=O.length;V<j;V++)O[V]=0}function S(O){y(O,0)}function y(O,V){const j=l.newAttributes,tt=l.enabledAttributes,ct=l.attributeDivisors;j[O]=1,tt[O]===0&&(o.enableVertexAttribArray(O),tt[O]=1),ct[O]!==V&&(o.vertexAttribDivisor(O,V),ct[O]=V)}function D(){const O=l.newAttributes,V=l.enabledAttributes;for(let j=0,tt=V.length;j<tt;j++)V[j]!==O[j]&&(o.disableVertexAttribArray(j),V[j]=0)}function U(O,V,j,tt,ct,rt,B){B===!0?o.vertexAttribIPointer(O,V,j,ct,rt):o.vertexAttribPointer(O,V,j,tt,ct,rt)}function A(O,V,j,tt){M();const ct=tt.attributes,rt=j.getAttributes(),B=V.defaultAttributeValues;for(const k in rt){const X=rt[k];if(X.location>=0){let ft=ct[k];if(ft===void 0&&(k==="instanceMatrix"&&O.instanceMatrix&&(ft=O.instanceMatrix),k==="instanceColor"&&O.instanceColor&&(ft=O.instanceColor)),ft!==void 0){const N=ft.normalized,Q=ft.itemSize,mt=t.get(ft);if(mt===void 0)continue;const yt=mt.buffer,bt=mt.type,Nt=mt.bytesPerElement,nt=bt===o.INT||bt===o.UNSIGNED_INT||ft.gpuType===Nm;if(ft.isInterleavedBufferAttribute){const vt=ft.data,At=vt.stride,Kt=ft.offset;if(vt.isInstancedInterleavedBuffer){for(let Wt=0;Wt<X.locationSize;Wt++)y(X.location+Wt,vt.meshPerAttribute);O.isInstancedMesh!==!0&&tt._maxInstanceCount===void 0&&(tt._maxInstanceCount=vt.meshPerAttribute*vt.count)}else for(let Wt=0;Wt<X.locationSize;Wt++)S(X.location+Wt);o.bindBuffer(o.ARRAY_BUFFER,yt);for(let Wt=0;Wt<X.locationSize;Wt++)U(X.location+Wt,Q/X.locationSize,bt,N,At*Nt,(Kt+Q/X.locationSize*Wt)*Nt,nt)}else{if(ft.isInstancedBufferAttribute){for(let vt=0;vt<X.locationSize;vt++)y(X.location+vt,ft.meshPerAttribute);O.isInstancedMesh!==!0&&tt._maxInstanceCount===void 0&&(tt._maxInstanceCount=ft.meshPerAttribute*ft.count)}else for(let vt=0;vt<X.locationSize;vt++)S(X.location+vt);o.bindBuffer(o.ARRAY_BUFFER,yt);for(let vt=0;vt<X.locationSize;vt++)U(X.location+vt,Q/X.locationSize,bt,N,Q*Nt,Q/X.locationSize*vt*Nt,nt)}}else if(B!==void 0){const N=B[k];if(N!==void 0)switch(N.length){case 2:o.vertexAttrib2fv(X.location,N);break;case 3:o.vertexAttrib3fv(X.location,N);break;case 4:o.vertexAttrib4fv(X.location,N);break;default:o.vertexAttrib1fv(X.location,N)}}}}D()}function L(){F();for(const O in a){const V=a[O];for(const j in V){const tt=V[j];for(const ct in tt)m(tt[ct].object),delete tt[ct];delete V[j]}delete a[O]}}function P(O){if(a[O.id]===void 0)return;const V=a[O.id];for(const j in V){const tt=V[j];for(const ct in tt)m(tt[ct].object),delete tt[ct];delete V[j]}delete a[O.id]}function z(O){for(const V in a){const j=a[V];if(j[O.id]===void 0)continue;const tt=j[O.id];for(const ct in tt)m(tt[ct].object),delete tt[ct];delete j[O.id]}}function F(){b(),c=!0,l!==r&&(l=r,h(l.object))}function b(){r.geometry=null,r.program=null,r.wireframe=!1}return{setup:f,reset:F,resetDefaultState:b,dispose:L,releaseStatesOfGeometry:P,releaseStatesOfProgram:z,initAttributes:M,enableAttribute:S,disableUnusedAttributes:D}}function ER(o,t,e){let a;function r(h){a=h}function l(h,m){o.drawArrays(a,h,m),e.update(m,a,1)}function c(h,m,g){g!==0&&(o.drawArraysInstanced(a,h,m,g),e.update(m,a,g))}function f(h,m,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawArraysWEBGL(a,h,0,m,0,g);let x=0;for(let E=0;E<g;E++)x+=m[E];e.update(x,a,1)}function p(h,m,g,v){if(g===0)return;const x=t.get("WEBGL_multi_draw");if(x===null)for(let E=0;E<h.length;E++)c(h[E],m[E],v[E]);else{x.multiDrawArraysInstancedWEBGL(a,h,0,m,0,v,0,g);let E=0;for(let M=0;M<g;M++)E+=m[M]*v[M];e.update(E,a,1)}}this.setMode=r,this.render=l,this.renderInstances=c,this.renderMultiDraw=f,this.renderMultiDrawInstances=p}function TR(o,t,e,a){let r;function l(){if(r!==void 0)return r;if(t.has("EXT_texture_filter_anisotropic")===!0){const z=t.get("EXT_texture_filter_anisotropic");r=o.getParameter(z.MAX_TEXTURE_MAX_ANISOTROPY_EXT)}else r=0;return r}function c(z){return!(z!==Ki&&a.convert(z)!==o.getParameter(o.IMPLEMENTATION_COLOR_READ_FORMAT))}function f(z){const F=z===du&&(t.has("EXT_color_buffer_half_float")||t.has("EXT_color_buffer_float"));return!(z!==ha&&a.convert(z)!==o.getParameter(o.IMPLEMENTATION_COLOR_READ_TYPE)&&z!==Ha&&!F)}function p(z){if(z==="highp"){if(o.getShaderPrecisionFormat(o.VERTEX_SHADER,o.HIGH_FLOAT).precision>0&&o.getShaderPrecisionFormat(o.FRAGMENT_SHADER,o.HIGH_FLOAT).precision>0)return"highp";z="mediump"}return z==="mediump"&&o.getShaderPrecisionFormat(o.VERTEX_SHADER,o.MEDIUM_FLOAT).precision>0&&o.getShaderPrecisionFormat(o.FRAGMENT_SHADER,o.MEDIUM_FLOAT).precision>0?"mediump":"lowp"}let h=e.precision!==void 0?e.precision:"highp";const m=p(h);m!==h&&(console.warn("THREE.WebGLRenderer:",h,"not supported, using",m,"instead."),h=m);const g=e.logarithmicDepthBuffer===!0,v=e.reversedDepthBuffer===!0&&t.has("EXT_clip_control"),x=o.getParameter(o.MAX_TEXTURE_IMAGE_UNITS),E=o.getParameter(o.MAX_VERTEX_TEXTURE_IMAGE_UNITS),M=o.getParameter(o.MAX_TEXTURE_SIZE),S=o.getParameter(o.MAX_CUBE_MAP_TEXTURE_SIZE),y=o.getParameter(o.MAX_VERTEX_ATTRIBS),D=o.getParameter(o.MAX_VERTEX_UNIFORM_VECTORS),U=o.getParameter(o.MAX_VARYING_VECTORS),A=o.getParameter(o.MAX_FRAGMENT_UNIFORM_VECTORS),L=E>0,P=o.getParameter(o.MAX_SAMPLES);return{isWebGL2:!0,getMaxAnisotropy:l,getMaxPrecision:p,textureFormatReadable:c,textureTypeReadable:f,precision:h,logarithmicDepthBuffer:g,reversedDepthBuffer:v,maxTextures:x,maxVertexTextures:E,maxTextureSize:M,maxCubemapSize:S,maxAttributes:y,maxVertexUniforms:D,maxVaryings:U,maxFragmentUniforms:A,vertexTextures:L,maxSamples:P}}function bR(o){const t=this;let e=null,a=0,r=!1,l=!1;const c=new as,f=new ue,p={value:null,needsUpdate:!1};this.uniform=p,this.numPlanes=0,this.numIntersection=0,this.init=function(g,v){const x=g.length!==0||v||a!==0||r;return r=v,a=g.length,x},this.beginShadows=function(){l=!0,m(null)},this.endShadows=function(){l=!1},this.setGlobalState=function(g,v){e=m(g,v,0)},this.setState=function(g,v,x){const E=g.clippingPlanes,M=g.clipIntersection,S=g.clipShadows,y=o.get(g);if(!r||E===null||E.length===0||l&&!S)l?m(null):h();else{const D=l?0:a,U=D*4;let A=y.clippingState||null;p.value=A,A=m(E,v,U,x);for(let L=0;L!==U;++L)A[L]=e[L];y.clippingState=A,this.numIntersection=M?this.numPlanes:0,this.numPlanes+=D}};function h(){p.value!==e&&(p.value=e,p.needsUpdate=a>0),t.numPlanes=a,t.numIntersection=0}function m(g,v,x,E){const M=g!==null?g.length:0;let S=null;if(M!==0){if(S=p.value,E!==!0||S===null){const y=x+M*4,D=v.matrixWorldInverse;f.getNormalMatrix(D),(S===null||S.length<y)&&(S=new Float32Array(y));for(let U=0,A=x;U!==M;++U,A+=4)c.copy(g[U]).applyMatrix4(D,f),c.normal.toArray(S,A),S[A+3]=c.constant}p.value=S,p.needsUpdate=!0}return t.numPlanes=M,t.numIntersection=0,S}}function AR(o){let t=new WeakMap;function e(c,f){return f===zp?c.mapping=Do:f===Ip&&(c.mapping=Uo),c}function a(c){if(c&&c.isTexture){const f=c.mapping;if(f===zp||f===Ip)if(t.has(c)){const p=t.get(c).texture;return e(p,c.mapping)}else{const p=c.image;if(p&&p.height>0){const h=new x1(p.height);return h.fromEquirectangularTexture(o,c),t.set(c,h),c.addEventListener("dispose",r),e(h.texture,c.mapping)}else return null}}return c}function r(c){const f=c.target;f.removeEventListener("dispose",r);const p=t.get(f);p!==void 0&&(t.delete(f),p.dispose())}function l(){t=new WeakMap}return{get:a,dispose:l}}const So=4,Tx=[.125,.215,.35,.446,.526,.582],ls=20,hp=new ky,bx=new ce;let dp=null,pp=0,mp=0,_p=!1;const rs=(1+Math.sqrt(5))/2,go=1/rs,Ax=[new it(-rs,go,0),new it(rs,go,0),new it(-go,0,rs),new it(go,0,rs),new it(0,rs,-go),new it(0,rs,go),new it(-1,1,-1),new it(1,1,-1),new it(-1,1,1),new it(1,1,1)],RR=new it;class Rx{constructor(t){this._renderer=t,this._pingPongRenderTarget=null,this._lodMax=0,this._cubeSize=0,this._lodPlanes=[],this._sizeLods=[],this._sigmas=[],this._blurMaterial=null,this._cubemapMaterial=null,this._equirectMaterial=null,this._compileMaterial(this._blurMaterial)}fromScene(t,e=0,a=.1,r=100,l={}){const{size:c=256,position:f=RR}=l;dp=this._renderer.getRenderTarget(),pp=this._renderer.getActiveCubeFace(),mp=this._renderer.getActiveMipmapLevel(),_p=this._renderer.xr.enabled,this._renderer.xr.enabled=!1,this._setSize(c);const p=this._allocateTargets();return p.depthBuffer=!0,this._sceneToCubeUV(t,a,r,p,f),e>0&&this._blur(p,0,0,e),this._applyPMREM(p),this._cleanup(p),p}fromEquirectangular(t,e=null){return this._fromTexture(t,e)}fromCubemap(t,e=null){return this._fromTexture(t,e)}compileCubemapShader(){this._cubemapMaterial===null&&(this._cubemapMaterial=Dx(),this._compileMaterial(this._cubemapMaterial))}compileEquirectangularShader(){this._equirectMaterial===null&&(this._equirectMaterial=Cx(),this._compileMaterial(this._equirectMaterial))}dispose(){this._dispose(),this._cubemapMaterial!==null&&this._cubemapMaterial.dispose(),this._equirectMaterial!==null&&this._equirectMaterial.dispose()}_setSize(t){this._lodMax=Math.floor(Math.log2(t)),this._cubeSize=Math.pow(2,this._lodMax)}_dispose(){this._blurMaterial!==null&&this._blurMaterial.dispose(),this._pingPongRenderTarget!==null&&this._pingPongRenderTarget.dispose();for(let t=0;t<this._lodPlanes.length;t++)this._lodPlanes[t].dispose()}_cleanup(t){this._renderer.setRenderTarget(dp,pp,mp),this._renderer.xr.enabled=_p,t.scissorTest=!1,Qc(t,0,0,t.width,t.height)}_fromTexture(t,e){t.mapping===Do||t.mapping===Uo?this._setSize(t.image.length===0?16:t.image[0].width||t.image[0].image.width):this._setSize(t.image.width/4),dp=this._renderer.getRenderTarget(),pp=this._renderer.getActiveCubeFace(),mp=this._renderer.getActiveMipmapLevel(),_p=this._renderer.xr.enabled,this._renderer.xr.enabled=!1;const a=e||this._allocateTargets();return this._textureToCubeUV(t,a),this._applyPMREM(a),this._cleanup(a),a}_allocateTargets(){const t=3*Math.max(this._cubeSize,112),e=4*this._cubeSize,a={magFilter:ua,minFilter:ua,generateMipmaps:!1,type:du,format:Ki,colorSpace:Lo,depthBuffer:!1},r=wx(t,e,a);if(this._pingPongRenderTarget===null||this._pingPongRenderTarget.width!==t||this._pingPongRenderTarget.height!==e){this._pingPongRenderTarget!==null&&this._dispose(),this._pingPongRenderTarget=wx(t,e,a);const{_lodMax:l}=this;({sizeLods:this._sizeLods,lodPlanes:this._lodPlanes,sigmas:this._sigmas}=wR(l)),this._blurMaterial=CR(l,t,e)}return r}_compileMaterial(t){const e=new yi(this._lodPlanes[0],t);this._renderer.compile(e,hp)}_sceneToCubeUV(t,e,a,r,l){const p=new Ii(90,1,e,a),h=[1,-1,1,1,1,1],m=[1,1,1,-1,-1,-1],g=this._renderer,v=g.autoClear,x=g.toneMapping;g.getClearColor(bx),g.toneMapping=Rr,g.autoClear=!1,g.state.buffers.depth.getReversed()&&(g.setRenderTarget(r),g.clearDepth(),g.setRenderTarget(null));const M=new Uy({name:"PMREM.Background",side:ii,depthWrite:!1,depthTest:!1}),S=new yi(new vs,M);let y=!1;const D=t.background;D?D.isColor&&(M.color.copy(D),t.background=null,y=!0):(M.color.copy(bx),y=!0);for(let U=0;U<6;U++){const A=U%3;A===0?(p.up.set(0,h[U],0),p.position.set(l.x,l.y,l.z),p.lookAt(l.x+m[U],l.y,l.z)):A===1?(p.up.set(0,0,h[U]),p.position.set(l.x,l.y,l.z),p.lookAt(l.x,l.y+m[U],l.z)):(p.up.set(0,h[U],0),p.position.set(l.x,l.y,l.z),p.lookAt(l.x,l.y,l.z+m[U]));const L=this._cubeSize;Qc(r,A*L,U>2?L:0,L,L),g.setRenderTarget(r),y&&g.render(S,p),g.render(t,p)}S.geometry.dispose(),S.material.dispose(),g.toneMapping=x,g.autoClear=v,t.background=D}_textureToCubeUV(t,e){const a=this._renderer,r=t.mapping===Do||t.mapping===Uo;r?(this._cubemapMaterial===null&&(this._cubemapMaterial=Dx()),this._cubemapMaterial.uniforms.flipEnvMap.value=t.isRenderTargetTexture===!1?-1:1):this._equirectMaterial===null&&(this._equirectMaterial=Cx());const l=r?this._cubemapMaterial:this._equirectMaterial,c=new yi(this._lodPlanes[0],l),f=l.uniforms;f.envMap.value=t;const p=this._cubeSize;Qc(e,0,0,3*p,2*p),a.setRenderTarget(e),a.render(c,hp)}_applyPMREM(t){const e=this._renderer,a=e.autoClear;e.autoClear=!1;const r=this._lodPlanes.length;for(let l=1;l<r;l++){const c=Math.sqrt(this._sigmas[l]*this._sigmas[l]-this._sigmas[l-1]*this._sigmas[l-1]),f=Ax[(r-l-1)%Ax.length];this._blur(t,l-1,l,c,f)}e.autoClear=a}_blur(t,e,a,r,l){const c=this._pingPongRenderTarget;this._halfBlur(t,c,e,a,r,"latitudinal",l),this._halfBlur(c,t,a,a,r,"longitudinal",l)}_halfBlur(t,e,a,r,l,c,f){const p=this._renderer,h=this._blurMaterial;c!=="latitudinal"&&c!=="longitudinal"&&console.error("blur direction must be either latitudinal or longitudinal!");const m=3,g=new yi(this._lodPlanes[r],h),v=h.uniforms,x=this._sizeLods[a]-1,E=isFinite(l)?Math.PI/(2*x):2*Math.PI/(2*ls-1),M=l/E,S=isFinite(l)?1+Math.floor(m*M):ls;S>ls&&console.warn(`sigmaRadians, ${l}, is too large and will clip, as it requested ${S} samples when the maximum is set to ${ls}`);const y=[];let D=0;for(let z=0;z<ls;++z){const F=z/M,b=Math.exp(-F*F/2);y.push(b),z===0?D+=b:z<S&&(D+=2*b)}for(let z=0;z<y.length;z++)y[z]=y[z]/D;v.envMap.value=t.texture,v.samples.value=S,v.weights.value=y,v.latitudinal.value=c==="latitudinal",f&&(v.poleAxis.value=f);const{_lodMax:U}=this;v.dTheta.value=E,v.mipInt.value=U-a;const A=this._sizeLods[r],L=3*A*(r>U-So?r-U+So:0),P=4*(this._cubeSize-A);Qc(e,L,P,3*A,2*A),p.setRenderTarget(e),p.render(g,hp)}}function wR(o){const t=[],e=[],a=[];let r=o;const l=o-So+1+Tx.length;for(let c=0;c<l;c++){const f=Math.pow(2,r);e.push(f);let p=1/f;c>o-So?p=Tx[c-o+So-1]:c===0&&(p=0),a.push(p);const h=1/(f-2),m=-h,g=1+h,v=[m,m,g,m,g,g,m,m,g,g,m,g],x=6,E=6,M=3,S=2,y=1,D=new Float32Array(M*E*x),U=new Float32Array(S*E*x),A=new Float32Array(y*E*x);for(let P=0;P<x;P++){const z=P%3*2/3-1,F=P>2?0:-1,b=[z,F,0,z+2/3,F,0,z+2/3,F+1,0,z,F,0,z+2/3,F+1,0,z,F+1,0];D.set(b,M*E*P),U.set(v,S*E*P);const O=[P,P,P,P,P,P];A.set(O,y*E*P)}const L=new Ti;L.setAttribute("position",new Mi(D,M)),L.setAttribute("uv",new Mi(U,S)),L.setAttribute("faceIndex",new Mi(A,y)),t.push(L),r>So&&r--}return{lodPlanes:t,sizeLods:e,sigmas:a}}function wx(o,t,e){const a=new gs(o,t,e);return a.texture.mapping=bf,a.texture.name="PMREM.cubeUv",a.scissorTest=!0,a}function Qc(o,t,e,a,r){o.viewport.set(t,e,a,r),o.scissor.set(t,e,a,r)}function CR(o,t,e){const a=new Float32Array(ls),r=new it(0,1,0);return new ka({name:"SphericalGaussianBlur",defines:{n:ls,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${o}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:a},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Xm(),fragmentShader:`
...
#define LOW_PRECISION`),t}function Vw(o){let t="SHADOWMAP_TYPE_BASIC";return o.shadowMapType===_y?t="SHADOWMAP_TYPE_PCF":o.shadowMapType===uT?t="SHADOWMAP_TYPE_PCF_SOFT":o.shadowMapType===za&&(t="SHADOWMAP_TYPE_VSM"),t}function kw(o){let t="ENVMAP_TYPE_CUBE";if(o.envMap)switch(o.envMapMode){case Do:case Uo:t="ENVMAP_TYPE_CUBE";break;case bf:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Xw(o){let t="ENVMAP_MODE_REFLECTION";if(o.envMap)switch(o.envMapMode){case Uo:t="ENVMAP_MODE_REFRACTION";break}return t}function Ww(o){let t="ENVMAP_BLENDING_NONE";if(o.envMap)switch(o.combine){case Om:t="ENVMAP_BLENDING_MULTIPLY";break;case wT:t="ENVMAP_BLENDING_MIX";break;case CT:t="ENVMAP_BLENDING_ADD";break}return t}function qw(o){const t=o.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,a=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:a,maxMip:e}}function Yw(o,t,e,a){const r=o.getContext(),l=e.defines;let c=e.vertexShader,f=e.fragmentShader;const p=Vw(e),h=kw(e),m=Xw(e),g=Ww(e),v=qw(e),x=Nw(e),E=Pw(l),M=r.createProgram();let S,y,D=e.glslVersion?"#version "+e.glslVersion+`
`:"";e.isRawShaderMaterial?(S=["#define SHADER_TYPE "+e.shaderType,"#define SHADER_NAME "+e.shaderName,E].filter(Wl).join(`
`),S.length>0&&(S+=`
`),y=["#define SHADER_TYPE "+e.shaderType,"#define SHADER_NAME "+e.shaderName,E].filter(Wl).join(`
`),y.length>0&&(y+=`
...
`)+`
`+y);const U=D+S+c,A=D+y+f,L=Bx(r,r.VERTEX_SHADER,U),P=Bx(r,r.FRAGMENT_SHADER,A);r.attachShader(M,L),r.attachShader(M,P),e.index0AttributeName!==void 0?r.bindAttribLocation(M,0,e.index0AttributeName):e.morphTargets===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M);function z(V){if(o.debug.checkShaderErrors){const j=r.getProgramInfoLog(M)||"",tt=r.getShaderInfoLog(L)||"",ct=r.getShaderInfoLog(P)||"",rt=j.trim(),B=tt.trim(),k=ct.trim();let X=!0,ft=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if(X=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(r,M,L,P);else{const N=Hx(r,L,"vertex"),Q=Hx(r,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`
...
}`;function uC(o,t,e){let a=new km;const r=new Te,l=new Te,c=new rn,f=new A1({depthPacking:FT}),p=new R1,h={},m=e.maxTextureSize,g={[Va]:ii,[ii]:Va,[Fa]:Fa},v=new ka({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Te},radius:{value:4}},vertexShader:oC,fragmentShader:lC}),x=v.clone();x.defines.HORIZONTAL_PASS=1;const E=new Ti;E.setAttribute("position",new Mi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new yi(E,v),S=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=_y;let y=this.type;this.render=function(P,z,F){if(S.enabled===!1||S.autoUpdate===!1&&S.needsUpdate===!1||P.length===0)return;const b=o.getRenderTarget(),O=o.getActiveCubeFace(),V=o.getActiveMipmapLevel(),j=o.state;j.setBlending(Ar),j.buffers.depth.getReversed()===!0?j.buffers.color.setClear(0,0,0,0):j.buffers.color.setClear(1,1,1,1),j.buffers.depth.setTest(!0),j.setScissorTest(!1);const tt=y!==za&&this.type===za,ct=y===za&&this.type!==za;for(let rt=0,B=P.length;rt<B;rt++){const k=P[rt],X=k.shadow;if(X===void 0){console.warn("THREE.WebGLShadowMap:",k,"has no shadow.");continue}if(X.autoUpdate===!1&&X.needsUpdate===!1)continue;r.copy(X.mapSize);const ft=X.getFrameExtents();if(r.multiply(ft),l.copy(X.mapSize),(r.x>m||r.y>m)&&(r.x>m&&(l.x=Math.floor(m/ft.x),r.x=l.x*ft.x,X.mapSize.x=l.x),r.y>m&&(l.y=Math.floor(m/ft.y),r.y=l.y*ft.y,X.mapSize.y=l.y)),X.map===null||tt===!0||ct===!0){const Q=this.type!==za?{minFilter:Qi,magFilter:Qi}:{};X.map!==null&&X.map.dispose(),X.map=new gs(r.x,r.y,Q),X.map.texture.name=k.name+".shadowMap",X.camera.updateProjectionMatrix()}o.setRenderTarget(X.map),o.clear();const N=X.getViewportCount();for(let Q=0;Q<N;Q++){const mt=X.getViewport(Q);c.set(l.x*mt.x,l.y*mt.y,l.x*mt.z,l.y*mt.w),j.viewport(c),X.updateMatrices(k,Q),a=X.getFrustum(),A(z,F,X.camera,k,this.type)}X.isPointLightShadow!==!0&&this.type===za&&D(X,F),X.needsUpdate=!1}y=this.type,S.needsUpdate=!1,o.setRenderTarget(b,O,V)};function D(P,z){const F=t.update(M);v.defines.VSM_SAMPLES!==P.blurSamples&&(v.defines.VSM_SAMPLES=P.blurSamples,x.defines.VSM_SAMPLES=P.blurSamples,v.needsUpdate=!0,x.needsUpdate=!0),P.mapPass===null&&(P.mapPass=new gs(r.x,r.y)),v.uniforms.shadow_pass.value=P.map.texture,v.uniforms.resolution.value=P.mapSize,v.uniforms.radius.value=P.radius,o.setRenderTarget(P.mapPass),o.clear(),o.renderBufferDirect(z,null,F,v,M,null),x.uniforms.shadow_pass.value=P.mapPass.texture,x.uniforms.resolution.value=P.mapSize,x.uniforms.radius.value=P.radius,o.setRenderTarget(P.map),o.clear(),o.renderBufferDirect(z,null,F,x,M,null)}function U(P,z,F,b){let O=null;const V=F.isPointLight===!0?P.customDistanceMaterial:P.customDepthMaterial;if(V!==void 0)O=V;else if(O=F.isPointLight===!0?p:f,o.localClippingEnabled&&z.clipShadows===!0&&Array.isArray(z.clippingPlanes)&&z.clippingPlanes.length!==0||z.displacementMap&&z.displacementScale!==0||z.alphaMap&&z.alphaTest>0||z.map&&z.alphaTest>0||z.alphaToCoverage===!0){const j=O.uuid,tt=z.uuid;let ct=h[j];ct===void 0&&(ct={},h[j]=ct);let rt=ct[tt];rt===void 0&&(rt=O.clone(),ct[tt]=rt,z.addEventListener("dispose",L)),O=rt}if(O.visible=z.visible,O.wireframe=z.wireframe,b===za?O.side=z.shadowSide!==null?z.shadowSide:z.side:O.side=z.shadowSide!==null?z.shadowSide:g[z.side],O.alphaMap=z.alphaMap,O.alphaTest=z.alphaToCoverage===!0?.5:z.alphaTest,O.map=z.map,O.clipShadows=z.clipShadows,O.clippingPlanes=z.clippingPlanes,O.clipIntersection=z.clipIntersection,O.displacementMap=z.displacementMap,O.displacementScale=z.displacementScale,O.displacementBias=z.displacementBias,O.wireframeLinewidth=z.wireframeLinewidth,O.linewidth=z.linewidth,F.isPointLight===!0&&O.isMeshDistanceMaterial===!0){const j=o.properties.get(O);j.light=F}return O}function A(P,z,F,b,O){if(P.visible===!1)return;if(P.layers.test(z.layers)&&(P.isMesh||P.isLine||P.isPoints)&&(P.castShadow||P.receiveShadow&&O===za)&&(!P.frustumCulled||a.intersectsObject(P))){P.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,P.matrixWorld);const tt=t.update(P),ct=P.material;if(Array.isArray(ct)){const rt=tt.groups;for(let B=0,k=rt.length;B<k;B++){const X=rt[B],ft=ct[X.materialIndex];if(ft&&ft.visible){const N=U(P,ft,b,O);P.onBeforeShadow(o,P,z,F,tt,N,X),o.renderBufferDirect(F,null,tt,N,P,X),P.onAfterShadow(o,P,z,F,tt,N,X)}}}else if(ct.visible){const rt=U(P,ct,b,O);P.onBeforeShadow(o,P,z,F,tt,rt,null),o.renderBufferDirect(F,null,tt,rt,P,null),P.onAfterShadow(o,P,z,F,tt,rt,null)}}const j=P.children;for(let tt=0,ct=j.length;tt<ct;tt++)A(j[tt],z,F,b,O)}function L(P){P.target.removeEventListener("dispose",L);for(const F in h){const b=h[F],O=P.target.uuid;O in b&&(b[O].dispose(),delete b[O])}}}const cC={[Cp]:Dp,[Up]:Np,[Lp]:Pp,[Co]:Op,[Dp]:Cp,[Np]:Up,[Pp]:Lp,[Op]:Co};function fC(o,t){function e(){let q=!1;const Tt=new rn;let wt=null;const It=new rn(0,0,0,0);return{setMask:function(Mt){wt!==Mt&&!q&&(o.colorMask(Mt,Mt,Mt,Mt),wt=Mt)},setLocked:function(Mt){q=Mt},setClear:function(Mt,xt,Ht,ae,Ce){Ce===!0&&(Mt*=ae,xt*=ae,Ht*=ae),Tt.set(Mt,xt,Ht,ae),It.equals(Tt)===!1&&(o.clearColor(Mt,xt,Ht,ae),It.copy(Tt))},reset:function(){q=!1,wt=null,It.set(-1,0,0,0)}}}function a(){let q=!1,Tt=!1,wt=null,It=null,Mt=null;return{setReversed:function(xt){if(Tt!==xt){const Ht=t.get("EXT_clip_control");xt?Ht.clipControlEXT(Ht.LOWER_LEFT_EXT,Ht.ZERO_TO_ONE_EXT):Ht.clipControlEXT(Ht.LOWER_LEFT_EXT,Ht.NEGATIVE_ONE_TO_ONE_EXT),Tt=xt;const ae=Mt;Mt=null,this.setClear(ae)}},getReversed:function(){return Tt},setTest:function(xt){xt?vt(o.DEPTH_TEST):At(o.DEPTH_TEST)},setMask:function(xt){wt!==xt&&!q&&(o.depthMask(xt),wt=xt)},setFunc:function(xt){if(Tt&&(xt=cC[xt]),It!==xt){switch(xt){case Cp:o.depthFunc(o.NEVER);break;case Dp:o.depthFunc(o.ALWAYS);break;case Up:o.depthFunc(o.LESS);break;case Co:o.depthFunc(o.LEQUAL);break;case Lp:o.depthFunc(o.EQUAL);break;case Op:o.depthFunc(o.GEQUAL);break;case Np:o.depthFunc(o.GREATER);break;case Pp:o.depthFunc(o.NOTEQUAL);break;default:o.depthFunc(o.LEQUAL)}It=xt}},setLocked:function(xt){q=xt},setClear:function(xt){Mt!==xt&&(Tt&&(xt=1-xt),o.clearDepth(xt),Mt=xt)},reset:function(){q=!1,wt=null,It=null,Mt=null,Tt=!1}}}function r(){let q=!1,Tt=null,wt=null,It=null,Mt=null,xt=null,Ht=null,ae=null,Ce=null;return{setTest:function(be){q||(be?vt(o.STENCIL_TEST):At(o.STENCIL_TEST))},setMask:function(be){Tt!==be&&!q&&(o.stencilMask(be),Tt=be)},setFunc:function(be,Gi,gn){(wt!==be||It!==Gi||Mt!==gn)&&(o.stencilFunc(be,Gi,gn),wt=be,It=Gi,Mt=gn)},setOp:function(be,Gi,gn){(xt!==be||Ht!==Gi||ae!==gn)&&(o.stencilOp(be,Gi,gn),xt=be,Ht=Gi,ae=gn)},setLocked:function(be){q=be},setClear:function(be){Ce!==be&&(o.clearStencil(be),Ce=be)},reset:function(){q=!1,Tt=null,wt=null,It=null,Mt=null,xt=null,Ht=null,ae=null,Ce=null}}}const l=new e,c=new a,f=new r,p=new WeakMap,h=new WeakMap;let m={},g={},v=new WeakMap,x=[],E=null,M=!1,S=null,y=null,D=null,U=null,A=null,L=null,P=null,z=new ce(0,0,0),F=0,b=!1,O=null,V=null,j=null,tt=null,ct=null;const rt=o.getParameter(o.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let B=!1,k=0;const X=o.getParameter(o.VERSION);X.indexOf("WebGL")!==-1?(k=parseFloat(/^WebGL (\d)/.exec(X)[1]),B=k>=1):X.indexOf("OpenGL ES")!==-1&&(k=parseFloat(/^OpenGL ES (\d)/.exec(X)[1]),B=k>=2);let ft=null,N={};const Q=o.getParameter(o.SCISSOR_BOX),mt=o.getParameter(o.VIEWPORT),yt=new rn().fromArray(Q),bt=new rn().fromArray(mt);function Nt(q,Tt,wt,It){const Mt=new Uint8Array(4),xt=o.createTexture();o.bindTexture(q,xt),o.texParameteri(q,o.TEXTURE_MIN_FILTER,o.NEAREST),o.texParameteri(q,o.TEXTURE_MAG_FILTER,o.NEAREST);for(let Ht=0;Ht<wt;Ht++)q===o.TEXTURE_3D||q===o.TEXTURE_2D_ARRAY?o.texImage3D(Tt,0,o.RGBA,1,1,It,0,o.RGBA,o.UNSIGNED_BYTE,Mt):o.texImage2D(Tt+Ht,0,o.RGBA,1,1,0,o.RGBA,o.UNSIGNED_BYTE,Mt);return xt}const nt={};nt[o.TEXTURE_2D]=Nt(o.TEXTURE_2D,o.TEXTURE_2D,1),nt[o.TEXTURE_CUBE_MAP]=Nt(o.TEXTURE_CUBE_MAP,o.TEXTURE_CUBE_MAP_POSITIVE_X,6),nt[o.TEXTURE_2D_ARRAY]=Nt(o.TEXTURE_2D_ARRAY,o.TEXTURE_2D_ARRAY,1,1),nt[o.TEXTURE_3D]=Nt(o.TEXTURE_3D,o.TEXTURE_3D,1,1),l.setClear(0,0,0,1),c.setClear(1),f.setClear(0),vt(o.DEPTH_TEST),c.setFunc(Co),ne(!1),Pt(Wv),vt(o.CULL_FACE),Le(Ar);function vt(q){m[q]!==!0&&(o.enable(q),m[q]=!0)}function At(q){m[q]!==!1&&(o.disable(q),m[q]=!1)}function Kt(q,Tt){return g[q]!==Tt?(o.bindFramebuffer(q,Tt),g[q]=Tt,q===o.DRAW_FRAMEBUFFER&&(g[o.FRAMEBUFFER]=Tt),q===o.FRAMEBUFFER&&(g[o.DRAW_FRAMEBUFFER]=Tt),!0):!1}function Wt(q,Tt){let wt=x,It=!1;if(q){wt=v.get(Tt),wt===void 0&&(wt=[],v.set(Tt,wt));const Mt=q.textures;if(wt.length!==Mt.length||wt[0]!==o.COLOR_ATTACHMENT0){for(let xt=0,Ht=Mt.length;xt<Ht;xt++)wt[xt]=o.COLOR_ATTACHMENT0+xt;wt.length=Mt.length,It=!0}}else wt[0]!==o.BACK&&(wt[0]=o.BACK,It=!0);It&&o.drawBuffers(wt)}function pe(q){return E!==q?(o.useProgram(q),E=q,!0):!1}const cn={[os]:o.FUNC_ADD,[fT]:o.FUNC_SUBTRACT,[hT]:o.FUNC_REVERSE_SUBTRACT};cn[dT]=o.MIN,cn[pT]=o.MAX;const G={[mT]:o.ZERO,[_T]:o.ONE,[gT]:o.SRC_COLOR,[Rp]:o.SRC_ALPHA,[ET]:o.SRC_ALPHA_SATURATE,[ST]:o.DST_COLOR,[xT]:o.DST_ALPHA,[vT]:o.ONE_MINUS_SRC_COLOR,[wp]:o.ONE_MINUS_SRC_ALPHA,[MT]:o.ONE_MINUS_DST_COLOR,[yT]:o.ONE_MINUS_DST_ALPHA,[TT]:o.CONSTANT_COLOR,[bT]:o.ONE_MINUS_CONSTANT_COLOR,[AT]:o.CONSTANT_ALPHA,[RT]:o.ONE_MINUS_CONSTANT_ALPHA};function Le(q,Tt,wt,It,Mt,xt,Ht,ae,Ce,be){if(q===Ar){M===!0&&(At(o.BLEND),M=!1);return}if(M===!1&&(vt(o.BLEND),M=!0),q!==cT){if(q!==S||be!==b){if((y!==os||A!==os)&&(o.blendEquation(o.FUNC_ADD),y=os,A=os),be)switch(q){case To:o.blendFuncSeparate(o.ONE,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case hf:o.blendFunc(o.ONE,o.ONE);break;case qv:o.blendFuncSeparate(o.ZERO,o.ONE_MINUS_SRC_COLOR,o.ZERO,o.ONE);break;case Yv:o.blendFuncSeparate(o.DST_COLOR,o.ONE_MINUS_SRC_ALPHA,o.ZERO,o.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",q);break}else switch(q){case To:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case hf:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE,o.ONE,o.ONE);break;case qv:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Yv:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",q);break}D=null,U=null,L=null,P=null,z.set(0,0,0),F=0,S=q,b=be}return}Mt=Mt||Tt,xt=xt||wt,Ht=Ht||It,(Tt!==y||Mt!==A)&&(o.blendEquationSeparate(cn[Tt],cn[Mt]),y=Tt,A=Mt),(wt!==D||It!==U||xt!==L||Ht!==P)&&(o.blendFuncSeparate(G[wt],G[It],G[xt],G[Ht]),D=wt,U=It,L=xt,P=Ht),(ae.equals(z)===!1||Ce!==F)&&(o.blendColor(ae.r,ae.g,ae.b,Ce),z.copy(ae),F=Ce),S=q,b=!1}function re(q,Tt){q.side===Fa?At(o.CULL_FACE):vt(o.CULL_FACE);let wt=q.side===ii;Tt&&(wt=!wt),ne(wt),q.blending===To&&q.transparent===!1?Le(Ar):Le(q.blending,q.blendEquation,q.blendSrc,q.blendDst,q.blendEquationAlpha,q.blendSrcAlpha,q.blendDstAlpha,q.blendColor,q.blendAlpha,q.premultipliedAlpha),c.setFunc(q.depthFunc),c.setTest(q.depthTest),c.setMask(q.depthWrite),l.setMask(q.colorWrite);const It=q.stencilWrite;f.setTest(It),It&&(f.setMask(q.stencilWriteMask),f.setFunc(q.stencilFunc,q.stencilRef,q.stencilFuncMask),f.setOp(q.stencilFail,q.stencilZFail,q.stencilZPass)),Gt(q.polygonOffset,q.polygonOffsetFactor,q.polygonOffsetUnits),q.alphaToCoverage===!0?vt(o.SAMPLE_ALPHA_TO_COVERAGE):At(o.SAMPLE_ALPHA_TO_COVERAGE)}function ne(q){O!==q&&(q?o.frontFace(o.CW):o.frontFace(o.CCW),O=q)}function Pt(q){q!==oT?(vt(o.CULL_FACE),q!==V&&(q===Wv?o.cullFace(o.BACK):q===lT?o.cullFace(o.FRONT):o.cullFace(o.FRONT_AND_BACK))):At(o.CULL_FACE),V=q}function Ve(q){q!==j&&(B&&o.lineWidth(q),j=q)}function Gt(q,Tt,wt){q?(vt(o.POLYGON_OFFSET_FILL),(tt!==Tt||ct!==wt)&&(o.polygonOffset(Tt,wt),tt=Tt,ct=wt)):At(o.POLYGON_OFFSET_FILL)}function se(q){q?vt(o.SCISSOR_TEST):At(o.SCISSOR_TEST)}function je(q){q===void 0&&(q=o.TEXTURE0+rt-1),ft!==q&&(o.activeTexture(q),ft=q)}function Ze(q,Tt,wt){wt===void 0&&(ft===null?wt=o.TEXTURE0+rt-1:wt=ft);let It=N[wt];It===void 0&&(It={type:void 0,texture:void 0},N[wt]=It),(It.type!==q||It.texture!==Tt)&&(ft!==wt&&(o.activeTexture(wt),ft=wt),o.bindTexture(q,Tt||nt[q]),It.type=q,It.texture=Tt)}function I(){const q=N[ft];q!==void 0&&q.type!==void 0&&(o.bindTexture(q.type,null),q.type=void 0,q.texture=void 0)}function R(){try{o.compressedTexImage2D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function et(){try{o.compressedTexImage3D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function ht(){try{o.texSubImage2D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function _t(){try{o.texSubImage3D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function ut(){try{o.compressedTexSubImage2D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function zt(){try{o.compressedTexSubImage3D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function Rt(){try{o.texStorage2D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function kt(){try{o.texStorage3D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function qt(){try{o.texImage2D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function St(){try{o.texImage3D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function Ut(q){yt.equals(q)===!1&&(o.scissor(q.x,q.y,q.z,q.w),yt.copy(q))}function jt(q){bt.equals(q)===!1&&(o.viewport(q.x,q.y,q.z,q.w),bt.copy(q))}function Vt(q,Tt){let wt=h.get(Tt);wt===void 0&&(wt=new WeakMap,h.set(Tt,wt));let It=wt.get(q);It===void 0&&(It=o.getUniformBlockIndex(Tt,q.name),wt.set(q,It))}function Ct(q,Tt){const It=h.get(Tt).get(q);p.get(Tt)!==It&&(o.uniformBlockBinding(Tt,It,q.__bindingPointIndex),p.set(Tt,It))}function oe(){o.disable(o.BLEND),o.disable(o.CULL_FACE),o.disable(o.DEPTH_TEST),o.disable(o.POLYGON_OFFSET_FILL),o.disable(o.SCISSOR_TEST),o.disable(o.STENCIL_TEST),o.disable(o.SAMPLE_ALPHA_TO_COVERAGE),o.blendEquation(o.FUNC_ADD),o.blendFunc(o.ONE,o.ZERO),o.blendFuncSeparate(o.ONE,o.ZERO,o.ONE,o.ZERO),o.blendColor(0,0,0,0),o.colorMask(!0,!0,!0,!0),o.clearColor(0,0,0,0),o.depthMask(!0),o.depthFunc(o.LESS),c.setReversed(!1),o.clearDepth(1),o.stencilMask(4294967295),o.stencilFunc(o.ALWAYS,0,4294967295),o.stencilOp(o.KEEP,o.KEEP,o.KEEP),o.clearStencil(0),o.cullFace(o.BACK),o.frontFace(o.CCW),o.polygonOffset(0,0),o.activeTexture(o.TEXTURE0),o.bindFramebuffer(o.FRAMEBUFFER,null),o.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),o.bindFramebuffer(o.READ_FRAMEBUFFER,null),o.useProgram(null),o.lineWidth(1),o.scissor(0,0,o.canvas.width,o.canvas.height),o.viewport(0,0,o.canvas.width,o.canvas.height),m={},ft=null,N={},g={},v=new WeakMap,x=[],E=null,M=!1,S=null,y=null,D=null,U=null,A=null,L=null,P=null,z=new ce(0,0,0),F=0,b=!1,O=null,V=null,j=null,tt=null,ct=null,yt.set(0,0,o.canvas.width,o.canvas.height),bt.set(0,0,o.canvas.width,o.canvas.height),l.reset(),c.reset(),f.reset()}return{buffers:{color:l,depth:c,stencil:f},enable:vt,disable:At,bindFramebuffer:Kt,drawBuffers:Wt,useProgram:pe,setBlending:Le,setMaterial:re,setFlipSided:ne,setCullFace:Pt,setLineWidth:Ve,setPolygonOffset:Gt,setScissorTest:se,activeTexture:je,bindTexture:Ze,unbindTexture:I,compressedTexImage2D:R,compressedTexImage3D:et,texImage2D:qt,texImage3D:St,updateUBOMapping:Vt,uniformBlockBinding:Ct,texStorage2D:Rt,texStorage3D:kt,texSubImage2D:ht,texSubImage3D:_t,compressedTexSubImage2D:ut,compressedTexSubImage3D:zt,scissor:Ut,viewport:jt,reset:oe}}function hC(o,t,e,a,r,l,c){const f=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,p=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),h=new Te,m=new WeakMap;let g;const v=new WeakMap;let x=!1;try{x=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function E(I,R){return x?new OffscreenCanvas(I,R):au("canvas")}function M(I,R,et){let ht=1;const _t=Ze(I);if((_t.width>et||_t.height>et)&&(ht=et/Math.max(_t.width,_t.height)),ht<1)if(typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&I instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&I instanceof ImageBitmap||typeof VideoFrame<"u"&&I instanceof VideoFrame){const ut=Math.floor(ht*_t.width),zt=Math.floor(ht*_t.height);g===void 0&&(g=E(ut,zt));const Rt=R?E(ut,zt):g;return Rt.width=ut,Rt.height=zt,Rt.getContext("2d").drawImage(I,0,0,ut,zt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+_t.width+"x"+_t.height+") to ("+ut+"x"+zt+")."),Rt}else return"data"in I&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+_t.width+"x"+_t.height+")."),I;return I}function S(I){return I.generateMipmaps}function y(I){o.generateMipmap(I)}function D(I){return I.isWebGLCubeRenderTarget?o.TEXTURE_CUBE_MAP:I.isWebGL3DRenderTarget?o.TEXTURE_3D:I.isWebGLArrayRenderTarget||I.isCompressedArrayTexture?o.TEXTURE_2D_ARRAY:o.TEXTURE_2D}function U(I,R,et,ht,_t=!1){if(I!==null){if(o[I]!==void 0)return o[I];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+I+"'")}let ut=R;if(R===o.RED&&(et===o.FLOAT&&(ut=o.R32F),et===o.HALF_FLOAT&&(ut=o.R16F),et===o.UNSIGNED_BYTE&&(ut=o.R8)),R===o.RED_INTEGER&&(et===o.UNSIGNED_BYTE&&(ut=o.R8UI),et===o.UNSIGNED_SHORT&&(ut=o.R16UI),et===o.UNSIGNED_INT&&(ut=o.R32UI),et===o.BYTE&&(ut=o.R8I),et===o.SHORT&&(ut=o.R16I),et===o.INT&&(ut=o.R32I)),R===o.RG&&(et===o.FLOAT&&(ut=o.RG32F),et===o.HALF_FLOAT&&(ut=o.RG16F),et===o.UNSIGNED_BYTE&&(ut=o.RG8)),R===o.RG_INTEGER&&(et===o.UNSIGNED_BYTE&&(ut=o.RG8UI),et===o.UNSIGNED_SHORT&&(ut=o.RG16UI),et===o.UNSIGNED_INT&&(ut=o.RG32UI),et===o.BYTE&&(ut=o.RG8I),et===o.SHORT&&(ut=o.RG16I),et===o.INT&&(ut=o.RG32I)),R===o.RGB_INTEGER&&(et===o.UNSIGNED_BYTE&&(ut=o.RGB8UI),et===o.UNSIGNED_SHORT&&(ut=o.RGB16UI),et===o.UNSIGNED_INT&&(ut=o.RGB32UI),et===o.BYTE&&(ut=o.RGB8I),et===o.SHORT&&(ut=o.RGB16I),et===o.INT&&(ut=o.RGB32I)),R===o.RGBA_INTEGER&&(et===o.UNSIGNED_BYTE&&(ut=o.RGBA8UI),et===o.UNSIGNED_SHORT&&(ut=o.RGBA16UI),et===o.UNSIGNED_INT&&(ut=o.RGBA32UI),et===o.BYTE&&(ut=o.RGBA8I),et===o.SHORT&&(ut=o.RGBA16I),et===o.INT&&(ut=o.RGBA32I)),R===o.RGB&&(et===o.UNSIGNED_INT_5_9_9_9_REV&&(ut=o.RGB9_E5),et===o.UNSIGNED_INT_10F_11F_11F_REV&&(ut=o.R11F_G11F_B10F)),R===o.RGBA){const zt=_t?pf:ye.getTransfer(ht);et===o.FLOAT&&(ut=o.RGBA32F),et===o.HALF_FLOAT&&(ut=o.RGBA16F),et===o.UNSIGNED_BYTE&&(ut=zt===Ie?o.SRGB8_ALPHA8:o.RGBA8),et===o.UNSIGNED_SHORT_4_4_4_4&&(ut=o.RGBA4),et===o.UNSIGNED_SHORT_5_5_5_1&&(ut=o.RGB5_A1)}return(ut===o.R16F||ut===o.R32F||ut===o.RG16F||ut===o.RG32F||ut===o.RGBA16F||ut===o.RGBA32F)&&t.get("EXT_color_buffer_float"),ut}function A(I,R){let et;return I?R===null||R===_s||R===eu?et=o.DEPTH24_STENCIL8:R===Ha?et=o.DEPTH32F_STENCIL8:R===tu&&(et=o.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):R===null||R===_s||R===eu?et=o.DEPTH_COMPONENT24:R===Ha?et=o.DEPTH_COMPONENT32F:R===tu&&(et=o.DEPTH_COMPONENT16),et}function L(I,R){return S(I)===!0||I.isFramebufferTexture&&I.minFilter!==Qi&&I.minFilter!==ua?Math.log2(Math.max(R.width,R.height))+1:I.mipmaps!==void 0&&I.mipmaps.length>0?I.mipmaps.length:I.isCompressedTexture&&Array.isArray(I.image)?R.mipmaps.length:1}function P(I){const R=I.target;R.removeEventListener("dispose",P),F(R),R.isVideoTexture&&m.delete(R)}function z(I){const R=I.target;R.removeEventListener("dispose",z),O(R)}function F(I){const R=a.get(I);if(R.__webglInit===void 0)return;const et=I.source,ht=v.get(et);if(ht){const _t=ht[R.__cacheKey];_t.usedTimes--,_t.usedTimes===0&&b(I),Object.keys(ht).length===0&&v.delete(et)}a.remove(I)}function b(I){const R=a.get(I);o.deleteTexture(R.__webglTexture);const et=I.source,ht=v.get(et);delete ht[R.__cacheKey],c.memory.textures--}function O(I){const R=a.get(I);if(I.depthTexture&&(I.depthTexture.dispose(),a.remove(I.depthTexture)),I.isWebGLCubeRenderTarget)for(let ht=0;ht<6;ht++){if(Array.isArray(R.__webglFramebuffer[ht]))for(let _t=0;_t<R.__webglFramebuffer[ht].length;_t++)o.deleteFramebuffer(R.__webglFramebuffer[ht][_t]);else o.deleteFramebuffer(R.__webglFramebuffer[ht]);R.__webglDepthbuffer&&o.deleteRenderbuffer(R.__webglDepthbuffer[ht])}else{if(Array.isArray(R.__webglFramebuffer))for(let ht=0;ht<R.__webglFramebuffer.length;ht++)o.deleteFramebuffer(R.__webglFramebuffer[ht]);else o.deleteFramebuffer(R.__webglFramebuffer);if(R.__webglDepthbuffer&&o.deleteRenderbuffer(R.__webglDepthbuffer),R.__webglMultisampledFramebuffer&&o.deleteFramebuffer(R.__webglMultisampledFramebuffer),R.__webglColorRenderbuffer)for(let ht=0;ht<R.__webglColorRenderbuffer.length;ht++)R.__webglColorRenderbuffer[ht]&&o.deleteRenderbuffer(R.__webglColorRenderbuffer[ht]);R.__webglDepthRenderbuffer&&o.deleteRenderbuffer(R.__webglDepthRenderbuffer)}const et=I.textures;for(let ht=0,_t=et.length;ht<_t;ht++){const ut=a.get(et[ht]);ut.__webglTexture&&(o.deleteTexture(ut.__webglTexture),c.memory.textures--),a.remove(et[ht])}a.remove(I)}let V=0;function j(){V=0}function tt(){const I=V;return I>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+I+" texture units while this GPU supports only "+r.maxTextures),V+=1,I}function ct(I){const R=[];return R.push(I.wrapS),R.push(I.wrapT),R.push(I.wrapR||0),R.push(I.magFilter),R.push(I.minFilter),R.push(I.anisotropy),R.push(I.internalFormat),R.push(I.format),R.push(I.type),R.push(I.generateMipmaps),R.push(I.premultiplyAlpha),R.push(I.flipY),R.push(I.unpackAlignment),R.push(I.colorSpace),R.join()}function rt(I,R){const et=a.get(I);if(I.isVideoTexture&&se(I),I.isRenderTargetTexture===!1&&I.isExternalTexture!==!0&&I.version>0&&et.__version!==I.version){const ht=I.image;if(ht===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ht.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{nt(et,I,R);return}}else I.isExternalTexture&&(et.__webglTexture=I.sourceTexture?I.sourceTexture:null);e.bindTexture(o.TEXTURE_2D,et.__webglTexture,o.TEXTURE0+R)}function B(I,R){const et=a.get(I);if(I.isRenderTargetTexture===!1&&I.version>0&&et.__version!==I.version){nt(et,I,R);return}e.bindTexture(o.TEXTURE_2D_ARRAY,et.__webglTexture,o.TEXTURE0+R)}function k(I,R){const et=a.get(I);if(I.isRenderTargetTexture===!1&&I.version>0&&et.__version!==I.version){nt(et,I,R);return}e.bindTexture(o.TEXTURE_3D,et.__webglTexture,o.TEXTURE0+R)}function X(I,R){const et=a.get(I);if(I.version>0&&et.__version!==I.version){vt(et,I,R);return}e.bindTexture(o.TEXTURE_CUBE_MAP,et.__webglTexture,o.TEXTURE0+R)}const ft={[df]:o.REPEAT,[us]:o.CLAMP_TO_EDGE,[Bp]:o.MIRRORED_REPEAT},N={[Qi]:o.NEAREST,[IT]:o.NEAREST_MIPMAP_NEAREST,[wc]:o.NEAREST_MIPMAP_LINEAR,[ua]:o.LINEAR,[Bd]:o.LINEAR_MIPMAP_NEAREST,[cs]:o.LINEAR_MIPMAP_LINEAR},Q={[GT]:o.NEVER,[YT]:o.ALWAYS,[VT]:o.LESS,[Ay]:o.LEQUAL,[kT]:o.EQUAL,[qT]:o.GEQUAL,[XT]:o.GREATER,[WT]:o.NOTEQUAL};function mt(I,R){if(R.type===Ha&&t.has("OES_texture_float_linear")===!1&&(R.magFilter===ua||R.magFilter===Bd||R.magFilter===wc||R.magFilter===cs||R.minFilter===ua||R.minFilter===Bd||R.minFilter===wc||R.minFilter===cs)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),o.texParameteri(I,o.TEXTURE_WRAP_S,ft[R.wrapS]),o.texParameteri(I,o.TEXTURE_WRAP_T,ft[R.wrapT]),(I===o.TEXTURE_3D||I===o.TEXTURE_2D_ARRAY)&&o.texParameteri(I,o.TEXTURE_WRAP_R,ft[R.wrapR]),o.texParameteri(I,o.TEXTURE_MAG_FILTER,N[R.magFilter]),o.texParameteri(I,o.TEXTURE_MIN_FILTER,N[R.minFilter]),R.compareFunction&&(o.texParameteri(I,o.TEXTURE_COMPARE_MODE,o.COMPARE_REF_TO_TEXTURE),o.texParameteri(I,o.TEXTURE_COMPARE_FUNC,Q[R.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(R.magFilter===Qi||R.minFilter!==wc&&R.minFilter!==cs||R.type===Ha&&t.has("OES_texture_float_linear")===!1)return;if(R.anisotropy>1||a.get(R).__currentAnisotropy){const et=t.get("EXT_texture_filter_anisotropic");o.texParameterf(I,et.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(R.anisotropy,r.getMaxAnisotropy())),a.get(R).__currentAnisotropy=R.anisotropy}}}function yt(I,R){let et=!1;I.__webglInit===void 0&&(I.__webglInit=!0,R.addEventListener("dispose",P));const ht=R.source;let _t=v.get(ht);_t===void 0&&(_t={},v.set(ht,_t));const ut=ct(R);if(ut!==I.__cacheKey){_t[ut]===void 0&&(_t[ut]={texture:o.createTexture(),usedTimes:0},c.memory.textures++,et=!0),_t[ut].usedTimes++;const zt=_t[I.__cacheKey];zt!==void 0&&(_t[I.__cacheKey].usedTimes--,zt.usedTimes===0&&b(R)),I.__cacheKey=ut,I.__webglTexture=_t[ut].texture}return et}function bt(I,R,et){return Math.floor(Math.floor(I/et)/R)}function Nt(I,R,et,ht){const ut=I.updateRanges;if(ut.length===0)e.texSubImage2D(o.TEXTURE_2D,0,0,0,R.width,R.height,et,ht,R.data);else{ut.sort((St,Ut)=>St.start-Ut.start);let zt=0;for(let St=1;St<ut.length;St++){const Ut=ut[zt],jt=ut[St],Vt=Ut.start+Ut.count,Ct=bt(jt.start,R.width,4),oe=bt(Ut.start,R.width,4);jt.start<=Vt+1&&Ct===oe&&bt(jt.start+jt.count-1,R.width,4)===Ct?Ut.count=Math.max(Ut.count,jt.start+jt.count-Ut.start):(++zt,ut[zt]=jt)}ut.length=zt+1;const Rt=o.getParameter(o.UNPACK_ROW_LENGTH),kt=o.getParameter(o.UNPACK_SKIP_PIXELS),qt=o.getParameter(o.UNPACK_SKIP_ROWS);o.pixelStorei(o.UNPACK_ROW_LENGTH,R.width);for(let St=0,Ut=ut.length;St<Ut;St++){const jt=ut[St],Vt=Math.floor(jt.start/4),Ct=Math.ceil(jt.count/4),oe=Vt%R.width,q=Math.floor(Vt/R.width),Tt=Ct,wt=1;o.pixelStorei(o.UNPACK_SKIP_PIXELS,oe),o.pixelStorei(o.UNPACK_SKIP_ROWS,q),e.texSubImage2D(o.TEXTURE_2D,0,oe,q,Tt,wt,et,ht,R.data)}I.clearUpdateRanges(),o.pixelStorei(o.UNPACK_ROW_LENGTH,Rt),o.pixelStorei(o.UNPACK_SKIP_PIXELS,kt),o.pixelStorei(o.UNPACK_SKIP_ROWS,qt)}}function nt(I,R,et){let ht=o.TEXTURE_2D;(R.isDataArrayTexture||R.isCompressedArrayTexture)&&(ht=o.TEXTURE_2D_ARRAY),R.isData3DTexture&&(ht=o.TEXTURE_3D);const _t=yt(I,R),ut=R.source;e.bindTexture(ht,I.__webglTexture,o.TEXTURE0+et);const zt=a.get(ut);if(ut.version!==zt.__version||_t===!0){e.activeTexture(o.TEXTURE0+et);const Rt=ye.getPrimaries(ye.workingColorSpace),kt=R.colorSpace===Mr?null:ye.getPrimaries(R.colorSpace),qt=R.colorSpace===Mr||Rt===kt?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,R.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,R.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,R.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,qt);let St=M(R.image,!1,r.maxTextureSize);St=je(R,St);const Ut=l.convert(R.format,R.colorSpace),jt=l.convert(R.type);let Vt=U(R.internalFormat,Ut,jt,R.colorSpace,R.isVideoTexture);mt(ht,R);let Ct;const oe=R.mipmaps,q=R.isVideoTexture!==!0,Tt=zt.__version===void 0||_t===!0,wt=ut.dataReady,It=L(R,St);if(R.isDepthTexture)Vt=A(R.format===iu,R.type),Tt&&(q?e.texStorage2D(o.TEXTURE_2D,1,Vt,St.width,St.height):e.texImage2D(o.TEXTURE_2D,0,Vt,St.width,St.height,0,Ut,jt,null));else if(R.isDataTexture)if(oe.length>0){q&&Tt&&e.texStorage2D(o.TEXTURE_2D,It,Vt,oe[0].width,oe[0].height);for(let Mt=0,xt=oe.length;Mt<xt;Mt++)Ct=oe[Mt],q?wt&&e.texSubImage2D(o.TEXTURE_2D,Mt,0,0,Ct.width,Ct.height,Ut,jt,Ct.data):e.texImage2D(o.TEXTURE_2D,Mt,Vt,Ct.width,Ct.height,0,Ut,jt,Ct.data);R.generateMipmaps=!1}else q?(Tt&&e.texStorage2D(o.TEXTURE_2D,It,Vt,St.width,St.height),wt&&Nt(R,St,Ut,jt)):e.texImage2D(o.TEXTURE_2D,0,Vt,St.width,St.height,0,Ut,jt,St.data);else if(R.isCompressedTexture)if(R.isCompressedArrayTexture){q&&Tt&&e.texStorage3D(o.TEXTURE_2D_ARRAY,It,Vt,oe[0].width,oe[0].height,St.depth);for(let Mt=0,xt=oe.length;Mt<xt;Mt++)if(Ct=oe[Mt],R.format!==Ki)if(Ut!==null)if(q){if(wt)if(R.layerUpdates.size>0){const Ht=Ex(Ct.width,Ct.height,R.format,R.type);for(const ae of R.layerUpdates){const Ce=Ct.data.subarray(ae*Ht/Ct.data.BYTES_PER_ELEMENT,(ae+1)*Ht/Ct.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,Mt,0,0,ae,Ct.width,Ct.height,1,Ut,Ce)}R.clearLayerUpdates()}else e.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,Mt,0,0,0,Ct.width,Ct.height,St.depth,Ut,Ct.data)}else e.compressedTexImage3D(o.TEXTURE_2D_ARRAY,Mt,Vt,Ct.width,Ct.height,St.depth,0,Ct.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else q?wt&&e.texSubImage3D(o.TEXTURE_2D_ARRAY,Mt,0,0,0,Ct.width,Ct.height,St.depth,Ut,jt,Ct.data):e.texImage3D(o.TEXTURE_2D_ARRAY,Mt,Vt,Ct.width,Ct.height,St.depth,0,Ut,jt,Ct.data)}else{q&&Tt&&e.texStorage2D(o.TEXTURE_2D,It,Vt,oe[0].width,oe[0].height);for(let Mt=0,xt=oe.length;Mt<xt;Mt++)Ct=oe[Mt],R.format!==Ki?Ut!==null?q?wt&&e.compressedTexSubImage2D(o.TEXTURE_2D,Mt,0,0,Ct.width,Ct.height,Ut,Ct.data):e.compressedTexImage2D(o.TEXTURE_2D,Mt,Vt,Ct.width,Ct.height,0,Ct.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):q?wt&&e.texSubImage2D(o.TEXTURE_2D,Mt,0,0,Ct.width,Ct.height,Ut,jt,Ct.data):e.texImage2D(o.TEXTURE_2D,Mt,Vt,Ct.width,Ct.height,0,Ut,jt,Ct.data)}else if(R.isDataArrayTexture)if(q){if(Tt&&e.texStorage3D(o.TEXTURE_2D_ARRAY,It,Vt,St.width,St.height,St.depth),wt)if(R.layerUpdates.size>0){const Mt=Ex(St.width,St.height,R.format,R.type);for(const xt of R.layerUpdates){const Ht=St.data.subarray(xt*Mt/St.data.BYTES_PER_ELEMENT,(xt+1)*Mt/St.data.BYTES_PER_ELEMENT);e.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,xt,St.width,St.height,1,Ut,jt,Ht)}R.clearLayerUpdates()}else e.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,0,St.width,St.height,St.depth,Ut,jt,St.data)}else e.texImage3D(o.TEXTURE_2D_ARRAY,0,Vt,St.width,St.height,St.depth,0,Ut,jt,St.data);else if(R.isData3DTexture)q?(Tt&&e.texStorage3D(o.TEXTURE_3D,It,Vt,St.width,St.height,St.depth),wt&&e.texSubImage3D(o.TEXTURE_3D,0,0,0,0,St.width,St.height,St.depth,Ut,jt,St.data)):e.texImage3D(o.TEXTURE_3D,0,Vt,St.width,St.height,St.depth,0,Ut,jt,St.data);else if(R.isFramebufferTexture){if(Tt)if(q)e.texStorage2D(o.TEXTURE_2D,It,Vt,St.width,St.height);else{let Mt=St.width,xt=St.height;for(let Ht=0;Ht<It;Ht++)e.texImage2D(o.TEXTURE_2D,Ht,Vt,Mt,xt,0,Ut,jt,null),Mt>>=1,xt>>=1}}else if(oe.length>0){if(q&&Tt){const Mt=Ze(oe[0]);e.texStorage2D(o.TEXTURE_2D,It,Vt,Mt.width,Mt.height)}for(let Mt=0,xt=oe.length;Mt<xt;Mt++)Ct=oe[Mt],q?wt&&e.texSubImage2D(o.TEXTURE_2D,Mt,0,0,Ut,jt,Ct):e.texImage2D(o.TEXTURE_2D,Mt,Vt,Ut,jt,Ct);R.generateMipmaps=!1}else if(q){if(Tt){const Mt=Ze(St);e.texStorage2D(o.TEXTURE_2D,It,Vt,Mt.width,Mt.height)}wt&&e.texSubImage2D(o.TEXTURE_2D,0,0,0,Ut,jt,St)}else e.texImage2D(o.TEXTURE_2D,0,Vt,Ut,jt,St);S(R)&&y(ht),zt.__version=ut.version,R.onUpdate&&R.onUpdate(R)}I.__version=R.version}function vt(I,R,et){if(R.image.length!==6)return;const ht=yt(I,R),_t=R.source;e.bindTexture(o.TEXTURE_CUBE_MAP,I.__webglTexture,o.TEXTURE0+et);const ut=a.get(_t);if(_t.version!==ut.__version||ht===!0){e.activeTexture(o.TEXTURE0+et);const zt=ye.getPrimaries(ye.workingColorSpace),Rt=R.colorSpace===Mr?null:ye.getPrimaries(R.colorSpace),kt=R.colorSpace===Mr||zt===Rt?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,R.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,R.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,R.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,kt);const qt=R.isCompressedTexture||R.image[0].isCompressedTexture,St=R.image[0]&&R.image[0].isDataTexture,Ut=[];for(let xt=0;xt<6;xt++)!qt&&!St?Ut[xt]=M(R.image[xt],!0,r.maxCubemapSize):Ut[xt]=St?R.image[xt].image:R.image[xt],Ut[xt]=je(R,Ut[xt]);const jt=Ut[0],Vt=l.convert(R.format,R.colorSpace),Ct=l.convert(R.type),oe=U(R.internalFormat,Vt,Ct,R.colorSpace),q=R.isVideoTexture!==!0,Tt=ut.__version===void 0||ht===!0,wt=_t.dataReady;let It=L(R,jt);mt(o.TEXTURE_CUBE_MAP,R);let Mt;if(qt){q&&Tt&&e.texStorage2D(o.TEXTURE_CUBE_MAP,It,oe,jt.width,jt.height);for(let xt=0;xt<6;xt++){Mt=Ut[xt].mipmaps;for(let Ht=0;Ht<Mt.length;Ht++){const ae=Mt[Ht];R.format!==Ki?Vt!==null?q?wt&&e.compressedTexSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht,0,0,ae.width,ae.height,Vt,ae.data):e.compressedTexImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht,oe,ae.width,ae.height,0,ae.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):q?wt&&e.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht,0,0,ae.width,ae.height,Vt,Ct,ae.data):e.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht,oe,ae.width,ae.height,0,Vt,Ct,ae.data)}}}else{if(Mt=R.mipmaps,q&&Tt){Mt.length>0&&It++;const xt=Ze(Ut[0]);e.texStorage2D(o.TEXTURE_CUBE_MAP,It,oe,xt.width,xt.height)}for(let xt=0;xt<6;xt++)if(St){q?wt&&e.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,0,0,0,Ut[xt].width,Ut[xt].height,Vt,Ct,Ut[xt].data):e.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,0,oe,Ut[xt].width,Ut[xt].height,0,Vt,Ct,Ut[xt].data);for(let Ht=0;Ht<Mt.length;Ht++){const Ce=Mt[Ht].image[xt].image;q?wt&&e.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht+1,0,0,Ce.width,Ce.height,Vt,Ct,Ce.data):e.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht+1,oe,Ce.width,Ce.height,0,Vt,Ct,Ce.data)}}else{q?wt&&e.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,0,0,0,Vt,Ct,Ut[xt]):e.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,0,oe,Vt,Ct,Ut[xt]);for(let Ht=0;Ht<Mt.length;Ht++){const ae=Mt[Ht];q?wt&&e.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht+1,0,0,Vt,Ct,ae.image[xt]):e.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht+1,oe,Vt,Ct,ae.image[xt])}}}S(R)&&y(o.TEXTURE_CUBE_MAP),ut.__version=_t.version,R.onUpdate&&R.onUpdate(R)}I.__version=R.version}function At(I,R,et,ht,_t,ut){const zt=l.convert(et.format,et.colorSpace),Rt=l.convert(et.type),kt=U(et.internalFormat,zt,Rt,et.colorSpace),qt=a.get(R),St=a.get(et);if(St.__renderTarget=R,!qt.__hasExternalTextures){const Ut=Math.max(1,R.width>>ut),jt=Math.max(1,R.height>>ut);_t===o.TEXTURE_3D||_t===o.TEXTURE_2D_ARRAY?e.texImage3D(_t,ut,kt,Ut,jt,R.depth,0,zt,Rt,null):e.texImage2D(_t,ut,kt,Ut,jt,0,zt,Rt,null)}e.bindFramebuffer(o.FRAMEBUFFER,I),Gt(R)?f.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,ht,_t,St.__webglTexture,0,Ve(R)):(_t===o.TEXTURE_2D||_t>=o.TEXTURE_CUBE_MAP_POSITIVE_X&&_t<=o.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&o.framebufferTexture2D(o.FRAMEBUFFER,ht,_t,St.__webglTexture,ut),e.bindFramebuffer(o.FRAMEBUFFER,null)}function Kt(I,R,et){if(o.bindRenderbuffer(o.RENDERBUFFER,I),R.depthBuffer){const ht=R.depthTexture,_t=ht&&ht.isDepthTexture?ht.type:null,ut=A(R.stencilBuffer,_t),zt=R.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,Rt=Ve(R);Gt(R)?f.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,Rt,ut,R.width,R.height):et?o.renderbufferStorageMultisample(o.RENDERBUFFER,Rt,ut,R.width,R.height):o.renderbufferStorage(o.RENDERBUFFER,ut,R.width,R.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,zt,o.RENDERBUFFER,I)}else{const ht=R.textures;for(let _t=0;_t<ht.length;_t++){const ut=ht[_t],zt=l.convert(ut.format,ut.colorSpace),Rt=l.convert(ut.type),kt=U(ut.internalFormat,zt,Rt,ut.colorSpace),qt=Ve(R);et&&Gt(R)===!1?o.renderbufferStorageMultisample(o.RENDERBUFFER,qt,kt,R.width,R.height):Gt(R)?f.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,qt,kt,R.width,R.height):o.renderbufferStorage(o.RENDERBUFFER,kt,R.width,R.height)}}o.bindRenderbuffer(o.RENDERBUFFER,null)}function Wt(I,R){if(R&&R.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(o.FRAMEBUFFER,I),!(R.depthTexture&&R.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const ht=a.get(R.depthTexture);ht.__renderTarget=R,(!ht.__webglTexture||R.depthTexture.image.width!==R.width||R.depthTexture.image.height!==R.height)&&(R.depthTexture.image.width=R.width,R.depthTexture.image.height=R.height,R.depthTexture.needsUpdate=!0),rt(R.depthTexture,0);const _t=ht.__webglTexture,ut=Ve(R);if(R.depthTexture.format===nu)Gt(R)?f.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,_t,0,ut):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,_t,0);else if(R.depthTexture.format===iu)Gt(R)?f.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,_t,0,ut):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,_t,0);else throw new Error("Unknown depthTexture format")}function pe(I){const R=a.get(I),et=I.isWebGLCubeRenderTarget===!0;if(R.__boundDepthTexture!==I.depthTexture){const ht=I.depthTexture;if(R.__depthDisposeCallback&&R.__depthDisposeCallback(),ht){const _t=()=>{delete R.__boundDepthTexture,delete R.__depthDisposeCallback,ht.removeEventListener("dispose",_t)};ht.addEventListener("dispose",_t),R.__depthDisposeCallback=_t}R.__boundDepthTexture=ht}if(I.depthTexture&&!R.__autoAllocateDepthBuffer){if(et)throw new Error("target.depthTexture not supported in Cube render targets");const ht=I.texture.mipmaps;ht&&ht.length>0?Wt(R.__webglFramebuffer[0],I):Wt(R.__webglFramebuffer,I)}else if(et){R.__webglDepthbuffer=[];for(let ht=0;ht<6;ht++)if(e.bindFramebuffer(o.FRAMEBUFFER,R.__webglFramebuffer[ht]),R.__webglDepthbuffer[ht]===void 0)R.__webglDepthbuffer[ht]=o.createRenderbuffer(),Kt(R.__webglDepthbuffer[ht],I,!1);else{const _t=I.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,ut=R.__webglDepthbuffer[ht];o.bindRenderbuffer(o.RENDERBUFFER,ut),o.framebufferRenderbuffer(o.FRAMEBUFFER,_t,o.RENDERBUFFER,ut)}}else{const ht=I.texture.mipmaps;if(ht&&ht.length>0?e.bindFramebuffer(o.FRAMEBUFFER,R.__webglFramebuffer[0]):e.bindFramebuffer(o.FRAMEBUFFER,R.__webglFramebuffer),R.__webglDepthbuffer===void 0)R.__webglDepthbuffer=o.createRenderbuffer(),Kt(R.__webglDepthbuffer,I,!1);else{const _t=I.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,ut=R.__webglDepthbuffer;o.bindRenderbuffer(o.RENDERBUFFER,ut),o.framebufferRenderbuffer(o.FRAMEBUFFER,_t,o.RENDERBUFFER,ut)}}e.bindFramebuffer(o.FRAMEBUFFER,null)}function cn(I,R,et){const ht=a.get(I);R!==void 0&&At(ht.__webglFramebuffer,I,I.texture,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,0),et!==void 0&&pe(I)}function G(I){const R=I.texture,et=a.get(I),ht=a.get(R);I.addEventListener("dispose",z);const _t=I.textures,ut=I.isWebGLCubeRenderTarget===!0,zt=_t.length>1;if(zt||(ht.__webglTexture===void 0&&(ht.__webglTexture=o.createTexture()),ht.__version=R.version,c.memory.textures++),ut){et.__webglFramebuffer=[];for(let Rt=0;Rt<6;Rt++)if(R.mipmaps&&R.mipmaps.length>0){et.__webglFramebuffer[Rt]=[];for(let kt=0;kt<R.mipmaps.length;kt++)et.__webglFramebuffer[Rt][kt]=o.createFramebuffer()}else et.__webglFramebuffer[Rt]=o.createFramebuffer()}else{if(R.mipmaps&&R.mipmaps.length>0){et.__webglFramebuffer=[];for(let Rt=0;Rt<R.mipmaps.length;Rt++)et.__webglFramebuffer[Rt]=o.createFramebuffer()}else et.__webglFramebuffer=o.createFramebuffer();if(zt)for(let Rt=0,kt=_t.length;Rt<kt;Rt++){const qt=a.get(_t[Rt]);qt.__webglTexture===void 0&&(qt.__webglTexture=o.createTexture(),c.memory.textures++)}if(I.samples>0&&Gt(I)===!1){et.__webglMultisampledFramebuffer=o.createFramebuffer(),et.__webglColorRenderbuffer=[],e.bindFramebuffer(o.FRAMEBUFFER,et.__webglMultisampledFramebuffer);for(let Rt=0;Rt<_t.length;Rt++){const kt=_t[Rt];et.__webglColorRenderbuffer[Rt]=o.createRenderbuffer(),o.bindRenderbuffer(o.RENDERBUFFER,et.__webglColorRenderbuffer[Rt]);const qt=l.convert(kt.format,kt.colorSpace),St=l.convert(kt.type),Ut=U(kt.internalFormat,qt,St,kt.colorSpace,I.isXRRenderTarget===!0),jt=Ve(I);o.renderbufferStorageMultisample(o.RENDERBUFFER,jt,Ut,I.width,I.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Rt,o.RENDERBUFFER,et.__webglColorRenderbuffer[Rt])}o.bindRenderbuffer(o.RENDERBUFFER,null),I.depthBuffer&&(et.__webglDepthRenderbuffer=o.createRenderbuffer(),Kt(et.__webglDepthRenderbuffer,I,!0)),e.bindFramebuffer(o.FRAMEBUFFER,null)}}if(ut){e.bindTexture(o.TEXTURE_CUBE_MAP,ht.__webglTexture),mt(o.TEXTURE_CUBE_MAP,R);for(let Rt=0;Rt<6;Rt++)if(R.mipmaps&&R.mipmaps.length>0)for(let kt=0;kt<R.mipmaps.length;kt++)At(et.__webglFramebuffer[Rt][kt],I,R,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+Rt,kt);else At(et.__webglFramebuffer[Rt],I,R,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+Rt,0);S(R)&&y(o.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(zt){for(let Rt=0,kt=_t.length;Rt<kt;Rt++){const qt=_t[Rt],St=a.get(qt);let Ut=o.TEXTURE_2D;(I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(Ut=I.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),e.bindTexture(Ut,St.__webglTexture),mt(Ut,qt),At(et.__webglFramebuffer,I,qt,o.COLOR_ATTACHMENT0+Rt,Ut,0),S(qt)&&y(Ut)}e.unbindTexture()}else{let Rt=o.TEXTURE_2D;if((I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(Rt=I.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),e.bindTexture(Rt,ht.__webglTexture),mt(Rt,R),R.mipmaps&&R.mipmaps.length>0)for(let kt=0;kt<R.mipmaps.length;kt++)At(et.__webglFramebuffer[kt],I,R,o.COLOR_ATTACHMENT0,Rt,kt);else At(et.__webglFramebuffer,I,R,o.COLOR_ATTACHMENT0,Rt,0);S(R)&&y(Rt),e.unbindTexture()}I.depthBuffer&&pe(I)}function Le(I){const R=I.textures;for(let et=0,ht=R.length;et<ht;et++){const _t=R[et];if(S(_t)){const ut=D(I),zt=a.get(_t).__webglTexture;e.bindTexture(ut,zt),y(ut),e.unbindTexture()}}}const re=[],ne=[];function Pt(I){if(I.samples>0){if(Gt(I)===!1){const R=I.textures,et=I.width,ht=I.height;let _t=o.COLOR_BUFFER_BIT;const ut=I.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,zt=a.get(I),Rt=R.length>1;if(Rt)for(let qt=0;qt<R.length;qt++)e.bindFramebuffer(o.FRAMEBUFFER,zt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+qt,o.RENDERBUFFER,null),e.bindFramebuffer(o.FRAMEBUFFER,zt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+qt,o.TEXTURE_2D,null,0);e.bindFramebuffer(o.READ_FRAMEBUFFER,zt.__webglMultisampledFramebuffer);const kt=I.texture.mipmaps;kt&&kt.length>0?e.bindFramebuffer(o.DRAW_FRAMEBUFFER,zt.__webglFramebuffer[0]):e.bindFramebuffer(o.DRAW_FRAMEBUFFER,zt.__webglFramebuffer);for(let qt=0;qt<R.length;qt++){if(I.resolveDepthBuffer&&(I.depthBuffer&&(_t|=o.DEPTH_BUFFER_BIT),I.stencilBuffer&&I.resolveStencilBuffer&&(_t|=o.STENCIL_BUFFER_BIT)),Rt){o.framebufferRenderbuffer(o.READ_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.RENDERBUFFER,zt.__webglColorRenderbuffer[qt]);const St=a.get(R[qt]).__webglTexture;o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,St,0)}o.blitFramebuffer(0,0,et,ht,0,0,et,ht,_t,o.NEAREST),p===!0&&(re.length=0,ne.length=0,re.push(o.COLOR_ATTACHMENT0+qt),I.depthBuffer&&I.resolveDepthBuffer===!1&&(re.push(ut),ne.push(ut),o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,ne)),o.invalidateFramebuffer(o.READ_FRAMEBUFFER,re))}if(e.bindFramebuffer(o.READ_FRAMEBUFFER,null),e.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),Rt)for(let qt=0;qt<R.length;qt++){e.bindFramebuffer(o.FRAMEBUFFER,zt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+qt,o.RENDERBUFFER,zt.__webglColorRenderbuffer[qt]);const St=a.get(R[qt]).__webglTexture;e.bindFramebuffer(o.FRAMEBUFFER,zt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+qt,o.TEXTURE_2D,St,0)}e.bindFramebuffer(o.DRAW_FRAMEBUFFER,zt.__webglMultisampledFramebuffer)}else if(I.depthBuffer&&I.resolveDepthBuffer===!1&&p){const R=I.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT;o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,[R])}}}function Ve(I){return Math.min(r.maxSamples,I.samples)}function Gt(I){const R=a.get(I);return I.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&R.__useRenderToTexture!==!1}function se(I){const R=c.render.frame;m.get(I)!==R&&(m.set(I,R),I.update())}function je(I,R){const et=I.colorSpace,ht=I.format,_t=I.type;return I.isCompressedTexture===!0||I.isVideoTexture===!0||et!==Lo&&et!==Mr&&(ye.getTransfer(et)===Ie?(ht!==Ki||_t!==ha)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",et)),R}function Ze(I){return typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement?(h.width=I.naturalWidth||I.width,h.height=I.naturalHeight||I.height):typeof VideoFrame<"u"&&I instanceof VideoFrame?(h.width=I.displayWidth,h.height=I.displayHeight):(h.width=I.width,h.height=I.height),h}this.allocateTextureUnit=tt,this.resetTextureUnits=j,this.setTexture2D=rt,this.setTexture2DArray=B,this.setTexture3D=k,this.setTextureCube=X,this.rebindTextures=cn,this.setupRenderTarget=G,this.updateRenderTargetMipmap=Le,this.updateMultisampleRenderTarget=Pt,this.setupDepthRenderbuffer=pe,this.setupFrameBufferTexture=At,this.useMultisampledRTT=Gt}function dC(o,t){function e(a,r=Mr){let l;const c=ye.getTransfer(r);if(a===ha)return o.UNSIGNED_BYTE;if(a===Pm)return o.UNSIGNED_SHORT_4_4_4_4;if(a===zm)return o.UNSIGNED_SHORT_5_5_5_1;if(a===yy)return o.UNSIGNED_INT_5_9_9_9_REV;if(a===Sy)return o.UNSIGNED_INT_10F_11F_11F_REV;if(a===vy)return o.BYTE;if(a===xy)return o.SHORT;if(a===tu)return o.UNSIGNED_SHORT;if(a===Nm)return o.INT;if(a===_s)return o.UNSIGNED_INT;if(a===Ha)return o.FLOAT;if(a===du)return o.HALF_FLOAT;if(a===My)return o.ALPHA;if(a===Ey)return o.RGB;if(a===Ki)return o.RGBA;if(a===nu)return o.DEPTH_COMPONENT;if(a===iu)return o.DEPTH_STENCIL;if(a===Ty)return o.RED;if(a===Im)return o.RED_INTEGER;if(a===by)return o.RG;if(a===Bm)return o.RG_INTEGER;if(a===Fm)return o.RGBA_INTEGER;if(a===ef||a===nf||a===af||a===rf)if(c===Ie)if(l=t.get("WEBGL_compressed_texture_s3tc_srgb"),l!==null){if(a===ef)return l.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(a===nf)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(a===af)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(a===rf)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(l=t.get("WEBGL_compressed_texture_s3tc"),l!==null){if(a===ef)return l.COMPRESSED_RGB_S3TC_DXT1_EXT;if(a===nf)return l.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(a===af)return l.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(a===rf)return l.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(a===Fp||a===Hp||a===Gp||a===Vp)if(l=t.get("WEBGL_compressed_texture_pvrtc"),l!==null){if(a===Fp)return l.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(a===Hp)return l.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(a===Gp)return l.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(a===Vp)return l.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(a===kp||a===Xp||a===Wp)if(l=t.get("WEBGL_compressed_texture_etc"),l!==null){if(a===kp||a===Xp)return c===Ie?l.COMPRESSED_SRGB8_ETC2:l.COMPRESSED_RGB8_ETC2;if(a===Wp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:l.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(a===qp||a===Yp||a===jp||a===Zp||a===Kp||a===Qp||a===Jp||a===$p||a===tm||a===em||a===nm||a===im||a===am||a===rm)if(l=t.get("WEBGL_compressed_texture_astc"),l!==null){if(a===qp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:l.COMPRESSED_RGBA_ASTC_4x4_KHR;if(a===Yp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:l.COMPRESSED_RGBA_ASTC_5x4_KHR;if(a===jp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:l.COMPRESSED_RGBA_ASTC_5x5_KHR;if(a===Zp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:l.COMPRESSED_RGBA_ASTC_6x5_KHR;if(a===Kp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:l.COMPRESSED_RGBA_ASTC_6x6_KHR;if(a===Qp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:l.COMPRESSED_RGBA_ASTC_8x5_KHR;if(a===Jp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:l.COMPRESSED_RGBA_ASTC_8x6_KHR;if(a===$p)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:l.COMPRESSED_RGBA_ASTC_8x8_KHR;if(a===tm)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:l.COMPRESSED_RGBA_ASTC_10x5_KHR;if(a===em)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:l.COMPRESSED_RGBA_ASTC_10x6_KHR;if(a===nm)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:l.COMPRESSED_RGBA_ASTC_10x8_KHR;if(a===im)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:l.COMPRESSED_RGBA_ASTC_10x10_KHR;if(a===am)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:l.COMPRESSED_RGBA_ASTC_12x10_KHR;if(a===rm)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:l.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(a===sm||a===om||a===lm)if(l=t.get("EXT_texture_compression_bptc"),l!==null){if(a===sm)return c===Ie?l.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:l.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(a===om)return l.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(a===lm)return l.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(a===um||a===cm||a===fm||a===hm)if(l=t.get("EXT_texture_compression_rgtc"),l!==null){if(a===um)return l.COMPRESSED_RED_RGTC1_EXT;if(a===cm)return l.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(a===fm)return l.COMPRESSED_RED_GREEN_RGTC2_EXT;if(a===hm)return l.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return a===eu?o.UNSIGNED_INT_24_8:o[a]!==void 0?o[a]:null}return{convert:e}}const pC=`
void main() {
...
}`;class _C{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e){if(this.texture===null){const a=new By(t.texture);(t.depthNear!==e.depthNear||t.depthFar!==e.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=a}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,a=new ka({vertexShader:pC,fragmentShader:mC,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new yi(new Af(20,20),a)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class gC extends Ho{constructor(t,e){super();const a=this;let r=null,l=1,c=null,f="local-floor",p=1,h=null,m=null,g=null,v=null,x=null,E=null;const M=typeof XRWebGLBinding<"u",S=new _C,y={},D=e.getContextAttributes();let U=null,A=null;const L=[],P=[],z=new Te;let F=null;const b=new Ii;b.viewport=new rn;const O=new Ii;O.viewport=new rn;const V=[b,O],j=new I1;let tt=null,ct=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(nt){let vt=L[nt];return vt===void 0&&(vt=new op,L[nt]=vt),vt.getTargetRaySpace()},this.getControllerGrip=function(nt){let vt=L[nt];return vt===void 0&&(vt=new op,L[nt]=vt),vt.getGripSpace()},this.getHand=function(nt){let vt=L[nt];return vt===void 0&&(vt=new op,L[nt]=vt),vt.getHandSpace()};function rt(nt){const vt=P.indexOf(nt.inputSource);if(vt===-1)return;const At=L[vt];At!==void 0&&(At.update(nt.inputSource,nt.frame,h||c),At.dispatchEvent({type:nt.type,data:nt.inputSource}))}function B(){r.removeEventListener("select",rt),r.removeEventListener("selectstart",rt),r.removeEventListener("selectend",rt),r.removeEventListener("squeeze",rt),r.removeEventListener("squeezestart",rt),r.removeEventListener("squeezeend",rt),r.removeEventListener("end",B),r.removeEventListener("inputsourceschange",k);for(let nt=0;nt<L.length;nt++){const vt=P[nt];vt!==null&&(P[nt]=null,L[nt].disconnect(vt))}tt=null,ct=null,S.reset();for(const nt in y)delete y[nt];t.setRenderTarget(U),x=null,v=null,g=null,r=null,A=null,Nt.stop(),a.isPresenting=!1,t.setPixelRatio(F),t.setSize(z.width,z.height,!1),a.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(nt){l=nt,a.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(nt){f=nt,a.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return h||c},this.setReferenceSpace=function(nt){h=nt},this.getBaseLayer=function(){return v!==null?v:x},this.getBinding=function(){return g===null&&M&&(g=new XRWebGLBinding(r,e)),g},this.getFrame=function(){return E},this.getSession=function(){return r},this.setSession=async function(nt){if(r=nt,r!==null){if(U=t.getRenderTarget(),r.addEventListener("select",rt),r.addEventListener("selectstart",rt),r.addEventListener("selectend",rt),r.addEventListener("squeeze",rt),r.addEventListener("squeezestart",rt),r.addEventListener("squeezeend",rt),r.addEventListener("end",B),r.addEventListener("inputsourceschange",k),D.xrCompatible!==!0&&await e.makeXRCompatible(),F=t.getPixelRatio(),t.getSize(z),M&&"createProjectionLayer"in XRWebGLBinding.prototype){let At=null,Kt=null,Wt=null;D.depth&&(Wt=D.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,At=D.stencil?iu:nu,Kt=D.stencil?eu:_s);const pe={colorFormat:e.RGBA8,depthFormat:Wt,scaleFactor:l};g=this.getBinding(),v=g.createProjectionLayer(pe),r.updateRenderState({layers:[v]}),t.setPixelRatio(1),t.setSize(v.textureWidth,v.textureHeight,!1),A=new gs(v.textureWidth,v.textureHeight,{format:Ki,type:ha,depthTexture:new Iy(v.textureWidth,v.textureHeight,Kt,void 0,void 0,void 0,void 0,void 0,void 0,At),stencilBuffer:D.stencil,colorSpace:t.outputColorSpace,samples:D.antialias?4:0,resolveDepthBuffer:v.ignoreDepthValues===!1,resolveStencilBuffer:v.ignoreDepthValues===!1})}else{const At={antialias:D.antialias,alpha:!0,depth:D.depth,stencil:D.stencil,framebufferScaleFactor:l};x=new XRWebGLLayer(r,e,At),r.updateRenderState({baseLayer:x}),t.setPixelRatio(1),t.setSize(x.framebufferWidth,x.framebufferHeight,!1),A=new gs(x.framebufferWidth,x.framebufferHeight,{format:Ki,type:ha,colorSpace:t.outputColorSpace,stencilBuffer:D.stencil,resolveDepthBuffer:x.ignoreDepthValues===!1,resolveStencilBuffer:x.ignoreDepthValues===!1})}A.isXRRenderTarget=!0,this.setFoveation(p),h=null,c=await r.requestReferenceSpace(f),Nt.setContext(r),Nt.start(),a.isPresenting=!0,a.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return S.getDepthTexture()};function k(nt){for(let vt=0;vt<nt.removed.length;vt++){const At=nt.removed[vt],Kt=P.indexOf(At);Kt>=0&&(P[Kt]=null,L[Kt].disconnect(At))}for(let vt=0;vt<nt.added.length;vt++){const At=nt.added[vt];let Kt=P.indexOf(At);if(Kt===-1){for(let pe=0;pe<L.length;pe++)if(pe>=P.length){P.push(At),Kt=pe;break}else if(P[pe]===null){P[pe]=At,Kt=pe;break}if(Kt===-1)break}const Wt=L[Kt];Wt&&Wt.connect(At)}}const X=new it,ft=new it;function N(nt,vt,At){X.setFromMatrixPosition(vt.matrixWorld),ft.setFromMatrixPosition(At.matrixWorld);const Kt=X.distanceTo(ft),Wt=vt.projectionMatrix.elements,pe=At.projectionMatrix.elements,cn=Wt[14]/(Wt[10]-1),G=Wt[14]/(Wt[10]+1),Le=(Wt[9]+1)/Wt[5],re=(Wt[9]-1)/Wt[5],ne=(Wt[8]-1)/Wt[0],Pt=(pe[8]+1)/pe[0],Ve=cn*ne,Gt=cn*Pt,se=Kt/(-ne+Pt),je=se*-ne;if(vt.matrixWorld.decompose(nt.position,nt.quaternion,nt.scale),nt.translateX(je),nt.translateZ(se),nt.matrixWorld.compose(nt.position,nt.quaternion,nt.scale),nt.matrixWorldInverse.copy(nt.matrixWorld).invert(),Wt[10]===-1)nt.projectionMatrix.copy(vt.projectionMatrix),nt.projectionMatrixInverse.copy(vt.projectionMatrixInverse);else{const Ze=cn+se,I=G+se,R=Ve-je,et=Gt+(Kt-je),ht=Le*G/I*Ze,_t=re*G/I*Ze;nt.projectionMatrix.makePerspective(R,et,ht,_t,Ze,I),nt.projectionMatrixInverse.copy(nt.projectionMatrix).invert()}}function Q(nt,vt){vt===null?nt.matrixWorld.copy(nt.matrix):nt.matrixWorld.multiplyMatrices(vt.matrixWorld,nt.matrix),nt.matrixWorldInverse.copy(nt.matrixWorld).invert()}this.updateCamera=function(nt){if(r===null)return;let vt=nt.near,At=nt.far;S.texture!==null&&(S.depthNear>0&&(vt=S.depthNear),S.depthFar>0&&(At=S.depthFar)),j.near=O.near=b.near=vt,j.far=O.far=b.far=At,(tt!==j.near||ct!==j.far)&&(r.updateRenderState({depthNear:j.near,depthFar:j.far}),tt=j.near,ct=j.far),j.layers.mask=nt.layers.mask|6,b.layers.mask=j.layers.mask&3,O.layers.mask=j.layers.mask&5;const Kt=nt.parent,Wt=j.cameras;Q(j,Kt);for(let pe=0;pe<Wt.length;pe++)Q(Wt[pe],Kt);Wt.length===2?N(j,b,O):j.projectionMatrix.copy(b.projectionMatrix),mt(nt,j,Kt)};function mt(nt,vt,At){At===null?nt.matrix.copy(vt.matrixWorld):(nt.matrix.copy(At.matrixWorld),nt.matrix.invert(),nt.matrix.multiply(vt.matrixWorld)),nt.matrix.decompose(nt.position,nt.quaternion,nt.scale),nt.updateMatrixWorld(!0),nt.projectionMatrix.copy(vt.projectionMatrix),nt.projectionMatrixInverse.copy(vt.projectionMatrixInverse),nt.isPerspectiveCamera&&(nt.fov=dm*2*Math.atan(1/nt.projectionMatrix.elements[5]),nt.zoom=1)}this.getCamera=function(){return j},this.getFoveation=function(){if(!(v===null&&x===null))return p},this.setFoveation=function(nt){p=nt,v!==null&&(v.fixedFoveation=nt),x!==null&&x.fixedFoveation!==void 0&&(x.fixedFoveation=nt)},this.hasDepthSensing=function(){return S.texture!==null},this.getDepthSensingMesh=function(){return S.getMesh(j)},this.getCameraTexture=function(nt){return y[nt]};let yt=null;function bt(nt,vt){if(m=vt.getViewerPose(h||c),E=vt,m!==null){const At=m.views;x!==null&&(t.setRenderTargetFramebuffer(A,x.framebuffer),t.setRenderTarget(A));let Kt=!1;At.length!==j.cameras.length&&(j.cameras.length=0,Kt=!0);for(let G=0;G<At.length;G++){const Le=At[G];let re=null;if(x!==null)re=x.getViewport(Le);else{const Pt=g.getViewSubImage(v,Le);re=Pt.viewport,G===0&&(t.setRenderTargetTextures(A,Pt.colorTexture,Pt.depthStencilTexture),t.setRenderTarget(A))}let ne=V[G];ne===void 0&&(ne=new Ii,ne.layers.enable(G),ne.viewport=new rn,V[G]=ne),ne.matrix.fromArray(Le.transform.matrix),ne.matrix.decompose(ne.position,ne.quaternion,ne.scale),ne.projectionMatrix.fromArray(Le.projectionMatrix),ne.projectionMatrixInverse.copy(ne.projectionMatrix).invert(),ne.viewport.set(re.x,re.y,re.width,re.height),G===0&&(j.matrix.copy(ne.matrix),j.matrix.decompose(j.position,j.quaternion,j.scale)),Kt===!0&&j.cameras.push(ne)}const Wt=r.enabledFeatures;if(Wt&&Wt.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&M){g=a.getBinding();const G=g.getDepthInformation(At[0]);G&&G.isValid&&G.texture&&S.init(G,r.renderState)}if(Wt&&Wt.includes("camera-access")&&M){t.state.unbindTexture(),g=a.getBinding();for(let G=0;G<At.length;G++){const Le=At[G].camera;if(Le){let re=y[Le];re||(re=new By,y[Le]=re);const ne=g.getCameraImage(Le);re.sourceTexture=ne}}}}for(let At=0;At<L.length;At++){const Kt=P[At],Wt=L[At];Kt!==null&&Wt!==void 0&&Wt.update(Kt,vt,h||c)}yt&&yt(nt,vt),vt.detectedPlanes&&a.dispatchEvent({type:"planesdetected",data:vt}),E=null}const Nt=new Xy;Nt.setAnimationLoop(bt),this.setAnimationLoop=function(nt){yt=nt},this.dispose=function(){}}}const es=new Ji,vC=new $e;function xC(o,t){function e(S,y){S.matrixAutoUpdate===!0&&S.updateMatrix(),y.value.copy(S.matrix)}function a(S,y){y.color.getRGB(S.fogColor.value,Ny(o)),y.isFog?(S.fogNear.value=y.near,S.fogFar.value=y.far):y.isFogExp2&&(S.fogDensity.value=y.density)}function r(S,y,D,U,A){y.isMeshBasicMaterial||y.isMeshLambertMaterial?l(S,y):y.isMeshToonMaterial?(l(S,y),g(S,y)):y.isMeshPhongMaterial?(l(S,y),m(S,y)):y.isMeshStandardMaterial?(l(S,y),v(S,y),y.isMeshPhysicalMaterial&&x(S,y,A)):y.isMeshMatcapMaterial?(l(S,y),E(S,y)):y.isMeshDepthMaterial?l(S,y):y.isMeshDistanceMaterial?(l(S,y),M(S,y)):y.isMeshNormalMaterial?l(S,y):y.isLineBasicMaterial?(c(S,y),y.isLineDashedMaterial&&f(S,y)):y.isPointsMaterial?p(S,y,D,U):y.isSpriteMaterial?h(S,y):y.isShadowMaterial?(S.color.value.copy(y.color),S.opacity.value=y.opacity):y.isShaderMaterial&&(y.uniformsNeedUpdate=!1)}function l(S,y){S.opacity.value=y.opacity,y.color&&S.diffuse.value.copy(y.color),y.emissive&&S.emissive.value.copy(y.emissive).multiplyScalar(y.emissiveIntensity),y.map&&(S.map.value=y.map,e(y.map,S.mapTransform)),y.alphaMap&&(S.alphaMap.value=y.alphaMap,e(y.alphaMap,S.alphaMapTransform)),y.bumpMap&&(S.bumpMap.value=y.bumpMap,e(y.bumpMap,S.bumpMapTransform),S.bumpScale.value=y.bumpScale,y.side===ii&&(S.bumpScale.value*=-1)),y.normalMap&&(S.normalMap.value=y.normalMap,e(y.normalMap,S.normalMapTransform),S.normalScale.value.copy(y.normalScale),y.side===ii&&S.normalScale.value.negate()),y.displacementMap&&(S.displacementMap.value=y.displacementMap,e(y.displacementMap,S.displacementMapTransform),S.displacementScale.value=y.displacementScale,S.displacementBias.value=y.displacementBias),y.emissiveMap&&(S.emissiveMap.value=y.emissiveMap,e(y.emissiveMap,S.emissiveMapTransform)),y.specularMap&&(S.specularMap.value=y.specularMap,e(y.specularMap,S.specularMapTransform)),y.alphaTest>0&&(S.alphaTest.value=y.alphaTest);const D=t.get(y),U=D.envMap,A=D.envMapRotation;U&&(S.envMap.value=U,es.copy(A),es.x*=-1,es.y*=-1,es.z*=-1,U.isCubeTexture&&U.isRenderTargetTexture===!1&&(es.y*=-1,es.z*=-1),S.envMapRotation.value.setFromMatrix4(vC.makeRotationFromEuler(es)),S.flipEnvMap.value=U.isCubeTexture&&U.isRenderTargetTexture===!1?-1:1,S.reflectivity.value=y.reflectivity,S.ior.value=y.ior,S.refractionRatio.value=y.refractionRatio),y.lightMap&&(S.lightMap.value=y.lightMap,S.lightMapIntensity.value=y.lightMapIntensity,e(y.lightMap,S.lightMapTransform)),y.aoMap&&(S.aoMap.value=y.aoMap,S.aoMapIntensity.value=y.aoMapIntensity,e(y.aoMap,S.aoMapTransform))}function c(S,y){S.diffuse.value.copy(y.color),S.opacity.value=y.opacity,y.map&&(S.map.value=y.map,e(y.map,S.mapTransform))}function f(S,y){S.dashSize.value=y.dashSize,S.totalSize.value=y.dashSize+y.gapSize,S.scale.value=y.scale}function p(S,y,D,U){S.diffuse.value.copy(y.color),S.opacity.value=y.opacity,S.size.value=y.size*D,S.scale.value=U*.5,y.map&&(S.map.value=y.map,e(y.map,S.uvTransform)),y.alphaMap&&(S.alphaMap.value=y.alphaMap,e(y.alphaMap,S.alphaMapTransform)),y.alphaTest>0&&(S.alphaTest.value=y.alphaTest)}function h(S,y){S.diffuse.value.copy(y.color),S.opacity.value=y.opacity,S.rotation.value=y.rotation,y.map&&(S.map.value=y.map,e(y.map,S.mapTransform)),y.alphaMap&&(S.alphaMap.value=y.alphaMap,e(y.alphaMap,S.alphaMapTransform)),y.alphaTest>0&&(S.alphaTest.value=y.alphaTest)}function m(S,y){S.specular.value.copy(y.specular),S.shininess.value=Math.max(y.shininess,1e-4)}function g(S,y){y.gradientMap&&(S.gradientMap.value=y.gradientMap)}function v(S,y){S.metalness.value=y.metalness,y.metalnessMap&&(S.metalnessMap.value=y.metalnessMap,e(y.metalnessMap,S.metalnessMapTransform)),S.roughness.value=y.roughness,y.roughnessMap&&(S.roughnessMap.value=y.roughnessMap,e(y.roughnessMap,S.roughnessMapTransform)),y.envMap&&(S.envMapIntensity.value=y.envMapIntensity)}function x(S,y,D){S.ior.value=y.ior,y.sheen>0&&(S.sheenColor.value.copy(y.sheenColor).multiplyScalar(y.sheen),S.sheenRoughness.value=y.sheenRoughness,y.sheenColorMap&&(S.sheenColorMap.value=y.sheenColorMap,e(y.sheenColorMap,S.sheenColorMapTransform)),y.sheenRoughnessMap&&(S.sheenRoughnessMap.value=y.sheenRoughnessMap,e(y.sheenRoughnessMap,S.sheenRoughnessMapTransform))),y.clearcoat>0&&(S.clearcoat.value=y.clearcoat,S.clearcoatRoughness.value=y.clearcoatRoughness,y.clearcoatMap&&(S.clearcoatMap.value=y.clearcoatMap,e(y.clearcoatMap,S.clearcoatMapTransform)),y.clearcoatRoughnessMap&&(S.clearcoatRoughnessMap.value=y.clearcoatRoughnessMap,e(y.clearcoatRoughnessMap,S.clearcoatRoughnessMapTransform)),y.clearcoatNormalMap&&(S.clearcoatNormalMap.value=y.clearcoatNormalMap,e(y.clearcoatNormalMap,S.clearcoatNormalMapTransform),S.clearcoatNormalScale.value.copy(y.clearcoatNormalScale),y.side===ii&&S.clearcoatNormalScale.value.negate())),y.dispersion>0&&(S.dispersion.value=y.dispersion),y.iridescence>0&&(S.iridescence.value=y.iridescence,S.iridescenceIOR.value=y.iridescenceIOR,S.iridescenceThicknessMinimum.value=y.iridescenceThicknessRange[0],S.iridescenceThicknessMaximum.value=y.iridescenceThicknessRange[1],y.iridescenceMap&&(S.iridescenceMap.value=y.iridescenceMap,e(y.iridescenceMap,S.iridescenceMapTransform)),y.iridescenceThicknessMap&&(S.iridescenceThicknessMap.value=y.iridescenceThicknessMap,e(y.iridescenceThicknessMap,S.iridescenceThicknessMapTransform))),y.transmission>0&&(S.transmission.value=y.transmission,S.transmissionSamplerMap.value=D.texture,S.transmissionSamplerSize.value.set(D.width,D.height),y.transmissionMap&&(S.transmissionMap.value=y.transmissionMap,e(y.transmissionMap,S.transmissionMapTransform)),S.thickness.value=y.thickness,y.thicknessMap&&(S.thicknessMap.value=y.thicknessMap,e(y.thicknessMap,S.thicknessMapTransform)),S.attenuationDistance.value=y.attenuationDistance,S.attenuationColor.value.copy(y.attenuationColor)),y.anisotropy>0&&(S.anisotropyVector.value.set(y.anisotropy*Math.cos(y.anisotropyRotation),y.anisotropy*Math.sin(y.anisotropyRotation)),y.anisotropyMap&&(S.anisotropyMap.value=y.anisotropyMap,e(y.anisotropyMap,S.anisotropyMapTransform))),S.specularIntensity.value=y.specularIntensity,S.specularColor.value.copy(y.specularColor),y.specularColorMap&&(S.specularColorMap.value=y.specularColorMap,e(y.specularColorMap,S.specularColorMapTransform)),y.specularIntensityMap&&(S.specularIntensityMap.value=y.specularIntensityMap,e(y.specularIntensityMap,S.specularIntensityMapTransform))}function E(S,y){y.matcap&&(S.matcap.value=y.matcap)}function M(S,y){const D=t.get(y).light;S.referencePosition.value.setFromMatrixPosition(D.matrixWorld),S.nearDistance.value=D.shadow.camera.near,S.farDistance.value=D.shadow.camera.far}return{refreshFogUniforms:a,refreshMaterialUniforms:r}}function yC(o,t,e,a){let r={},l={},c=[];const f=o.getParameter(o.MAX_UNIFORM_BUFFER_BINDINGS);function p(D,U){const A=U.program;a.uniformBlockBinding(D,A)}function h(D,U){let A=r[D.id];A===void 0&&(E(D),A=m(D),r[D.id]=A,D.addEventListener("dispose",S));const L=U.program;a.updateUBOMapping(D,L);const P=t.render.frame;l[D.id]!==P&&(v(D),l[D.id]=P)}function m(D){const U=g();D.__bindingPointIndex=U;const A=o.createBuffer(),L=D.__size,P=D.usage;return o.bindBuffer(o.UNIFORM_BUFFER,A),o.bufferData(o.UNIFORM_BUFFER,L,P),o.bindBuffer(o.UNIFORM_BUFFER,null),o.bindBufferBase(o.UNIFORM_BUFFER,U,A),A}function g(){for(let D=0;D<f;D++)if(c.indexOf(D)===-1)return c.push(D),D;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function v(D){const U=r[D.id],A=D.uniforms,L=D.__cache;o.bindBuffer(o.UNIFORM_BUFFER,U);for(let P=0,z=A.length;P<z;P++){const F=Array.isArray(A[P])?A[P]:[A[P]];for(let b=0,O=F.length;b<O;b++){const V=F[b];if(x(V,P,b,L)===!0){const j=V.__offset,tt=Array.isArray(V.value)?V.value:[V.value];let ct=0;for(let rt=0;rt<tt.length;rt++){const B=tt[rt],k=M(B);typeof B=="number"||typeof B=="boolean"?(V.__data[0]=B,o.bufferSubData(o.UNIFORM_BUFFER,j+ct,V.__data)):B.isMatrix3?(V.__data[0]=B.elements[0],V.__data[1]=B.elements[1],V.__data[2]=B.elements[2],V.__data[3]=0,V.__data[4]=B.elements[3],V.__data[5]=B.elements[4],V.__data[6]=B.elements[5],V.__data[7]=0,V.__data[8]=B.elements[6],V.__data[9]=B.elements[7],V.__data[10]=B.elements[8],V.__data[11]=0):(B.toArray(V.__data,ct),ct+=k.storage/Float32Array.BYTES_PER_ELEMENT)}o.bufferSubData(o.UNIFORM_BUFFER,j,V.__data)}}}o.bindBuffer(o.UNIFORM_BUFFER,null)}function x(D,U,A,L){const P=D.value,z=U+"_"+A;if(L[z]===void 0)return typeof P=="number"||typeof P=="boolean"?L[z]=P:L[z]=P.clone(),!0;{const F=L[z];if(typeof P=="number"||typeof P=="boolean"){if(F!==P)return L[z]=P,!0}else if(F.equals(P)===!1)return F.copy(P),!0}return!1}function E(D){const U=D.uniforms;let A=0;const L=16;for(let z=0,F=U.length;z<F;z++){const b=Array.isArray(U[z])?U[z]:[U[z]];for(let O=0,V=b.length;O<V;O++){const j=b[O],tt=Array.isArray(j.value)?j.value:[j.value];for(let ct=0,rt=tt.length;ct<rt;ct++){const B=tt[ct],k=M(B),X=A%L,ft=X%k.boundary,N=X+ft;A+=ft,N!==0&&L-N<k.storage&&(A+=L-N),j.__data=new Float32Array(k.storage/Float32Array.BYTES_PER_ELEMENT),j.__offset=A,A+=k.storage}}}const P=A%L;return P>0&&(A+=L-P),D.__size=A,D.__cache={},this}function M(D){const U={boundary:0,storage:0};return typeof D=="number"||typeof D=="boolean"?(U.boundary=4,U.storage=4):D.isVector2?(U.boundary=8,U.storage=8):D.isVector3||D.isColor?(U.boundary=16,U.storage=12):D.isVector4?(U.boundary=16,U.storage=16):D.isMatrix3?(U.boundary=48,U.storage=48):D.isMatrix4?(U.boundary=64,U.storage=64):D.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",D),U}function S(D){const U=D.target;U.removeEventListener("dispose",S);const A=c.indexOf(U.__bindingPointIndex);c.splice(A,1),o.deleteBuffer(r[U.id]),delete r[U.id],delete l[U.id]}function y(){for(const D in r)o.deleteBuffer(r[D]);c=[],r={},l={}}return{bind:p,update:h,dispose:y}}class SC{constructor(t={}){const{canvas:e=ZT(),context:a=null,depth:r=!0,stencil:l=!1,alpha:c=!1,antialias:f=!1,premultipliedAlpha:p=!0,preserveDrawingBuffer:h=!1,powerPreference:m="default",failIfMajorPerformanceCaveat:g=!1,reversedDepthBuffer:v=!1}=t;this.isWebGLRenderer=!0;let x;if(a!==null){if(typeof WebGLRenderingContext<"u"&&a instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");x=a.getContextAttributes().alpha}else x=c;const E=new Uint32Array(4),M=new Int32Array(4);let S=null,y=null;const D=[],U=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Rr,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const A=this;let L=!1;this._outputColorSpace=Nn;let P=0,z=0,F=null,b=-1,O=null;const V=new rn,j=new rn;let tt=null;const ct=new ce(0);let rt=0,B=e.width,k=e.height,X=1,ft=null,N=null;const Q=new rn(0,0,B,k),mt=new rn(0,0,B,k);let yt=!1;const bt=new km;let Nt=!1,nt=!1;const vt=new $e,At=new it,Kt=new rn,Wt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let pe=!1;function cn(){return F===null?X:1}let G=a;function Le(C,Y){return e.getContext(C,Y)}try{const C={alpha:!0,depth:r,stencil:l,antialias:f,premultipliedAlpha:p,preserveDrawingBuffer:h,powerPreference:m,failIfMajorPerformanceCaveat:g};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${Lm}`),e.addEventListener("webglcontextlost",wt,!1),e.addEventListener("webglcontextrestored",It,!1),e.addEventListener("webglcontextcreationerror",Mt,!1),G===null){const Y="webgl2";if(G=Le(Y,C),G===null)throw Le(Y)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(C){throw console.error("THREE.WebGLRenderer: "+C.message),C}let re,ne,Pt,Ve,Gt,se,je,Ze,I,R,et,ht,_t,ut,zt,Rt,kt,qt,St,Ut,jt,Vt,Ct,oe;function q(){re=new UR(G),re.init(),Vt=new dC(G,re),ne=new TR(G,re,t,Vt),Pt=new fC(G,re),ne.reversedDepthBuffer&&v&&Pt.buffers.depth.setReversed(!0),Ve=new NR(G),Gt=new Jw,se=new hC(G,re,Pt,Gt,ne,Vt,Ve),je=new AR(A),Ze=new DR(A),I=new H1(G),Ct=new MR(G,I),R=new LR(G,I,Ve,Ct),et=new zR(G,R,I,Ve),St=new PR(G,ne,se),Rt=new bR(Gt),ht=new Qw(A,je,Ze,re,ne,Ct,Rt),_t=new xC(A,Gt),ut=new tC,zt=new sC(re),qt=new SR(A,je,Ze,Pt,et,x,p),kt=new uC(A,et,ne),oe=new yC(G,Ve,ne,Pt),Ut=new ER(G,re,Ve),jt=new OR(G,re,Ve),Ve.programs=ht.programs,A.capabilities=ne,A.extensions=re,A.properties=Gt,A.renderLists=ut,A.shadowMap=kt,A.state=Pt,A.info=Ve}q();const Tt=new gC(A,G);this.xr=Tt,this.getContext=function(){return G},this.getContextAttributes=function(){return G.getContextAttributes()},this.forceContextLoss=function(){const C=re.get("WEBGL_lose_context");C&&C.loseContext()},this.forceContextRestore=function(){const C=re.get("WEBGL_lose_context");C&&C.restoreContext()},this.getPixelRatio=function(){return X},this.setPixelRatio=function(C){C!==void 0&&(X=C,this.setSize(B,k,!1))},this.getSize=function(C){return C.set(B,k)},this.setSize=function(C,Y,ot=!0){if(Tt.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}B=C,k=Y,e.width=Math.floor(C*X),e.height=Math.floor(Y*X),ot===!0&&(e.style.width=C+"px",e.style.height=Y+"px"),this.setViewport(0,0,C,Y)},this.getDrawingBufferSize=function(C){return C.set(B*X,k*X).floor()},this.setDrawingBufferSize=function(C,Y,ot){B=C,k=Y,X=ot,e.width=Math.floor(C*ot),e.height=Math.floor(Y*ot),this.setViewport(0,0,C,Y)},this.getCurrentViewport=function(C){return C.copy(V)},this.getViewport=function(C){return C.copy(Q)},this.setViewport=function(C,Y,ot,lt){C.isVector4?Q.set(C.x,C.y,C.z,C.w):Q.set(C,Y,ot,lt),Pt.viewport(V.copy(Q).multiplyScalar(X).round())},this.getScissor=function(C){return C.copy(mt)},this.setScissor=function(C,Y,ot,lt){C.isVector4?mt.set(C.x,C.y,C.z,C.w):mt.set(C,Y,ot,lt),Pt.scissor(j.copy(mt).multiplyScalar(X).round())},this.getScissorTest=function(){return yt},this.setScissorTest=function(C){Pt.setScissorTest(yt=C)},this.setOpaqueSort=function(C){ft=C},this.setTransparentSort=function(C){N=C},this.getClearColor=function(C){return C.copy(qt.getClearColor())},this.setClearColor=function(){qt.setClearColor(...arguments)},this.getClearAlpha=function(){return qt.getClearAlpha()},this.setClearAlpha=function(){qt.setClearAlpha(...arguments)},this.clear=function(C=!0,Y=!0,ot=!0){let lt=0;if(C){let K=!1;if(F!==null){const Et=F.texture.format;K=Et===Fm||Et===Bm||Et===Im}if(K){const Et=F.texture.type,Dt=Et===ha||Et===_s||Et===tu||Et===eu||Et===Pm||Et===zm,Bt=qt.getClearColor(),Lt=qt.getClearAlpha(),Jt=Bt.r,te=Bt.g,Xt=Bt.b;Dt?(E[0]=Jt,E[1]=te,E[2]=Xt,E[3]=Lt,G.clearBufferuiv(G.COLOR,0,E)):(M[0]=Jt,M[1]=te,M[2]=Xt,M[3]=Lt,G.clearBufferiv(G.COLOR,0,M))}else lt|=G.COLOR_BUFFER_BIT}Y&&(lt|=G.DEPTH_BUFFER_BIT),ot&&(lt|=G.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),G.clear(lt)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",wt,!1),e.removeEventListener("webglcontextrestored",It,!1),e.removeEventListener("webglcontextcreationerror",Mt,!1),qt.dispose(),ut.dispose(),zt.dispose(),Gt.dispose(),je.dispose(),Ze.dispose(),et.dispose(),Ct.dispose(),oe.dispose(),ht.dispose(),Tt.dispose(),Tt.removeEventListener("sessionstart",gn),Tt.removeEventListener("sessionend",vn),tn.stop()};function wt(C){C.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),L=!0}function It(){console.log("THREE.WebGLRenderer: Context Restored."),L=!1;const C=Ve.autoReset,Y=kt.enabled,ot=kt.autoUpdate,lt=kt.needsUpdate,K=kt.type;q(),Ve.autoReset=C,kt.enabled=Y,kt.autoUpdate=ot,kt.needsUpdate=lt,kt.type=K}function Mt(C){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",C.statusMessage)}function xt(C){const Y=C.target;Y.removeEventListener("dispose",xt),Ht(Y)}function Ht(C){ae(C),Gt.remove(C)}function ae(C){const Y=Gt.get(C).programs;Y!==void 0&&(Y.forEach(function(ot){ht.releaseProgram(ot)}),C.isShaderMaterial&&ht.releaseShaderCache(C))}this.renderBufferDirect=function(C,Y,ot,lt,K,Et){Y===null&&(Y=Wt);const Dt=K.isMesh&&K.matrixWorld.determinant()<0,Bt=qa(C,Y,ot,lt,K);Pt.setMaterial(lt,Dt);let Lt=ot.index,Jt=1;if(lt.wireframe===!0){if(Lt=R.getWireframeAttribute(ot),Lt===void 0)return;Jt=2}const te=ot.drawRange,Xt=ot.attributes.position;let fe=te.start*Jt,Ae=(te.start+te.count)*Jt;Et!==null&&(fe=Math.max(fe,Et.start*Jt),Ae=Math.min(Ae,(Et.start+Et.count)*Jt)),Lt!==null?(fe=Math.max(fe,0),Ae=Math.min(Ae,Lt.count)):Xt!=null&&(fe=Math.max(fe,0),Ae=Math.min(Ae,Xt.count));const We=Ae-fe;if(We<0||We===1/0)return;Ct.setup(K,lt,Bt,ot,Lt);let Oe,he=Ut;if(Lt!==null&&(Oe=I.get(Lt),he=jt,he.setIndex(Oe)),K.isMesh)lt.wireframe===!0?(Pt.setLineWidth(lt.wireframeLinewidth*cn()),he.setMode(G.LINES)):he.setMode(G.TRIANGLES);else if(K.isLine){let Qt=lt.linewidth;Qt===void 0&&(Qt=1),Pt.setLineWidth(Qt*cn()),K.isLineSegments?he.setMode(G.LINES):K.isLineLoop?he.setMode(G.LINE_LOOP):he.setMode(G.LINE_STRIP)}else K.isPoints?he.setMode(G.POINTS):K.isSprite&&he.setMode(G.TRIANGLES);if(K.isBatchedMesh)if(K._multiDrawInstances!==null)ru("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),he.renderMultiDrawInstances(K._multiDrawStarts,K._multiDrawCounts,K._multiDrawCount,K._multiDrawInstances);else if(re.get("WEBGL_multi_draw"))he.renderMultiDraw(K._multiDrawStarts,K._multiDrawCounts,K._multiDrawCount);else{const Qt=K._multiDrawStarts,Xe=K._multiDrawCounts,ge=K._multiDrawCount,zn=Lt?I.get(Lt).bytesPerElement:1,Vi=Gt.get(lt).currentProgram.getUniforms();for(let Xn=0;Xn<ge;Xn++)Vi.setValue(G,"_gl_DrawID",Xn),he.render(Qt[Xn]/zn,Xe[Xn])}else if(K.isInstancedMesh)he.renderInstances(fe,We,K.count);else if(ot.isInstancedBufferGeometry){const Qt=ot._maxInstanceCount!==void 0?ot._maxInstanceCount:1/0,Xe=Math.min(ot.instanceCount,Qt);he.renderInstances(fe,We,Xe)}else he.render(fe,We)};function Ce(C,Y,ot){C.transparent===!0&&C.side===Fa&&C.forceSinglePass===!1?(C.side=ii,C.needsUpdate=!0,ta(C,Y,ot),C.side=Va,C.needsUpdate=!0,ta(C,Y,ot),C.side=Fa):ta(C,Y,ot)}this.compile=function(C,Y,ot=null){ot===null&&(ot=C),y=zt.get(ot),y.init(Y),U.push(y),ot.traverseVisible(function(K){K.isLight&&K.layers.test(Y.layers)&&(y.pushLight(K),K.castShadow&&y.pushShadow(K))}),C!==ot&&C.traverseVisible(function(K){K.isLight&&K.layers.test(Y.layers)&&(y.pushLight(K),K.castShadow&&y.pushShadow(K))}),y.setupLights();const lt=new Set;return C.traverse(function(K){if(!(K.isMesh||K.isPoints||K.isLine||K.isSprite))return;const Et=K.material;if(Et)if(Array.isArray(Et))for(let Dt=0;Dt<Et.length;Dt++){const Bt=Et[Dt];Ce(Bt,ot,K),lt.add(Bt)}else Ce(Et,ot,K),lt.add(Et)}),y=U.pop(),lt},this.compileAsync=function(C,Y,ot=null){const lt=this.compile(C,Y,ot);return new Promise(K=>{function Et(){if(lt.forEach(function(Dt){Gt.get(Dt).currentProgram.isReady()&&lt.delete(Dt)}),lt.size===0){K(C);return}setTimeout(Et,10)}re.get("KHR_parallel_shader_compile")!==null?Et():setTimeout(Et,10)})};let be=null;function Gi(C){be&&be(C)}function gn(){tn.stop()}function vn(){tn.start()}const tn=new Xy;tn.setAnimationLoop(Gi),typeof self<"u"&&tn.setContext(self),this.setAnimationLoop=function(C){be=C,Tt.setAnimationLoop(C),C===null?tn.stop():tn.start()},Tt.addEventListener("sessionstart",gn),Tt.addEventListener("sessionend",vn),this.render=function(C,Y){if(Y!==void 0&&Y.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(L===!0)return;if(C.matrixWorldAutoUpdate===!0&&C.updateMatrixWorld(),Y.parent===null&&Y.matrixWorldAutoUpdate===!0&&Y.updateMatrixWorld(),Tt.enabled===!0&&Tt.isPresenting===!0&&(Tt.cameraAutoUpdate===!0&&Tt.updateCamera(Y),Y=Tt.getCamera()),C.isScene===!0&&C.onBeforeRender(A,C,Y,F),y=zt.get(C,U.length),y.init(Y),U.push(y),vt.multiplyMatrices(Y.projectionMatrix,Y.matrixWorldInverse),bt.setFromProjectionMatrix(vt,ca,Y.reversedDepth),nt=this.localClippingEnabled,Nt=Rt.init(this.clippingPlanes,nt),S=ut.get(C,D.length),S.init(),D.push(S),Tt.enabled===!0&&Tt.isPresenting===!0){const Et=A.xr.getDepthSensingMesh();Et!==null&&$i(Et,Y,-1/0,A.sortObjects)}$i(C,Y,0,A.sortObjects),S.finish(),A.sortObjects===!0&&S.sort(ft,N),pe=Tt.enabled===!1||Tt.isPresenting===!1||Tt.hasDepthSensing()===!1,pe&&qt.addToRenderList(S,C),this.info.render.frame++,Nt===!0&&Rt.beginShadows();const ot=y.state.shadowsArray;kt.render(ot,C,Y),Nt===!0&&Rt.endShadows(),this.info.autoReset===!0&&this.info.reset();const lt=S.opaque,K=S.transmissive;if(y.setupLights(),Y.isArrayCamera){const Et=Y.cameras;if(K.length>0)for(let Dt=0,Bt=Et.length;Dt<Bt;Dt++){const Lt=Et[Dt];xu(lt,K,C,Lt)}pe&&qt.render(C);for(let Dt=0,Bt=Et.length;Dt<Bt;Dt++){const Lt=Et[Dt];Ss(S,C,Lt,Lt.viewport)}}else K.length>0&&xu(lt,K,C,Y),pe&&qt.render(C),Ss(S,C,Y);F!==null&&z===0&&(se.updateMultisampleRenderTarget(F),se.updateRenderTargetMipmap(F)),C.isScene===!0&&C.onAfterRender(A,C,Y),Ct.resetDefaultState(),b=-1,O=null,U.pop(),U.length>0?(y=U[U.length-1],Nt===!0&&Rt.setGlobalState(A.clippingPlanes,y.state.camera)):y=null,D.pop(),D.length>0?S=D[D.length-1]:S=null};function $i(C,Y,ot,lt){if(C.visible===!1)return;if(C.layers.test(Y.layers)){if(C.isGroup)ot=C.renderOrder;else if(C.isLOD)C.autoUpdate===!0&&C.update(Y);else if(C.isLight)y.pushLight(C),C.castShadow&&y.pushShadow(C);else if(C.isSprite){if(!C.frustumCulled||bt.intersectsSprite(C)){lt&&Kt.setFromMatrixPosition(C.matrixWorld).applyMatrix4(vt);const Dt=et.update(C),Bt=C.material;Bt.visible&&S.push(C,Dt,Bt,ot,Kt.z,null)}}else if((C.isMesh||C.isLine||C.isPoints)&&(!C.frustumCulled||bt.intersectsObject(C))){const Dt=et.update(C),Bt=C.material;if(lt&&(C.boundingSphere!==void 0?(C.boundingSphere===null&&C.computeBoundingSphere(),Kt.copy(C.boundingSphere.center)):(Dt.boundingSphere===null&&Dt.computeBoundingSphere(),Kt.copy(Dt.boundingSphere.center)),Kt.applyMatrix4(C.matrixWorld).applyMatrix4(vt)),Array.isArray(Bt)){const Lt=Dt.groups;for(let Jt=0,te=Lt.length;Jt<te;Jt++){const Xt=Lt[Jt],fe=Bt[Xt.materialIndex];fe&&fe.visible&&S.push(C,Dt,fe,ot,Kt.z,Xt)}}else Bt.visible&&S.push(C,Dt,Bt,ot,Kt.z,null)}}const Et=C.children;for(let Dt=0,Bt=Et.length;Dt<Bt;Dt++)$i(Et[Dt],Y,ot,lt)}function Ss(C,Y,ot,lt){const K=C.opaque,Et=C.transmissive,Dt=C.transparent;y.setupLightsView(ot),Nt===!0&&Rt.setGlobalState(A.clippingPlanes,ot),lt&&Pt.viewport(V.copy(lt)),K.length>0&&Ms(K,Y,ot),Et.length>0&&Ms(Et,Y,ot),Dt.length>0&&Ms(Dt,Y,ot),Pt.buffers.depth.setTest(!0),Pt.buffers.depth.setMask(!0),Pt.buffers.color.setMask(!0),Pt.setPolygonOffset(!1)}function xu(C,Y,ot,lt){if((ot.isScene===!0?ot.overrideMaterial:null)!==null)return;y.state.transmissionRenderTarget[lt.id]===void 0&&(y.state.transmissionRenderTarget[lt.id]=new gs(1,1,{generateMipmaps:!0,type:re.has("EXT_color_buffer_half_float")||re.has("EXT_color_buffer_float")?du:ha,minFilter:cs,samples:4,stencilBuffer:l,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ye.workingColorSpace}));const Et=y.state.transmissionRenderTarget[lt.id],Dt=lt.viewport||V;Et.setSize(Dt.z*A.transmissionResolutionScale,Dt.w*A.transmissionResolutionScale);const Bt=A.getRenderTarget(),Lt=A.getActiveCubeFace(),Jt=A.getActiveMipmapLevel();A.setRenderTarget(Et),A.getClearColor(ct),rt=A.getClearAlpha(),rt<1&&A.setClearColor(16777215,.5),A.clear(),pe&&qt.render(ot);const te=A.toneMapping;A.toneMapping=Rr;const Xt=lt.viewport;if(lt.viewport!==void 0&&(lt.viewport=void 0),y.setupLightsView(lt),Nt===!0&&Rt.setGlobalState(A.clippingPlanes,lt),Ms(C,ot,lt),se.updateMultisampleRenderTarget(Et),se.updateRenderTargetMipmap(Et),re.has("WEBGL_multisampled_render_to_texture")===!1){let fe=!1;for(let Ae=0,We=Y.length;Ae<We;Ae++){const Oe=Y[Ae],he=Oe.object,Qt=Oe.geometry,Xe=Oe.material,ge=Oe.group;if(Xe.side===Fa&&he.layers.test(lt.layers)){const zn=Xe.side;Xe.side=ii,Xe.needsUpdate=!0,ko(he,ot,lt,Qt,Xe,ge),Xe.side=zn,Xe.needsUpdate=!0,fe=!0}}fe===!0&&(se.updateMultisampleRenderTarget(Et),se.updateRenderTargetMipmap(Et))}A.setRenderTarget(Bt,Lt,Jt),A.setClearColor(ct,rt),Xt!==void 0&&(lt.viewport=Xt),A.toneMapping=te}function Ms(C,Y,ot){const lt=Y.isScene===!0?Y.overrideMaterial:null;for(let K=0,Et=C.length;K<Et;K++){const Dt=C[K],Bt=Dt.object,Lt=Dt.geometry,Jt=Dt.group;let te=Dt.material;te.allowOverride===!0&&lt!==null&&(te=lt),Bt.layers.test(ot.layers)&&ko(Bt,Y,ot,Lt,te,Jt)}}function ko(C,Y,ot,lt,K,Et){C.onBeforeRender(A,Y,ot,lt,K,Et),C.modelViewMatrix.multiplyMatrices(ot.matrixWorldInverse,C.matrixWorld),C.normalMatrix.getNormalMatrix(C.modelViewMatrix),K.onBeforeRender(A,Y,ot,lt,C,Et),K.transparent===!0&&K.side===Fa&&K.forceSinglePass===!1?(K.side=ii,K.needsUpdate=!0,A.renderBufferDirect(ot,Y,lt,K,C,Et),K.side=Va,K.needsUpdate=!0,A.renderBufferDirect(ot,Y,lt,K,C,Et),K.side=Fa):A.renderBufferDirect(ot,Y,lt,K,C,Et),C.onAfterRender(A,Y,ot,lt,K,Et)}function ta(C,Y,ot){Y.isScene!==!0&&(Y=Wt);const lt=Gt.get(C),K=y.state.lights,Et=y.state.shadowsArray,Dt=K.state.version,Bt=ht.getParameters(C,K.state,Et,Y,ot),Lt=ht.getProgramCacheKey(Bt);let Jt=lt.programs;lt.environment=C.isMeshStandardMaterial?Y.environment:null,lt.fog=Y.fog,lt.envMap=(C.isMeshStandardMaterial?Ze:je).get(C.envMap||lt.environment),lt.envMapRotation=lt.environment!==null&&C.envMap===null?Y.environmentRotation:C.envMapRotation,Jt===void 0&&(C.addEventListener("dispose",xt),Jt=new Map,lt.programs=Jt);let te=Jt.get(Lt);if(te!==void 0){if(lt.currentProgram===te&&lt.lightsStateVersion===Dt)return ma(C,Bt),te}else Bt.uniforms=ht.getUniforms(C),C.onBeforeCompile(Bt,A),te=ht.acquireProgram(Bt,Lt),Jt.set(Lt,te),lt.uniforms=Bt.uniforms;const Xt=lt.uniforms;return(!C.isShaderMaterial&&!C.isRawShaderMaterial||C.clipping===!0)&&(Xt.clippingPlanes=Rt.uniform),ma(C,Bt),lt.needsLights=Ya(C),lt.lightsStateVersion=Dt,lt.needsLights&&(Xt.ambientLightColor.value=K.state.ambient,Xt.lightProbe.value=K.state.probe,Xt.directionalLights.value=K.state.directional,Xt.directionalLightShadows.value=K.state.directionalShadow,Xt.spotLights.value=K.state.spot,Xt.spotLightShadows.value=K.state.spotShadow,Xt.rectAreaLights.value=K.state.rectArea,Xt.ltc_1.value=K.state.rectAreaLTC1,Xt.ltc_2.value=K.state.rectAreaLTC2,Xt.pointLights.value=K.state.point,Xt.pointLightShadows.value=K.state.pointShadow,Xt.hemisphereLights.value=K.state.hemi,Xt.directionalShadowMap.value=K.state.directionalShadowMap,Xt.directionalShadowMatrix.value=K.state.directionalShadowMatrix,Xt.spotShadowMap.value=K.state.spotShadowMap,Xt.spotLightMatrix.value=K.state.spotLightMatrix,Xt.spotLightMap.value=K.state.spotLightMap,Xt.pointShadowMap.value=K.state.pointShadowMap,Xt.pointShadowMatrix.value=K.state.pointShadowMatrix),lt.currentProgram=te,lt.uniformsList=null,te}function Es(C){if(C.uniformsList===null){const Y=C.currentProgram.getUniforms();C.uniformsList=of.seqWithValue(Y.seq,C.uniforms)}return C.uniformsList}function ma(C,Y){const ot=Gt.get(C);ot.outputColorSpace=Y.outputColorSpace,ot.batching=Y.batching,ot.batchingColor=Y.batchingColor,ot.instancing=Y.instancing,ot.instancingColor=Y.instancingColor,ot.instancingMorph=Y.instancingMorph,ot.skinning=Y.skinning,ot.morphTargets=Y.morphTargets,ot.morphNormals=Y.morphNormals,ot.morphColors=Y.morphColors,ot.morphTargetsCount=Y.morphTargetsCount,ot.numClippingPlanes=Y.numClippingPlanes,ot.numIntersection=Y.numClipIntersection,ot.vertexAlphas=Y.vertexAlphas,ot.vertexTangents=Y.vertexTangents,ot.toneMapping=Y.toneMapping}function qa(C,Y,ot,lt,K){Y.isScene!==!0&&(Y=Wt),se.resetTextureUnits();const Et=Y.fog,Dt=lt.isMeshStandardMaterial?Y.environment:null,Bt=F===null?A.outputColorSpace:F.isXRRenderTarget===!0?F.texture.colorSpace:Lo,Lt=(lt.isMeshStandardMaterial?Ze:je).get(lt.envMap||Dt),Jt=lt.vertexColors===!0&&!!ot.attributes.color&&ot.attributes.color.itemSize===4,te=!!ot.attributes.tangent&&(!!lt.normalMap||lt.anisotropy>0),Xt=!!ot.morphAttributes.position,fe=!!ot.morphAttributes.normal,Ae=!!ot.morphAttributes.color;let We=Rr;lt.toneMapped&&(F===null||F.isXRRenderTarget===!0)&&(We=A.toneMapping);const Oe=ot.morphAttributes.position||ot.morphAttributes.normal||ot.morphAttributes.color,he=Oe!==void 0?Oe.length:0,Qt=Gt.get(lt),Xe=y.state.lights;if(Nt===!0&&(nt===!0||C!==O)){const en=C===O&&lt.id===b;Rt.setState(lt,C,en)}let ge=!1;lt.version===Qt.__version?(Qt.needsLights&&Qt.lightsStateVersion!==Xe.state.version||Qt.outputColorSpace!==Bt||K.isBatchedMesh&&Qt.batching===!1||!K.isBatchedMesh&&Qt.batching===!0||K.isBatchedMesh&&Qt.batchingColor===!0&&K.colorTexture===null||K.isBatchedMesh&&Qt.batchingColor===!1&&K.colorTexture!==null||K.isInstancedMesh&&Qt.instancing===!1||!K.isInstancedMesh&&Qt.instancing===!0||K.isSkinnedMesh&&Qt.skinning===!1||!K.isSkinnedMesh&&Qt.skinning===!0||K.isInstancedMesh&&Qt.instancingColor===!0&&K.instanceColor===null||K.isInstancedMesh&&Qt.instancingColor===!1&&K.instanceColor!==null||K.isInstancedMesh&&Qt.instancingMorph===!0&&K.morphTexture===null||K.isInstancedMesh&&Qt.instancingMorph===!1&&K.morphTexture!==null||Qt.envMap!==Lt||lt.fog===!0&&Qt.fog!==Et||Qt.numClippingPlanes!==void 0&&(Qt.numClippingPlanes!==Rt.numPlanes||Qt.numIntersection!==Rt.numIntersection)||Qt.vertexAlphas!==Jt||Qt.vertexTangents!==te||Qt.morphTargets!==Xt||Qt.morphNormals!==fe||Qt.morphColors!==Ae||Qt.toneMapping!==We||Qt.morphTargetsCount!==he)&&(ge=!0):(ge=!0,Qt.__version=lt.version);let zn=Qt.currentProgram;ge===!0&&(zn=ta(lt,Y,K));let Vi=!1,Xn=!1,En=!1;const Be=zn.getUniforms(),Wn=Qt.uniforms;if(Pt.useProgram(zn.program)&&(Vi=!0,Xn=!0,En=!0),lt.id!==b&&(b=lt.id,Xn=!0),Vi||O!==C){Pt.buffers.depth.getReversed()&&C.reversedDepth!==!0&&(C._reversedDepth=!0,C.updateProjectionMatrix()),Be.setValue(G,"projectionMatrix",C.projectionMatrix),Be.setValue(G,"viewMatrix",C.matrixWorldInverse);const Dn=Be.map.cameraPosition;Dn!==void 0&&Dn.setValue(G,At.setFromMatrixPosition(C.matrixWorld)),ne.logarithmicDepthBuffer&&Be.setValue(G,"logDepthBufFC",2/(Math.log(C.far+1)/Math.LN2)),(lt.isMeshPhongMaterial||lt.isMeshToonMaterial||lt.isMeshLambertMaterial||lt.isMeshBasicMaterial||lt.isMeshStandardMaterial||lt.isShaderMaterial)&&Be.setValue(G,"isOrthographic",C.isOrthographicCamera===!0),O!==C&&(O=C,Xn=!0,En=!0)}if(K.isSkinnedMesh){Be.setOptional(G,K,"bindMatrix"),Be.setOptional(G,K,"bindMatrixInverse");const en=K.skeleton;en&&(en.boneTexture===null&&en.computeBoneTexture(),Be.setValue(G,"boneTexture",en.boneTexture,se))}K.isBatchedMesh&&(Be.setOptional(G,K,"batchingTexture"),Be.setValue(G,"batchingTexture",K._matricesTexture,se),Be.setOptional(G,K,"batchingIdTexture"),Be.setValue(G,"batchingIdTexture",K._indirectTexture,se),Be.setOptional(G,K,"batchingColorTexture"),K._colorsTexture!==null&&Be.setValue(G,"batchingColorTexture",K._colorsTexture,se));const In=ot.morphAttributes;if((In.position!==void 0||In.normal!==void 0||In.color!==void 0)&&St.update(K,ot,zn),(Xn||Qt.receiveShadow!==K.receiveShadow)&&(Qt.receiveShadow=K.receiveShadow,Be.setValue(G,"receiveShadow",K.receiveShadow)),lt.isMeshGouraudMaterial&&lt.envMap!==null&&(Wn.envMap.value=Lt,Wn.flipEnvMap.value=Lt.isCubeTexture&&Lt.isRenderTargetTexture===!1?-1:1),lt.isMeshStandardMaterial&&lt.envMap===null&&Y.environment!==null&&(Wn.envMapIntensity.value=Y.environmentIntensity),Xn&&(Be.setValue(G,"toneMappingExposure",A.toneMappingExposure),Qt.needsLights&&Or(Wn,En),Et&&lt.fog===!0&&_t.refreshFogUniforms(Wn,Et),_t.refreshMaterialUniforms(Wn,lt,X,k,y.state.transmissionRenderTarget[C.id]),of.upload(G,Es(Qt),Wn,se)),lt.isShaderMaterial&&lt.uniformsNeedUpdate===!0&&(of.upload(G,Es(Qt),Wn,se),lt.uniformsNeedUpdate=!1),lt.isSpriteMaterial&&Be.setValue(G,"center",K.center),Be.setValue(G,"modelViewMatrix",K.modelViewMatrix),Be.setValue(G,"normalMatrix",K.normalMatrix),Be.setValue(G,"modelMatrix",K.matrixWorld),lt.isShaderMaterial||lt.isRawShaderMaterial){const en=lt.uniformsGroups;for(let Dn=0,Ts=en.length;Dn<Ts;Dn++){const Qn=en[Dn];oe.update(Qn,zn),oe.bind(Qn,zn)}}return zn}function Or(C,Y){C.ambientLightColor.needsUpdate=Y,C.lightProbe.needsUpdate=Y,C.directionalLights.needsUpdate=Y,C.directionalLightShadows.needsUpdate=Y,C.pointLights.needsUpdate=Y,C.pointLightShadows.needsUpdate=Y,C.spotLights.needsUpdate=Y,C.spotLightShadows.needsUpdate=Y,C.rectAreaLights.needsUpdate=Y,C.hemisphereLights.needsUpdate=Y}function Ya(C){return C.isMeshLambertMaterial||C.isMeshToonMaterial||C.isMeshPhongMaterial||C.isMeshStandardMaterial||C.isShadowMaterial||C.isShaderMaterial&&C.lights===!0}this.getActiveCubeFace=function(){return P},this.getActiveMipmapLevel=function(){return z},this.getRenderTarget=function(){return F},this.setRenderTargetTextures=function(C,Y,ot){const lt=Gt.get(C);lt.__autoAllocateDepthBuffer=C.resolveDepthBuffer===!1,lt.__autoAllocateDepthBuffer===!1&&(lt.__useRenderToTexture=!1),Gt.get(C.texture).__webglTexture=Y,Gt.get(C.depthTexture).__webglTexture=lt.__autoAllocateDepthBuffer?void 0:ot,lt.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(C,Y){const ot=Gt.get(C);ot.__webglFramebuffer=Y,ot.__useDefaultFramebuffer=Y===void 0};const fn=G.createFramebuffer();this.setRenderTarget=function(C,Y=0,ot=0){F=C,P=Y,z=ot;let lt=!0,K=null,Et=!1,Dt=!1;if(C){const Lt=Gt.get(C);if(Lt.__useDefaultFramebuffer!==void 0)Pt.bindFramebuffer(G.FRAMEBUFFER,null),lt=!1;else if(Lt.__webglFramebuffer===void 0)se.setupRenderTarget(C);else if(Lt.__hasExternalTextures)se.rebindTextures(C,Gt.get(C.texture).__webglTexture,Gt.get(C.depthTexture).__webglTexture);else if(C.depthBuffer){const Xt=C.depthTexture;if(Lt.__boundDepthTexture!==Xt){if(Xt!==null&&Gt.has(Xt)&&(C.width!==Xt.image.width||C.height!==Xt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");se.setupDepthRenderbuffer(C)}}const Jt=C.texture;(Jt.isData3DTexture||Jt.isDataArrayTexture||Jt.isCompressedArrayTexture)&&(Dt=!0);const te=Gt.get(C).__webglFramebuffer;C.isWebGLCubeRenderTarget?(Array.isArray(te[Y])?K=te[Y][ot]:K=te[Y],Et=!0):C.samples>0&&se.useMultisampledRTT(C)===!1?K=Gt.get(C).__webglMultisampledFramebuffer:Array.isArray(te)?K=te[ot]:K=te,V.copy(C.viewport),j.copy(C.scissor),tt=C.scissorTest}else V.copy(Q).multiplyScalar(X).floor(),j.copy(mt).multiplyScalar(X).floor(),tt=yt;if(ot!==0&&(K=fn),Pt.bindFramebuffer(G.FRAMEBUFFER,K)&&lt&&Pt.drawBuffers(C,K),Pt.viewport(V),Pt.scissor(j),Pt.setScissorTest(tt),Et){const Lt=Gt.get(C.texture);G.framebufferTexture2D(G.FRAMEBUFFER,G.COLOR_ATTACHMENT0,G.TEXTURE_CUBE_MAP_POSITIVE_X+Y,Lt.__webglTexture,ot)}else if(Dt){const Lt=Y;for(let Jt=0;Jt<C.textures.length;Jt++){const te=Gt.get(C.textures[Jt]);G.framebufferTextureLayer(G.FRAMEBUFFER,G.COLOR_ATTACHMENT0+Jt,te.__webglTexture,ot,Lt)}}else if(C!==null&&ot!==0){const Lt=Gt.get(C.texture);G.framebufferTexture2D(G.FRAMEBUFFER,G.COLOR_ATTACHMENT0,G.TEXTURE_2D,Lt.__webglTexture,ot)}b=-1},this.readRenderTargetPixels=function(C,Y,ot,lt,K,Et,Dt,Bt=0){if(!(C&&C.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Lt=Gt.get(C).__webglFramebuffer;if(C.isWebGLCubeRenderTarget&&Dt!==void 0&&(Lt=Lt[Dt]),Lt){Pt.bindFramebuffer(G.FRAMEBUFFER,Lt);try{const Jt=C.textures[Bt],te=Jt.format,Xt=Jt.type;if(!ne.textureFormatReadable(te)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ne.textureTypeReadable(Xt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}Y>=0&&Y<=C.width-lt&&ot>=0&&ot<=C.height-K&&(C.textures.length>1&&G.readBuffer(G.COLOR_ATTACHMENT0+Bt),G.readPixels(Y,ot,lt,K,Vt.convert(te),Vt.convert(Xt),Et))}finally{const Jt=F!==null?Gt.get(F).__webglFramebuffer:null;Pt.bindFramebuffer(G.FRAMEBUFFER,Jt)}}},this.readRenderTargetPixelsAsync=async function(C,Y,ot,lt,K,Et,Dt,Bt=0){if(!(C&&C.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Lt=Gt.get(C).__webglFramebuffer;if(C.isWebGLCubeRenderTarget&&Dt!==void 0&&(Lt=Lt[Dt]),Lt)if(Y>=0&&Y<=C.width-lt&&ot>=0&&ot<=C.height-K){Pt.bindFramebuffer(G.FRAMEBUFFER,Lt);const Jt=C.textures[Bt],te=Jt.format,Xt=Jt.type;if(!ne.textureFormatReadable(te))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ne.textureTypeReadable(Xt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const fe=G.createBuffer();G.bindBuffer(G.PIXEL_PACK_BUFFER,fe),G.bufferData(G.PIXEL_PACK_BUFFER,Et.byteLength,G.STREAM_READ),C.textures.length>1&&G.readBuffer(G.COLOR_ATTACHMENT0+Bt),G.readPixels(Y,ot,lt,K,Vt.convert(te),Vt.convert(Xt),0);const Ae=F!==null?Gt.get(F).__webglFramebuffer:null;Pt.bindFramebuffer(G.FRAMEBUFFER,Ae);const We=G.fenceSync(G.SYNC_GPU_COMMANDS_COMPLETE,0);return G.flush(),await KT(G,We,4),G.bindBuffer(G.PIXEL_PACK_BUFFER,fe),G.getBufferSubData(G.PIXEL_PACK_BUFFER,0,Et),G.deleteBuffer(fe),G.deleteSync(We),Et}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(C,Y=null,ot=0){const lt=Math.pow(2,-ot),K=Math.floor(C.image.width*lt),Et=Math.floor(C.image.height*lt),Dt=Y!==null?Y.x:0,Bt=Y!==null?Y.y:0;se.setTexture2D(C,0),G.copyTexSubImage2D(G.TEXTURE_2D,ot,0,0,Dt,Bt,K,Et),Pt.unbindTexture()};const yu=G.createFramebuffer(),Su=G.createFramebuffer();this.copyTextureToTexture=function(C,Y,ot=null,lt=null,K=0,Et=null){Et===null&&(K!==0?(ru("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Et=K,K=0):Et=0);let Dt,Bt,Lt,Jt,te,Xt,fe,Ae,We;const Oe=C.isCompressedTexture?C.mipmaps[Et]:C.image;if(ot!==null)Dt=ot.max.x-ot.min.x,Bt=ot.max.y-ot.min.y,Lt=ot.isBox3?ot.max.z-ot.min.z:1,Jt=ot.min.x,te=ot.min.y,Xt=ot.isBox3?ot.min.z:0;else{const In=Math.pow(2,-K);Dt=Math.floor(Oe.width*In),Bt=Math.floor(Oe.height*In),C.isDataArrayTexture?Lt=Oe.depth:C.isData3DTexture?Lt=Math.floor(Oe.depth*In):Lt=1,Jt=0,te=0,Xt=0}lt!==null?(fe=lt.x,Ae=lt.y,We=lt.z):(fe=0,Ae=0,We=0);const he=Vt.convert(Y.format),Qt=Vt.convert(Y.type);let Xe;Y.isData3DTexture?(se.setTexture3D(Y,0),Xe=G.TEXTURE_3D):Y.isDataArrayTexture||Y.isCompressedArrayTexture?(se.setTexture2DArray(Y,0),Xe=G.TEXTURE_2D_ARRAY):(se.setTexture2D(Y,0),Xe=G.TEXTURE_2D),G.pixelStorei(G.UNPACK_FLIP_Y_WEBGL,Y.flipY),G.pixelStorei(G.UNPACK_PREMULTIPLY_ALPHA_WEBGL,Y.premultiplyAlpha),G.pixelStorei(G.UNPACK_ALIGNMENT,Y.unpackAlignment);const ge=G.getParameter(G.UNPACK_ROW_LENGTH),zn=G.getParameter(G.UNPACK_IMAGE_HEIGHT),Vi=G.getParameter(G.UNPACK_SKIP_PIXELS),Xn=G.getParameter(G.UNPACK_SKIP_ROWS),En=G.getParameter(G.UNPACK_SKIP_IMAGES);G.pixelStorei(G.UNPACK_ROW_LENGTH,Oe.width),G.pixelStorei(G.UNPACK_IMAGE_HEIGHT,Oe.height),G.pixelStorei(G.UNPACK_SKIP_PIXELS,Jt),G.pixelStorei(G.UNPACK_SKIP_ROWS,te),G.pixelStorei(G.UNPACK_SKIP_IMAGES,Xt);const Be=C.isDataArrayTexture||C.isData3DTexture,Wn=Y.isDataArrayTexture||Y.isData3DTexture;if(C.isDepthTexture){const In=Gt.get(C),en=Gt.get(Y),Dn=Gt.get(In.__renderTarget),Ts=Gt.get(en.__renderTarget);Pt.bindFramebuffer(G.READ_FRAMEBUFFER,Dn.__webglFramebuffer),Pt.bindFramebuffer(G.DRAW_FRAMEBUFFER,Ts.__webglFramebuffer);for(let Qn=0;Qn<Lt;Qn++)Be&&(G.framebufferTextureLayer(G.READ_FRAMEBUFFER,G.COLOR_ATTACHMENT0,Gt.get(C).__webglTexture,K,Xt+Qn),G.framebufferTextureLayer(G.DRAW_FRAMEBUFFER,G.COLOR_ATTACHMENT0,Gt.get(Y).__webglTexture,Et,We+Qn)),G.blitFramebuffer(Jt,te,Dt,Bt,fe,Ae,Dt,Bt,G.DEPTH_BUFFER_BIT,G.NEAREST);Pt.bindFramebuffer(G.READ_FRAMEBUFFER,null),Pt.bindFramebuffer(G.DRAW_FRAMEBUFFER,null)}else if(K!==0||C.isRenderTargetTexture||Gt.has(C)){const In=Gt.get(C),en=Gt.get(Y);Pt.bindFramebuffer(G.READ_FRAMEBUFFER,yu),Pt.bindFramebuffer(G.DRAW_FRAMEBUFFER,Su);for(let Dn=0;Dn<Lt;Dn++)Be?G.framebufferTextureLayer(G.READ_FRAMEBUFFER,G.COLOR_ATTACHMENT0,In.__webglTexture,K,Xt+Dn):G.framebufferTexture2D(G.READ_FRAMEBUFFER,G.COLOR_ATTACHMENT0,G.TEXTURE_2D,In.__webglTexture,K),Wn?G.framebufferTextureLayer(G.DRAW_FRAMEBUFFER,G.COLOR_ATTACHMENT0,en.__webglTexture,Et,We+Dn):G.framebufferTexture2D(G.DRAW_FRAMEBUFFER,G.COLOR_ATTACHMENT0,G.TEXTURE_2D,en.__webglTexture,Et),K!==0?G.blitFramebuffer(Jt,te,Dt,Bt,fe,Ae,Dt,Bt,G.COLOR_BUFFER_BIT,G.NEAREST):Wn?G.copyTexSubImage3D(Xe,Et,fe,Ae,We+Dn,Jt,te,Dt,Bt):G.copyTexSubImage2D(Xe,Et,fe,Ae,Jt,te,Dt,Bt);Pt.bindFramebuffer(G.READ_FRAMEBUFFER,null),Pt.bindFramebuffer(G.DRAW_FRAMEBUFFER,null)}else Wn?C.isDataTexture||C.isData3DTexture?G.texSubImage3D(Xe,Et,fe,Ae,We,Dt,Bt,Lt,he,Qt,Oe.data):Y.isCompressedArrayTexture?G.compressedTexSubImage3D(Xe,Et,fe,Ae,We,Dt,Bt,Lt,he,Oe.data):G.texSubImage3D(Xe,Et,fe,Ae,We,Dt,Bt,Lt,he,Qt,Oe):C.isDataTexture?G.texSubImage2D(G.TEXTURE_2D,Et,fe,Ae,Dt,Bt,he,Qt,Oe.data):C.isCompressedTexture?G.compressedTexSubImage2D(G.TEXTURE_2D,Et,fe,Ae,Oe.width,Oe.height,he,Oe.data):G.texSubImage2D(G.TEXTURE_2D,Et,fe,Ae,Dt,Bt,he,Qt,Oe);G.pixelStorei(G.UNPACK_ROW_LENGTH,ge),G.pixelStorei(G.UNPACK_IMAGE_HEIGHT,zn),G.pixelStorei(G.UNPACK_SKIP_PIXELS,Vi),G.pixelStorei(G.UNPACK_SKIP_ROWS,Xn),G.pixelStorei(G.UNPACK_SKIP_IMAGES,En),Et===0&&Y.generateMipmaps&&G.generateMipmap(Xe),Pt.unbindTexture()},this.initRenderTarget=function(C){Gt.get(C).__webglFramebuffer===void 0&&se.setupRenderTarget(C)},this.initTexture=function(C){C.isCubeTexture?se.setTextureCube(C,0):C.isData3DTexture?se.setTexture3D(C,0):C.isDataArrayTexture||C.isCompressedArrayTexture?se.setTexture2DArray(C,0):se.setTexture2D(C,0),Pt.unbindTexture()},this.resetState=function(){P=0,z=0,F=null,Pt.reset(),Ct.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ca}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=ye._getDrawingBufferColorSpace(t),e.unpackColorSpace=ye._getUnpackColorSpace()}}const MC=/^[og]\s*(.+)?/,EC=/^mtllib /,TC=/^usemtl /,bC=/^usemap /,jx=/\s+/,Zx=new it,vp=new it,Kx=new it,Qx=new it,Pi=new it,$c=new ce;function AC(){const o={objects:[],object:{},vertices:[],normals:[],colors:[],uvs:[],materials:{},materialLibraries:[],startObject:function(t,e){if(this.object&&this.object.fromDeclaration===!1){this.object.name=t,this.object.fromDeclaration=e!==!1;return}const a=this.object&&typeof this.object.currentMaterial=="function"?this.object.currentMaterial():void 0;if(this.object&&typeof this.object._finalize=="function"&&this.object._finalize(!0),this.object={name:t||"",fromDeclaration:e!==!1,geometry:{vertices:[],normals:[],colors:[],uvs:[],hasUVIndices:!1},materials:[],smooth:!0,startMaterial:function(r,l){const c=this._finalize(!1);c&&(c.inherited||c.groupCount<=0)&&this.materials.splice(c.index,1);const f={index:this.materials.length,name:r||"",mtllib:Array.isArray(l)&&l.length>0?l[l.length-1]:"",smooth:c!==void 0?c.smooth:this.smooth,groupStart:c!==void 0?c.groupEnd:0,groupEnd:-1,groupCount:-1,inherited:!1,clone:function(p){const h={index:typeof p=="number"?p:this.index,name:this.name,mtllib:this.mtllib,smooth:this.smooth,groupStart:0,groupEnd:-1,groupCount:-1,inherited:!1};return h.clone=this.clone.bind(h),h}};return this.materials.push(f),f},currentMaterial:function(){if(this.materials.length>0)return this.materials[this.materials.length-1]},_finalize:function(r){const l=this.currentMaterial();if(l&&l.groupEnd===-1&&(l.groupEnd=this.geometry.vertices.length/3,l.groupCount=l.groupEnd-l.groupStart,l.inherited=!1),r&&this.materials.length>1)for(let c=this.materials.length-1;c>=0;c--)this.materials[c].groupCount<=0&&this.materials.splice(c,1);return r&&this.materials.length===0&&this.materials.push({name:"",smooth:this.smooth}),l}},a&&a.name&&typeof a.clone=="function"){const r=a.clone(0);r.inherited=!0,this.object.materials.push(r)}this.objects.push(this.object)},finalize:function(){this.object&&typeof this.object._finalize=="function"&&this.object._finalize(!0)},parseVertexIndex:function(t,e){const a=parseInt(t,10);return(a>=0?a-1:a+e/3)*3},parseNormalIndex:function(t,e){const a=parseInt(t,10);return(a>=0?a-1:a+e/3)*3},parseUVIndex:function(t,e){const a=parseInt(t,10);return(a>=0?a-1:a+e/2)*2},addVertex:function(t,e,a){const r=this.vertices,l=this.object.geometry.vertices;l.push(r[t+0],r[t+1],r[t+2]),l.push(r[e+0],r[e+1],r[e+2]),l.push(r[a+0],r[a+1],r[a+2])},addVertexPoint:function(t){const e=this.vertices;this.object.geometry.vertices.push(e[t+0],e[t+1],e[t+2])},addVertexLine:function(t){const e=this.vertices;this.object.geometry.vertices.push(e[t+0],e[t+1],e[t+2])},addNormal:function(t,e,a){const r=this.normals,l=this.object.geometry.normals;l.push(r[t+0],r[t+1],r[t+2]),l.push(r[e+0],r[e+1],r[e+2]),l.push(r[a+0],r[a+1],r[a+2])},addFaceNormal:function(t,e,a){const r=this.vertices,l=this.object.geometry.normals;Zx.fromArray(r,t),vp.fromArray(r,e),Kx.fromArray(r,a),Pi.subVectors(Kx,vp),Qx.subVectors(Zx,vp),Pi.cross(Qx),Pi.normalize(),l.push(Pi.x,Pi.y,Pi.z),l.push(Pi.x,Pi.y,Pi.z),l.push(Pi.x,Pi.y,Pi.z)},addColor:function(t,e,a){const r=this.colors,l=this.object.geometry.colors;r[t]!==void 0&&l.push(r[t+0],r[t+1],r[t+2]),r[e]!==void 0&&l.push(r[e+0],r[e+1],r[e+2]),r[a]!==void 0&&l.push(r[a+0],r[a+1],r[a+2])},addUV:function(t,e,a){const r=this.uvs,l=this.object.geometry.uvs;l.push(r[t+0],r[t+1]),l.push(r[e+0],r[e+1]),l.push(r[a+0],r[a+1])},addDefaultUV:function(){const t=this.object.geometry.uvs;t.push(0,0),t.push(0,0),t.push(0,0)},addUVLine:function(t){const e=this.uvs;this.object.geometry.uvs.push(e[t+0],e[t+1])},addFace:function(t,e,a,r,l,c,f,p,h){const m=this.vertices.length;let g=this.parseVertexIndex(t,m),v=this.parseVertexIndex(e,m),x=this.parseVertexIndex(a,m);if(this.addVertex(g,v,x),this.addColor(g,v,x),f!==void 0&&f!==""){const E=this.normals.length;g=this.parseNormalIndex(f,E),v=this.parseNormalIndex(p,E),x=this.parseNormalIndex(h,E),this.addNormal(g,v,x)}else this.addFaceNormal(g,v,x);if(r!==void 0&&r!==""){const E=this.uvs.length;g=this.parseUVIndex(r,E),v=this.parseUVIndex(l,E),x=this.parseUVIndex(c,E),this.addUV(g,v,x),this.object.geometry.hasUVIndices=!0}else this.addDefaultUV()},addPointGeometry:function(t){this.object.geometry.type="Points";const e=this.vertices.length;for(let a=0,r=t.length;a<r;a++){const l=this.parseVertexIndex(t[a],e);this.addVertexPoint(l),this.addColor(l)}},addLineGeometry:function(t,e){this.object.geometry.type="Line";const a=this.vertices.length,r=this.uvs.length;for(let l=0,c=t.length;l<c;l++)this.addVertexLine(this.parseVertexIndex(t[l],a));for(let l=0,c=e.length;l<c;l++)this.addUVLine(this.parseUVIndex(e[l],r))}};return o.startObject("",!1),o}class Jx extends Go{constructor(t){super(t),this.materials=null}load(t,e,a,r){const l=this,c=new Gy(this.manager);c.setPath(this.path),c.setRequestHeader(this.requestHeader),c.setWithCredentials(this.withCredentials),c.load(t,function(f){try{e(l.parse(f))}catch(p){r?r(p):console.error(p),l.manager.itemError(t)}},a,r)}setMaterials(t){return this.materials=t,this}parse(t){const e=new AC;t.indexOf(`\r
`)!==-1&&(t=t.replace(/\r\n/g,`
`)),t.indexOf(`\\
`)!==-1&&(t=t.replace(/\\\n/g,""));const a=t.split(`
`);let r=[];for(let f=0,p=a.length;f<p;f++){const h=a[f].trimStart();if(h.length===0)continue;const m=h.charAt(0);if(m!=="#")if(m==="v"){const g=h.split(jx);switch(g[0]){case"v":e.vertices.push(parseFloat(g[1]),parseFloat(g[2]),parseFloat(g[3])),g.length>=7?($c.setRGB(parseFloat(g[4]),parseFloat(g[5]),parseFloat(g[6]),Nn),e.colors.push($c.r,$c.g,$c.b)):e.colors.push(void 0,void 0,void 0);break;case"vn":e.normals.push(parseFloat(g[1]),parseFloat(g[2]),parseFloat(g[3]));break;case"vt":e.uvs.push(parseFloat(g[1]),parseFloat(g[2]));break}}else if(m==="f"){const v=h.slice(1).trim().split(jx),x=[];for(let M=0,S=v.length;M<S;M++){const y=v[M];if(y.length>0){const D=y.split("/");x.push(D)}}const E=x[0];for(let M=1,S=x.length-1;M<S;M++){const y=x[M],D=x[M+1];e.addFace(E[0],y[0],D[0],E[1],y[1],D[1],E[2],y[2],D[2])}}else if(m==="l"){const g=h.substring(1).trim().split(" ");let v=[];const x=[];if(h.indexOf("/")===-1)v=g;else for(let E=0,M=g.length;E<M;E++){const S=g[E].split("/");S[0]!==""&&v.push(S[0]),S[1]!==""&&x.push(S[1])}e.addLineGeometry(v,x)}else if(m==="p"){const v=h.slice(1).trim().split(" ");e.addPointGeometry(v)}else if((r=MC.exec(h))!==null){const g=(" "+r[0].slice(1).trim()).slice(1);e.startObject(g)}else if(TC.test(h))e.object.startMaterial(h.substring(7).trim(),e.materialLibraries);else if(EC.test(h))e.materialLibraries.push(h.substring(7).trim());else if(bC.test(h))console.warn('THREE.OBJLoader: Rendering identifier "usemap" not supported. Textures must be defined in MTL files.');else if(m==="s"){if(r=h.split(" "),r.length>1){const v=r[1].trim().toLowerCase();e.object.smooth=v!=="0"&&v!=="off"}else e.object.smooth=!0;const g=e.object.currentMaterial();g&&(g.smooth=e.object.smooth)}else{if(h==="\0")continue;console.warn('THREE.OBJLoader: Unexpected line: "'+h+'"')}}e.finalize();const l=new xo;if(l.materialLibraries=[].concat(e.materialLibraries),!(e.objects.length===1&&e.objects[0].geometry.vertices.length===0)===!0)for(let f=0,p=e.objects.length;f<p;f++){const h=e.objects[f],m=h.geometry,g=h.materials,v=m.type==="Line",x=m.type==="Points";let E=!1;if(m.vertices.length===0)continue;const M=new Ti;M.setAttribute("position",new jn(m.vertices,3)),m.normals.length>0&&M.setAttribute("normal",new jn(m.normals,3)),m.colors.length>0&&(E=!0,M.setAttribute("color",new jn(m.colors,3))),m.hasUVIndices===!0&&M.setAttribute("uv",new jn(m.uvs,2));const S=[];for(let D=0,U=g.length;D<U;D++){const A=g[D],L=A.name+"_"+A.smooth+"_"+E;let P=e.materials[L];if(this.materials!==null){if(P=this.materials.create(A.name),v&&P&&!(P instanceof sf)){const z=new sf;da.prototype.copy.call(z,P),z.color.copy(P.color),P=z}else if(x&&P&&!(P instanceof yo)){const z=new yo({size:10,sizeAttenuation:!1});da.prototype.copy.call(z,P),z.color.copy(P.color),z.map=P.map,P=z}}P===void 0&&(v?P=new sf:x?P=new yo({size:1,sizeAttenuation:!1}):P=new Fy,P.name=A.name,P.flatShading=!A.smooth,P.vertexColors=E,e.materials[L]=P),S.push(P)}let y;if(S.length>1){for(let D=0,U=g.length;D<U;D++){const A=g[D];M.addGroup(A.groupStart,A.groupCount,D)}v?y=new vx(M,S):x?y=new jl(M,S):y=new yi(M,S)}else v?y=new vx(M,S[0]):x?y=new jl(M,S[0]):y=new yi(M,S[0]);y.name=h.name,l.add(y)}else if(e.vertices.length>0){const f=new yo({size:1,sizeAttenuation:!1}),p=new Ti;p.setAttribute("position",new jn(e.vertices,3)),e.colors.length>0&&e.colors[0]!==void 0&&(p.setAttribute("color",new jn(e.colors,3)),f.vertexColors=!0);const h=new jl(p,f);l.add(h)}return l}}class RC extends Go{constructor(t){super(t)}load(t,e,a,r){const l=this,c=this.path===""?z1.extractUrlBase(t):this.path,f=new Gy(this.manager);f.setPath(this.path),f.setRequestHeader(this.requestHeader),f.setWithCredentials(this.withCredentials),f.load(t,function(p){try{e(l.parse(p,c))}catch(h){r?r(h):console.error(h),l.manager.itemError(t)}},a,r)}setMaterialOptions(t){return this.materialOptions=t,this}parse(t,e){const a=t.split(`
...
*/var Ei={autoSleep:120,force3D:"auto",nullTargetWarn:1,units:{lineHeight:""}},No={duration:.5,overwrite:!1,delay:0},Wm,Pn,Ye,Bi=1e8,Ge=1/Bi,_m=Math.PI*2,CC=_m/4,DC=0,Ky=Math.sqrt,UC=Math.cos,LC=Math.sin,Cn=function(t){return typeof t=="string"},sn=function(t){return typeof t=="function"},Xa=function(t){return typeof t=="number"},qm=function(t){return typeof t>"u"},pa=function(t){return typeof t=="object"},ai=function(t){return t!==!1},Ym=function(){return typeof window<"u"},tf=function(t){return sn(t)||Cn(t)},Qy=typeof ArrayBuffer=="function"&&ArrayBuffer.isView||function(){},kn=Array.isArray,gm=/(?:-?\.?\d|\.)+/gi,Jy=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,Mo=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,xp=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,$y=/[+-]=-?[.\d]+/,tS=/[^,'"\[\]\s]+/gi,OC=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,Qe,sa,vm,jm,bi={},vf={},eS,nS=function(t){return(vf=Po(t,bi))&&li},Zm=function(t,e){return console.warn("Invalid property",t,"set to",e,"Missing plugin? gsap.registerPlugin()")},su=function(t,e){return!e&&console.warn(t)},iS=function(t,e){return t&&(bi[t]=e)&&vf&&(vf[t]=e)||bi},ou=function(){return 0},NC={suppressEvents:!0,isStart:!0,kill:!1},lf={suppressEvents:!0,kill:!1},PC={suppressEvents:!0},Km={},wr=[],xm={},aS,vi={},yp={},$x=30,uf=[],Qm="",Jm=function(t){var e=t[0],a,r;if(pa(e)||sn(e)||(t=[t]),!(a=(e._gsap||{}).harness)){for(r=uf.length;r--&&!uf[r].targetTest(e););a=uf[r]}for(r=t.length;r--;)t[r]&&(t[r]._gsap||(t[r]._gsap=new wS(t[r],a)))||t.splice(r,1);return t},hs=function(t){return t._gsap||Jm(Fi(t))[0]._gsap},rS=function(t,e,a){return(a=t[e])&&sn(a)?t[e]():qm(a)&&t.getAttribute&&t.getAttribute(e)||a},ri=function(t,e){return(t=t.split(",")).forEach(e)||t},un=function(t){return Math.round(t*1e5)/1e5||0},_n=function(t){return Math.round(t*1e7)/1e7||0},Ao=function(t,e){var a=e.charAt(0),r=parseFloat(e.substr(2));return t=parseFloat(t),a==="+"?t+r:a==="-"?t-r:a==="*"?t*r:t/r},zC=function(t,e){for(var a=e.length,r=0;t.indexOf(e[r])<0&&++r<a;);return r<a},xf=function(){var t=wr.length,e=wr.slice(0),a,r;for(xm={},wr.length=0,a=0;a<t;a++)r=e[a],r&&r._lazy&&(r.render(r._lazy[0],r._lazy[1],!0)._lazy=0)},$m=function(t){return!!(t._initted||t._startAt||t.add)},sS=function(t,e,a,r){wr.length&&!Pn&&xf(),t.render(e,a,!!(Pn&&e<0&&$m(t))),wr.length&&!Pn&&xf()},oS=function(t){var e=parseFloat(t);return(e||e===0)&&(t+"").match(tS).length<2?e:Cn(t)?t.trim():t},lS=function(t){return t},Ai=function(t,e){for(var a in e)a in t||(t[a]=e[a]);return t},IC=function(t){return function(e,a){for(var r in a)r in e||r==="duration"&&t||r==="ease"||(e[r]=a[r])}},Po=function(t,e){for(var a in e)t[a]=e[a];return t},ty=function o(t,e){for(var a in e)a!=="__proto__"&&a!=="constructor"&&a!=="prototype"&&(t[a]=pa(e[a])?o(t[a]||(t[a]={}),e[a]):e[a]);return t},yf=function(t,e){var a={},r;for(r in t)r in e||(a[r]=t[r]);return a},Kl=function(t){var e=t.parent||Qe,a=t.keyframes?IC(kn(t.keyframes)):Ai;if(ai(t.inherit))for(;e;)a(t,e.vars.defaults),e=e.parent||e._dp;return t},BC=function(t,e){for(var a=t.length,r=a===e.length;r&&a--&&t[a]===e[a];);return a<0},uS=function(t,e,a,r,l){var c=t[r],f;if(l)for(f=e[l];c&&c[l]>f;)c=c._prev;return c?(e._next=c._next,c._next=e):(e._next=t[a],t[a]=e),e._next?e._next._prev=e:t[r]=e,e._prev=c,e.parent=e._dp=t,e},wf=function(t,e,a,r){a===void 0&&(a="_first"),r===void 0&&(r="_last");var l=e._prev,c=e._next;l?l._next=c:t[a]===e&&(t[a]=c),c?c._prev=l:t[r]===e&&(t[r]=l),e._next=e._prev=e.parent=null},Dr=function(t,e){t.parent&&(!e||t.parent.autoRemoveChildren)&&t.parent.remove&&t.parent.remove(t),t._act=0},ds=function(t,e){if(t&&(!e||e._end>t._dur||e._start<0))for(var a=t;a;)a._dirty=1,a=a.parent;return t},FC=function(t){for(var e=t.parent;e&&e.parent;)e._dirty=1,e.totalDuration(),e=e.parent;return t},ym=function(t,e,a,r){return t._startAt&&(Pn?t._startAt.revert(lf):t.vars.immediateRender&&!t.vars.autoRevert||t._startAt.render(e,!0,r))},HC=function o(t){return!t||t._ts&&o(t.parent)},ey=function(t){return t._repeat?zo(t._tTime,t=t.duration()+t._rDelay)*t:0},zo=function(t,e){var a=Math.floor(t=_n(t/e));return t&&a===t?a-1:a},Sf=function(t,e){return(t-e._start)*e._ts+(e._ts>=0?0:e._dirty?e.totalDuration():e._tDur)},Cf=function(t){return t._end=_n(t._start+(t._tDur/Math.abs(t._ts||t._rts||Ge)||0))},Df=function(t,e){var a=t._dp;return a&&a.smoothChildTiming&&t._ts&&(t._start=_n(a._time-(t._ts>0?e/t._ts:((t._dirty?t.totalDuration():t._tDur)-e)/-t._ts)),Cf(t),a._dirty||ds(a,t)),t},cS=function(t,e){var a;if((e._time||!e._dur&&e._initted||e._start<t._time&&(e._dur||!e.add))&&(a=Sf(t.rawTime(),e),(!e._dur||vu(0,e.totalDuration(),a)-e._tTime>Ge)&&e.render(a,!0)),ds(t,e)._dp&&t._initted&&t._time>=t._dur&&t._ts){if(t._dur<t.duration())for(a=t;a._dp;)a.rawTime()>=0&&a.totalTime(a._tTime),a=a._dp;t._zTime=-Ge}},la=function(t,e,a,r){return e.parent&&Dr(e),e._start=_n((Xa(a)?a:a||t!==Qe?zi(t,a,e):t._time)+e._delay),e._end=_n(e._start+(e.totalDuration()/Math.abs(e.timeScale())||0)),uS(t,e,"_first","_last",t._sort?"_start":0),Sm(e)||(t._recent=e),r||cS(t,e),t._ts<0&&Df(t,t._tTime),t},fS=function(t,e){return(bi.ScrollTrigger||Zm("scrollTrigger",e))&&bi.ScrollTrigger.create(e,t)},hS=function(t,e,a,r,l){if(e_(t,e,l),!t._initted)return 1;if(!a&&t._pt&&!Pn&&(t._dur&&t.vars.lazy!==!1||!t._dur&&t.vars.lazy)&&aS!==xi.frame)return wr.push(t),t._lazy=[l,r],1},GC=function o(t){var e=t.parent;return e&&e._ts&&e._initted&&!e._lock&&(e.rawTime()<0||o(e))},Sm=function(t){var e=t.data;return e==="isFromStart"||e==="isStart"},VC=function(t,e,a,r){var l=t.ratio,c=e<0||!e&&(!t._start&&GC(t)&&!(!t._initted&&Sm(t))||(t._ts<0||t._dp._ts<0)&&!Sm(t))?0:1,f=t._rDelay,p=0,h,m,g;if(f&&t._repeat&&(p=vu(0,t._tDur,e),m=zo(p,f),t._yoyo&&m&1&&(c=1-c),m!==zo(t._tTime,f)&&(l=1-c,t.vars.repeatRefresh&&t._initted&&t.invalidate())),c!==l||Pn||r||t._zTime===Ge||!e&&t._zTime){if(!t._initted&&hS(t,e,r,a,p))return;for(g=t._zTime,t._zTime=e||(a?Ge:0),a||(a=e&&!g),t.ratio=c,t._from&&(c=1-c),t._time=0,t._tTime=p,h=t._pt;h;)h.r(c,h.d),h=h._next;e<0&&ym(t,e,a,!0),t._onUpdate&&!a&&Si(t,"onUpdate"),p&&t._repeat&&!a&&t.parent&&Si(t,"onRepeat"),(e>=t._tDur||e<0)&&t.ratio===c&&(c&&Dr(t,1),!a&&!Pn&&(Si(t,c?"onComplete":"onReverseComplete",!0),t._prom&&t._prom()))}else t._zTime||(t._zTime=e)},kC=function(t,e,a){var r;if(a>e)for(r=t._first;r&&r._start<=a;){if(r.data==="isPause"&&r._start>e)return r;r=r._next}else for(r=t._last;r&&r._start>=a;){if(r.data==="isPause"&&r._start<e)return r;r=r._prev}},Io=function(t,e,a,r){var l=t._repeat,c=_n(e)||0,f=t._tTime/t._tDur;return f&&!r&&(t._time*=c/t._dur),t._dur=c,t._tDur=l?l<0?1e10:_n(c*(l+1)+t._rDelay*l):c,f>0&&!r&&Df(t,t._tTime=t._tDur*f),t.parent&&Cf(t),a||ds(t.parent,t),t},ny=function(t){return t instanceof Zn?ds(t):Io(t,t._dur)},XC={_start:0,endTime:ou,totalDuration:ou},zi=function o(t,e,a){var r=t.labels,l=t._recent||XC,c=t.duration()>=Bi?l.endTime(!1):t._dur,f,p,h;return Cn(e)&&(isNaN(e)||e in r)?(p=e.charAt(0),h=e.substr(-1)==="%",f=e.indexOf("="),p==="<"||p===">"?(f>=0&&(e=e.replace(/=/,"")),(p==="<"?l._start:l.endTime(l._repeat>=0))+(parseFloat(e.substr(1))||0)*(h?(f<0?l:a).totalDuration()/100:1)):f<0?(e in r||(r[e]=c),r[e]):(p=parseFloat(e.charAt(f-1)+e.substr(f+1)),h&&a&&(p=p/100*(kn(a)?a[0]:a).totalDuration()),f>1?o(t,e.substr(0,f-1),a)+p:c+p)):e==null?c:+e},Ql=function(t,e,a){var r=Xa(e[1]),l=(r?2:1)+(t<2?0:1),c=e[l],f,p;if(r&&(c.duration=e[1]),c.parent=a,t){for(f=c,p=a;p&&!("immediateRender"in f);)f=p.vars.defaults||{},p=ai(p.vars.inherit)&&p.parent;c.immediateRender=ai(f.immediateRender),t<2?c.runBackwards=1:c.startAt=e[l-1]}return new mn(e[0],c,e[l+1])},Lr=function(t,e){return t||t===0?e(t):e},vu=function(t,e,a){return a<t?t:a>e?e:a},Vn=function(t,e){return!Cn(t)||!(e=OC.exec(t))?"":e[1]},WC=function(t,e,a){return Lr(a,function(r){return vu(t,e,r)})},Mm=[].slice,dS=function(t,e){return t&&pa(t)&&"length"in t&&(!e&&!t.length||t.length-1 in t&&pa(t[0]))&&!t.nodeType&&t!==sa},qC=function(t,e,a){return a===void 0&&(a=[]),t.forEach(function(r){var l;return Cn(r)&&!e||dS(r,1)?(l=a).push.apply(l,Fi(r)):a.push(r)})||a},Fi=function(t,e,a){return Ye&&!e&&Ye.selector?Ye.selector(t):Cn(t)&&!a&&(vm||!Bo())?Mm.call((e||jm).querySelectorAll(t),0):kn(t)?qC(t,a):dS(t)?Mm.call(t,0):t?[t]:[]},Em=function(t){return t=Fi(t)[0]||su("Invalid scope")||{},function(e){var a=t.current||t.nativeElement||t;return Fi(e,a.querySelectorAll?a:a===t?su("Invalid scope")||jm.createElement("div"):t)}},pS=function(t){return t.sort(function(){return .5-Math.random()})},mS=function(t){if(sn(t))return t;var e=pa(t)?t:{each:t},a=ps(e.ease),r=e.from||0,l=parseFloat(e.base)||0,c={},f=r>0&&r<1,p=isNaN(r)||f,h=e.axis,m=r,g=r;return Cn(r)?m=g={center:.5,edges:.5,end:1}[r]||0:!f&&p&&(m=r[0],g=r[1]),function(v,x,E){var M=(E||e).length,S=c[M],y,D,U,A,L,P,z,F,b;if(!S){if(b=e.grid==="auto"?0:(e.grid||[1,Bi])[1],!b){for(z=-Bi;z<(z=E[b++].getBoundingClientRect().left)&&b<M;);b<M&&b--}for(S=c[M]=[],y=p?Math.min(b,M)*m-.5:r%b,D=b===Bi?0:p?M*g/b-.5:r/b|0,z=0,F=Bi,P=0;P<M;P++)U=P%b-y,A=D-(P/b|0),S[P]=L=h?Math.abs(h==="y"?A:U):Ky(U*U+A*A),L>z&&(z=L),L<F&&(F=L);r==="random"&&pS(S),S.max=z-F,S.min=F,S.v=M=(parseFloat(e.amount)||parseFloat(e.each)*(b>M?M-1:h?h==="y"?M/b:b:Math.max(b,M/b))||0)*(r==="edges"?-1:1),S.b=M<0?l-M:l,S.u=Vn(e.amount||e.each)||0,a=a&&M<0?bS(a):a}return M=(S[v]-S.min)/S.max||0,_n(S.b+(a?a(M):M)*S.v)+S.u}},Tm=function(t){var e=Math.pow(10,((t+"").split(".")[1]||"").length);return function(a){var r=_n(Math.round(parseFloat(a)/t)*t*e);return(r-r%1)/e+(Xa(a)?0:Vn(a))}},_S=function(t,e){var a=kn(t),r,l;return!a&&pa(t)&&(r=a=t.radius||Bi,t.values?(t=Fi(t.values),(l=!Xa(t[0]))&&(r*=r)):t=Tm(t.increment)),Lr(e,a?sn(t)?function(c){return l=t(c),Math.abs(l-c)<=r?l:c}:function(c){for(var f=parseFloat(l?c.x:c),p=parseFloat(l?c.y:0),h=Bi,m=0,g=t.length,v,x;g--;)l?(v=t[g].x-f,x=t[g].y-p,v=v*v+x*x):v=Math.abs(t[g]-f),v<h&&(h=v,m=g);return m=!r||h<=r?t[m]:c,l||m===c||Xa(c)?m:m+Vn(c)}:Tm(t))},gS=function(t,e,a,r){return Lr(kn(t)?!e:a===!0?!!(a=0):!r,function(){return kn(t)?t[~~(Math.random()*t.length)]:(a=a||1e-5)&&(r=a<1?Math.pow(10,(a+"").length-2):1)&&Math.floor(Math.round((t-a/2+Math.random()*(e-t+a*.99))/a)*a*r)/r})},YC=function(){for(var t=arguments.length,e=new Array(t),a=0;a<t;a++)e[a]=arguments[a];return function(r){return e.reduce(function(l,c){return c(l)},r)}},jC=function(t,e){return function(a){return t(parseFloat(a))+(e||Vn(a))}},ZC=function(t,e,a){return xS(t,e,0,1,a)},vS=function(t,e,a){return Lr(a,function(r){return t[~~e(r)]})},KC=function o(t,e,a){var r=e-t;return kn(t)?vS(t,o(0,t.length),e):Lr(a,function(l){return(r+(l-t)%r)%r+t})},QC=function o(t,e,a){var r=e-t,l=r*2;return kn(t)?vS(t,o(0,t.length-1),e):Lr(a,function(c){return c=(l+(c-t)%l)%l||0,t+(c>r?l-c:c)})},lu=function(t){for(var e=0,a="",r,l,c,f;~(r=t.indexOf("random(",e));)c=t.indexOf(")",r),f=t.charAt(r+7)==="[",l=t.substr(r+7,c-r-7).match(f?tS:gm),a+=t.substr(e,r-e)+gS(f?l:+l[0],f?0:+l[1],+l[2]||1e-5),e=c+1;return a+t.substr(e,t.length-e)},xS=function(t,e,a,r,l){var c=e-t,f=r-a;return Lr(l,function(p){return a+((p-t)/c*f||0)})},JC=function o(t,e,a,r){var l=isNaN(t+e)?0:function(x){return(1-x)*t+x*e};if(!l){var c=Cn(t),f={},p,h,m,g,v;if(a===!0&&(r=1)&&(a=null),c)t={p:t},e={p:e};else if(kn(t)&&!kn(e)){for(m=[],g=t.length,v=g-2,h=1;h<g;h++)m.push(o(t[h-1],t[h]));g--,l=function(E){E*=g;var M=Math.min(v,~~E);return m[M](E-M)},a=e}else r||(t=Po(kn(t)?[]:{},t));if(!m){for(p in e)t_.call(f,t,p,"get",e[p]);l=function(E){return a_(E,f)||(c?t.p:t)}}}return Lr(a,l)},iy=function(t,e,a){var r=t.labels,l=Bi,c,f,p;for(c in r)f=r[c]-e,f<0==!!a&&f&&l>(f=Math.abs(f))&&(p=c,l=f);return p},Si=function(t,e,a){var r=t.vars,l=r[e],c=Ye,f=t._ctx,p,h,m;if(l)return p=r[e+"Params"],h=r.callbackScope||t,a&&wr.length&&xf(),f&&(Ye=f),m=p?l.apply(h,p):l.call(h),Ye=c,m},ql=function(t){return Dr(t),t.scrollTrigger&&t.scrollTrigger.kill(!!Pn),t.progress()<1&&Si(t,"onInterrupt"),t},Eo,yS=[],SS=function(t){if(t)if(t=!t.name&&t.default||t,Ym()||t.headless){var e=t.name,a=sn(t),r=e&&!a&&t.init?function(){this._props=[]}:t,l={init:ou,render:a_,add:t_,kill:p2,modifier:d2,rawVars:0},c={targetTest:0,get:0,getSetter:i_,aliases:{},register:0};if(Bo(),t!==r){if(vi[e])return;Ai(r,Ai(yf(t,l),c)),Po(r.prototype,Po(l,yf(t,c))),vi[r.prop=e]=r,t.targetTest&&(uf.push(r),Km[e]=1),e=(e==="css"?"CSS":e.charAt(0).toUpperCase()+e.substr(1))+"Plugin"}iS(e,r),t.register&&t.register(li,r,si)}else yS.push(t)},He=255,Yl={aqua:[0,He,He],lime:[0,He,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,He],navy:[0,0,128],white:[He,He,He],olive:[128,128,0],yellow:[He,He,0],orange:[He,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[He,0,0],pink:[He,192,203],cyan:[0,He,He],transparent:[He,He,He,0]},Sp=function(t,e,a){return t+=t<0?1:t>1?-1:0,(t*6<1?e+(a-e)*t*6:t<.5?a:t*3<2?e+(a-e)*(2/3-t)*6:e)*He+.5|0},MS=function(t,e,a){var r=t?Xa(t)?[t>>16,t>>8&He,t&He]:0:Yl.black,l,c,f,p,h,m,g,v,x,E;if(!r){if(t.substr(-1)===","&&(t=t.substr(0,t.length-1)),Yl[t])r=Yl[t];else if(t.charAt(0)==="#"){if(t.length<6&&(l=t.charAt(1),c=t.charAt(2),f=t.charAt(3),t="#"+l+l+c+c+f+f+(t.length===5?t.charAt(4)+t.charAt(4):"")),t.length===9)return r=parseInt(t.substr(1,6),16),[r>>16,r>>8&He,r&He,parseInt(t.substr(7),16)/255];t=parseInt(t.substr(1),16),r=[t>>16,t>>8&He,t&He]}else if(t.substr(0,3)==="hsl"){if(r=E=t.match(gm),!e)p=+r[0]%360/360,h=+r[1]/100,m=+r[2]/100,c=m<=.5?m*(h+1):m+h-m*h,l=m*2-c,r.length>3&&(r[3]*=1),r[0]=Sp(p+1/3,l,c),r[1]=Sp(p,l,c),r[2]=Sp(p-1/3,l,c);else if(~t.indexOf("="))return r=t.match(Jy),a&&r.length<4&&(r[3]=1),r}else r=t.match(gm)||Yl.transparent;r=r.map(Number)}return e&&!E&&(l=r[0]/He,c=r[1]/He,f=r[2]/He,g=Math.max(l,c,f),v=Math.min(l,c,f),m=(g+v)/2,g===v?p=h=0:(x=g-v,h=m>.5?x/(2-g-v):x/(g+v),p=g===l?(c-f)/x+(c<f?6:0):g===c?(f-l)/x+2:(l-c)/x+4,p*=60),r[0]=~~(p+.5),r[1]=~~(h*100+.5),r[2]=~~(m*100+.5)),a&&r.length<4&&(r[3]=1),r},ES=function(t){var e=[],a=[],r=-1;return t.split(Cr).forEach(function(l){var c=l.match(Mo)||[];e.push.apply(e,c),a.push(r+=c.length+1)}),e.c=a,e},ay=function(t,e,a){var r="",l=(t+r).match(Cr),c=e?"hsla(":"rgba(",f=0,p,h,m,g;if(!l)return t;if(l=l.map(function(v){return(v=MS(v,e,1))&&c+(e?v[0]+","+v[1]+"%,"+v[2]+"%,"+v[3]:v.join(","))+")"}),a&&(m=ES(t),p=a.c,p.join(r)!==m.c.join(r)))for(h=t.replace(Cr,"1").split(Mo),g=h.length-1;f<g;f++)r+=h[f]+(~p.indexOf(f)?l.shift()||c+"0,0,0,0)":(m.length?m:l.length?l:a).shift());if(!h)for(h=t.split(Cr),g=h.length-1;f<g;f++)r+=h[f]+l[f];return r+h[g]},Cr=(function(){var o="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b",t;for(t in Yl)o+="|"+t+"\\b";return new RegExp(o+")","gi")})(),$C=/hsl[a]?\(/,TS=function(t){var e=t.join(" "),a;if(Cr.lastIndex=0,Cr.test(e))return a=$C.test(e),t[1]=ay(t[1],a),t[0]=ay(t[0],a,ES(t[1])),!0},uu,xi=(function(){var o=Date.now,t=500,e=33,a=o(),r=a,l=1e3/240,c=l,f=[],p,h,m,g,v,x,E=function M(S){var y=o()-r,D=S===!0,U,A,L,P;if((y>t||y<0)&&(a+=y-e),r+=y,L=r-a,U=L-c,(U>0||D)&&(P=++g.frame,v=L-g.time*1e3,g.time=L=L/1e3,c+=U+(U>=l?4:l-U),A=1),D||(p=h(M)),A)for(x=0;x<f.length;x++)f[x](L,v,P,S)};return g={time:0,frame:0,tick:function(){E(!0)},deltaRatio:function(S){return v/(1e3/(S||60))},wake:function(){eS&&(!vm&&Ym()&&(sa=vm=window,jm=sa.document||{},bi.gsap=li,(sa.gsapVersions||(sa.gsapVersions=[])).push(li.version),nS(vf||sa.GreenSockGlobals||!sa.gsap&&sa||{}),yS.forEach(SS)),m=typeof requestAnimationFrame<"u"&&requestAnimationFrame,p&&g.sleep(),h=m||function(S){return setTimeout(S,c-g.time*1e3+1|0)},uu=1,E(2))},sleep:function(){(m?cancelAnimationFrame:clearTimeout)(p),uu=0,h=ou},lagSmoothing:function(S,y){t=S||1/0,e=Math.min(y||33,t)},fps:function(S){l=1e3/(S||240),c=g.time*1e3+l},add:function(S,y,D){var U=y?function(A,L,P,z){S(A,L,P,z),g.remove(U)}:S;return g.remove(S),f[D?"unshift":"push"](U),Bo(),U},remove:function(S,y){~(y=f.indexOf(S))&&f.splice(y,1)&&x>=y&&x--},_listeners:f},g})(),Bo=function(){return!uu&&xi.wake()},Me={},t2=/^[\d.\-M][\d.\-,\s]/,e2=/["']/g,n2=function(t){for(var e={},a=t.substr(1,t.length-3).split(":"),r=a[0],l=1,c=a.length,f,p,h;l<c;l++)p=a[l],f=l!==c-1?p.lastIndexOf(","):p.length,h=p.substr(0,f),e[r]=isNaN(h)?h.replace(e2,"").trim():+h,r=p.substr(f+1).trim();return e},i2=function(t){var e=t.indexOf("(")+1,a=t.indexOf(")"),r=t.indexOf("(",e);return t.substring(e,~r&&r<a?t.indexOf(")",a+1):a)},a2=function(t){var e=(t+"").split("("),a=Me[e[0]];return a&&e.length>1&&a.config?a.config.apply(null,~t.indexOf("{")?[n2(e[1])]:i2(t).split(",").map(oS)):Me._CE&&t2.test(t)?Me._CE("",t):a},bS=function(t){return function(e){return 1-t(1-e)}},AS=function o(t,e){for(var a=t._first,r;a;)a instanceof Zn?o(a,e):a.vars.yoyoEase&&(!a._yoyo||!a._repeat)&&a._yoyo!==e&&(a.timeline?o(a.timeline,e):(r=a._ease,a._ease=a._yEase,a._yEase=r,a._yoyo=e)),a=a._next},ps=function(t,e){return t&&(sn(t)?t:Me[t]||a2(t))||e},ys=function(t,e,a,r){a===void 0&&(a=function(p){return 1-e(1-p)}),r===void 0&&(r=function(p){return p<.5?e(p*2)/2:1-e((1-p)*2)/2});var l={easeIn:e,easeOut:a,easeInOut:r},c;return ri(t,function(f){Me[f]=bi[f]=l,Me[c=f.toLowerCase()]=a;for(var p in l)Me[c+(p==="easeIn"?".in":p==="easeOut"?".out":".inOut")]=Me[f+"."+p]=l[p]}),l},RS=function(t){return function(e){return e<.5?(1-t(1-e*2))/2:.5+t((e-.5)*2)/2}},Mp=function o(t,e,a){var r=e>=1?e:1,l=(a||(t?.3:.45))/(e<1?e:1),c=l/_m*(Math.asin(1/r)||0),f=function(m){return m===1?1:r*Math.pow(2,-10*m)*LC((m-c)*l)+1},p=t==="out"?f:t==="in"?function(h){return 1-f(1-h)}:RS(f);return l=_m/l,p.config=function(h,m){return o(t,h,m)},p},Ep=function o(t,e){e===void 0&&(e=1.70158);var a=function(c){return c?--c*c*((e+1)*c+e)+1:0},r=t==="out"?a:t==="in"?function(l){return 1-a(1-l)}:RS(a);return r.config=function(l){return o(t,l)},r};ri("Linear,Quad,Cubic,Quart,Quint,Strong",function(o,t){var e=t<5?t+1:t;ys(o+",Power"+(e-1),t?function(a){return Math.pow(a,e)}:function(a){return a},function(a){return 1-Math.pow(1-a,e)},function(a){return a<.5?Math.pow(a*2,e)/2:1-Math.pow((1-a)*2,e)/2})});Me.Linear.easeNone=Me.none=Me.Linear.easeIn;ys("Elastic",Mp("in"),Mp("out"),Mp());(function(o,t){var e=1/t,a=2*e,r=2.5*e,l=function(f){return f<e?o*f*f:f<a?o*Math.pow(f-1.5/t,2)+.75:f<r?o*(f-=2.25/t)*f+.9375:o*Math.pow(f-2.625/t,2)+.984375};ys("Bounce",function(c){return 1-l(1-c)},l)})(7.5625,2.75);ys("Expo",function(o){return Math.pow(2,10*(o-1))*o+o*o*o*o*o*o*(1-o)});ys("Circ",function(o){return-(Ky(1-o*o)-1)});ys("Sine",function(o){return o===1?1:-UC(o*CC)+1});ys("Back",Ep("in"),Ep("out"),Ep());Me.SteppedEase=Me.steps=bi.SteppedEase={config:function(t,e){t===void 0&&(t=1);var a=1/t,r=t+(e?0:1),l=e?1:0,c=1-Ge;return function(f){return((r*vu(0,c,f)|0)+l)*a}}};No.ease=Me["quad.out"];ri("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt",function(o){return Qm+=o+","+o+"Params,"});var wS=function(t,e){this.id=DC++,t._gsap=this,this.target=t,this.harness=e,this.get=e?e.get:rS,this.set=e?e.getSetter:i_},cu=(function(){function o(e){this.vars=e,this._delay=+e.delay||0,(this._repeat=e.repeat===1/0?-2:e.repeat||0)&&(this._rDelay=e.repeatDelay||0,this._yoyo=!!e.yoyo||!!e.yoyoEase),this._ts=1,Io(this,+e.duration,1,1),this.data=e.data,Ye&&(this._ctx=Ye,Ye.data.push(this)),uu||xi.wake()}var t=o.prototype;return t.delay=function(a){return a||a===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+a-this._delay),this._delay=a,this):this._delay},t.duration=function(a){return arguments.length?this.totalDuration(this._repeat>0?a+(a+this._rDelay)*this._repeat:a):this.totalDuration()&&this._dur},t.totalDuration=function(a){return arguments.length?(this._dirty=0,Io(this,this._repeat<0?a:(a-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},t.totalTime=function(a,r){if(Bo(),!arguments.length)return this._tTime;var l=this._dp;if(l&&l.smoothChildTiming&&this._ts){for(Df(this,a),!l._dp||l.parent||cS(l,this);l&&l.parent;)l.parent._time!==l._start+(l._ts>=0?l._tTime/l._ts:(l.totalDuration()-l._tTime)/-l._ts)&&l.totalTime(l._tTime,!0),l=l.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&a<this._tDur||this._ts<0&&a>0||!this._tDur&&!a)&&la(this._dp,this,this._start-this._delay)}return(this._tTime!==a||!this._dur&&!r||this._initted&&Math.abs(this._zTime)===Ge||!a&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=a),sS(this,a,r)),this},t.time=function(a,r){return arguments.length?this.totalTime(Math.min(this.totalDuration(),a+ey(this))%(this._dur+this._rDelay)||(a?this._dur:0),r):this._time},t.totalProgress=function(a,r){return arguments.length?this.totalTime(this.totalDuration()*a,r):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.rawTime()>=0&&this._initted?1:0},t.progress=function(a,r){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-a:a)+ey(this),r):this.duration()?Math.min(1,this._time/this._dur):this.rawTime()>0?1:0},t.iteration=function(a,r){var l=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(a-1)*l,r):this._repeat?zo(this._tTime,l)+1:1},t.timeScale=function(a,r){if(!arguments.length)return this._rts===-Ge?0:this._rts;if(this._rts===a)return this;var l=this.parent&&this._ts?Sf(this.parent._time,this):this._tTime;return this._rts=+a||0,this._ts=this._ps||a===-Ge?0:this._rts,this.totalTime(vu(-Math.abs(this._delay),this.totalDuration(),l),r!==!1),Cf(this),FC(this)},t.paused=function(a){return arguments.length?(this._ps!==a&&(this._ps=a,a?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(Bo(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==Ge&&(this._tTime-=Ge)))),this):this._ps},t.startTime=function(a){if(arguments.length){this._start=a;var r=this.parent||this._dp;return r&&(r._sort||!this.parent)&&la(r,this,a-this._delay),this}return this._start},t.endTime=function(a){return this._start+(ai(a)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},t.rawTime=function(a){var r=this.parent||this._dp;return r?a&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?Sf(r.rawTime(a),this):this._tTime:this._tTime},t.revert=function(a){a===void 0&&(a=PC);var r=Pn;return Pn=a,$m(this)&&(this.timeline&&this.timeline.revert(a),this.totalTime(-.01,a.suppressEvents)),this.data!=="nested"&&a.kill!==!1&&this.kill(),Pn=r,this},t.globalTime=function(a){for(var r=this,l=arguments.length?a:r.rawTime();r;)l=r._start+l/(Math.abs(r._ts)||1),r=r._dp;return!this.parent&&this._sat?this._sat.globalTime(a):l},t.repeat=function(a){return arguments.length?(this._repeat=a===1/0?-2:a,ny(this)):this._repeat===-2?1/0:this._repeat},t.repeatDelay=function(a){if(arguments.length){var r=this._time;return this._rDelay=a,ny(this),r?this.time(r):this}return this._rDelay},t.yoyo=function(a){return arguments.length?(this._yoyo=a,this):this._yoyo},t.seek=function(a,r){return this.totalTime(zi(this,a),ai(r))},t.restart=function(a,r){return this.play().totalTime(a?-this._delay:0,ai(r)),this._dur||(this._zTime=-Ge),this},t.play=function(a,r){return a!=null&&this.seek(a,r),this.reversed(!1).paused(!1)},t.reverse=function(a,r){return a!=null&&this.seek(a||this.totalDuration(),r),this.reversed(!0).paused(!1)},t.pause=function(a,r){return a!=null&&this.seek(a,r),this.paused(!0)},t.resume=function(){return this.paused(!1)},t.reversed=function(a){return arguments.length?(!!a!==this.reversed()&&this.timeScale(-this._rts||(a?-Ge:0)),this):this._rts<0},t.invalidate=function(){return this._initted=this._act=0,this._zTime=-Ge,this},t.isActive=function(){var a=this.parent||this._dp,r=this._start,l;return!!(!a||this._ts&&this._initted&&a.isActive()&&(l=a.rawTime(!0))>=r&&l<this.endTime(!0)-Ge)},t.eventCallback=function(a,r,l){var c=this.vars;return arguments.length>1?(r?(c[a]=r,l&&(c[a+"Params"]=l),a==="onUpdate"&&(this._onUpdate=r)):delete c[a],this):c[a]},t.then=function(a){var r=this;return new Promise(function(l){var c=sn(a)?a:lS,f=function(){var h=r.then;r.then=null,sn(c)&&(c=c(r))&&(c.then||c===r)&&(r.then=h),l(c),r.then=h};r._initted&&r.totalProgress()===1&&r._ts>=0||!r._tTime&&r._ts<0?f():r._prom=f})},t.kill=function(){ql(this)},o})();Ai(cu.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-Ge,_prom:0,_ps:!1,_rts:1});var Zn=(function(o){Zy(t,o);function t(a,r){var l;return a===void 0&&(a={}),l=o.call(this,a)||this,l.labels={},l.smoothChildTiming=!!a.smoothChildTiming,l.autoRemoveChildren=!!a.autoRemoveChildren,l._sort=ai(a.sortChildren),Qe&&la(a.parent||Qe,Ia(l),r),a.reversed&&l.reverse(),a.paused&&l.paused(!0),a.scrollTrigger&&fS(Ia(l),a.scrollTrigger),l}var e=t.prototype;return e.to=function(r,l,c){return Ql(0,arguments,this),this},e.from=function(r,l,c){return Ql(1,arguments,this),this},e.fromTo=function(r,l,c,f){return Ql(2,arguments,this),this},e.set=function(r,l,c){return l.duration=0,l.parent=this,Kl(l).repeatDelay||(l.repeat=0),l.immediateRender=!!l.immediateRender,new mn(r,l,zi(this,c),1),this},e.call=function(r,l,c){return la(this,mn.delayedCall(0,r,l),c)},e.staggerTo=function(r,l,c,f,p,h,m){return c.duration=l,c.stagger=c.stagger||f,c.onComplete=h,c.onCompleteParams=m,c.parent=this,new mn(r,c,zi(this,p)),this},e.staggerFrom=function(r,l,c,f,p,h,m){return c.runBackwards=1,Kl(c).immediateRender=ai(c.immediateRender),this.staggerTo(r,l,c,f,p,h,m)},e.staggerFromTo=function(r,l,c,f,p,h,m,g){return f.startAt=c,Kl(f).immediateRender=ai(f.immediateRender),this.staggerTo(r,l,f,p,h,m,g)},e.render=function(r,l,c){var f=this._time,p=this._dirty?this.totalDuration():this._tDur,h=this._dur,m=r<=0?0:_n(r),g=this._zTime<0!=r<0&&(this._initted||!h),v,x,E,M,S,y,D,U,A,L,P,z;if(this!==Qe&&m>p&&r>=0&&(m=p),m!==this._tTime||c||g){if(f!==this._time&&h&&(m+=this._time-f,r+=this._time-f),v=m,A=this._start,U=this._ts,y=!U,g&&(h||(f=this._zTime),(r||!l)&&(this._zTime=r)),this._repeat){if(P=this._yoyo,S=h+this._rDelay,this._repeat<-1&&r<0)return this.totalTime(S*100+r,l,c);if(v=_n(m%S),m===p?(M=this._repeat,v=h):(L=_n(m/S),M=~~L,M&&M===L&&(v=h,M--),v>h&&(v=h)),L=zo(this._tTime,S),!f&&this._tTime&&L!==M&&this._tTime-L*S-this._dur<=0&&(L=M),P&&M&1&&(v=h-v,z=1),M!==L&&!this._lock){var F=P&&L&1,b=F===(P&&M&1);if(M<L&&(F=!F),f=F?0:m%h?h:m,this._lock=1,this.render(f||(z?0:_n(M*S)),l,!h)._lock=0,this._tTime=m,!l&&this.parent&&Si(this,"onRepeat"),this.vars.repeatRefresh&&!z&&(this.invalidate()._lock=1),f&&f!==this._time||y!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act)return this;if(h=this._dur,p=this._tDur,b&&(this._lock=2,f=F?h:-1e-4,this.render(f,!0),this.vars.repeatRefresh&&!z&&this.invalidate()),this._lock=0,!this._ts&&!y)return this;AS(this,z)}}if(this._hasPause&&!this._forcing&&this._lock<2&&(D=kC(this,_n(f),_n(v)),D&&(m-=v-(v=D._start))),this._tTime=m,this._time=v,this._act=!U,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=r,f=0),!f&&m&&!l&&!L&&(Si(this,"onStart"),this._tTime!==m))return this;if(v>=f&&r>=0)for(x=this._first;x;){if(E=x._next,(x._act||v>=x._start)&&x._ts&&D!==x){if(x.parent!==this)return this.render(r,l,c);if(x.render(x._ts>0?(v-x._start)*x._ts:(x._dirty?x.totalDuration():x._tDur)+(v-x._start)*x._ts,l,c),v!==this._time||!this._ts&&!y){D=0,E&&(m+=this._zTime=-Ge);break}}x=E}else{x=this._last;for(var O=r<0?r:v;x;){if(E=x._prev,(x._act||O<=x._end)&&x._ts&&D!==x){if(x.parent!==this)return this.render(r,l,c);if(x.render(x._ts>0?(O-x._start)*x._ts:(x._dirty?x.totalDuration():x._tDur)+(O-x._start)*x._ts,l,c||Pn&&$m(x)),v!==this._time||!this._ts&&!y){D=0,E&&(m+=this._zTime=O?-Ge:Ge);break}}x=E}}if(D&&!l&&(this.pause(),D.render(v>=f?0:-Ge)._zTime=v>=f?1:-1,this._ts))return this._start=A,Cf(this),this.render(r,l,c);this._onUpdate&&!l&&Si(this,"onUpdate",!0),(m===p&&this._tTime>=this.totalDuration()||!m&&f)&&(A===this._start||Math.abs(U)!==Math.abs(this._ts))&&(this._lock||((r||!h)&&(m===p&&this._ts>0||!m&&this._ts<0)&&Dr(this,1),!l&&!(r<0&&!f)&&(m||f||!p)&&(Si(this,m===p&&r>=0?"onComplete":"onReverseComplete",!0),this._prom&&!(m<p&&this.timeScale()>0)&&this._prom())))}return this},e.add=function(r,l){var c=this;if(Xa(l)||(l=zi(this,l,r)),!(r instanceof cu)){if(kn(r))return r.forEach(function(f){return c.add(f,l)}),this;if(Cn(r))return this.addLabel(r,l);if(sn(r))r=mn.delayedCall(0,r);else return this}return this!==r?la(this,r,l):this},e.getChildren=function(r,l,c,f){r===void 0&&(r=!0),l===void 0&&(l=!0),c===void 0&&(c=!0),f===void 0&&(f=-Bi);for(var p=[],h=this._first;h;)h._start>=f&&(h instanceof mn?l&&p.push(h):(c&&p.push(h),r&&p.push.apply(p,h.getChildren(!0,l,c)))),h=h._next;return p},e.getById=function(r){for(var l=this.getChildren(1,1,1),c=l.length;c--;)if(l[c].vars.id===r)return l[c]},e.remove=function(r){return Cn(r)?this.removeLabel(r):sn(r)?this.killTweensOf(r):(r.parent===this&&wf(this,r),r===this._recent&&(this._recent=this._last),ds(this))},e.totalTime=function(r,l){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=_n(xi.time-(this._ts>0?r/this._ts:(this.totalDuration()-r)/-this._ts))),o.prototype.totalTime.call(this,r,l),this._forcing=0,this):this._tTime},e.addLabel=function(r,l){return this.labels[r]=zi(this,l),this},e.removeLabel=function(r){return delete this.labels[r],this},e.addPause=function(r,l,c){var f=mn.delayedCall(0,l||ou,c);return f.data="isPause",this._hasPause=1,la(this,f,zi(this,r))},e.removePause=function(r){var l=this._first;for(r=zi(this,r);l;)l._start===r&&l.data==="isPause"&&Dr(l),l=l._next},e.killTweensOf=function(r,l,c){for(var f=this.getTweensOf(r,c),p=f.length;p--;)Er!==f[p]&&f[p].kill(r,l);return this},e.getTweensOf=function(r,l){for(var c=[],f=Fi(r),p=this._first,h=Xa(l),m;p;)p instanceof mn?zC(p._targets,f)&&(h?(!Er||p._initted&&p._ts)&&p.globalTime(0)<=l&&p.globalTime(p.totalDuration())>l:!l||p.isActive())&&c.push(p):(m=p.getTweensOf(f,l)).length&&c.push.apply(c,m),p=p._next;return c},e.tweenTo=function(r,l){l=l||{};var c=this,f=zi(c,r),p=l,h=p.startAt,m=p.onStart,g=p.onStartParams,v=p.immediateRender,x,E=mn.to(c,Ai({ease:l.ease||"none",lazy:!1,immediateRender:!1,time:f,overwrite:"auto",duration:l.duration||Math.abs((f-(h&&"time"in h?h.time:c._time))/c.timeScale())||Ge,onStart:function(){if(c.pause(),!x){var S=l.duration||Math.abs((f-(h&&"time"in h?h.time:c._time))/c.timeScale());E._dur!==S&&Io(E,S,0,1).render(E._time,!0,!0),x=1}m&&m.apply(E,g||[])}},l));return v?E.render(0):E},e.tweenFromTo=function(r,l,c){return this.tweenTo(l,Ai({startAt:{time:zi(this,r)}},c))},e.recent=function(){return this._recent},e.nextLabel=function(r){return r===void 0&&(r=this._time),iy(this,zi(this,r))},e.previousLabel=function(r){return r===void 0&&(r=this._time),iy(this,zi(this,r),1)},e.currentLabel=function(r){return arguments.length?this.seek(r,!0):this.previousLabel(this._time+Ge)},e.shiftChildren=function(r,l,c){c===void 0&&(c=0);for(var f=this._first,p=this.labels,h;f;)f._start>=c&&(f._start+=r,f._end+=r),f=f._next;if(l)for(h in p)p[h]>=c&&(p[h]+=r);return ds(this)},e.invalidate=function(r){var l=this._first;for(this._lock=0;l;)l.invalidate(r),l=l._next;return o.prototype.invalidate.call(this,r)},e.clear=function(r){r===void 0&&(r=!0);for(var l=this._first,c;l;)c=l._next,this.remove(l),l=c;return this._dp&&(this._time=this._tTime=this._pTime=0),r&&(this.labels={}),ds(this)},e.totalDuration=function(r){var l=0,c=this,f=c._last,p=Bi,h,m,g;if(arguments.length)return c.timeScale((c._repeat<0?c.duration():c.totalDuration())/(c.reversed()?-r:r));if(c._dirty){for(g=c.parent;f;)h=f._prev,f._dirty&&f.totalDuration(),m=f._start,m>p&&c._sort&&f._ts&&!c._lock?(c._lock=1,la(c,f,m-f._delay,1)._lock=0):p=m,m<0&&f._ts&&(l-=m,(!g&&!c._dp||g&&g.smoothChildTiming)&&(c._start+=m/c._ts,c._time-=m,c._tTime-=m),c.shiftChildren(-m,!1,-1/0),p=0),f._end>l&&f._ts&&(l=f._end),f=h;Io(c,c===Qe&&c._time>l?c._time:l,1,1),c._dirty=0}return c._tDur},t.updateRoot=function(r){if(Qe._ts&&(sS(Qe,Sf(r,Qe)),aS=xi.frame),xi.frame>=$x){$x+=Ei.autoSleep||120;var l=Qe._first;if((!l||!l._ts)&&Ei.autoSleep&&xi._listeners.length<2){for(;l&&!l._ts;)l=l._next;l||xi.sleep()}}},t})(cu);Ai(Zn.prototype,{_lock:0,_hasPause:0,_forcing:0});var r2=function(t,e,a,r,l,c,f){var p=new si(this._pt,t,e,0,1,NS,null,l),h=0,m=0,g,v,x,E,M,S,y,D;for(p.b=a,p.e=r,a+="",r+="",(y=~r.indexOf("random("))&&(r=lu(r)),c&&(D=[a,r],c(D,t,e),a=D[0],r=D[1]),v=a.match(xp)||[];g=xp.exec(r);)E=g[0],M=r.substring(h,g.index),x?x=(x+1)%5:M.substr(-5)==="rgba("&&(x=1),E!==v[m++]&&(S=parseFloat(v[m-1])||0,p._pt={_next:p._pt,p:M||m===1?M:",",s:S,c:E.charAt(1)==="="?Ao(S,E)-S:parseFloat(E)-S,m:x&&x<4?Math.round:0},h=xp.lastIndex);return p.c=h<r.length?r.substring(h,r.length):"",p.fp=f,($y.test(r)||y)&&(p.e=0),this._pt=p,p},t_=function(t,e,a,r,l,c,f,p,h,m){sn(r)&&(r=r(l||0,t,c));var g=t[e],v=a!=="get"?a:sn(g)?h?t[e.indexOf("set")||!sn(t["get"+e.substr(3)])?e:"get"+e.substr(3)](h):t[e]():g,x=sn(g)?h?c2:LS:n_,E;if(Cn(r)&&(~r.indexOf("random(")&&(r=lu(r)),r.charAt(1)==="="&&(E=Ao(v,r)+(Vn(v)||0),(E||E===0)&&(r=E))),!m||v!==r||bm)return!isNaN(v*r)&&r!==""?(E=new si(this._pt,t,e,+v||0,r-(v||0),typeof g=="boolean"?h2:OS,0,x),h&&(E.fp=h),f&&E.modifier(f,this,t),this._pt=E):(!g&&!(e in t)&&Zm(e,r),r2.call(this,t,e,v,r,x,p||Ei.stringFilter,h))},s2=function(t,e,a,r,l){if(sn(t)&&(t=Jl(t,l,e,a,r)),!pa(t)||t.style&&t.nodeType||kn(t)||Qy(t))return Cn(t)?Jl(t,l,e,a,r):t;var c={},f;for(f in t)c[f]=Jl(t[f],l,e,a,r);return c},CS=function(t,e,a,r,l,c){var f,p,h,m;if(vi[t]&&(f=new vi[t]).init(l,f.rawVars?e[t]:s2(e[t],r,l,c,a),a,r,c)!==!1&&(a._pt=p=new si(a._pt,l,t,0,1,f.render,f,0,f.priority),a!==Eo))for(h=a._ptLookup[a._targets.indexOf(l)],m=f._props.length;m--;)h[f._props[m]]=p;return f},Er,bm,e_=function o(t,e,a){var r=t.vars,l=r.ease,c=r.startAt,f=r.immediateRender,p=r.lazy,h=r.onUpdate,m=r.runBackwards,g=r.yoyoEase,v=r.keyframes,x=r.autoRevert,E=t._dur,M=t._startAt,S=t._targets,y=t.parent,D=y&&y.data==="nested"?y.vars.targets:S,U=t._overwrite==="auto"&&!Wm,A=t.timeline,L,P,z,F,b,O,V,j,tt,ct,rt,B,k;if(A&&(!v||!l)&&(l="none"),t._ease=ps(l,No.ease),t._yEase=g?bS(ps(g===!0?l:g,No.ease)):0,g&&t._yoyo&&!t._repeat&&(g=t._yEase,t._yEase=t._ease,t._ease=g),t._from=!A&&!!r.runBackwards,!A||v&&!r.stagger){if(j=S[0]?hs(S[0]).harness:0,B=j&&r[j.prop],L=yf(r,Km),M&&(M._zTime<0&&M.progress(1),e<0&&m&&f&&!x?M.render(-1,!0):M.revert(m&&E?lf:NC),M._lazy=0),c){if(Dr(t._startAt=mn.set(S,Ai({data:"isStart",overwrite:!1,parent:y,immediateRender:!0,lazy:!M&&ai(p),startAt:null,delay:0,onUpdate:h&&function(){return Si(t,"onUpdate")},stagger:0},c))),t._startAt._dp=0,t._startAt._sat=t,e<0&&(Pn||!f&&!x)&&t._startAt.revert(lf),f&&E&&e<=0&&a<=0){e&&(t._zTime=e);return}}else if(m&&E&&!M){if(e&&(f=!1),z=Ai({overwrite:!1,data:"isFromStart",lazy:f&&!M&&ai(p),immediateRender:f,stagger:0,parent:y},L),B&&(z[j.prop]=B),Dr(t._startAt=mn.set(S,z)),t._startAt._dp=0,t._startAt._sat=t,e<0&&(Pn?t._startAt.revert(lf):t._startAt.render(-1,!0)),t._zTime=e,!f)o(t._startAt,Ge,Ge);else if(!e)return}for(t._pt=t._ptCache=0,p=E&&ai(p)||p&&!E,P=0;P<S.length;P++){if(b=S[P],V=b._gsap||Jm(S)[P]._gsap,t._ptLookup[P]=ct={},xm[V.id]&&wr.length&&xf(),rt=D===S?P:D.indexOf(b),j&&(tt=new j).init(b,B||L,t,rt,D)!==!1&&(t._pt=F=new si(t._pt,b,tt.name,0,1,tt.render,tt,0,tt.priority),tt._props.forEach(function(X){ct[X]=F}),tt.priority&&(O=1)),!j||B)for(z in L)vi[z]&&(tt=CS(z,L,t,rt,b,D))?tt.priority&&(O=1):ct[z]=F=t_.call(t,b,z,"get",L[z],rt,D,0,r.stringFilter);t._op&&t._op[P]&&t.kill(b,t._op[P]),U&&t._pt&&(Er=t,Qe.killTweensOf(b,ct,t.globalTime(e)),k=!t.parent,Er=0),t._pt&&p&&(xm[V.id]=1)}O&&PS(t),t._onInit&&t._onInit(t)}t._onUpdate=h,t._initted=(!t._op||t._pt)&&!k,v&&e<=0&&A.render(Bi,!0,!0)},o2=function(t,e,a,r,l,c,f,p){var h=(t._pt&&t._ptCache||(t._ptCache={}))[e],m,g,v,x;if(!h)for(h=t._ptCache[e]=[],v=t._ptLookup,x=t._targets.length;x--;){if(m=v[x][e],m&&m.d&&m.d._pt)for(m=m.d._pt;m&&m.p!==e&&m.fp!==e;)m=m._next;if(!m)return bm=1,t.vars[e]="+=0",e_(t,f),bm=0,p?su(e+" not eligible for reset"):1;h.push(m)}for(x=h.length;x--;)g=h[x],m=g._pt||g,m.s=(r||r===0)&&!l?r:m.s+(r||0)+c*m.c,m.c=a-m.s,g.e&&(g.e=un(a)+Vn(g.e)),g.b&&(g.b=m.s+Vn(g.b))},l2=function(t,e){var a=t[0]?hs(t[0]).harness:0,r=a&&a.aliases,l,c,f,p;if(!r)return e;l=Po({},e);for(c in r)if(c in l)for(p=r[c].split(","),f=p.length;f--;)l[p[f]]=l[c];return l},u2=function(t,e,a,r){var l=e.ease||r||"power1.inOut",c,f;if(kn(e))f=a[t]||(a[t]=[]),e.forEach(function(p,h){return f.push({t:h/(e.length-1)*100,v:p,e:l})});else for(c in e)f=a[c]||(a[c]=[]),c==="ease"||f.push({t:parseFloat(t),v:e[c],e:l})},Jl=function(t,e,a,r,l){return sn(t)?t.call(e,a,r,l):Cn(t)&&~t.indexOf("random(")?lu(t):t},DS=Qm+"repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",US={};ri(DS+",id,stagger,delay,duration,paused,scrollTrigger",function(o){return US[o]=1});var mn=(function(o){Zy(t,o);function t(a,r,l,c){var f;typeof r=="number"&&(l.duration=r,r=l,l=null),f=o.call(this,c?r:Kl(r))||this;var p=f.vars,h=p.duration,m=p.delay,g=p.immediateRender,v=p.stagger,x=p.overwrite,E=p.keyframes,M=p.defaults,S=p.scrollTrigger,y=p.yoyoEase,D=r.parent||Qe,U=(kn(a)||Qy(a)?Xa(a[0]):"length"in r)?[a]:Fi(a),A,L,P,z,F,b,O,V;if(f._targets=U.length?Jm(U):su("GSAP target "+a+" not found. https://gsap.com",!Ei.nullTargetWarn)||[],f._ptLookup=[],f._overwrite=x,E||v||tf(h)||tf(m)){if(r=f.vars,A=f.timeline=new Zn({data:"nested",defaults:M||{},targets:D&&D.data==="nested"?D.vars.targets:U}),A.kill(),A.parent=A._dp=Ia(f),A._start=0,v||tf(h)||tf(m)){if(z=U.length,O=v&&mS(v),pa(v))for(F in v)~DS.indexOf(F)&&(V||(V={}),V[F]=v[F]);for(L=0;L<z;L++)P=yf(r,US),P.stagger=0,y&&(P.yoyoEase=y),V&&Po(P,V),b=U[L],P.duration=+Jl(h,Ia(f),L,b,U),P.delay=(+Jl(m,Ia(f),L,b,U)||0)-f._delay,!v&&z===1&&P.delay&&(f._delay=m=P.delay,f._start+=m,P.delay=0),A.to(b,P,O?O(L,b,U):0),A._ease=Me.none;A.duration()?h=m=0:f.timeline=0}else if(E){Kl(Ai(A.vars.defaults,{ease:"none"})),A._ease=ps(E.ease||r.ease||"none");var j=0,tt,ct,rt;if(kn(E))E.forEach(function(B){return A.to(U,B,">")}),A.duration();else{P={};for(F in E)F==="ease"||F==="easeEach"||u2(F,E[F],P,E.easeEach);for(F in P)for(tt=P[F].sort(function(B,k){return B.t-k.t}),j=0,L=0;L<tt.length;L++)ct=tt[L],rt={ease:ct.e,duration:(ct.t-(L?tt[L-1].t:0))/100*h},rt[F]=ct.v,A.to(U,rt,j),j+=rt.duration;A.duration()<h&&A.to({},{duration:h-A.duration()})}}h||f.duration(h=A.duration())}else f.timeline=0;return x===!0&&!Wm&&(Er=Ia(f),Qe.killTweensOf(U),Er=0),la(D,Ia(f),l),r.reversed&&f.reverse(),r.paused&&f.paused(!0),(g||!h&&!E&&f._start===_n(D._time)&&ai(g)&&HC(Ia(f))&&D.data!=="nested")&&(f._tTime=-Ge,f.render(Math.max(0,-m)||0)),S&&fS(Ia(f),S),f}var e=t.prototype;return e.render=function(r,l,c){var f=this._time,p=this._tDur,h=this._dur,m=r<0,g=r>p-Ge&&!m?p:r<Ge?0:r,v,x,E,M,S,y,D,U,A;if(!h)VC(this,r,l,c);else if(g!==this._tTime||!r||c||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==m||this._lazy){if(v=g,U=this.timeline,this._repeat){if(M=h+this._rDelay,this._repeat<-1&&m)return this.totalTime(M*100+r,l,c);if(v=_n(g%M),g===p?(E=this._repeat,v=h):(S=_n(g/M),E=~~S,E&&E===S?(v=h,E--):v>h&&(v=h)),y=this._yoyo&&E&1,y&&(A=this._yEase,v=h-v),S=zo(this._tTime,M),v===f&&!c&&this._initted&&E===S)return this._tTime=g,this;E!==S&&(U&&this._yEase&&AS(U,y),this.vars.repeatRefresh&&!y&&!this._lock&&v!==M&&this._initted&&(this._lock=c=1,this.render(_n(M*E),!0).invalidate()._lock=0))}if(!this._initted){if(hS(this,m?r:v,c,l,g))return this._tTime=0,this;if(f!==this._time&&!(c&&this.vars.repeatRefresh&&E!==S))return this;if(h!==this._dur)return this.render(r,l,c)}if(this._tTime=g,this._time=v,!this._act&&this._ts&&(this._act=1,this._lazy=0),this.ratio=D=(A||this._ease)(v/h),this._from&&(this.ratio=D=1-D),!f&&g&&!l&&!S&&(Si(this,"onStart"),this._tTime!==g))return this;for(x=this._pt;x;)x.r(D,x.d),x=x._next;U&&U.render(r<0?r:U._dur*U._ease(v/this._dur),l,c)||this._startAt&&(this._zTime=r),this._onUpdate&&!l&&(m&&ym(this,r,l,c),Si(this,"onUpdate")),this._repeat&&E!==S&&this.vars.onRepeat&&!l&&this.parent&&Si(this,"onRepeat"),(g===this._tDur||!g)&&this._tTime===g&&(m&&!this._onUpdate&&ym(this,r,!0,!0),(r||!h)&&(g===this._tDur&&this._ts>0||!g&&this._ts<0)&&Dr(this,1),!l&&!(m&&!f)&&(g||f||y)&&(Si(this,g===p?"onComplete":"onReverseComplete",!0),this._prom&&!(g<p&&this.timeScale()>0)&&this._prom()))}return this},e.targets=function(){return this._targets},e.invalidate=function(r){return(!r||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(r),o.prototype.invalidate.call(this,r)},e.resetTo=function(r,l,c,f,p){uu||xi.wake(),this._ts||this.play();var h=Math.min(this._dur,(this._dp._time-this._start)*this._ts),m;return this._initted||e_(this,h),m=this._ease(h/this._dur),o2(this,r,l,c,f,m,h,p)?this.resetTo(r,l,c,f,1):(Df(this,0),this.parent||uS(this._dp,this,"_first","_last",this._dp._sort?"_start":0),this.render(0))},e.kill=function(r,l){if(l===void 0&&(l="all"),!r&&(!l||l==="all"))return this._lazy=this._pt=0,this.parent?ql(this):this.scrollTrigger&&this.scrollTrigger.kill(!!Pn),this;if(this.timeline){var c=this.timeline.totalDuration();return this.timeline.killTweensOf(r,l,Er&&Er.vars.overwrite!==!0)._first||ql(this),this.parent&&c!==this.timeline.totalDuration()&&Io(this,this._dur*this.timeline._tDur/c,0,1),this}var f=this._targets,p=r?Fi(r):f,h=this._ptLookup,m=this._pt,g,v,x,E,M,S,y;if((!l||l==="all")&&BC(f,p))return l==="all"&&(this._pt=0),ql(this);for(g=this._op=this._op||[],l!=="all"&&(Cn(l)&&(M={},ri(l,function(D){return M[D]=1}),l=M),l=l2(f,l)),y=f.length;y--;)if(~p.indexOf(f[y])){v=h[y],l==="all"?(g[y]=l,E=v,x={}):(x=g[y]=g[y]||{},E=l);for(M in E)S=v&&v[M],S&&((!("kill"in S.d)||S.d.kill(M)===!0)&&wf(this,S,"_pt"),delete v[M]),x!=="all"&&(x[M]=1)}return this._initted&&!this._pt&&m&&ql(this),this},t.to=function(r,l){return new t(r,l,arguments[2])},t.from=function(r,l){return Ql(1,arguments)},t.delayedCall=function(r,l,c,f){return new t(l,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:r,onComplete:l,onReverseComplete:l,onCompleteParams:c,onReverseCompleteParams:c,callbackScope:f})},t.fromTo=function(r,l,c){return Ql(2,arguments)},t.set=function(r,l){return l.duration=0,l.repeatDelay||(l.repeat=0),new t(r,l)},t.killTweensOf=function(r,l,c){return Qe.killTweensOf(r,l,c)},t})(cu);Ai(mn.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0});ri("staggerTo,staggerFrom,staggerFromTo",function(o){mn[o]=function(){var t=new Zn,e=Mm.call(arguments,0);return e.splice(o==="staggerFromTo"?5:4,0,0),t[o].apply(t,e)}});var n_=function(t,e,a){return t[e]=a},LS=function(t,e,a){return t[e](a)},c2=function(t,e,a,r){return t[e](r.fp,a)},f2=function(t,e,a){return t.setAttribute(e,a)},i_=function(t,e){return sn(t[e])?LS:qm(t[e])&&t.setAttribute?f2:n_},OS=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e6)/1e6,e)},h2=function(t,e){return e.set(e.t,e.p,!!(e.s+e.c*t),e)},NS=function(t,e){var a=e._pt,r="";if(!t&&e.b)r=e.b;else if(t===1&&e.e)r=e.e;else{for(;a;)r=a.p+(a.m?a.m(a.s+a.c*t):Math.round((a.s+a.c*t)*1e4)/1e4)+r,a=a._next;r+=e.c}e.set(e.t,e.p,r,e)},a_=function(t,e){for(var a=e._pt;a;)a.r(t,a.d),a=a._next},d2=function(t,e,a,r){for(var l=this._pt,c;l;)c=l._next,l.p===r&&l.modifier(t,e,a),l=c},p2=function(t){for(var e=this._pt,a,r;e;)r=e._next,e.p===t&&!e.op||e.op===t?wf(this,e,"_pt"):e.dep||(a=1),e=r;return!a},m2=function(t,e,a,r){r.mSet(t,e,r.m.call(r.tween,a,r.mt),r)},PS=function(t){for(var e=t._pt,a,r,l,c;e;){for(a=e._next,r=l;r&&r.pr>e.pr;)r=r._next;(e._prev=r?r._prev:c)?e._prev._next=e:l=e,(e._next=r)?r._prev=e:c=e,e=a}t._pt=l},si=(function(){function o(e,a,r,l,c,f,p,h,m){this.t=a,this.s=l,this.c=c,this.p=r,this.r=f||OS,this.d=p||this,this.set=h||n_,this.pr=m||0,this._next=e,e&&(e._prev=this)}var t=o.prototype;return t.modifier=function(a,r,l){this.mSet=this.mSet||this.set,this.set=m2,this.m=a,this.mt=l,this.tween=r},o})();ri(Qm+"parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger",function(o){return Km[o]=1});bi.TweenMax=bi.TweenLite=mn;bi.TimelineLite=bi.TimelineMax=Zn;Qe=new Zn({sortChildren:!1,defaults:No,autoRemoveChildren:!0,id:"root",smoothChildTiming:!0});Ei.stringFilter=TS;var ms=[],cf={},_2=[],ry=0,g2=0,Tp=function(t){return(cf[t]||_2).map(function(e){return e()})},Am=function(){var t=Date.now(),e=[];t-ry>2&&(Tp("matchMediaInit"),ms.forEach(function(a){var r=a.queries,l=a.conditions,c,f,p,h;for(f in r)c=sa.matchMedia(r[f]).matches,c&&(p=1),c!==l[f]&&(l[f]=c,h=1);h&&(a.revert(),p&&e.push(a))}),Tp("matchMediaRevert"),e.forEach(function(a){return a.onMatch(a,function(r){return a.add(null,r)})}),ry=t,Tp("matchMedia"))},zS=(function(){function o(e,a){this.selector=a&&Em(a),this.data=[],this._r=[],this.isReverted=!1,this.id=g2++,e&&this.add(e)}var t=o.prototype;return t.add=function(a,r,l){sn(a)&&(l=r,r=a,a=sn);var c=this,f=function(){var h=Ye,m=c.selector,g;return h&&h!==c&&h.data.push(c),l&&(c.selector=Em(l)),Ye=c,g=r.apply(c,arguments),sn(g)&&c._r.push(g),Ye=h,c.selector=m,c.isReverted=!1,g};return c.last=f,a===sn?f(c,function(p){return c.add(null,p)}):a?c[a]=f:f},t.ignore=function(a){var r=Ye;Ye=null,a(this),Ye=r},t.getTweens=function(){var a=[];return this.data.forEach(function(r){return r instanceof o?a.push.apply(a,r.getTweens()):r instanceof mn&&!(r.parent&&r.parent.data==="nested")&&a.push(r)}),a},t.clear=function(){this._r.length=this.data.length=0},t.kill=function(a,r){var l=this;if(a?(function(){for(var f=l.getTweens(),p=l.data.length,h;p--;)h=l.data[p],h.data==="isFlip"&&(h.revert(),h.getChildren(!0,!0,!1).forEach(function(m){return f.splice(f.indexOf(m),1)}));for(f.map(function(m){return{g:m._dur||m._delay||m._sat&&!m._sat.vars.immediateRender?m.globalTime(0):-1/0,t:m}}).sort(function(m,g){return g.g-m.g||-1/0}).forEach(function(m){return m.t.revert(a)}),p=l.data.length;p--;)h=l.data[p],h instanceof Zn?h.data!=="nested"&&(h.scrollTrigger&&h.scrollTrigger.revert(),h.kill()):!(h instanceof mn)&&h.revert&&h.revert(a);l._r.forEach(function(m){return m(a,l)}),l.isReverted=!0})():this.data.forEach(function(f){return f.kill&&f.kill()}),this.clear(),r)for(var c=ms.length;c--;)ms[c].id===this.id&&ms.splice(c,1)},t.revert=function(a){this.kill(a||{})},o})(),v2=(function(){function o(e){this.contexts=[],this.scope=e,Ye&&Ye.data.push(this)}var t=o.prototype;return t.add=function(a,r,l){pa(a)||(a={matches:a});var c=new zS(0,l||this.scope),f=c.conditions={},p,h,m;Ye&&!c.selector&&(c.selector=Ye.selector),this.contexts.push(c),r=c.add("onMatch",r),c.queries=a;for(h in a)h==="all"?m=1:(p=sa.matchMedia(a[h]),p&&(ms.indexOf(c)<0&&ms.push(c),(f[h]=p.matches)&&(m=1),p.addListener?p.addListener(Am):p.addEventListener("change",Am)));return m&&r(c,function(g){return c.add(null,g)}),this},t.revert=function(a){this.kill(a||{})},t.kill=function(a){this.contexts.forEach(function(r){return r.kill(a,!0)})},o})(),Mf={registerPlugin:function(){for(var t=arguments.length,e=new Array(t),a=0;a<t;a++)e[a]=arguments[a];e.forEach(function(r){return SS(r)})},timeline:function(t){return new Zn(t)},getTweensOf:function(t,e){return Qe.getTweensOf(t,e)},getProperty:function(t,e,a,r){Cn(t)&&(t=Fi(t)[0]);var l=hs(t||{}).get,c=a?lS:oS;return a==="native"&&(a=""),t&&(e?c((vi[e]&&vi[e].get||l)(t,e,a,r)):function(f,p,h){return c((vi[f]&&vi[f].get||l)(t,f,p,h))})},quickSetter:function(t,e,a){if(t=Fi(t),t.length>1){var r=t.map(function(m){return li.quickSetter(m,e,a)}),l=r.length;return function(m){for(var g=l;g--;)r[g](m)}}t=t[0]||{};var c=vi[e],f=hs(t),p=f.harness&&(f.harness.aliases||{})[e]||e,h=c?function(m){var g=new c;Eo._pt=0,g.init(t,a?m+a:m,Eo,0,[t]),g.render(1,g),Eo._pt&&a_(1,Eo)}:f.set(t,p);return c?h:function(m){return h(t,p,a?m+a:m,f,1)}},quickTo:function(t,e,a){var r,l=li.to(t,Ai((r={},r[e]="+=0.1",r.paused=!0,r.stagger=0,r),a||{})),c=function(p,h,m){return l.resetTo(e,p,h,m)};return c.tween=l,c},isTweening:function(t){return Qe.getTweensOf(t,!0).length>0},defaults:function(t){return t&&t.ease&&(t.ease=ps(t.ease,No.ease)),ty(No,t||{})},config:function(t){return ty(Ei,t||{})},registerEffect:function(t){var e=t.name,a=t.effect,r=t.plugins,l=t.defaults,c=t.extendTimeline;(r||"").split(",").forEach(function(f){return f&&!vi[f]&&!bi[f]&&su(e+" effect requires "+f+" plugin.")}),yp[e]=function(f,p,h){return a(Fi(f),Ai(p||{},l),h)},c&&(Zn.prototype[e]=function(f,p,h){return this.add(yp[e](f,pa(p)?p:(h=p)&&{},this),h)})},registerEase:function(t,e){Me[t]=ps(e)},parseEase:function(t,e){return arguments.length?ps(t,e):Me},getById:function(t){return Qe.getById(t)},exportRoot:function(t,e){t===void 0&&(t={});var a=new Zn(t),r,l;for(a.smoothChildTiming=ai(t.smoothChildTiming),Qe.remove(a),a._dp=0,a._time=a._tTime=Qe._time,r=Qe._first;r;)l=r._next,(e||!(!r._dur&&r instanceof mn&&r.vars.onComplete===r._targets[0]))&&la(a,r,r._start-r._delay),r=l;return la(Qe,a,0),a},context:function(t,e){return t?new zS(t,e):Ye},matchMedia:function(t){return new v2(t)},matchMediaRefresh:function(){return ms.forEach(function(t){var e=t.conditions,a,r;for(r in e)e[r]&&(e[r]=!1,a=1);a&&t.revert()})||Am()},addEventListener:function(t,e){var a=cf[t]||(cf[t]=[]);~a.indexOf(e)||a.push(e)},removeEventListener:function(t,e){var a=cf[t],r=a&&a.indexOf(e);r>=0&&a.splice(r,1)},utils:{wrap:KC,wrapYoyo:QC,distribute:mS,random:gS,snap:_S,normalize:ZC,getUnit:Vn,clamp:WC,splitColor:MS,toArray:Fi,selector:Em,mapRange:xS,pipe:YC,unitize:jC,interpolate:JC,shuffle:pS},install:nS,effects:yp,ticker:xi,updateRoot:Zn.updateRoot,plugins:vi,globalTimeline:Qe,core:{PropTween:si,globals:iS,Tween:mn,Timeline:Zn,Animation:cu,getCache:hs,_removeLinkedListItem:wf,reverting:function(){return Pn},context:function(t){return t&&Ye&&(Ye.data.push(t),t._ctx=Ye),Ye},suppressOverwrites:function(t){return Wm=t}}};ri("to,from,fromTo,delayedCall,set,killTweensOf",function(o){return Mf[o]=mn[o]});xi.add(Zn.updateRoot);Eo=Mf.to({},{duration:0});var x2=function(t,e){for(var a=t._pt;a&&a.p!==e&&a.op!==e&&a.fp!==e;)a=a._next;return a},y2=function(t,e){var a=t._targets,r,l,c;for(r in e)for(l=a.length;l--;)c=t._ptLookup[l][r],c&&(c=c.d)&&(c._pt&&(c=x2(c,r)),c&&c.modifier&&c.modifier(e[r],t,a[l],r))},bp=function(t,e){return{name:t,headless:1,rawVars:1,init:function(r,l,c){c._onInit=function(f){var p,h;if(Cn(l)&&(p={},ri(l,function(m){return p[m]=1}),l=p),e){p={};for(h in l)p[h]=e(l[h]);l=p}y2(f,l)}}}},li=Mf.registerPlugin({name:"attr",init:function(t,e,a,r,l){var c,f,p;this.tween=a;for(c in e)p=t.getAttribute(c)||"",f=this.add(t,"setAttribute",(p||0)+"",e[c],r,l,0,0,c),f.op=c,f.b=p,this._props.push(c)},render:function(t,e){for(var a=e._pt;a;)Pn?a.set(a.t,a.p,a.b,a):a.r(t,a.d),a=a._next}},{name:"endArray",headless:1,init:function(t,e){for(var a=e.length;a--;)this.add(t,a,t[a]||0,e[a],0,0,0,0,0,1)}},bp("roundProps",Tm),bp("modifiers"),bp("snap",_S))||Mf;mn.version=Zn.version=li.version="3.13.0";eS=1;Ym()&&Bo();Me.Power0;Me.Power1;Me.Power2;Me.Power3;Me.Power4;Me.Linear;Me.Quad;Me.Cubic;Me.Quart;Me.Quint;Me.Strong;Me.Elastic;Me.Back;Me.SteppedEase;Me.Bounce;Me.Sine;Me.Expo;Me.Circ;/*!
 * CSSPlugin 3.13.0
 * https://gsap.com
 *
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var sy,Tr,Ro,r_,fs,oy,s_,S2=function(){return typeof window<"u"},Wa={},ss=180/Math.PI,wo=Math.PI/180,vo=Math.atan2,ly=1e8,o_=/([A-Z])/g,M2=/(left|right|width|margin|padding|x)/i,E2=/[\s,\(]\S/,fa={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},Rm=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},T2=function(t,e){return e.set(e.t,e.p,t===1?e.e:Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},b2=function(t,e){return e.set(e.t,e.p,t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},A2=function(t,e){var a=e.s+e.c*t;e.set(e.t,e.p,~~(a+(a<0?-.5:.5))+e.u,e)},IS=function(t,e){return e.set(e.t,e.p,t?e.e:e.b,e)},BS=function(t,e){return e.set(e.t,e.p,t!==1?e.b:e.e,e)},R2=function(t,e,a){return t.style[e]=a},w2=function(t,e,a){return t.style.setProperty(e,a)},C2=function(t,e,a){return t._gsap[e]=a},D2=function(t,e,a){return t._gsap.scaleX=t._gsap.scaleY=a},U2=function(t,e,a,r,l){var c=t._gsap;c.scaleX=c.scaleY=a,c.renderTransform(l,c)},L2=function(t,e,a,r,l){var c=t._gsap;c[e]=a,c.renderTransform(l,c)},Je="transform",oi=Je+"Origin",O2=function o(t,e){var a=this,r=this.target,l=r.style,c=r._gsap;if(t in Wa&&l){if(this.tfm=this.tfm||{},t!=="transform")t=fa[t]||t,~t.indexOf(",")?t.split(",").forEach(function(f){return a.tfm[f]=Ba(r,f)}):this.tfm[t]=c.x?c[t]:Ba(r,t),t===oi&&(this.tfm.zOrigin=c.zOrigin);else return fa.transform.split(",").forEach(function(f){return o.call(a,f,e)});if(this.props.indexOf(Je)>=0)return;c.svg&&(this.svgo=r.getAttribute("data-svg-origin"),this.props.push(oi,e,"")),t=Je}(l||e)&&this.props.push(t,e,l[t])},FS=function(t){t.translate&&(t.removeProperty("translate"),t.removeProperty("scale"),t.removeProperty("rotate"))},N2=function(){var t=this.props,e=this.target,a=e.style,r=e._gsap,l,c;for(l=0;l<t.length;l+=3)t[l+1]?t[l+1]===2?e[t[l]](t[l+2]):e[t[l]]=t[l+2]:t[l+2]?a[t[l]]=t[l+2]:a.removeProperty(t[l].substr(0,2)==="--"?t[l]:t[l].replace(o_,"-$1").toLowerCase());if(this.tfm){for(c in this.tfm)r[c]=this.tfm[c];r.svg&&(r.renderTransform(),e.setAttribute("data-svg-origin",this.svgo||"")),l=s_(),(!l||!l.isStart)&&!a[Je]&&(FS(a),r.zOrigin&&a[oi]&&(a[oi]+=" "+r.zOrigin+"px",r.zOrigin=0,r.renderTransform()),r.uncache=1)}},HS=function(t,e){var a={target:t,props:[],revert:N2,save:O2};return t._gsap||li.core.getCache(t),e&&t.style&&t.nodeType&&e.split(",").forEach(function(r){return a.save(r)}),a},GS,wm=function(t,e){var a=Tr.createElementNS?Tr.createElementNS((e||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),t):Tr.createElement(t);return a&&a.style?a:Tr.createElement(t)},Hi=function o(t,e,a){var r=getComputedStyle(t);return r[e]||r.getPropertyValue(e.replace(o_,"-$1").toLowerCase())||r.getPropertyValue(e)||!a&&o(t,Fo(e)||e,1)||""},uy="O,Moz,ms,Ms,Webkit".split(","),Fo=function(t,e,a){var r=e||fs,l=r.style,c=5;if(t in l&&!a)return t;for(t=t.charAt(0).toUpperCase()+t.substr(1);c--&&!(uy[c]+t in l););return c<0?null:(c===3?"ms":c>=0?uy[c]:"")+t},Cm=function(){S2()&&window.document&&(sy=window,Tr=sy.document,Ro=Tr.documentElement,fs=wm("div")||{style:{}},wm("div"),Je=Fo(Je),oi=Je+"Origin",fs.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",GS=!!Fo("perspective"),s_=li.core.reverting,r_=1)},cy=function(t){var e=t.ownerSVGElement,a=wm("svg",e&&e.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),r=t.cloneNode(!0),l;r.style.display="block",a.appendChild(r),Ro.appendChild(a);try{l=r.getBBox()}catch{}return a.removeChild(r),Ro.removeChild(a),l},fy=function(t,e){for(var a=e.length;a--;)if(t.hasAttribute(e[a]))return t.getAttribute(e[a])},VS=function(t){var e,a;try{e=t.getBBox()}catch{e=cy(t),a=1}return e&&(e.width||e.height)||a||(e=cy(t)),e&&!e.width&&!e.x&&!e.y?{x:+fy(t,["x","cx","x1"])||0,y:+fy(t,["y","cy","y1"])||0,width:0,height:0}:e},kS=function(t){return!!(t.getCTM&&(!t.parentNode||t.ownerSVGElement)&&VS(t))},xs=function(t,e){if(e){var a=t.style,r;e in Wa&&e!==oi&&(e=Je),a.removeProperty?(r=e.substr(0,2),(r==="ms"||e.substr(0,6)==="webkit")&&(e="-"+e),a.removeProperty(r==="--"?e:e.replace(o_,"-$1").toLowerCase())):a.removeAttribute(e)}},br=function(t,e,a,r,l,c){var f=new si(t._pt,e,a,0,1,c?BS:IS);return t._pt=f,f.b=r,f.e=l,t._props.push(a),f},hy={deg:1,rad:1,turn:1},P2={grid:1,flex:1},Ur=function o(t,e,a,r){var l=parseFloat(a)||0,c=(a+"").trim().substr((l+"").length)||"px",f=fs.style,p=M2.test(e),h=t.tagName.toLowerCase()==="svg",m=(h?"client":"offset")+(p?"Width":"Height"),g=100,v=r==="px",x=r==="%",E,M,S,y;if(r===c||!l||hy[r]||hy[c])return l;if(c!=="px"&&!v&&(l=o(t,e,a,"px")),y=t.getCTM&&kS(t),(x||c==="%")&&(Wa[e]||~e.indexOf("adius")))return E=y?t.getBBox()[p?"width":"height"]:t[m],un(x?l/E*g:l/100*E);if(f[p?"width":"height"]=g+(v?c:r),M=r!=="rem"&&~e.indexOf("adius")||r==="em"&&t.appendChild&&!h?t:t.parentNode,y&&(M=(t.ownerSVGElement||{}).parentNode),(!M||M===Tr||!M.appendChild)&&(M=Tr.body),S=M._gsap,S&&x&&S.width&&p&&S.time===xi.time&&!S.uncache)return un(l/S.width*g);if(x&&(e==="height"||e==="width")){var D=t.style[e];t.style[e]=g+r,E=t[m],D?t.style[e]=D:xs(t,e)}else(x||c==="%")&&!P2[Hi(M,"display")]&&(f.position=Hi(t,"position")),M===t&&(f.position="static"),M.appendChild(fs),E=fs[m],M.removeChild(fs),f.position="absolute";return p&&x&&(S=hs(M),S.time=xi.time,S.width=M[m]),un(v?E*l/g:E&&l?g/E*l:0)},Ba=function(t,e,a,r){var l;return r_||Cm(),e in fa&&e!=="transform"&&(e=fa[e],~e.indexOf(",")&&(e=e.split(",")[0])),Wa[e]&&e!=="transform"?(l=hu(t,r),l=e!=="transformOrigin"?l[e]:l.svg?l.origin:Tf(Hi(t,oi))+" "+l.zOrigin+"px"):(l=t.style[e],(!l||l==="auto"||r||~(l+"").indexOf("calc("))&&(l=Ef[e]&&Ef[e](t,e,a)||Hi(t,e)||rS(t,e)||(e==="opacity"?1:0))),a&&!~(l+"").trim().indexOf(" ")?Ur(t,e,l,a)+a:l},z2=function(t,e,a,r){if(!a||a==="none"){var l=Fo(e,t,1),c=l&&Hi(t,l,1);c&&c!==a?(e=l,a=c):e==="borderColor"&&(a=Hi(t,"borderTopColor"))}var f=new si(this._pt,t.style,e,0,1,NS),p=0,h=0,m,g,v,x,E,M,S,y,D,U,A,L;if(f.b=a,f.e=r,a+="",r+="",r.substring(0,6)==="var(--"&&(r=Hi(t,r.substring(4,r.indexOf(")")))),r==="auto"&&(M=t.style[e],t.style[e]=r,r=Hi(t,e)||r,M?t.style[e]=M:xs(t,e)),m=[a,r],TS(m),a=m[0],r=m[1],v=a.match(Mo)||[],L=r.match(Mo)||[],L.length){for(;g=Mo.exec(r);)S=g[0],D=r.substring(p,g.index),E?E=(E+1)%5:(D.substr(-5)==="rgba("||D.substr(-5)==="hsla(")&&(E=1),S!==(M=v[h++]||"")&&(x=parseFloat(M)||0,A=M.substr((x+"").length),S.charAt(1)==="="&&(S=Ao(x,S)+A),y=parseFloat(S),U=S.substr((y+"").length),p=Mo.lastIndex-U.length,U||(U=U||Ei.units[e]||A,p===r.length&&(r+=U,f.e+=U)),A!==U&&(x=Ur(t,e,M,U)||0),f._pt={_next:f._pt,p:D||h===1?D:",",s:x,c:y-x,m:E&&E<4||e==="zIndex"?Math.round:0});f.c=p<r.length?r.substring(p,r.length):""}else f.r=e==="display"&&r==="none"?BS:IS;return $y.test(r)&&(f.e=0),this._pt=f,f},dy={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},I2=function(t){var e=t.split(" "),a=e[0],r=e[1]||"50%";return(a==="top"||a==="bottom"||r==="left"||r==="right")&&(t=a,a=r,r=t),e[0]=dy[a]||a,e[1]=dy[r]||r,e.join(" ")},B2=function(t,e){if(e.tween&&e.tween._time===e.tween._dur){var a=e.t,r=a.style,l=e.u,c=a._gsap,f,p,h;if(l==="all"||l===!0)r.cssText="",p=1;else for(l=l.split(","),h=l.length;--h>-1;)f=l[h],Wa[f]&&(p=1,f=f==="transformOrigin"?oi:Je),xs(a,f);p&&(xs(a,Je),c&&(c.svg&&a.removeAttribute("transform"),r.scale=r.rotate=r.translate="none",hu(a,1),c.uncache=1,FS(r)))}},Ef={clearProps:function(t,e,a,r,l){if(l.data!=="isFromStart"){var c=t._pt=new si(t._pt,e,a,0,0,B2);return c.u=r,c.pr=-10,c.tween=l,t._props.push(a),1}}},fu=[1,0,0,1,0,0],XS={},WS=function(t){return t==="matrix(1, 0, 0, 1, 0, 0)"||t==="none"||!t},py=function(t){var e=Hi(t,Je);return WS(e)?fu:e.substr(7).match(Jy).map(un)},l_=function(t,e){var a=t._gsap||hs(t),r=t.style,l=py(t),c,f,p,h;return a.svg&&t.getAttribute("transform")?(p=t.transform.baseVal.consolidate().matrix,l=[p.a,p.b,p.c,p.d,p.e,p.f],l.join(",")==="1,0,0,1,0,0"?fu:l):(l===fu&&!t.offsetParent&&t!==Ro&&!a.svg&&(p=r.display,r.display="block",c=t.parentNode,(!c||!t.offsetParent&&!t.getBoundingClientRect().width)&&(h=1,f=t.nextElementSibling,Ro.appendChild(t)),l=py(t),p?r.display=p:xs(t,"display"),h&&(f?c.insertBefore(t,f):c?c.appendChild(t):Ro.removeChild(t))),e&&l.length>6?[l[0],l[1],l[4],l[5],l[12],l[13]]:l)},Dm=function(t,e,a,r,l,c){var f=t._gsap,p=l||l_(t,!0),h=f.xOrigin||0,m=f.yOrigin||0,g=f.xOffset||0,v=f.yOffset||0,x=p[0],E=p[1],M=p[2],S=p[3],y=p[4],D=p[5],U=e.split(" "),A=parseFloat(U[0])||0,L=parseFloat(U[1])||0,P,z,F,b;a?p!==fu&&(z=x*S-E*M)&&(F=A*(S/z)+L*(-M/z)+(M*D-S*y)/z,b=A*(-E/z)+L*(x/z)-(x*D-E*y)/z,A=F,L=b):(P=VS(t),A=P.x+(~U[0].indexOf("%")?A/100*P.width:A),L=P.y+(~(U[1]||U[0]).indexOf("%")?L/100*P.height:L)),r||r!==!1&&f.smooth?(y=A-h,D=L-m,f.xOffset=g+(y*x+D*M)-y,f.yOffset=v+(y*E+D*S)-D):f.xOffset=f.yOffset=0,f.xOrigin=A,f.yOrigin=L,f.smooth=!!r,f.origin=e,f.originIsAbsolute=!!a,t.style[oi]="0px 0px",c&&(br(c,f,"xOrigin",h,A),br(c,f,"yOrigin",m,L),br(c,f,"xOffset",g,f.xOffset),br(c,f,"yOffset",v,f.yOffset)),t.setAttribute("data-svg-origin",A+" "+L)},hu=function(t,e){var a=t._gsap||new wS(t);if("x"in a&&!e&&!a.uncache)return a;var r=t.style,l=a.scaleX<0,c="px",f="deg",p=getComputedStyle(t),h=Hi(t,oi)||"0",m,g,v,x,E,M,S,y,D,U,A,L,P,z,F,b,O,V,j,tt,ct,rt,B,k,X,ft,N,Q,mt,yt,bt,Nt;return m=g=v=M=S=y=D=U=A=0,x=E=1,a.svg=!!(t.getCTM&&kS(t)),p.translate&&((p.translate!=="none"||p.scale!=="none"||p.rotate!=="none")&&(r[Je]=(p.translate!=="none"?"translate3d("+(p.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(p.rotate!=="none"?"rotate("+p.rotate+") ":"")+(p.scale!=="none"?"scale("+p.scale.split(" ").join(",")+") ":"")+(p[Je]!=="none"?p[Je]:"")),r.scale=r.rotate=r.translate="none"),z=l_(t,a.svg),a.svg&&(a.uncache?(X=t.getBBox(),h=a.xOrigin-X.x+"px "+(a.yOrigin-X.y)+"px",k=""):k=!e&&t.getAttribute("data-svg-origin"),Dm(t,k||h,!!k||a.originIsAbsolute,a.smooth!==!1,z)),L=a.xOrigin||0,P=a.yOrigin||0,z!==fu&&(V=z[0],j=z[1],tt=z[2],ct=z[3],m=rt=z[4],g=B=z[5],z.length===6?(x=Math.sqrt(V*V+j*j),E=Math.sqrt(ct*ct+tt*tt),M=V||j?vo(j,V)*ss:0,D=tt||ct?vo(tt,ct)*ss+M:0,D&&(E*=Math.abs(Math.cos(D*wo))),a.svg&&(m-=L-(L*V+P*tt),g-=P-(L*j+P*ct))):(Nt=z[6],yt=z[7],N=z[8],Q=z[9],mt=z[10],bt=z[11],m=z[12],g=z[13],v=z[14],F=vo(Nt,mt),S=F*ss,F&&(b=Math.cos(-F),O=Math.sin(-F),k=rt*b+N*O,X=B*b+Q*O,ft=Nt*b+mt*O,N=rt*-O+N*b,Q=B*-O+Q*b,mt=Nt*-O+mt*b,bt=yt*-O+bt*b,rt=k,B=X,Nt=ft),F=vo(-tt,mt),y=F*ss,F&&(b=Math.cos(-F),O=Math.sin(-F),k=V*b-N*O,X=j*b-Q*O,ft=tt*b-mt*O,bt=ct*O+bt*b,V=k,j=X,tt=ft),F=vo(j,V),M=F*ss,F&&(b=Math.cos(F),O=Math.sin(F),k=V*b+j*O,X=rt*b+B*O,j=j*b-V*O,B=B*b-rt*O,V=k,rt=X),S&&Math.abs(S)+Math.abs(M)>359.9&&(S=M=0,y=180-y),x=un(Math.sqrt(V*V+j*j+tt*tt)),E=un(Math.sqrt(B*B+Nt*Nt)),F=vo(rt,B),D=Math.abs(F)>2e-4?F*ss:0,A=bt?1/(bt<0?-bt:bt):0),a.svg&&(k=t.getAttribute("transform"),a.forceCSS=t.setAttribute("transform","")||!WS(Hi(t,Je)),k&&t.setAttribute("transform",k))),Math.abs(D)>90&&Math.abs(D)<270&&(l?(x*=-1,D+=M<=0?180:-180,M+=M<=0?180:-180):(E*=-1,D+=D<=0?180:-180)),e=e||a.uncache,a.x=m-((a.xPercent=m&&(!e&&a.xPercent||(Math.round(t.offsetWidth/2)===Math.round(-m)?-50:0)))?t.offsetWidth*a.xPercent/100:0)+c,a.y=g-((a.yPercent=g&&(!e&&a.yPercent||(Math.round(t.offsetHeight/2)===Math.round(-g)?-50:0)))?t.offsetHeight*a.yPercent/100:0)+c,a.z=v+c,a.scaleX=un(x),a.scaleY=un(E),a.rotation=un(M)+f,a.rotationX=un(S)+f,a.rotationY=un(y)+f,a.skewX=D+f,a.skewY=U+f,a.transformPerspective=A+c,(a.zOrigin=parseFloat(h.split(" ")[2])||!e&&a.zOrigin||0)&&(r[oi]=Tf(h)),a.xOffset=a.yOffset=0,a.force3D=Ei.force3D,a.renderTransform=a.svg?H2:GS?qS:F2,a.uncache=0,a},Tf=function(t){return(t=t.split(" "))[0]+" "+t[1]},Ap=function(t,e,a){var r=Vn(e);return un(parseFloat(e)+parseFloat(Ur(t,"x",a+"px",r)))+r},F2=function(t,e){e.z="0px",e.rotationY=e.rotationX="0deg",e.force3D=0,qS(t,e)},ns="0deg",Xl="0px",is=") ",qS=function(t,e){var a=e||this,r=a.xPercent,l=a.yPercent,c=a.x,f=a.y,p=a.z,h=a.rotation,m=a.rotationY,g=a.rotationX,v=a.skewX,x=a.skewY,E=a.scaleX,M=a.scaleY,S=a.transformPerspective,y=a.force3D,D=a.target,U=a.zOrigin,A="",L=y==="auto"&&t&&t!==1||y===!0;if(U&&(g!==ns||m!==ns)){var P=parseFloat(m)*wo,z=Math.sin(P),F=Math.cos(P),b;P=parseFloat(g)*wo,b=Math.cos(P),c=Ap(D,c,z*b*-U),f=Ap(D,f,-Math.sin(P)*-U),p=Ap(D,p,F*b*-U+U)}S!==Xl&&(A+="perspective("+S+is),(r||l)&&(A+="translate("+r+"%, "+l+"%) "),(L||c!==Xl||f!==Xl||p!==Xl)&&(A+=p!==Xl||L?"translate3d("+c+", "+f+", "+p+") ":"translate("+c+", "+f+is),h!==ns&&(A+="rotate("+h+is),m!==ns&&(A+="rotateY("+m+is),g!==ns&&(A+="rotateX("+g+is),(v!==ns||x!==ns)&&(A+="skew("+v+", "+x+is),(E!==1||M!==1)&&(A+="scale("+E+", "+M+is),D.style[Je]=A||"translate(0, 0)"},H2=function(t,e){var a=e||this,r=a.xPercent,l=a.yPercent,c=a.x,f=a.y,p=a.rotation,h=a.skewX,m=a.skewY,g=a.scaleX,v=a.scaleY,x=a.target,E=a.xOrigin,M=a.yOrigin,S=a.xOffset,y=a.yOffset,D=a.forceCSS,U=parseFloat(c),A=parseFloat(f),L,P,z,F,b;p=parseFloat(p),h=parseFloat(h),m=parseFloat(m),m&&(m=parseFloat(m),h+=m,p+=m),p||h?(p*=wo,h*=wo,L=Math.cos(p)*g,P=Math.sin(p)*g,z=Math.sin(p-h)*-v,F=Math.cos(p-h)*v,h&&(m*=wo,b=Math.tan(h-m),b=Math.sqrt(1+b*b),z*=b,F*=b,m&&(b=Math.tan(m),b=Math.sqrt(1+b*b),L*=b,P*=b)),L=un(L),P=un(P),z=un(z),F=un(F)):(L=g,F=v,P=z=0),(U&&!~(c+"").indexOf("px")||A&&!~(f+"").indexOf("px"))&&(U=Ur(x,"x",c,"px"),A=Ur(x,"y",f,"px")),(E||M||S||y)&&(U=un(U+E-(E*L+M*z)+S),A=un(A+M-(E*P+M*F)+y)),(r||l)&&(b=x.getBBox(),U=un(U+r/100*b.width),A=un(A+l/100*b.height)),b="matrix("+L+","+P+","+z+","+F+","+U+","+A+")",x.setAttribute("transform",b),D&&(x.style[Je]=b)},G2=function(t,e,a,r,l){var c=360,f=Cn(l),p=parseFloat(l)*(f&&~l.indexOf("rad")?ss:1),h=p-r,m=r+h+"deg",g,v;return f&&(g=l.split("_")[1],g==="short"&&(h%=c,h!==h%(c/2)&&(h+=h<0?c:-c)),g==="cw"&&h<0?h=(h+c*ly)%c-~~(h/c)*c:g==="ccw"&&h>0&&(h=(h-c*ly)%c-~~(h/c)*c)),t._pt=v=new si(t._pt,e,a,r,h,T2),v.e=m,v.u="deg",t._props.push(a),v},my=function(t,e){for(var a in e)t[a]=e[a];return t},V2=function(t,e,a){var r=my({},a._gsap),l="perspective,force3D,transformOrigin,svgOrigin",c=a.style,f,p,h,m,g,v,x,E;r.svg?(h=a.getAttribute("transform"),a.setAttribute("transform",""),c[Je]=e,f=hu(a,1),xs(a,Je),a.setAttribute("transform",h)):(h=getComputedStyle(a)[Je],c[Je]=e,f=hu(a,1),c[Je]=h);for(p in Wa)h=r[p],m=f[p],h!==m&&l.indexOf(p)<0&&(x=Vn(h),E=Vn(m),g=x!==E?Ur(a,p,h,E):parseFloat(h),v=parseFloat(m),t._pt=new si(t._pt,f,p,g,v-g,Rm),t._pt.u=E||0,t._props.push(p));my(f,r)};ri("padding,margin,Width,Radius",function(o,t){var e="Top",a="Right",r="Bottom",l="Left",c=(t<3?[e,a,r,l]:[e+l,e+a,r+a,r+l]).map(function(f){return t<2?o+f:"border"+f+o});Ef[t>1?"border"+o:o]=function(f,p,h,m,g){var v,x;if(arguments.length<4)return v=c.map(function(E){return Ba(f,E,h)}),x=v.join(" "),x.split(v[0]).length===5?v[0]:x;v=(m+"").split(" "),x={},c.forEach(function(E,M){return x[E]=v[M]=v[M]||v[(M-1)/2|0]}),f.init(p,x,g)}});var YS={name:"css",register:Cm,targetTest:function(t){return t.style&&t.nodeType},init:function(t,e,a,r,l){var c=this._props,f=t.style,p=a.vars.startAt,h,m,g,v,x,E,M,S,y,D,U,A,L,P,z,F;r_||Cm(),this.styles=this.styles||HS(t),F=this.styles.props,this.tween=a;for(M in e)if(M!=="autoRound"&&(m=e[M],!(vi[M]&&CS(M,e,a,r,t,l)))){if(x=typeof m,E=Ef[M],x==="function"&&(m=m.call(a,r,t,l),x=typeof m),x==="string"&&~m.indexOf("random(")&&(m=lu(m)),E)E(this,t,M,m,a)&&(z=1);else if(M.substr(0,2)==="--")h=(getComputedStyle(t).getPropertyValue(M)+"").trim(),m+="",Cr.lastIndex=0,Cr.test(h)||(S=Vn(h),y=Vn(m)),y?S!==y&&(h=Ur(t,M,h,y)+y):S&&(m+=S),this.add(f,"setProperty",h,m,r,l,0,0,M),c.push(M),F.push(M,0,f[M]);else if(x!=="undefined"){if(p&&M in p?(h=typeof p[M]=="function"?p[M].call(a,r,t,l):p[M],Cn(h)&&~h.indexOf("random(")&&(h=lu(h)),Vn(h+"")||h==="auto"||(h+=Ei.units[M]||Vn(Ba(t,M))||""),(h+"").charAt(1)==="="&&(h=Ba(t,M))):h=Ba(t,M),v=parseFloat(h),D=x==="string"&&m.charAt(1)==="="&&m.substr(0,2),D&&(m=m.substr(2)),g=parseFloat(m),M in fa&&(M==="autoAlpha"&&(v===1&&Ba(t,"visibility")==="hidden"&&g&&(v=0),F.push("visibility",0,f.visibility),br(this,f,"visibility",v?"inherit":"hidden",g?"inherit":"hidden",!g)),M!=="scale"&&M!=="transform"&&(M=fa[M],~M.indexOf(",")&&(M=M.split(",")[0]))),U=M in Wa,U){if(this.styles.save(M),x==="string"&&m.substring(0,6)==="var(--"&&(m=Hi(t,m.substring(4,m.indexOf(")"))),g=parseFloat(m)),A||(L=t._gsap,L.renderTransform&&!e.parseTransform||hu(t,e.parseTransform),P=e.smoothOrigin!==!1&&L.smooth,A=this._pt=new si(this._pt,f,Je,0,1,L.renderTransform,L,0,-1),A.dep=1),M==="scale")this._pt=new si(this._pt,L,"scaleY",L.scaleY,(D?Ao(L.scaleY,D+g):g)-L.scaleY||0,Rm),this._pt.u=0,c.push("scaleY",M),M+="X";else if(M==="transformOrigin"){F.push(oi,0,f[oi]),m=I2(m),L.svg?Dm(t,m,0,P,0,this):(y=parseFloat(m.split(" ")[2])||0,y!==L.zOrigin&&br(this,L,"zOrigin",L.zOrigin,y),br(this,f,M,Tf(h),Tf(m)));continue}else if(M==="svgOrigin"){Dm(t,m,1,P,0,this);continue}else if(M in XS){G2(this,L,M,v,D?Ao(v,D+m):m);continue}else if(M==="smoothOrigin"){br(this,L,"smooth",L.smooth,m);continue}else if(M==="force3D"){L[M]=m;continue}else if(M==="transform"){V2(this,m,t);continue}}else M in f||(M=Fo(M)||M);if(U||(g||g===0)&&(v||v===0)&&!E2.test(m)&&M in f)S=(h+"").substr((v+"").length),g||(g=0),y=Vn(m)||(M in Ei.units?Ei.units[M]:S),S!==y&&(v=Ur(t,M,h,y)),this._pt=new si(this._pt,U?L:f,M,v,(D?Ao(v,D+g):g)-v,!U&&(y==="px"||M==="zIndex")&&e.autoRound!==!1?A2:Rm),this._pt.u=y||0,S!==y&&y!=="%"&&(this._pt.b=h,this._pt.r=b2);else if(M in f)z2.call(this,t,M,h,D?D+m:m);else if(M in t)this.add(t,M,h||t[M],D?D+m:m,r,l);else if(M!=="parseTransform"){Zm(M,m);continue}U||(M in f?F.push(M,0,f[M]):typeof t[M]=="function"?F.push(M,2,t[M]()):F.push(M,1,h||t[M])),c.push(M)}}z&&PS(this)},render:function(t,e){if(e.tween._time||!s_())for(var a=e._pt;a;)a.r(t,a.d),a=a._next;else e.styles.revert()},get:Ba,aliases:fa,getSetter:function(t,e,a){var r=fa[e];return r&&r.indexOf(",")<0&&(e=r),e in Wa&&e!==oi&&(t._gsap.x||Ba(t,"x"))?a&&oy===a?e==="scale"?D2:C2:(oy=a||{})&&(e==="scale"?U2:L2):t.style&&!qm(t.style[e])?R2:~e.indexOf("-")?w2:i_(t,e)},core:{_removeProperty:xs,_getMatrix:l_}};li.utils.checkPrefix=Fo;li.core.getStyleSaver=HS;(function(o,t,e,a){var r=ri(o+","+t+","+e,function(l){Wa[l]=1});ri(t,function(l){Ei.units[l]="deg",XS[l]=1}),fa[r[13]]=o+","+t,ri(a,function(l){var c=l.split(":");fa[c[1]]=r[c[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");ri("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(o){Ei.units[o]="px"});li.registerPlugin(YS);var ff=li.registerPlugin(YS)||li;ff.core.Tween;function k2(){const o=$l.useRef(null);return $l.useEffect(()=>{const t=o.current,e=t.clientWidth,a=t.clientHeight,r=new S1,l=new Ii(45,e/a,.1,1e3);l.position.z=5;const c=new SC({antialias:!0,alpha:!0});c.setSize(e,a),c.setPixelRatio(Math.min(window.devicePixelRatio,2)),c.setClearColor(0,0),t.appendChild(c.domElement);const f=new xo;r.add(f),new RC().load("/models/middle2.mtl",k=>{k.preload();const X=new Jx;X.setMaterials(k),X.load("/models/middle2.obj",ft=>{ft.scale.setScalar(.01),ft.position.set(0,0,0),ft.traverse(N=>{N.isMesh&&(N.castShadow=!0,N.receiveShadow=!0,N.material&&(N.material.needsUpdate=!0,Array.isArray(N.material)&&N.material.forEach(Q=>{Q.needsUpdate=!0})))}),f.add(ft)},ft=>{console.log("OBJ loading progress:",ft.loaded/ft.total*100+"%")},ft=>{console.error("Error loading OBJ model:",ft);const N=new vs(1,1,1),Q=new cp({color:8956671}),mt=new yi(N,Q);f.add(mt)})},k=>{console.log("MTL loading progress:",k.loaded/k.total*100+"%")},k=>{console.error("Error loading MTL materials:",k),new Jx().load("/models/middle2.obj",ft=>{ft.scale.setScalar(.01),ft.position.set(0,0,0),ft.traverse(N=>{N.isMesh&&(N.material=new cp({color:8947848,roughness:.5,metalness:.3}),N.castShadow=!0,N.receiveShadow=!0)}),f.add(ft)})});const h=new vs(.1,.1,.1),m=new cp({transparent:!0,opacity:0});new yi(h,m);const g=new N1(16777215,1);g.position.set(5,5,5),r.add(g);const v=new P1(4210752,.6);r.add(v);const x=50;let E=0,M=0,S=0,y=0;const D=new Ti,U=new Float32Array(x*3),A=new Float32Array(x);for(let k=0;k<x;k++)U[k*3]=0,U[k*3+1]=0,U[k*3+2]=0,A[k]=(x-k)/x;D.setAttribute("position",new Mi(U,3)),D.setAttribute("opacity",new Mi(A,1));const L=new ka({uniforms:{time:{value:0},color:{value:new ce(8956671)}},vertexShader:`
