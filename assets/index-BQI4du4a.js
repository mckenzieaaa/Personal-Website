...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        `})]}):E.jsxs("div",{style:{width:"100vw",height:"100vh",background:"#000000",color:"white",margin:0,padding:0,overflow:"hidden auto",scrollSnapType:"y mandatory"},children:[E.jsxs("section",{style:{minHeight:"100vh",height:"100vh",width:"100vw",padding:"40px",background:"linear-gradient(135deg, #000000 0%, #1a1a1a 50%, #000000 100%)",display:"flex",alignItems:"center",justifyContent:"space-between",position:"relative",scrollSnapAlign:"start",scrollSnapStop:"always",overflow:"hidden"},children:[E.jsxs("div",{style:{flex:"1",display:"flex",flexDirection:"column",justifyContent:"center",padding:"0 80px",zIndex:2},children:[E.jsxs("div",{style:{marginBottom:"40px",display:"flex",alignItems:"center",gap:"15px"},children:[E.jsx("img",{src:"/Personal-Website/images/logo111.svg",alt:"OYXR Logo",style:{width:"60px",height:"60px",filter:"invert(1)",opacity:.9,backgroundColor:"white",borderRadius:"50%",padding:"8px",border:"2px solid rgba(255,255,255,0.8)"}}),E.jsx("div",{style:{fontSize:"1.5rem",fontWeight:"300",color:"white",letterSpacing:"0.1em",fontFamily:"'Inter', sans-serif"},children:"OYXR"})]}),E.jsx("div",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.3em",marginBottom:"30px",textTransform:"uppercase",fontWeight:"300",fontFamily:"'Inter', sans-serif"},children:"Digital Artist & Creative Technologist"}),E.jsxs("h1",{style:{fontSize:"clamp(2rem, 4vw, 3.5rem)",fontWeight:"100",margin:"0 0 30px 0",letterSpacing:"-0.03em",lineHeight:"1.1",background:"linear-gradient(135deg, #ffffff 0%, #888888 100%)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",fontFamily:"'Inter', sans-serif"},children:["Xinran",E.jsx("br",{}),"Ouyang"]}),E.jsx("p",{style:{fontSize:"clamp(1rem, 2vw, 1.2rem)",lineHeight:"1.6",color:"rgba(255,255,255,0.7)",fontWeight:"300",maxWidth:"500px",margin:"0 0 50px 0",fontFamily:"'Inter', sans-serif"},children:"Exploring the intersection of technology, creativity, and human experience through immersive digital art and interactive installations."}),E.jsxs("div",{style:{display:"flex",gap:"20px",flexWrap:"wrap"},children:[E.jsx("button",{style:{background:"white",color:"black",border:"none",padding:"16px 32px",fontSize:"0.95rem",fontWeight:"500",letterSpacing:"0.05em",cursor:"pointer",transition:"all 0.3s ease",fontFamily:"'Inter', sans-serif",textTransform:"uppercase"},onMouseEnter:R=>{R.target.style.background="rgba(255,255,255,0.9)",R.target.style.transform="translateY(-2px)"},onMouseLeave:R=>{R.target.style.background="white",R.target.style.transform="translateY(0)"},onClick:()=>document.getElementById("work").scrollIntoView({behavior:"smooth"}),children:"View Work"}),E.jsx("button",{style:{background:"transparent",color:"white",border:"1px solid rgba(255,255,255,0.3)",padding:"16px 32px",fontSize:"0.95rem",fontWeight:"400",letterSpacing:"0.05em",cursor:"pointer",transition:"all 0.3s ease",fontFamily:"'Inter', sans-serif",textTransform:"uppercase"},onMouseEnter:R=>{R.target.style.borderColor="white",R.target.style.background="rgba(255,255,255,0.1)"},onMouseLeave:R=>{R.target.style.borderColor="rgba(255,255,255,0.3)",R.target.style.background="transparent"},onClick:()=>document.getElementById("about").scrollIntoView({behavior:"smooth"}),children:"About"}),E.jsx("button",{style:{background:"transparent",color:"white",border:"1px solid rgba(255,255,255,0.3)",padding:"16px 32px",fontSize:"0.95rem",fontWeight:"400",letterSpacing:"0.05em",cursor:"pointer",transition:"all 0.3s ease",fontFamily:"'Inter', sans-serif",textTransform:"uppercase"},onMouseEnter:R=>{R.target.style.borderColor="white",R.target.style.background="rgba(255,255,255,0.1)"},onMouseLeave:R=>{R.target.style.borderColor="rgba(255,255,255,0.3)",R.target.style.background="transparent"},onClick:()=>document.getElementById("showcase").scrollIntoView({behavior:"smooth"}),children:"3D Showcase"})]})]}),E.jsxs("div",{style:{flex:"1",display:"flex",alignItems:"center",justifyContent:"flex-start",padding:"0 80px 0 20px",perspective:"1000px",position:"relative"},children:[E.jsx("div",{style:{position:"absolute",top:"20%",right:"-100px",width:"300px",height:"300px",opacity:.3,zIndex:0,pointerEvents:"none"},children:E.jsx(br,{modelSize:1.5,rotationSpeed:.01,showWireframe:!0,color:4890367,geometry:"torus"})}),E.jsxs("div",{style:{position:"relative",width:"100%",maxWidth:"700px",height:"400px",zIndex:1},children:[E.jsx("div",{style:{position:"absolute",top:"50%",left:"50%",width:"600px",height:"300px",transform:`translate(-50%, -50%) rotateY(${n*-90}deg)`,transformStyle:"preserve-3d",transition:a?"transform 0.8s cubic-bezier(0.4, 0, 0.2, 1)":"none"},children:D.map((R,W)=>{const V=W*90,P=W===n;return E.jsx("div",{style:{position:"absolute",width:"450px",height:"280px",top:"50%",left:"50%",transform:`translate(-50%, -50%) rotateY(${V}deg) translateZ(300px)`,transformStyle:"preserve-3d",cursor:"pointer",transition:"all 0.3s ease"},onClick:()=>t(R),children:E.jsxs("div",{style:{width:"100%",height:"100%",background:"rgba(0,0,0,0.8)",borderRadius:"16px",border:P?"2px solid rgba(255,255,255,0.3)":"1px solid rgba(255,255,255,0.1)",overflow:"hidden",position:"relative",transform:P?"scale(1.05)":"scale(0.9)",opacity:P?1:.7,transition:"all 0.3s ease",boxShadow:P?"0 20px 40px rgba(0,0,0,0.5)":"0 10px 20px rgba(0,0,0,0.3)",display:"flex",padding:"20px",gap:"20px"},children:[E.jsxs("div",{style:{flex:"2",display:"flex",alignItems:"center",justifyContent:"center",backgroundColor:"rgba(255,255,255,0.05)",borderRadius:"12px",overflow:"hidden"},children:[E.jsx("img",{src:R.image,alt:R.title,style:{maxWidth:"100%",maxHeight:"100%",objectFit:"contain",borderRadius:"8px"},onError:X=>{X.target.style.display="none",X.target.nextSibling.style.display="flex"}}),E.jsx("div",{style:{display:"none",alignItems:"center",justifyContent:"center",color:"rgba(255,255,255,0.6)",fontSize:"1rem",fontFamily:"'Inter', sans-serif",textAlign:"center",padding:"20px"},children:R.title})]}),E.jsxs("div",{style:{flex:"1",display:"flex",flexDirection:"column",justifyContent:"center",padding:"10px 0"},children:[E.jsxs("div",{style:{fontSize:"0.7rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.1em",marginBottom:"12px",textTransform:"uppercase",fontFamily:"'Inter', sans-serif"},children:[R.category," • ",R.year]}),E.jsx("h3",{style:{fontSize:"1.1rem",fontWeight:"500",margin:"0",color:"white",letterSpacing:"-0.01em",fontFamily:"'Inter', sans-serif",lineHeight:"1.3"},children:R.title})]}),E.jsx("div",{style:{position:"absolute",top:"15px",right:"15px",width:"30px",height:"30px",background:"rgba(0,0,0,0.7)",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",color:"white",fontSize:"14px",opacity:P?1:.7,border:"1px solid rgba(255,255,255,0.2)"},children:"↗"})]})},R.id)})}),E.jsxs("div",{style:{position:"absolute",bottom:"-60px",left:"50%",transform:"translateX(-50%)",display:"flex",alignItems:"center",gap:"20px"},children:[E.jsx("button",{onClick:()=>T("prev"),disabled:a,style:{width:"35px",height:"35px",border:"1px solid rgba(255,255,255,0.3)",background:"rgba(0,0,0,0.5)",color:"white",borderRadius:"50%",cursor:a?"not-allowed":"pointer",fontSize:"14px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s ease",opacity:a?.5:1},children:"←"}),E.jsx("div",{style:{display:"flex",gap:"8px"},children:D.map((R,W)=>E.jsx("div",{onClick:()=>{a||i(W)},style:{width:"8px",height:"8px",borderRadius:"50%",background:W===n?"rgba(255,255,255,0.8)":"rgba(255,255,255,0.3)",cursor:a?"not-allowed":"pointer",transition:"all 0.3s ease"}},W))}),E.jsx("button",{onClick:()=>T("next"),disabled:a,style:{width:"35px",height:"35px",border:"1px solid rgba(255,255,255,0.3)",background:"rgba(0,0,0,0.5)",color:"white",borderRadius:"50%",cursor:a?"not-allowed":"pointer",fontSize:"14px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s ease",opacity:a?.5:1},children:"→"})]})]})]}),E.jsx("div",{style:{position:"absolute",bottom:"40px",left:"50%",transform:"translateX(-50%)",color:"rgba(255,255,255,0.4)",fontSize:"0.8rem",letterSpacing:"0.1em",fontFamily:"'Inter', sans-serif"},children:"SCROLL TO EXPLORE"})]}),E.jsxs("section",{id:"work",style:{height:"100vh",width:"100vw",padding:"40px",background:"linear-gradient(180deg, #000000 0%, #1a1a1a 50%, #000000 100%)",display:"flex",alignItems:"center",justifyContent:"center",scrollSnapAlign:"start",scrollSnapStop:"always",overflow:"hidden"},children:[E.jsxs("div",{style:{width:"320px",display:"flex",flexDirection:"column",paddingRight:"40px"},children:[E.jsxs("div",{style:{marginBottom:"40px"},children:[E.jsx("h2",{style:{fontSize:"2.5rem",fontWeight:"300",margin:"0 0 15px 0",letterSpacing:"-0.02em",color:"white",fontFamily:"'Inter', sans-serif"},children:"Featured Work"}),E.jsx("p",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.6)",margin:0,fontFamily:"'Inter', sans-serif",lineHeight:"1.6"},children:"A selection of recent projects exploring digital art and interactive experiences"})]}),E.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"10px",flex:1,maxHeight:"calc(100vh - 200px)",overflowY:"auto"},children:C.map(R=>E.jsxs("button",{onClick:()=>o(R.id),style:{background:s===R.id?"linear-gradient(135deg, #667eea 0%, #764ba2 100%)":"rgba(255, 255, 255, 0.05)",border:s===R.id?"none":"1px solid rgba(255, 255, 255, 0.1)",borderRadius:"12px",padding:"12px 16px",color:"white",fontSize:"0.9rem",fontWeight:"400",cursor:"pointer",transition:"all 0.3s ease",display:"flex",alignItems:"center",gap:"10px",textAlign:"left",fontFamily:"'Inter', sans-serif",transform:s===R.id?"translateX(5px)":"translateX(0)",boxShadow:s===R.id?"0 4px 15px rgba(102, 126, 234, 0.3)":"none"},onMouseEnter:W=>{s!==R.id&&(W.target.style.background="rgba(255, 255, 255, 0.1)",W.target.style.transform="translateX(3px)")},onMouseLeave:W=>{s!==R.id&&(W.target.style.background="rgba(255, 255, 255, 0.05)",W.target.style.transform="translateX(0)")},children:[E.jsx("span",{style:{fontSize:"1.1rem"},children:R.icon}),E.jsx("span",{children:R.name})]},R.id))})]}),E.jsx("div",{style:{flex:1,display:"grid",gridTemplateColumns:"repeat(2, 1fr)",gridTemplateRows:"repeat(2, 1fr)",gap:"20px",height:"100%",overflow:"hidden"},children:L.map((R,W)=>E.jsxs("div",{style:{background:"rgba(255,255,255,0.05)",borderRadius:"16px",border:"1px solid rgba(255,255,255,0.1)",overflow:"hidden",cursor:"pointer",transition:"all 0.4s cubic-bezier(0.4, 0, 0.2, 1)",transform:"translateY(0)",opacity:1,display:"flex",flexDirection:"column",height:"100%"},onClick:()=>t(R),onMouseEnter:V=>{V.target.style.transform="translateY(-8px)",V.target.style.borderColor="rgba(255,255,255,0.3)",V.target.style.boxShadow="0 20px 40px rgba(0,0,0,0.3)"},onMouseLeave:V=>{V.target.style.transform="translateY(0)",V.target.style.borderColor="rgba(255,255,255,0.1)",V.target.style.boxShadow="none"},children:[E.jsxs("div",{style:{width:"100%",flex:"1",position:"relative",overflow:"hidden",backgroundColor:"rgba(0,0,0,0.8)",display:"flex",alignItems:"center",justifyContent:"center",minHeight:"180px"},children:[E.jsx("img",{src:`${R.image}?v=${Date.now()}`,alt:R.title,style:{maxWidth:"100%",maxHeight:"100%",objectFit:"contain",transition:"transform 0.4s ease"},onError:V=>{V.target.style.display="none",V.target.nextSibling.style.display="flex"}}),E.jsx("div",{style:{display:"none",alignItems:"center",justifyContent:"center",color:"rgba(255,255,255,0.6)",fontSize:"1.2rem",fontFamily:"'Inter', sans-serif",textAlign:"center",height:"100%"},children:R.title}),E.jsx("div",{style:{position:"absolute",top:"12px",right:"12px",width:"32px",height:"32px",background:"rgba(0,0,0,0.7)",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",color:"white",fontSize:"14px",opacity:.8,transition:"all 0.3s ease"},children:"↗"})]}),E.jsxs("div",{style:{padding:"12px 16px",background:"rgba(0,0,0,0.3)",borderTop:"1px solid rgba(255,255,255,0.1)"},children:[E.jsxs("div",{style:{fontSize:"0.75rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.1em",marginBottom:"6px",textTransform:"uppercase",fontFamily:"'Inter', sans-serif"},children:[R.category," • ",R.year]}),E.jsx("h3",{style:{fontSize:"1rem",fontWeight:"500",margin:"0",color:"white",letterSpacing:"-0.01em",fontFamily:"'Inter', sans-serif",lineHeight:"1.3"},children:R.title})]})]},R.id))})]}),E.jsx("section",{id:"about",style:{height:"100vh",width:"100vw",padding:"40px",background:"linear-gradient(135deg, #0a0a0a 0%, #1a1a1a 50%, #0a0a0a 100%)",display:"flex",alignItems:"center",justifyContent:"center",scrollSnapAlign:"start",scrollSnapStop:"always",overflow:"hidden",position:"relative"},children:E.jsxs("div",{style:{flex:"1",display:"flex",flexDirection:"column",justifyContent:"center",padding:"0 80px",zIndex:2,maxWidth:"1200px"},children:[E.jsxs("div",{style:{width:"100%",textAlign:"left"},children:[E.jsxs("div",{style:{display:"flex",alignItems:"flex-start",gap:"20px",marginBottom:"30px"},children:[E.jsx("div",{style:{flexShrink:0},children:E.jsxs("div",{style:{width:"120px",height:"120px",borderRadius:"50%",background:"rgba(255,255,255,0.05)",border:"2px solid rgba(255,255,255,0.1)",overflow:"hidden",position:"relative",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s ease"},children:[E.jsx("span",{style:{fontSize:"2rem",color:"rgba(255,255,255,0.4)"},children:"👤"}),E.jsx("img",{src:"/Personal-Website/images/xinran-photo.jpg?v=2025100909",alt:"Xinran Ouyang",style:{width:"100%",height:"100%",objectFit:"cover",position:"absolute",top:0,left:0,opacity:0},onLoad:R=>{R.target.style.opacity=1},onError:R=>{R.target.style.display="none"}})]})}),E.jsxs("div",{children:[E.jsx("div",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.3em",marginBottom:"15px",textTransform:"uppercase",fontWeight:"300",fontFamily:"'Inter', sans-serif"},children:"Digital Artist & Creative Technologist"}),E.jsx("h2",{style:{fontSize:"clamp(2.5rem, 5vw, 4rem)",fontWeight:"100",margin:"0 0 10px 0",letterSpacing:"-0.03em",lineHeight:"1.1",background:"linear-gradient(135deg, #ffffff 0%, #888888 100%)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",fontFamily:"'Inter', sans-serif"},children:"About Me"}),E.jsx("div",{style:{fontSize:"1.1rem",color:"rgba(255,255,255,0.7)",fontFamily:"'Inter', sans-serif",fontWeight:"300"},children:"Xinran Ouyang"})]})]}),E.jsxs("div",{style:{marginBottom:"30px",textAlign:"left",maxWidth:"800px"},children:[E.jsx("p",{style:{fontSize:"clamp(1rem, 2vw, 1.2rem)",lineHeight:"1.6",color:"rgba(255,255,255,0.8)",margin:"0 0 15px 0",fontFamily:"'Inter', sans-serif",fontWeight:"300"},children:"I'm a digital media artist currently pursuing my Master's in Innovative Multimedia Entertainment at The Hong Kong Polytechnic University, with a strong foundation in digital media arts."}),E.jsx("p",{style:{fontSize:"1rem",lineHeight:"1.6",color:"rgba(255,255,255,0.7)",margin:0,fontFamily:"'Inter', sans-serif",fontWeight:"300"},children:"My work spans across digital media production, interactive installations, and multimedia entertainment, with experience in animation distribution, special effects production, and interactive art creation."})]}),E.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"20px",marginBottom:"40px",width:"100%"},children:[E.jsxs("div",{style:{background:l==="awards"?"rgba(255,255,255,0.08)":"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"15px",padding:"20px 25px",cursor:"pointer",transition:"all 0.3s ease",width:"100%",maxWidth:"800px"},onClick:()=>c(l==="awards"?null:"awards"),children:[E.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"15px",marginBottom:l==="awards"?"20px":"0"},children:[E.jsx("span",{style:{fontSize:"1.8rem"},children:"🏆"}),E.jsx("h3",{style:{fontSize:"1.3rem",fontWeight:"500",color:"white",margin:0,fontFamily:"'Inter', sans-serif"},children:"Awards & Recognition"}),E.jsx("span",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.5)",marginLeft:"auto",transform:l==="awards"?"rotate(180deg)":"rotate(0deg)",transition:"transform 0.3s ease"},children:"▼"})]}),l==="awards"&&E.jsxs("div",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.8)",lineHeight:"1.7",fontFamily:"'Inter', sans-serif"},children:[E.jsxs("div",{style:{marginBottom:"15px",paddingLeft:"15px",borderLeft:"3px solid rgba(255,255,255,0.3)"},children:[E.jsx("strong",{style:{color:"rgba(255,255,255,0.9)"},children:"The 14th National Exhibition of Fine Arts"}),E.jsx("br",{}),E.jsx("span",{style:{color:"rgba(255,255,255,0.6)",fontSize:"0.9rem"},children:"Nominated for Final | July 2024"}),E.jsx("br",{}),E.jsx("span",{style:{fontSize:"0.95rem"},children:"National level recognition for outstanding artistic achievement"})]}),E.jsxs("div",{style:{marginBottom:"15px",paddingLeft:"15px",borderLeft:"3px solid rgba(255,255,255,0.3)"},children:[E.jsx("strong",{style:{color:"rgba(255,255,255,0.9)"},children:"Busan International Art Festival"}),E.jsx("br",{}),E.jsx("span",{style:{color:"rgba(255,255,255,0.6)",fontSize:"0.9rem"},children:"Selected Award | December 2022"}),E.jsx("br",{}),E.jsx("span",{style:{fontSize:"0.95rem"},children:"International recognition for creative digital media work"})]}),E.jsxs("div",{style:{marginBottom:"15px",paddingLeft:"15px",borderLeft:"3px solid rgba(255,255,255,0.3)"},children:[E.jsx("strong",{style:{color:"rgba(255,255,255,0.9)"},children:"Sichuan Fine Arts Institute"}),E.jsx("br",{}),E.jsx("span",{style:{color:"rgba(255,255,255,0.6)",fontSize:"0.9rem"},children:"Second-class Scholarship | December 2022"}),E.jsx("br",{}),E.jsx("span",{style:{fontSize:"0.95rem"},children:"Academic excellence in Digital Media studies"})]}),E.jsxs("div",{style:{paddingLeft:"15px",borderLeft:"3px solid rgba(255,255,255,0.3)"},children:[E.jsx("strong",{style:{color:"rgba(255,255,255,0.9)"},children:"National Printmakers Exhibition"}),E.jsx("br",{}),E.jsx("span",{style:{color:"rgba(255,255,255,0.6)",fontSize:"0.9rem"},children:"Excellence Award | May 2021"}),E.jsx("br",{}),E.jsx("span",{style:{fontSize:"0.95rem"},children:"Recognition for outstanding printmaking artworks"})]})]})]}),E.jsxs("div",{style:{background:l==="experience"?"rgba(255,255,255,0.08)":"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"15px",padding:"20px 25px",cursor:"pointer",transition:"all 0.3s ease",width:"100%",maxWidth:"800px"},onClick:()=>c(l==="experience"?null:"experience"),children:[E.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"15px",marginBottom:l==="experience"?"20px":"0"},children:[E.jsx("span",{style:{fontSize:"1.8rem"},children:"💼"}),E.jsx("h3",{style:{fontSize:"1.3rem",fontWeight:"500",color:"white",margin:0,fontFamily:"'Inter', sans-serif"},children:"Experience & Education"}),E.jsx("span",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.5)",marginLeft:"auto",transform:l==="experience"?"rotate(180deg)":"rotate(0deg)",transition:"transform 0.3s ease"},children:"▼"})]}),l==="experience"&&E.jsxs("div",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.8)",lineHeight:"1.7",fontFamily:"'Inter', sans-serif"},children:[E.jsxs("div",{style:{marginBottom:"15px",paddingLeft:"15px",borderLeft:"3px solid rgba(255,255,255,0.3)"},children:[E.jsx("strong",{style:{color:"rgba(255,255,255,0.9)"},children:"MSc Innovative Multimedia Entertainment"}),E.jsx("br",{}),E.jsx("span",{style:{color:"rgba(255,255,255,0.6)",fontSize:"0.9rem"},children:"The Hong Kong Polytechnic University | 2025-2026 (Expected)"}),E.jsx("br",{}),E.jsx("span",{style:{fontSize:"0.95rem"},children:"Currently pursuing advanced studies in multimedia entertainment and digital innovation"})]}),E.jsxs("div",{style:{marginBottom:"15px",paddingLeft:"15px",borderLeft:"3px solid rgba(255,255,255,0.3)"},children:[E.jsx("strong",{style:{color:"rgba(255,255,255,0.9)"},children:"Bachelor in Digital Media"}),E.jsx("br",{}),E.jsx("span",{style:{color:"rgba(255,255,255,0.6)",fontSize:"0.9rem"},children:"Sichuan Fine Arts Institute | 2021-2025"}),E.jsx("br",{}),E.jsx("span",{style:{fontSize:"0.95rem"},children:"GPA: 3.67/5.0, Average Score: 86.75% - Focus on digital media arts and interactive design"})]}),E.jsxs("div",{style:{marginBottom:"15px",paddingLeft:"15px",borderLeft:"3px solid rgba(255,255,255,0.3)"},children:[E.jsx("strong",{style:{color:"rgba(255,255,255,0.9)"},children:"Assistant Director - Overseas Marketing"}),E.jsx("br",{}),E.jsx("span",{style:{color:"rgba(255,255,255,0.6)",fontSize:"0.9rem"},children:"Chongqing Jiazuo Film & TV Culture Media | August 2024"}),E.jsx("br",{}),E.jsx("span",{style:{fontSize:"0.95rem"},children:"Managed distribution of animated films in Latin America and coordinated TCL China Theatres project"})]}),E.jsxs("div",{style:{paddingLeft:"15px",borderLeft:"3px solid rgba(255,255,255,0.3)"},children:[E.jsx("strong",{style:{color:"rgba(255,255,255,0.9)"},children:"Special Effects Production Assistant"}),E.jsx("br",{}),E.jsx("span",{style:{color:"rgba(255,255,255,0.6)",fontSize:"0.9rem"},children:"Chongqing Yingsha Culture Communication | January 2024"}),E.jsx("br",{}),E.jsx("span",{style:{fontSize:"0.95rem"},children:"Assisted in post-production special effects for promotional films and commercials"})]})]})]}),E.jsxs("div",{style:{background:l==="contact"?"rgba(255,255,255,0.08)":"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"15px",padding:"20px 25px",cursor:"pointer",transition:"all 0.3s ease",width:"100%",maxWidth:"800px"},onClick:()=>c(l==="contact"?null:"contact"),children:[E.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"15px",marginBottom:l==="contact"?"20px":"0"},children:[E.jsx("span",{style:{fontSize:"1.8rem"},children:"�"}),E.jsx("h3",{style:{fontSize:"1.3rem",fontWeight:"500",color:"white",margin:0,fontFamily:"'Inter', sans-serif"},children:"Contact & Connect"}),E.jsx("span",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.5)",marginLeft:"auto",transform:l==="contact"?"rotate(180deg)":"rotate(0deg)",transition:"transform 0.3s ease"},children:"▼"})]}),l==="contact"&&E.jsxs("div",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.8)",lineHeight:"1.7",fontFamily:"'Inter', sans-serif"},children:[E.jsx("div",{style:{marginBottom:"20px"},children:E.jsx("p",{style:{margin:"0 0 15px 0",fontSize:"1rem",color:"rgba(255,255,255,0.9)"},children:"I'm always excited to collaborate on innovative projects that push the boundaries of digital art and technology."})}),E.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"12px"},children:[E.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px"},children:[E.jsx("span",{style:{fontSize:"1.2rem"},children:"✉️"}),E.jsx("a",{href:"mailto:megan_ouyang@163.com",style:{color:"rgba(255,255,255,0.9)",textDecoration:"none",fontSize:"1rem",fontWeight:"400"},children:"megan_ouyang@163.com"})]}),E.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px"},children:[E.jsx("span",{style:{fontSize:"1.2rem"},children:"💼"}),E.jsx("a",{href:"https://linkedin.com/in/xinran-ouyang",target:"_blank",rel:"noopener noreferrer",style:{color:"rgba(255,255,255,0.9)",textDecoration:"none",fontSize:"1rem",fontWeight:"400"},children:"LinkedIn Profile"})]}),E.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px"},children:[E.jsx("span",{style:{fontSize:"1.2rem"},children:"�"}),E.jsx("a",{href:"https://instagram.com/xinran.creative",target:"_blank",rel:"noopener noreferrer",style:{color:"rgba(255,255,255,0.9)",textDecoration:"none",fontSize:"1rem",fontWeight:"400"},children:"Instagram @xinran.creative"})]}),E.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px"},children:[E.jsx("span",{style:{fontSize:"1.2rem"},children:"📍"}),E.jsx("span",{style:{color:"rgba(255,255,255,0.8)",fontSize:"1rem"},children:"San Francisco Bay Area, CA"})]})]})]})]})]}),E.jsxs("div",{style:{marginBottom:"30px",display:"flex",flexDirection:"column",alignItems:"flex-start"},children:[E.jsx("h3",{style:{fontSize:"1.2rem",fontWeight:"500",margin:"0 0 15px 0",color:"white",fontFamily:"'Inter', sans-serif"},children:"Basic Information"}),E.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(250px, 1fr))",gap:"15px",width:"100%",maxWidth:"800px"},children:[E.jsxs("div",{style:{background:"rgba(255,255,255,0.05)",padding:"15px 20px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)"},children:[E.jsx("div",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.6)",marginBottom:"5px",fontFamily:"'Inter', sans-serif"},children:"Location"}),E.jsx("div",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.9)",fontFamily:"'Inter', sans-serif",fontWeight:"400"},children:"Hong Kong / Chongqing"})]}),E.jsxs("div",{style:{background:"rgba(255,255,255,0.05)",padding:"15px 20px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)"},children:[E.jsx("div",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.6)",marginBottom:"5px",fontFamily:"'Inter', sans-serif"},children:"Status"}),E.jsx("div",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.9)",fontFamily:"'Inter', sans-serif",fontWeight:"400"},children:"Graduate Student"})]}),E.jsxs("div",{style:{background:"rgba(255,255,255,0.05)",padding:"15px 20px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)"},children:[E.jsx("div",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.6)",marginBottom:"5px",fontFamily:"'Inter', sans-serif"},children:"Focus"}),E.jsx("div",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.9)",fontFamily:"'Inter', sans-serif",fontWeight:"400"},children:"Digital Media & Entertainment"})]})]})]}),E.jsxs("div",{style:{display:"flex",gap:"20px",flexWrap:"wrap",marginTop:"40px"},children:[E.jsx("button",{style:{background:"white",color:"black",border:"none",padding:"16px 32px",fontSize:"0.95rem",fontWeight:"500",letterSpacing:"0.05em",cursor:"pointer",transition:"all 0.3s ease",fontFamily:"'Inter', sans-serif",textTransform:"uppercase"},onMouseEnter:R=>{R.target.style.background="rgba(255,255,255,0.9)",R.target.style.transform="translateY(-2px)"},onMouseLeave:R=>{R.target.style.background="white",R.target.style.transform="translateY(0)"},onClick:()=>document.getElementById("showcase").scrollIntoView({behavior:"smooth"}),children:"Get in Touch"}),E.jsx("button",{style:{background:"transparent",color:"white",border:"1px solid rgba(255,255,255,0.3)",padding:"16px 32px",fontSize:"0.95rem",fontWeight:"400",letterSpacing:"0.05em",cursor:"pointer",transition:"all 0.3s ease",fontFamily:"'Inter', sans-serif",textTransform:"uppercase"},onMouseEnter:R=>{R.target.style.borderColor="white",R.target.style.background="rgba(255,255,255,0.1)"},onMouseLeave:R=>{R.target.style.borderColor="rgba(255,255,255,0.3)",R.target.style.background="transparent"},onClick:()=>document.getElementById("work").scrollIntoView({behavior:"smooth"}),children:"View Work"})]})]}),E.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"30px",height:"100%",paddingTop:"20px"},children:[E.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"20px",padding:"30px",fontFamily:"'Inter', sans-serif"},children:[E.jsxs("h3",{style:{fontSize:"1.4rem",fontWeight:"500",color:"white",margin:"0 0 25px 0",display:"flex",alignItems:"center",gap:"12px"},children:[E.jsx("span",{style:{fontSize:"1.8rem"},children:"🏆"}),"Achievements & Awards"]}),E.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(2, 1fr)",gap:"15px"},children:[{title:"National Scholarship",year:"2024",description:"Full scholarship for top 1% academic performance at Dartmouth College",color:"#FFD700"},{title:"Dean's List",year:"2023-2024",description:"Recognition for outstanding academic achievement with GPA 3.8+",color:"#00ff88"},{title:"Digital Arts Award",year:"2023",description:"Excellence in interactive media and digital installation work",color:"#9999ff"},{title:"Innovation Prize",year:"2022",description:"Creative technology project recognition for multi-sensory installations",color:"#ff6b35"}].map((R,W)=>E.jsxs("div",{style:{background:"rgba(255,255,255,0.04)",borderRadius:"12px",padding:"15px",border:"1px solid rgba(255,255,255,0.08)",borderLeft:`4px solid ${R.color}`,cursor:"pointer",transition:"all 0.3s ease",position:"relative",overflow:"hidden"},onMouseEnter:V=>{V.target.style.background="rgba(255,255,255,0.08)",V.target.style.transform="translateY(-2px)",V.target.style.borderColor="rgba(255,255,255,0.15)"},onMouseLeave:V=>{V.target.style.background="rgba(255,255,255,0.04)",V.target.style.transform="translateY(0)",V.target.style.borderColor="rgba(255,255,255,0.08)"},onClick:()=>{h("achievement"),t(R),setIsModalOpen(!0)},children:[E.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"8px"},children:[E.jsx("div",{style:{fontSize:"0.95rem",fontWeight:"600",color:"rgba(255,255,255,0.95)"},children:R.title}),E.jsx("div",{style:{fontSize:"0.75rem",color:R.color,fontWeight:"500",background:"rgba(255,255,255,0.1)",padding:"3px 10px",borderRadius:"15px"},children:R.year})]}),E.jsx("div",{style:{fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",lineHeight:"1.3",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:"Click to view details"}),E.jsx("div",{style:{position:"absolute",bottom:"8px",right:"12px",fontSize:"0.8rem",color:"rgba(255,255,255,0.4)",fontWeight:"300"},children:"↗"})]},W))})]}),E.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"20px",padding:"30px",fontFamily:"'Inter', sans-serif"},children:[E.jsxs("h3",{style:{fontSize:"1.4rem",fontWeight:"500",color:"white",margin:"0 0 25px 0",display:"flex",alignItems:"center",gap:"12px"},children:[E.jsx("span",{style:{fontSize:"1.8rem"},children:"�"}),"Get In Touch"]}),E.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"15px"},children:[E.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px",padding:"12px 16px",background:"rgba(255,255,255,0.04)",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.08)",fontSize:"0.95rem",color:"rgba(255,255,255,0.8)"},children:[E.jsx("span",{children:"🇨🇳"}),E.jsx("span",{children:"+86 15723351973"})]}),E.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px",padding:"12px 16px",background:"rgba(255,255,255,0.04)",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.08)",fontSize:"0.95rem",color:"rgba(255,255,255,0.8)"},children:[E.jsx("span",{children:"🇭🇰"}),E.jsx("span",{children:"+852 84963034"})]}),E.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px",padding:"12px 16px",background:"rgba(255,255,255,0.04)",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.08)",fontSize:"0.95rem",color:"rgba(255,255,255,0.8)"},children:[E.jsx("span",{children:"📧"}),E.jsx("span",{children:"McKenzie.ouyang@gmail.com"})]})]})]}),E.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"20px",padding:"25px",fontFamily:"'Inter', sans-serif",textAlign:"center"},children:[E.jsx("div",{style:{fontSize:"2rem",marginBottom:"10px"},children:"�"}),E.jsx("div",{style:{fontSize:"1.1rem",fontWeight:"500",color:"white",marginBottom:"8px"},children:"Interest Focus"}),E.jsx("div",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.7)",lineHeight:"1.5"},children:"Passionate about game level design and technical art, exploring the intersection of gameplay mechanics and visual storytelling"})]})]})]})}),E.jsxs("section",{id:"showcase",style:{height:"100vh",width:"100vw",padding:"40px",background:"linear-gradient(135deg, #0a0a0a 0%, #1a1a1a 50%, #0a0a0a 100%)",display:"flex",alignItems:"center",justifyContent:"center",scrollSnapAlign:"start",scrollSnapStop:"always",overflow:"hidden",position:"relative"},children:[E.jsxs("div",{style:{flex:"1",display:"flex",flexDirection:"column",justifyContent:"center",padding:"0 80px",zIndex:2,maxWidth:"600px"},children:[E.jsxs("div",{style:{marginBottom:"40px",textAlign:"left"},children:[E.jsx("h2",{style:{fontSize:"clamp(2.5rem, 6vw, 4.5rem)",fontWeight:"200",margin:"0 0 15px 0",letterSpacing:"-0.02em",color:"white",fontFamily:"'Inter', sans-serif"},children:"3D Showcase"}),E.jsx("p",{style:{fontSize:"1.1rem",color:"rgba(255,255,255,0.7)",maxWidth:"500px",margin:"0",lineHeight:"1.5",fontFamily:"'Inter', sans-serif",fontWeight:"300"},children:"Interactive 3D models exploring form, movement, and digital materiality. Each piece responds to user interaction and demonstrates different aspects of computational geometry."})]}),E.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(2, 1fr)",gap:"20px",marginBottom:"30px"},children:[E.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"15px",padding:"15px",height:"200px",position:"relative",cursor:"pointer",transition:"all 0.3s ease"},onMouseEnter:R=>{R.target.style.background="rgba(255,255,255,0.06)",R.target.style.borderColor="rgba(255,255,255,0.2)",R.target.style.transform="translateY(-5px)"},onMouseLeave:R=>{R.target.style.background="rgba(255,255,255,0.03)",R.target.style.borderColor="rgba(255,255,255,0.1)",R.target.style.transform="translateY(0)"},children:[E.jsx(br,{scale:1.2,position:[0,0,0],rotation:[.2,0,0],modelSize:1.5,rotationSpeed:.01,showWireframe:!1,color:65416,geometry:"sphere"}),E.jsx("div",{style:{position:"absolute",bottom:"10px",left:"15px",fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",fontFamily:"'Inter', sans-serif"},children:"Organic Sphere"})]}),E.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"15px",padding:"15px",height:"200px",position:"relative",cursor:"pointer",transition:"all 0.3s ease"},onMouseEnter:R=>{R.target.style.background="rgba(255,255,255,0.06)",R.target.style.borderColor="rgba(255,255,255,0.2)",R.target.style.transform="translateY(-5px)"},onMouseLeave:R=>{R.target.style.background="rgba(255,255,255,0.03)",R.target.style.borderColor="rgba(255,255,255,0.1)",R.target.style.transform="translateY(0)"},children:[E.jsx(br,{scale:1.2,position:[0,0,0],rotation:[.3,.3,0],modelSize:1.3,rotationSpeed:.015,showWireframe:!0,color:16739179,geometry:"cube"}),E.jsx("div",{style:{position:"absolute",bottom:"10px",left:"15px",fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",fontFamily:"'Inter', sans-serif"},children:"Wireframe Cube"})]}),E.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"15px",padding:"15px",height:"200px",position:"relative",cursor:"pointer",transition:"all 0.3s ease"},onMouseEnter:R=>{R.target.style.background="rgba(255,255,255,0.06)",R.target.style.borderColor="rgba(255,255,255,0.2)",R.target.style.transform="translateY(-5px)"},onMouseLeave:R=>{R.target.style.background="rgba(255,255,255,0.03)",R.target.style.borderColor="rgba(255,255,255,0.1)",R.target.style.transform="translateY(0)"},children:[E.jsx(br,{scale:1.2,position:[0,0,0],rotation:[.4,0,0],modelSize:1.4,rotationSpeed:.008,showWireframe:!1,color:5164484,geometry:"torus"}),E.jsx("div",{style:{position:"absolute",bottom:"10px",left:"15px",fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",fontFamily:"'Inter', sans-serif"},children:"Torus Ring"})]}),E.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"15px",padding:"15px",height:"200px",position:"relative",cursor:"pointer",transition:"all 0.3s ease"},onMouseEnter:R=>{R.target.style.background="rgba(255,255,255,0.06)",R.target.style.borderColor="rgba(255,255,255,0.2)",R.target.style.transform="translateY(-5px)"},onMouseLeave:R=>{R.target.style.background="rgba(255,255,255,0.03)",R.target.style.borderColor="rgba(255,255,255,0.1)",R.target.style.transform="translateY(0)"},children:[E.jsx(br,{scale:1.2,position:[0,0,0],rotation:[0,0,0],modelSize:1.6,rotationSpeed:.012,showWireframe:!1,color:16754470,geometry:"cone"}),E.jsx("div",{style:{position:"absolute",bottom:"10px",left:"15px",fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",fontFamily:"'Inter', sans-serif"},children:"Geometric Cone"})]})]}),E.jsxs("div",{style:{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"12px",padding:"20px",marginBottom:"20px"},children:[E.jsx("h3",{style:{fontSize:"1.1rem",fontWeight:"500",color:"white",margin:"0 0 10px 0",fontFamily:"'Inter', sans-serif"},children:"🎯 Interactive Features"}),E.jsx("p",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.7)",margin:"0",lineHeight:"1.5",fontFamily:"'Inter', sans-serif"},children:"Each model features real-time rendering with WebGL, responsive mouse interactions, and procedural animations. Built with Three.js and React for seamless performance across devices."})]})]}),E.jsx("div",{style:{flex:"1",height:"100%",display:"flex",alignItems:"center",justifyContent:"center",position:"relative"},children:E.jsxs("div",{style:{width:"400px",height:"400px",background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"20px",overflow:"hidden",position:"relative"},children:[E.jsx(br,{scale:2,position:[0,0,0],rotation:[.2,.3,0],modelSize:2.5,rotationSpeed:.005,showWireframe:!1,color:10233776,geometry:"icosahedron"}),E.jsxs("div",{style:{position:"absolute",bottom:"15px",left:"20px",right:"20px",textAlign:"center"},children:[E.jsx("h4",{style:{fontSize:"1.2rem",fontWeight:"500",color:"white",margin:"0 0 5px 0",fontFamily:"'Inter', sans-serif"},children:"Featured: Icosahedron"}),E.jsx("p",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.6)",margin:"0",fontFamily:"'Inter', sans-serif"},children:"Complex polyhedron with 20 triangular faces"})]})]})})]}),e&&E.jsx("div",{style:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",background:"rgba(0,0,0,0.9)",zIndex:2e3,display:"flex",alignItems:"center",justifyContent:"center",padding:"20px"},onClick:()=>t(null),children:E.jsxs("div",{style:{background:"#1a1a1a",borderRadius:"12px",maxWidth:"800px",maxHeight:"90vh",overflow:"auto",position:"relative"},onClick:R=>R.stopPropagation(),children:[E.jsx("button",{onClick:()=>t(null),style:{position:"absolute",top:"20px",right:"20px",background:"rgba(255,255,255,0.1)",border:"none",borderRadius:"50%",width:"40px",height:"40px",color:"white",fontSize:"20px",cursor:"pointer",zIndex:10},children:"×"}),E.jsx("img",{src:e.image,alt:e.title,style:{width:"100%",height:"400px",objectFit:"cover",borderRadius:"12px 12px 0 0"}}),E.jsxs("div",{style:{padding:"30px"},children:[E.jsxs("div",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.1em",marginBottom:"15px",textTransform:"uppercase",fontFamily:"'Inter', sans-serif"},children:[e.category," • ",e.year]}),E.jsx("h2",{style:{fontSize:"2rem",fontWeight:"500",margin:"0 0 20px 0",color:"white",fontFamily:"'Inter', sans-serif"},children:e.title}),E.jsx("p",{style:{fontSize:"1.1rem",lineHeight:"1.7",color:"rgba(255,255,255,0.8)",margin:"0 0 30px 0",fontFamily:"'Inter', sans-serif"},children:e.description}),e.gallery&&E.jsxs("div",{children:[E.jsx("h3",{style:{fontSize:"1.2rem",color:"white",marginBottom:"20px",fontFamily:"'Inter', sans-serif"},children:"Gallery"}),E.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(300px, 1fr))",gap:"25px"},children:e.gallery.map((R,W)=>E.jsx("img",{src:R,alt:`${e.title} ${W+1}`,style:{width:"100%",height:"auto",minHeight:"250px",objectFit:"contain",borderRadius:"12px",cursor:"pointer",transition:"transform 0.3s ease",border:"1px solid rgba(255, 255, 255, 0.1)",backgroundColor:"rgba(0,0,0,0.3)"},onMouseEnter:V=>{V.target.style.transform="scale(1.03)"},onMouseLeave:V=>{V.target.style.transform="scale(1)"}},W))})]})]})]})}),d&&E.jsxs("div",{style:{position:"fixed",left:f.x,top:f.y,width:"400px",maxHeight:"500px",background:"rgba(0,0,0,0.95)",backdropFilter:"blur(20px)",border:"1px solid rgba(255,255,255,0.2)",borderRadius:"12px",zIndex:2e3,overflow:"hidden",boxShadow:"0 20px 40px rgba(0,0,0,0.5)",userSelect:"none"},children:[E.jsxs("div",{style:{background:"rgba(255,255,255,0.1)",padding:"12px 16px",borderBottom:"1px solid rgba(255,255,255,0.1)",cursor:x?"grabbing":"grab",display:"flex",alignItems:"center",justifyContent:"space-between"},onMouseDown:b,children:[E.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[E.jsx("div",{style:{width:"12px",height:"12px",background:"#ff5f57",borderRadius:"50%"}}),E.jsx("div",{style:{width:"12px",height:"12px",background:"#ffbd2e",borderRadius:"50%"}}),E.jsx("div",{style:{width:"12px",height:"12px",background:"#28ca42",borderRadius:"50%"}})]}),E.jsxs("h3",{style:{color:"white",fontSize:"0.9rem",fontWeight:"500",margin:0,fontFamily:"'Inter', sans-serif"},children:[d==="about"&&"About Me",d==="education"&&"Education",d==="showcase"&&"3D Showcase",d==="awards"&&"Awards",d==="interests"&&"Interests",d==="skills"&&"Skills",d==="achievement"&&"Achievement Details"]}),E.jsx("button",{style:{background:"transparent",border:"none",color:"rgba(255,255,255,0.7)",fontSize:"16px",cursor:"pointer",padding:"4px",borderRadius:"4px",transition:"all 0.2s ease"},onClick:()=>h(null),onMouseEnter:R=>{R.target.style.background="rgba(255,255,255,0.1)",R.target.style.color="white"},onMouseLeave:R=>{R.target.style.background="transparent",R.target.style.color="rgba(255,255,255,0.7)"},children:"×"})]}),E.jsxs("div",{style:{padding:"20px",maxHeight:"420px",overflow:"auto",color:"white",fontFamily:"'Inter', sans-serif"},children:[d==="about"&&E.jsxs("div",{children:[E.jsx("div",{style:{fontSize:"2rem",textAlign:"center",marginBottom:"16px"},children:"👋"}),E.jsx("p",{style:{fontSize:"0.95rem",lineHeight:"1.6",color:"rgba(255,255,255,0.9)",margin:0},children:"I'm a digital artist and creative technologist passionate about exploring the intersection of art, technology, and human experience. My work focuses on creating immersive digital experiences that blur the boundaries between the virtual and physical worlds."})]}),d==="education"&&E.jsxs("div",{children:[E.jsx("div",{style:{fontSize:"2rem",textAlign:"center",marginBottom:"16px"},children:"🎓"}),E.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[E.jsxs("div",{children:[E.jsx("h4",{style:{fontSize:"1rem",fontWeight:"600",margin:"0 0 4px 0",color:"white"},children:"Master's in Digital Arts"}),E.jsx("p",{style:{fontSize:"0.85rem",color:"rgba(255,255,255,0.8)",margin:"0 0 2px 0"},children:"University of Arts"}),E.jsx("p",{style:{fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",margin:0},children:"2022-2024"})]}),E.jsxs("div",{children:[E.jsx("h4",{style:{fontSize:"1rem",fontWeight:"600",margin:"0 0 4px 0",color:"white"},children:"Bachelor's in Interactive Media"}),E.jsx("p",{style:{fontSize:"0.85rem",color:"rgba(255,255,255,0.8)",margin:"0 0 2px 0"},children:"Design Institute"}),E.jsx("p",{style:{fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",margin:0},children:"2018-2022"})]})]})]}),d==="showcase"&&E.jsxs("div",{children:[E.jsx("div",{style:{fontSize:"2rem",textAlign:"center",marginBottom:"16px"},children:"📫"}),E.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"12px"},children:[E.jsxs("div",{style:{background:"rgba(255,255,255,0.05)",padding:"12px",borderRadius:"8px",textAlign:"center"},children:[E.jsx("div",{style:{fontSize:"1.2rem",marginBottom:"4px"},children:"✉️"}),E.jsx("p",{style:{fontSize:"0.9rem",margin:0,color:"rgba(255,255,255,0.9)"},children:"McKenzie.ouyang@gmail.com"})]}),E.jsxs("div",{style:{display:"flex",gap:"8px"},children:[E.jsxs("div",{style:{background:"rgba(255,255,255,0.05)",padding:"10px",borderRadius:"8px",textAlign:"center",flex:1},children:[E.jsx("div",{style:{fontSize:"1rem",marginBottom:"2px"},children:"🇨🇳"}),E.jsx("p",{style:{fontSize:"0.8rem",margin:0,color:"rgba(255,255,255,0.8)"},children:"+86 15723351973"})]}),E.jsxs("div",{style:{background:"rgba(255,255,255,0.05)",padding:"10px",borderRadius:"8px",textAlign:"center",flex:1},children:[E.jsx("div",{style:{fontSize:"1rem",marginBottom:"2px"},children:"🇭🇰"}),E.jsx("p",{style:{fontSize:"0.8rem",margin:0,color:"rgba(255,255,255,0.8)"},children:"+852 84963034"})]})]})]})]}),d==="awards"&&E.jsxs("div",{children:[E.jsx("div",{style:{fontSize:"2rem",textAlign:"center",marginBottom:"16px"},children:"🏆"}),E.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"12px"},children:[E.jsxs("div",{style:{display:"flex",alignItems:"flex-start",gap:"8px"},children:[E.jsx("div",{style:{fontSize:"1.2rem"},children:"🥇"}),E.jsxs("div",{children:[E.jsx("h4",{style:{fontSize:"0.9rem",fontWeight:"600",margin:"0 0 2px 0"},children:"Digital Art Excellence Award"}),E.jsx("p",{style:{fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",margin:0},children:"National Arts Competition 2024"})]})]}),E.jsxs("div",{style:{display:"flex",alignItems:"flex-start",gap:"8px"},children:[E.jsx("div",{style:{fontSize:"1.2rem"},children:"🥈"}),E.jsxs("div",{children:[E.jsx("h4",{style:{fontSize:"0.9rem",fontWeight:"600",margin:"0 0 2px 0"},children:"Innovation in Interactive Media"}),E.jsx("p",{style:{fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",margin:0},children:"Tech Arts Festival 2023"})]})]})]})]}),d==="interests"&&E.jsxs("div",{children:[E.jsx("div",{style:{fontSize:"2rem",textAlign:"center",marginBottom:"16px"},children:"🎨"}),E.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"12px"},children:["3D Modeling","VR/AR","AI Art","Photography","Game Design","Motion Graphics"].map(R=>E.jsx("span",{style:{background:"rgba(255,255,255,0.1)",border:"1px solid rgba(255,255,255,0.2)",borderRadius:"12px",padding:"4px 8px",fontSize:"0.75rem",color:"rgba(255,255,255,0.9)"},children:R},R))}),E.jsx("p",{style:{fontSize:"0.85rem",lineHeight:"1.5",color:"rgba(255,255,255,0.8)",margin:0},children:"My creative journey spans multiple disciplines, always seeking new ways to merge traditional artforms with emerging technologies."})]}),d==="skills"&&E.jsxs("div",{children:[E.jsx("div",{style:{fontSize:"2rem",textAlign:"center",marginBottom:"16px"},children:"⚡"}),E.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[E.jsxs("div",{children:[E.jsx("h4",{style:{fontSize:"0.9rem",fontWeight:"600",marginBottom:"8px",color:"rgba(255,255,255,0.9)"},children:"Design & Creative"}),E.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:"6px"},children:["Digital Art","Visual Design","Installation Art","Motion Graphics"].map(R=>E.jsx("span",{style:{background:"rgba(255,255,255,0.08)",border:"1px solid rgba(255,255,255,0.15)",borderRadius:"10px",padding:"3px 8px",fontSize:"0.7rem",color:"rgba(255,255,255,0.8)"},children:R},R))})]}),E.jsxs("div",{children:[E.jsx("h4",{style:{fontSize:"0.9rem",fontWeight:"600",marginBottom:"8px",color:"rgba(255,255,255,0.9)"},children:"Technical"}),E.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:"6px"},children:["Creative Coding","Interactive Design","3D Modeling","VR/AR Development"].map(R=>E.jsx("span",{style:{background:"rgba(255,255,255,0.08)",border:"1px solid rgba(255,255,255,0.15)",borderRadius:"10px",padding:"3px 8px",fontSize:"0.7rem",color:"rgba(255,255,255,0.8)"},children:R},R))})]})]})]}),d==="achievement"&&e&&E.jsxs("div",{children:[E.jsx("div",{style:{fontSize:"2rem",textAlign:"center",marginBottom:"16px"},children:"🏆"}),E.jsxs("div",{style:{textAlign:"center",marginBottom:"20px"},children:[E.jsx("h2",{style:{fontSize:"1.3rem",fontWeight:"600",margin:"0 0 8px 0",color:"white",fontFamily:"'Inter', sans-serif"},children:e.title}),E.jsx("div",{style:{display:"inline-block",fontSize:"0.9rem",color:e.color,fontWeight:"500",background:"rgba(255,255,255,0.1)",padding:"6px 16px",borderRadius:"20px",border:`1px solid ${e.color}40`},children:e.year})]}),E.jsxs("div",{style:{background:"rgba(255,255,255,0.05)",borderRadius:"12px",padding:"20px",border:`2px solid ${e.color}40`,borderLeft:`4px solid ${e.color}`},children:[E.jsx("p",{style:{fontSize:"1rem",lineHeight:"1.6",color:"rgba(255,255,255,0.9)",margin:"0 0 16px 0",fontFamily:"'Inter', sans-serif"},children:e.description}),E.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",fontSize:"0.85rem",color:"rgba(255,255,255,0.7)"},children:[E.jsx("span",{style:{fontSize:"1rem"},children:"✨"}),"This achievement represents a significant milestone in my academic and creative journey."]})]})]})]})]})]})}pM.createRoot(document.getElementById("root")).render(E.jsx(Ae.StrictMode,{children:E.jsx(TA,{})}));
