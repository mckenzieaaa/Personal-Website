 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(P,X){var B=P.length;P.push(X);t:for(;0<B;){var tt=B-1>>>1,rt=P[tt];if(0<a(rt,X))P[tt]=X,P[B]=rt,B=tt;else break t}}function n(P){return P.length===0?null:P[0]}function i(P){if(P.length===0)return null;var X=P[0],B=P.pop();if(B!==X){P[0]=B;t:for(var tt=0,rt=P.length,_t=rt>>>1;tt<_t;){var Ot=2*(tt+1)-1,ne=P[Ot],Zt=Ot+1,Xt=P[Zt];if(0>a(ne,B))Zt<rt&&0>a(Xt,ne)?(P[tt]=Xt,P[Zt]=B,tt=Zt):(P[tt]=ne,P[Ot]=B,tt=Ot);else if(Zt<rt&&0>a(Xt,B))P[tt]=Xt,P[Zt]=B,tt=Zt;else break t}}return X}function a(P,X){var B=P.sortIndex-X.sortIndex;return B!==0?B:P.id-X.id}if(e.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var r=performance;e.unstable_now=function(){return r.now()}}else{var s=Date,o=s.now();e.unstable_now=function(){return s.now()-o}}var l=[],c=[],d=1,h=null,f=3,p=!1,x=!1,y=!1,m=!1,u=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,_=typeof setImmediate<"u"?setImmediate:null;function v(P){for(var X=n(c);X!==null;){if(X.callback===null)i(c);else if(X.startTime<=P)i(c),X.sortIndex=X.expirationTime,t(l,X);else break;X=n(c)}}function A(P){if(y=!1,v(P),!x)if(n(l)!==null)x=!0,C||(C=!0,G());else{var X=n(c);X!==null&&V(A,X.startTime-P)}}var C=!1,w=-1,L=5,T=-1;function E(){return m?!0:!(e.unstable_now()-T<L)}function N(){if(m=!1,C){var P=e.unstable_now();T=P;var X=!0;try{t:{x=!1,y&&(y=!1,g(w),w=-1),p=!0;var B=f;try{e:{for(v(P),h=n(l);h!==null&&!(h.expirationTime>P&&E());){var tt=h.callback;if(typeof tt=="function"){h.callback=null,f=h.priorityLevel;var rt=tt(h.expirationTime<=P);if(P=e.unstable_now(),typeof rt=="function"){h.callback=rt,v(P),X=!0;break e}h===n(l)&&i(l),v(P)}else i(l);h=n(l)}if(h!==null)X=!0;else{var _t=n(c);_t!==null&&V(A,_t.startTime-P),X=!1}}break t}finally{h=null,f=B,p=!1}X=void 0}}finally{X?G():C=!1}}}var G;if(typeof _=="function")G=function(){_(N)};else if(typeof MessageChannel<"u"){var D=new MessageChannel,W=D.port2;D.port1.onmessage=N,G=function(){W.postMessage(null)}}else G=function(){u(N,0)};function V(P,X){w=u(function(){P(e.unstable_now())},X)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(P){P.callback=null},e.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):L=0<P?Math.floor(1e3/P):5},e.unstable_getCurrentPriorityLevel=function(){return f},e.unstable_next=function(P){switch(f){case 1:case 2:case 3:var X=3;break;default:X=f}var B=f;f=X;try{return P()}finally{f=B}},e.unstable_requestPaint=function(){m=!0},e.unstable_runWithPriority=function(P,X){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var B=f;f=P;try{return X()}finally{f=B}},e.unstable_scheduleCallback=function(P,X,B){var tt=e.unstable_now();switch(typeof B=="object"&&B!==null?(B=B.delay,B=typeof B=="number"&&0<B?tt+B:tt):B=tt,P){case 1:var rt=-1;break;case 2:rt=250;break;case 5:rt=1073741823;break;case 4:rt=1e4;break;default:rt=5e3}return rt=B+rt,P={id:d++,callback:X,priorityLevel:P,startTime:B,expirationTime:rt,sortIndex:-1},B>tt?(P.sortIndex=B,t(c,P),n(l)===null&&P===n(c)&&(y?(g(w),w=-1):y=!0,V(A,B-tt))):(P.sortIndex=rt,t(l,P),x||p||(x=!0,C||(C=!0,G()))),P},e.unstable_shouldYield=E,e.unstable_wrapCallback=function(P){var X=f;return function(){var B=f;f=X;try{return P.apply(this,arguments)}finally{f=B}}}})(Kg);Zg.exports=Kg;var zx=Zg.exports,Qg={exports:{}},on={};/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:_a,depthTest:!1,depthWrite:!1})}function yg(){return new ba({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:cp(),fragmentShader:`
		...
		`,blending:_a,depthTest:!1,depthWrite:!1})}function Sg(){return new ba({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:cp(),fragmentShader:`
...
`)+`
`+u);const _=g+m+s,v=g+u+o,A=Cg(a,a.VERTEX_SHADER,_),C=Cg(a,a.FRAGMENT_SHADER,v);a.attachShader(y,A),a.attachShader(y,C),n.index0AttributeName!==void 0?a.bindAttribLocation(y,0,n.index0AttributeName):n.morphTargets===!0&&a.bindAttribLocation(y,0,"position"),a.linkProgram(y);function w(N){if(e.debug.checkShaderErrors){const G=a.getProgramInfoLog(y)||"",D=a.getShaderInfoLog(A)||"",W=a.getShaderInfoLog(C)||"",V=G.trim(),P=D.trim(),X=W.trim();let B=!0,tt=!0;if(a.getProgramParameter(y,a.LINK_STATUS)===!1)if(B=!1,typeof e.debug.onShaderError=="function")e.debug.onShaderError(a,y,A,C);else{const rt=Ug(a,A,"vertex"),_t=Ug(a,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+a.getError()+" - VALIDATE_STATUS "+a.getProgramParameter(y,a.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
...
}`;class xA{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,n){if(this.texture===null){const i=new rx(t.texture);(t.depthNear!==n.depthNear||t.depthFar!==n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=i}}getMesh(t){if(this.texture!==null&&this.mesh===null){const n=t.cameras[0].viewport,i=new ba({vertexShader:_A,fragmentShader:vA,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new oi(new Yc(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class yA extends Ss{constructor(t,n){super();const i=this;let a=null,r=1,s=null,o="local-floor",l=1,c=null,d=null,h=null,f=null,p=null,x=null;const y=typeof XRWebGLBinding<"u",m=new xA,u={},g=n.getContextAttributes();let _=null,v=null;const A=[],C=[],w=new $t;let L=null;const T=new En;T.viewport=new ue;const E=new En;E.viewport=new ue;const N=[T,E],G=new Gb;let D=null,W=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Z){let $=A[Z];return $===void 0&&($=new ef,A[Z]=$),$.getTargetRaySpace()},this.getControllerGrip=function(Z){let $=A[Z];return $===void 0&&($=new ef,A[Z]=$),$.getGripSpace()},this.getHand=function(Z){let $=A[Z];return $===void 0&&($=new ef,A[Z]=$),$.getHandSpace()};function V(Z){const $=C.indexOf(Z.inputSource);if($===-1)return;const pt=A[$];pt!==void 0&&(pt.update(Z.inputSource,Z.frame,c||s),pt.dispatchEvent({type:Z.type,data:Z.inputSource}))}function P(){a.removeEventListener("select",V),a.removeEventListener("selectstart",V),a.removeEventListener("selectend",V),a.removeEventListener("squeeze",V),a.removeEventListener("squeezestart",V),a.removeEventListener("squeezeend",V),a.removeEventListener("end",P),a.removeEventListener("inputsourceschange",X);for(let Z=0;Z<A.length;Z++){const $=C[Z];$!==null&&(C[Z]=null,A[Z].disconnect($))}D=null,W=null,m.reset();for(const Z in u)delete u[Z];t.setRenderTarget(_),p=null,f=null,h=null,a=null,v=null,Xt.stop(),i.isPresenting=!1,t.setPixelRatio(L),t.setSize(w.width,w.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Z){r=Z,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Z){o=Z,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||s},this.setReferenceSpace=function(Z){c=Z},this.getBaseLayer=function(){return f!==null?f:p},this.getBinding=function(){return h===null&&y&&(h=new XRWebGLBinding(a,n)),h},this.getFrame=function(){return x},this.getSession=function(){return a},this.setSession=async function(Z){if(a=Z,a!==null){if(_=t.getRenderTarget(),a.addEventListener("select",V),a.addEventListener("selectstart",V),a.addEventListener("selectend",V),a.addEventListener("squeeze",V),a.addEventListener("squeezestart",V),a.addEventListener("squeezeend",V),a.addEventListener("end",P),a.addEventListener("inputsourceschange",X),g.xrCompatible!==!0&&await n.makeXRCompatible(),L=t.getPixelRatio(),t.getSize(w),y&&"createProjectionLayer"in XRWebGLBinding.prototype){let pt=null,Lt=null,Et=null;g.depth&&(Et=g.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,pt=g.stencil?bo:Mo,Lt=g.stencil?So:er);const Yt={colorFormat:n.RGBA8,depthFormat:Et,scaleFactor:r};h=this.getBinding(),f=h.createProjectionLayer(Yt),a.updateRenderState({layers:[f]}),t.setPixelRatio(1),t.setSize(f.textureWidth,f.textureHeight,!1),v=new nr(f.textureWidth,f.textureHeight,{format:Kn,type:di,depthTexture:new ax(f.textureWidth,f.textureHeight,Lt,void 0,void 0,void 0,void 0,void 0,void 0,pt),stencilBuffer:g.stencil,colorSpace:t.outputColorSpace,samples:g.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{const pt={antialias:g.antialias,alpha:!0,depth:g.depth,stencil:g.stencil,framebufferScaleFactor:r};p=new XRWebGLLayer(a,n,pt),a.updateRenderState({baseLayer:p}),t.setPixelRatio(1),t.setSize(p.framebufferWidth,p.framebufferHeight,!1),v=new nr(p.framebufferWidth,p.framebufferHeight,{format:Kn,type:di,colorSpace:t.outputColorSpace,stencilBuffer:g.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}v.isXRRenderTarget=!0,this.setFoveation(l),c=null,s=await a.requestReferenceSpace(o),Xt.setContext(a),Xt.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(a!==null)return a.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function X(Z){for(let $=0;$<Z.removed.length;$++){const pt=Z.removed[$],Lt=C.indexOf(pt);Lt>=0&&(C[Lt]=null,A[Lt].disconnect(pt))}for(let $=0;$<Z.added.length;$++){const pt=Z.added[$];let Lt=C.indexOf(pt);if(Lt===-1){for(let Yt=0;Yt<A.length;Yt++)if(Yt>=C.length){C.push(pt),Lt=Yt;break}else if(C[Yt]===null){C[Yt]=pt,Lt=Yt;break}if(Lt===-1)break}const Et=A[Lt];Et&&Et.connect(pt)}}const B=new F,tt=new F;function rt(Z,$,pt){B.setFromMatrixPosition($.matrixWorld),tt.setFromMatrixPosition(pt.matrixWorld);const Lt=B.distanceTo(tt),Et=$.projectionMatrix.elements,Yt=pt.projectionMatrix.elements,Ke=Et[14]/(Et[10]-1),U=Et[14]/(Et[10]+1),_e=(Et[9]+1)/Et[5],Pt=(Et[9]-1)/Et[5],Dt=(Et[8]-1)/Et[0],vt=(Yt[8]+1)/Yt[0],ve=Ke*Dt,xt=Ke*vt,Bt=Lt/(-Dt+vt),Ge=Bt*-Dt;if($.matrixWorld.decompose(Z.position,Z.quaternion,Z.scale),Z.translateX(Ge),Z.translateZ(Bt),Z.matrixWorld.compose(Z.position,Z.quaternion,Z.scale),Z.matrixWorldInverse.copy(Z.matrixWorld).invert(),Et[10]===-1)Z.projectionMatrix.copy($.projectionMatrix),Z.projectionMatrixInverse.copy($.projectionMatrixInverse);else{const De=Ke+Bt,R=U+Bt,S=ve-Ge,H=xt+(Lt-Ge),q=_e*U/R*De,J=Pt*U/R*De;Z.projectionMatrix.makePerspective(S,H,q,J,De,R),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert()}}function _t(Z,$){$===null?Z.matrixWorld.copy(Z.matrix):Z.matrixWorld.multiplyMatrices($.matrixWorld,Z.matrix),Z.matrixWorldInverse.copy(Z.matrixWorld).invert()}this.updateCamera=function(Z){if(a===null)return;let $=Z.near,pt=Z.far;m.texture!==null&&(m.depthNear>0&&($=m.depthNear),m.depthFar>0&&(pt=m.depthFar)),G.near=E.near=T.near=$,G.far=E.far=T.far=pt,(D!==G.near||W!==G.far)&&(a.updateRenderState({depthNear:G.near,depthFar:G.far}),D=G.near,W=G.far),G.layers.mask=Z.layers.mask|6,T.layers.mask=G.layers.mask&3,E.layers.mask=G.layers.mask&5;const Lt=Z.parent,Et=G.cameras;_t(G,Lt);for(let Yt=0;Yt<Et.length;Yt++)_t(Et[Yt],Lt);Et.length===2?rt(G,T,E):G.projectionMatrix.copy(T.projectionMatrix),Ot(Z,G,Lt)};function Ot(Z,$,pt){pt===null?Z.matrix.copy($.matrixWorld):(Z.matrix.copy(pt.matrixWorld),Z.matrix.invert(),Z.matrix.multiply($.matrixWorld)),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.updateMatrixWorld(!0),Z.projectionMatrix.copy($.projectionMatrix),Z.projectionMatrixInverse.copy($.projectionMatrixInverse),Z.isPerspectiveCamera&&(Z.fov=qd*2*Math.atan(1/Z.projectionMatrix.elements[5]),Z.zoom=1)}this.getCamera=function(){return G},this.getFoveation=function(){if(!(f===null&&p===null))return l},this.setFoveation=function(Z){l=Z,f!==null&&(f.fixedFoveation=Z),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=Z)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(G)},this.getCameraTexture=function(Z){return u[Z]};let ne=null;function Zt(Z,$){if(d=$.getViewerPose(c||s),x=$,d!==null){const pt=d.views;p!==null&&(t.setRenderTargetFramebuffer(v,p.framebuffer),t.setRenderTarget(v));let Lt=!1;pt.length!==G.cameras.length&&(G.cameras.length=0,Lt=!0);for(let U=0;U<pt.length;U++){const _e=pt[U];let Pt=null;if(p!==null)Pt=p.getViewport(_e);else{const vt=h.getViewSubImage(f,_e);Pt=vt.viewport,U===0&&(t.setRenderTargetTextures(v,vt.colorTexture,vt.depthStencilTexture),t.setRenderTarget(v))}let Dt=N[U];Dt===void 0&&(Dt=new En,Dt.layers.enable(U),Dt.viewport=new ue,N[U]=Dt),Dt.matrix.fromArray(_e.transform.matrix),Dt.matrix.decompose(Dt.position,Dt.quaternion,Dt.scale),Dt.projectionMatrix.fromArray(_e.projectionMatrix),Dt.projectionMatrixInverse.copy(Dt.projectionMatrix).invert(),Dt.viewport.set(Pt.x,Pt.y,Pt.width,Pt.height),U===0&&(G.matrix.copy(Dt.matrix),G.matrix.decompose(G.position,G.quaternion,G.scale)),Lt===!0&&G.cameras.push(Dt)}const Et=a.enabledFeatures;if(Et&&Et.includes("depth-sensing")&&a.depthUsage=="gpu-optimized"&&y){h=i.getBinding();const U=h.getDepthInformation(pt[0]);U&&U.isValid&&U.texture&&m.init(U,a.renderState)}if(Et&&Et.includes("camera-access")&&y){t.state.unbindTexture(),h=i.getBinding();for(let U=0;U<pt.length;U++){const _e=pt[U].camera;if(_e){let Pt=u[_e];Pt||(Pt=new rx,u[_e]=Pt);const Dt=h.getCameraImage(_e);Pt.sourceTexture=Dt}}}}for(let pt=0;pt<A.length;pt++){const Lt=C[pt],Et=A[pt];Lt!==null&&Et!==void 0&&Et.update(Lt,$,c||s)}ne&&ne(Z,$),$.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:$}),x=null}const Xt=new lx;Xt.setAnimationLoop(Zt),this.setAnimationLoop=function(Z){ne=Z},this.dispose=function(){}}}const Oa=new hi,SA=new Ce;function MA(e,t){function n(m,u){m.matrixAutoUpdate===!0&&m.updateMatrix(),u.value.copy(m.matrix)}function i(m,u){u.color.getRGB(m.fogColor.value,ex(e)),u.isFog?(m.fogNear.value=u.near,m.fogFar.value=u.far):u.isFogExp2&&(m.fogDensity.value=u.density)}function a(m,u,g,_,v){u.isMeshBasicMaterial||u.isMeshLambertMaterial?r(m,u):u.isMeshToonMaterial?(r(m,u),h(m,u)):u.isMeshPhongMaterial?(r(m,u),d(m,u)):u.isMeshStandardMaterial?(r(m,u),f(m,u),u.isMeshPhysicalMaterial&&p(m,u,v)):u.isMeshMatcapMaterial?(r(m,u),x(m,u)):u.isMeshDepthMaterial?r(m,u):u.isMeshDistanceMaterial?(r(m,u),y(m,u)):u.isMeshNormalMaterial?r(m,u):u.isLineBasicMaterial?(s(m,u),u.isLineDashedMaterial&&o(m,u)):u.isPointsMaterial?l(m,u,g,_):u.isSpriteMaterial?c(m,u):u.isShadowMaterial?(m.color.value.copy(u.color),m.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function r(m,u){m.opacity.value=u.opacity,u.color&&m.diffuse.value.copy(u.color),u.emissive&&m.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(m.map.value=u.map,n(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,n(u.alphaMap,m.alphaMapTransform)),u.bumpMap&&(m.bumpMap.value=u.bumpMap,n(u.bumpMap,m.bumpMapTransform),m.bumpScale.value=u.bumpScale,u.side===hn&&(m.bumpScale.value*=-1)),u.normalMap&&(m.normalMap.value=u.normalMap,n(u.normalMap,m.normalMapTransform),m.normalScale.value.copy(u.normalScale),u.side===hn&&m.normalScale.value.negate()),u.displacementMap&&(m.displacementMap.value=u.displacementMap,n(u.displacementMap,m.displacementMapTransform),m.displacementScale.value=u.displacementScale,m.displacementBias.value=u.displacementBias),u.emissiveMap&&(m.emissiveMap.value=u.emissiveMap,n(u.emissiveMap,m.emissiveMapTransform)),u.specularMap&&(m.specularMap.value=u.specularMap,n(u.specularMap,m.specularMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest);const g=t.get(u),_=g.envMap,v=g.envMapRotation;_&&(m.envMap.value=_,Oa.copy(v),Oa.x*=-1,Oa.y*=-1,Oa.z*=-1,_.isCubeTexture&&_.isRenderTargetTexture===!1&&(Oa.y*=-1,Oa.z*=-1),m.envMapRotation.value.setFromMatrix4(SA.makeRotationFromEuler(Oa)),m.flipEnvMap.value=_.isCubeTexture&&_.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=u.reflectivity,m.ior.value=u.ior,m.refractionRatio.value=u.refractionRatio),u.lightMap&&(m.lightMap.value=u.lightMap,m.lightMapIntensity.value=u.lightMapIntensity,n(u.lightMap,m.lightMapTransform)),u.aoMap&&(m.aoMap.value=u.aoMap,m.aoMapIntensity.value=u.aoMapIntensity,n(u.aoMap,m.aoMapTransform))}function s(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,u.map&&(m.map.value=u.map,n(u.map,m.mapTransform))}function o(m,u){m.dashSize.value=u.dashSize,m.totalSize.value=u.dashSize+u.gapSize,m.scale.value=u.scale}function l(m,u,g,_){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.size.value=u.size*g,m.scale.value=_*.5,u.map&&(m.map.value=u.map,n(u.map,m.uvTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,n(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function c(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.rotation.value=u.rotation,u.map&&(m.map.value=u.map,n(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,n(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function d(m,u){m.specular.value.copy(u.specular),m.shininess.value=Math.max(u.shininess,1e-4)}function h(m,u){u.gradientMap&&(m.gradientMap.value=u.gradientMap)}function f(m,u){m.metalness.value=u.metalness,u.metalnessMap&&(m.metalnessMap.value=u.metalnessMap,n(u.metalnessMap,m.metalnessMapTransform)),m.roughness.value=u.roughness,u.roughnessMap&&(m.roughnessMap.value=u.roughnessMap,n(u.roughnessMap,m.roughnessMapTransform)),u.envMap&&(m.envMapIntensity.value=u.envMapIntensity)}function p(m,u,g){m.ior.value=u.ior,u.sheen>0&&(m.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),m.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(m.sheenColorMap.value=u.sheenColorMap,n(u.sheenColorMap,m.sheenColorMapTransform)),u.sheenRoughnessMap&&(m.sheenRoughnessMap.value=u.sheenRoughnessMap,n(u.sheenRoughnessMap,m.sheenRoughnessMapTransform))),u.clearcoat>0&&(m.clearcoat.value=u.clearcoat,m.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(m.clearcoatMap.value=u.clearcoatMap,n(u.clearcoatMap,m.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,n(u.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(m.clearcoatNormalMap.value=u.clearcoatNormalMap,n(u.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===hn&&m.clearcoatNormalScale.value.negate())),u.dispersion>0&&(m.dispersion.value=u.dispersion),u.iridescence>0&&(m.iridescence.value=u.iridescence,m.iridescenceIOR.value=u.iridescenceIOR,m.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(m.iridescenceMap.value=u.iridescenceMap,n(u.iridescenceMap,m.iridescenceMapTransform)),u.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=u.iridescenceThicknessMap,n(u.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),u.transmission>0&&(m.transmission.value=u.transmission,m.transmissionSamplerMap.value=g.texture,m.transmissionSamplerSize.value.set(g.width,g.height),u.transmissionMap&&(m.transmissionMap.value=u.transmissionMap,n(u.transmissionMap,m.transmissionMapTransform)),m.thickness.value=u.thickness,u.thicknessMap&&(m.thicknessMap.value=u.thicknessMap,n(u.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=u.attenuationDistance,m.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(m.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(m.anisotropyMap.value=u.anisotropyMap,n(u.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=u.specularIntensity,m.specularColor.value.copy(u.specularColor),u.specularColorMap&&(m.specularColorMap.value=u.specularColorMap,n(u.specularColorMap,m.specularColorMapTransform)),u.specularIntensityMap&&(m.specularIntensityMap.value=u.specularIntensityMap,n(u.specularIntensityMap,m.specularIntensityMapTransform))}function x(m,u){u.matcap&&(m.matcap.value=u.matcap)}function y(m,u){const g=t.get(u).light;m.referencePosition.value.setFromMatrixPosition(g.matrixWorld),m.nearDistance.value=g.shadow.camera.near,m.farDistance.value=g.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:a}}function bA(e,t,n,i){let a={},r={},s=[];const o=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function l(g,_){const v=_.program;i.uniformBlockBinding(g,v)}function c(g,_){let v=a[g.id];v===void 0&&(x(g),v=d(g),a[g.id]=v,g.addEventListener("dispose",m));const A=_.program;i.updateUBOMapping(g,A);const C=t.render.frame;r[g.id]!==C&&(f(g),r[g.id]=C)}function d(g){const _=h();g.__bindingPointIndex=_;const v=e.createBuffer(),A=g.__size,C=g.usage;return e.bindBuffer(e.UNIFORM_BUFFER,v),e.bufferData(e.UNIFORM_BUFFER,A,C),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,_,v),v}function h(){for(let g=0;g<o;g++)if(s.indexOf(g)===-1)return s.push(g),g;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(g){const _=a[g.id],v=g.uniforms,A=g.__cache;e.bindBuffer(e.UNIFORM_BUFFER,_);for(let C=0,w=v.length;C<w;C++){const L=Array.isArray(v[C])?v[C]:[v[C]];for(let T=0,E=L.length;T<E;T++){const N=L[T];if(p(N,C,T,A)===!0){const G=N.__offset,D=Array.isArray(N.value)?N.value:[N.value];let W=0;for(let V=0;V<D.length;V++){const P=D[V],X=y(P);typeof P=="number"||typeof P=="boolean"?(N.__data[0]=P,e.bufferSubData(e.UNIFORM_BUFFER,G+W,N.__data)):P.isMatrix3?(N.__data[0]=P.elements[0],N.__data[1]=P.elements[1],N.__data[2]=P.elements[2],N.__data[3]=0,N.__data[4]=P.elements[3],N.__data[5]=P.elements[4],N.__data[6]=P.elements[5],N.__data[7]=0,N.__data[8]=P.elements[6],N.__data[9]=P.elements[7],N.__data[10]=P.elements[8],N.__data[11]=0):(P.toArray(N.__data,W),W+=X.storage/Float32Array.BYTES_PER_ELEMENT)}e.bufferSubData(e.UNIFORM_BUFFER,G,N.__data)}}}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(g,_,v,A){const C=g.value,w=_+"_"+v;if(A[w]===void 0)return typeof C=="number"||typeof C=="boolean"?A[w]=C:A[w]=C.clone(),!0;{const L=A[w];if(typeof C=="number"||typeof C=="boolean"){if(L!==C)return A[w]=C,!0}else if(L.equals(C)===!1)return L.copy(C),!0}return!1}function x(g){const _=g.uniforms;let v=0;const A=16;for(let w=0,L=_.length;w<L;w++){const T=Array.isArray(_[w])?_[w]:[_[w]];for(let E=0,N=T.length;E<N;E++){const G=T[E],D=Array.isArray(G.value)?G.value:[G.value];for(let W=0,V=D.length;W<V;W++){const P=D[W],X=y(P),B=v%A,tt=B%X.boundary,rt=B+tt;v+=tt,rt!==0&&A-rt<X.storage&&(v+=A-rt),G.__data=new Float32Array(X.storage/Float32Array.BYTES_PER_ELEMENT),G.__offset=v,v+=X.storage}}}const C=v%A;return C>0&&(v+=A-C),g.__size=v,g.__cache={},this}function y(g){const _={boundary:0,storage:0};return typeof g=="number"||typeof g=="boolean"?(_.boundary=4,_.storage=4):g.isVector2?(_.boundary=8,_.storage=8):g.isVector3||g.isColor?(_.boundary=16,_.storage=12):g.isVector4?(_.boundary=16,_.storage=16):g.isMatrix3?(_.boundary=48,_.storage=48):g.isMatrix4?(_.boundary=64,_.storage=64):g.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",g),_}function m(g){const _=g.target;_.removeEventListener("dispose",m);const v=s.indexOf(_.__bindingPointIndex);s.splice(v,1),e.deleteBuffer(a[_.id]),delete a[_.id],delete r[_.id]}function u(){for(const g in a)e.deleteBuffer(a[g]);s=[],a={},r={}}return{bind:l,update:c,dispose:u}}class EA{constructor(t={}){const{canvas:n=nb(),context:i=null,depth:a=!0,stencil:r=!1,alpha:s=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:h=!1,reversedDepthBuffer:f=!1}=t;this.isWebGLRenderer=!0;let p;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=i.getContextAttributes().alpha}else p=s;const x=new Uint32Array(4),y=new Int32Array(4);let m=null,u=null;const g=[],_=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=va,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const v=this;let A=!1;this._outputColorSpace=zn;let C=0,w=0,L=null,T=-1,E=null;const N=new ue,G=new ue;let D=null;const W=new Jt(0);let V=0,P=n.width,X=n.height,B=1,tt=null,rt=null;const _t=new ue(0,0,P,X),Ot=new ue(0,0,P,X);let ne=!1;const Zt=new rp;let Xt=!1,Z=!1;const $=new Ce,pt=new F,Lt=new ue,Et={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Yt=!1;function Ke(){return L===null?B:1}let U=i;function _e(b,z){return n.getContext(b,z)}try{const b={alpha:!0,depth:a,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:d,failIfMajorPerformanceCaveat:h};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${Zh}`),n.addEventListener("webglcontextlost",ot,!1),n.addEventListener("webglcontextrestored",ht,!1),n.addEventListener("webglcontextcreationerror",et,!1),U===null){const z="webgl2";if(U=_e(z,b),U===null)throw _e(z)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(b){throw console.error("THREE.WebGLRenderer: "+b.message),b}let Pt,Dt,vt,ve,xt,Bt,Ge,De,R,S,H,q,J,Y,bt,st,yt,St,it,ft,wt,Mt,ct,zt;function O(){Pt=new OT(U),Pt.init(),Mt=new gA(U,Pt),Dt=new RT(U,Pt,t,Mt),vt=new pA(U,Pt),Dt.reversedDepthBuffer&&f&&vt.buffers.depth.setReversed(!0),ve=new IT(U),xt=new eA,Bt=new mA(U,Pt,vt,xt,Dt,Mt,ve),Ge=new CT(v),De=new NT(v),R=new kb(U),ct=new TT(U,R),S=new PT(U,R,ve,ct),H=new FT(U,S,R,ve),it=new BT(U,Dt,Bt),st=new wT(xt),q=new tA(v,Ge,De,Pt,Dt,ct,st),J=new MA(v,xt),Y=new iA,bt=new cA(Pt),St=new ET(v,Ge,De,vt,H,p,l),yt=new dA(v,H,Dt),zt=new bA(U,ve,Dt,vt),ft=new AT(U,Pt,ve),wt=new zT(U,Pt,ve),ve.programs=q.programs,v.capabilities=Dt,v.extensions=Pt,v.properties=xt,v.renderLists=Y,v.shadowMap=yt,v.state=vt,v.info=ve}O();const at=new yA(v,U);this.xr=at,this.getContext=function(){return U},this.getContextAttributes=function(){return U.getContextAttributes()},this.forceContextLoss=function(){const b=Pt.get("WEBGL_lose_context");b&&b.loseContext()},this.forceContextRestore=function(){const b=Pt.get("WEBGL_lose_context");b&&b.restoreContext()},this.getPixelRatio=function(){return B},this.setPixelRatio=function(b){b!==void 0&&(B=b,this.setSize(P,X,!1))},this.getSize=function(b){return b.set(P,X)},this.setSize=function(b,z,k=!0){if(at.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}P=b,X=z,n.width=Math.floor(b*B),n.height=Math.floor(z*B),k===!0&&(n.style.width=b+"px",n.style.height=z+"px"),this.setViewport(0,0,b,z)},this.getDrawingBufferSize=function(b){return b.set(P*B,X*B).floor()},this.setDrawingBufferSize=function(b,z,k){P=b,X=z,B=k,n.width=Math.floor(b*k),n.height=Math.floor(z*k),this.setViewport(0,0,b,z)},this.getCurrentViewport=function(b){return b.copy(N)},this.getViewport=function(b){return b.copy(_t)},this.setViewport=function(b,z,k,j){b.isVector4?_t.set(b.x,b.y,b.z,b.w):_t.set(b,z,k,j),vt.viewport(N.copy(_t).multiplyScalar(B).round())},this.getScissor=function(b){return b.copy(Ot)},this.setScissor=function(b,z,k,j){b.isVector4?Ot.set(b.x,b.y,b.z,b.w):Ot.set(b,z,k,j),vt.scissor(G.copy(Ot).multiplyScalar(B).round())},this.getScissorTest=function(){return ne},this.setScissorTest=function(b){vt.setScissorTest(ne=b)},this.setOpaqueSort=function(b){tt=b},this.setTransparentSort=function(b){rt=b},this.getClearColor=function(b){return b.copy(St.getClearColor())},this.setClearColor=function(){St.setClearColor(...arguments)},this.getClearAlpha=function(){return St.getClearAlpha()},this.setClearAlpha=function(){St.setClearAlpha(...arguments)},this.clear=function(b=!0,z=!0,k=!0){let j=0;if(b){let I=!1;if(L!==null){const nt=L.texture.format;I=nt===np||nt===ep||nt===tp}if(I){const nt=L.texture.type,ut=nt===di||nt===er||nt===yo||nt===So||nt===Jh||nt===$h,mt=St.getClearColor(),dt=St.getClearAlpha(),Rt=mt.r,Ut=mt.g,Tt=mt.b;ut?(x[0]=Rt,x[1]=Ut,x[2]=Tt,x[3]=dt,U.clearBufferuiv(U.COLOR,0,x)):(y[0]=Rt,y[1]=Ut,y[2]=Tt,y[3]=dt,U.clearBufferiv(U.COLOR,0,y))}else j|=U.COLOR_BUFFER_BIT}z&&(j|=U.DEPTH_BUFFER_BIT),k&&(j|=U.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),U.clear(j)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",ot,!1),n.removeEventListener("webglcontextrestored",ht,!1),n.removeEventListener("webglcontextcreationerror",et,!1),St.dispose(),Y.dispose(),bt.dispose(),xt.dispose(),Ge.dispose(),De.dispose(),H.dispose(),ct.dispose(),zt.dispose(),q.dispose(),at.dispose(),at.removeEventListener("sessionstart",ti),at.removeEventListener("sessionend",up),Aa.stop()};function ot(b){b.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),A=!0}function ht(){console.log("THREE.WebGLRenderer: Context Restored."),A=!1;const b=ve.autoReset,z=yt.enabled,k=yt.autoUpdate,j=yt.needsUpdate,I=yt.type;O(),ve.autoReset=b,yt.enabled=z,yt.autoUpdate=k,yt.needsUpdate=j,yt.type=I}function et(b){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",b.statusMessage)}function Q(b){const z=b.target;z.removeEventListener("dispose",Q),gt(z)}function gt(b){Nt(b),xt.remove(b)}function Nt(b){const z=xt.get(b).programs;z!==void 0&&(z.forEach(function(k){q.releaseProgram(k)}),b.isShaderMaterial&&q.releaseShaderCache(b))}this.renderBufferDirect=function(b,z,k,j,I,nt){z===null&&(z=Et);const ut=I.isMesh&&I.matrixWorld.determinant()<0,mt=hx(b,z,k,j,I);vt.setMaterial(j,ut);let dt=k.index,Rt=1;if(j.wireframe===!0){if(dt=S.getWireframeAttribute(k),dt===void 0)return;Rt=2}const Ut=k.drawRange,Tt=k.attributes.position;let Wt=Ut.start*Rt,se=(Ut.start+Ut.count)*Rt;nt!==null&&(Wt=Math.max(Wt,nt.start*Rt),se=Math.min(se,(nt.start+nt.count)*Rt)),dt!==null?(Wt=Math.max(Wt,0),se=Math.min(se,dt.count)):Tt!=null&&(Wt=Math.max(Wt,0),se=Math.min(se,Tt.count));const Te=se-Wt;if(Te<0||Te===1/0)return;ct.setup(I,j,mt,k,dt);let me,fe=ft;if(dt!==null&&(me=R.get(dt),fe=wt,fe.setIndex(me)),I.isMesh)j.wireframe===!0?(vt.setLineWidth(j.wireframeLinewidth*Ke()),fe.setMode(U.LINES)):fe.setMode(U.TRIANGLES);else if(I.isLine){let At=j.linewidth;At===void 0&&(At=1),vt.setLineWidth(At*Ke()),I.isLineSegments?fe.setMode(U.LINES):I.isLineLoop?fe.setMode(U.LINE_LOOP):fe.setMode(U.LINE_STRIP)}else I.isPoints?fe.setMode(U.POINTS):I.isSprite&&fe.setMode(U.TRIANGLES);if(I.isBatchedMesh)if(I._multiDrawInstances!==null)Eo("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),fe.renderMultiDrawInstances(I._multiDrawStarts,I._multiDrawCounts,I._multiDrawCount,I._multiDrawInstances);else if(Pt.get("WEBGL_multi_draw"))fe.renderMultiDraw(I._multiDrawStarts,I._multiDrawCounts,I._multiDrawCount);else{const At=I._multiDrawStarts,Me=I._multiDrawCounts,Kt=I._multiDrawCount,_n=dt?R.get(dt).bytesPerElement:1,or=xt.get(j).currentProgram.getUniforms();for(let vn=0;vn<Kt;vn++)or.setValue(U,"_gl_DrawID",vn),fe.render(At[vn]/_n,Me[vn])}else if(I.isInstancedMesh)fe.renderInstances(Wt,Te,I.count);else if(k.isInstancedBufferGeometry){const At=k._maxInstanceCount!==void 0?k._maxInstanceCount:1/0,Me=Math.min(k.instanceCount,At);fe.renderInstances(Wt,Te,Me)}else fe.render(Wt,Te)};function he(b,z,k){b.transparent===!0&&b.side===Ri&&b.forceSinglePass===!1?(b.side=hn,b.needsUpdate=!0,Yo(b,z,k),b.side=Ma,b.needsUpdate=!0,Yo(b,z,k),b.side=Ri):Yo(b,z,k)}this.compile=function(b,z,k=null){k===null&&(k=b),u=bt.get(k),u.init(z),_.push(u),k.traverseVisible(function(I){I.isLight&&I.layers.test(z.layers)&&(u.pushLight(I),I.castShadow&&u.pushShadow(I))}),b!==k&&b.traverseVisible(function(I){I.isLight&&I.layers.test(z.layers)&&(u.pushLight(I),I.castShadow&&u.pushShadow(I))}),u.setupLights();const j=new Set;return b.traverse(function(I){if(!(I.isMesh||I.isPoints||I.isLine||I.isSprite))return;const nt=I.material;if(nt)if(Array.isArray(nt))for(let ut=0;ut<nt.length;ut++){const mt=nt[ut];he(mt,k,I),j.add(mt)}else he(nt,k,I),j.add(nt)}),u=_.pop(),j},this.compileAsync=function(b,z,k=null){const j=this.compile(b,z,k);return new Promise(I=>{function nt(){if(j.forEach(function(ut){xt.get(ut).currentProgram.isReady()&&j.delete(ut)}),j.size===0){I(b);return}setTimeout(nt,10)}Pt.get("KHR_parallel_shader_compile")!==null?nt():setTimeout(nt,10)})};let ie=null;function gi(b){ie&&ie(b)}function ti(){Aa.stop()}function up(){Aa.start()}const Aa=new lx;Aa.setAnimationLoop(gi),typeof self<"u"&&Aa.setContext(self),this.setAnimationLoop=function(b){ie=b,at.setAnimationLoop(b),b===null?Aa.stop():Aa.start()},at.addEventListener("sessionstart",ti),at.addEventListener("sessionend",up),this.render=function(b,z){if(z!==void 0&&z.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(A===!0)return;if(b.matrixWorldAutoUpdate===!0&&b.updateMatrixWorld(),z.parent===null&&z.matrixWorldAutoUpdate===!0&&z.updateMatrixWorld(),at.enabled===!0&&at.isPresenting===!0&&(at.cameraAutoUpdate===!0&&at.updateCamera(z),z=at.getCamera()),b.isScene===!0&&b.onBeforeRender(v,b,z,L),u=bt.get(b,_.length),u.init(z),_.push(u),$.multiplyMatrices(z.projectionMatrix,z.matrixWorldInverse),Zt.setFromProjectionMatrix($,si,z.reversedDepth),Z=this.localClippingEnabled,Xt=st.init(this.clippingPlanes,Z),m=Y.get(b,g.length),m.init(),g.push(m),at.enabled===!0&&at.isPresenting===!0){const nt=v.xr.getDepthSensingMesh();nt!==null&&Zc(nt,z,-1/0,v.sortObjects)}Zc(b,z,0,v.sortObjects),m.finish(),v.sortObjects===!0&&m.sort(tt,rt),Yt=at.enabled===!1||at.isPresenting===!1||at.hasDepthSensing()===!1,Yt&&St.addToRenderList(m,b),this.info.render.frame++,Xt===!0&&st.beginShadows();const k=u.state.shadowsArray;yt.render(k,b,z),Xt===!0&&st.endShadows(),this.info.autoReset===!0&&this.info.reset();const j=m.opaque,I=m.transmissive;if(u.setupLights(),z.isArrayCamera){const nt=z.cameras;if(I.length>0)for(let ut=0,mt=nt.length;ut<mt;ut++){const dt=nt[ut];dp(j,I,b,dt)}Yt&&St.render(b);for(let ut=0,mt=nt.length;ut<mt;ut++){const dt=nt[ut];fp(m,b,dt,dt.viewport)}}else I.length>0&&dp(j,I,b,z),Yt&&St.render(b),fp(m,b,z);L!==null&&w===0&&(Bt.updateMultisampleRenderTarget(L),Bt.updateRenderTargetMipmap(L)),b.isScene===!0&&b.onAfterRender(v,b,z),ct.resetDefaultState(),T=-1,E=null,_.pop(),_.length>0?(u=_[_.length-1],Xt===!0&&st.setGlobalState(v.clippingPlanes,u.state.camera)):u=null,g.pop(),g.length>0?m=g[g.length-1]:m=null};function Zc(b,z,k,j){if(b.visible===!1)return;if(b.layers.test(z.layers)){if(b.isGroup)k=b.renderOrder;else if(b.isLOD)b.autoUpdate===!0&&b.update(z);else if(b.isLight)u.pushLight(b),b.castShadow&&u.pushShadow(b);else if(b.isSprite){if(!b.frustumCulled||Zt.intersectsSprite(b)){j&&Lt.setFromMatrixPosition(b.matrixWorld).applyMatrix4($);const ut=H.update(b),mt=b.material;mt.visible&&m.push(b,ut,mt,k,Lt.z,null)}}else if((b.isMesh||b.isLine||b.isPoints)&&(!b.frustumCulled||Zt.intersectsObject(b))){const ut=H.update(b),mt=b.material;if(j&&(b.boundingSphere!==void 0?(b.boundingSphere===null&&b.computeBoundingSphere(),Lt.copy(b.boundingSphere.center)):(ut.boundingSphere===null&&ut.computeBoundingSphere(),Lt.copy(ut.boundingSphere.center)),Lt.applyMatrix4(b.matrixWorld).applyMatrix4($)),Array.isArray(mt)){const dt=ut.groups;for(let Rt=0,Ut=dt.length;Rt<Ut;Rt++){const Tt=dt[Rt],Wt=mt[Tt.materialIndex];Wt&&Wt.visible&&m.push(b,ut,Wt,k,Lt.z,Tt)}}else mt.visible&&m.push(b,ut,mt,k,Lt.z,null)}}const nt=b.children;for(let ut=0,mt=nt.length;ut<mt;ut++)Zc(nt[ut],z,k,j)}function fp(b,z,k,j){const I=b.opaque,nt=b.transmissive,ut=b.transparent;u.setupLightsView(k),Xt===!0&&st.setGlobalState(v.clippingPlanes,k),j&&vt.viewport(N.copy(j)),I.length>0&&jo(I,z,k),nt.length>0&&jo(nt,z,k),ut.length>0&&jo(ut,z,k),vt.buffers.depth.setTest(!0),vt.buffers.depth.setMask(!0),vt.buffers.color.setMask(!0),vt.setPolygonOffset(!1)}function dp(b,z,k,j){if((k.isScene===!0?k.overrideMaterial:null)!==null)return;u.state.transmissionRenderTarget[j.id]===void 0&&(u.state.transmissionRenderTarget[j.id]=new nr(1,1,{generateMipmaps:!0,type:Pt.has("EXT_color_buffer_half_float")||Pt.has("EXT_color_buffer_float")?Go:di,minFilter:ka,samples:4,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Qt.workingColorSpace}));const nt=u.state.transmissionRenderTarget[j.id],ut=j.viewport||N;nt.setSize(ut.z*v.transmissionResolutionScale,ut.w*v.transmissionResolutionScale);const mt=v.getRenderTarget(),dt=v.getActiveCubeFace(),Rt=v.getActiveMipmapLevel();v.setRenderTarget(nt),v.getClearColor(W),V=v.getClearAlpha(),V<1&&v.setClearColor(16777215,.5),v.clear(),Yt&&St.render(k);const Ut=v.toneMapping;v.toneMapping=va;const Tt=j.viewport;if(j.viewport!==void 0&&(j.viewport=void 0),u.setupLightsView(j),Xt===!0&&st.setGlobalState(v.clippingPlanes,j),jo(b,k,j),Bt.updateMultisampleRenderTarget(nt),Bt.updateRenderTargetMipmap(nt),Pt.has("WEBGL_multisampled_render_to_texture")===!1){let Wt=!1;for(let se=0,Te=z.length;se<Te;se++){const me=z[se],fe=me.object,At=me.geometry,Me=me.material,Kt=me.group;if(Me.side===Ri&&fe.layers.test(j.layers)){const _n=Me.side;Me.side=hn,Me.needsUpdate=!0,hp(fe,k,j,At,Me,Kt),Me.side=_n,Me.needsUpdate=!0,Wt=!0}}Wt===!0&&(Bt.updateMultisampleRenderTarget(nt),Bt.updateRenderTargetMipmap(nt))}v.setRenderTarget(mt,dt,Rt),v.setClearColor(W,V),Tt!==void 0&&(j.viewport=Tt),v.toneMapping=Ut}function jo(b,z,k){const j=z.isScene===!0?z.overrideMaterial:null;for(let I=0,nt=b.length;I<nt;I++){const ut=b[I],mt=ut.object,dt=ut.geometry,Rt=ut.group;let Ut=ut.material;Ut.allowOverride===!0&&j!==null&&(Ut=j),mt.layers.test(k.layers)&&hp(mt,z,k,dt,Ut,Rt)}}function hp(b,z,k,j,I,nt){b.onBeforeRender(v,z,k,j,I,nt),b.modelViewMatrix.multiplyMatrices(k.matrixWorldInverse,b.matrixWorld),b.normalMatrix.getNormalMatrix(b.modelViewMatrix),I.onBeforeRender(v,z,k,j,b,nt),I.transparent===!0&&I.side===Ri&&I.forceSinglePass===!1?(I.side=hn,I.needsUpdate=!0,v.renderBufferDirect(k,z,j,I,b,nt),I.side=Ma,I.needsUpdate=!0,v.renderBufferDirect(k,z,j,I,b,nt),I.side=Ri):v.renderBufferDirect(k,z,j,I,b,nt),b.onAfterRender(v,z,k,j,I,nt)}function Yo(b,z,k){z.isScene!==!0&&(z=Et);const j=xt.get(b),I=u.state.lights,nt=u.state.shadowsArray,ut=I.state.version,mt=q.getParameters(b,I.state,nt,z,k),dt=q.getProgramCacheKey(mt);let Rt=j.programs;j.environment=b.isMeshStandardMaterial?z.environment:null,j.fog=z.fog,j.envMap=(b.isMeshStandardMaterial?De:Ge).get(b.envMap||j.environment),j.envMapRotation=j.environment!==null&&b.envMap===null?z.environmentRotation:b.envMapRotation,Rt===void 0&&(b.addEventListener("dispose",Q),Rt=new Map,j.programs=Rt);let Ut=Rt.get(dt);if(Ut!==void 0){if(j.currentProgram===Ut&&j.lightsStateVersion===ut)return mp(b,mt),Ut}else mt.uniforms=q.getUniforms(b),b.onBeforeCompile(mt,v),Ut=q.acquireProgram(mt,dt),Rt.set(dt,Ut),j.uniforms=mt.uniforms;const Tt=j.uniforms;return(!b.isShaderMaterial&&!b.isRawShaderMaterial||b.clipping===!0)&&(Tt.clippingPlanes=st.uniform),mp(b,mt),j.needsLights=mx(b),j.lightsStateVersion=ut,j.needsLights&&(Tt.ambientLightColor.value=I.state.ambient,Tt.lightProbe.value=I.state.probe,Tt.directionalLights.value=I.state.directional,Tt.directionalLightShadows.value=I.state.directionalShadow,Tt.spotLights.value=I.state.spot,Tt.spotLightShadows.value=I.state.spotShadow,Tt.rectAreaLights.value=I.state.rectArea,Tt.ltc_1.value=I.state.rectAreaLTC1,Tt.ltc_2.value=I.state.rectAreaLTC2,Tt.pointLights.value=I.state.point,Tt.pointLightShadows.value=I.state.pointShadow,Tt.hemisphereLights.value=I.state.hemi,Tt.directionalShadowMap.value=I.state.directionalShadowMap,Tt.directionalShadowMatrix.value=I.state.directionalShadowMatrix,Tt.spotShadowMap.value=I.state.spotShadowMap,Tt.spotLightMatrix.value=I.state.spotLightMatrix,Tt.spotLightMap.value=I.state.spotLightMap,Tt.pointShadowMap.value=I.state.pointShadowMap,Tt.pointShadowMatrix.value=I.state.pointShadowMatrix),j.currentProgram=Ut,j.uniformsList=null,Ut}function pp(b){if(b.uniformsList===null){const z=b.currentProgram.getUniforms();b.uniformsList=ql.seqWithValue(z.seq,b.uniforms)}return b.uniformsList}function mp(b,z){const k=xt.get(b);k.outputColorSpace=z.outputColorSpace,k.batching=z.batching,k.batchingColor=z.batchingColor,k.instancing=z.instancing,k.instancingColor=z.instancingColor,k.instancingMorph=z.instancingMorph,k.skinning=z.skinning,k.morphTargets=z.morphTargets,k.morphNormals=z.morphNormals,k.morphColors=z.morphColors,k.morphTargetsCount=z.morphTargetsCount,k.numClippingPlanes=z.numClippingPlanes,k.numIntersection=z.numClipIntersection,k.vertexAlphas=z.vertexAlphas,k.vertexTangents=z.vertexTangents,k.toneMapping=z.toneMapping}function hx(b,z,k,j,I){z.isScene!==!0&&(z=Et),Bt.resetTextureUnits();const nt=z.fog,ut=j.isMeshStandardMaterial?z.environment:null,mt=L===null?v.outputColorSpace:L.isXRRenderTarget===!0?L.texture.colorSpace:ds,dt=(j.isMeshStandardMaterial?De:Ge).get(j.envMap||ut),Rt=j.vertexColors===!0&&!!k.attributes.color&&k.attributes.color.itemSize===4,Ut=!!k.attributes.tangent&&(!!j.normalMap||j.anisotropy>0),Tt=!!k.morphAttributes.position,Wt=!!k.morphAttributes.normal,se=!!k.morphAttributes.color;let Te=va;j.toneMapped&&(L===null||L.isXRRenderTarget===!0)&&(Te=v.toneMapping);const me=k.morphAttributes.position||k.morphAttributes.normal||k.morphAttributes.color,fe=me!==void 0?me.length:0,At=xt.get(j),Me=u.state.lights;if(Xt===!0&&(Z===!0||b!==E)){const nn=b===E&&j.id===T;st.setState(j,b,nn)}let Kt=!1;j.version===At.__version?(At.needsLights&&At.lightsStateVersion!==Me.state.version||At.outputColorSpace!==mt||I.isBatchedMesh&&At.batching===!1||!I.isBatchedMesh&&At.batching===!0||I.isBatchedMesh&&At.batchingColor===!0&&I.colorTexture===null||I.isBatchedMesh&&At.batchingColor===!1&&I.colorTexture!==null||I.isInstancedMesh&&At.instancing===!1||!I.isInstancedMesh&&At.instancing===!0||I.isSkinnedMesh&&At.skinning===!1||!I.isSkinnedMesh&&At.skinning===!0||I.isInstancedMesh&&At.instancingColor===!0&&I.instanceColor===null||I.isInstancedMesh&&At.instancingColor===!1&&I.instanceColor!==null||I.isInstancedMesh&&At.instancingMorph===!0&&I.morphTexture===null||I.isInstancedMesh&&At.instancingMorph===!1&&I.morphTexture!==null||At.envMap!==dt||j.fog===!0&&At.fog!==nt||At.numClippingPlanes!==void 0&&(At.numClippingPlanes!==st.numPlanes||At.numIntersection!==st.numIntersection)||At.vertexAlphas!==Rt||At.vertexTangents!==Ut||At.morphTargets!==Tt||At.morphNormals!==Wt||At.morphColors!==se||At.toneMapping!==Te||At.morphTargetsCount!==fe)&&(Kt=!0):(Kt=!0,At.__version=j.version);let _n=At.currentProgram;Kt===!0&&(_n=Yo(j,z,I));let or=!1,vn=!1,Es=!1;const be=_n.getUniforms(),Ln=At.uniforms;if(vt.useProgram(_n.program)&&(or=!0,vn=!0,Es=!0),j.id!==T&&(T=j.id,vn=!0),or||E!==b){vt.buffers.depth.getReversed()&&b.reversedDepth!==!0&&(b._reversedDepth=!0,b.updateProjectionMatrix()),be.setValue(U,"projectionMatrix",b.projectionMatrix),be.setValue(U,"viewMatrix",b.matrixWorldInverse);const ln=be.map.cameraPosition;ln!==void 0&&ln.setValue(U,pt.setFromMatrixPosition(b.matrixWorld)),Dt.logarithmicDepthBuffer&&be.setValue(U,"logDepthBufFC",2/(Math.log(b.far+1)/Math.LN2)),(j.isMeshPhongMaterial||j.isMeshToonMaterial||j.isMeshLambertMaterial||j.isMeshBasicMaterial||j.isMeshStandardMaterial||j.isShaderMaterial)&&be.setValue(U,"isOrthographic",b.isOrthographicCamera===!0),E!==b&&(E=b,vn=!0,Es=!0)}if(I.isSkinnedMesh){be.setOptional(U,I,"bindMatrix"),be.setOptional(U,I,"bindMatrixInverse");const nn=I.skeleton;nn&&(nn.boneTexture===null&&nn.computeBoneTexture(),be.setValue(U,"boneTexture",nn.boneTexture,Bt))}I.isBatchedMesh&&(be.setOptional(U,I,"batchingTexture"),be.setValue(U,"batchingTexture",I._matricesTexture,Bt),be.setOptional(U,I,"batchingIdTexture"),be.setValue(U,"batchingIdTexture",I._indirectTexture,Bt),be.setOptional(U,I,"batchingColorTexture"),I._colorsTexture!==null&&be.setValue(U,"batchingColorTexture",I._colorsTexture,Bt));const Nn=k.morphAttributes;if((Nn.position!==void 0||Nn.normal!==void 0||Nn.color!==void 0)&&it.update(I,k,_n),(vn||At.receiveShadow!==I.receiveShadow)&&(At.receiveShadow=I.receiveShadow,be.setValue(U,"receiveShadow",I.receiveShadow)),j.isMeshGouraudMaterial&&j.envMap!==null&&(Ln.envMap.value=dt,Ln.flipEnvMap.value=dt.isCubeTexture&&dt.isRenderTargetTexture===!1?-1:1),j.isMeshStandardMaterial&&j.envMap===null&&z.environment!==null&&(Ln.envMapIntensity.value=z.environmentIntensity),vn&&(be.setValue(U,"toneMappingExposure",v.toneMappingExposure),At.needsLights&&px(Ln,Es),nt&&j.fog===!0&&J.refreshFogUniforms(Ln,nt),J.refreshMaterialUniforms(Ln,j,B,X,u.state.transmissionRenderTarget[b.id]),ql.upload(U,pp(At),Ln,Bt)),j.isShaderMaterial&&j.uniformsNeedUpdate===!0&&(ql.upload(U,pp(At),Ln,Bt),j.uniformsNeedUpdate=!1),j.isSpriteMaterial&&be.setValue(U,"center",I.center),be.setValue(U,"modelViewMatrix",I.modelViewMatrix),be.setValue(U,"normalMatrix",I.normalMatrix),be.setValue(U,"modelMatrix",I.matrixWorld),j.isShaderMaterial||j.isRawShaderMaterial){const nn=j.uniformsGroups;for(let ln=0,Kc=nn.length;ln<Kc;ln++){const Ra=nn[ln];zt.update(Ra,_n),zt.bind(Ra,_n)}}return _n}function px(b,z){b.ambientLightColor.needsUpdate=z,b.lightProbe.needsUpdate=z,b.directionalLights.needsUpdate=z,b.directionalLightShadows.needsUpdate=z,b.pointLights.needsUpdate=z,b.pointLightShadows.needsUpdate=z,b.spotLights.needsUpdate=z,b.spotLightShadows.needsUpdate=z,b.rectAreaLights.needsUpdate=z,b.hemisphereLights.needsUpdate=z}function mx(b){return b.isMeshLambertMaterial||b.isMeshToonMaterial||b.isMeshPhongMaterial||b.isMeshStandardMaterial||b.isShadowMaterial||b.isShaderMaterial&&b.lights===!0}this.getActiveCubeFace=function(){return C},this.getActiveMipmapLevel=function(){return w},this.getRenderTarget=function(){return L},this.setRenderTargetTextures=function(b,z,k){const j=xt.get(b);j.__autoAllocateDepthBuffer=b.resolveDepthBuffer===!1,j.__autoAllocateDepthBuffer===!1&&(j.__useRenderToTexture=!1),xt.get(b.texture).__webglTexture=z,xt.get(b.depthTexture).__webglTexture=j.__autoAllocateDepthBuffer?void 0:k,j.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(b,z){const k=xt.get(b);k.__webglFramebuffer=z,k.__useDefaultFramebuffer=z===void 0};const gx=U.createFramebuffer();this.setRenderTarget=function(b,z=0,k=0){L=b,C=z,w=k;let j=!0,I=null,nt=!1,ut=!1;if(b){const dt=xt.get(b);if(dt.__useDefaultFramebuffer!==void 0)vt.bindFramebuffer(U.FRAMEBUFFER,null),j=!1;else if(dt.__webglFramebuffer===void 0)Bt.setupRenderTarget(b);else if(dt.__hasExternalTextures)Bt.rebindTextures(b,xt.get(b.texture).__webglTexture,xt.get(b.depthTexture).__webglTexture);else if(b.depthBuffer){const Tt=b.depthTexture;if(dt.__boundDepthTexture!==Tt){if(Tt!==null&&xt.has(Tt)&&(b.width!==Tt.image.width||b.height!==Tt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");Bt.setupDepthRenderbuffer(b)}}const Rt=b.texture;(Rt.isData3DTexture||Rt.isDataArrayTexture||Rt.isCompressedArrayTexture)&&(ut=!0);const Ut=xt.get(b).__webglFramebuffer;b.isWebGLCubeRenderTarget?(Array.isArray(Ut[z])?I=Ut[z][k]:I=Ut[z],nt=!0):b.samples>0&&Bt.useMultisampledRTT(b)===!1?I=xt.get(b).__webglMultisampledFramebuffer:Array.isArray(Ut)?I=Ut[k]:I=Ut,N.copy(b.viewport),G.copy(b.scissor),D=b.scissorTest}else N.copy(_t).multiplyScalar(B).floor(),G.copy(Ot).multiplyScalar(B).floor(),D=ne;if(k!==0&&(I=gx),vt.bindFramebuffer(U.FRAMEBUFFER,I)&&j&&vt.drawBuffers(b,I),vt.viewport(N),vt.scissor(G),vt.setScissorTest(D),nt){const dt=xt.get(b.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_CUBE_MAP_POSITIVE_X+z,dt.__webglTexture,k)}else if(ut){const dt=z;for(let Rt=0;Rt<b.textures.length;Rt++){const Ut=xt.get(b.textures[Rt]);U.framebufferTextureLayer(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0+Rt,Ut.__webglTexture,k,dt)}}else if(b!==null&&k!==0){const dt=xt.get(b.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,dt.__webglTexture,k)}T=-1},this.readRenderTargetPixels=function(b,z,k,j,I,nt,ut,mt=0){if(!(b&&b.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let dt=xt.get(b).__webglFramebuffer;if(b.isWebGLCubeRenderTarget&&ut!==void 0&&(dt=dt[ut]),dt){vt.bindFramebuffer(U.FRAMEBUFFER,dt);try{const Rt=b.textures[mt],Ut=Rt.format,Tt=Rt.type;if(!Dt.textureFormatReadable(Ut)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Dt.textureTypeReadable(Tt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}z>=0&&z<=b.width-j&&k>=0&&k<=b.height-I&&(b.textures.length>1&&U.readBuffer(U.COLOR_ATTACHMENT0+mt),U.readPixels(z,k,j,I,Mt.convert(Ut),Mt.convert(Tt),nt))}finally{const Rt=L!==null?xt.get(L).__webglFramebuffer:null;vt.bindFramebuffer(U.FRAMEBUFFER,Rt)}}},this.readRenderTargetPixelsAsync=async function(b,z,k,j,I,nt,ut,mt=0){if(!(b&&b.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let dt=xt.get(b).__webglFramebuffer;if(b.isWebGLCubeRenderTarget&&ut!==void 0&&(dt=dt[ut]),dt)if(z>=0&&z<=b.width-j&&k>=0&&k<=b.height-I){vt.bindFramebuffer(U.FRAMEBUFFER,dt);const Rt=b.textures[mt],Ut=Rt.format,Tt=Rt.type;if(!Dt.textureFormatReadable(Ut))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Dt.textureTypeReadable(Tt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Wt=U.createBuffer();U.bindBuffer(U.PIXEL_PACK_BUFFER,Wt),U.bufferData(U.PIXEL_PACK_BUFFER,nt.byteLength,U.STREAM_READ),b.textures.length>1&&U.readBuffer(U.COLOR_ATTACHMENT0+mt),U.readPixels(z,k,j,I,Mt.convert(Ut),Mt.convert(Tt),0);const se=L!==null?xt.get(L).__webglFramebuffer:null;vt.bindFramebuffer(U.FRAMEBUFFER,se);const Te=U.fenceSync(U.SYNC_GPU_COMMANDS_COMPLETE,0);return U.flush(),await ib(U,Te,4),U.bindBuffer(U.PIXEL_PACK_BUFFER,Wt),U.getBufferSubData(U.PIXEL_PACK_BUFFER,0,nt),U.deleteBuffer(Wt),U.deleteSync(Te),nt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(b,z=null,k=0){const j=Math.pow(2,-k),I=Math.floor(b.image.width*j),nt=Math.floor(b.image.height*j),ut=z!==null?z.x:0,mt=z!==null?z.y:0;Bt.setTexture2D(b,0),U.copyTexSubImage2D(U.TEXTURE_2D,k,0,0,ut,mt,I,nt),vt.unbindTexture()};const _x=U.createFramebuffer(),vx=U.createFramebuffer();this.copyTextureToTexture=function(b,z,k=null,j=null,I=0,nt=null){nt===null&&(I!==0?(Eo("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),nt=I,I=0):nt=0);let ut,mt,dt,Rt,Ut,Tt,Wt,se,Te;const me=b.isCompressedTexture?b.mipmaps[nt]:b.image;if(k!==null)ut=k.max.x-k.min.x,mt=k.max.y-k.min.y,dt=k.isBox3?k.max.z-k.min.z:1,Rt=k.min.x,Ut=k.min.y,Tt=k.isBox3?k.min.z:0;else{const Nn=Math.pow(2,-I);ut=Math.floor(me.width*Nn),mt=Math.floor(me.height*Nn),b.isDataArrayTexture?dt=me.depth:b.isData3DTexture?dt=Math.floor(me.depth*Nn):dt=1,Rt=0,Ut=0,Tt=0}j!==null?(Wt=j.x,se=j.y,Te=j.z):(Wt=0,se=0,Te=0);const fe=Mt.convert(z.format),At=Mt.convert(z.type);let Me;z.isData3DTexture?(Bt.setTexture3D(z,0),Me=U.TEXTURE_3D):z.isDataArrayTexture||z.isCompressedArrayTexture?(Bt.setTexture2DArray(z,0),Me=U.TEXTURE_2D_ARRAY):(Bt.setTexture2D(z,0),Me=U.TEXTURE_2D),U.pixelStorei(U.UNPACK_FLIP_Y_WEBGL,z.flipY),U.pixelStorei(U.UNPACK_PREMULTIPLY_ALPHA_WEBGL,z.premultiplyAlpha),U.pixelStorei(U.UNPACK_ALIGNMENT,z.unpackAlignment);const Kt=U.getParameter(U.UNPACK_ROW_LENGTH),_n=U.getParameter(U.UNPACK_IMAGE_HEIGHT),or=U.getParameter(U.UNPACK_SKIP_PIXELS),vn=U.getParameter(U.UNPACK_SKIP_ROWS),Es=U.getParameter(U.UNPACK_SKIP_IMAGES);U.pixelStorei(U.UNPACK_ROW_LENGTH,me.width),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,me.height),U.pixelStorei(U.UNPACK_SKIP_PIXELS,Rt),U.pixelStorei(U.UNPACK_SKIP_ROWS,Ut),U.pixelStorei(U.UNPACK_SKIP_IMAGES,Tt);const be=b.isDataArrayTexture||b.isData3DTexture,Ln=z.isDataArrayTexture||z.isData3DTexture;if(b.isDepthTexture){const Nn=xt.get(b),nn=xt.get(z),ln=xt.get(Nn.__renderTarget),Kc=xt.get(nn.__renderTarget);vt.bindFramebuffer(U.READ_FRAMEBUFFER,ln.__webglFramebuffer),vt.bindFramebuffer(U.DRAW_FRAMEBUFFER,Kc.__webglFramebuffer);for(let Ra=0;Ra<dt;Ra++)be&&(U.framebufferTextureLayer(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,xt.get(b).__webglTexture,I,Tt+Ra),U.framebufferTextureLayer(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,xt.get(z).__webglTexture,nt,Te+Ra)),U.blitFramebuffer(Rt,Ut,ut,mt,Wt,se,ut,mt,U.DEPTH_BUFFER_BIT,U.NEAREST);vt.bindFramebuffer(U.READ_FRAMEBUFFER,null),vt.bindFramebuffer(U.DRAW_FRAMEBUFFER,null)}else if(I!==0||b.isRenderTargetTexture||xt.has(b)){const Nn=xt.get(b),nn=xt.get(z);vt.bindFramebuffer(U.READ_FRAMEBUFFER,_x),vt.bindFramebuffer(U.DRAW_FRAMEBUFFER,vx);for(let ln=0;ln<dt;ln++)be?U.framebufferTextureLayer(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,Nn.__webglTexture,I,Tt+ln):U.framebufferTexture2D(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,Nn.__webglTexture,I),Ln?U.framebufferTextureLayer(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,nn.__webglTexture,nt,Te+ln):U.framebufferTexture2D(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,nn.__webglTexture,nt),I!==0?U.blitFramebuffer(Rt,Ut,ut,mt,Wt,se,ut,mt,U.COLOR_BUFFER_BIT,U.NEAREST):Ln?U.copyTexSubImage3D(Me,nt,Wt,se,Te+ln,Rt,Ut,ut,mt):U.copyTexSubImage2D(Me,nt,Wt,se,Rt,Ut,ut,mt);vt.bindFramebuffer(U.READ_FRAMEBUFFER,null),vt.bindFramebuffer(U.DRAW_FRAMEBUFFER,null)}else Ln?b.isDataTexture||b.isData3DTexture?U.texSubImage3D(Me,nt,Wt,se,Te,ut,mt,dt,fe,At,me.data):z.isCompressedArrayTexture?U.compressedTexSubImage3D(Me,nt,Wt,se,Te,ut,mt,dt,fe,me.data):U.texSubImage3D(Me,nt,Wt,se,Te,ut,mt,dt,fe,At,me):b.isDataTexture?U.texSubImage2D(U.TEXTURE_2D,nt,Wt,se,ut,mt,fe,At,me.data):b.isCompressedTexture?U.compressedTexSubImage2D(U.TEXTURE_2D,nt,Wt,se,me.width,me.height,fe,me.data):U.texSubImage2D(U.TEXTURE_2D,nt,Wt,se,ut,mt,fe,At,me);U.pixelStorei(U.UNPACK_ROW_LENGTH,Kt),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,_n),U.pixelStorei(U.UNPACK_SKIP_PIXELS,or),U.pixelStorei(U.UNPACK_SKIP_ROWS,vn),U.pixelStorei(U.UNPACK_SKIP_IMAGES,Es),nt===0&&z.generateMipmaps&&U.generateMipmap(Me),vt.unbindTexture()},this.initRenderTarget=function(b){xt.get(b).__webglFramebuffer===void 0&&Bt.setupRenderTarget(b)},this.initTexture=function(b){b.isCubeTexture?Bt.setTextureCube(b,0):b.isData3DTexture?Bt.setTexture3D(b,0):b.isDataArrayTexture||b.isCompressedArrayTexture?Bt.setTexture2DArray(b,0):Bt.setTexture2D(b,0),vt.unbindTexture()},this.resetState=function(){C=0,w=0,L=null,vt.reset(),ct.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return si}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const n=this.getContext();n.drawingBufferColorSpace=Qt._getDrawingBufferColorSpace(t),n.unpackColorSpace=Qt._getUnpackColorSpace()}}const Er=({modelPath:e,scale:t=1,position:n=[0,0,0],rotation:i=[0,0,0],modelSize:a=2,rotationSpeed:r=.01,showWireframe:s=!1,color:o=4886754,geometry:l="box"})=>{const c=Ae.useRef(null),d=Ae.useRef(null),h=Ae.useRef(null),f=Ae.useRef(null);return Ae.useEffect(()=>{if(!c.current)return;const p=new Cb;d.current=p;const x=new En(75,c.current.clientWidth/c.current.clientHeight,.1,1e3);x.position.set(0,0,5);const y=new EA({alpha:!0,antialias:!0});y.setSize(c.current.clientWidth,c.current.clientHeight),y.setClearColor(0,0),y.shadowMap.enabled=!0,y.shadowMap.type=zv,h.current=y,c.current.appendChild(y.domElement);const m=new Hb(16777215,.6);p.add(m);const u=new Fb(16777215,.8);u.position.set(10,10,5),u.castShadow=!0,p.add(u);const g=new Ib(4886754,.5);g.position.set(-10,-10,-5),p.add(g);let _;switch(l){case"sphere":_=new sp(a,32,32);break;case"torus":_=new op(a,a*.4,16,32);break;default:_=new Ms(a,a,a)}const v=new Nb({color:o,transparent:!0,opacity:s?.6:.8,wireframe:s}),A=new oi(_,v);A.position.set(...n),A.rotation.set(...i),A.scale.setScalar(t),A.castShadow=!0,A.receiveShadow=!0,p.add(A);const C=()=>{f.current=requestAnimationFrame(C),A.rotation.x+=r,A.rotation.y+=r*.7,A.rotation.z+=r*.3,A.position.y=n[1]+Math.sin(Date.now()*.001)*.3,y.render(p,x)};C();const w=()=>{c.current&&(x.aspect=c.current.clientWidth/c.current.clientHeight,x.updateProjectionMatrix(),y.setSize(c.current.clientWidth,c.current.clientHeight))};return window.addEventListener("resize",w),()=>{window.removeEventListener("resize",w),f.current&&cancelAnimationFrame(f.current),c.current&&y.domElement&&c.current.removeChild(y.domElement),_.dispose(),v.dispose(),y.dispose()}},[e,t,n,i,a,r,s,o,l]),M.jsx("div",{ref:c,style:{width:"100%",height:"100%",position:"relative"}})};function TA(){const[e,t]=Ae.useState(null),[n,i]=Ae.useState(0),[a,r]=Ae.useState(!1),[s,o]=Ae.useState("all"),[l,c]=Ae.useState(null),[d,h]=Ae.useState(null),[f,p]=Ae.useState({x:100,y:100}),[x,y]=Ae.useState(!1),[m,u]=Ae.useState({x:0,y:0}),[g,_]=Ae.useState(!0),[v,A]=Ae.useState(0),C=[{id:"virtual-soul",title:"Virtual Soul",category:"Digital Art",year:"2024",description:"A series exploring the ethereal essence of identity in digital realms.",software:["photoshop","aftereffects","cinema4d","3dmax","unrealengine"],image:"/Personal-Website/images/1-Virtual%20Soul/image001.jpg",gallery:["/Personal-Website/images/1-Virtual%20Soul/image001.jpg","/Personal-Website/images/1-Virtual%20Soul/image002.jpg","/Personal-Website/images/1-Virtual%20Soul/image003.jpg","/Personal-Website/images/1-Virtual%20Soul/image004.jpg","/Personal-Website/images/1-Virtual%20Soul/image005.jpg","/Personal-Website/images/1-Virtual%20Soul/image006.jpg","/Personal-Website/images/1-Virtual%20Soul/image007.jpg"]},{id:"nether-portal",title:"Nether Portal",category:"Generative Art",year:"2023",description:"Hypnotic tunnels and geometry bending through imaginary space. This project incorporates AI for code generation and image creation.",software:["touchdesigner","aftereffects","photoshop","arduino","ai"],image:"/Personal-Website/images/2-Nether%20Portal/image008.jpg",gallery:["/Personal-Website/images/2-Nether%20Portal/image008.jpg","/Personal-Website/images/2-Nether%20Portal/image009.jpg","/Personal-Website/images/2-Nether%20Portal/image010.jpg","/Personal-Website/images/2-Nether%20Portal/image011.jpg","/Personal-Website/images/2-Nether%20Portal/image013.jpg","/Personal-Website/images/2-Nether%20Portal/image014.jpg"]},{id:"prayer-bloom",title:"Prayer of Wind and Bloom",category:"Interactive Installation",year:"2023",description:"An immersive experience connecting nature and technology. This project combines digital tools with traditional handcraft techniques.",software:["arduino","photoshop"],image:"/Personal-Website/images/3-Prayer%20of%20Wind%20and%20Bloom/image015.jpg",gallery:["/Personal-Website/images/3-Prayer%20of%20Wind%20and%20Bloom/image015.jpg","/Personal-Website/images/3-Prayer%20of%20Wind%20and%20Bloom/image016.jpg","/Personal-Website/images/3-Prayer%20of%20Wind%20and%20Bloom/image017.jpg","/Personal-Website/images/3-Prayer%20of%20Wind%20and%20Bloom/image018.jpg","/Personal-Website/images/3-Prayer%20of%20Wind%20and%20Bloom/image019.jpg"]},{id:"unnatural-chronologies",title:"Unnatural Chronologies",category:"Video Art",year:"2022",description:"A meditation on time and digital decay through glitch aesthetics.",software:["touchdesigner","aftereffects","photoshop","artivive","blender"],image:"/Personal-Website/images/4-Unnatural%20Chronologies/image020.jpg",gallery:["/Personal-Website/images/4-Unnatural%20Chronologies/image020.jpg","/Personal-Website/images/4-Unnatural%20Chronologies/image021.jpg","/Personal-Website/images/4-Unnatural%20Chronologies/image022.jpg","/Personal-Website/images/4-Unnatural%20Chronologies/image023.jpg","/Personal-Website/images/4-Unnatural%20Chronologies/image024.jpg","/Personal-Website/images/4-Unnatural%20Chronologies/image025.jpg","/Personal-Website/images/4-Unnatural%20Chronologies/image026.jpg"]}],w=[{id:"all",name:"All",icon:"🎨"},{id:"photoshop",name:"Photoshop",icon:"🖼️"},{id:"blender",name:"Blender",icon:"🌪️"},{id:"aftereffects",name:"After Effects",icon:"🎬"},{id:"cinema4d",name:"Cinema 4D",icon:"🎭"},{id:"touchdesigner",name:"TouchDesigner",icon:"⚡"},{id:"arduino",name:"Arduino",icon:"🔧"},{id:"3dmax",name:"3D Max",icon:"🏗️"},{id:"unrealengine",name:"Unreal Engine",icon:"🎮"},{id:"ai",name:"AI Tools",icon:"🤖"},{id:"artivive",name:"Artivive",icon:"🔮"}],L=s==="all"?C:C.filter(D=>D.software.includes(s)),T=D=>{a||(r(!0),i(D==="next"?W=>(W+1)%C.length:W=>(W-1+C.length)%C.length),setTimeout(()=>r(!1),800))};Ae.useEffect(()=>{const D=setInterval(()=>{!e&&!a&&T("next")},5e3);return()=>clearInterval(D)},[e,a]);const E=D=>{y(!0);const W=D.target.getBoundingClientRect();u({x:D.clientX-W.left,y:D.clientY-W.top})},N=D=>{x&&p({x:D.clientX-m.x,y:D.clientY-m.y})},G=()=>{y(!1)};return Ae.useEffect(()=>{if(x)return document.addEventListener("mousemove",N),document.addEventListener("mouseup",G),()=>{document.removeEventListener("mousemove",N),document.removeEventListener("mouseup",G)}},[x,m]),Ae.useEffect(()=>{const D=setInterval(()=>{A(W=>W>=100?(clearInterval(D),setTimeout(()=>_(!1),1500),100):W+Math.random()*15)},80);return()=>clearInterval(D)},[]),g?M.jsxs("div",{style:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",background:"linear-gradient(135deg, #000000 0%, #1a1a1a 50%, #000000 100%)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",zIndex:9999,color:"white",fontFamily:"'Inter', sans-serif"},children:[M.jsx("div",{style:{fontSize:"2rem",fontWeight:"300",color:"white",letterSpacing:"0.2em",marginBottom:"30px",fontFamily:"'Inter', sans-serif"},children:"OYXR"}),M.jsxs("div",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.7)",letterSpacing:"0.1em",marginBottom:"40px",textAlign:"center"},children:["Loading Digital Experience",M.jsx("br",{}),M.jsx("span",{style:{opacity:.5},children:"Welcome to My Creative World"})]}),M.jsx("div",{style:{width:"300px",height:"3px",background:"rgba(255,255,255,0.1)",borderRadius:"2px",overflow:"hidden",marginBottom:"20px"},children:M.jsx("div",{style:{width:`${v}%`,height:"100%",background:"linear-gradient(90deg, #ffffff 0%, #888888 50%, #ffffff 100%)",borderRadius:"2px",transition:"width 0.3s ease",boxShadow:"0 0 10px rgba(255,255,255,0.5)"}})}),M.jsxs("div",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.8)",letterSpacing:"0.1em"},children:[Math.round(v),"%"]}),M.jsx("div",{style:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%, -50%)",width:"400px",height:"400px",pointerEvents:"none",zIndex:-1},children:[...Array(20)].map((D,W)=>M.jsx("div",{style:{position:"absolute",width:"4px",height:"4px",background:"rgba(255,255,255,0.3)",borderRadius:"50%",top:"50%",left:"50%",transform:`
                  translate(-50%, -50%) 
                  rotate(${W*18}deg) 
                  translateY(-${100+W*10}px)
                  rotate(${Date.now()/(1e3+W*100)}deg)
                `,animation:`float ${2+W*.1}s ease-in-out infinite`,animationDelay:`${W*.1}s`}},W))}),M.jsx("style",{jsx:!0,children:`
          @keyframes pulse {
        ...
        `})]}):M.jsxs("div",{style:{width:"100vw",height:"100vh",background:"#000000",color:"white",margin:0,padding:0,overflow:"hidden auto",scrollSnapType:"y mandatory"},children:[M.jsxs("section",{style:{minHeight:"100vh",height:"100vh",width:"100vw",padding:"40px",background:"linear-gradient(135deg, #000000 0%, #1a1a1a 50%, #000000 100%)",display:"flex",alignItems:"center",justifyContent:"space-between",position:"relative",scrollSnapAlign:"start",scrollSnapStop:"always",overflow:"hidden"},children:[M.jsxs("div",{style:{flex:"1",display:"flex",flexDirection:"column",justifyContent:"center",padding:"0 80px",zIndex:2},children:[M.jsxs("div",{style:{marginBottom:"40px",display:"flex",alignItems:"center",gap:"15px"},children:[M.jsx("img",{src:"/Personal-Website/images/logo111.svg",alt:"OYXR Logo",style:{width:"60px",height:"60px",filter:"invert(1)",opacity:.9,backgroundColor:"white",borderRadius:"50%",padding:"8px",border:"2px solid rgba(255,255,255,0.8)"}}),M.jsx("div",{style:{fontSize:"1.5rem",fontWeight:"300",color:"white",letterSpacing:"0.1em",fontFamily:"'Inter', sans-serif"},children:"OYXR"})]}),M.jsx("div",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.3em",marginBottom:"30px",textTransform:"uppercase",fontWeight:"300",fontFamily:"'Inter', sans-serif"},children:"Digital Artist & Creative Technologist"}),M.jsxs("h1",{style:{fontSize:"clamp(2rem, 4vw, 3.5rem)",fontWeight:"100",margin:"0 0 30px 0",letterSpacing:"-0.03em",lineHeight:"1.1",background:"linear-gradient(135deg, #ffffff 0%, #888888 100%)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",fontFamily:"'Inter', sans-serif"},children:["Xinran",M.jsx("br",{}),"Ouyang"]}),M.jsx("p",{style:{fontSize:"clamp(1rem, 2vw, 1.2rem)",lineHeight:"1.6",color:"rgba(255,255,255,0.7)",fontWeight:"300",maxWidth:"500px",margin:"0 0 50px 0",fontFamily:"'Inter', sans-serif"},children:"Exploring the intersection of technology, creativity, and human experience through immersive digital art and interactive installations."}),M.jsxs("div",{style:{display:"flex",gap:"20px",flexWrap:"wrap"},children:[M.jsx("button",{style:{background:"white",color:"black",border:"none",padding:"16px 32px",fontSize:"0.95rem",fontWeight:"500",letterSpacing:"0.05em",cursor:"pointer",transition:"all 0.3s ease",fontFamily:"'Inter', sans-serif",textTransform:"uppercase"},onMouseEnter:D=>{D.target.style.background="rgba(255,255,255,0.9)",D.target.style.transform="translateY(-2px)"},onMouseLeave:D=>{D.target.style.background="white",D.target.style.transform="translateY(0)"},onClick:()=>document.getElementById("work").scrollIntoView({behavior:"smooth"}),children:"View Work"}),M.jsx("button",{style:{background:"transparent",color:"white",border:"1px solid rgba(255,255,255,0.3)",padding:"16px 32px",fontSize:"0.95rem",fontWeight:"400",letterSpacing:"0.05em",cursor:"pointer",transition:"all 0.3s ease",fontFamily:"'Inter', sans-serif",textTransform:"uppercase"},onMouseEnter:D=>{D.target.style.borderColor="white",D.target.style.background="rgba(255,255,255,0.1)"},onMouseLeave:D=>{D.target.style.borderColor="rgba(255,255,255,0.3)",D.target.style.background="transparent"},onClick:()=>document.getElementById("about").scrollIntoView({behavior:"smooth"}),children:"About"}),M.jsx("button",{style:{background:"transparent",color:"white",border:"1px solid rgba(255,255,255,0.3)",padding:"16px 32px",fontSize:"0.95rem",fontWeight:"400",letterSpacing:"0.05em",cursor:"pointer",transition:"all 0.3s ease",fontFamily:"'Inter', sans-serif",textTransform:"uppercase"},onMouseEnter:D=>{D.target.style.borderColor="white",D.target.style.background="rgba(255,255,255,0.1)"},onMouseLeave:D=>{D.target.style.borderColor="rgba(255,255,255,0.3)",D.target.style.background="transparent"},onClick:()=>document.getElementById("showcase").scrollIntoView({behavior:"smooth"}),children:"3D Showcase"})]})]}),M.jsxs("div",{style:{flex:"1",display:"flex",alignItems:"center",justifyContent:"flex-start",padding:"0 80px 0 20px",perspective:"1000px",position:"relative"},children:[M.jsx("div",{style:{position:"absolute",top:"20%",right:"-100px",width:"300px",height:"300px",opacity:.3,zIndex:0,pointerEvents:"none"},children:M.jsx(Er,{modelSize:1.5,rotationSpeed:.01,showWireframe:!0,color:4890367,geometry:"torus"})}),M.jsxs("div",{style:{position:"relative",width:"100%",maxWidth:"700px",height:"400px",zIndex:1},children:[M.jsx("div",{style:{position:"absolute",top:"50%",left:"50%",width:"600px",height:"300px",transform:`translate(-50%, -50%) rotateY(${n*-90}deg)`,transformStyle:"preserve-3d",transition:a?"transform 0.8s cubic-bezier(0.4, 0, 0.2, 1)":"none"},children:C.map((D,W)=>{const V=W*90,P=W===n;return M.jsx("div",{style:{position:"absolute",width:"450px",height:"280px",top:"50%",left:"50%",transform:`translate(-50%, -50%) rotateY(${V}deg) translateZ(300px)`,transformStyle:"preserve-3d",cursor:"pointer",transition:"all 0.3s ease"},onClick:()=>t(D),children:M.jsxs("div",{style:{width:"100%",height:"100%",background:"rgba(0,0,0,0.8)",borderRadius:"16px",border:P?"2px solid rgba(255,255,255,0.3)":"1px solid rgba(255,255,255,0.1)",overflow:"hidden",position:"relative",transform:P?"scale(1.05)":"scale(0.9)",opacity:P?1:.7,transition:"all 0.3s ease",boxShadow:P?"0 20px 40px rgba(0,0,0,0.5)":"0 10px 20px rgba(0,0,0,0.3)",display:"flex",padding:"20px",gap:"20px"},children:[M.jsxs("div",{style:{flex:"2",display:"flex",alignItems:"center",justifyContent:"center",backgroundColor:"rgba(255,255,255,0.05)",borderRadius:"12px",overflow:"hidden"},children:[M.jsx("img",{src:D.image,alt:D.title,style:{maxWidth:"100%",maxHeight:"100%",objectFit:"contain",borderRadius:"8px"},onError:X=>{X.target.style.display="none",X.target.nextSibling.style.display="flex"}}),M.jsx("div",{style:{display:"none",alignItems:"center",justifyContent:"center",color:"rgba(255,255,255,0.6)",fontSize:"1rem",fontFamily:"'Inter', sans-serif",textAlign:"center",padding:"20px"},children:D.title})]}),M.jsxs("div",{style:{flex:"1",display:"flex",flexDirection:"column",justifyContent:"center",padding:"10px 0"},children:[M.jsxs("div",{style:{fontSize:"0.7rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.1em",marginBottom:"12px",textTransform:"uppercase",fontFamily:"'Inter', sans-serif"},children:[D.category," • ",D.year]}),M.jsx("h3",{style:{fontSize:"1.1rem",fontWeight:"500",margin:"0",color:"white",letterSpacing:"-0.01em",fontFamily:"'Inter', sans-serif",lineHeight:"1.3"},children:D.title})]}),M.jsx("div",{style:{position:"absolute",top:"15px",right:"15px",width:"30px",height:"30px",background:"rgba(0,0,0,0.7)",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",color:"white",fontSize:"14px",opacity:P?1:.7,border:"1px solid rgba(255,255,255,0.2)"},children:"↗"})]})},D.id)})}),M.jsxs("div",{style:{position:"absolute",bottom:"-60px",left:"50%",transform:"translateX(-50%)",display:"flex",alignItems:"center",gap:"20px"},children:[M.jsx("button",{onClick:()=>T("prev"),disabled:a,style:{width:"35px",height:"35px",border:"1px solid rgba(255,255,255,0.3)",background:"rgba(0,0,0,0.5)",color:"white",borderRadius:"50%",cursor:a?"not-allowed":"pointer",fontSize:"14px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s ease",opacity:a?.5:1},children:"←"}),M.jsx("div",{style:{display:"flex",gap:"8px"},children:C.map((D,W)=>M.jsx("div",{onClick:()=>{a||i(W)},style:{width:"8px",height:"8px",borderRadius:"50%",background:W===n?"rgba(255,255,255,0.8)":"rgba(255,255,255,0.3)",cursor:a?"not-allowed":"pointer",transition:"all 0.3s ease"}},W))}),M.jsx("button",{onClick:()=>T("next"),disabled:a,style:{width:"35px",height:"35px",border:"1px solid rgba(255,255,255,0.3)",background:"rgba(0,0,0,0.5)",color:"white",borderRadius:"50%",cursor:a?"not-allowed":"pointer",fontSize:"14px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s ease",opacity:a?.5:1},children:"→"})]})]})]}),M.jsx("div",{style:{position:"absolute",bottom:"40px",left:"50%",transform:"translateX(-50%)",color:"rgba(255,255,255,0.4)",fontSize:"0.8rem",letterSpacing:"0.1em",fontFamily:"'Inter', sans-serif"},children:"SCROLL TO EXPLORE"})]}),M.jsxs("section",{id:"work",style:{height:"100vh",width:"100vw",padding:"40px",background:"linear-gradient(180deg, #000000 0%, #1a1a1a 50%, #000000 100%)",display:"flex",alignItems:"center",justifyContent:"center",scrollSnapAlign:"start",scrollSnapStop:"always",overflow:"hidden"},children:[M.jsxs("div",{style:{width:"320px",display:"flex",flexDirection:"column",paddingRight:"40px"},children:[M.jsxs("div",{style:{marginBottom:"40px"},children:[M.jsx("h2",{style:{fontSize:"2.5rem",fontWeight:"300",margin:"0 0 15px 0",letterSpacing:"-0.02em",color:"white",fontFamily:"'Inter', sans-serif"},children:"Featured Work"}),M.jsx("p",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.6)",margin:0,fontFamily:"'Inter', sans-serif",lineHeight:"1.6"},children:"A selection of recent projects exploring digital art and interactive experiences"})]}),M.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"10px",flex:1,maxHeight:"calc(100vh - 200px)",overflowY:"auto"},children:w.map(D=>M.jsxs("button",{onClick:()=>o(D.id),style:{background:s===D.id?"linear-gradient(135deg, #667eea 0%, #764ba2 100%)":"rgba(255, 255, 255, 0.05)",border:s===D.id?"none":"1px solid rgba(255, 255, 255, 0.1)",borderRadius:"12px",padding:"12px 16px",color:"white",fontSize:"0.9rem",fontWeight:"400",cursor:"pointer",transition:"all 0.3s ease",display:"flex",alignItems:"center",gap:"10px",textAlign:"left",fontFamily:"'Inter', sans-serif",transform:s===D.id?"translateX(5px)":"translateX(0)",boxShadow:s===D.id?"0 4px 15px rgba(102, 126, 234, 0.3)":"none"},onMouseEnter:W=>{s!==D.id&&(W.target.style.background="rgba(255, 255, 255, 0.1)",W.target.style.transform="translateX(3px)")},onMouseLeave:W=>{s!==D.id&&(W.target.style.background="rgba(255, 255, 255, 0.05)",W.target.style.transform="translateX(0)")},children:[M.jsx("span",{style:{fontSize:"1.1rem"},children:D.icon}),M.jsx("span",{children:D.name})]},D.id))})]}),M.jsx("div",{style:{flex:1,display:"grid",gridTemplateColumns:"repeat(2, 1fr)",gridTemplateRows:"repeat(2, 1fr)",gap:"20px",height:"100%",overflow:"hidden"},children:L.map((D,W)=>M.jsxs("div",{style:{background:"rgba(255,255,255,0.05)",borderRadius:"16px",border:"1px solid rgba(255,255,255,0.1)",overflow:"hidden",cursor:"pointer",transition:"all 0.4s cubic-bezier(0.4, 0, 0.2, 1)",transform:"translateY(0)",opacity:1,display:"flex",flexDirection:"column",height:"100%"},onClick:()=>t(D),onMouseEnter:V=>{V.target.style.transform="translateY(-8px)",V.target.style.borderColor="rgba(255,255,255,0.3)",V.target.style.boxShadow="0 20px 40px rgba(0,0,0,0.3)"},onMouseLeave:V=>{V.target.style.transform="translateY(0)",V.target.style.borderColor="rgba(255,255,255,0.1)",V.target.style.boxShadow="none"},children:[M.jsxs("div",{style:{width:"100%",flex:"1",position:"relative",overflow:"hidden",backgroundColor:"rgba(0,0,0,0.8)",display:"flex",alignItems:"center",justifyContent:"center",minHeight:"180px"},children:[M.jsx("img",{src:`${D.image}?v=${Date.now()}`,alt:D.title,style:{maxWidth:"100%",maxHeight:"100%",objectFit:"contain",transition:"transform 0.4s ease"},onError:V=>{V.target.style.display="none",V.target.nextSibling.style.display="flex"}}),M.jsx("div",{style:{display:"none",alignItems:"center",justifyContent:"center",color:"rgba(255,255,255,0.6)",fontSize:"1.2rem",fontFamily:"'Inter', sans-serif",textAlign:"center",height:"100%"},children:D.title}),M.jsx("div",{style:{position:"absolute",top:"12px",right:"12px",width:"32px",height:"32px",background:"rgba(0,0,0,0.7)",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",color:"white",fontSize:"14px",opacity:.8,transition:"all 0.3s ease"},children:"↗"})]}),M.jsxs("div",{style:{padding:"12px 16px",background:"rgba(0,0,0,0.3)",borderTop:"1px solid rgba(255,255,255,0.1)"},children:[M.jsxs("div",{style:{fontSize:"0.75rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.1em",marginBottom:"6px",textTransform:"uppercase",fontFamily:"'Inter', sans-serif"},children:[D.category," • ",D.year]}),M.jsx("h3",{style:{fontSize:"1rem",fontWeight:"500",margin:"0",color:"white",letterSpacing:"-0.01em",fontFamily:"'Inter', sans-serif",lineHeight:"1.3"},children:D.title})]})]},D.id))})]}),M.jsx("section",{id:"about",style:{minHeight:"100vh",width:"100vw",background:"linear-gradient(135deg, #0a0a0a 0%, #1a1a1a 50%, #0a0a0a 100%)",display:"flex",alignItems:"center",justifyContent:"center",scrollSnapAlign:"start",scrollSnapStop:"always",overflow:"auto",position:"relative",paddingTop:"40px",paddingBottom:"40px"},children:M.jsxs("div",{style:{width:"100%",display:"flex",flexDirection:"row",justifyContent:"center",padding:"0 80px",zIndex:2,maxWidth:"1200px",gap:"60px"},children:[M.jsxs("div",{style:{flex:"1",display:"flex",flexDirection:"column",justifyContent:"flex-start",paddingTop:"20px"},children:[M.jsxs("div",{style:{display:"flex",alignItems:"flex-start",gap:"20px",marginBottom:"30px"},children:[M.jsx("div",{style:{flexShrink:0},children:M.jsxs("div",{style:{width:"120px",height:"120px",borderRadius:"50%",background:"rgba(255,255,255,0.05)",border:"2px solid rgba(255,255,255,0.1)",overflow:"hidden",position:"relative",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s ease"},children:[M.jsx("span",{style:{fontSize:"2rem",color:"rgba(255,255,255,0.4)"},children:"👤"}),M.jsx("img",{src:"/Personal-Website/images/xinran-photo.jpg?v=2025100909",alt:"Xinran Ouyang",style:{width:"100%",height:"100%",objectFit:"cover",position:"absolute",top:0,left:0,opacity:0},onLoad:D=>{D.target.style.opacity=1},onError:D=>{D.target.style.display="none"}})]})}),M.jsxs("div",{children:[M.jsx("div",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.3em",marginBottom:"15px",textTransform:"uppercase",fontWeight:"300",fontFamily:"'Inter', sans-serif"},children:"Digital Artist & Creative Technologist"}),M.jsx("h2",{style:{fontSize:"clamp(2.5rem, 5vw, 4rem)",fontWeight:"100",margin:"0 0 10px 0",letterSpacing:"-0.03em",lineHeight:"1.1",background:"linear-gradient(135deg, #ffffff 0%, #888888 100%)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",fontFamily:"'Inter', sans-serif"},children:"About Me"}),M.jsx("div",{style:{fontSize:"1.1rem",color:"rgba(255,255,255,0.7)",fontFamily:"'Inter', sans-serif",fontWeight:"300"},children:"Xinran Ouyang"})]})]}),M.jsxs("div",{style:{marginBottom:"30px",textAlign:"left",maxWidth:"800px"},children:[M.jsx("p",{style:{fontSize:"clamp(1rem, 2vw, 1.2rem)",lineHeight:"1.6",color:"rgba(255,255,255,0.8)",margin:"0 0 15px 0",fontFamily:"'Inter', sans-serif",fontWeight:"300"},children:"I'm a digital media artist currently pursuing my Master's in Innovative Multimedia Entertainment at The Hong Kong Polytechnic University, with a strong foundation in digital media arts."}),M.jsx("p",{style:{fontSize:"1rem",lineHeight:"1.6",color:"rgba(255,255,255,0.7)",margin:0,fontFamily:"'Inter', sans-serif",fontWeight:"300"},children:"My work spans across digital media production, interactive installations, and multimedia entertainment, with experience in animation distribution, special effects production, and interactive art creation."})]}),M.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"20px",marginBottom:"40px",width:"100%"},children:[M.jsxs("div",{style:{background:l==="awards"?"rgba(255,255,255,0.08)":"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"15px",padding:"20px 25px",cursor:"pointer",transition:"all 0.3s ease",width:"100%",maxWidth:"800px"},onClick:()=>c(l==="awards"?null:"awards"),children:[M.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"15px",marginBottom:l==="awards"?"20px":"0"},children:[M.jsx("span",{style:{fontSize:"1.8rem"},children:"🏆"}),M.jsx("h3",{style:{fontSize:"1.3rem",fontWeight:"500",color:"white",margin:0,fontFamily:"'Inter', sans-serif"},children:"Awards & Recognition"}),M.jsx("span",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.5)",marginLeft:"auto",transform:l==="awards"?"rotate(180deg)":"rotate(0deg)",transition:"transform 0.3s ease"},children:"▼"})]}),l==="awards"&&M.jsxs("div",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.8)",lineHeight:"1.7",fontFamily:"'Inter', sans-serif"},children:[M.jsxs("div",{style:{marginBottom:"15px",paddingLeft:"15px",borderLeft:"3px solid rgba(255,255,255,0.3)"},children:[M.jsx("strong",{style:{color:"rgba(255,255,255,0.9)"},children:"The 14th National Exhibition of Fine Arts"}),M.jsx("br",{}),M.jsx("span",{style:{color:"rgba(255,255,255,0.6)",fontSize:"0.9rem"},children:"Nominated for Final | July 2024"}),M.jsx("br",{}),M.jsx("span",{style:{fontSize:"0.95rem"},children:"National level recognition for outstanding artistic achievement"})]}),M.jsxs("div",{style:{marginBottom:"15px",paddingLeft:"15px",borderLeft:"3px solid rgba(255,255,255,0.3)"},children:[M.jsx("strong",{style:{color:"rgba(255,255,255,0.9)"},children:"Busan International Art Festival"}),M.jsx("br",{}),M.jsx("span",{style:{color:"rgba(255,255,255,0.6)",fontSize:"0.9rem"},children:"Selected Award | December 2022"}),M.jsx("br",{}),M.jsx("span",{style:{fontSize:"0.95rem"},children:"International recognition for creative digital media work"})]}),M.jsxs("div",{style:{marginBottom:"15px",paddingLeft:"15px",borderLeft:"3px solid rgba(255,255,255,0.3)"},children:[M.jsx("strong",{style:{color:"rgba(255,255,255,0.9)"},children:"Sichuan Fine Arts Institute"}),M.jsx("br",{}),M.jsx("span",{style:{color:"rgba(255,255,255,0.6)",fontSize:"0.9rem"},children:"Second-class Scholarship | December 2022"}),M.jsx("br",{}),M.jsx("span",{style:{fontSize:"0.95rem"},children:"Academic excellence in Digital Media studies"})]}),M.jsxs("div",{style:{paddingLeft:"15px",borderLeft:"3px solid rgba(255,255,255,0.3)"},children:[M.jsx("strong",{style:{color:"rgba(255,255,255,0.9)"},children:"National Printmakers Exhibition"}),M.jsx("br",{}),M.jsx("span",{style:{color:"rgba(255,255,255,0.6)",fontSize:"0.9rem"},children:"Excellence Award | May 2021"}),M.jsx("br",{}),M.jsx("span",{style:{fontSize:"0.95rem"},children:"Recognition for outstanding printmaking artworks"})]})]})]}),M.jsxs("div",{style:{background:l==="experience"?"rgba(255,255,255,0.08)":"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"15px",padding:"20px 25px",cursor:"pointer",transition:"all 0.3s ease",width:"100%",maxWidth:"800px"},onClick:()=>c(l==="experience"?null:"experience"),children:[M.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"15px",marginBottom:l==="experience"?"20px":"0"},children:[M.jsx("span",{style:{fontSize:"1.8rem"},children:"💼"}),M.jsx("h3",{style:{fontSize:"1.3rem",fontWeight:"500",color:"white",margin:0,fontFamily:"'Inter', sans-serif"},children:"Experience & Education"}),M.jsx("span",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.5)",marginLeft:"auto",transform:l==="experience"?"rotate(180deg)":"rotate(0deg)",transition:"transform 0.3s ease"},children:"▼"})]}),l==="experience"&&M.jsxs("div",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.8)",lineHeight:"1.7",fontFamily:"'Inter', sans-serif"},children:[M.jsxs("div",{style:{marginBottom:"15px",paddingLeft:"15px",borderLeft:"3px solid rgba(255,255,255,0.3)"},children:[M.jsx("strong",{style:{color:"rgba(255,255,255,0.9)"},children:"MSc Innovative Multimedia Entertainment"}),M.jsx("br",{}),M.jsx("span",{style:{color:"rgba(255,255,255,0.6)",fontSize:"0.9rem"},children:"The Hong Kong Polytechnic University | 2025-2026 (Expected)"}),M.jsx("br",{}),M.jsx("span",{style:{fontSize:"0.95rem"},children:"Currently pursuing advanced studies in multimedia entertainment and digital innovation"})]}),M.jsxs("div",{style:{marginBottom:"15px",paddingLeft:"15px",borderLeft:"3px solid rgba(255,255,255,0.3)"},children:[M.jsx("strong",{style:{color:"rgba(255,255,255,0.9)"},children:"Bachelor in Digital Media"}),M.jsx("br",{}),M.jsx("span",{style:{color:"rgba(255,255,255,0.6)",fontSize:"0.9rem"},children:"Sichuan Fine Arts Institute | 2021-2025"}),M.jsx("br",{}),M.jsx("span",{style:{fontSize:"0.95rem"},children:"GPA: 3.67/5.0, Average Score: 86.75% - Focus on digital media arts and interactive design"})]}),M.jsxs("div",{style:{marginBottom:"15px",paddingLeft:"15px",borderLeft:"3px solid rgba(255,255,255,0.3)"},children:[M.jsx("strong",{style:{color:"rgba(255,255,255,0.9)"},children:"Assistant Director - Overseas Marketing"}),M.jsx("br",{}),M.jsx("span",{style:{color:"rgba(255,255,255,0.6)",fontSize:"0.9rem"},children:"Chongqing Jiazuo Film & TV Culture Media | August 2024"}),M.jsx("br",{}),M.jsx("span",{style:{fontSize:"0.95rem"},children:"Managed distribution of animated films in Latin America and coordinated TCL China Theatres project"})]}),M.jsxs("div",{style:{paddingLeft:"15px",borderLeft:"3px solid rgba(255,255,255,0.3)"},children:[M.jsx("strong",{style:{color:"rgba(255,255,255,0.9)"},children:"Special Effects Production Assistant"}),M.jsx("br",{}),M.jsx("span",{style:{color:"rgba(255,255,255,0.6)",fontSize:"0.9rem"},children:"Chongqing Yingsha Culture Communication | January 2024"}),M.jsx("br",{}),M.jsx("span",{style:{fontSize:"0.95rem"},children:"Assisted in post-production special effects for promotional films and commercials"})]})]})]}),M.jsxs("div",{style:{background:l==="contact"?"rgba(255,255,255,0.08)":"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"15px",padding:"20px 25px",cursor:"pointer",transition:"all 0.3s ease",width:"100%",maxWidth:"800px"},onClick:()=>c(l==="contact"?null:"contact"),children:[M.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"15px",marginBottom:l==="contact"?"20px":"0"},children:[M.jsx("span",{style:{fontSize:"1.8rem"},children:"�"}),M.jsx("h3",{style:{fontSize:"1.3rem",fontWeight:"500",color:"white",margin:0,fontFamily:"'Inter', sans-serif"},children:"Contact & Connect"}),M.jsx("span",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.5)",marginLeft:"auto",transform:l==="contact"?"rotate(180deg)":"rotate(0deg)",transition:"transform 0.3s ease"},children:"▼"})]}),l==="contact"&&M.jsxs("div",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.8)",lineHeight:"1.7",fontFamily:"'Inter', sans-serif"},children:[M.jsx("div",{style:{marginBottom:"20px"},children:M.jsx("p",{style:{margin:"0 0 15px 0",fontSize:"1rem",color:"rgba(255,255,255,0.9)"},children:"I'm always excited to collaborate on innovative projects that push the boundaries of digital art and technology."})}),M.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"12px"},children:[M.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px"},children:[M.jsx("span",{style:{fontSize:"1.2rem"},children:"✉️"}),M.jsx("a",{href:"mailto:megan_ouyang@163.com",style:{color:"rgba(255,255,255,0.9)",textDecoration:"none",fontSize:"1rem",fontWeight:"400"},children:"megan_ouyang@163.com"})]}),M.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px"},children:[M.jsx("span",{style:{fontSize:"1.2rem"},children:"💼"}),M.jsx("a",{href:"https://linkedin.com/in/xinran-ouyang",target:"_blank",rel:"noopener noreferrer",style:{color:"rgba(255,255,255,0.9)",textDecoration:"none",fontSize:"1rem",fontWeight:"400"},children:"LinkedIn Profile"})]}),M.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px"},children:[M.jsx("span",{style:{fontSize:"1.2rem"},children:"�"}),M.jsx("a",{href:"https://instagram.com/xinran.creative",target:"_blank",rel:"noopener noreferrer",style:{color:"rgba(255,255,255,0.9)",textDecoration:"none",fontSize:"1rem",fontWeight:"400"},children:"Instagram @xinran.creative"})]}),M.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px"},children:[M.jsx("span",{style:{fontSize:"1.2rem"},children:"📍"}),M.jsx("span",{style:{color:"rgba(255,255,255,0.8)",fontSize:"1rem"},children:"San Francisco Bay Area, CA"})]})]})]})]})]}),M.jsxs("div",{style:{marginBottom:"30px",display:"flex",flexDirection:"column",alignItems:"flex-start"},children:[M.jsx("h3",{style:{fontSize:"1.2rem",fontWeight:"500",margin:"0 0 15px 0",color:"white",fontFamily:"'Inter', sans-serif"},children:"Basic Information"}),M.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(250px, 1fr))",gap:"15px",width:"100%",maxWidth:"800px"},children:[M.jsxs("div",{style:{background:"rgba(255,255,255,0.05)",padding:"15px 20px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)"},children:[M.jsx("div",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.6)",marginBottom:"5px",fontFamily:"'Inter', sans-serif"},children:"Location"}),M.jsx("div",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.9)",fontFamily:"'Inter', sans-serif",fontWeight:"400"},children:"Hong Kong / Chongqing"})]}),M.jsxs("div",{style:{background:"rgba(255,255,255,0.05)",padding:"15px 20px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)"},children:[M.jsx("div",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.6)",marginBottom:"5px",fontFamily:"'Inter', sans-serif"},children:"Status"}),M.jsx("div",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.9)",fontFamily:"'Inter', sans-serif",fontWeight:"400"},children:"Graduate Student"})]}),M.jsxs("div",{style:{background:"rgba(255,255,255,0.05)",padding:"15px 20px",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.1)"},children:[M.jsx("div",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.6)",marginBottom:"5px",fontFamily:"'Inter', sans-serif"},children:"Focus"}),M.jsx("div",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.9)",fontFamily:"'Inter', sans-serif",fontWeight:"400"},children:"Digital Media & Entertainment"})]})]})]})]}),M.jsxs("div",{style:{flex:"1",display:"flex",flexDirection:"column",gap:"30px",paddingTop:"20px"},children:[M.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"20px",padding:"30px",fontFamily:"'Inter', sans-serif"},children:[M.jsxs("h3",{style:{fontSize:"1.4rem",fontWeight:"500",color:"white",margin:"0 0 25px 0",display:"flex",alignItems:"center",gap:"12px"},children:[M.jsx("span",{style:{fontSize:"1.8rem"},children:"🏆"}),"Achievements & Awards"]}),M.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(2, 1fr)",gap:"15px"},children:[{title:"The 14th National Exhibition of Fine Arts",year:"07/2024",description:"Nominated for Final in the 14th National Exhibition of Fine Arts, representing excellence in contemporary art and creative innovation on a national level.",color:"#FFD700"},{title:"EDA Oriental Lake District - Leading South",year:"05/2023",description:"Nominated for District Level recognition in the EDA Oriental Lake District - Leading South exhibition, showcasing outstanding artistic achievement in regional contemporary art.",color:"#00ff88"},{title:"Sichuan Fine Arts Institute - Second-class Scholarship",year:"12/2022",description:"Awarded Second-class Scholarship at Sichuan Fine Arts Institute for outstanding academic performance and artistic excellence in digital media arts program.",color:"#9999ff"},{title:"Busan International Art Festival 2022",year:"12/2022",description:"Selected Award recipient at the Busan International Art Festival 2022, recognized for innovative work in international contemporary art scene.",color:"#ff6b35"},{title:"Internet + Innovation Competition - Third Prize",year:"09/2022",description:"Third Prize winner in Sichuan Fine Arts Institute The 7th 'Internet +' Innovation and Entrepreneurship Competition for creative technology integration.",color:"#00ccff"},{title:"National Printmakers Exhibition - Excellence Award",year:"05/2021",description:"Excellence Award in National Printmakers and Young Children's Small Prints Invitation Exhibition, demonstrating mastery in traditional and contemporary printmaking techniques.",color:"#ff3366"}].map((D,W)=>M.jsxs("div",{style:{background:"rgba(255,255,255,0.04)",borderRadius:"12px",padding:"15px",border:"1px solid rgba(255,255,255,0.08)",borderLeft:`4px solid ${D.color}`,cursor:"pointer",transition:"all 0.3s ease",position:"relative",overflow:"hidden"},onMouseEnter:V=>{V.target.style.background="rgba(255,255,255,0.08)",V.target.style.transform="translateY(-2px)",V.target.style.borderColor="rgba(255,255,255,0.15)"},onMouseLeave:V=>{V.target.style.background="rgba(255,255,255,0.04)",V.target.style.transform="translateY(0)",V.target.style.borderColor="rgba(255,255,255,0.08)"},onClick:()=>{h("achievement"),t(D),setIsModalOpen(!0)},children:[M.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"8px"},children:[M.jsx("div",{style:{fontSize:"0.95rem",fontWeight:"600",color:"rgba(255,255,255,0.95)"},children:D.title}),M.jsx("div",{style:{fontSize:"0.75rem",color:D.color,fontWeight:"500",background:"rgba(255,255,255,0.1)",padding:"3px 10px",borderRadius:"15px"},children:D.year})]}),M.jsx("div",{style:{fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",lineHeight:"1.3",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:"Click to view details"}),M.jsx("div",{style:{position:"absolute",bottom:"8px",right:"12px",fontSize:"0.8rem",color:"rgba(255,255,255,0.4)",fontWeight:"300"},children:"↗"})]},W))})]}),M.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"20px",padding:"30px",fontFamily:"'Inter', sans-serif"},children:[M.jsxs("h3",{style:{fontSize:"1.4rem",fontWeight:"500",color:"white",margin:"0 0 25px 0",display:"flex",alignItems:"center",gap:"12px"},children:[M.jsx("span",{style:{fontSize:"1.8rem"},children:"🎮"}),"Game Interests & Experience"]}),M.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"15px"},children:[M.jsxs("div",{style:{background:"rgba(255,255,255,0.04)",borderRadius:"12px",padding:"20px",border:"1px solid rgba(255,255,255,0.08)",borderLeft:"4px solid #00ff88"},children:[M.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",marginBottom:"8px"},children:[M.jsx("span",{style:{fontSize:"1.2rem"},children:"💻"}),M.jsx("div",{style:{fontSize:"1rem",fontWeight:"600",color:"rgba(255,255,255,0.95)"},children:"Steam Gaming Collection"})]}),M.jsx("div",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.7)",lineHeight:"1.5"},children:"Own over 200 games on Steam, with particular passion for CRPGs such as Divinity: Original Sin 2 and Disco Elysium, demonstrating strong interest in narrative-driven and strategy-heavy titles."})]}),M.jsxs("div",{style:{background:"rgba(255,255,255,0.04)",borderRadius:"12px",padding:"20px",border:"1px solid rgba(255,255,255,0.08)",borderLeft:"4px solid #9999ff"},children:[M.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",marginBottom:"8px"},children:[M.jsx("span",{style:{fontSize:"1.2rem"},children:"🎲"}),M.jsx("div",{style:{fontSize:"1rem",fontWeight:"600",color:"rgba(255,255,255,0.95)"},children:"Board Game Expertise"})]}),M.jsx("div",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.7)",lineHeight:"1.5"},children:"Experienced board game player, having played over 100 different board games including heavy strategy titles like Brass: Birmingham and Ark Nova, reflecting analytical thinking and familiarity with complex rule systems."})]}),M.jsxs("div",{style:{background:"rgba(255,255,255,0.04)",borderRadius:"12px",padding:"20px",border:"1px solid rgba(255,255,255,0.08)",borderLeft:"4px solid #ff6b35"},children:[M.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",marginBottom:"8px"},children:[M.jsx("span",{style:{fontSize:"1.2rem"},children:"📱"}),M.jsx("div",{style:{fontSize:"1rem",fontWeight:"600",color:"rgba(255,255,255,0.95)"},children:"Competitive Mobile Gaming"})]}),M.jsx("div",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.7)",lineHeight:"1.5"},children:"Active mobile gamer with strong competitive performance; ranked top 3 in regional weapon leaderboard in CrossFire Mobile, demonstrating strategic thinking and precision skills."})]})]})]}),M.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"20px",padding:"30px",fontFamily:"'Inter', sans-serif"},children:[M.jsxs("h3",{style:{fontSize:"1.4rem",fontWeight:"500",color:"white",margin:"0 0 25px 0",display:"flex",alignItems:"center",gap:"12px"},children:[M.jsx("span",{style:{fontSize:"1.8rem"},children:"�"}),"Get In Touch"]}),M.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"15px"},children:[M.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px",padding:"12px 16px",background:"rgba(255,255,255,0.04)",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.08)",fontSize:"0.95rem",color:"rgba(255,255,255,0.8)"},children:[M.jsx("span",{children:"🇨🇳"}),M.jsx("span",{children:"+86 15723351973"})]}),M.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px",padding:"12px 16px",background:"rgba(255,255,255,0.04)",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.08)",fontSize:"0.95rem",color:"rgba(255,255,255,0.8)"},children:[M.jsx("span",{children:"🇭🇰"}),M.jsx("span",{children:"+852 84963034"})]}),M.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px",padding:"12px 16px",background:"rgba(255,255,255,0.04)",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.08)",fontSize:"0.95rem",color:"rgba(255,255,255,0.8)"},children:[M.jsx("span",{children:"📧"}),M.jsx("span",{children:"McKenzie.ouyang@gmail.com"})]})]})]}),M.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"20px",padding:"25px",fontFamily:"'Inter', sans-serif",textAlign:"center"},children:[M.jsx("div",{style:{fontSize:"2rem",marginBottom:"10px"},children:"�"}),M.jsx("div",{style:{fontSize:"1.1rem",fontWeight:"500",color:"white",marginBottom:"8px"},children:"Interest Focus"}),M.jsx("div",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.7)",lineHeight:"1.5"},children:"Passionate about game level design and technical art, exploring the intersection of gameplay mechanics and visual storytelling"})]})]})]})}),M.jsxs("section",{id:"showcase",style:{height:"100vh",width:"100vw",padding:"40px",background:"linear-gradient(135deg, #0a0a0a 0%, #1a1a1a 50%, #0a0a0a 100%)",display:"flex",alignItems:"center",justifyContent:"center",scrollSnapAlign:"start",scrollSnapStop:"always",overflow:"hidden",position:"relative"},children:[M.jsxs("div",{style:{flex:"1",display:"flex",flexDirection:"column",justifyContent:"center",padding:"0 80px",zIndex:2,maxWidth:"600px"},children:[M.jsxs("div",{style:{marginBottom:"40px",textAlign:"left"},children:[M.jsx("h2",{style:{fontSize:"clamp(2.5rem, 6vw, 4.5rem)",fontWeight:"200",margin:"0 0 15px 0",letterSpacing:"-0.02em",color:"white",fontFamily:"'Inter', sans-serif"},children:"3D Showcase"}),M.jsx("p",{style:{fontSize:"1.1rem",color:"rgba(255,255,255,0.7)",maxWidth:"500px",margin:"0",lineHeight:"1.5",fontFamily:"'Inter', sans-serif",fontWeight:"300"},children:"Interactive 3D models exploring form, movement, and digital materiality. Each piece responds to user interaction and demonstrates different aspects of computational geometry."})]}),M.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(2, 1fr)",gap:"20px",marginBottom:"30px"},children:[M.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"15px",padding:"15px",height:"200px",position:"relative",cursor:"pointer",transition:"all 0.3s ease"},onMouseEnter:D=>{D.target.style.background="rgba(255,255,255,0.06)",D.target.style.borderColor="rgba(255,255,255,0.2)",D.target.style.transform="translateY(-5px)"},onMouseLeave:D=>{D.target.style.background="rgba(255,255,255,0.03)",D.target.style.borderColor="rgba(255,255,255,0.1)",D.target.style.transform="translateY(0)"},children:[M.jsx(Er,{scale:1.2,position:[0,0,0],rotation:[.2,0,0],modelSize:1.5,rotationSpeed:.01,showWireframe:!1,color:65416,geometry:"sphere"}),M.jsx("div",{style:{position:"absolute",bottom:"10px",left:"15px",fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",fontFamily:"'Inter', sans-serif"},children:"Organic Sphere"})]}),M.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"15px",padding:"15px",height:"200px",position:"relative",cursor:"pointer",transition:"all 0.3s ease"},onMouseEnter:D=>{D.target.style.background="rgba(255,255,255,0.06)",D.target.style.borderColor="rgba(255,255,255,0.2)",D.target.style.transform="translateY(-5px)"},onMouseLeave:D=>{D.target.style.background="rgba(255,255,255,0.03)",D.target.style.borderColor="rgba(255,255,255,0.1)",D.target.style.transform="translateY(0)"},children:[M.jsx(Er,{scale:1.2,position:[0,0,0],rotation:[.3,.3,0],modelSize:1.3,rotationSpeed:.015,showWireframe:!0,color:16739179,geometry:"cube"}),M.jsx("div",{style:{position:"absolute",bottom:"10px",left:"15px",fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",fontFamily:"'Inter', sans-serif"},children:"Wireframe Cube"})]}),M.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"15px",padding:"15px",height:"200px",position:"relative",cursor:"pointer",transition:"all 0.3s ease"},onMouseEnter:D=>{D.target.style.background="rgba(255,255,255,0.06)",D.target.style.borderColor="rgba(255,255,255,0.2)",D.target.style.transform="translateY(-5px)"},onMouseLeave:D=>{D.target.style.background="rgba(255,255,255,0.03)",D.target.style.borderColor="rgba(255,255,255,0.1)",D.target.style.transform="translateY(0)"},children:[M.jsx(Er,{scale:1.2,position:[0,0,0],rotation:[.4,0,0],modelSize:1.4,rotationSpeed:.008,showWireframe:!1,color:5164484,geometry:"torus"}),M.jsx("div",{style:{position:"absolute",bottom:"10px",left:"15px",fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",fontFamily:"'Inter', sans-serif"},children:"Torus Ring"})]}),M.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"15px",padding:"15px",height:"200px",position:"relative",cursor:"pointer",transition:"all 0.3s ease"},onMouseEnter:D=>{D.target.style.background="rgba(255,255,255,0.06)",D.target.style.borderColor="rgba(255,255,255,0.2)",D.target.style.transform="translateY(-5px)"},onMouseLeave:D=>{D.target.style.background="rgba(255,255,255,0.03)",D.target.style.borderColor="rgba(255,255,255,0.1)",D.target.style.transform="translateY(0)"},children:[M.jsx(Er,{scale:1.2,position:[0,0,0],rotation:[0,0,0],modelSize:1.6,rotationSpeed:.012,showWireframe:!1,color:16754470,geometry:"cone"}),M.jsx("div",{style:{position:"absolute",bottom:"10px",left:"15px",fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",fontFamily:"'Inter', sans-serif"},children:"Geometric Cone"})]})]}),M.jsxs("div",{style:{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"12px",padding:"20px",marginBottom:"20px"},children:[M.jsx("h3",{style:{fontSize:"1.1rem",fontWeight:"500",color:"white",margin:"0 0 10px 0",fontFamily:"'Inter', sans-serif"},children:"🎯 Interactive Features"}),M.jsx("p",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.7)",margin:"0",lineHeight:"1.5",fontFamily:"'Inter', sans-serif"},children:"Each model features real-time rendering with WebGL, responsive mouse interactions, and procedural animations. Built with Three.js and React for seamless performance across devices."})]})]}),M.jsx("div",{style:{flex:"1",height:"100%",display:"flex",alignItems:"center",justifyContent:"center",position:"relative"},children:M.jsxs("div",{style:{width:"400px",height:"400px",background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"20px",overflow:"hidden",position:"relative"},children:[M.jsx(Er,{scale:2,position:[0,0,0],rotation:[.2,.3,0],modelSize:2.5,rotationSpeed:.005,showWireframe:!1,color:10233776,geometry:"icosahedron"}),M.jsxs("div",{style:{position:"absolute",bottom:"15px",left:"20px",right:"20px",textAlign:"center"},children:[M.jsx("h4",{style:{fontSize:"1.2rem",fontWeight:"500",color:"white",margin:"0 0 5px 0",fontFamily:"'Inter', sans-serif"},children:"Featured: Icosahedron"}),M.jsx("p",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.6)",margin:"0",fontFamily:"'Inter', sans-serif"},children:"Complex polyhedron with 20 triangular faces"})]})]})})]}),e&&M.jsx("div",{style:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",background:"rgba(0,0,0,0.9)",zIndex:2e3,display:"flex",alignItems:"center",justifyContent:"center",padding:"20px"},onClick:()=>t(null),children:M.jsxs("div",{style:{background:"#1a1a1a",borderRadius:"12px",maxWidth:"800px",maxHeight:"90vh",overflow:"auto",position:"relative"},onClick:D=>D.stopPropagation(),children:[M.jsx("button",{onClick:()=>t(null),style:{position:"absolute",top:"20px",right:"20px",background:"rgba(255,255,255,0.1)",border:"none",borderRadius:"50%",width:"40px",height:"40px",color:"white",fontSize:"20px",cursor:"pointer",zIndex:10},children:"×"}),M.jsx("img",{src:e.image,alt:e.title,style:{width:"100%",height:"400px",objectFit:"cover",borderRadius:"12px 12px 0 0"}}),M.jsxs("div",{style:{padding:"30px"},children:[M.jsxs("div",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.1em",marginBottom:"15px",textTransform:"uppercase",fontFamily:"'Inter', sans-serif"},children:[e.category," • ",e.year]}),M.jsx("h2",{style:{fontSize:"2rem",fontWeight:"500",margin:"0 0 20px 0",color:"white",fontFamily:"'Inter', sans-serif"},children:e.title}),M.jsx("p",{style:{fontSize:"1.1rem",lineHeight:"1.7",color:"rgba(255,255,255,0.8)",margin:"0 0 30px 0",fontFamily:"'Inter', sans-serif"},children:e.description}),e.gallery&&M.jsxs("div",{children:[M.jsx("h3",{style:{fontSize:"1.2rem",color:"white",marginBottom:"20px",fontFamily:"'Inter', sans-serif"},children:"Gallery"}),M.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(300px, 1fr))",gap:"25px"},children:e.gallery.map((D,W)=>M.jsx("img",{src:D,alt:`${e.title} ${W+1}`,style:{width:"100%",height:"auto",minHeight:"250px",objectFit:"contain",borderRadius:"12px",cursor:"pointer",transition:"transform 0.3s ease",border:"1px solid rgba(255, 255, 255, 0.1)",backgroundColor:"rgba(0,0,0,0.3)"},onMouseEnter:V=>{V.target.style.transform="scale(1.03)"},onMouseLeave:V=>{V.target.style.transform="scale(1)"}},W))})]})]})]})}),d&&M.jsxs("div",{style:{position:"fixed",left:f.x,top:f.y,width:"400px",maxHeight:"500px",background:"rgba(0,0,0,0.95)",backdropFilter:"blur(20px)",border:"1px solid rgba(255,255,255,0.2)",borderRadius:"12px",zIndex:2e3,overflow:"hidden",boxShadow:"0 20px 40px rgba(0,0,0,0.5)",userSelect:"none"},children:[M.jsxs("div",{style:{background:"rgba(255,255,255,0.1)",padding:"12px 16px",borderBottom:"1px solid rgba(255,255,255,0.1)",cursor:x?"grabbing":"grab",display:"flex",alignItems:"center",justifyContent:"space-between"},onMouseDown:E,children:[M.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[M.jsx("div",{style:{width:"12px",height:"12px",background:"#ff5f57",borderRadius:"50%"}}),M.jsx("div",{style:{width:"12px",height:"12px",background:"#ffbd2e",borderRadius:"50%"}}),M.jsx("div",{style:{width:"12px",height:"12px",background:"#28ca42",borderRadius:"50%"}})]}),M.jsxs("h3",{style:{color:"white",fontSize:"0.9rem",fontWeight:"500",margin:0,fontFamily:"'Inter', sans-serif"},children:[d==="about"&&"About Me",d==="education"&&"Education",d==="showcase"&&"3D Showcase",d==="awards"&&"Awards",d==="interests"&&"Interests",d==="skills"&&"Skills",d==="achievement"&&"Achievement Details"]}),M.jsx("button",{style:{background:"transparent",border:"none",color:"rgba(255,255,255,0.7)",fontSize:"16px",cursor:"pointer",padding:"4px",borderRadius:"4px",transition:"all 0.2s ease"},onClick:()=>h(null),onMouseEnter:D=>{D.target.style.background="rgba(255,255,255,0.1)",D.target.style.color="white"},onMouseLeave:D=>{D.target.style.background="transparent",D.target.style.color="rgba(255,255,255,0.7)"},children:"×"})]}),M.jsxs("div",{style:{padding:"20px",maxHeight:"420px",overflow:"auto",color:"white",fontFamily:"'Inter', sans-serif"},children:[d==="about"&&M.jsxs("div",{children:[M.jsx("div",{style:{fontSize:"2rem",textAlign:"center",marginBottom:"16px"},children:"👋"}),M.jsx("p",{style:{fontSize:"0.95rem",lineHeight:"1.6",color:"rgba(255,255,255,0.9)",margin:0},children:"I'm a digital artist and creative technologist passionate about exploring the intersection of art, technology, and human experience. My work focuses on creating immersive digital experiences that blur the boundaries between the virtual and physical worlds."})]}),d==="education"&&M.jsxs("div",{children:[M.jsx("div",{style:{fontSize:"2rem",textAlign:"center",marginBottom:"16px"},children:"🎓"}),M.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[M.jsxs("div",{children:[M.jsx("h4",{style:{fontSize:"1rem",fontWeight:"600",margin:"0 0 4px 0",color:"white"},children:"Master's in Digital Arts"}),M.jsx("p",{style:{fontSize:"0.85rem",color:"rgba(255,255,255,0.8)",margin:"0 0 2px 0"},children:"University of Arts"}),M.jsx("p",{style:{fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",margin:0},children:"2022-2024"})]}),M.jsxs("div",{children:[M.jsx("h4",{style:{fontSize:"1rem",fontWeight:"600",margin:"0 0 4px 0",color:"white"},children:"Bachelor's in Interactive Media"}),M.jsx("p",{style:{fontSize:"0.85rem",color:"rgba(255,255,255,0.8)",margin:"0 0 2px 0"},children:"Design Institute"}),M.jsx("p",{style:{fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",margin:0},children:"2018-2022"})]})]})]}),d==="showcase"&&M.jsxs("div",{children:[M.jsx("div",{style:{fontSize:"2rem",textAlign:"center",marginBottom:"16px"},children:"📫"}),M.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"12px"},children:[M.jsxs("div",{style:{background:"rgba(255,255,255,0.05)",padding:"12px",borderRadius:"8px",textAlign:"center"},children:[M.jsx("div",{style:{fontSize:"1.2rem",marginBottom:"4px"},children:"✉️"}),M.jsx("p",{style:{fontSize:"0.9rem",margin:0,color:"rgba(255,255,255,0.9)"},children:"McKenzie.ouyang@gmail.com"})]}),M.jsxs("div",{style:{display:"flex",gap:"8px"},children:[M.jsxs("div",{style:{background:"rgba(255,255,255,0.05)",padding:"10px",borderRadius:"8px",textAlign:"center",flex:1},children:[M.jsx("div",{style:{fontSize:"1rem",marginBottom:"2px"},children:"🇨🇳"}),M.jsx("p",{style:{fontSize:"0.8rem",margin:0,color:"rgba(255,255,255,0.8)"},children:"+86 15723351973"})]}),M.jsxs("div",{style:{background:"rgba(255,255,255,0.05)",padding:"10px",borderRadius:"8px",textAlign:"center",flex:1},children:[M.jsx("div",{style:{fontSize:"1rem",marginBottom:"2px"},children:"🇭🇰"}),M.jsx("p",{style:{fontSize:"0.8rem",margin:0,color:"rgba(255,255,255,0.8)"},children:"+852 84963034"})]})]})]})]}),d==="awards"&&M.jsxs("div",{children:[M.jsx("div",{style:{fontSize:"2rem",textAlign:"center",marginBottom:"16px"},children:"🏆"}),M.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"12px"},children:[M.jsxs("div",{style:{display:"flex",alignItems:"flex-start",gap:"8px"},children:[M.jsx("div",{style:{fontSize:"1.2rem"},children:"🥇"}),M.jsxs("div",{children:[M.jsx("h4",{style:{fontSize:"0.9rem",fontWeight:"600",margin:"0 0 2px 0"},children:"Digital Art Excellence Award"}),M.jsx("p",{style:{fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",margin:0},children:"National Arts Competition 2024"})]})]}),M.jsxs("div",{style:{display:"flex",alignItems:"flex-start",gap:"8px"},children:[M.jsx("div",{style:{fontSize:"1.2rem"},children:"🥈"}),M.jsxs("div",{children:[M.jsx("h4",{style:{fontSize:"0.9rem",fontWeight:"600",margin:"0 0 2px 0"},children:"Innovation in Interactive Media"}),M.jsx("p",{style:{fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",margin:0},children:"Tech Arts Festival 2023"})]})]})]})]}),d==="interests"&&M.jsxs("div",{children:[M.jsx("div",{style:{fontSize:"2rem",textAlign:"center",marginBottom:"16px"},children:"🎨"}),M.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"12px"},children:["3D Modeling","VR/AR","AI Art","Photography","Game Design","Motion Graphics"].map(D=>M.jsx("span",{style:{background:"rgba(255,255,255,0.1)",border:"1px solid rgba(255,255,255,0.2)",borderRadius:"12px",padding:"4px 8px",fontSize:"0.75rem",color:"rgba(255,255,255,0.9)"},children:D},D))}),M.jsx("p",{style:{fontSize:"0.85rem",lineHeight:"1.5",color:"rgba(255,255,255,0.8)",margin:0},children:"My creative journey spans multiple disciplines, always seeking new ways to merge traditional artforms with emerging technologies."})]}),d==="skills"&&M.jsxs("div",{children:[M.jsx("div",{style:{fontSize:"2rem",textAlign:"center",marginBottom:"16px"},children:"⚡"}),M.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[M.jsxs("div",{children:[M.jsx("h4",{style:{fontSize:"0.9rem",fontWeight:"600",marginBottom:"8px",color:"rgba(255,255,255,0.9)"},children:"Design & Creative"}),M.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:"6px"},children:["Digital Art","Visual Design","Installation Art","Motion Graphics"].map(D=>M.jsx("span",{style:{background:"rgba(255,255,255,0.08)",border:"1px solid rgba(255,255,255,0.15)",borderRadius:"10px",padding:"3px 8px",fontSize:"0.7rem",color:"rgba(255,255,255,0.8)"},children:D},D))})]}),M.jsxs("div",{children:[M.jsx("h4",{style:{fontSize:"0.9rem",fontWeight:"600",marginBottom:"8px",color:"rgba(255,255,255,0.9)"},children:"Technical"}),M.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:"6px"},children:["Creative Coding","Interactive Design","3D Modeling","VR/AR Development"].map(D=>M.jsx("span",{style:{background:"rgba(255,255,255,0.08)",border:"1px solid rgba(255,255,255,0.15)",borderRadius:"10px",padding:"3px 8px",fontSize:"0.7rem",color:"rgba(255,255,255,0.8)"},children:D},D))})]})]})]}),d==="achievement"&&e&&M.jsxs("div",{children:[M.jsx("div",{style:{fontSize:"2rem",textAlign:"center",marginBottom:"16px"},children:"🏆"}),M.jsxs("div",{style:{textAlign:"center",marginBottom:"20px"},children:[M.jsx("h2",{style:{fontSize:"1.3rem",fontWeight:"600",margin:"0 0 8px 0",color:"white",fontFamily:"'Inter', sans-serif"},children:e.title}),M.jsx("div",{style:{display:"inline-block",fontSize:"0.9rem",color:e.color,fontWeight:"500",background:"rgba(255,255,255,0.1)",padding:"6px 16px",borderRadius:"20px",border:`1px solid ${e.color}40`},children:e.year})]}),M.jsxs("div",{style:{background:"rgba(255,255,255,0.05)",borderRadius:"12px",padding:"20px",border:`2px solid ${e.color}40`,borderLeft:`4px solid ${e.color}`},children:[M.jsx("p",{style:{fontSize:"1rem",lineHeight:"1.6",color:"rgba(255,255,255,0.9)",margin:"0 0 16px 0",fontFamily:"'Inter', sans-serif"},children:e.description}),M.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",fontSize:"0.85rem",color:"rgba(255,255,255,0.7)"},children:[M.jsx("span",{style:{fontSize:"1rem"},children:"✨"}),"This achievement represents a significant milestone in my academic and creative journey."]})]})]})]})]})]})}pM.createRoot(document.getElementById("root")).render(M.jsx(Ae.StrictMode,{children:M.jsx(TA,{})}));
