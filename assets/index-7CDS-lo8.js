 ...
 */var vx=Symbol.for("react.transitional.element"),xx=Symbol.for("react.fragment");function Fg(e,t,n){var i=null;if(n!==void 0&&(i=""+n),t.key!==void 0&&(i=""+t.key),"key"in t){n={};for(var a in t)a!=="key"&&(n[a]=t[a])}else n=t;return t=n.ref,{$$typeof:vx,type:e,key:i,ref:t!==void 0?t:null,props:n}}Rc.Fragment=xx;Rc.jsx=Fg;Rc.jsxs=Fg;zg.exports=Rc;var rt=zg.exports,Hg={exports:{}},Ht={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        `})]}):l==="fluid"?rt.jsxs("div",{style:{position:"relative"},children:[rt.jsx("button",{onClick:()=>c("home"),style:{position:"fixed",top:"30px",left:"30px",zIndex:1e3,background:"rgba(255, 255, 255, 0.1)",border:"1px solid rgba(255, 255, 255, 0.3)",color:"white",padding:"12px 24px",borderRadius:"8px",cursor:"pointer",fontSize:"1rem",fontFamily:"'Inter', sans-serif",backdropFilter:"blur(10px)",transition:"all 0.3s ease"},onMouseEnter:m=>{m.target.style.background="rgba(255, 255, 255, 0.2)",m.target.style.borderColor="rgba(255, 255, 255, 0.5)"},onMouseLeave:m=>{m.target.style.background="rgba(255, 255, 255, 0.1)",m.target.style.borderColor="rgba(255, 255, 255, 0.3)"},children:"← Back to Portfolio"}),rt.jsx(bR,{})]}):rt.jsxs("div",{style:{width:"100vw",height:"100vh",background:"#000000",color:"white",margin:0,padding:0,overflow:"hidden auto",scrollSnapType:"y mandatory"},children:[rt.jsxs("section",{style:{minHeight:"100vh",height:"100vh",width:"100vw",padding:"40px",background:"linear-gradient(135deg, #000000 0%, #1a1a1a 50%, #000000 100%)",display:"flex",alignItems:"center",justifyContent:"space-between",position:"relative",scrollSnapAlign:"start",scrollSnapStop:"always",overflow:"hidden"},children:[rt.jsxs("div",{style:{flex:"1",display:"flex",flexDirection:"column",justifyContent:"center",padding:"0 80px",zIndex:2},children:[rt.jsx("h1",{style:{fontSize:"clamp(3rem, 6vw, 5rem)",fontWeight:"100",margin:"0 0 20px 0",letterSpacing:"-0.03em",lineHeight:"1.1",background:"linear-gradient(135deg, #ffffff 0%, #888888 100%)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",fontFamily:"'Inter', sans-serif"},children:"OYXR"}),rt.jsx("div",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.3em",marginBottom:"50px",textTransform:"uppercase",fontWeight:"300",fontFamily:"'Inter', sans-serif"},children:"Designer · Coder · Gamer · Occasional Reality Glitcher"}),rt.jsx("button",{onClick:()=>c("fluid"),style:{background:"rgba(255, 255, 255, 0.05)",border:"1px solid rgba(255, 255, 255, 0.2)",color:"rgba(255, 255, 255, 0.8)",padding:"15px 30px",borderRadius:"8px",cursor:"pointer",fontSize:"0.9rem",fontFamily:"'Inter', sans-serif",backdropFilter:"blur(10px)",transition:"all 0.3s ease",alignSelf:"flex-start",letterSpacing:"0.1em"},onMouseEnter:m=>{m.target.style.background="rgba(100, 120, 255, 0.2)",m.target.style.borderColor="rgba(100, 120, 255, 0.4)",m.target.style.color="rgba(255, 255, 255, 1)"},onMouseLeave:m=>{m.target.style.background="rgba(255, 255, 255, 0.05)",m.target.style.borderColor="rgba(255, 255, 255, 0.2)",m.target.style.color="rgba(255, 255, 255, 0.8)"},children:"🌊 FLUID PARTICLES"})]}),rt.jsxs("div",{style:{flex:"1",display:"flex",alignItems:"center",justifyContent:"flex-start",padding:"0 80px 0 20px",perspective:"1000px",position:"relative"},children:[rt.jsx("div",{style:{position:"absolute",top:"20%",right:"-100px",width:"300px",height:"300px",opacity:.3,zIndex:0,pointerEvents:"none"},children:rt.jsx(TR,{modelSize:1.5,rotationSpeed:.01,showWireframe:!0,color:4890367,geometry:"torus"})}),rt.jsxs("div",{style:{position:"relative",width:"100%",maxWidth:"700px",height:"400px",zIndex:1},children:[rt.jsx("div",{style:{position:"absolute",top:"50%",left:"50%",width:"600px",height:"300px",transform:`translate(-50%, -50%) rotateY(${n*-90}deg)`,transformStyle:"preserve-3d",transition:a?"transform 0.8s cubic-bezier(0.4, 0, 0.2, 1)":"none"},children:x.map((m,_)=>{const v=_*90,b=_===n;return rt.jsx("div",{style:{position:"absolute",width:"450px",height:"280px",top:"50%",left:"50%",transform:`translate(-50%, -50%) rotateY(${v}deg) translateZ(300px)`,transformStyle:"preserve-3d",cursor:"pointer",transition:"all 0.3s ease"},onClick:()=>t(m),children:rt.jsxs("div",{style:{width:"100%",height:"100%",background:"rgba(0,0,0,0.8)",borderRadius:"16px",border:b?"2px solid rgba(255,255,255,0.3)":"1px solid rgba(255,255,255,0.1)",overflow:"hidden",position:"relative",transform:b?"scale(1.05)":"scale(0.9)",opacity:b?1:.7,transition:"all 0.3s ease",boxShadow:b?"0 20px 40px rgba(0,0,0,0.5)":"0 10px 20px rgba(0,0,0,0.3)",display:"flex",padding:"20px",gap:"20px"},children:[rt.jsxs("div",{style:{flex:"2",display:"flex",alignItems:"center",justifyContent:"center",backgroundColor:"rgba(255,255,255,0.05)",borderRadius:"12px",overflow:"hidden"},children:[rt.jsx("img",{src:m.image,alt:m.title,style:{maxWidth:"100%",maxHeight:"100%",objectFit:"contain",borderRadius:"8px"},onError:C=>{C.target.style.display="none",C.target.nextSibling.style.display="flex"}}),rt.jsx("div",{style:{display:"none",alignItems:"center",justifyContent:"center",color:"rgba(255,255,255,0.6)",fontSize:"1rem",fontFamily:"'Inter', sans-serif",textAlign:"center",padding:"20px"},children:m.title})]}),rt.jsxs("div",{style:{flex:"1",display:"flex",flexDirection:"column",justifyContent:"center",padding:"10px 0"},children:[rt.jsxs("div",{style:{fontSize:"0.7rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.1em",marginBottom:"12px",textTransform:"uppercase",fontFamily:"'Inter', sans-serif"},children:[m.category," • ",m.year]}),rt.jsx("h3",{style:{fontSize:"1.1rem",fontWeight:"500",margin:"0",color:"white",letterSpacing:"-0.01em",fontFamily:"'Inter', sans-serif",lineHeight:"1.3"},children:m.title})]}),rt.jsx("div",{style:{position:"absolute",top:"15px",right:"15px",width:"30px",height:"30px",background:"rgba(0,0,0,0.7)",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",color:"white",fontSize:"14px",opacity:b?1:.7,border:"1px solid rgba(255,255,255,0.2)"},children:"↗"})]})},m.id)})}),rt.jsxs("div",{style:{position:"absolute",bottom:"-60px",left:"50%",transform:"translateX(-50%)",display:"flex",alignItems:"center",gap:"20px"},children:[rt.jsx("button",{onClick:()=>u("prev"),disabled:a,style:{width:"35px",height:"35px",border:"1px solid rgba(255,255,255,0.3)",background:"rgba(0,0,0,0.5)",color:"white",borderRadius:"50%",cursor:a?"not-allowed":"pointer",fontSize:"14px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s ease",opacity:a?.5:1},children:"←"}),rt.jsx("div",{style:{display:"flex",gap:"8px"},children:x.map((m,_)=>rt.jsx("div",{onClick:()=>{a||i(_)},style:{width:"8px",height:"8px",borderRadius:"50%",background:_===n?"rgba(255,255,255,0.8)":"rgba(255,255,255,0.3)",cursor:a?"not-allowed":"pointer",transition:"all 0.3s ease"}},_))}),rt.jsx("button",{onClick:()=>u("next"),disabled:a,style:{width:"35px",height:"35px",border:"1px solid rgba(255,255,255,0.3)",background:"rgba(0,0,0,0.5)",color:"white",borderRadius:"50%",cursor:a?"not-allowed":"pointer",fontSize:"14px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s ease",opacity:a?.5:1},children:"→"})]})]})]}),rt.jsx("div",{style:{position:"absolute",bottom:"40px",left:"50%",transform:"translateX(-50%)",color:"rgba(255,255,255,0.4)",fontSize:"0.8rem",letterSpacing:"0.1em",fontFamily:"'Inter', sans-serif"},children:"SCROLL TO EXPLORE"})]}),rt.jsxs("section",{id:"work",style:{height:"100vh",width:"100vw",padding:"40px",background:"linear-gradient(180deg, #000000 0%, #1a1a1a 50%, #000000 100%)",display:"flex",alignItems:"center",justifyContent:"center",scrollSnapAlign:"start",scrollSnapStop:"always",overflow:"hidden"},children:[rt.jsxs("div",{style:{width:"320px",display:"flex",flexDirection:"column",paddingRight:"40px"},children:[rt.jsxs("div",{style:{marginBottom:"40px"},children:[rt.jsx("h2",{style:{fontSize:"2.5rem",fontWeight:"300",margin:"0 0 15px 0",letterSpacing:"-0.02em",color:"white",fontFamily:"'Inter', sans-serif"},children:"Featured Work"}),rt.jsx("p",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.6)",margin:0,fontFamily:"'Inter', sans-serif",lineHeight:"1.6"},children:"A selection of recent projects exploring digital art and interactive experiences"})]}),rt.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"10px",flex:1,maxHeight:"calc(100vh - 200px)",overflowY:"auto"},children:S.map(m=>rt.jsxs("button",{onClick:()=>o(m.id),style:{background:s===m.id?"linear-gradient(135deg, #667eea 0%, #764ba2 100%)":"rgba(255, 255, 255, 0.05)",border:s===m.id?"none":"1px solid rgba(255, 255, 255, 0.1)",borderRadius:"12px",padding:"12px 16px",color:"white",fontSize:"0.9rem",fontWeight:"400",cursor:"pointer",transition:"all 0.3s ease",display:"flex",alignItems:"center",gap:"10px",textAlign:"left",fontFamily:"'Inter', sans-serif",transform:s===m.id?"translateX(5px)":"translateX(0)",boxShadow:s===m.id?"0 4px 15px rgba(102, 126, 234, 0.3)":"none"},onMouseEnter:_=>{s!==m.id&&(_.target.style.background="rgba(255, 255, 255, 0.1)",_.target.style.transform="translateX(3px)")},onMouseLeave:_=>{s!==m.id&&(_.target.style.background="rgba(255, 255, 255, 0.05)",_.target.style.transform="translateX(0)")},children:[rt.jsx("span",{style:{fontSize:"1.1rem"},children:m.icon}),rt.jsx("span",{children:m.name})]},m.id))})]}),rt.jsx("div",{style:{flex:1,display:"grid",gridTemplateColumns:"repeat(2, 1fr)",gridTemplateRows:"repeat(2, 1fr)",gap:"20px",height:"100%",overflow:"hidden"},children:g.map((m,_)=>rt.jsxs("div",{style:{background:"rgba(255,255,255,0.05)",borderRadius:"16px",border:"1px solid rgba(255,255,255,0.1)",overflow:"hidden",cursor:"pointer",transition:"all 0.4s cubic-bezier(0.4, 0, 0.2, 1)",transform:"translateY(0)",opacity:1,display:"flex",flexDirection:"column",height:"100%"},onClick:()=>t(m),onMouseEnter:v=>{v.target.style.transform="translateY(-8px)",v.target.style.borderColor="rgba(255,255,255,0.3)",v.target.style.boxShadow="0 20px 40px rgba(0,0,0,0.3)"},onMouseLeave:v=>{v.target.style.transform="translateY(0)",v.target.style.borderColor="rgba(255,255,255,0.1)",v.target.style.boxShadow="none"},children:[rt.jsxs("div",{style:{width:"100%",flex:"1",position:"relative",overflow:"hidden",backgroundColor:"rgba(0,0,0,0.8)",display:"flex",alignItems:"center",justifyContent:"center",minHeight:"180px"},children:[rt.jsx("img",{src:`${m.image}?v=${Date.now()}`,alt:m.title,style:{maxWidth:"100%",maxHeight:"100%",objectFit:"contain",transition:"transform 0.4s ease"},onError:v=>{v.target.style.display="none",v.target.nextSibling.style.display="flex"}}),rt.jsx("div",{style:{display:"none",alignItems:"center",justifyContent:"center",color:"rgba(255,255,255,0.6)",fontSize:"1.2rem",fontFamily:"'Inter', sans-serif",textAlign:"center",height:"100%"},children:m.title}),rt.jsx("div",{style:{position:"absolute",top:"12px",right:"12px",width:"32px",height:"32px",background:"rgba(0,0,0,0.7)",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",color:"white",fontSize:"14px",opacity:.8,transition:"all 0.3s ease"},children:"↗"})]}),rt.jsxs("div",{style:{padding:"12px 16px",background:"rgba(0,0,0,0.3)",borderTop:"1px solid rgba(255,255,255,0.1)"},children:[rt.jsxs("div",{style:{fontSize:"0.75rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.1em",marginBottom:"6px",textTransform:"uppercase",fontFamily:"'Inter', sans-serif"},children:[m.category," • ",m.year]}),rt.jsx("h3",{style:{fontSize:"1rem",fontWeight:"500",margin:"0",color:"white",letterSpacing:"-0.01em",fontFamily:"'Inter', sans-serif",lineHeight:"1.3"},children:m.title})]})]},m.id))})]}),e&&rt.jsx("div",{style:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",background:"rgba(0,0,0,0.9)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:1e3,padding:"20px"},onClick:()=>t(null),children:rt.jsxs("div",{style:{position:"relative",maxWidth:"90vw",maxHeight:"90vh",background:"#1a1a1a",borderRadius:"20px",overflow:"hidden",boxShadow:"0 25px 50px rgba(0,0,0,0.5)"},onClick:m=>m.stopPropagation(),children:[rt.jsx("button",{onClick:()=>t(null),style:{position:"absolute",top:"15px",right:"15px",background:"rgba(255,255,255,0.1)",border:"none",color:"white",fontSize:"1.5rem",padding:"10px",borderRadius:"50%",cursor:"pointer",zIndex:10,transition:"all 0.3s ease"},onMouseEnter:m=>{m.target.style.background="rgba(255,255,255,0.2)"},onMouseLeave:m=>{m.target.style.background="rgba(255,255,255,0.1)"},children:"×"}),rt.jsxs("div",{style:{display:"flex",flexDirection:"row",maxHeight:"90vh",overflow:"hidden"},children:[rt.jsxs("div",{style:{flex:"1.5",position:"relative",minHeight:"500px",background:"#0a0a0a"},children:[rt.jsx("img",{src:e.gallery[n],alt:e.title,style:{width:"100%",height:"100%",objectFit:"cover"}}),e.gallery.length>1&&rt.jsxs(rt.Fragment,{children:[rt.jsx("button",{onClick:()=>i(n>0?n-1:e.gallery.length-1),style:{position:"absolute",left:"15px",top:"50%",transform:"translateY(-50%)",background:"rgba(0,0,0,0.5)",border:"none",color:"white",fontSize:"1.5rem",padding:"15px 20px",borderRadius:"50%",cursor:"pointer",transition:"all 0.3s ease"},onMouseEnter:m=>{m.target.style.background="rgba(0,0,0,0.7)"},onMouseLeave:m=>{m.target.style.background="rgba(0,0,0,0.5)"},children:"‹"}),rt.jsx("button",{onClick:()=>i(n<e.gallery.length-1?n+1:0),style:{position:"absolute",right:"15px",top:"50%",transform:"translateY(-50%)",background:"rgba(0,0,0,0.5)",border:"none",color:"white",fontSize:"1.5rem",padding:"15px 20px",borderRadius:"50%",cursor:"pointer",transition:"all 0.3s ease"},onMouseEnter:m=>{m.target.style.background="rgba(0,0,0,0.7)"},onMouseLeave:m=>{m.target.style.background="rgba(0,0,0,0.5)"},children:"›"})]}),rt.jsxs("div",{style:{position:"absolute",bottom:"15px",left:"50%",transform:"translateX(-50%)",background:"rgba(0,0,0,0.7)",color:"white",padding:"8px 16px",borderRadius:"20px",fontSize:"0.85rem",fontFamily:"'Inter', sans-serif"},children:[n+1," / ",e.gallery.length]})]}),rt.jsxs("div",{style:{flex:"1",padding:"40px",display:"flex",flexDirection:"column",justifyContent:"flex-start"},children:[rt.jsxs("div",{style:{marginBottom:"20px"},children:[rt.jsxs("div",{style:{fontSize:"0.85rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.1em",marginBottom:"8px",textTransform:"uppercase",fontFamily:"'Inter', sans-serif"},children:[e.category," • ",e.year]}),rt.jsx("h1",{style:{fontSize:"2.5rem",fontWeight:"200",margin:"0 0 15px 0",color:"white",fontFamily:"'Inter', sans-serif"},children:e.title}),rt.jsx("p",{style:{fontSize:"1rem",lineHeight:"1.6",color:"rgba(255,255,255,0.8)",margin:"0 0 30px 0",fontFamily:"'Inter', sans-serif"},children:e.description})]}),rt.jsxs("div",{style:{marginBottom:"30px"},children:[rt.jsx("h3",{style:{fontSize:"1rem",fontWeight:"500",margin:"0 0 12px 0",color:"rgba(255,255,255,0.8)",letterSpacing:"0.05em",textTransform:"uppercase",fontFamily:"'Inter', sans-serif"},children:"Tools Used"}),rt.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:"8px"},children:e.software.map((m,_)=>{const v=S.find(b=>b.id===m);return rt.jsxs("span",{style:{padding:"6px 12px",background:"rgba(255,255,255,0.1)",borderRadius:"15px",fontSize:"0.8rem",color:"rgba(255,255,255,0.8)",fontFamily:"'Inter', sans-serif",display:"flex",alignItems:"center",gap:"6px"},children:[v==null?void 0:v.icon," ",(v==null?void 0:v.name)||m]},_)})})]})]})]})]})})]})}dM.createRoot(document.getElementById("root")).render(rt.jsx(be.StrictMode,{children:rt.jsx(AR,{})}));
