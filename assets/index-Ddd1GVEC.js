...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        `})]}):R.jsxs("div",{style:{width:"100vw",height:"100vh",background:"#000000",color:"white",margin:0,padding:0,overflow:"hidden auto",scrollSnapType:"y mandatory"},children:[R.jsxs("section",{style:{minHeight:"100vh",height:"100vh",width:"100vw",padding:"40px",background:"linear-gradient(135deg, #000000 0%, #1a1a1a 50%, #000000 100%)",display:"flex",alignItems:"center",justifyContent:"space-between",position:"relative",scrollSnapAlign:"start",scrollSnapStop:"always",overflow:"hidden"},children:[R.jsxs("div",{style:{flex:"1",display:"flex",flexDirection:"column",justifyContent:"center",padding:"0 80px",zIndex:2},children:[R.jsxs("div",{style:{marginBottom:"40px",display:"flex",alignItems:"center",gap:"15px"},children:[R.jsx("img",{src:"/Personal-Website/images/logo111.svg",alt:"OYXR Logo",style:{width:"60px",height:"60px",filter:"invert(1)",opacity:.9,backgroundColor:"white",borderRadius:"50%",padding:"8px",border:"2px solid rgba(255,255,255,0.8)"}}),R.jsx("div",{style:{fontSize:"1.5rem",fontWeight:"300",color:"white",letterSpacing:"0.1em",fontFamily:"'Inter', sans-serif"},children:"OYXR"})]}),R.jsx("div",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.3em",marginBottom:"30px",textTransform:"uppercase",fontWeight:"300",fontFamily:"'Inter', sans-serif"},children:"Digital Artist & Creative Technologist"}),R.jsxs("h1",{style:{fontSize:"clamp(2rem, 4vw, 3.5rem)",fontWeight:"100",margin:"0 0 30px 0",letterSpacing:"-0.03em",lineHeight:"1.1",background:"linear-gradient(135deg, #ffffff 0%, #888888 100%)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",fontFamily:"'Inter', sans-serif"},children:["Xinran",R.jsx("br",{}),"Ouyang"]}),R.jsx("p",{style:{fontSize:"clamp(1rem, 2vw, 1.2rem)",lineHeight:"1.6",color:"rgba(255,255,255,0.7)",fontWeight:"300",maxWidth:"500px",margin:"0 0 50px 0",fontFamily:"'Inter', sans-serif"},children:"Exploring the intersection of technology, creativity, and human experience through immersive digital art and interactive installations."}),R.jsxs("div",{style:{display:"flex",gap:"20px",flexWrap:"wrap"},children:[R.jsx("button",{style:{background:"white",color:"black",border:"none",padding:"16px 32px",fontSize:"0.95rem",fontWeight:"500",letterSpacing:"0.05em",cursor:"pointer",transition:"all 0.3s ease",fontFamily:"'Inter', sans-serif",textTransform:"uppercase"},onMouseEnter:T=>{T.target.style.background="rgba(255,255,255,0.9)",T.target.style.transform="translateY(-2px)"},onMouseLeave:T=>{T.target.style.background="white",T.target.style.transform="translateY(0)"},onClick:()=>document.getElementById("work").scrollIntoView({behavior:"smooth"}),children:"View Work"}),R.jsx("button",{style:{background:"transparent",color:"white",border:"1px solid rgba(255,255,255,0.3)",padding:"16px 32px",fontSize:"0.95rem",fontWeight:"400",letterSpacing:"0.05em",cursor:"pointer",transition:"all 0.3s ease",fontFamily:"'Inter', sans-serif",textTransform:"uppercase"},onMouseEnter:T=>{T.target.style.borderColor="white",T.target.style.background="rgba(255,255,255,0.1)"},onMouseLeave:T=>{T.target.style.borderColor="rgba(255,255,255,0.3)",T.target.style.background="transparent"},onClick:()=>document.getElementById("about").scrollIntoView({behavior:"smooth"}),children:"About"})]})]}),R.jsxs("div",{style:{flex:"1",display:"flex",alignItems:"center",justifyContent:"flex-start",padding:"0 80px 0 20px",perspective:"1000px",position:"relative"},children:[R.jsx("div",{style:{position:"absolute",top:"20%",right:"-100px",width:"300px",height:"300px",opacity:.3,zIndex:0,pointerEvents:"none"},children:R.jsx(Dl,{modelSize:1.5,rotationSpeed:.01,showWireframe:!0,color:4890367,geometry:"torus"})}),R.jsxs("div",{style:{position:"relative",width:"100%",maxWidth:"700px",height:"400px",zIndex:1},children:[R.jsx("div",{style:{position:"absolute",top:"50%",left:"50%",width:"600px",height:"300px",transform:`translate(-50%, -50%) rotateY(${n*-90}deg)`,transformStyle:"preserve-3d",transition:a?"transform 0.8s cubic-bezier(0.4, 0, 0.2, 1)":"none"},children:D.map((T,V)=>{const j=V*90,P=V===n;return R.jsx("div",{style:{position:"absolute",width:"450px",height:"280px",top:"50%",left:"50%",transform:`translate(-50%, -50%) rotateY(${j}deg) translateZ(300px)`,transformStyle:"preserve-3d",cursor:"pointer",transition:"all 0.3s ease"},onClick:()=>t(T),children:R.jsxs("div",{style:{width:"100%",height:"100%",background:"rgba(0,0,0,0.8)",borderRadius:"16px",border:P?"2px solid rgba(255,255,255,0.3)":"1px solid rgba(255,255,255,0.1)",overflow:"hidden",position:"relative",transform:P?"scale(1.05)":"scale(0.9)",opacity:P?1:.7,transition:"all 0.3s ease",boxShadow:P?"0 20px 40px rgba(0,0,0,0.5)":"0 10px 20px rgba(0,0,0,0.3)",display:"flex",padding:"20px",gap:"20px"},children:[R.jsxs("div",{style:{flex:"2",display:"flex",alignItems:"center",justifyContent:"center",backgroundColor:"rgba(255,255,255,0.05)",borderRadius:"12px",overflow:"hidden"},children:[R.jsx("img",{src:T.image,alt:T.title,style:{maxWidth:"100%",maxHeight:"100%",objectFit:"contain",borderRadius:"8px"},onError:W=>{W.target.style.display="none",W.target.nextSibling.style.display="flex"}}),R.jsx("div",{style:{display:"none",alignItems:"center",justifyContent:"center",color:"rgba(255,255,255,0.6)",fontSize:"1rem",fontFamily:"'Inter', sans-serif",textAlign:"center",padding:"20px"},children:T.title})]}),R.jsxs("div",{style:{flex:"1",display:"flex",flexDirection:"column",justifyContent:"center",padding:"10px 0"},children:[R.jsxs("div",{style:{fontSize:"0.7rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.1em",marginBottom:"12px",textTransform:"uppercase",fontFamily:"'Inter', sans-serif"},children:[T.category," • ",T.year]}),R.jsx("h3",{style:{fontSize:"1.1rem",fontWeight:"500",margin:"0",color:"white",letterSpacing:"-0.01em",fontFamily:"'Inter', sans-serif",lineHeight:"1.3"},children:T.title})]}),R.jsx("div",{style:{position:"absolute",top:"15px",right:"15px",width:"30px",height:"30px",background:"rgba(0,0,0,0.7)",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",color:"white",fontSize:"14px",opacity:P?1:.7,border:"1px solid rgba(255,255,255,0.2)"},children:"↗"})]})},T.id)})}),R.jsxs("div",{style:{position:"absolute",bottom:"-60px",left:"50%",transform:"translateX(-50%)",display:"flex",alignItems:"center",gap:"20px"},children:[R.jsx("button",{onClick:()=>b("prev"),disabled:a,style:{width:"35px",height:"35px",border:"1px solid rgba(255,255,255,0.3)",background:"rgba(0,0,0,0.5)",color:"white",borderRadius:"50%",cursor:a?"not-allowed":"pointer",fontSize:"14px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s ease",opacity:a?.5:1},children:"←"}),R.jsx("div",{style:{display:"flex",gap:"8px"},children:D.map((T,V)=>R.jsx("div",{onClick:()=>{a||i(V)},style:{width:"8px",height:"8px",borderRadius:"50%",background:V===n?"rgba(255,255,255,0.8)":"rgba(255,255,255,0.3)",cursor:a?"not-allowed":"pointer",transition:"all 0.3s ease"}},V))}),R.jsx("button",{onClick:()=>b("next"),disabled:a,style:{width:"35px",height:"35px",border:"1px solid rgba(255,255,255,0.3)",background:"rgba(0,0,0,0.5)",color:"white",borderRadius:"50%",cursor:a?"not-allowed":"pointer",fontSize:"14px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s ease",opacity:a?.5:1},children:"→"})]})]})]}),R.jsx("div",{style:{position:"absolute",bottom:"40px",left:"50%",transform:"translateX(-50%)",color:"rgba(255,255,255,0.4)",fontSize:"0.8rem",letterSpacing:"0.1em",fontFamily:"'Inter', sans-serif"},children:"SCROLL TO EXPLORE"})]}),R.jsxs("section",{id:"work",style:{height:"100vh",width:"100vw",padding:"40px",background:"linear-gradient(180deg, #000000 0%, #1a1a1a 50%, #000000 100%)",display:"flex",alignItems:"center",justifyContent:"center",scrollSnapAlign:"start",scrollSnapStop:"always",overflow:"hidden"},children:[R.jsxs("div",{style:{width:"320px",display:"flex",flexDirection:"column",paddingRight:"40px"},children:[R.jsxs("div",{style:{marginBottom:"40px"},children:[R.jsx("h2",{style:{fontSize:"2.5rem",fontWeight:"300",margin:"0 0 15px 0",letterSpacing:"-0.02em",color:"white",fontFamily:"'Inter', sans-serif"},children:"Featured Work"}),R.jsx("p",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.6)",margin:0,fontFamily:"'Inter', sans-serif",lineHeight:"1.6"},children:"A selection of recent projects exploring digital art and interactive experiences"})]}),R.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"10px",flex:1,maxHeight:"calc(100vh - 200px)",overflowY:"auto"},children:C.map(T=>R.jsxs("button",{onClick:()=>o(T.id),style:{background:s===T.id?"linear-gradient(135deg, #667eea 0%, #764ba2 100%)":"rgba(255, 255, 255, 0.05)",border:s===T.id?"none":"1px solid rgba(255, 255, 255, 0.1)",borderRadius:"12px",padding:"12px 16px",color:"white",fontSize:"0.9rem",fontWeight:"400",cursor:"pointer",transition:"all 0.3s ease",display:"flex",alignItems:"center",gap:"10px",textAlign:"left",fontFamily:"'Inter', sans-serif",transform:s===T.id?"translateX(5px)":"translateX(0)",boxShadow:s===T.id?"0 4px 15px rgba(102, 126, 234, 0.3)":"none"},onMouseEnter:V=>{s!==T.id&&(V.target.style.background="rgba(255, 255, 255, 0.1)",V.target.style.transform="translateX(3px)")},onMouseLeave:V=>{s!==T.id&&(V.target.style.background="rgba(255, 255, 255, 0.05)",V.target.style.transform="translateX(0)")},children:[R.jsx("span",{style:{fontSize:"1.1rem"},children:T.icon}),R.jsx("span",{children:T.name})]},T.id))})]}),R.jsx("div",{style:{flex:1,display:"grid",gridTemplateColumns:"repeat(2, 1fr)",gridTemplateRows:"repeat(2, 1fr)",gap:"20px",height:"100%",overflow:"hidden"},children:L.map((T,V)=>R.jsxs("div",{style:{background:"rgba(255,255,255,0.05)",borderRadius:"16px",border:"1px solid rgba(255,255,255,0.1)",overflow:"hidden",cursor:"pointer",transition:"all 0.4s cubic-bezier(0.4, 0, 0.2, 1)",transform:"translateY(0)",opacity:1,display:"flex",flexDirection:"column",height:"100%"},onClick:()=>t(T),onMouseEnter:j=>{j.target.style.transform="translateY(-8px)",j.target.style.borderColor="rgba(255,255,255,0.3)",j.target.style.boxShadow="0 20px 40px rgba(0,0,0,0.3)"},onMouseLeave:j=>{j.target.style.transform="translateY(0)",j.target.style.borderColor="rgba(255,255,255,0.1)",j.target.style.boxShadow="none"},children:[R.jsxs("div",{style:{width:"100%",flex:"1",position:"relative",overflow:"hidden",backgroundColor:"rgba(0,0,0,0.8)",display:"flex",alignItems:"center",justifyContent:"center",minHeight:"180px"},children:[R.jsx("img",{src:`${T.image}?v=${Date.now()}`,alt:T.title,style:{maxWidth:"100%",maxHeight:"100%",objectFit:"contain",transition:"transform 0.4s ease"},onError:j=>{j.target.style.display="none",j.target.nextSibling.style.display="flex"}}),R.jsx("div",{style:{display:"none",alignItems:"center",justifyContent:"center",color:"rgba(255,255,255,0.6)",fontSize:"1.2rem",fontFamily:"'Inter', sans-serif",textAlign:"center",height:"100%"},children:T.title}),R.jsx("div",{style:{position:"absolute",top:"12px",right:"12px",width:"32px",height:"32px",background:"rgba(0,0,0,0.7)",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",color:"white",fontSize:"14px",opacity:.8,transition:"all 0.3s ease"},children:"↗"})]}),R.jsxs("div",{style:{padding:"12px 16px",background:"rgba(0,0,0,0.3)",borderTop:"1px solid rgba(255,255,255,0.1)"},children:[R.jsxs("div",{style:{fontSize:"0.75rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.1em",marginBottom:"6px",textTransform:"uppercase",fontFamily:"'Inter', sans-serif"},children:[T.category," • ",T.year]}),R.jsx("h3",{style:{fontSize:"1rem",fontWeight:"500",margin:"0",color:"white",letterSpacing:"-0.01em",fontFamily:"'Inter', sans-serif",lineHeight:"1.3"},children:T.title})]})]},T.id))})]}),R.jsx("section",{id:"about",style:{height:"100vh",width:"100vw",padding:"40px",background:"linear-gradient(135deg, #0a0a0a 0%, #1a1a1a 50%, #0a0a0a 100%)",display:"flex",alignItems:"center",justifyContent:"space-between",scrollSnapAlign:"start",scrollSnapStop:"always",overflow:"hidden",position:"relative"},children:R.jsxs("div",{style:{flex:"1",display:"flex",flexDirection:"column",justifyContent:"center",padding:"0 80px",zIndex:2,maxWidth:"600px"},children:[R.jsxs("div",{style:{width:"100%",textAlign:"left"},children:[R.jsxs("div",{style:{display:"flex",alignItems:"flex-start",gap:"20px",marginBottom:"30px"},children:[R.jsx("div",{style:{flexShrink:0},children:R.jsxs("div",{style:{width:"120px",height:"120px",borderRadius:"50%",background:"rgba(255,255,255,0.05)",border:"2px solid rgba(255,255,255,0.1)",overflow:"hidden",position:"relative",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s ease"},children:[R.jsx("span",{style:{fontSize:"2rem",color:"rgba(255,255,255,0.4)"},children:"👤"}),R.jsx("img",{src:"/Personal-Website/images/xinran-photo.jpg?v=2025100909",alt:"Xinran Ouyang",style:{width:"100%",height:"100%",objectFit:"cover",position:"absolute",top:0,left:0,opacity:0},onLoad:T=>{T.target.style.opacity=1},onError:T=>{T.target.style.display="none"}})]})}),R.jsxs("div",{children:[R.jsx("div",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.3em",marginBottom:"15px",textTransform:"uppercase",fontWeight:"300",fontFamily:"'Inter', sans-serif"},children:"Digital Artist & Creative Technologist"}),R.jsx("h2",{style:{fontSize:"clamp(2.5rem, 5vw, 4rem)",fontWeight:"100",margin:"0 0 10px 0",letterSpacing:"-0.03em",lineHeight:"1.1",background:"linear-gradient(135deg, #ffffff 0%, #888888 100%)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",fontFamily:"'Inter', sans-serif"},children:"About Me"}),R.jsx("div",{style:{fontSize:"1.1rem",color:"rgba(255,255,255,0.7)",fontFamily:"'Inter', sans-serif",fontWeight:"300"},children:"Xinran Ouyang"})]})]}),R.jsxs("div",{style:{marginBottom:"30px",textAlign:"left",maxWidth:"800px"},children:[R.jsx("p",{style:{fontSize:"clamp(1rem, 2vw, 1.2rem)",lineHeight:"1.6",color:"rgba(255,255,255,0.8)",margin:"0 0 15px 0",fontFamily:"'Inter', sans-serif",fontWeight:"300"},children:"I'm a digital artist and creative technologist passionate about exploring the intersection of art, technology, and human experience."}),R.jsx("p",{style:{fontSize:"1rem",lineHeight:"1.6",color:"rgba(255,255,255,0.7)",margin:0,fontFamily:"'Inter', sans-serif",fontWeight:"300"},children:"My work focuses on creating immersive digital experiences that blur the boundaries between the virtual and physical worlds, always seeking to create meaningful connections through innovative technology."})]}),R.jsxs("div",{style:{display:"flex",gap:"15px",marginBottom:"30px",justifyContent:"flex-start",flexWrap:"wrap"},children:[R.jsxs("div",{style:{background:l==="education"?"rgba(255,255,255,0.08)":"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"12px",padding:"15px 20px",cursor:"pointer",transition:"all 0.3s ease",minWidth:"200px",maxWidth:"250px"},onClick:()=>c(l==="education"?null:"education"),children:[R.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px",marginBottom:l==="education"?"16px":"0"},children:[R.jsx("span",{style:{fontSize:"1.5rem"},children:"🎓"}),R.jsx("h3",{style:{fontSize:"1.1rem",fontWeight:"500",color:"white",margin:0,fontFamily:"'Inter', sans-serif"},children:"Education"}),R.jsx("span",{style:{fontSize:"0.8rem",color:"rgba(255,255,255,0.5)",marginLeft:"auto",transform:l==="education"?"rotate(180deg)":"rotate(0deg)",transition:"transform 0.3s ease"},children:"▼"})]}),l==="education"&&R.jsxs("div",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.8)",lineHeight:"1.6",fontFamily:"'Inter', sans-serif"},children:[R.jsxs("div",{style:{marginBottom:"10px"},children:[R.jsx("strong",{children:"Master's in Digital Arts"}),R.jsx("br",{}),"University of Arts | 2022-2024"]}),R.jsxs("div",{children:[R.jsx("strong",{children:"Bachelor's in Interactive Media"}),R.jsx("br",{}),"Design Institute | 2018-2022"]})]})]}),R.jsxs("div",{style:{background:l==="interests"?"rgba(255,255,255,0.08)":"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"12px",padding:"15px 20px",cursor:"pointer",transition:"all 0.3s ease",minWidth:"200px",maxWidth:"250px"},onClick:()=>c(l==="interests"?null:"interests"),children:[R.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px",marginBottom:l==="interests"?"16px":"0"},children:[R.jsx("span",{style:{fontSize:"1.5rem"},children:"💫"}),R.jsx("h3",{style:{fontSize:"1.1rem",fontWeight:"500",color:"white",margin:0,fontFamily:"'Inter', sans-serif"},children:"Interests"}),R.jsx("span",{style:{fontSize:"0.8rem",color:"rgba(255,255,255,0.5)",marginLeft:"auto",transform:l==="interests"?"rotate(180deg)":"rotate(0deg)",transition:"transform 0.3s ease"},children:"▼"})]}),l==="interests"&&R.jsxs("div",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.8)",lineHeight:"1.6",fontFamily:"'Inter', sans-serif"},children:[R.jsx("div",{style:{marginBottom:"6px"},children:"🎨 Digital Art & Animation"}),R.jsx("div",{style:{marginBottom:"6px"},children:"🤖 AI & Machine Learning"}),R.jsx("div",{style:{marginBottom:"6px"},children:"🎮 Interactive Experience Design"}),R.jsx("div",{children:"🎵 Electronic Music Production"})]})]})]}),R.jsxs("div",{style:{marginBottom:"30px",display:"flex",flexDirection:"column",alignItems:"flex-start"},children:[R.jsx("h3",{style:{fontSize:"1.2rem",fontWeight:"500",margin:"0 0 15px 0",color:"white",fontFamily:"'Inter', sans-serif"},children:"Skills & Tools"}),R.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:"12px",justifyContent:"flex-start",maxWidth:"600px"},children:["Digital Art","Interactive Design","Creative Coding","Installation Art","Visual Design","Creative Direction"].map((T,V)=>R.jsx("span",{style:{padding:"8px 16px",background:"rgba(255,255,255,0.1)",borderRadius:"20px",fontSize:"0.9rem",color:"rgba(255,255,255,0.8)",fontFamily:"'Inter', sans-serif",border:"1px solid rgba(255,255,255,0.2)"},children:T},V))})]}),R.jsxs("div",{style:{marginBottom:"30px",display:"flex",flexDirection:"column",alignItems:"flex-start"},children:[R.jsx("h3",{style:{fontSize:"1.2rem",fontWeight:"500",margin:"0 0 15px 0",color:"white",fontFamily:"'Inter', sans-serif"},children:"3D Showcase"}),R.jsxs("div",{style:{width:"100%",maxWidth:"400px",height:"250px",background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"15px",overflow:"hidden",position:"relative"},children:[R.jsx(Dl,{scale:1.5,position:[0,0,0],rotation:[.2,0,0],modelSize:1.8,rotationSpeed:.015,showWireframe:!1,color:65416,geometry:"sphere"}),R.jsx("div",{style:{position:"absolute",bottom:"10px",left:"15px",fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",fontFamily:"'Inter', sans-serif"},children:"Interactive 3D Model"})]})]}),R.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"flex-start"},children:[R.jsx("h3",{style:{fontSize:"1.2rem",fontWeight:"500",margin:"0 0 15px 0",color:"white",fontFamily:"'Inter', sans-serif"},children:"Get in Touch"}),R.jsxs("div",{style:{display:"flex",gap:"15px",flexWrap:"wrap",justifyContent:"flex-start"},children:[R.jsx("a",{href:"mailto:McKenzie.ouyang@gmail.com",style:{color:"rgba(255,255,255,0.8)",textDecoration:"none",fontSize:"1rem",fontFamily:"'Inter', sans-serif",padding:"10px 20px",border:"1px solid rgba(255,255,255,0.3)",borderRadius:"6px",transition:"all 0.3s ease"},onMouseEnter:T=>{T.target.style.background="rgba(255,255,255,0.1)",T.target.style.borderColor="rgba(255,255,255,0.5)"},onMouseLeave:T=>{T.target.style.background="transparent",T.target.style.borderColor="rgba(255,255,255,0.3)"},children:"Email"}),R.jsx("a",{href:"https://linkedin.com",target:"_blank",rel:"noopener noreferrer",style:{color:"rgba(255,255,255,0.8)",textDecoration:"none",fontSize:"1rem",fontFamily:"'Inter', sans-serif",padding:"10px 20px",border:"1px solid rgba(255,255,255,0.3)",borderRadius:"6px",transition:"all 0.3s ease"},onMouseEnter:T=>{T.target.style.background="rgba(255,255,255,0.1)",T.target.style.borderColor="rgba(255,255,255,0.5)"},onMouseLeave:T=>{T.target.style.background="transparent",T.target.style.borderColor="rgba(255,255,255,0.3)"},children:"LinkedIn"})]})]}),R.jsxs("div",{style:{display:"flex",gap:"20px",flexWrap:"wrap",marginTop:"40px"},children:[R.jsx("button",{style:{background:"white",color:"black",border:"none",padding:"16px 32px",fontSize:"0.95rem",fontWeight:"500",letterSpacing:"0.05em",cursor:"pointer",transition:"all 0.3s ease",fontFamily:"'Inter', sans-serif",textTransform:"uppercase"},onMouseEnter:T=>{T.target.style.background="rgba(255,255,255,0.9)",T.target.style.transform="translateY(-2px)"},onMouseLeave:T=>{T.target.style.background="white",T.target.style.transform="translateY(0)"},onClick:()=>document.getElementById("contact").scrollIntoView({behavior:"smooth"}),children:"Get in Touch"}),R.jsx("button",{style:{background:"transparent",color:"white",border:"1px solid rgba(255,255,255,0.3)",padding:"16px 32px",fontSize:"0.95rem",fontWeight:"400",letterSpacing:"0.05em",cursor:"pointer",transition:"all 0.3s ease",fontFamily:"'Inter', sans-serif",textTransform:"uppercase"},onMouseEnter:T=>{T.target.style.borderColor="white",T.target.style.background="rgba(255,255,255,0.1)"},onMouseLeave:T=>{T.target.style.borderColor="rgba(255,255,255,0.3)",T.target.style.background="transparent"},onClick:()=>document.getElementById("work").scrollIntoView({behavior:"smooth"}),children:"View Work"})]})]}),R.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"30px",height:"100%",paddingTop:"20px"},children:[R.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"20px",padding:"30px",fontFamily:"'Inter', sans-serif"},children:[R.jsxs("h3",{style:{fontSize:"1.4rem",fontWeight:"500",color:"white",margin:"0 0 25px 0",display:"flex",alignItems:"center",gap:"12px"},children:[R.jsx("span",{style:{fontSize:"1.8rem"},children:"⚡"}),"Skills & Tools"]}),R.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(2, 1fr)",gap:"15px"},children:[{name:"TouchDesigner",level:"95%",color:"#00ff88"},{name:"Blender",level:"90%",color:"#ff6b35"},{name:"After Effects",level:"85%",color:"#9999ff"},{name:"Cinema 4D",level:"80%",color:"#ffcc00"},{name:"Arduino",level:"75%",color:"#00ccff"},{name:"Premiere Pro",level:"85%",color:"#ff3366"}].map((T,V)=>R.jsxs("div",{style:{background:"rgba(255,255,255,0.04)",borderRadius:"12px",padding:"15px",border:"1px solid rgba(255,255,255,0.08)"},children:[R.jsx("div",{style:{fontSize:"0.9rem",fontWeight:"500",color:"rgba(255,255,255,0.9)",marginBottom:"8px"},children:T.name}),R.jsx("div",{style:{background:"rgba(255,255,255,0.1)",borderRadius:"6px",height:"4px",overflow:"hidden"},children:R.jsx("div",{style:{background:T.color,height:"100%",width:T.level,borderRadius:"6px",transition:"width 2s ease"}})})]},V))})]}),R.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"20px",padding:"30px",fontFamily:"'Inter', sans-serif"},children:[R.jsxs("h3",{style:{fontSize:"1.4rem",fontWeight:"500",color:"white",margin:"0 0 25px 0",display:"flex",alignItems:"center",gap:"12px"},children:[R.jsx("span",{style:{fontSize:"1.8rem"},children:"�"}),"Get In Touch"]}),R.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"15px"},children:[R.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px",padding:"12px 16px",background:"rgba(255,255,255,0.04)",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.08)",fontSize:"0.95rem",color:"rgba(255,255,255,0.8)"},children:[R.jsx("span",{children:"🇨🇳"}),R.jsx("span",{children:"+86 15723351973"})]}),R.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px",padding:"12px 16px",background:"rgba(255,255,255,0.04)",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.08)",fontSize:"0.95rem",color:"rgba(255,255,255,0.8)"},children:[R.jsx("span",{children:"🇭🇰"}),R.jsx("span",{children:"+852 84963034"})]}),R.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px",padding:"12px 16px",background:"rgba(255,255,255,0.04)",borderRadius:"12px",border:"1px solid rgba(255,255,255,0.08)",fontSize:"0.95rem",color:"rgba(255,255,255,0.8)"},children:[R.jsx("span",{children:"📧"}),R.jsx("span",{children:"McKenzie.ouyang@gmail.com"})]})]})]}),R.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"20px",padding:"25px",fontFamily:"'Inter', sans-serif",textAlign:"center"},children:[R.jsx("div",{style:{fontSize:"2rem",marginBottom:"10px"},children:"�"}),R.jsx("div",{style:{fontSize:"1.1rem",fontWeight:"500",color:"white",marginBottom:"8px"},children:"Interest Focus"}),R.jsx("div",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.7)",lineHeight:"1.5"},children:"Passionate about game level design and technical art, exploring the intersection of gameplay mechanics and visual storytelling"})]})]})]})}),R.jsxs("section",{id:"contact",style:{height:"100vh",width:"100vw",padding:"40px",background:"linear-gradient(135deg, #0a0a0a 0%, #1a1a1a 50%, #0a0a0a 100%)",display:"flex",alignItems:"center",justifyContent:"space-between",scrollSnapAlign:"start",scrollSnapStop:"always",overflow:"hidden",position:"relative"},children:[R.jsx("div",{style:{position:"absolute",top:"10%",left:"5%",width:"200px",height:"200px",opacity:.15,zIndex:0,pointerEvents:"none"},children:R.jsx(Dl,{modelSize:1.2,rotationSpeed:.008,showWireframe:!1,color:7042047,geometry:"sphere"})}),R.jsx("div",{style:{position:"absolute",bottom:"15%",right:"8%",width:"150px",height:"150px",opacity:.1,zIndex:0,pointerEvents:"none"},children:R.jsx(Dl,{modelSize:.8,rotationSpeed:-.012,showWireframe:!0,color:16739229,geometry:"box"})}),R.jsxs("div",{style:{flex:"1",display:"flex",flexDirection:"column",justifyContent:"center",padding:"0 80px",zIndex:2,maxWidth:"600px"},children:[R.jsxs("div",{style:{marginBottom:"40px",textAlign:"left"},children:[R.jsx("h2",{style:{fontSize:"clamp(2.5rem, 6vw, 4.5rem)",fontWeight:"200",margin:"0 0 15px 0",letterSpacing:"-0.02em",color:"white",fontFamily:"'Inter', sans-serif"},children:"Let's Connect"}),R.jsx("p",{style:{fontSize:"1.1rem",color:"rgba(255,255,255,0.7)",maxWidth:"500px",margin:"0",lineHeight:"1.5",fontFamily:"'Inter', sans-serif",fontWeight:"300"},children:"Ready to collaborate on digital art projects, creative installations, or explore new technologies together."})]}),R.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"20px",marginBottom:"40px"},children:[R.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"20px",padding:"25px 20px",transition:"all 0.3s ease",cursor:"pointer"},onMouseEnter:T=>{T.target.style.background="rgba(255,255,255,0.06)",T.target.style.borderColor="rgba(255,255,255,0.2)",T.target.style.transform="translateY(-5px)"},onMouseLeave:T=>{T.target.style.background="rgba(255,255,255,0.03)",T.target.style.borderColor="rgba(255,255,255,0.1)",T.target.style.transform="translateY(0)"},onClick:()=>window.open("mailto:McKenzie.ouyang@gmail.com"),children:[R.jsx("div",{style:{fontSize:"3rem",marginBottom:"20px"},children:"📧"}),R.jsx("h3",{style:{fontSize:"1.3rem",fontWeight:"500",color:"white",margin:"0 0 15px 0",fontFamily:"'Inter', sans-serif"},children:"Email"}),R.jsx("p",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.8)",margin:"0",fontFamily:"'Inter', sans-serif",wordBreak:"break-all"},children:"McKenzie.ouyang@gmail.com"})]}),R.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"20px",padding:"25px 20px",transition:"all 0.3s ease",cursor:"pointer"},onMouseEnter:T=>{T.target.style.background="rgba(255,255,255,0.06)",T.target.style.borderColor="rgba(255,255,255,0.2)",T.target.style.transform="translateY(-5px)"},onMouseLeave:T=>{T.target.style.background="rgba(255,255,255,0.03)",T.target.style.borderColor="rgba(255,255,255,0.1)",T.target.style.transform="translateY(0)"},onClick:()=>window.open("tel:+8615723351973"),children:[R.jsx("div",{style:{fontSize:"3rem",marginBottom:"20px"},children:"🇨🇳"}),R.jsx("h3",{style:{fontSize:"1.3rem",fontWeight:"500",color:"white",margin:"0 0 15px 0",fontFamily:"'Inter', sans-serif"},children:"China"}),R.jsx("p",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.8)",margin:"0",fontFamily:"'Inter', sans-serif"},children:"+86 15723351973"})]}),R.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"20px",padding:"25px 20px",transition:"all 0.3s ease",cursor:"pointer"},onMouseEnter:T=>{T.target.style.background="rgba(255,255,255,0.06)",T.target.style.borderColor="rgba(255,255,255,0.2)",T.target.style.transform="translateY(-5px)"},onMouseLeave:T=>{T.target.style.background="rgba(255,255,255,0.03)",T.target.style.borderColor="rgba(255,255,255,0.1)",T.target.style.transform="translateY(0)"},onClick:()=>window.open("tel:+85284963034"),children:[R.jsx("div",{style:{fontSize:"3rem",marginBottom:"20px"},children:"🇭🇰"}),R.jsx("h3",{style:{fontSize:"1.3rem",fontWeight:"500",color:"white",margin:"0 0 15px 0",fontFamily:"'Inter', sans-serif"},children:"Hong Kong"}),R.jsx("p",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.8)",margin:"0",fontFamily:"'Inter', sans-serif"},children:"+852 84963034"})]})]}),R.jsxs("div",{style:{display:"flex",justifyContent:"center",gap:"20px",flexWrap:"wrap"},children:[R.jsxs("a",{href:"https://linkedin.com",target:"_blank",rel:"noopener noreferrer",style:{display:"flex",alignItems:"center",gap:"12px",color:"rgba(255,255,255,0.8)",textDecoration:"none",fontSize:"1.1rem",fontFamily:"'Inter', sans-serif",padding:"15px 25px",border:"1px solid rgba(255,255,255,0.2)",borderRadius:"12px",transition:"all 0.3s ease",background:"rgba(255,255,255,0.02)"},onMouseEnter:T=>{T.target.style.background="rgba(255,255,255,0.1)",T.target.style.borderColor="rgba(255,255,255,0.4)",T.target.style.transform="translateY(-3px)"},onMouseLeave:T=>{T.target.style.background="rgba(255,255,255,0.02)",T.target.style.borderColor="rgba(255,255,255,0.2)",T.target.style.transform="translateY(0)"},children:[R.jsx("span",{style:{fontSize:"1.5rem"},children:"💼"}),"LinkedIn"]}),R.jsxs("a",{href:"https://instagram.com",target:"_blank",rel:"noopener noreferrer",style:{display:"flex",alignItems:"center",gap:"12px",color:"rgba(255,255,255,0.8)",textDecoration:"none",fontSize:"1.1rem",fontFamily:"'Inter', sans-serif",padding:"15px 25px",border:"1px solid rgba(255,255,255,0.2)",borderRadius:"12px",transition:"all 0.3s ease",background:"rgba(255,255,255,0.02)"},onMouseEnter:T=>{T.target.style.background="rgba(255,255,255,0.1)",T.target.style.borderColor="rgba(255,255,255,0.4)",T.target.style.transform="translateY(-3px)"},onMouseLeave:T=>{T.target.style.background="rgba(255,255,255,0.02)",T.target.style.borderColor="rgba(255,255,255,0.2)",T.target.style.transform="translateY(0)"},children:[R.jsx("span",{style:{fontSize:"1.5rem"},children:"📸"}),"Instagram"]}),R.jsxs("a",{href:"https://github.com",target:"_blank",rel:"noopener noreferrer",style:{display:"flex",alignItems:"center",gap:"12px",color:"rgba(255,255,255,0.8)",textDecoration:"none",fontSize:"1.1rem",fontFamily:"'Inter', sans-serif",padding:"15px 25px",border:"1px solid rgba(255,255,255,0.2)",borderRadius:"12px",transition:"all 0.3s ease",background:"rgba(255,255,255,0.02)"},onMouseEnter:T=>{T.target.style.background="rgba(255,255,255,0.1)",T.target.style.borderColor="rgba(255,255,255,0.4)",T.target.style.transform="translateY(-3px)"},onMouseLeave:T=>{T.target.style.background="rgba(255,255,255,0.02)",T.target.style.borderColor="rgba(255,255,255,0.2)",T.target.style.transform="translateY(0)"},children:[R.jsx("span",{style:{fontSize:"1.5rem"},children:"💻"}),"GitHub"]})]}),R.jsxs("div",{style:{marginTop:"15px",padding:"12px",background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"15px",maxWidth:"350px",margin:"15px auto 0"},children:[R.jsx("div",{style:{fontSize:"2rem",marginBottom:"15px"},children:"🎮"}),R.jsx("div",{style:{fontSize:"1.2rem",fontWeight:"500",color:"white",marginBottom:"10px",fontFamily:"'Inter', sans-serif"},children:"Interest Focus"}),R.jsx("div",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.7)",lineHeight:"1.6",fontFamily:"'Inter', sans-serif"},children:"Passionate about game level design and technical art, exploring immersive virtual worlds and gameplay mechanics."})]})]})]}),e&&R.jsx("div",{style:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",background:"rgba(0,0,0,0.9)",zIndex:2e3,display:"flex",alignItems:"center",justifyContent:"center",padding:"20px"},onClick:()=>t(null),children:R.jsxs("div",{style:{background:"#1a1a1a",borderRadius:"12px",maxWidth:"800px",maxHeight:"90vh",overflow:"auto",position:"relative"},onClick:T=>T.stopPropagation(),children:[R.jsx("button",{onClick:()=>t(null),style:{position:"absolute",top:"20px",right:"20px",background:"rgba(255,255,255,0.1)",border:"none",borderRadius:"50%",width:"40px",height:"40px",color:"white",fontSize:"20px",cursor:"pointer",zIndex:10},children:"×"}),R.jsx("img",{src:e.image,alt:e.title,style:{width:"100%",height:"400px",objectFit:"cover",borderRadius:"12px 12px 0 0"}}),R.jsxs("div",{style:{padding:"30px"},children:[R.jsxs("div",{style:{fontSize:"0.9rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.1em",marginBottom:"15px",textTransform:"uppercase",fontFamily:"'Inter', sans-serif"},children:[e.category," • ",e.year]}),R.jsx("h2",{style:{fontSize:"2rem",fontWeight:"500",margin:"0 0 20px 0",color:"white",fontFamily:"'Inter', sans-serif"},children:e.title}),R.jsx("p",{style:{fontSize:"1.1rem",lineHeight:"1.7",color:"rgba(255,255,255,0.8)",margin:"0 0 30px 0",fontFamily:"'Inter', sans-serif"},children:e.description}),e.gallery&&R.jsxs("div",{children:[R.jsx("h3",{style:{fontSize:"1.2rem",color:"white",marginBottom:"20px",fontFamily:"'Inter', sans-serif"},children:"Gallery"}),R.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(300px, 1fr))",gap:"25px"},children:e.gallery.map((T,V)=>R.jsx("img",{src:T,alt:`${e.title} ${V+1}`,style:{width:"100%",height:"auto",minHeight:"250px",objectFit:"contain",borderRadius:"12px",cursor:"pointer",transition:"transform 0.3s ease",border:"1px solid rgba(255, 255, 255, 0.1)",backgroundColor:"rgba(0,0,0,0.3)"},onMouseEnter:j=>{j.target.style.transform="scale(1.03)"},onMouseLeave:j=>{j.target.style.transform="scale(1)"}},V))})]})]})]})}),d&&R.jsxs("div",{style:{position:"fixed",left:f.x,top:f.y,width:"400px",maxHeight:"500px",background:"rgba(0,0,0,0.95)",backdropFilter:"blur(20px)",border:"1px solid rgba(255,255,255,0.2)",borderRadius:"12px",zIndex:2e3,overflow:"hidden",boxShadow:"0 20px 40px rgba(0,0,0,0.5)",userSelect:"none"},children:[R.jsxs("div",{style:{background:"rgba(255,255,255,0.1)",padding:"12px 16px",borderBottom:"1px solid rgba(255,255,255,0.1)",cursor:x?"grabbing":"grab",display:"flex",alignItems:"center",justifyContent:"space-between"},onMouseDown:E,children:[R.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[R.jsx("div",{style:{width:"12px",height:"12px",background:"#ff5f57",borderRadius:"50%"}}),R.jsx("div",{style:{width:"12px",height:"12px",background:"#ffbd2e",borderRadius:"50%"}}),R.jsx("div",{style:{width:"12px",height:"12px",background:"#28ca42",borderRadius:"50%"}})]}),R.jsxs("h3",{style:{color:"white",fontSize:"0.9rem",fontWeight:"500",margin:0,fontFamily:"'Inter', sans-serif"},children:[d==="about"&&"About Me",d==="education"&&"Education",d==="contact"&&"Contact",d==="awards"&&"Awards",d==="interests"&&"Interests",d==="skills"&&"Skills"]}),R.jsx("button",{style:{background:"transparent",border:"none",color:"rgba(255,255,255,0.7)",fontSize:"16px",cursor:"pointer",padding:"4px",borderRadius:"4px",transition:"all 0.2s ease"},onClick:()=>h(null),onMouseEnter:T=>{T.target.style.background="rgba(255,255,255,0.1)",T.target.style.color="white"},onMouseLeave:T=>{T.target.style.background="transparent",T.target.style.color="rgba(255,255,255,0.7)"},children:"×"})]}),R.jsxs("div",{style:{padding:"20px",maxHeight:"420px",overflow:"auto",color:"white",fontFamily:"'Inter', sans-serif"},children:[d==="about"&&R.jsxs("div",{children:[R.jsx("div",{style:{fontSize:"2rem",textAlign:"center",marginBottom:"16px"},children:"👋"}),R.jsx("p",{style:{fontSize:"0.95rem",lineHeight:"1.6",color:"rgba(255,255,255,0.9)",margin:0},children:"I'm a digital artist and creative technologist passionate about exploring the intersection of art, technology, and human experience. My work focuses on creating immersive digital experiences that blur the boundaries between the virtual and physical worlds."})]}),d==="education"&&R.jsxs("div",{children:[R.jsx("div",{style:{fontSize:"2rem",textAlign:"center",marginBottom:"16px"},children:"🎓"}),R.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[R.jsxs("div",{children:[R.jsx("h4",{style:{fontSize:"1rem",fontWeight:"600",margin:"0 0 4px 0",color:"white"},children:"Master's in Digital Arts"}),R.jsx("p",{style:{fontSize:"0.85rem",color:"rgba(255,255,255,0.8)",margin:"0 0 2px 0"},children:"University of Arts"}),R.jsx("p",{style:{fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",margin:0},children:"2022-2024"})]}),R.jsxs("div",{children:[R.jsx("h4",{style:{fontSize:"1rem",fontWeight:"600",margin:"0 0 4px 0",color:"white"},children:"Bachelor's in Interactive Media"}),R.jsx("p",{style:{fontSize:"0.85rem",color:"rgba(255,255,255,0.8)",margin:"0 0 2px 0"},children:"Design Institute"}),R.jsx("p",{style:{fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",margin:0},children:"2018-2022"})]})]})]}),d==="contact"&&R.jsxs("div",{children:[R.jsx("div",{style:{fontSize:"2rem",textAlign:"center",marginBottom:"16px"},children:"📫"}),R.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"12px"},children:[R.jsxs("div",{style:{background:"rgba(255,255,255,0.05)",padding:"12px",borderRadius:"8px",textAlign:"center"},children:[R.jsx("div",{style:{fontSize:"1.2rem",marginBottom:"4px"},children:"✉️"}),R.jsx("p",{style:{fontSize:"0.9rem",margin:0,color:"rgba(255,255,255,0.9)"},children:"McKenzie.ouyang@gmail.com"})]}),R.jsxs("div",{style:{display:"flex",gap:"8px"},children:[R.jsxs("div",{style:{background:"rgba(255,255,255,0.05)",padding:"10px",borderRadius:"8px",textAlign:"center",flex:1},children:[R.jsx("div",{style:{fontSize:"1rem",marginBottom:"2px"},children:"🇨🇳"}),R.jsx("p",{style:{fontSize:"0.8rem",margin:0,color:"rgba(255,255,255,0.8)"},children:"+86 15723351973"})]}),R.jsxs("div",{style:{background:"rgba(255,255,255,0.05)",padding:"10px",borderRadius:"8px",textAlign:"center",flex:1},children:[R.jsx("div",{style:{fontSize:"1rem",marginBottom:"2px"},children:"🇭🇰"}),R.jsx("p",{style:{fontSize:"0.8rem",margin:0,color:"rgba(255,255,255,0.8)"},children:"+852 84963034"})]})]})]})]}),d==="awards"&&R.jsxs("div",{children:[R.jsx("div",{style:{fontSize:"2rem",textAlign:"center",marginBottom:"16px"},children:"🏆"}),R.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"12px"},children:[R.jsxs("div",{style:{display:"flex",alignItems:"flex-start",gap:"8px"},children:[R.jsx("div",{style:{fontSize:"1.2rem"},children:"🥇"}),R.jsxs("div",{children:[R.jsx("h4",{style:{fontSize:"0.9rem",fontWeight:"600",margin:"0 0 2px 0"},children:"Digital Art Excellence Award"}),R.jsx("p",{style:{fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",margin:0},children:"National Arts Competition 2024"})]})]}),R.jsxs("div",{style:{display:"flex",alignItems:"flex-start",gap:"8px"},children:[R.jsx("div",{style:{fontSize:"1.2rem"},children:"🥈"}),R.jsxs("div",{children:[R.jsx("h4",{style:{fontSize:"0.9rem",fontWeight:"600",margin:"0 0 2px 0"},children:"Innovation in Interactive Media"}),R.jsx("p",{style:{fontSize:"0.8rem",color:"rgba(255,255,255,0.6)",margin:0},children:"Tech Arts Festival 2023"})]})]})]})]}),d==="interests"&&R.jsxs("div",{children:[R.jsx("div",{style:{fontSize:"2rem",textAlign:"center",marginBottom:"16px"},children:"🎨"}),R.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"12px"},children:["3D Modeling","VR/AR","AI Art","Photography","Game Design","Motion Graphics"].map(T=>R.jsx("span",{style:{background:"rgba(255,255,255,0.1)",border:"1px solid rgba(255,255,255,0.2)",borderRadius:"12px",padding:"4px 8px",fontSize:"0.75rem",color:"rgba(255,255,255,0.9)"},children:T},T))}),R.jsx("p",{style:{fontSize:"0.85rem",lineHeight:"1.5",color:"rgba(255,255,255,0.8)",margin:0},children:"My creative journey spans multiple disciplines, always seeking new ways to merge traditional artforms with emerging technologies."})]}),d==="skills"&&R.jsxs("div",{children:[R.jsx("div",{style:{fontSize:"2rem",textAlign:"center",marginBottom:"16px"},children:"⚡"}),R.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[R.jsxs("div",{children:[R.jsx("h4",{style:{fontSize:"0.9rem",fontWeight:"600",marginBottom:"8px",color:"rgba(255,255,255,0.9)"},children:"Design & Creative"}),R.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:"6px"},children:["Digital Art","Visual Design","Installation Art","Motion Graphics"].map(T=>R.jsx("span",{style:{background:"rgba(255,255,255,0.08)",border:"1px solid rgba(255,255,255,0.15)",borderRadius:"10px",padding:"3px 8px",fontSize:"0.7rem",color:"rgba(255,255,255,0.8)"},children:T},T))})]}),R.jsxs("div",{children:[R.jsx("h4",{style:{fontSize:"0.9rem",fontWeight:"600",marginBottom:"8px",color:"rgba(255,255,255,0.9)"},children:"Technical"}),R.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:"6px"},children:["Creative Coding","Interactive Design","3D Modeling","VR/AR Development"].map(T=>R.jsx("span",{style:{background:"rgba(255,255,255,0.08)",border:"1px solid rgba(255,255,255,0.15)",borderRadius:"10px",padding:"3px 8px",fontSize:"0.7rem",color:"rgba(255,255,255,0.8)"},children:T},T))})]})]})]})]})]})]})}pM.createRoot(document.getElementById("root")).render(R.jsx(Ae.StrictMode,{children:R.jsx(TA,{})}));
