 ...
 */var vx=Symbol.for("react.transitional.element"),xx=Symbol.for("react.fragment");function Fg(e,t,n){var i=null;if(n!==void 0&&(i=""+n),t.key!==void 0&&(i=""+t.key),"key"in t){n={};for(var a in t)a!=="key"&&(n[a]=t[a])}else n=t;return t=n.ref,{$$typeof:vx,type:e,key:i,ref:t!==void 0?t:null,props:n}}Rc.Fragment=xx;Rc.jsx=Fg;Rc.jsxs=Fg;Bg.exports=Rc;var Q=Bg.exports,Hg={exports:{}},Ht={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(N,V){var I=N.length;N.push(V);t:for(;0<I;){var tt=I-1>>>1,rt=N[tt];if(0<a(rt,V))N[tt]=V,N[I]=rt,I=tt;else break t}}function n(N){return N.length===0?null:N[0]}function i(N){if(N.length===0)return null;var V=N[0],I=N.pop();if(I!==V){N[0]=I;t:for(var tt=0,rt=N.length,_t=rt>>>1;tt<_t;){var Ot=2*(tt+1)-1,ne=N[Ot],Zt=Ot+1,Wt=N[Zt];if(0>a(ne,I))Zt<rt&&0>a(Wt,ne)?(N[tt]=Wt,N[Zt]=I,tt=Zt):(N[tt]=ne,N[Ot]=I,tt=Ot);else if(Zt<rt&&0>a(Wt,I))N[tt]=Wt,N[Zt]=I,tt=Zt;else break t}}return V}function a(N,V){var I=N.sortIndex-V.sortIndex;return I!==0?I:N.id-V.id}if(e.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var r=performance;e.unstable_now=function(){return r.now()}}else{var s=Date,o=s.now();e.unstable_now=function(){return s.now()-o}}var l=[],c=[],d=1,h=null,f=3,p=!1,x=!1,S=!1,g=!1,u=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,_=typeof setImmediate<"u"?setImmediate:null;function v(N){for(var V=n(c);V!==null;){if(V.callback===null)i(c);else if(V.startTime<=N)i(c),V.sortIndex=V.expirationTime,t(l,V);else break;V=n(c)}}function b(N){if(S=!1,v(N),!x)if(n(l)!==null)x=!0,C||(C=!0,F());else{var V=n(c);V!==null&&Y(b,V.startTime-N)}}var C=!1,A=-1,D=5,T=-1;function E(){return g?!0:!(e.unstable_now()-T<D)}function U(){if(g=!1,C){var N=e.unstable_now();T=N;var V=!0;try{t:{x=!1,S&&(S=!1,m(A),A=-1),p=!0;var I=f;try{e:{for(v(N),h=n(l);h!==null&&!(h.expirationTime>N&&E());){var tt=h.callback;if(typeof tt=="function"){h.callback=null,f=h.priorityLevel;var rt=tt(h.expirationTime<=N);if(N=e.unstable_now(),typeof rt=="function"){h.callback=rt,v(N),V=!0;break e}h===n(l)&&i(l),v(N)}else i(l);h=n(l)}if(h!==null)V=!0;else{var _t=n(c);_t!==null&&Y(b,_t.startTime-N),V=!1}}break t}finally{h=null,f=I,p=!1}V=void 0}}finally{V?F():C=!1}}}var F;if(typeof _=="function")F=function(){_(U)};else if(typeof MessageChannel<"u"){var k=new MessageChannel,K=k.port2;k.port1.onmessage=U,F=function(){K.postMessage(null)}}else F=function(){u(U,0)};function Y(N,V){A=u(function(){N(e.unstable_now())},V)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(N){N.callback=null},e.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):D=0<N?Math.floor(1e3/N):5},e.unstable_getCurrentPriorityLevel=function(){return f},e.unstable_next=function(N){switch(f){case 1:case 2:case 3:var V=3;break;default:V=f}var I=f;f=V;try{return N()}finally{f=I}},e.unstable_requestPaint=function(){g=!0},e.unstable_runWithPriority=function(N,V){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var I=f;f=N;try{return V()}finally{f=I}},e.unstable_scheduleCallback=function(N,V,I){var tt=e.unstable_now();switch(typeof I=="object"&&I!==null?(I=I.delay,I=typeof I=="number"&&0<I?tt+I:tt):I=tt,N){case 1:var rt=-1;break;case 2:rt=250;break;case 5:rt=1073741823;break;case 4:rt=1e4;break;default:rt=5e3}return rt=I+rt,N={id:d++,callback:V,priorityLevel:N,startTime:I,expirationTime:rt,sortIndex:-1},I>tt?(N.sortIndex=I,t(c,N),n(l)===null&&N===n(c)&&(S?(m(A),A=-1):S=!0,Y(b,I-tt))):(N.sortIndex=rt,t(l,N),x||p||(x=!0,C||(C=!0,F()))),N},e.unstable_shouldYield=E,e.unstable_wrapCallback=function(N){var V=f;return function(){var I=f;f=V;try{return N.apply(this,arguments)}finally{f=I}}}})(Zg);jg.exports=Zg;var Px=jg.exports,Kg={exports:{}},on={};/**
 * @license React
...
`)}function OA(e,t){let n;switch(t){case IM:n="Linear";break;case zM:n="Reinhard";break;case BM:n="Cineon";break;case FM:n="ACESFilmic";break;case GM:n="AgX";break;case VM:n="Neutral";break;case HM:n="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),n="Linear"}return"vec3 "+e+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const wl=new z;function PA(){Qt.getLuminanceCoefficients(wl);const e=wl.x.toFixed(4),t=wl.y.toFixed(4),n=wl.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${e}, ${t}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
...
}`;function fR(e,t,n){let i=new ap;const a=new $t,r=new $t,s=new ue,o=new NE({depthPacking:WM}),l=new OE,c={},d=n.maxTextureSize,h={[Ma]:dn,[dn]:Ma,[Ri]:Ri},f=new Ea({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new $t},radius:{value:4}},vertexShader:cR,fragmentShader:uR}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const x=new Vi;x.setAttribute("position",new fi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const S=new oi(x,f),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ov;let u=this.type;this.render=function(C,A,D){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||C.length===0)return;const T=e.getRenderTarget(),E=e.getActiveCubeFace(),U=e.getActiveMipmapLevel(),F=e.state;F.setBlending(_a),F.buffers.depth.getReversed()===!0?F.buffers.color.setClear(0,0,0,0):F.buffers.color.setClear(1,1,1,1),F.buffers.depth.setTest(!0),F.setScissorTest(!1);const k=u!==bi&&this.type===bi,K=u===bi&&this.type!==bi;for(let Y=0,N=C.length;Y<N;Y++){const V=C[Y],I=V.shadow;if(I===void 0){console.warn("THREE.WebGLShadowMap:",V,"has no shadow.");continue}if(I.autoUpdate===!1&&I.needsUpdate===!1)continue;a.copy(I.mapSize);const tt=I.getFrameExtents();if(a.multiply(tt),r.copy(I.mapSize),(a.x>d||a.y>d)&&(a.x>d&&(r.x=Math.floor(d/tt.x),a.x=r.x*tt.x,I.mapSize.x=r.x),a.y>d&&(r.y=Math.floor(d/tt.y),a.y=r.y*tt.y,I.mapSize.y=r.y)),I.map===null||k===!0||K===!0){const _t=this.type!==bi?{minFilter:Jn,magFilter:Jn}:{};I.map!==null&&I.map.dispose(),I.map=new nr(a.x,a.y,_t),I.map.texture.name=V.name+".shadowMap",I.camera.updateProjectionMatrix()}e.setRenderTarget(I.map),e.clear();const rt=I.getViewportCount();for(let _t=0;_t<rt;_t++){const Ot=I.getViewport(_t);s.set(r.x*Ot.x,r.y*Ot.y,r.x*Ot.z,r.y*Ot.w),F.viewport(s),I.updateMatrices(V,_t),i=I.getFrustum(),v(A,D,I.camera,V,this.type)}I.isPointLightShadow!==!0&&this.type===bi&&m(I,D),I.needsUpdate=!1}u=this.type,g.needsUpdate=!1,e.setRenderTarget(T,E,U)};function m(C,A){const D=t.update(S);f.defines.VSM_SAMPLES!==C.blurSamples&&(f.defines.VSM_SAMPLES=C.blurSamples,p.defines.VSM_SAMPLES=C.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new nr(a.x,a.y)),f.uniforms.shadow_pass.value=C.map.texture,f.uniforms.resolution.value=C.mapSize,f.uniforms.radius.value=C.radius,e.setRenderTarget(C.mapPass),e.clear(),e.renderBufferDirect(A,null,D,f,S,null),p.uniforms.shadow_pass.value=C.mapPass.texture,p.uniforms.resolution.value=C.mapSize,p.uniforms.radius.value=C.radius,e.setRenderTarget(C.map),e.clear(),e.renderBufferDirect(A,null,D,p,S,null)}function _(C,A,D,T){let E=null;const U=D.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(U!==void 0)E=U;else if(E=D.isPointLight===!0?l:o,e.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0||A.alphaToCoverage===!0){const F=E.uuid,k=A.uuid;let K=c[F];K===void 0&&(K={},c[F]=K);let Y=K[k];Y===void 0&&(Y=E.clone(),K[k]=Y,A.addEventListener("dispose",b)),E=Y}if(E.visible=A.visible,E.wireframe=A.wireframe,T===bi?E.side=A.shadowSide!==null?A.shadowSide:A.side:E.side=A.shadowSide!==null?A.shadowSide:h[A.side],E.alphaMap=A.alphaMap,E.alphaTest=A.alphaToCoverage===!0?.5:A.alphaTest,E.map=A.map,E.clipShadows=A.clipShadows,E.clippingPlanes=A.clippingPlanes,E.clipIntersection=A.clipIntersection,E.displacementMap=A.displacementMap,E.displacementScale=A.displacementScale,E.displacementBias=A.displacementBias,E.wireframeLinewidth=A.wireframeLinewidth,E.linewidth=A.linewidth,D.isPointLight===!0&&E.isMeshDistanceMaterial===!0){const F=e.properties.get(E);F.light=D}return E}function v(C,A,D,T,E){if(C.visible===!1)return;if(C.layers.test(A.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&E===bi)&&(!C.frustumCulled||i.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(D.matrixWorldInverse,C.matrixWorld);const k=t.update(C),K=C.material;if(Array.isArray(K)){const Y=k.groups;for(let N=0,V=Y.length;N<V;N++){const I=Y[N],tt=K[I.materialIndex];if(tt&&tt.visible){const rt=_(C,tt,T,E);C.onBeforeShadow(e,C,A,D,k,rt,I),e.renderBufferDirect(D,null,k,rt,C,I),C.onAfterShadow(e,C,A,D,k,rt,I)}}}else if(K.visible){const Y=_(C,K,T,E);C.onBeforeShadow(e,C,A,D,k,Y,null),e.renderBufferDirect(D,null,k,Y,C,null),C.onAfterShadow(e,C,A,D,k,Y,null)}}const F=C.children;for(let k=0,K=F.length;k<K;k++)v(F[k],A,D,T,E)}function b(C){C.target.removeEventListener("dispose",b);for(const D in c){const T=c[D],E=C.target.uuid;E in T&&(T[E].dispose(),delete T[E])}}}const hR={[lh]:ch,[uh]:dh,[fh]:ph,[ls]:hh,[ch]:lh,[dh]:uh,[ph]:fh,[hh]:ls};function dR(e,t){function n(){let L=!1;const at=new ue;let ot=null;const dt=new ue(0,0,0,0);return{setMask:function(et){ot!==et&&!L&&(e.colorMask(et,et,et,et),ot=et)},setLocked:function(et){L=et},setClear:function(et,Z,gt,Nt,de){de===!0&&(et*=Nt,Z*=Nt,gt*=Nt),at.set(et,Z,gt,Nt),dt.equals(at)===!1&&(e.clearColor(et,Z,gt,Nt),dt.copy(at))},reset:function(){L=!1,ot=null,dt.set(-1,0,0,0)}}}function i(){let L=!1,at=!1,ot=null,dt=null,et=null;return{setReversed:function(Z){if(at!==Z){const gt=t.get("EXT_clip_control");Z?gt.clipControlEXT(gt.LOWER_LEFT_EXT,gt.ZERO_TO_ONE_EXT):gt.clipControlEXT(gt.LOWER_LEFT_EXT,gt.NEGATIVE_ONE_TO_ONE_EXT),at=Z;const Nt=et;et=null,this.setClear(Nt)}},getReversed:function(){return at},setTest:function(Z){Z?$(e.DEPTH_TEST):pt(e.DEPTH_TEST)},setMask:function(Z){ot!==Z&&!L&&(e.depthMask(Z),ot=Z)},setFunc:function(Z){if(at&&(Z=hR[Z]),dt!==Z){switch(Z){case lh:e.depthFunc(e.NEVER);break;case ch:e.depthFunc(e.ALWAYS);break;case uh:e.depthFunc(e.LESS);break;case ls:e.depthFunc(e.LEQUAL);break;case fh:e.depthFunc(e.EQUAL);break;case hh:e.depthFunc(e.GEQUAL);break;case dh:e.depthFunc(e.GREATER);break;case ph:e.depthFunc(e.NOTEQUAL);break;default:e.depthFunc(e.LEQUAL)}dt=Z}},setLocked:function(Z){L=Z},setClear:function(Z){et!==Z&&(at&&(Z=1-Z),e.clearDepth(Z),et=Z)},reset:function(){L=!1,ot=null,dt=null,et=null,at=!1}}}function a(){let L=!1,at=null,ot=null,dt=null,et=null,Z=null,gt=null,Nt=null,de=null;return{setTest:function(ie){L||(ie?$(e.STENCIL_TEST):pt(e.STENCIL_TEST))},setMask:function(ie){at!==ie&&!L&&(e.stencilMask(ie),at=ie)},setFunc:function(ie,gi,ti){(ot!==ie||dt!==gi||et!==ti)&&(e.stencilFunc(ie,gi,ti),ot=ie,dt=gi,et=ti)},setOp:function(ie,gi,ti){(Z!==ie||gt!==gi||Nt!==ti)&&(e.stencilOp(ie,gi,ti),Z=ie,gt=gi,Nt=ti)},setLocked:function(ie){L=ie},setClear:function(ie){de!==ie&&(e.clearStencil(ie),de=ie)},reset:function(){L=!1,at=null,ot=null,dt=null,et=null,Z=null,gt=null,Nt=null,de=null}}}const r=new n,s=new i,o=new a,l=new WeakMap,c=new WeakMap;let d={},h={},f=new WeakMap,p=[],x=null,S=!1,g=null,u=null,m=null,_=null,v=null,b=null,C=null,A=new Jt(0,0,0),D=0,T=!1,E=null,U=null,F=null,k=null,K=null;const Y=e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let N=!1,V=0;const I=e.getParameter(e.VERSION);I.indexOf("WebGL")!==-1?(V=parseFloat(/^WebGL (\d)/.exec(I)[1]),N=V>=1):I.indexOf("OpenGL ES")!==-1&&(V=parseFloat(/^OpenGL ES (\d)/.exec(I)[1]),N=V>=2);let tt=null,rt={};const _t=e.getParameter(e.SCISSOR_BOX),Ot=e.getParameter(e.VIEWPORT),ne=new ue().fromArray(_t),Zt=new ue().fromArray(Ot);function Wt(L,at,ot,dt){const et=new Uint8Array(4),Z=e.createTexture();e.bindTexture(L,Z),e.texParameteri(L,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(L,e.TEXTURE_MAG_FILTER,e.NEAREST);for(let gt=0;gt<ot;gt++)L===e.TEXTURE_3D||L===e.TEXTURE_2D_ARRAY?e.texImage3D(at,0,e.RGBA,1,1,dt,0,e.RGBA,e.UNSIGNED_BYTE,et):e.texImage2D(at+gt,0,e.RGBA,1,1,0,e.RGBA,e.UNSIGNED_BYTE,et);return Z}const q={};q[e.TEXTURE_2D]=Wt(e.TEXTURE_2D,e.TEXTURE_2D,1),q[e.TEXTURE_CUBE_MAP]=Wt(e.TEXTURE_CUBE_MAP,e.TEXTURE_CUBE_MAP_POSITIVE_X,6),q[e.TEXTURE_2D_ARRAY]=Wt(e.TEXTURE_2D_ARRAY,e.TEXTURE_2D_ARRAY,1,1),q[e.TEXTURE_3D]=Wt(e.TEXTURE_3D,e.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),o.setClear(0),$(e.DEPTH_TEST),s.setFunc(ls),Dt(!1),vt(Hm),$(e.CULL_FACE),_e(_a);function $(L){d[L]!==!0&&(e.enable(L),d[L]=!0)}function pt(L){d[L]!==!1&&(e.disable(L),d[L]=!1)}function Lt(L,at){return h[L]!==at?(e.bindFramebuffer(L,at),h[L]=at,L===e.DRAW_FRAMEBUFFER&&(h[e.FRAMEBUFFER]=at),L===e.FRAMEBUFFER&&(h[e.DRAW_FRAMEBUFFER]=at),!0):!1}function Tt(L,at){let ot=p,dt=!1;if(L){ot=f.get(at),ot===void 0&&(ot=[],f.set(at,ot));const et=L.textures;if(ot.length!==et.length||ot[0]!==e.COLOR_ATTACHMENT0){for(let Z=0,gt=et.length;Z<gt;Z++)ot[Z]=e.COLOR_ATTACHMENT0+Z;ot.length=et.length,dt=!0}}else ot[0]!==e.BACK&&(ot[0]=e.BACK,dt=!0);dt&&e.drawBuffers(ot)}function qt(L){return x!==L?(e.useProgram(L),x=L,!0):!1}const Ke={[Ha]:e.FUNC_ADD,[_M]:e.FUNC_SUBTRACT,[vM]:e.FUNC_REVERSE_SUBTRACT};Ke[xM]=e.MIN,Ke[SM]=e.MAX;const w={[yM]:e.ZERO,[MM]:e.ONE,[EM]:e.SRC_COLOR,[sh]:e.SRC_ALPHA,[wM]:e.SRC_ALPHA_SATURATE,[RM]:e.DST_COLOR,[bM]:e.DST_ALPHA,[TM]:e.ONE_MINUS_SRC_COLOR,[oh]:e.ONE_MINUS_SRC_ALPHA,[CM]:e.ONE_MINUS_DST_COLOR,[AM]:e.ONE_MINUS_DST_ALPHA,[DM]:e.CONSTANT_COLOR,[UM]:e.ONE_MINUS_CONSTANT_COLOR,[LM]:e.CONSTANT_ALPHA,[NM]:e.ONE_MINUS_CONSTANT_ALPHA};function _e(L,at,ot,dt,et,Z,gt,Nt,de,ie){if(L===_a){S===!0&&(pt(e.BLEND),S=!1);return}if(S===!1&&($(e.BLEND),S=!0),L!==gM){if(L!==g||ie!==T){if((u!==Ha||v!==Ha)&&(e.blendEquation(e.FUNC_ADD),u=Ha,v=Ha),ie)switch(L){case Zr:e.blendFuncSeparate(e.ONE,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case Gm:e.blendFunc(e.ONE,e.ONE);break;case Vm:e.blendFuncSeparate(e.ZERO,e.ONE_MINUS_SRC_COLOR,e.ZERO,e.ONE);break;case km:e.blendFuncSeparate(e.DST_COLOR,e.ONE_MINUS_SRC_ALPHA,e.ZERO,e.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}else switch(L){case Zr:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case Gm:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE,e.ONE,e.ONE);break;case Vm:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case km:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}m=null,_=null,b=null,C=null,A.set(0,0,0),D=0,g=L,T=ie}return}et=et||at,Z=Z||ot,gt=gt||dt,(at!==u||et!==v)&&(e.blendEquationSeparate(Ke[at],Ke[et]),u=at,v=et),(ot!==m||dt!==_||Z!==b||gt!==C)&&(e.blendFuncSeparate(w[ot],w[dt],w[Z],w[gt]),m=ot,_=dt,b=Z,C=gt),(Nt.equals(A)===!1||de!==D)&&(e.blendColor(Nt.r,Nt.g,Nt.b,de),A.copy(Nt),D=de),g=L,T=!1}function Pt(L,at){L.side===Ri?pt(e.CULL_FACE):$(e.CULL_FACE);let ot=L.side===dn;at&&(ot=!ot),Dt(ot),L.blending===Zr&&L.transparent===!1?_e(_a):_e(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),s.setFunc(L.depthFunc),s.setTest(L.depthTest),s.setMask(L.depthWrite),r.setMask(L.colorWrite);const dt=L.stencilWrite;o.setTest(dt),dt&&(o.setMask(L.stencilWriteMask),o.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),o.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),xt(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?$(e.SAMPLE_ALPHA_TO_COVERAGE):pt(e.SAMPLE_ALPHA_TO_COVERAGE)}function Dt(L){E!==L&&(L?e.frontFace(e.CW):e.frontFace(e.CCW),E=L)}function vt(L){L!==pM?($(e.CULL_FACE),L!==U&&(L===Hm?e.cullFace(e.BACK):L===mM?e.cullFace(e.FRONT):e.cullFace(e.FRONT_AND_BACK))):pt(e.CULL_FACE),U=L}function ve(L){L!==F&&(N&&e.lineWidth(L),F=L)}function xt(L,at,ot){L?($(e.POLYGON_OFFSET_FILL),(k!==at||K!==ot)&&(e.polygonOffset(at,ot),k=at,K=ot)):pt(e.POLYGON_OFFSET_FILL)}function Bt(L){L?$(e.SCISSOR_TEST):pt(e.SCISSOR_TEST)}function Ge(L){L===void 0&&(L=e.TEXTURE0+Y-1),tt!==L&&(e.activeTexture(L),tt=L)}function De(L,at,ot){ot===void 0&&(tt===null?ot=e.TEXTURE0+Y-1:ot=tt);let dt=rt[ot];dt===void 0&&(dt={type:void 0,texture:void 0},rt[ot]=dt),(dt.type!==L||dt.texture!==at)&&(tt!==ot&&(e.activeTexture(ot),tt=ot),e.bindTexture(L,at||q[L]),dt.type=L,dt.texture=at)}function R(){const L=rt[tt];L!==void 0&&L.type!==void 0&&(e.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function y(){try{e.compressedTexImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function B(){try{e.compressedTexImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function W(){try{e.texSubImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function J(){try{e.texSubImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function X(){try{e.compressedTexSubImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Et(){try{e.compressedTexSubImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function st(){try{e.texStorage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function St(){try{e.texStorage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function yt(){try{e.texImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function it(){try{e.texImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ft(L){ne.equals(L)===!1&&(e.scissor(L.x,L.y,L.z,L.w),ne.copy(L))}function Ct(L){Zt.equals(L)===!1&&(e.viewport(L.x,L.y,L.z,L.w),Zt.copy(L))}function Mt(L,at){let ot=c.get(at);ot===void 0&&(ot=new WeakMap,c.set(at,ot));let dt=ot.get(L);dt===void 0&&(dt=e.getUniformBlockIndex(at,L.name),ot.set(L,dt))}function ct(L,at){const dt=c.get(at).get(L);l.get(at)!==dt&&(e.uniformBlockBinding(at,dt,L.__bindingPointIndex),l.set(at,dt))}function It(){e.disable(e.BLEND),e.disable(e.CULL_FACE),e.disable(e.DEPTH_TEST),e.disable(e.POLYGON_OFFSET_FILL),e.disable(e.SCISSOR_TEST),e.disable(e.STENCIL_TEST),e.disable(e.SAMPLE_ALPHA_TO_COVERAGE),e.blendEquation(e.FUNC_ADD),e.blendFunc(e.ONE,e.ZERO),e.blendFuncSeparate(e.ONE,e.ZERO,e.ONE,e.ZERO),e.blendColor(0,0,0,0),e.colorMask(!0,!0,!0,!0),e.clearColor(0,0,0,0),e.depthMask(!0),e.depthFunc(e.LESS),s.setReversed(!1),e.clearDepth(1),e.stencilMask(4294967295),e.stencilFunc(e.ALWAYS,0,4294967295),e.stencilOp(e.KEEP,e.KEEP,e.KEEP),e.clearStencil(0),e.cullFace(e.BACK),e.frontFace(e.CCW),e.polygonOffset(0,0),e.activeTexture(e.TEXTURE0),e.bindFramebuffer(e.FRAMEBUFFER,null),e.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),e.bindFramebuffer(e.READ_FRAMEBUFFER,null),e.useProgram(null),e.lineWidth(1),e.scissor(0,0,e.canvas.width,e.canvas.height),e.viewport(0,0,e.canvas.width,e.canvas.height),d={},tt=null,rt={},h={},f=new WeakMap,p=[],x=null,S=!1,g=null,u=null,m=null,_=null,v=null,b=null,C=null,A=new Jt(0,0,0),D=0,T=!1,E=null,U=null,F=null,k=null,K=null,ne.set(0,0,e.canvas.width,e.canvas.height),Zt.set(0,0,e.canvas.width,e.canvas.height),r.reset(),s.reset(),o.reset()}return{buffers:{color:r,depth:s,stencil:o},enable:$,disable:pt,bindFramebuffer:Lt,drawBuffers:Tt,useProgram:qt,setBlending:_e,setMaterial:Pt,setFlipSided:Dt,setCullFace:vt,setLineWidth:ve,setPolygonOffset:xt,setScissorTest:Bt,activeTexture:Ge,bindTexture:De,unbindTexture:R,compressedTexImage2D:y,compressedTexImage3D:B,texImage2D:yt,texImage3D:it,updateUBOMapping:Mt,uniformBlockBinding:ct,texStorage2D:st,texStorage3D:St,texSubImage2D:W,texSubImage3D:J,compressedTexSubImage2D:X,compressedTexSubImage3D:Et,scissor:ft,viewport:Ct,reset:It}}function pR(e,t,n,i,a,r,s){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new $t,d=new WeakMap;let h;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(R,y){return p?new OffscreenCanvas(R,y):Ac("canvas")}function S(R,y,B){let W=1;const J=De(R);if((J.width>B||J.height>B)&&(W=B/Math.max(J.width,J.height)),W<1)if(typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&R instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&R instanceof ImageBitmap||typeof VideoFrame<"u"&&R instanceof VideoFrame){const X=Math.floor(W*J.width),Et=Math.floor(W*J.height);h===void 0&&(h=x(X,Et));const st=y?x(X,Et):h;return st.width=X,st.height=Et,st.getContext("2d").drawImage(R,0,0,X,Et),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+X+"x"+Et+")."),st}else return"data"in R&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),R;return R}function g(R){return R.generateMipmaps}function u(R){e.generateMipmap(R)}function m(R){return R.isWebGLCubeRenderTarget?e.TEXTURE_CUBE_MAP:R.isWebGL3DRenderTarget?e.TEXTURE_3D:R.isWebGLArrayRenderTarget||R.isCompressedArrayTexture?e.TEXTURE_2D_ARRAY:e.TEXTURE_2D}function _(R,y,B,W,J=!1){if(R!==null){if(e[R]!==void 0)return e[R];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+R+"'")}let X=y;if(y===e.RED&&(B===e.FLOAT&&(X=e.R32F),B===e.HALF_FLOAT&&(X=e.R16F),B===e.UNSIGNED_BYTE&&(X=e.R8)),y===e.RED_INTEGER&&(B===e.UNSIGNED_BYTE&&(X=e.R8UI),B===e.UNSIGNED_SHORT&&(X=e.R16UI),B===e.UNSIGNED_INT&&(X=e.R32UI),B===e.BYTE&&(X=e.R8I),B===e.SHORT&&(X=e.R16I),B===e.INT&&(X=e.R32I)),y===e.RG&&(B===e.FLOAT&&(X=e.RG32F),B===e.HALF_FLOAT&&(X=e.RG16F),B===e.UNSIGNED_BYTE&&(X=e.RG8)),y===e.RG_INTEGER&&(B===e.UNSIGNED_BYTE&&(X=e.RG8UI),B===e.UNSIGNED_SHORT&&(X=e.RG16UI),B===e.UNSIGNED_INT&&(X=e.RG32UI),B===e.BYTE&&(X=e.RG8I),B===e.SHORT&&(X=e.RG16I),B===e.INT&&(X=e.RG32I)),y===e.RGB_INTEGER&&(B===e.UNSIGNED_BYTE&&(X=e.RGB8UI),B===e.UNSIGNED_SHORT&&(X=e.RGB16UI),B===e.UNSIGNED_INT&&(X=e.RGB32UI),B===e.BYTE&&(X=e.RGB8I),B===e.SHORT&&(X=e.RGB16I),B===e.INT&&(X=e.RGB32I)),y===e.RGBA_INTEGER&&(B===e.UNSIGNED_BYTE&&(X=e.RGBA8UI),B===e.UNSIGNED_SHORT&&(X=e.RGBA16UI),B===e.UNSIGNED_INT&&(X=e.RGBA32UI),B===e.BYTE&&(X=e.RGBA8I),B===e.SHORT&&(X=e.RGBA16I),B===e.INT&&(X=e.RGBA32I)),y===e.RGB&&(B===e.UNSIGNED_INT_5_9_9_9_REV&&(X=e.RGB9_E5),B===e.UNSIGNED_INT_10F_11F_11F_REV&&(X=e.R11F_G11F_B10F)),y===e.RGBA){const Et=J?Tc:Qt.getTransfer(W);B===e.FLOAT&&(X=e.RGBA32F),B===e.HALF_FLOAT&&(X=e.RGBA16F),B===e.UNSIGNED_BYTE&&(X=Et===oe?e.SRGB8_ALPHA8:e.RGBA8),B===e.UNSIGNED_SHORT_4_4_4_4&&(X=e.RGBA4),B===e.UNSIGNED_SHORT_5_5_5_1&&(X=e.RGB5_A1)}return(X===e.R16F||X===e.R32F||X===e.RG16F||X===e.RG32F||X===e.RGBA16F||X===e.RGBA32F)&&t.get("EXT_color_buffer_float"),X}function v(R,y){let B;return R?y===null||y===er||y===So?B=e.DEPTH24_STENCIL8:y===Ni?B=e.DEPTH32F_STENCIL8:y===xo&&(B=e.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):y===null||y===er||y===So?B=e.DEPTH_COMPONENT24:y===Ni?B=e.DEPTH_COMPONENT32F:y===xo&&(B=e.DEPTH_COMPONENT16),B}function b(R,y){return g(R)===!0||R.isFramebufferTexture&&R.minFilter!==Jn&&R.minFilter!==ri?Math.log2(Math.max(y.width,y.height))+1:R.mipmaps!==void 0&&R.mipmaps.length>0?R.mipmaps.length:R.isCompressedTexture&&Array.isArray(R.image)?y.mipmaps.length:1}function C(R){const y=R.target;y.removeEventListener("dispose",C),D(y),y.isVideoTexture&&d.delete(y)}function A(R){const y=R.target;y.removeEventListener("dispose",A),E(y)}function D(R){const y=i.get(R);if(y.__webglInit===void 0)return;const B=R.source,W=f.get(B);if(W){const J=W[y.__cacheKey];J.usedTimes--,J.usedTimes===0&&T(R),Object.keys(W).length===0&&f.delete(B)}i.remove(R)}function T(R){const y=i.get(R);e.deleteTexture(y.__webglTexture);const B=R.source,W=f.get(B);delete W[y.__cacheKey],s.memory.textures--}function E(R){const y=i.get(R);if(R.depthTexture&&(R.depthTexture.dispose(),i.remove(R.depthTexture)),R.isWebGLCubeRenderTarget)for(let W=0;W<6;W++){if(Array.isArray(y.__webglFramebuffer[W]))for(let J=0;J<y.__webglFramebuffer[W].length;J++)e.deleteFramebuffer(y.__webglFramebuffer[W][J]);else e.deleteFramebuffer(y.__webglFramebuffer[W]);y.__webglDepthbuffer&&e.deleteRenderbuffer(y.__webglDepthbuffer[W])}else{if(Array.isArray(y.__webglFramebuffer))for(let W=0;W<y.__webglFramebuffer.length;W++)e.deleteFramebuffer(y.__webglFramebuffer[W]);else e.deleteFramebuffer(y.__webglFramebuffer);if(y.__webglDepthbuffer&&e.deleteRenderbuffer(y.__webglDepthbuffer),y.__webglMultisampledFramebuffer&&e.deleteFramebuffer(y.__webglMultisampledFramebuffer),y.__webglColorRenderbuffer)for(let W=0;W<y.__webglColorRenderbuffer.length;W++)y.__webglColorRenderbuffer[W]&&e.deleteRenderbuffer(y.__webglColorRenderbuffer[W]);y.__webglDepthRenderbuffer&&e.deleteRenderbuffer(y.__webglDepthRenderbuffer)}const B=R.textures;for(let W=0,J=B.length;W<J;W++){const X=i.get(B[W]);X.__webglTexture&&(e.deleteTexture(X.__webglTexture),s.memory.textures--),i.remove(B[W])}i.remove(R)}let U=0;function F(){U=0}function k(){const R=U;return R>=a.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+R+" texture units while this GPU supports only "+a.maxTextures),U+=1,R}function K(R){const y=[];return y.push(R.wrapS),y.push(R.wrapT),y.push(R.wrapR||0),y.push(R.magFilter),y.push(R.minFilter),y.push(R.anisotropy),y.push(R.internalFormat),y.push(R.format),y.push(R.type),y.push(R.generateMipmaps),y.push(R.premultiplyAlpha),y.push(R.flipY),y.push(R.unpackAlignment),y.push(R.colorSpace),y.join()}function Y(R,y){const B=i.get(R);if(R.isVideoTexture&&Bt(R),R.isRenderTargetTexture===!1&&R.isExternalTexture!==!0&&R.version>0&&B.__version!==R.version){const W=R.image;if(W===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{q(B,R,y);return}}else R.isExternalTexture&&(B.__webglTexture=R.sourceTexture?R.sourceTexture:null);n.bindTexture(e.TEXTURE_2D,B.__webglTexture,e.TEXTURE0+y)}function N(R,y){const B=i.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&B.__version!==R.version){q(B,R,y);return}n.bindTexture(e.TEXTURE_2D_ARRAY,B.__webglTexture,e.TEXTURE0+y)}function V(R,y){const B=i.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&B.__version!==R.version){q(B,R,y);return}n.bindTexture(e.TEXTURE_3D,B.__webglTexture,e.TEXTURE0+y)}function I(R,y){const B=i.get(R);if(R.version>0&&B.__version!==R.version){$(B,R,y);return}n.bindTexture(e.TEXTURE_CUBE_MAP,B.__webglTexture,e.TEXTURE0+y)}const tt={[_h]:e.REPEAT,[Va]:e.CLAMP_TO_EDGE,[vh]:e.MIRRORED_REPEAT},rt={[Jn]:e.NEAREST,[kM]:e.NEAREST_MIPMAP_NEAREST,[ll]:e.NEAREST_MIPMAP_LINEAR,[ri]:e.LINEAR,[Uu]:e.LINEAR_MIPMAP_NEAREST,[ka]:e.LINEAR_MIPMAP_LINEAR},_t={[qM]:e.NEVER,[$M]:e.ALWAYS,[jM]:e.LESS,[Yv]:e.LEQUAL,[ZM]:e.EQUAL,[JM]:e.GEQUAL,[KM]:e.GREATER,[QM]:e.NOTEQUAL};function Ot(R,y){if(y.type===Ni&&t.has("OES_texture_float_linear")===!1&&(y.magFilter===ri||y.magFilter===Uu||y.magFilter===ll||y.magFilter===ka||y.minFilter===ri||y.minFilter===Uu||y.minFilter===ll||y.minFilter===ka)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),e.texParameteri(R,e.TEXTURE_WRAP_S,tt[y.wrapS]),e.texParameteri(R,e.TEXTURE_WRAP_T,tt[y.wrapT]),(R===e.TEXTURE_3D||R===e.TEXTURE_2D_ARRAY)&&e.texParameteri(R,e.TEXTURE_WRAP_R,tt[y.wrapR]),e.texParameteri(R,e.TEXTURE_MAG_FILTER,rt[y.magFilter]),e.texParameteri(R,e.TEXTURE_MIN_FILTER,rt[y.minFilter]),y.compareFunction&&(e.texParameteri(R,e.TEXTURE_COMPARE_MODE,e.COMPARE_REF_TO_TEXTURE),e.texParameteri(R,e.TEXTURE_COMPARE_FUNC,_t[y.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(y.magFilter===Jn||y.minFilter!==ll&&y.minFilter!==ka||y.type===Ni&&t.has("OES_texture_float_linear")===!1)return;if(y.anisotropy>1||i.get(y).__currentAnisotropy){const B=t.get("EXT_texture_filter_anisotropic");e.texParameterf(R,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(y.anisotropy,a.getMaxAnisotropy())),i.get(y).__currentAnisotropy=y.anisotropy}}}function ne(R,y){let B=!1;R.__webglInit===void 0&&(R.__webglInit=!0,y.addEventListener("dispose",C));const W=y.source;let J=f.get(W);J===void 0&&(J={},f.set(W,J));const X=K(y);if(X!==R.__cacheKey){J[X]===void 0&&(J[X]={texture:e.createTexture(),usedTimes:0},s.memory.textures++,B=!0),J[X].usedTimes++;const Et=J[R.__cacheKey];Et!==void 0&&(J[R.__cacheKey].usedTimes--,Et.usedTimes===0&&T(y)),R.__cacheKey=X,R.__webglTexture=J[X].texture}return B}function Zt(R,y,B){return Math.floor(Math.floor(R/B)/y)}function Wt(R,y,B,W){const X=R.updateRanges;if(X.length===0)n.texSubImage2D(e.TEXTURE_2D,0,0,0,y.width,y.height,B,W,y.data);else{X.sort((it,ft)=>it.start-ft.start);let Et=0;for(let it=1;it<X.length;it++){const ft=X[Et],Ct=X[it],Mt=ft.start+ft.count,ct=Zt(Ct.start,y.width,4),It=Zt(ft.start,y.width,4);Ct.start<=Mt+1&&ct===It&&Zt(Ct.start+Ct.count-1,y.width,4)===ct?ft.count=Math.max(ft.count,Ct.start+Ct.count-ft.start):(++Et,X[Et]=Ct)}X.length=Et+1;const st=e.getParameter(e.UNPACK_ROW_LENGTH),St=e.getParameter(e.UNPACK_SKIP_PIXELS),yt=e.getParameter(e.UNPACK_SKIP_ROWS);e.pixelStorei(e.UNPACK_ROW_LENGTH,y.width);for(let it=0,ft=X.length;it<ft;it++){const Ct=X[it],Mt=Math.floor(Ct.start/4),ct=Math.ceil(Ct.count/4),It=Mt%y.width,L=Math.floor(Mt/y.width),at=ct,ot=1;e.pixelStorei(e.UNPACK_SKIP_PIXELS,It),e.pixelStorei(e.UNPACK_SKIP_ROWS,L),n.texSubImage2D(e.TEXTURE_2D,0,It,L,at,ot,B,W,y.data)}R.clearUpdateRanges(),e.pixelStorei(e.UNPACK_ROW_LENGTH,st),e.pixelStorei(e.UNPACK_SKIP_PIXELS,St),e.pixelStorei(e.UNPACK_SKIP_ROWS,yt)}}function q(R,y,B){let W=e.TEXTURE_2D;(y.isDataArrayTexture||y.isCompressedArrayTexture)&&(W=e.TEXTURE_2D_ARRAY),y.isData3DTexture&&(W=e.TEXTURE_3D);const J=ne(R,y),X=y.source;n.bindTexture(W,R.__webglTexture,e.TEXTURE0+B);const Et=i.get(X);if(X.version!==Et.__version||J===!0){n.activeTexture(e.TEXTURE0+B);const st=Qt.getPrimaries(Qt.workingColorSpace),St=y.colorSpace===aa?null:Qt.getPrimaries(y.colorSpace),yt=y.colorSpace===aa||st===St?e.NONE:e.BROWSER_DEFAULT_WEBGL;e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,y.flipY),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),e.pixelStorei(e.UNPACK_ALIGNMENT,y.unpackAlignment),e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,yt);let it=S(y.image,!1,a.maxTextureSize);it=Ge(y,it);const ft=r.convert(y.format,y.colorSpace),Ct=r.convert(y.type);let Mt=_(y.internalFormat,ft,Ct,y.colorSpace,y.isVideoTexture);Ot(W,y);let ct;const It=y.mipmaps,L=y.isVideoTexture!==!0,at=Et.__version===void 0||J===!0,ot=X.dataReady,dt=b(y,it);if(y.isDepthTexture)Mt=v(y.format===Mo,y.type),at&&(L?n.texStorage2D(e.TEXTURE_2D,1,Mt,it.width,it.height):n.texImage2D(e.TEXTURE_2D,0,Mt,it.width,it.height,0,ft,Ct,null));else if(y.isDataTexture)if(It.length>0){L&&at&&n.texStorage2D(e.TEXTURE_2D,dt,Mt,It[0].width,It[0].height);for(let et=0,Z=It.length;et<Z;et++)ct=It[et],L?ot&&n.texSubImage2D(e.TEXTURE_2D,et,0,0,ct.width,ct.height,ft,Ct,ct.data):n.texImage2D(e.TEXTURE_2D,et,Mt,ct.width,ct.height,0,ft,Ct,ct.data);y.generateMipmaps=!1}else L?(at&&n.texStorage2D(e.TEXTURE_2D,dt,Mt,it.width,it.height),ot&&Wt(y,it,ft,Ct)):n.texImage2D(e.TEXTURE_2D,0,Mt,it.width,it.height,0,ft,Ct,it.data);else if(y.isCompressedTexture)if(y.isCompressedArrayTexture){L&&at&&n.texStorage3D(e.TEXTURE_2D_ARRAY,dt,Mt,It[0].width,It[0].height,it.depth);for(let et=0,Z=It.length;et<Z;et++)if(ct=It[et],y.format!==Kn)if(ft!==null)if(L){if(ot)if(y.layerUpdates.size>0){const gt=dg(ct.width,ct.height,y.format,y.type);for(const Nt of y.layerUpdates){const de=ct.data.subarray(Nt*gt/ct.data.BYTES_PER_ELEMENT,(Nt+1)*gt/ct.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,et,0,0,Nt,ct.width,ct.height,1,ft,de)}y.clearLayerUpdates()}else n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,et,0,0,0,ct.width,ct.height,it.depth,ft,ct.data)}else n.compressedTexImage3D(e.TEXTURE_2D_ARRAY,et,Mt,ct.width,ct.height,it.depth,0,ct.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else L?ot&&n.texSubImage3D(e.TEXTURE_2D_ARRAY,et,0,0,0,ct.width,ct.height,it.depth,ft,Ct,ct.data):n.texImage3D(e.TEXTURE_2D_ARRAY,et,Mt,ct.width,ct.height,it.depth,0,ft,Ct,ct.data)}else{L&&at&&n.texStorage2D(e.TEXTURE_2D,dt,Mt,It[0].width,It[0].height);for(let et=0,Z=It.length;et<Z;et++)ct=It[et],y.format!==Kn?ft!==null?L?ot&&n.compressedTexSubImage2D(e.TEXTURE_2D,et,0,0,ct.width,ct.height,ft,ct.data):n.compressedTexImage2D(e.TEXTURE_2D,et,Mt,ct.width,ct.height,0,ct.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):L?ot&&n.texSubImage2D(e.TEXTURE_2D,et,0,0,ct.width,ct.height,ft,Ct,ct.data):n.texImage2D(e.TEXTURE_2D,et,Mt,ct.width,ct.height,0,ft,Ct,ct.data)}else if(y.isDataArrayTexture)if(L){if(at&&n.texStorage3D(e.TEXTURE_2D_ARRAY,dt,Mt,it.width,it.height,it.depth),ot)if(y.layerUpdates.size>0){const et=dg(it.width,it.height,y.format,y.type);for(const Z of y.layerUpdates){const gt=it.data.subarray(Z*et/it.data.BYTES_PER_ELEMENT,(Z+1)*et/it.data.BYTES_PER_ELEMENT);n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,Z,it.width,it.height,1,ft,Ct,gt)}y.clearLayerUpdates()}else n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,0,it.width,it.height,it.depth,ft,Ct,it.data)}else n.texImage3D(e.TEXTURE_2D_ARRAY,0,Mt,it.width,it.height,it.depth,0,ft,Ct,it.data);else if(y.isData3DTexture)L?(at&&n.texStorage3D(e.TEXTURE_3D,dt,Mt,it.width,it.height,it.depth),ot&&n.texSubImage3D(e.TEXTURE_3D,0,0,0,0,it.width,it.height,it.depth,ft,Ct,it.data)):n.texImage3D(e.TEXTURE_3D,0,Mt,it.width,it.height,it.depth,0,ft,Ct,it.data);else if(y.isFramebufferTexture){if(at)if(L)n.texStorage2D(e.TEXTURE_2D,dt,Mt,it.width,it.height);else{let et=it.width,Z=it.height;for(let gt=0;gt<dt;gt++)n.texImage2D(e.TEXTURE_2D,gt,Mt,et,Z,0,ft,Ct,null),et>>=1,Z>>=1}}else if(It.length>0){if(L&&at){const et=De(It[0]);n.texStorage2D(e.TEXTURE_2D,dt,Mt,et.width,et.height)}for(let et=0,Z=It.length;et<Z;et++)ct=It[et],L?ot&&n.texSubImage2D(e.TEXTURE_2D,et,0,0,ft,Ct,ct):n.texImage2D(e.TEXTURE_2D,et,Mt,ft,Ct,ct);y.generateMipmaps=!1}else if(L){if(at){const et=De(it);n.texStorage2D(e.TEXTURE_2D,dt,Mt,et.width,et.height)}ot&&n.texSubImage2D(e.TEXTURE_2D,0,0,0,ft,Ct,it)}else n.texImage2D(e.TEXTURE_2D,0,Mt,ft,Ct,it);g(y)&&u(W),Et.__version=X.version,y.onUpdate&&y.onUpdate(y)}R.__version=y.version}function $(R,y,B){if(y.image.length!==6)return;const W=ne(R,y),J=y.source;n.bindTexture(e.TEXTURE_CUBE_MAP,R.__webglTexture,e.TEXTURE0+B);const X=i.get(J);if(J.version!==X.__version||W===!0){n.activeTexture(e.TEXTURE0+B);const Et=Qt.getPrimaries(Qt.workingColorSpace),st=y.colorSpace===aa?null:Qt.getPrimaries(y.colorSpace),St=y.colorSpace===aa||Et===st?e.NONE:e.BROWSER_DEFAULT_WEBGL;e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,y.flipY),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),e.pixelStorei(e.UNPACK_ALIGNMENT,y.unpackAlignment),e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,St);const yt=y.isCompressedTexture||y.image[0].isCompressedTexture,it=y.image[0]&&y.image[0].isDataTexture,ft=[];for(let Z=0;Z<6;Z++)!yt&&!it?ft[Z]=S(y.image[Z],!0,a.maxCubemapSize):ft[Z]=it?y.image[Z].image:y.image[Z],ft[Z]=Ge(y,ft[Z]);const Ct=ft[0],Mt=r.convert(y.format,y.colorSpace),ct=r.convert(y.type),It=_(y.internalFormat,Mt,ct,y.colorSpace),L=y.isVideoTexture!==!0,at=X.__version===void 0||W===!0,ot=J.dataReady;let dt=b(y,Ct);Ot(e.TEXTURE_CUBE_MAP,y);let et;if(yt){L&&at&&n.texStorage2D(e.TEXTURE_CUBE_MAP,dt,It,Ct.width,Ct.height);for(let Z=0;Z<6;Z++){et=ft[Z].mipmaps;for(let gt=0;gt<et.length;gt++){const Nt=et[gt];y.format!==Kn?Mt!==null?L?ot&&n.compressedTexSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,gt,0,0,Nt.width,Nt.height,Mt,Nt.data):n.compressedTexImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,gt,It,Nt.width,Nt.height,0,Nt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):L?ot&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,gt,0,0,Nt.width,Nt.height,Mt,ct,Nt.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,gt,It,Nt.width,Nt.height,0,Mt,ct,Nt.data)}}}else{if(et=y.mipmaps,L&&at){et.length>0&&dt++;const Z=De(ft[0]);n.texStorage2D(e.TEXTURE_CUBE_MAP,dt,It,Z.width,Z.height)}for(let Z=0;Z<6;Z++)if(it){L?ot&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,ft[Z].width,ft[Z].height,Mt,ct,ft[Z].data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,It,ft[Z].width,ft[Z].height,0,Mt,ct,ft[Z].data);for(let gt=0;gt<et.length;gt++){const de=et[gt].image[Z].image;L?ot&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,gt+1,0,0,de.width,de.height,Mt,ct,de.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,gt+1,It,de.width,de.height,0,Mt,ct,de.data)}}else{L?ot&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,Mt,ct,ft[Z]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,It,Mt,ct,ft[Z]);for(let gt=0;gt<et.length;gt++){const Nt=et[gt];L?ot&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,gt+1,0,0,Mt,ct,Nt.image[Z]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,gt+1,It,Mt,ct,Nt.image[Z])}}}g(y)&&u(e.TEXTURE_CUBE_MAP),X.__version=J.version,y.onUpdate&&y.onUpdate(y)}R.__version=y.version}function pt(R,y,B,W,J,X){const Et=r.convert(B.format,B.colorSpace),st=r.convert(B.type),St=_(B.internalFormat,Et,st,B.colorSpace),yt=i.get(y),it=i.get(B);if(it.__renderTarget=y,!yt.__hasExternalTextures){const ft=Math.max(1,y.width>>X),Ct=Math.max(1,y.height>>X);J===e.TEXTURE_3D||J===e.TEXTURE_2D_ARRAY?n.texImage3D(J,X,St,ft,Ct,y.depth,0,Et,st,null):n.texImage2D(J,X,St,ft,Ct,0,Et,st,null)}n.bindFramebuffer(e.FRAMEBUFFER,R),xt(y)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,W,J,it.__webglTexture,0,ve(y)):(J===e.TEXTURE_2D||J>=e.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=e.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&e.framebufferTexture2D(e.FRAMEBUFFER,W,J,it.__webglTexture,X),n.bindFramebuffer(e.FRAMEBUFFER,null)}function Lt(R,y,B){if(e.bindRenderbuffer(e.RENDERBUFFER,R),y.depthBuffer){const W=y.depthTexture,J=W&&W.isDepthTexture?W.type:null,X=v(y.stencilBuffer,J),Et=y.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,st=ve(y);xt(y)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,st,X,y.width,y.height):B?e.renderbufferStorageMultisample(e.RENDERBUFFER,st,X,y.width,y.height):e.renderbufferStorage(e.RENDERBUFFER,X,y.width,y.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,Et,e.RENDERBUFFER,R)}else{const W=y.textures;for(let J=0;J<W.length;J++){const X=W[J],Et=r.convert(X.format,X.colorSpace),st=r.convert(X.type),St=_(X.internalFormat,Et,st,X.colorSpace),yt=ve(y);B&&xt(y)===!1?e.renderbufferStorageMultisample(e.RENDERBUFFER,yt,St,y.width,y.height):xt(y)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,yt,St,y.width,y.height):e.renderbufferStorage(e.RENDERBUFFER,St,y.width,y.height)}}e.bindRenderbuffer(e.RENDERBUFFER,null)}function Tt(R,y){if(y&&y.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(e.FRAMEBUFFER,R),!(y.depthTexture&&y.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const W=i.get(y.depthTexture);W.__renderTarget=y,(!W.__webglTexture||y.depthTexture.image.width!==y.width||y.depthTexture.image.height!==y.height)&&(y.depthTexture.image.width=y.width,y.depthTexture.image.height=y.height,y.depthTexture.needsUpdate=!0),Y(y.depthTexture,0);const J=W.__webglTexture,X=ve(y);if(y.depthTexture.format===yo)xt(y)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,e.DEPTH_ATTACHMENT,e.TEXTURE_2D,J,0,X):e.framebufferTexture2D(e.FRAMEBUFFER,e.DEPTH_ATTACHMENT,e.TEXTURE_2D,J,0);else if(y.depthTexture.format===Mo)xt(y)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,e.DEPTH_STENCIL_ATTACHMENT,e.TEXTURE_2D,J,0,X):e.framebufferTexture2D(e.FRAMEBUFFER,e.DEPTH_STENCIL_ATTACHMENT,e.TEXTURE_2D,J,0);else throw new Error("Unknown depthTexture format")}function qt(R){const y=i.get(R),B=R.isWebGLCubeRenderTarget===!0;if(y.__boundDepthTexture!==R.depthTexture){const W=R.depthTexture;if(y.__depthDisposeCallback&&y.__depthDisposeCallback(),W){const J=()=>{delete y.__boundDepthTexture,delete y.__depthDisposeCallback,W.removeEventListener("dispose",J)};W.addEventListener("dispose",J),y.__depthDisposeCallback=J}y.__boundDepthTexture=W}if(R.depthTexture&&!y.__autoAllocateDepthBuffer){if(B)throw new Error("target.depthTexture not supported in Cube render targets");const W=R.texture.mipmaps;W&&W.length>0?Tt(y.__webglFramebuffer[0],R):Tt(y.__webglFramebuffer,R)}else if(B){y.__webglDepthbuffer=[];for(let W=0;W<6;W++)if(n.bindFramebuffer(e.FRAMEBUFFER,y.__webglFramebuffer[W]),y.__webglDepthbuffer[W]===void 0)y.__webglDepthbuffer[W]=e.createRenderbuffer(),Lt(y.__webglDepthbuffer[W],R,!1);else{const J=R.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,X=y.__webglDepthbuffer[W];e.bindRenderbuffer(e.RENDERBUFFER,X),e.framebufferRenderbuffer(e.FRAMEBUFFER,J,e.RENDERBUFFER,X)}}else{const W=R.texture.mipmaps;if(W&&W.length>0?n.bindFramebuffer(e.FRAMEBUFFER,y.__webglFramebuffer[0]):n.bindFramebuffer(e.FRAMEBUFFER,y.__webglFramebuffer),y.__webglDepthbuffer===void 0)y.__webglDepthbuffer=e.createRenderbuffer(),Lt(y.__webglDepthbuffer,R,!1);else{const J=R.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,X=y.__webglDepthbuffer;e.bindRenderbuffer(e.RENDERBUFFER,X),e.framebufferRenderbuffer(e.FRAMEBUFFER,J,e.RENDERBUFFER,X)}}n.bindFramebuffer(e.FRAMEBUFFER,null)}function Ke(R,y,B){const W=i.get(R);y!==void 0&&pt(W.__webglFramebuffer,R,R.texture,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,0),B!==void 0&&qt(R)}function w(R){const y=R.texture,B=i.get(R),W=i.get(y);R.addEventListener("dispose",A);const J=R.textures,X=R.isWebGLCubeRenderTarget===!0,Et=J.length>1;if(Et||(W.__webglTexture===void 0&&(W.__webglTexture=e.createTexture()),W.__version=y.version,s.memory.textures++),X){B.__webglFramebuffer=[];for(let st=0;st<6;st++)if(y.mipmaps&&y.mipmaps.length>0){B.__webglFramebuffer[st]=[];for(let St=0;St<y.mipmaps.length;St++)B.__webglFramebuffer[st][St]=e.createFramebuffer()}else B.__webglFramebuffer[st]=e.createFramebuffer()}else{if(y.mipmaps&&y.mipmaps.length>0){B.__webglFramebuffer=[];for(let st=0;st<y.mipmaps.length;st++)B.__webglFramebuffer[st]=e.createFramebuffer()}else B.__webglFramebuffer=e.createFramebuffer();if(Et)for(let st=0,St=J.length;st<St;st++){const yt=i.get(J[st]);yt.__webglTexture===void 0&&(yt.__webglTexture=e.createTexture(),s.memory.textures++)}if(R.samples>0&&xt(R)===!1){B.__webglMultisampledFramebuffer=e.createFramebuffer(),B.__webglColorRenderbuffer=[],n.bindFramebuffer(e.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let st=0;st<J.length;st++){const St=J[st];B.__webglColorRenderbuffer[st]=e.createRenderbuffer(),e.bindRenderbuffer(e.RENDERBUFFER,B.__webglColorRenderbuffer[st]);const yt=r.convert(St.format,St.colorSpace),it=r.convert(St.type),ft=_(St.internalFormat,yt,it,St.colorSpace,R.isXRRenderTarget===!0),Ct=ve(R);e.renderbufferStorageMultisample(e.RENDERBUFFER,Ct,ft,R.width,R.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+st,e.RENDERBUFFER,B.__webglColorRenderbuffer[st])}e.bindRenderbuffer(e.RENDERBUFFER,null),R.depthBuffer&&(B.__webglDepthRenderbuffer=e.createRenderbuffer(),Lt(B.__webglDepthRenderbuffer,R,!0)),n.bindFramebuffer(e.FRAMEBUFFER,null)}}if(X){n.bindTexture(e.TEXTURE_CUBE_MAP,W.__webglTexture),Ot(e.TEXTURE_CUBE_MAP,y);for(let st=0;st<6;st++)if(y.mipmaps&&y.mipmaps.length>0)for(let St=0;St<y.mipmaps.length;St++)pt(B.__webglFramebuffer[st][St],R,y,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+st,St);else pt(B.__webglFramebuffer[st],R,y,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+st,0);g(y)&&u(e.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Et){for(let st=0,St=J.length;st<St;st++){const yt=J[st],it=i.get(yt);let ft=e.TEXTURE_2D;(R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(ft=R.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(ft,it.__webglTexture),Ot(ft,yt),pt(B.__webglFramebuffer,R,yt,e.COLOR_ATTACHMENT0+st,ft,0),g(yt)&&u(ft)}n.unbindTexture()}else{let st=e.TEXTURE_2D;if((R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(st=R.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(st,W.__webglTexture),Ot(st,y),y.mipmaps&&y.mipmaps.length>0)for(let St=0;St<y.mipmaps.length;St++)pt(B.__webglFramebuffer[St],R,y,e.COLOR_ATTACHMENT0,st,St);else pt(B.__webglFramebuffer,R,y,e.COLOR_ATTACHMENT0,st,0);g(y)&&u(st),n.unbindTexture()}R.depthBuffer&&qt(R)}function _e(R){const y=R.textures;for(let B=0,W=y.length;B<W;B++){const J=y[B];if(g(J)){const X=m(R),Et=i.get(J).__webglTexture;n.bindTexture(X,Et),u(X),n.unbindTexture()}}}const Pt=[],Dt=[];function vt(R){if(R.samples>0){if(xt(R)===!1){const y=R.textures,B=R.width,W=R.height;let J=e.COLOR_BUFFER_BIT;const X=R.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,Et=i.get(R),st=y.length>1;if(st)for(let yt=0;yt<y.length;yt++)n.bindFramebuffer(e.FRAMEBUFFER,Et.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+yt,e.RENDERBUFFER,null),n.bindFramebuffer(e.FRAMEBUFFER,Et.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+yt,e.TEXTURE_2D,null,0);n.bindFramebuffer(e.READ_FRAMEBUFFER,Et.__webglMultisampledFramebuffer);const St=R.texture.mipmaps;St&&St.length>0?n.bindFramebuffer(e.DRAW_FRAMEBUFFER,Et.__webglFramebuffer[0]):n.bindFramebuffer(e.DRAW_FRAMEBUFFER,Et.__webglFramebuffer);for(let yt=0;yt<y.length;yt++){if(R.resolveDepthBuffer&&(R.depthBuffer&&(J|=e.DEPTH_BUFFER_BIT),R.stencilBuffer&&R.resolveStencilBuffer&&(J|=e.STENCIL_BUFFER_BIT)),st){e.framebufferRenderbuffer(e.READ_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.RENDERBUFFER,Et.__webglColorRenderbuffer[yt]);const it=i.get(y[yt]).__webglTexture;e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,it,0)}e.blitFramebuffer(0,0,B,W,0,0,B,W,J,e.NEAREST),l===!0&&(Pt.length=0,Dt.length=0,Pt.push(e.COLOR_ATTACHMENT0+yt),R.depthBuffer&&R.resolveDepthBuffer===!1&&(Pt.push(X),Dt.push(X),e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,Dt)),e.invalidateFramebuffer(e.READ_FRAMEBUFFER,Pt))}if(n.bindFramebuffer(e.READ_FRAMEBUFFER,null),n.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),st)for(let yt=0;yt<y.length;yt++){n.bindFramebuffer(e.FRAMEBUFFER,Et.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+yt,e.RENDERBUFFER,Et.__webglColorRenderbuffer[yt]);const it=i.get(y[yt]).__webglTexture;n.bindFramebuffer(e.FRAMEBUFFER,Et.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+yt,e.TEXTURE_2D,it,0)}n.bindFramebuffer(e.DRAW_FRAMEBUFFER,Et.__webglMultisampledFramebuffer)}else if(R.depthBuffer&&R.resolveDepthBuffer===!1&&l){const y=R.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,[y])}}}function ve(R){return Math.min(a.maxSamples,R.samples)}function xt(R){const y=i.get(R);return R.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&y.__useRenderToTexture!==!1}function Bt(R){const y=s.render.frame;d.get(R)!==y&&(d.set(R,y),R.update())}function Ge(R,y){const B=R.colorSpace,W=R.format,J=R.type;return R.isCompressedTexture===!0||R.isVideoTexture===!0||B!==fs&&B!==aa&&(Qt.getTransfer(B)===oe?(W!==Kn||J!==hi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",B)),y}function De(R){return typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement?(c.width=R.naturalWidth||R.width,c.height=R.naturalHeight||R.height):typeof VideoFrame<"u"&&R instanceof VideoFrame?(c.width=R.displayWidth,c.height=R.displayHeight):(c.width=R.width,c.height=R.height),c}this.allocateTextureUnit=k,this.resetTextureUnits=F,this.setTexture2D=Y,this.setTexture2DArray=N,this.setTexture3D=V,this.setTextureCube=I,this.rebindTextures=Ke,this.setupRenderTarget=w,this.updateRenderTargetMipmap=_e,this.updateMultisampleRenderTarget=vt,this.setupDepthRenderbuffer=qt,this.setupFrameBufferTexture=pt,this.useMultisampledRTT=xt}function mR(e,t){function n(i,a=aa){let r;const s=Qt.getTransfer(a);if(i===hi)return e.UNSIGNED_BYTE;if(i===Qd)return e.UNSIGNED_SHORT_4_4_4_4;if(i===Jd)return e.UNSIGNED_SHORT_5_5_5_1;if(i===Fv)return e.UNSIGNED_INT_5_9_9_9_REV;if(i===Hv)return e.UNSIGNED_INT_10F_11F_11F_REV;if(i===zv)return e.BYTE;if(i===Bv)return e.SHORT;if(i===xo)return e.UNSIGNED_SHORT;if(i===Kd)return e.INT;if(i===er)return e.UNSIGNED_INT;if(i===Ni)return e.FLOAT;if(i===Ho)return e.HALF_FLOAT;if(i===Gv)return e.ALPHA;if(i===Vv)return e.RGB;if(i===Kn)return e.RGBA;if(i===yo)return e.DEPTH_COMPONENT;if(i===Mo)return e.DEPTH_STENCIL;if(i===kv)return e.RED;if(i===$d)return e.RED_INTEGER;if(i===Xv)return e.RG;if(i===tp)return e.RG_INTEGER;if(i===ep)return e.RGBA_INTEGER;if(i===kl||i===Xl||i===Wl||i===Yl)if(s===oe)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===kl)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Xl)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Wl)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Yl)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===kl)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Xl)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Wl)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Yl)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===xh||i===Sh||i===yh||i===Mh)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===xh)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Sh)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===yh)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Mh)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Eh||i===Th||i===bh)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(i===Eh||i===Th)return s===oe?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===bh)return s===oe?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===Ah||i===Rh||i===Ch||i===wh||i===Dh||i===Uh||i===Lh||i===Nh||i===Oh||i===Ph||i===Ih||i===zh||i===Bh||i===Fh)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(i===Ah)return s===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Rh)return s===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Ch)return s===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===wh)return s===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Dh)return s===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Uh)return s===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Lh)return s===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Nh)return s===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Oh)return s===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Ph)return s===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Ih)return s===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===zh)return s===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Bh)return s===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Fh)return s===oe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Hh||i===Gh||i===Vh)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(i===Hh)return s===oe?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Gh)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Vh)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===kh||i===Xh||i===Wh||i===Yh)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(i===kh)return r.COMPRESSED_RED_RGTC1_EXT;if(i===Xh)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Wh)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Yh)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===So?e.UNSIGNED_INT_24_8:e[i]!==void 0?e[i]:null}return{convert:n}}const gR=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        `})]}):l==="fluid"?Q.jsxs("div",{style:{position:"relative"},children:[Q.jsx("button",{onClick:()=>c("home"),style:{position:"fixed",top:"30px",left:"30px",zIndex:1e3,background:"rgba(255, 255, 255, 0.1)",border:"1px solid rgba(255, 255, 255, 0.3)",color:"white",padding:"12px 24px",borderRadius:"8px",cursor:"pointer",fontSize:"1rem",fontFamily:"'Inter', sans-serif",backdropFilter:"blur(10px)",transition:"all 0.3s ease"},onMouseEnter:m=>{m.target.style.background="rgba(255, 255, 255, 0.2)",m.target.style.borderColor="rgba(255, 255, 255, 0.5)"},onMouseLeave:m=>{m.target.style.background="rgba(255, 255, 255, 0.1)",m.target.style.borderColor="rgba(255, 255, 255, 0.3)"},children:"← Back to Portfolio"}),Q.jsx(bR,{})]}):Q.jsxs("div",{style:{width:"100vw",height:"100vh",background:"#000000",color:"white",margin:0,padding:0,overflow:"hidden auto",scrollSnapType:"y mandatory"},children:[Q.jsx("nav",{style:{position:"fixed",top:"30px",right:"30px",zIndex:1e3,display:"flex",gap:"15px"},children:Q.jsx("button",{onClick:()=>c("fluid"),style:{background:"rgba(255, 255, 255, 0.1)",border:"1px solid rgba(255, 255, 255, 0.3)",color:"white",padding:"12px 24px",borderRadius:"8px",cursor:"pointer",fontSize:"0.9rem",fontFamily:"'Inter', sans-serif",backdropFilter:"blur(10px)",transition:"all 0.3s ease"},onMouseEnter:m=>{m.target.style.background="rgba(100, 120, 255, 0.3)",m.target.style.borderColor="rgba(100, 120, 255, 0.5)"},onMouseLeave:m=>{m.target.style.background="rgba(255, 255, 255, 0.1)",m.target.style.borderColor="rgba(255, 255, 255, 0.3)"},children:"🌊 Fluid Particles"})}),Q.jsxs("section",{style:{minHeight:"100vh",height:"100vh",width:"100vw",padding:"40px",background:"linear-gradient(135deg, #000000 0%, #1a1a1a 50%, #000000 100%)",display:"flex",alignItems:"center",justifyContent:"space-between",position:"relative",scrollSnapAlign:"start",scrollSnapStop:"always",overflow:"hidden"},children:[Q.jsxs("div",{style:{flex:"1",display:"flex",flexDirection:"column",justifyContent:"center",padding:"0 80px",zIndex:2},children:[Q.jsx("h1",{style:{fontSize:"clamp(3rem, 6vw, 5rem)",fontWeight:"100",margin:"0 0 20px 0",letterSpacing:"-0.03em",lineHeight:"1.1",background:"linear-gradient(135deg, #ffffff 0%, #888888 100%)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",fontFamily:"'Inter', sans-serif"},children:"OYXR"}),Q.jsx("div",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.3em",marginBottom:"50px",textTransform:"uppercase",fontWeight:"300",fontFamily:"'Inter', sans-serif"},children:"Designer · Coder · Gamer · Occasional Reality Glitcher"})]}),Q.jsxs("div",{style:{flex:"1",display:"flex",alignItems:"center",justifyContent:"flex-start",padding:"0 80px 0 20px",perspective:"1000px",position:"relative"},children:[Q.jsx("div",{style:{position:"absolute",top:"20%",right:"-100px",width:"300px",height:"300px",opacity:.3,zIndex:0,pointerEvents:"none"},children:Q.jsx(TR,{modelSize:1.5,rotationSpeed:.01,showWireframe:!0,color:4890367,geometry:"torus"})}),Q.jsxs("div",{style:{position:"relative",width:"100%",maxWidth:"700px",height:"400px",zIndex:1},children:[Q.jsx("div",{style:{position:"absolute",top:"50%",left:"50%",width:"600px",height:"300px",transform:`translate(-50%, -50%) rotateY(${n*-90}deg)`,transformStyle:"preserve-3d",transition:a?"transform 0.8s cubic-bezier(0.4, 0, 0.2, 1)":"none"},children:x.map((m,_)=>{const v=_*90,b=_===n;return Q.jsx("div",{style:{position:"absolute",width:"450px",height:"280px",top:"50%",left:"50%",transform:`translate(-50%, -50%) rotateY(${v}deg) translateZ(300px)`,transformStyle:"preserve-3d",cursor:"pointer",transition:"all 0.3s ease"},onClick:()=>t(m),children:Q.jsxs("div",{style:{width:"100%",height:"100%",background:"rgba(0,0,0,0.8)",borderRadius:"16px",border:b?"2px solid rgba(255,255,255,0.3)":"1px solid rgba(255,255,255,0.1)",overflow:"hidden",position:"relative",transform:b?"scale(1.05)":"scale(0.9)",opacity:b?1:.7,transition:"all 0.3s ease",boxShadow:b?"0 20px 40px rgba(0,0,0,0.5)":"0 10px 20px rgba(0,0,0,0.3)",display:"flex",padding:"20px",gap:"20px"},children:[Q.jsxs("div",{style:{flex:"2",display:"flex",alignItems:"center",justifyContent:"center",backgroundColor:"rgba(255,255,255,0.05)",borderRadius:"12px",overflow:"hidden"},children:[Q.jsx("img",{src:m.image,alt:m.title,style:{maxWidth:"100%",maxHeight:"100%",objectFit:"contain",borderRadius:"8px"},onError:C=>{C.target.style.display="none",C.target.nextSibling.style.display="flex"}}),Q.jsx("div",{style:{display:"none",alignItems:"center",justifyContent:"center",color:"rgba(255,255,255,0.6)",fontSize:"1rem",fontFamily:"'Inter', sans-serif",textAlign:"center",padding:"20px"},children:m.title})]}),Q.jsxs("div",{style:{flex:"1",display:"flex",flexDirection:"column",justifyContent:"center",padding:"10px 0"},children:[Q.jsxs("div",{style:{fontSize:"0.7rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.1em",marginBottom:"12px",textTransform:"uppercase",fontFamily:"'Inter', sans-serif"},children:[m.category," • ",m.year]}),Q.jsx("h3",{style:{fontSize:"1.1rem",fontWeight:"500",margin:"0",color:"white",letterSpacing:"-0.01em",fontFamily:"'Inter', sans-serif",lineHeight:"1.3"},children:m.title})]}),Q.jsx("div",{style:{position:"absolute",top:"15px",right:"15px",width:"30px",height:"30px",background:"rgba(0,0,0,0.7)",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",color:"white",fontSize:"14px",opacity:b?1:.7,border:"1px solid rgba(255,255,255,0.2)"},children:"↗"})]})},m.id)})}),Q.jsxs("div",{style:{position:"absolute",bottom:"-60px",left:"50%",transform:"translateX(-50%)",display:"flex",alignItems:"center",gap:"20px"},children:[Q.jsx("button",{onClick:()=>u("prev"),disabled:a,style:{width:"35px",height:"35px",border:"1px solid rgba(255,255,255,0.3)",background:"rgba(0,0,0,0.5)",color:"white",borderRadius:"50%",cursor:a?"not-allowed":"pointer",fontSize:"14px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s ease",opacity:a?.5:1},children:"←"}),Q.jsx("div",{style:{display:"flex",gap:"8px"},children:x.map((m,_)=>Q.jsx("div",{onClick:()=>{a||i(_)},style:{width:"8px",height:"8px",borderRadius:"50%",background:_===n?"rgba(255,255,255,0.8)":"rgba(255,255,255,0.3)",cursor:a?"not-allowed":"pointer",transition:"all 0.3s ease"}},_))}),Q.jsx("button",{onClick:()=>u("next"),disabled:a,style:{width:"35px",height:"35px",border:"1px solid rgba(255,255,255,0.3)",background:"rgba(0,0,0,0.5)",color:"white",borderRadius:"50%",cursor:a?"not-allowed":"pointer",fontSize:"14px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.3s ease",opacity:a?.5:1},children:"→"})]})]})]}),Q.jsx("div",{style:{position:"absolute",bottom:"40px",left:"50%",transform:"translateX(-50%)",color:"rgba(255,255,255,0.4)",fontSize:"0.8rem",letterSpacing:"0.1em",fontFamily:"'Inter', sans-serif"},children:"SCROLL TO EXPLORE"})]}),Q.jsxs("section",{id:"work",style:{height:"100vh",width:"100vw",padding:"40px",background:"linear-gradient(180deg, #000000 0%, #1a1a1a 50%, #000000 100%)",display:"flex",alignItems:"center",justifyContent:"center",scrollSnapAlign:"start",scrollSnapStop:"always",overflow:"hidden"},children:[Q.jsxs("div",{style:{width:"320px",display:"flex",flexDirection:"column",paddingRight:"40px"},children:[Q.jsxs("div",{style:{marginBottom:"40px"},children:[Q.jsx("h2",{style:{fontSize:"2.5rem",fontWeight:"300",margin:"0 0 15px 0",letterSpacing:"-0.02em",color:"white",fontFamily:"'Inter', sans-serif"},children:"Featured Work"}),Q.jsx("p",{style:{fontSize:"1rem",color:"rgba(255,255,255,0.6)",margin:0,fontFamily:"'Inter', sans-serif",lineHeight:"1.6"},children:"A selection of recent projects exploring digital art and interactive experiences"})]}),Q.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"10px",flex:1,maxHeight:"calc(100vh - 200px)",overflowY:"auto"},children:S.map(m=>Q.jsxs("button",{onClick:()=>o(m.id),style:{background:s===m.id?"linear-gradient(135deg, #667eea 0%, #764ba2 100%)":"rgba(255, 255, 255, 0.05)",border:s===m.id?"none":"1px solid rgba(255, 255, 255, 0.1)",borderRadius:"12px",padding:"12px 16px",color:"white",fontSize:"0.9rem",fontWeight:"400",cursor:"pointer",transition:"all 0.3s ease",display:"flex",alignItems:"center",gap:"10px",textAlign:"left",fontFamily:"'Inter', sans-serif",transform:s===m.id?"translateX(5px)":"translateX(0)",boxShadow:s===m.id?"0 4px 15px rgba(102, 126, 234, 0.3)":"none"},onMouseEnter:_=>{s!==m.id&&(_.target.style.background="rgba(255, 255, 255, 0.1)",_.target.style.transform="translateX(3px)")},onMouseLeave:_=>{s!==m.id&&(_.target.style.background="rgba(255, 255, 255, 0.05)",_.target.style.transform="translateX(0)")},children:[Q.jsx("span",{style:{fontSize:"1.1rem"},children:m.icon}),Q.jsx("span",{children:m.name})]},m.id))})]}),Q.jsx("div",{style:{flex:1,display:"grid",gridTemplateColumns:"repeat(2, 1fr)",gridTemplateRows:"repeat(2, 1fr)",gap:"20px",height:"100%",overflow:"hidden"},children:g.map((m,_)=>Q.jsxs("div",{style:{background:"rgba(255,255,255,0.05)",borderRadius:"16px",border:"1px solid rgba(255,255,255,0.1)",overflow:"hidden",cursor:"pointer",transition:"all 0.4s cubic-bezier(0.4, 0, 0.2, 1)",transform:"translateY(0)",opacity:1,display:"flex",flexDirection:"column",height:"100%"},onClick:()=>t(m),onMouseEnter:v=>{v.target.style.transform="translateY(-8px)",v.target.style.borderColor="rgba(255,255,255,0.3)",v.target.style.boxShadow="0 20px 40px rgba(0,0,0,0.3)"},onMouseLeave:v=>{v.target.style.transform="translateY(0)",v.target.style.borderColor="rgba(255,255,255,0.1)",v.target.style.boxShadow="none"},children:[Q.jsxs("div",{style:{width:"100%",flex:"1",position:"relative",overflow:"hidden",backgroundColor:"rgba(0,0,0,0.8)",display:"flex",alignItems:"center",justifyContent:"center",minHeight:"180px"},children:[Q.jsx("img",{src:`${m.image}?v=${Date.now()}`,alt:m.title,style:{maxWidth:"100%",maxHeight:"100%",objectFit:"contain",transition:"transform 0.4s ease"},onError:v=>{v.target.style.display="none",v.target.nextSibling.style.display="flex"}}),Q.jsx("div",{style:{display:"none",alignItems:"center",justifyContent:"center",color:"rgba(255,255,255,0.6)",fontSize:"1.2rem",fontFamily:"'Inter', sans-serif",textAlign:"center",height:"100%"},children:m.title}),Q.jsx("div",{style:{position:"absolute",top:"12px",right:"12px",width:"32px",height:"32px",background:"rgba(0,0,0,0.7)",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",color:"white",fontSize:"14px",opacity:.8,transition:"all 0.3s ease"},children:"↗"})]}),Q.jsxs("div",{style:{padding:"12px 16px",background:"rgba(0,0,0,0.3)",borderTop:"1px solid rgba(255,255,255,0.1)"},children:[Q.jsxs("div",{style:{fontSize:"0.75rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.1em",marginBottom:"6px",textTransform:"uppercase",fontFamily:"'Inter', sans-serif"},children:[m.category," • ",m.year]}),Q.jsx("h3",{style:{fontSize:"1rem",fontWeight:"500",margin:"0",color:"white",letterSpacing:"-0.01em",fontFamily:"'Inter', sans-serif",lineHeight:"1.3"},children:m.title})]})]},m.id))})]}),e&&Q.jsx("div",{style:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",background:"rgba(0,0,0,0.9)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:1e3,padding:"20px"},onClick:()=>t(null),children:Q.jsxs("div",{style:{position:"relative",maxWidth:"90vw",maxHeight:"90vh",background:"#1a1a1a",borderRadius:"20px",overflow:"hidden",boxShadow:"0 25px 50px rgba(0,0,0,0.5)"},onClick:m=>m.stopPropagation(),children:[Q.jsx("button",{onClick:()=>t(null),style:{position:"absolute",top:"15px",right:"15px",background:"rgba(255,255,255,0.1)",border:"none",color:"white",fontSize:"1.5rem",padding:"10px",borderRadius:"50%",cursor:"pointer",zIndex:10,transition:"all 0.3s ease"},onMouseEnter:m=>{m.target.style.background="rgba(255,255,255,0.2)"},onMouseLeave:m=>{m.target.style.background="rgba(255,255,255,0.1)"},children:"×"}),Q.jsxs("div",{style:{display:"flex",flexDirection:"row",maxHeight:"90vh",overflow:"hidden"},children:[Q.jsxs("div",{style:{flex:"1.5",position:"relative",minHeight:"500px",background:"#0a0a0a"},children:[Q.jsx("img",{src:e.gallery[n],alt:e.title,style:{width:"100%",height:"100%",objectFit:"cover"}}),e.gallery.length>1&&Q.jsxs(Q.Fragment,{children:[Q.jsx("button",{onClick:()=>i(n>0?n-1:e.gallery.length-1),style:{position:"absolute",left:"15px",top:"50%",transform:"translateY(-50%)",background:"rgba(0,0,0,0.5)",border:"none",color:"white",fontSize:"1.5rem",padding:"15px 20px",borderRadius:"50%",cursor:"pointer",transition:"all 0.3s ease"},onMouseEnter:m=>{m.target.style.background="rgba(0,0,0,0.7)"},onMouseLeave:m=>{m.target.style.background="rgba(0,0,0,0.5)"},children:"‹"}),Q.jsx("button",{onClick:()=>i(n<e.gallery.length-1?n+1:0),style:{position:"absolute",right:"15px",top:"50%",transform:"translateY(-50%)",background:"rgba(0,0,0,0.5)",border:"none",color:"white",fontSize:"1.5rem",padding:"15px 20px",borderRadius:"50%",cursor:"pointer",transition:"all 0.3s ease"},onMouseEnter:m=>{m.target.style.background="rgba(0,0,0,0.7)"},onMouseLeave:m=>{m.target.style.background="rgba(0,0,0,0.5)"},children:"›"})]}),Q.jsxs("div",{style:{position:"absolute",bottom:"15px",left:"50%",transform:"translateX(-50%)",background:"rgba(0,0,0,0.7)",color:"white",padding:"8px 16px",borderRadius:"20px",fontSize:"0.85rem",fontFamily:"'Inter', sans-serif"},children:[n+1," / ",e.gallery.length]})]}),Q.jsxs("div",{style:{flex:"1",padding:"40px",display:"flex",flexDirection:"column",justifyContent:"flex-start"},children:[Q.jsxs("div",{style:{marginBottom:"20px"},children:[Q.jsxs("div",{style:{fontSize:"0.85rem",color:"rgba(255,255,255,0.6)",letterSpacing:"0.1em",marginBottom:"8px",textTransform:"uppercase",fontFamily:"'Inter', sans-serif"},children:[e.category," • ",e.year]}),Q.jsx("h1",{style:{fontSize:"2.5rem",fontWeight:"200",margin:"0 0 15px 0",color:"white",fontFamily:"'Inter', sans-serif"},children:e.title}),Q.jsx("p",{style:{fontSize:"1rem",lineHeight:"1.6",color:"rgba(255,255,255,0.8)",margin:"0 0 30px 0",fontFamily:"'Inter', sans-serif"},children:e.description})]}),Q.jsxs("div",{style:{marginBottom:"30px"},children:[Q.jsx("h3",{style:{fontSize:"1rem",fontWeight:"500",margin:"0 0 12px 0",color:"rgba(255,255,255,0.8)",letterSpacing:"0.05em",textTransform:"uppercase",fontFamily:"'Inter', sans-serif"},children:"Tools Used"}),Q.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:"8px"},children:e.software.map((m,_)=>{const v=S.find(b=>b.id===m);return Q.jsxs("span",{style:{padding:"6px 12px",background:"rgba(255,255,255,0.1)",borderRadius:"15px",fontSize:"0.8rem",color:"rgba(255,255,255,0.8)",fontFamily:"'Inter', sans-serif",display:"flex",alignItems:"center",gap:"6px"},children:[v==null?void 0:v.icon," ",(v==null?void 0:v.name)||m]},_)})})]})]})]})]})})]})}dM.createRoot(document.getElementById("root")).render(Q.jsx(be.StrictMode,{children:Q.jsx(AR,{})}));
