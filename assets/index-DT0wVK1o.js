 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var zv;function $E(){if(zv)return le;zv=1;var o=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),e=Symbol.for("react.fragment"),a=Symbol.for("react.strict_mode"),r=Symbol.for("react.profiler"),l=Symbol.for("react.consumer"),c=Symbol.for("react.context"),f=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),h=Symbol.for("react.memo"),m=Symbol.for("react.lazy"),g=Symbol.iterator;function v(N){return N===null||typeof N!="object"?null:(N=g&&N[g]||N["@@iterator"],typeof N=="function"?N:null)}var x={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},E=Object.assign,M={};function S(N,Q,ft){this.props=N,this.context=Q,this.refs=M,this.updater=ft||x}S.prototype.isReactComponent={},S.prototype.setState=function(N,Q){if(typeof N!="object"&&typeof N!="function"&&N!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,N,Q,"setState")},S.prototype.forceUpdate=function(N){this.updater.enqueueForceUpdate(this,N,"forceUpdate")};function y(){}y.prototype=S.prototype;function D(N,Q,ft){this.props=N,this.context=Q,this.refs=M,this.updater=ft||x}var U=D.prototype=new y;U.constructor=D,E(U,S.prototype),U.isPureReactComponent=!0;var A=Array.isArray,L={H:null,A:null,T:null,S:null,V:null},P=Object.prototype.hasOwnProperty;function z(N,Q,ft,yt,Tt,Nt){return ft=Nt.ref,{$$typeof:o,type:N,key:Q,ref:ft!==void 0?ft:null,props:Nt}}function F(N,Q){return z(N.type,Q,void 0,void 0,void 0,N.props)}function b(N){return typeof N=="object"&&N!==null&&N.$$typeof===o}function O(N){var Q={"=":"=0",":":"=2"};return"$"+N.replace(/[=:]/g,function(ft){return Q[ft]})}var k=/\/+/g;function j(N,Q){return typeof N=="object"&&N!==null&&N.key!=null?O(""+N.key):Q.toString(36)}function tt(){}function ct(N){switch(N.status){case"fulfilled":return N.value;case"rejected":throw N.reason;default:switch(typeof N.status=="string"?N.then(tt,tt):(N.status="pending",N.then(function(Q){N.status==="pending"&&(N.status="fulfilled",N.value=Q)},function(Q){N.status==="pending"&&(N.status="rejected",N.reason=Q)})),N.status){case"fulfilled":return N.value;case"rejected":throw N.reason}}throw N}function rt(N,Q,ft,yt,Tt){var Nt=typeof N;(Nt==="undefined"||Nt==="boolean")&&(N=null);var et=!1;if(N===null)et=!0;else switch(Nt){case"bigint":case"string":case"number":et=!0;break;case"object":switch(N.$$typeof){case o:case t:et=!0;break;case m:return et=N._init,rt(et(N._payload),Q,ft,yt,Tt)}}if(et)return Tt=Tt(N),et=yt===""?"."+j(N,0):yt,A(Tt)?(ft="",et!=null&&(ft=et.replace(k,"$&/")+"/"),rt(Tt,Q,ft,"",function(kt){return kt})):Tt!=null&&(b(Tt)&&(Tt=F(Tt,ft+(Tt.key==null||N&&N.key===Tt.key?"":(""+Tt.key).replace(k,"$&/")+"/")+et)),Q.push(Tt)),1;et=0;var _t=yt===""?".":yt+":";if(A(N))for(var At=0;At<N.length;At++)yt=N[At],Nt=_t+j(yt,At),et+=rt(yt,Q,ft,Nt,Tt);else if(At=v(N),typeof At=="function")for(N=At.call(N),At=0;!(yt=N.next()).done;)yt=yt.value,Nt=_t+j(yt,At++),et+=rt(yt,Q,ft,Nt,Tt);else if(Nt==="object"){if(typeof N.then=="function")return rt(ct(N),Q,ft,yt,Tt);throw Q=String(N),Error("Objects are not valid as a React child (found: "+(Q==="[object Object]"?"object with keys {"+Object.keys(N).join(", ")+"}":Q)+"). If you meant to render a collection of children, use an array instead.")}return et}function B(N,Q,ft){if(N==null)return N;var yt=[],Tt=0;return rt(N,yt,"","",function(Nt){return Q.call(ft,Nt,Tt++)}),yt}function G(N){if(N._status===-1){var Q=N._result;Q=Q(),Q.then(function(ft){(N._status===0||N._status===-1)&&(N._status=1,N._result=ft)},function(ft){(N._status===0||N._status===-1)&&(N._status=2,N._result=ft)}),N._status===-1&&(N._status=0,N._result=Q)}if(N._status===1)return N._result.default;throw N._result}var X=typeof reportError=="function"?reportError:function(N){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var Q=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof N=="object"&&N!==null&&typeof N.message=="string"?String(N.message):String(N),error:N});if(!window.dispatchEvent(Q))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",N);return}console.error(N)};function pt(){}return le.Children={map:B,forEach:function(N,Q,ft){B(N,function(){Q.apply(this,arguments)},ft)},count:function(N){var Q=0;return B(N,function(){Q++}),Q},toArray:function(N){return B(N,function(Q){return Q})||[]},only:function(N){if(!b(N))throw Error("React.Children.only expected to receive a single React element child.");return N}},le.Component=S,le.Fragment=e,le.Profiler=r,le.PureComponent=D,le.StrictMode=a,le.Suspense=p,le.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=L,le.__COMPILER_RUNTIME={__proto__:null,c:function(N){return L.H.useMemoCache(N)}},le.cache=function(N){return function(){return N.apply(null,arguments)}},le.cloneElement=function(N,Q,ft){if(N==null)throw Error("The argument must be a React element, but you passed "+N+".");var yt=E({},N.props),Tt=N.key,Nt=void 0;if(Q!=null)for(et in Q.ref!==void 0&&(Nt=void 0),Q.key!==void 0&&(Tt=""+Q.key),Q)!P.call(Q,et)||et==="key"||et==="__self"||et==="__source"||et==="ref"&&Q.ref===void 0||(yt[et]=Q[et]);var et=arguments.length-2;if(et===1)yt.children=ft;else if(1<et){for(var _t=Array(et),At=0;At<et;At++)_t[At]=arguments[At+2];yt.children=_t}return z(N.type,Tt,void 0,void 0,Nt,yt)},le.createContext=function(N){return N={$$typeof:c,_currentValue:N,_currentValue2:N,_threadCount:0,Provider:null,Consumer:null},N.Provider=N,N.Consumer={$$typeof:l,_context:N},N},le.createElement=function(N,Q,ft){var yt,Tt={},Nt=null;if(Q!=null)for(yt in Q.key!==void 0&&(Nt=""+Q.key),Q)P.call(Q,yt)&&yt!=="key"&&yt!=="__self"&&yt!=="__source"&&(Tt[yt]=Q[yt]);var et=arguments.length-2;if(et===1)Tt.children=ft;else if(1<et){for(var _t=Array(et),At=0;At<et;At++)_t[At]=arguments[At+2];Tt.children=_t}if(N&&N.defaultProps)for(yt in et=N.defaultProps,et)Tt[yt]===void 0&&(Tt[yt]=et[yt]);return z(N,Nt,void 0,void 0,null,Tt)},le.createRef=function(){return{current:null}},le.forwardRef=function(N){return{$$typeof:f,render:N}},le.isValidElement=b,le.lazy=function(N){return{$$typeof:m,_payload:{_status:-1,_result:N},_init:G}},le.memo=function(N,Q){return{$$typeof:h,type:N,compare:Q===void 0?null:Q}},le.startTransition=function(N){var Q=L.T,ft={};L.T=ft;try{var yt=N(),Tt=L.S;Tt!==null&&Tt(ft,yt),typeof yt=="object"&&yt!==null&&typeof yt.then=="function"&&yt.then(pt,X)}catch(Nt){X(Nt)}finally{L.T=Q}},le.unstable_useCacheRefresh=function(){return L.H.useCacheRefresh()},le.use=function(N){return L.H.use(N)},le.useActionState=function(N,Q,ft){return L.H.useActionState(N,Q,ft)},le.useCallback=function(N,Q){return L.H.useCallback(N,Q)},le.useContext=function(N){return L.H.useContext(N)},le.useDebugValue=function(){},le.useDeferredValue=function(N,Q){return L.H.useDeferredValue(N,Q)},le.useEffect=function(N,Q,ft){var yt=L.H;if(typeof ft=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return yt.useEffect(N,Q)},le.useId=function(){return L.H.useId()},le.useImperativeHandle=function(N,Q,ft){return L.H.useImperativeHandle(N,Q,ft)},le.useInsertionEffect=function(N,Q){return L.H.useInsertionEffect(N,Q)},le.useLayoutEffect=function(N,Q){return L.H.useLayoutEffect(N,Q)},le.useMemo=function(N,Q){return L.H.useMemo(N,Q)},le.useOptimistic=function(N,Q){return L.H.useOptimistic(N,Q)},le.useReducer=function(N,Q,ft){return L.H.useReducer(N,Q,ft)},le.useRef=function(N){return L.H.useRef(N)},le.useState=function(N){return L.H.useState(N)},le.useSyncExternalStore=function(N,Q,ft){return L.H.useSyncExternalStore(N,Q,ft)},le.useTransition=function(){return L.H.useTransition()},le.version="19.1.1",le}var Iv;function Dm(){return Iv||(Iv=1,Od.exports=$E()),Od.exports}var tu=Dm(),Nd={exports:{}},Bl={},Pd={exports:{}},zd={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Bv;function tT(){return Bv||(Bv=1,(function(o){function t(B,G){var X=B.length;B.push(G);t:for(;0<X;){var pt=X-1>>>1,N=B[pt];if(0<r(N,G))B[pt]=G,B[X]=N,X=pt;else break t}}function e(B){return B.length===0?null:B[0]}function a(B){if(B.length===0)return null;var G=B[0],X=B.pop();if(X!==G){B[0]=X;t:for(var pt=0,N=B.length,Q=N>>>1;pt<Q;){var ft=2*(pt+1)-1,yt=B[ft],Tt=ft+1,Nt=B[Tt];if(0>r(yt,X))Tt<N&&0>r(Nt,yt)?(B[pt]=Nt,B[Tt]=X,pt=Tt):(B[pt]=yt,B[ft]=X,pt=ft);else if(Tt<N&&0>r(Nt,X))B[pt]=Nt,B[Tt]=X,pt=Tt;else break t}}return G}function r(B,G){var X=B.sortIndex-G.sortIndex;return X!==0?X:B.id-G.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var l=performance;o.unstable_now=function(){return l.now()}}else{var c=Date,f=c.now();o.unstable_now=function(){return c.now()-f}}var p=[],h=[],m=1,g=null,v=3,x=!1,E=!1,M=!1,S=!1,y=typeof setTimeout=="function"?setTimeout:null,D=typeof clearTimeout=="function"?clearTimeout:null,U=typeof setImmediate<"u"?setImmediate:null;function A(B){for(var G=e(h);G!==null;){if(G.callback===null)a(h);else if(G.startTime<=B)a(h),G.sortIndex=G.expirationTime,t(p,G);else break;G=e(h)}}function L(B){if(M=!1,A(B),!E)if(e(p)!==null)E=!0,P||(P=!0,j());else{var G=e(h);G!==null&&rt(L,G.startTime-B)}}var P=!1,z=-1,F=5,b=-1;function O(){return S?!0:!(o.unstable_now()-b<F)}function k(){if(S=!1,P){var B=o.unstable_now();b=B;var G=!0;try{t:{E=!1,M&&(M=!1,D(z),z=-1),x=!0;var X=v;try{e:{for(A(B),g=e(p);g!==null&&!(g.expirationTime>B&&O());){var pt=g.callback;if(typeof pt=="function"){g.callback=null,v=g.priorityLevel;var N=pt(g.expirationTime<=B);if(B=o.unstable_now(),typeof N=="function"){g.callback=N,A(B),G=!0;break e}g===e(p)&&a(p),A(B)}else a(p);g=e(p)}if(g!==null)G=!0;else{var Q=e(h);Q!==null&&rt(L,Q.startTime-B),G=!1}}break t}finally{g=null,v=X,x=!1}G=void 0}}finally{G?j():P=!1}}}var j;if(typeof U=="function")j=function(){U(k)};else if(typeof MessageChannel<"u"){var tt=new MessageChannel,ct=tt.port2;tt.port1.onmessage=k,j=function(){ct.postMessage(null)}}else j=function(){y(k,0)};function rt(B,G){z=y(function(){B(o.unstable_now())},G)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(B){B.callback=null},o.unstable_forceFrameRate=function(B){0>B||125<B?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):F=0<B?Math.floor(1e3/B):5},o.unstable_getCurrentPriorityLevel=function(){return v},o.unstable_next=function(B){switch(v){case 1:case 2:case 3:var G=3;break;default:G=v}var X=v;v=G;try{return B()}finally{v=X}},o.unstable_requestPaint=function(){S=!0},o.unstable_runWithPriority=function(B,G){switch(B){case 1:case 2:case 3:case 4:case 5:break;default:B=3}var X=v;v=B;try{return G()}finally{v=X}},o.unstable_scheduleCallback=function(B,G,X){var pt=o.unstable_now();switch(typeof X=="object"&&X!==null?(X=X.delay,X=typeof X=="number"&&0<X?pt+X:pt):X=pt,B){case 1:var N=-1;break;case 2:N=250;break;case 5:N=1073741823;break;case 4:N=1e4;break;default:N=5e3}return N=X+N,B={id:m++,callback:G,priorityLevel:B,startTime:X,expirationTime:N,sortIndex:-1},X>pt?(B.sortIndex=X,t(h,B),e(p)===null&&B===e(h)&&(M?(D(z),z=-1):M=!0,rt(L,X-pt))):(B.sortIndex=N,t(p,B),E||x||(E=!0,P||(P=!0,j()))),B},o.unstable_shouldYield=O,o.unstable_wrapCallback=function(B){var G=v;return function(){var X=v;v=G;try{return B.apply(this,arguments)}finally{v=X}}}})(zd)),zd}var Fv;function eT(){return Fv||(Fv=1,Pd.exports=tT()),Pd.exports}var Id={exports:{}},Fn={};/**
 * @license React
...
`)+`
`+y);const U=D+S+c,A=D+y+f,L=Bx(r,r.VERTEX_SHADER,U),P=Bx(r,r.FRAGMENT_SHADER,A);r.attachShader(M,L),r.attachShader(M,P),e.index0AttributeName!==void 0?r.bindAttribLocation(M,0,e.index0AttributeName):e.morphTargets===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M);function z(k){if(o.debug.checkShaderErrors){const j=r.getProgramInfoLog(M)||"",tt=r.getShaderInfoLog(L)||"",ct=r.getShaderInfoLog(P)||"",rt=j.trim(),B=tt.trim(),G=ct.trim();let X=!0,pt=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if(X=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(r,M,L,P);else{const N=Hx(r,L,"vertex"),Q=Hx(r,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`
...
}`;function lC(o,t,e){let a=new Vm;const r=new Te,l=new Te,c=new rn,f=new Ab({depthPacking:FT}),p=new Rb,h={},m=e.maxTextureSize,g={[Va]:ii,[ii]:Va,[Fa]:Fa},v=new ka({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Te},radius:{value:4}},vertexShader:sC,fragmentShader:oC}),x=v.clone();x.defines.HORIZONTAL_PASS=1;const E=new Ti;E.setAttribute("position",new Mi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new yi(E,v),S=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=my;let y=this.type;this.render=function(P,z,F){if(S.enabled===!1||S.autoUpdate===!1&&S.needsUpdate===!1||P.length===0)return;const b=o.getRenderTarget(),O=o.getActiveCubeFace(),k=o.getActiveMipmapLevel(),j=o.state;j.setBlending(Ar),j.buffers.depth.getReversed()===!0?j.buffers.color.setClear(0,0,0,0):j.buffers.color.setClear(1,1,1,1),j.buffers.depth.setTest(!0),j.setScissorTest(!1);const tt=y!==za&&this.type===za,ct=y===za&&this.type!==za;for(let rt=0,B=P.length;rt<B;rt++){const G=P[rt],X=G.shadow;if(X===void 0){console.warn("THREE.WebGLShadowMap:",G,"has no shadow.");continue}if(X.autoUpdate===!1&&X.needsUpdate===!1)continue;r.copy(X.mapSize);const pt=X.getFrameExtents();if(r.multiply(pt),l.copy(X.mapSize),(r.x>m||r.y>m)&&(r.x>m&&(l.x=Math.floor(m/pt.x),r.x=l.x*pt.x,X.mapSize.x=l.x),r.y>m&&(l.y=Math.floor(m/pt.y),r.y=l.y*pt.y,X.mapSize.y=l.y)),X.map===null||tt===!0||ct===!0){const Q=this.type!==za?{minFilter:Qi,magFilter:Qi}:{};X.map!==null&&X.map.dispose(),X.map=new gs(r.x,r.y,Q),X.map.texture.name=G.name+".shadowMap",X.camera.updateProjectionMatrix()}o.setRenderTarget(X.map),o.clear();const N=X.getViewportCount();for(let Q=0;Q<N;Q++){const ft=X.getViewport(Q);c.set(l.x*ft.x,l.y*ft.y,l.x*ft.z,l.y*ft.w),j.viewport(c),X.updateMatrices(G,Q),a=X.getFrustum(),A(z,F,X.camera,G,this.type)}X.isPointLightShadow!==!0&&this.type===za&&D(X,F),X.needsUpdate=!1}y=this.type,S.needsUpdate=!1,o.setRenderTarget(b,O,k)};function D(P,z){const F=t.update(M);v.defines.VSM_SAMPLES!==P.blurSamples&&(v.defines.VSM_SAMPLES=P.blurSamples,x.defines.VSM_SAMPLES=P.blurSamples,v.needsUpdate=!0,x.needsUpdate=!0),P.mapPass===null&&(P.mapPass=new gs(r.x,r.y)),v.uniforms.shadow_pass.value=P.map.texture,v.uniforms.resolution.value=P.mapSize,v.uniforms.radius.value=P.radius,o.setRenderTarget(P.mapPass),o.clear(),o.renderBufferDirect(z,null,F,v,M,null),x.uniforms.shadow_pass.value=P.mapPass.texture,x.uniforms.resolution.value=P.mapSize,x.uniforms.radius.value=P.radius,o.setRenderTarget(P.map),o.clear(),o.renderBufferDirect(z,null,F,x,M,null)}function U(P,z,F,b){let O=null;const k=F.isPointLight===!0?P.customDistanceMaterial:P.customDepthMaterial;if(k!==void 0)O=k;else if(O=F.isPointLight===!0?p:f,o.localClippingEnabled&&z.clipShadows===!0&&Array.isArray(z.clippingPlanes)&&z.clippingPlanes.length!==0||z.displacementMap&&z.displacementScale!==0||z.alphaMap&&z.alphaTest>0||z.map&&z.alphaTest>0||z.alphaToCoverage===!0){const j=O.uuid,tt=z.uuid;let ct=h[j];ct===void 0&&(ct={},h[j]=ct);let rt=ct[tt];rt===void 0&&(rt=O.clone(),ct[tt]=rt,z.addEventListener("dispose",L)),O=rt}if(O.visible=z.visible,O.wireframe=z.wireframe,b===za?O.side=z.shadowSide!==null?z.shadowSide:z.side:O.side=z.shadowSide!==null?z.shadowSide:g[z.side],O.alphaMap=z.alphaMap,O.alphaTest=z.alphaToCoverage===!0?.5:z.alphaTest,O.map=z.map,O.clipShadows=z.clipShadows,O.clippingPlanes=z.clippingPlanes,O.clipIntersection=z.clipIntersection,O.displacementMap=z.displacementMap,O.displacementScale=z.displacementScale,O.displacementBias=z.displacementBias,O.wireframeLinewidth=z.wireframeLinewidth,O.linewidth=z.linewidth,F.isPointLight===!0&&O.isMeshDistanceMaterial===!0){const j=o.properties.get(O);j.light=F}return O}function A(P,z,F,b,O){if(P.visible===!1)return;if(P.layers.test(z.layers)&&(P.isMesh||P.isLine||P.isPoints)&&(P.castShadow||P.receiveShadow&&O===za)&&(!P.frustumCulled||a.intersectsObject(P))){P.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,P.matrixWorld);const tt=t.update(P),ct=P.material;if(Array.isArray(ct)){const rt=tt.groups;for(let B=0,G=rt.length;B<G;B++){const X=rt[B],pt=ct[X.materialIndex];if(pt&&pt.visible){const N=U(P,pt,b,O);P.onBeforeShadow(o,P,z,F,tt,N,X),o.renderBufferDirect(F,null,tt,N,P,X),P.onAfterShadow(o,P,z,F,tt,N,X)}}}else if(ct.visible){const rt=U(P,ct,b,O);P.onBeforeShadow(o,P,z,F,tt,rt,null),o.renderBufferDirect(F,null,tt,rt,P,null),P.onAfterShadow(o,P,z,F,tt,rt,null)}}const j=P.children;for(let tt=0,ct=j.length;tt<ct;tt++)A(j[tt],z,F,b,O)}function L(P){P.target.removeEventListener("dispose",L);for(const F in h){const b=h[F],O=P.target.uuid;O in b&&(b[O].dispose(),delete b[O])}}}const uC={[wp]:Cp,[Dp]:Op,[Up]:Np,[Co]:Lp,[Cp]:wp,[Op]:Dp,[Np]:Up,[Lp]:Co};function cC(o,t){function e(){let q=!1;const bt=new rn;let wt=null;const It=new rn(0,0,0,0);return{setMask:function(Mt){wt!==Mt&&!q&&(o.colorMask(Mt,Mt,Mt,Mt),wt=Mt)},setLocked:function(Mt){q=Mt},setClear:function(Mt,xt,Ht,ae,Ce){Ce===!0&&(Mt*=ae,xt*=ae,Ht*=ae),bt.set(Mt,xt,Ht,ae),It.equals(bt)===!1&&(o.clearColor(Mt,xt,Ht,ae),It.copy(bt))},reset:function(){q=!1,wt=null,It.set(-1,0,0,0)}}}function a(){let q=!1,bt=!1,wt=null,It=null,Mt=null;return{setReversed:function(xt){if(bt!==xt){const Ht=t.get("EXT_clip_control");xt?Ht.clipControlEXT(Ht.LOWER_LEFT_EXT,Ht.ZERO_TO_ONE_EXT):Ht.clipControlEXT(Ht.LOWER_LEFT_EXT,Ht.NEGATIVE_ONE_TO_ONE_EXT),bt=xt;const ae=Mt;Mt=null,this.setClear(ae)}},getReversed:function(){return bt},setTest:function(xt){xt?_t(o.DEPTH_TEST):At(o.DEPTH_TEST)},setMask:function(xt){wt!==xt&&!q&&(o.depthMask(xt),wt=xt)},setFunc:function(xt){if(bt&&(xt=uC[xt]),It!==xt){switch(xt){case wp:o.depthFunc(o.NEVER);break;case Cp:o.depthFunc(o.ALWAYS);break;case Dp:o.depthFunc(o.LESS);break;case Co:o.depthFunc(o.LEQUAL);break;case Up:o.depthFunc(o.EQUAL);break;case Lp:o.depthFunc(o.GEQUAL);break;case Op:o.depthFunc(o.GREATER);break;case Np:o.depthFunc(o.NOTEQUAL);break;default:o.depthFunc(o.LEQUAL)}It=xt}},setLocked:function(xt){q=xt},setClear:function(xt){Mt!==xt&&(bt&&(xt=1-xt),o.clearDepth(xt),Mt=xt)},reset:function(){q=!1,wt=null,It=null,Mt=null,bt=!1}}}function r(){let q=!1,bt=null,wt=null,It=null,Mt=null,xt=null,Ht=null,ae=null,Ce=null;return{setTest:function(be){q||(be?_t(o.STENCIL_TEST):At(o.STENCIL_TEST))},setMask:function(be){bt!==be&&!q&&(o.stencilMask(be),bt=be)},setFunc:function(be,Gi,gn){(wt!==be||It!==Gi||Mt!==gn)&&(o.stencilFunc(be,Gi,gn),wt=be,It=Gi,Mt=gn)},setOp:function(be,Gi,gn){(xt!==be||Ht!==Gi||ae!==gn)&&(o.stencilOp(be,Gi,gn),xt=be,Ht=Gi,ae=gn)},setLocked:function(be){q=be},setClear:function(be){Ce!==be&&(o.clearStencil(be),Ce=be)},reset:function(){q=!1,bt=null,wt=null,It=null,Mt=null,xt=null,Ht=null,ae=null,Ce=null}}}const l=new e,c=new a,f=new r,p=new WeakMap,h=new WeakMap;let m={},g={},v=new WeakMap,x=[],E=null,M=!1,S=null,y=null,D=null,U=null,A=null,L=null,P=null,z=new ce(0,0,0),F=0,b=!1,O=null,k=null,j=null,tt=null,ct=null;const rt=o.getParameter(o.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let B=!1,G=0;const X=o.getParameter(o.VERSION);X.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec(X)[1]),B=G>=1):X.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec(X)[1]),B=G>=2);let pt=null,N={};const Q=o.getParameter(o.SCISSOR_BOX),ft=o.getParameter(o.VIEWPORT),yt=new rn().fromArray(Q),Tt=new rn().fromArray(ft);function Nt(q,bt,wt,It){const Mt=new Uint8Array(4),xt=o.createTexture();o.bindTexture(q,xt),o.texParameteri(q,o.TEXTURE_MIN_FILTER,o.NEAREST),o.texParameteri(q,o.TEXTURE_MAG_FILTER,o.NEAREST);for(let Ht=0;Ht<wt;Ht++)q===o.TEXTURE_3D||q===o.TEXTURE_2D_ARRAY?o.texImage3D(bt,0,o.RGBA,1,1,It,0,o.RGBA,o.UNSIGNED_BYTE,Mt):o.texImage2D(bt+Ht,0,o.RGBA,1,1,0,o.RGBA,o.UNSIGNED_BYTE,Mt);return xt}const et={};et[o.TEXTURE_2D]=Nt(o.TEXTURE_2D,o.TEXTURE_2D,1),et[o.TEXTURE_CUBE_MAP]=Nt(o.TEXTURE_CUBE_MAP,o.TEXTURE_CUBE_MAP_POSITIVE_X,6),et[o.TEXTURE_2D_ARRAY]=Nt(o.TEXTURE_2D_ARRAY,o.TEXTURE_2D_ARRAY,1,1),et[o.TEXTURE_3D]=Nt(o.TEXTURE_3D,o.TEXTURE_3D,1,1),l.setClear(0,0,0,1),c.setClear(1),f.setClear(0),_t(o.DEPTH_TEST),c.setFunc(Co),ne(!1),Pt(Xv),_t(o.CULL_FACE),Le(Ar);function _t(q){m[q]!==!0&&(o.enable(q),m[q]=!0)}function At(q){m[q]!==!1&&(o.disable(q),m[q]=!1)}function kt(q,bt){return g[q]!==bt?(o.bindFramebuffer(q,bt),g[q]=bt,q===o.DRAW_FRAMEBUFFER&&(g[o.FRAMEBUFFER]=bt),q===o.FRAMEBUFFER&&(g[o.DRAW_FRAMEBUFFER]=bt),!0):!1}function qt(q,bt){let wt=x,It=!1;if(q){wt=v.get(bt),wt===void 0&&(wt=[],v.set(bt,wt));const Mt=q.textures;if(wt.length!==Mt.length||wt[0]!==o.COLOR_ATTACHMENT0){for(let xt=0,Ht=Mt.length;xt<Ht;xt++)wt[xt]=o.COLOR_ATTACHMENT0+xt;wt.length=Mt.length,It=!0}}else wt[0]!==o.BACK&&(wt[0]=o.BACK,It=!0);It&&o.drawBuffers(wt)}function pe(q){return E!==q?(o.useProgram(q),E=q,!0):!1}const cn={[os]:o.FUNC_ADD,[fT]:o.FUNC_SUBTRACT,[hT]:o.FUNC_REVERSE_SUBTRACT};cn[dT]=o.MIN,cn[pT]=o.MAX;const V={[mT]:o.ZERO,[_T]:o.ONE,[gT]:o.SRC_COLOR,[Ap]:o.SRC_ALPHA,[ET]:o.SRC_ALPHA_SATURATE,[ST]:o.DST_COLOR,[xT]:o.DST_ALPHA,[vT]:o.ONE_MINUS_SRC_COLOR,[Rp]:o.ONE_MINUS_SRC_ALPHA,[MT]:o.ONE_MINUS_DST_COLOR,[yT]:o.ONE_MINUS_DST_ALPHA,[TT]:o.CONSTANT_COLOR,[bT]:o.ONE_MINUS_CONSTANT_COLOR,[AT]:o.CONSTANT_ALPHA,[RT]:o.ONE_MINUS_CONSTANT_ALPHA};function Le(q,bt,wt,It,Mt,xt,Ht,ae,Ce,be){if(q===Ar){M===!0&&(At(o.BLEND),M=!1);return}if(M===!1&&(_t(o.BLEND),M=!0),q!==cT){if(q!==S||be!==b){if((y!==os||A!==os)&&(o.blendEquation(o.FUNC_ADD),y=os,A=os),be)switch(q){case To:o.blendFuncSeparate(o.ONE,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case hf:o.blendFunc(o.ONE,o.ONE);break;case Wv:o.blendFuncSeparate(o.ZERO,o.ONE_MINUS_SRC_COLOR,o.ZERO,o.ONE);break;case qv:o.blendFuncSeparate(o.DST_COLOR,o.ONE_MINUS_SRC_ALPHA,o.ZERO,o.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",q);break}else switch(q){case To:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case hf:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE,o.ONE,o.ONE);break;case Wv:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case qv:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",q);break}D=null,U=null,L=null,P=null,z.set(0,0,0),F=0,S=q,b=be}return}Mt=Mt||bt,xt=xt||wt,Ht=Ht||It,(bt!==y||Mt!==A)&&(o.blendEquationSeparate(cn[bt],cn[Mt]),y=bt,A=Mt),(wt!==D||It!==U||xt!==L||Ht!==P)&&(o.blendFuncSeparate(V[wt],V[It],V[xt],V[Ht]),D=wt,U=It,L=xt,P=Ht),(ae.equals(z)===!1||Ce!==F)&&(o.blendColor(ae.r,ae.g,ae.b,Ce),z.copy(ae),F=Ce),S=q,b=!1}function re(q,bt){q.side===Fa?At(o.CULL_FACE):_t(o.CULL_FACE);let wt=q.side===ii;bt&&(wt=!wt),ne(wt),q.blending===To&&q.transparent===!1?Le(Ar):Le(q.blending,q.blendEquation,q.blendSrc,q.blendDst,q.blendEquationAlpha,q.blendSrcAlpha,q.blendDstAlpha,q.blendColor,q.blendAlpha,q.premultipliedAlpha),c.setFunc(q.depthFunc),c.setTest(q.depthTest),c.setMask(q.depthWrite),l.setMask(q.colorWrite);const It=q.stencilWrite;f.setTest(It),It&&(f.setMask(q.stencilWriteMask),f.setFunc(q.stencilFunc,q.stencilRef,q.stencilFuncMask),f.setOp(q.stencilFail,q.stencilZFail,q.stencilZPass)),Gt(q.polygonOffset,q.polygonOffsetFactor,q.polygonOffsetUnits),q.alphaToCoverage===!0?_t(o.SAMPLE_ALPHA_TO_COVERAGE):At(o.SAMPLE_ALPHA_TO_COVERAGE)}function ne(q){O!==q&&(q?o.frontFace(o.CW):o.frontFace(o.CCW),O=q)}function Pt(q){q!==oT?(_t(o.CULL_FACE),q!==k&&(q===Xv?o.cullFace(o.BACK):q===lT?o.cullFace(o.FRONT):o.cullFace(o.FRONT_AND_BACK))):At(o.CULL_FACE),k=q}function Ve(q){q!==j&&(B&&o.lineWidth(q),j=q)}function Gt(q,bt,wt){q?(_t(o.POLYGON_OFFSET_FILL),(tt!==bt||ct!==wt)&&(o.polygonOffset(bt,wt),tt=bt,ct=wt)):At(o.POLYGON_OFFSET_FILL)}function se(q){q?_t(o.SCISSOR_TEST):At(o.SCISSOR_TEST)}function je(q){q===void 0&&(q=o.TEXTURE0+rt-1),pt!==q&&(o.activeTexture(q),pt=q)}function Ze(q,bt,wt){wt===void 0&&(pt===null?wt=o.TEXTURE0+rt-1:wt=pt);let It=N[wt];It===void 0&&(It={type:void 0,texture:void 0},N[wt]=It),(It.type!==q||It.texture!==bt)&&(pt!==wt&&(o.activeTexture(wt),pt=wt),o.bindTexture(q,bt||et[q]),It.type=q,It.texture=bt)}function I(){const q=N[pt];q!==void 0&&q.type!==void 0&&(o.bindTexture(q.type,null),q.type=void 0,q.texture=void 0)}function R(){try{o.compressedTexImage2D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function nt(){try{o.compressedTexImage3D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function ht(){try{o.texSubImage2D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function gt(){try{o.texSubImage3D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function ut(){try{o.compressedTexSubImage2D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function zt(){try{o.compressedTexSubImage3D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function Rt(){try{o.texStorage2D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function Xt(){try{o.texStorage3D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function Yt(){try{o.texImage2D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function St(){try{o.texImage3D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function Ut(q){yt.equals(q)===!1&&(o.scissor(q.x,q.y,q.z,q.w),yt.copy(q))}function Zt(q){Tt.equals(q)===!1&&(o.viewport(q.x,q.y,q.z,q.w),Tt.copy(q))}function Vt(q,bt){let wt=h.get(bt);wt===void 0&&(wt=new WeakMap,h.set(bt,wt));let It=wt.get(q);It===void 0&&(It=o.getUniformBlockIndex(bt,q.name),wt.set(q,It))}function Ct(q,bt){const It=h.get(bt).get(q);p.get(bt)!==It&&(o.uniformBlockBinding(bt,It,q.__bindingPointIndex),p.set(bt,It))}function oe(){o.disable(o.BLEND),o.disable(o.CULL_FACE),o.disable(o.DEPTH_TEST),o.disable(o.POLYGON_OFFSET_FILL),o.disable(o.SCISSOR_TEST),o.disable(o.STENCIL_TEST),o.disable(o.SAMPLE_ALPHA_TO_COVERAGE),o.blendEquation(o.FUNC_ADD),o.blendFunc(o.ONE,o.ZERO),o.blendFuncSeparate(o.ONE,o.ZERO,o.ONE,o.ZERO),o.blendColor(0,0,0,0),o.colorMask(!0,!0,!0,!0),o.clearColor(0,0,0,0),o.depthMask(!0),o.depthFunc(o.LESS),c.setReversed(!1),o.clearDepth(1),o.stencilMask(4294967295),o.stencilFunc(o.ALWAYS,0,4294967295),o.stencilOp(o.KEEP,o.KEEP,o.KEEP),o.clearStencil(0),o.cullFace(o.BACK),o.frontFace(o.CCW),o.polygonOffset(0,0),o.activeTexture(o.TEXTURE0),o.bindFramebuffer(o.FRAMEBUFFER,null),o.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),o.bindFramebuffer(o.READ_FRAMEBUFFER,null),o.useProgram(null),o.lineWidth(1),o.scissor(0,0,o.canvas.width,o.canvas.height),o.viewport(0,0,o.canvas.width,o.canvas.height),m={},pt=null,N={},g={},v=new WeakMap,x=[],E=null,M=!1,S=null,y=null,D=null,U=null,A=null,L=null,P=null,z=new ce(0,0,0),F=0,b=!1,O=null,k=null,j=null,tt=null,ct=null,yt.set(0,0,o.canvas.width,o.canvas.height),Tt.set(0,0,o.canvas.width,o.canvas.height),l.reset(),c.reset(),f.reset()}return{buffers:{color:l,depth:c,stencil:f},enable:_t,disable:At,bindFramebuffer:kt,drawBuffers:qt,useProgram:pe,setBlending:Le,setMaterial:re,setFlipSided:ne,setCullFace:Pt,setLineWidth:Ve,setPolygonOffset:Gt,setScissorTest:se,activeTexture:je,bindTexture:Ze,unbindTexture:I,compressedTexImage2D:R,compressedTexImage3D:nt,texImage2D:Yt,texImage3D:St,updateUBOMapping:Vt,uniformBlockBinding:Ct,texStorage2D:Rt,texStorage3D:Xt,texSubImage2D:ht,texSubImage3D:gt,compressedTexSubImage2D:ut,compressedTexSubImage3D:zt,scissor:Ut,viewport:Zt,reset:oe}}function fC(o,t,e,a,r,l,c){const f=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,p=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),h=new Te,m=new WeakMap;let g;const v=new WeakMap;let x=!1;try{x=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function E(I,R){return x?new OffscreenCanvas(I,R):ru("canvas")}function M(I,R,nt){let ht=1;const gt=Ze(I);if((gt.width>nt||gt.height>nt)&&(ht=nt/Math.max(gt.width,gt.height)),ht<1)if(typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&I instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&I instanceof ImageBitmap||typeof VideoFrame<"u"&&I instanceof VideoFrame){const ut=Math.floor(ht*gt.width),zt=Math.floor(ht*gt.height);g===void 0&&(g=E(ut,zt));const Rt=R?E(ut,zt):g;return Rt.width=ut,Rt.height=zt,Rt.getContext("2d").drawImage(I,0,0,ut,zt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+gt.width+"x"+gt.height+") to ("+ut+"x"+zt+")."),Rt}else return"data"in I&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+gt.width+"x"+gt.height+")."),I;return I}function S(I){return I.generateMipmaps}function y(I){o.generateMipmap(I)}function D(I){return I.isWebGLCubeRenderTarget?o.TEXTURE_CUBE_MAP:I.isWebGL3DRenderTarget?o.TEXTURE_3D:I.isWebGLArrayRenderTarget||I.isCompressedArrayTexture?o.TEXTURE_2D_ARRAY:o.TEXTURE_2D}function U(I,R,nt,ht,gt=!1){if(I!==null){if(o[I]!==void 0)return o[I];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+I+"'")}let ut=R;if(R===o.RED&&(nt===o.FLOAT&&(ut=o.R32F),nt===o.HALF_FLOAT&&(ut=o.R16F),nt===o.UNSIGNED_BYTE&&(ut=o.R8)),R===o.RED_INTEGER&&(nt===o.UNSIGNED_BYTE&&(ut=o.R8UI),nt===o.UNSIGNED_SHORT&&(ut=o.R16UI),nt===o.UNSIGNED_INT&&(ut=o.R32UI),nt===o.BYTE&&(ut=o.R8I),nt===o.SHORT&&(ut=o.R16I),nt===o.INT&&(ut=o.R32I)),R===o.RG&&(nt===o.FLOAT&&(ut=o.RG32F),nt===o.HALF_FLOAT&&(ut=o.RG16F),nt===o.UNSIGNED_BYTE&&(ut=o.RG8)),R===o.RG_INTEGER&&(nt===o.UNSIGNED_BYTE&&(ut=o.RG8UI),nt===o.UNSIGNED_SHORT&&(ut=o.RG16UI),nt===o.UNSIGNED_INT&&(ut=o.RG32UI),nt===o.BYTE&&(ut=o.RG8I),nt===o.SHORT&&(ut=o.RG16I),nt===o.INT&&(ut=o.RG32I)),R===o.RGB_INTEGER&&(nt===o.UNSIGNED_BYTE&&(ut=o.RGB8UI),nt===o.UNSIGNED_SHORT&&(ut=o.RGB16UI),nt===o.UNSIGNED_INT&&(ut=o.RGB32UI),nt===o.BYTE&&(ut=o.RGB8I),nt===o.SHORT&&(ut=o.RGB16I),nt===o.INT&&(ut=o.RGB32I)),R===o.RGBA_INTEGER&&(nt===o.UNSIGNED_BYTE&&(ut=o.RGBA8UI),nt===o.UNSIGNED_SHORT&&(ut=o.RGBA16UI),nt===o.UNSIGNED_INT&&(ut=o.RGBA32UI),nt===o.BYTE&&(ut=o.RGBA8I),nt===o.SHORT&&(ut=o.RGBA16I),nt===o.INT&&(ut=o.RGBA32I)),R===o.RGB&&(nt===o.UNSIGNED_INT_5_9_9_9_REV&&(ut=o.RGB9_E5),nt===o.UNSIGNED_INT_10F_11F_11F_REV&&(ut=o.R11F_G11F_B10F)),R===o.RGBA){const zt=gt?pf:ye.getTransfer(ht);nt===o.FLOAT&&(ut=o.RGBA32F),nt===o.HALF_FLOAT&&(ut=o.RGBA16F),nt===o.UNSIGNED_BYTE&&(ut=zt===Ie?o.SRGB8_ALPHA8:o.RGBA8),nt===o.UNSIGNED_SHORT_4_4_4_4&&(ut=o.RGBA4),nt===o.UNSIGNED_SHORT_5_5_5_1&&(ut=o.RGB5_A1)}return(ut===o.R16F||ut===o.R32F||ut===o.RG16F||ut===o.RG32F||ut===o.RGBA16F||ut===o.RGBA32F)&&t.get("EXT_color_buffer_float"),ut}function A(I,R){let nt;return I?R===null||R===_s||R===nu?nt=o.DEPTH24_STENCIL8:R===Ha?nt=o.DEPTH32F_STENCIL8:R===eu&&(nt=o.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):R===null||R===_s||R===nu?nt=o.DEPTH_COMPONENT24:R===Ha?nt=o.DEPTH_COMPONENT32F:R===eu&&(nt=o.DEPTH_COMPONENT16),nt}function L(I,R){return S(I)===!0||I.isFramebufferTexture&&I.minFilter!==Qi&&I.minFilter!==ua?Math.log2(Math.max(R.width,R.height))+1:I.mipmaps!==void 0&&I.mipmaps.length>0?I.mipmaps.length:I.isCompressedTexture&&Array.isArray(I.image)?R.mipmaps.length:1}function P(I){const R=I.target;R.removeEventListener("dispose",P),F(R),R.isVideoTexture&&m.delete(R)}function z(I){const R=I.target;R.removeEventListener("dispose",z),O(R)}function F(I){const R=a.get(I);if(R.__webglInit===void 0)return;const nt=I.source,ht=v.get(nt);if(ht){const gt=ht[R.__cacheKey];gt.usedTimes--,gt.usedTimes===0&&b(I),Object.keys(ht).length===0&&v.delete(nt)}a.remove(I)}function b(I){const R=a.get(I);o.deleteTexture(R.__webglTexture);const nt=I.source,ht=v.get(nt);delete ht[R.__cacheKey],c.memory.textures--}function O(I){const R=a.get(I);if(I.depthTexture&&(I.depthTexture.dispose(),a.remove(I.depthTexture)),I.isWebGLCubeRenderTarget)for(let ht=0;ht<6;ht++){if(Array.isArray(R.__webglFramebuffer[ht]))for(let gt=0;gt<R.__webglFramebuffer[ht].length;gt++)o.deleteFramebuffer(R.__webglFramebuffer[ht][gt]);else o.deleteFramebuffer(R.__webglFramebuffer[ht]);R.__webglDepthbuffer&&o.deleteRenderbuffer(R.__webglDepthbuffer[ht])}else{if(Array.isArray(R.__webglFramebuffer))for(let ht=0;ht<R.__webglFramebuffer.length;ht++)o.deleteFramebuffer(R.__webglFramebuffer[ht]);else o.deleteFramebuffer(R.__webglFramebuffer);if(R.__webglDepthbuffer&&o.deleteRenderbuffer(R.__webglDepthbuffer),R.__webglMultisampledFramebuffer&&o.deleteFramebuffer(R.__webglMultisampledFramebuffer),R.__webglColorRenderbuffer)for(let ht=0;ht<R.__webglColorRenderbuffer.length;ht++)R.__webglColorRenderbuffer[ht]&&o.deleteRenderbuffer(R.__webglColorRenderbuffer[ht]);R.__webglDepthRenderbuffer&&o.deleteRenderbuffer(R.__webglDepthRenderbuffer)}const nt=I.textures;for(let ht=0,gt=nt.length;ht<gt;ht++){const ut=a.get(nt[ht]);ut.__webglTexture&&(o.deleteTexture(ut.__webglTexture),c.memory.textures--),a.remove(nt[ht])}a.remove(I)}let k=0;function j(){k=0}function tt(){const I=k;return I>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+I+" texture units while this GPU supports only "+r.maxTextures),k+=1,I}function ct(I){const R=[];return R.push(I.wrapS),R.push(I.wrapT),R.push(I.wrapR||0),R.push(I.magFilter),R.push(I.minFilter),R.push(I.anisotropy),R.push(I.internalFormat),R.push(I.format),R.push(I.type),R.push(I.generateMipmaps),R.push(I.premultiplyAlpha),R.push(I.flipY),R.push(I.unpackAlignment),R.push(I.colorSpace),R.join()}function rt(I,R){const nt=a.get(I);if(I.isVideoTexture&&se(I),I.isRenderTargetTexture===!1&&I.isExternalTexture!==!0&&I.version>0&&nt.__version!==I.version){const ht=I.image;if(ht===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ht.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{et(nt,I,R);return}}else I.isExternalTexture&&(nt.__webglTexture=I.sourceTexture?I.sourceTexture:null);e.bindTexture(o.TEXTURE_2D,nt.__webglTexture,o.TEXTURE0+R)}function B(I,R){const nt=a.get(I);if(I.isRenderTargetTexture===!1&&I.version>0&&nt.__version!==I.version){et(nt,I,R);return}e.bindTexture(o.TEXTURE_2D_ARRAY,nt.__webglTexture,o.TEXTURE0+R)}function G(I,R){const nt=a.get(I);if(I.isRenderTargetTexture===!1&&I.version>0&&nt.__version!==I.version){et(nt,I,R);return}e.bindTexture(o.TEXTURE_3D,nt.__webglTexture,o.TEXTURE0+R)}function X(I,R){const nt=a.get(I);if(I.version>0&&nt.__version!==I.version){_t(nt,I,R);return}e.bindTexture(o.TEXTURE_CUBE_MAP,nt.__webglTexture,o.TEXTURE0+R)}const pt={[df]:o.REPEAT,[us]:o.CLAMP_TO_EDGE,[Ip]:o.MIRRORED_REPEAT},N={[Qi]:o.NEAREST,[IT]:o.NEAREST_MIPMAP_NEAREST,[wc]:o.NEAREST_MIPMAP_LINEAR,[ua]:o.LINEAR,[Bd]:o.LINEAR_MIPMAP_NEAREST,[cs]:o.LINEAR_MIPMAP_LINEAR},Q={[GT]:o.NEVER,[YT]:o.ALWAYS,[VT]:o.LESS,[by]:o.LEQUAL,[kT]:o.EQUAL,[qT]:o.GEQUAL,[XT]:o.GREATER,[WT]:o.NOTEQUAL};function ft(I,R){if(R.type===Ha&&t.has("OES_texture_float_linear")===!1&&(R.magFilter===ua||R.magFilter===Bd||R.magFilter===wc||R.magFilter===cs||R.minFilter===ua||R.minFilter===Bd||R.minFilter===wc||R.minFilter===cs)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),o.texParameteri(I,o.TEXTURE_WRAP_S,pt[R.wrapS]),o.texParameteri(I,o.TEXTURE_WRAP_T,pt[R.wrapT]),(I===o.TEXTURE_3D||I===o.TEXTURE_2D_ARRAY)&&o.texParameteri(I,o.TEXTURE_WRAP_R,pt[R.wrapR]),o.texParameteri(I,o.TEXTURE_MAG_FILTER,N[R.magFilter]),o.texParameteri(I,o.TEXTURE_MIN_FILTER,N[R.minFilter]),R.compareFunction&&(o.texParameteri(I,o.TEXTURE_COMPARE_MODE,o.COMPARE_REF_TO_TEXTURE),o.texParameteri(I,o.TEXTURE_COMPARE_FUNC,Q[R.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(R.magFilter===Qi||R.minFilter!==wc&&R.minFilter!==cs||R.type===Ha&&t.has("OES_texture_float_linear")===!1)return;if(R.anisotropy>1||a.get(R).__currentAnisotropy){const nt=t.get("EXT_texture_filter_anisotropic");o.texParameterf(I,nt.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(R.anisotropy,r.getMaxAnisotropy())),a.get(R).__currentAnisotropy=R.anisotropy}}}function yt(I,R){let nt=!1;I.__webglInit===void 0&&(I.__webglInit=!0,R.addEventListener("dispose",P));const ht=R.source;let gt=v.get(ht);gt===void 0&&(gt={},v.set(ht,gt));const ut=ct(R);if(ut!==I.__cacheKey){gt[ut]===void 0&&(gt[ut]={texture:o.createTexture(),usedTimes:0},c.memory.textures++,nt=!0),gt[ut].usedTimes++;const zt=gt[I.__cacheKey];zt!==void 0&&(gt[I.__cacheKey].usedTimes--,zt.usedTimes===0&&b(R)),I.__cacheKey=ut,I.__webglTexture=gt[ut].texture}return nt}function Tt(I,R,nt){return Math.floor(Math.floor(I/nt)/R)}function Nt(I,R,nt,ht){const ut=I.updateRanges;if(ut.length===0)e.texSubImage2D(o.TEXTURE_2D,0,0,0,R.width,R.height,nt,ht,R.data);else{ut.sort((St,Ut)=>St.start-Ut.start);let zt=0;for(let St=1;St<ut.length;St++){const Ut=ut[zt],Zt=ut[St],Vt=Ut.start+Ut.count,Ct=Tt(Zt.start,R.width,4),oe=Tt(Ut.start,R.width,4);Zt.start<=Vt+1&&Ct===oe&&Tt(Zt.start+Zt.count-1,R.width,4)===Ct?Ut.count=Math.max(Ut.count,Zt.start+Zt.count-Ut.start):(++zt,ut[zt]=Zt)}ut.length=zt+1;const Rt=o.getParameter(o.UNPACK_ROW_LENGTH),Xt=o.getParameter(o.UNPACK_SKIP_PIXELS),Yt=o.getParameter(o.UNPACK_SKIP_ROWS);o.pixelStorei(o.UNPACK_ROW_LENGTH,R.width);for(let St=0,Ut=ut.length;St<Ut;St++){const Zt=ut[St],Vt=Math.floor(Zt.start/4),Ct=Math.ceil(Zt.count/4),oe=Vt%R.width,q=Math.floor(Vt/R.width),bt=Ct,wt=1;o.pixelStorei(o.UNPACK_SKIP_PIXELS,oe),o.pixelStorei(o.UNPACK_SKIP_ROWS,q),e.texSubImage2D(o.TEXTURE_2D,0,oe,q,bt,wt,nt,ht,R.data)}I.clearUpdateRanges(),o.pixelStorei(o.UNPACK_ROW_LENGTH,Rt),o.pixelStorei(o.UNPACK_SKIP_PIXELS,Xt),o.pixelStorei(o.UNPACK_SKIP_ROWS,Yt)}}function et(I,R,nt){let ht=o.TEXTURE_2D;(R.isDataArrayTexture||R.isCompressedArrayTexture)&&(ht=o.TEXTURE_2D_ARRAY),R.isData3DTexture&&(ht=o.TEXTURE_3D);const gt=yt(I,R),ut=R.source;e.bindTexture(ht,I.__webglTexture,o.TEXTURE0+nt);const zt=a.get(ut);if(ut.version!==zt.__version||gt===!0){e.activeTexture(o.TEXTURE0+nt);const Rt=ye.getPrimaries(ye.workingColorSpace),Xt=R.colorSpace===Mr?null:ye.getPrimaries(R.colorSpace),Yt=R.colorSpace===Mr||Rt===Xt?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,R.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,R.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,R.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,Yt);let St=M(R.image,!1,r.maxTextureSize);St=je(R,St);const Ut=l.convert(R.format,R.colorSpace),Zt=l.convert(R.type);let Vt=U(R.internalFormat,Ut,Zt,R.colorSpace,R.isVideoTexture);ft(ht,R);let Ct;const oe=R.mipmaps,q=R.isVideoTexture!==!0,bt=zt.__version===void 0||gt===!0,wt=ut.dataReady,It=L(R,St);if(R.isDepthTexture)Vt=A(R.format===au,R.type),bt&&(q?e.texStorage2D(o.TEXTURE_2D,1,Vt,St.width,St.height):e.texImage2D(o.TEXTURE_2D,0,Vt,St.width,St.height,0,Ut,Zt,null));else if(R.isDataTexture)if(oe.length>0){q&&bt&&e.texStorage2D(o.TEXTURE_2D,It,Vt,oe[0].width,oe[0].height);for(let Mt=0,xt=oe.length;Mt<xt;Mt++)Ct=oe[Mt],q?wt&&e.texSubImage2D(o.TEXTURE_2D,Mt,0,0,Ct.width,Ct.height,Ut,Zt,Ct.data):e.texImage2D(o.TEXTURE_2D,Mt,Vt,Ct.width,Ct.height,0,Ut,Zt,Ct.data);R.generateMipmaps=!1}else q?(bt&&e.texStorage2D(o.TEXTURE_2D,It,Vt,St.width,St.height),wt&&Nt(R,St,Ut,Zt)):e.texImage2D(o.TEXTURE_2D,0,Vt,St.width,St.height,0,Ut,Zt,St.data);else if(R.isCompressedTexture)if(R.isCompressedArrayTexture){q&&bt&&e.texStorage3D(o.TEXTURE_2D_ARRAY,It,Vt,oe[0].width,oe[0].height,St.depth);for(let Mt=0,xt=oe.length;Mt<xt;Mt++)if(Ct=oe[Mt],R.format!==Ki)if(Ut!==null)if(q){if(wt)if(R.layerUpdates.size>0){const Ht=Ex(Ct.width,Ct.height,R.format,R.type);for(const ae of R.layerUpdates){const Ce=Ct.data.subarray(ae*Ht/Ct.data.BYTES_PER_ELEMENT,(ae+1)*Ht/Ct.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,Mt,0,0,ae,Ct.width,Ct.height,1,Ut,Ce)}R.clearLayerUpdates()}else e.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,Mt,0,0,0,Ct.width,Ct.height,St.depth,Ut,Ct.data)}else e.compressedTexImage3D(o.TEXTURE_2D_ARRAY,Mt,Vt,Ct.width,Ct.height,St.depth,0,Ct.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else q?wt&&e.texSubImage3D(o.TEXTURE_2D_ARRAY,Mt,0,0,0,Ct.width,Ct.height,St.depth,Ut,Zt,Ct.data):e.texImage3D(o.TEXTURE_2D_ARRAY,Mt,Vt,Ct.width,Ct.height,St.depth,0,Ut,Zt,Ct.data)}else{q&&bt&&e.texStorage2D(o.TEXTURE_2D,It,Vt,oe[0].width,oe[0].height);for(let Mt=0,xt=oe.length;Mt<xt;Mt++)Ct=oe[Mt],R.format!==Ki?Ut!==null?q?wt&&e.compressedTexSubImage2D(o.TEXTURE_2D,Mt,0,0,Ct.width,Ct.height,Ut,Ct.data):e.compressedTexImage2D(o.TEXTURE_2D,Mt,Vt,Ct.width,Ct.height,0,Ct.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):q?wt&&e.texSubImage2D(o.TEXTURE_2D,Mt,0,0,Ct.width,Ct.height,Ut,Zt,Ct.data):e.texImage2D(o.TEXTURE_2D,Mt,Vt,Ct.width,Ct.height,0,Ut,Zt,Ct.data)}else if(R.isDataArrayTexture)if(q){if(bt&&e.texStorage3D(o.TEXTURE_2D_ARRAY,It,Vt,St.width,St.height,St.depth),wt)if(R.layerUpdates.size>0){const Mt=Ex(St.width,St.height,R.format,R.type);for(const xt of R.layerUpdates){const Ht=St.data.subarray(xt*Mt/St.data.BYTES_PER_ELEMENT,(xt+1)*Mt/St.data.BYTES_PER_ELEMENT);e.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,xt,St.width,St.height,1,Ut,Zt,Ht)}R.clearLayerUpdates()}else e.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,0,St.width,St.height,St.depth,Ut,Zt,St.data)}else e.texImage3D(o.TEXTURE_2D_ARRAY,0,Vt,St.width,St.height,St.depth,0,Ut,Zt,St.data);else if(R.isData3DTexture)q?(bt&&e.texStorage3D(o.TEXTURE_3D,It,Vt,St.width,St.height,St.depth),wt&&e.texSubImage3D(o.TEXTURE_3D,0,0,0,0,St.width,St.height,St.depth,Ut,Zt,St.data)):e.texImage3D(o.TEXTURE_3D,0,Vt,St.width,St.height,St.depth,0,Ut,Zt,St.data);else if(R.isFramebufferTexture){if(bt)if(q)e.texStorage2D(o.TEXTURE_2D,It,Vt,St.width,St.height);else{let Mt=St.width,xt=St.height;for(let Ht=0;Ht<It;Ht++)e.texImage2D(o.TEXTURE_2D,Ht,Vt,Mt,xt,0,Ut,Zt,null),Mt>>=1,xt>>=1}}else if(oe.length>0){if(q&&bt){const Mt=Ze(oe[0]);e.texStorage2D(o.TEXTURE_2D,It,Vt,Mt.width,Mt.height)}for(let Mt=0,xt=oe.length;Mt<xt;Mt++)Ct=oe[Mt],q?wt&&e.texSubImage2D(o.TEXTURE_2D,Mt,0,0,Ut,Zt,Ct):e.texImage2D(o.TEXTURE_2D,Mt,Vt,Ut,Zt,Ct);R.generateMipmaps=!1}else if(q){if(bt){const Mt=Ze(St);e.texStorage2D(o.TEXTURE_2D,It,Vt,Mt.width,Mt.height)}wt&&e.texSubImage2D(o.TEXTURE_2D,0,0,0,Ut,Zt,St)}else e.texImage2D(o.TEXTURE_2D,0,Vt,Ut,Zt,St);S(R)&&y(ht),zt.__version=ut.version,R.onUpdate&&R.onUpdate(R)}I.__version=R.version}function _t(I,R,nt){if(R.image.length!==6)return;const ht=yt(I,R),gt=R.source;e.bindTexture(o.TEXTURE_CUBE_MAP,I.__webglTexture,o.TEXTURE0+nt);const ut=a.get(gt);if(gt.version!==ut.__version||ht===!0){e.activeTexture(o.TEXTURE0+nt);const zt=ye.getPrimaries(ye.workingColorSpace),Rt=R.colorSpace===Mr?null:ye.getPrimaries(R.colorSpace),Xt=R.colorSpace===Mr||zt===Rt?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,R.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,R.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,R.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,Xt);const Yt=R.isCompressedTexture||R.image[0].isCompressedTexture,St=R.image[0]&&R.image[0].isDataTexture,Ut=[];for(let xt=0;xt<6;xt++)!Yt&&!St?Ut[xt]=M(R.image[xt],!0,r.maxCubemapSize):Ut[xt]=St?R.image[xt].image:R.image[xt],Ut[xt]=je(R,Ut[xt]);const Zt=Ut[0],Vt=l.convert(R.format,R.colorSpace),Ct=l.convert(R.type),oe=U(R.internalFormat,Vt,Ct,R.colorSpace),q=R.isVideoTexture!==!0,bt=ut.__version===void 0||ht===!0,wt=gt.dataReady;let It=L(R,Zt);ft(o.TEXTURE_CUBE_MAP,R);let Mt;if(Yt){q&&bt&&e.texStorage2D(o.TEXTURE_CUBE_MAP,It,oe,Zt.width,Zt.height);for(let xt=0;xt<6;xt++){Mt=Ut[xt].mipmaps;for(let Ht=0;Ht<Mt.length;Ht++){const ae=Mt[Ht];R.format!==Ki?Vt!==null?q?wt&&e.compressedTexSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht,0,0,ae.width,ae.height,Vt,ae.data):e.compressedTexImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht,oe,ae.width,ae.height,0,ae.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):q?wt&&e.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht,0,0,ae.width,ae.height,Vt,Ct,ae.data):e.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht,oe,ae.width,ae.height,0,Vt,Ct,ae.data)}}}else{if(Mt=R.mipmaps,q&&bt){Mt.length>0&&It++;const xt=Ze(Ut[0]);e.texStorage2D(o.TEXTURE_CUBE_MAP,It,oe,xt.width,xt.height)}for(let xt=0;xt<6;xt++)if(St){q?wt&&e.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,0,0,0,Ut[xt].width,Ut[xt].height,Vt,Ct,Ut[xt].data):e.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,0,oe,Ut[xt].width,Ut[xt].height,0,Vt,Ct,Ut[xt].data);for(let Ht=0;Ht<Mt.length;Ht++){const Ce=Mt[Ht].image[xt].image;q?wt&&e.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht+1,0,0,Ce.width,Ce.height,Vt,Ct,Ce.data):e.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht+1,oe,Ce.width,Ce.height,0,Vt,Ct,Ce.data)}}else{q?wt&&e.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,0,0,0,Vt,Ct,Ut[xt]):e.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,0,oe,Vt,Ct,Ut[xt]);for(let Ht=0;Ht<Mt.length;Ht++){const ae=Mt[Ht];q?wt&&e.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht+1,0,0,Vt,Ct,ae.image[xt]):e.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht+1,oe,Vt,Ct,ae.image[xt])}}}S(R)&&y(o.TEXTURE_CUBE_MAP),ut.__version=gt.version,R.onUpdate&&R.onUpdate(R)}I.__version=R.version}function At(I,R,nt,ht,gt,ut){const zt=l.convert(nt.format,nt.colorSpace),Rt=l.convert(nt.type),Xt=U(nt.internalFormat,zt,Rt,nt.colorSpace),Yt=a.get(R),St=a.get(nt);if(St.__renderTarget=R,!Yt.__hasExternalTextures){const Ut=Math.max(1,R.width>>ut),Zt=Math.max(1,R.height>>ut);gt===o.TEXTURE_3D||gt===o.TEXTURE_2D_ARRAY?e.texImage3D(gt,ut,Xt,Ut,Zt,R.depth,0,zt,Rt,null):e.texImage2D(gt,ut,Xt,Ut,Zt,0,zt,Rt,null)}e.bindFramebuffer(o.FRAMEBUFFER,I),Gt(R)?f.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,ht,gt,St.__webglTexture,0,Ve(R)):(gt===o.TEXTURE_2D||gt>=o.TEXTURE_CUBE_MAP_POSITIVE_X&&gt<=o.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&o.framebufferTexture2D(o.FRAMEBUFFER,ht,gt,St.__webglTexture,ut),e.bindFramebuffer(o.FRAMEBUFFER,null)}function kt(I,R,nt){if(o.bindRenderbuffer(o.RENDERBUFFER,I),R.depthBuffer){const ht=R.depthTexture,gt=ht&&ht.isDepthTexture?ht.type:null,ut=A(R.stencilBuffer,gt),zt=R.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,Rt=Ve(R);Gt(R)?f.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,Rt,ut,R.width,R.height):nt?o.renderbufferStorageMultisample(o.RENDERBUFFER,Rt,ut,R.width,R.height):o.renderbufferStorage(o.RENDERBUFFER,ut,R.width,R.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,zt,o.RENDERBUFFER,I)}else{const ht=R.textures;for(let gt=0;gt<ht.length;gt++){const ut=ht[gt],zt=l.convert(ut.format,ut.colorSpace),Rt=l.convert(ut.type),Xt=U(ut.internalFormat,zt,Rt,ut.colorSpace),Yt=Ve(R);nt&&Gt(R)===!1?o.renderbufferStorageMultisample(o.RENDERBUFFER,Yt,Xt,R.width,R.height):Gt(R)?f.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,Yt,Xt,R.width,R.height):o.renderbufferStorage(o.RENDERBUFFER,Xt,R.width,R.height)}}o.bindRenderbuffer(o.RENDERBUFFER,null)}function qt(I,R){if(R&&R.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(o.FRAMEBUFFER,I),!(R.depthTexture&&R.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const ht=a.get(R.depthTexture);ht.__renderTarget=R,(!ht.__webglTexture||R.depthTexture.image.width!==R.width||R.depthTexture.image.height!==R.height)&&(R.depthTexture.image.width=R.width,R.depthTexture.image.height=R.height,R.depthTexture.needsUpdate=!0),rt(R.depthTexture,0);const gt=ht.__webglTexture,ut=Ve(R);if(R.depthTexture.format===iu)Gt(R)?f.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,gt,0,ut):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,gt,0);else if(R.depthTexture.format===au)Gt(R)?f.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,gt,0,ut):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,gt,0);else throw new Error("Unknown depthTexture format")}function pe(I){const R=a.get(I),nt=I.isWebGLCubeRenderTarget===!0;if(R.__boundDepthTexture!==I.depthTexture){const ht=I.depthTexture;if(R.__depthDisposeCallback&&R.__depthDisposeCallback(),ht){const gt=()=>{delete R.__boundDepthTexture,delete R.__depthDisposeCallback,ht.removeEventListener("dispose",gt)};ht.addEventListener("dispose",gt),R.__depthDisposeCallback=gt}R.__boundDepthTexture=ht}if(I.depthTexture&&!R.__autoAllocateDepthBuffer){if(nt)throw new Error("target.depthTexture not supported in Cube render targets");const ht=I.texture.mipmaps;ht&&ht.length>0?qt(R.__webglFramebuffer[0],I):qt(R.__webglFramebuffer,I)}else if(nt){R.__webglDepthbuffer=[];for(let ht=0;ht<6;ht++)if(e.bindFramebuffer(o.FRAMEBUFFER,R.__webglFramebuffer[ht]),R.__webglDepthbuffer[ht]===void 0)R.__webglDepthbuffer[ht]=o.createRenderbuffer(),kt(R.__webglDepthbuffer[ht],I,!1);else{const gt=I.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,ut=R.__webglDepthbuffer[ht];o.bindRenderbuffer(o.RENDERBUFFER,ut),o.framebufferRenderbuffer(o.FRAMEBUFFER,gt,o.RENDERBUFFER,ut)}}else{const ht=I.texture.mipmaps;if(ht&&ht.length>0?e.bindFramebuffer(o.FRAMEBUFFER,R.__webglFramebuffer[0]):e.bindFramebuffer(o.FRAMEBUFFER,R.__webglFramebuffer),R.__webglDepthbuffer===void 0)R.__webglDepthbuffer=o.createRenderbuffer(),kt(R.__webglDepthbuffer,I,!1);else{const gt=I.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,ut=R.__webglDepthbuffer;o.bindRenderbuffer(o.RENDERBUFFER,ut),o.framebufferRenderbuffer(o.FRAMEBUFFER,gt,o.RENDERBUFFER,ut)}}e.bindFramebuffer(o.FRAMEBUFFER,null)}function cn(I,R,nt){const ht=a.get(I);R!==void 0&&At(ht.__webglFramebuffer,I,I.texture,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,0),nt!==void 0&&pe(I)}function V(I){const R=I.texture,nt=a.get(I),ht=a.get(R);I.addEventListener("dispose",z);const gt=I.textures,ut=I.isWebGLCubeRenderTarget===!0,zt=gt.length>1;if(zt||(ht.__webglTexture===void 0&&(ht.__webglTexture=o.createTexture()),ht.__version=R.version,c.memory.textures++),ut){nt.__webglFramebuffer=[];for(let Rt=0;Rt<6;Rt++)if(R.mipmaps&&R.mipmaps.length>0){nt.__webglFramebuffer[Rt]=[];for(let Xt=0;Xt<R.mipmaps.length;Xt++)nt.__webglFramebuffer[Rt][Xt]=o.createFramebuffer()}else nt.__webglFramebuffer[Rt]=o.createFramebuffer()}else{if(R.mipmaps&&R.mipmaps.length>0){nt.__webglFramebuffer=[];for(let Rt=0;Rt<R.mipmaps.length;Rt++)nt.__webglFramebuffer[Rt]=o.createFramebuffer()}else nt.__webglFramebuffer=o.createFramebuffer();if(zt)for(let Rt=0,Xt=gt.length;Rt<Xt;Rt++){const Yt=a.get(gt[Rt]);Yt.__webglTexture===void 0&&(Yt.__webglTexture=o.createTexture(),c.memory.textures++)}if(I.samples>0&&Gt(I)===!1){nt.__webglMultisampledFramebuffer=o.createFramebuffer(),nt.__webglColorRenderbuffer=[],e.bindFramebuffer(o.FRAMEBUFFER,nt.__webglMultisampledFramebuffer);for(let Rt=0;Rt<gt.length;Rt++){const Xt=gt[Rt];nt.__webglColorRenderbuffer[Rt]=o.createRenderbuffer(),o.bindRenderbuffer(o.RENDERBUFFER,nt.__webglColorRenderbuffer[Rt]);const Yt=l.convert(Xt.format,Xt.colorSpace),St=l.convert(Xt.type),Ut=U(Xt.internalFormat,Yt,St,Xt.colorSpace,I.isXRRenderTarget===!0),Zt=Ve(I);o.renderbufferStorageMultisample(o.RENDERBUFFER,Zt,Ut,I.width,I.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Rt,o.RENDERBUFFER,nt.__webglColorRenderbuffer[Rt])}o.bindRenderbuffer(o.RENDERBUFFER,null),I.depthBuffer&&(nt.__webglDepthRenderbuffer=o.createRenderbuffer(),kt(nt.__webglDepthRenderbuffer,I,!0)),e.bindFramebuffer(o.FRAMEBUFFER,null)}}if(ut){e.bindTexture(o.TEXTURE_CUBE_MAP,ht.__webglTexture),ft(o.TEXTURE_CUBE_MAP,R);for(let Rt=0;Rt<6;Rt++)if(R.mipmaps&&R.mipmaps.length>0)for(let Xt=0;Xt<R.mipmaps.length;Xt++)At(nt.__webglFramebuffer[Rt][Xt],I,R,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+Rt,Xt);else At(nt.__webglFramebuffer[Rt],I,R,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+Rt,0);S(R)&&y(o.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(zt){for(let Rt=0,Xt=gt.length;Rt<Xt;Rt++){const Yt=gt[Rt],St=a.get(Yt);let Ut=o.TEXTURE_2D;(I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(Ut=I.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),e.bindTexture(Ut,St.__webglTexture),ft(Ut,Yt),At(nt.__webglFramebuffer,I,Yt,o.COLOR_ATTACHMENT0+Rt,Ut,0),S(Yt)&&y(Ut)}e.unbindTexture()}else{let Rt=o.TEXTURE_2D;if((I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(Rt=I.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),e.bindTexture(Rt,ht.__webglTexture),ft(Rt,R),R.mipmaps&&R.mipmaps.length>0)for(let Xt=0;Xt<R.mipmaps.length;Xt++)At(nt.__webglFramebuffer[Xt],I,R,o.COLOR_ATTACHMENT0,Rt,Xt);else At(nt.__webglFramebuffer,I,R,o.COLOR_ATTACHMENT0,Rt,0);S(R)&&y(Rt),e.unbindTexture()}I.depthBuffer&&pe(I)}function Le(I){const R=I.textures;for(let nt=0,ht=R.length;nt<ht;nt++){const gt=R[nt];if(S(gt)){const ut=D(I),zt=a.get(gt).__webglTexture;e.bindTexture(ut,zt),y(ut),e.unbindTexture()}}}const re=[],ne=[];function Pt(I){if(I.samples>0){if(Gt(I)===!1){const R=I.textures,nt=I.width,ht=I.height;let gt=o.COLOR_BUFFER_BIT;const ut=I.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,zt=a.get(I),Rt=R.length>1;if(Rt)for(let Yt=0;Yt<R.length;Yt++)e.bindFramebuffer(o.FRAMEBUFFER,zt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Yt,o.RENDERBUFFER,null),e.bindFramebuffer(o.FRAMEBUFFER,zt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+Yt,o.TEXTURE_2D,null,0);e.bindFramebuffer(o.READ_FRAMEBUFFER,zt.__webglMultisampledFramebuffer);const Xt=I.texture.mipmaps;Xt&&Xt.length>0?e.bindFramebuffer(o.DRAW_FRAMEBUFFER,zt.__webglFramebuffer[0]):e.bindFramebuffer(o.DRAW_FRAMEBUFFER,zt.__webglFramebuffer);for(let Yt=0;Yt<R.length;Yt++){if(I.resolveDepthBuffer&&(I.depthBuffer&&(gt|=o.DEPTH_BUFFER_BIT),I.stencilBuffer&&I.resolveStencilBuffer&&(gt|=o.STENCIL_BUFFER_BIT)),Rt){o.framebufferRenderbuffer(o.READ_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.RENDERBUFFER,zt.__webglColorRenderbuffer[Yt]);const St=a.get(R[Yt]).__webglTexture;o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,St,0)}o.blitFramebuffer(0,0,nt,ht,0,0,nt,ht,gt,o.NEAREST),p===!0&&(re.length=0,ne.length=0,re.push(o.COLOR_ATTACHMENT0+Yt),I.depthBuffer&&I.resolveDepthBuffer===!1&&(re.push(ut),ne.push(ut),o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,ne)),o.invalidateFramebuffer(o.READ_FRAMEBUFFER,re))}if(e.bindFramebuffer(o.READ_FRAMEBUFFER,null),e.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),Rt)for(let Yt=0;Yt<R.length;Yt++){e.bindFramebuffer(o.FRAMEBUFFER,zt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Yt,o.RENDERBUFFER,zt.__webglColorRenderbuffer[Yt]);const St=a.get(R[Yt]).__webglTexture;e.bindFramebuffer(o.FRAMEBUFFER,zt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+Yt,o.TEXTURE_2D,St,0)}e.bindFramebuffer(o.DRAW_FRAMEBUFFER,zt.__webglMultisampledFramebuffer)}else if(I.depthBuffer&&I.resolveDepthBuffer===!1&&p){const R=I.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT;o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,[R])}}}function Ve(I){return Math.min(r.maxSamples,I.samples)}function Gt(I){const R=a.get(I);return I.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&R.__useRenderToTexture!==!1}function se(I){const R=c.render.frame;m.get(I)!==R&&(m.set(I,R),I.update())}function je(I,R){const nt=I.colorSpace,ht=I.format,gt=I.type;return I.isCompressedTexture===!0||I.isVideoTexture===!0||nt!==Lo&&nt!==Mr&&(ye.getTransfer(nt)===Ie?(ht!==Ki||gt!==ha)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",nt)),R}function Ze(I){return typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement?(h.width=I.naturalWidth||I.width,h.height=I.naturalHeight||I.height):typeof VideoFrame<"u"&&I instanceof VideoFrame?(h.width=I.displayWidth,h.height=I.displayHeight):(h.width=I.width,h.height=I.height),h}this.allocateTextureUnit=tt,this.resetTextureUnits=j,this.setTexture2D=rt,this.setTexture2DArray=B,this.setTexture3D=G,this.setTextureCube=X,this.rebindTextures=cn,this.setupRenderTarget=V,this.updateRenderTargetMipmap=Le,this.updateMultisampleRenderTarget=Pt,this.setupDepthRenderbuffer=pe,this.setupFrameBufferTexture=At,this.useMultisampledRTT=Gt}function hC(o,t){function e(a,r=Mr){let l;const c=ye.getTransfer(r);if(a===ha)return o.UNSIGNED_BYTE;if(a===Nm)return o.UNSIGNED_SHORT_4_4_4_4;if(a===Pm)return o.UNSIGNED_SHORT_5_5_5_1;if(a===xy)return o.UNSIGNED_INT_5_9_9_9_REV;if(a===yy)return o.UNSIGNED_INT_10F_11F_11F_REV;if(a===gy)return o.BYTE;if(a===vy)return o.SHORT;if(a===eu)return o.UNSIGNED_SHORT;if(a===Om)return o.INT;if(a===_s)return o.UNSIGNED_INT;if(a===Ha)return o.FLOAT;if(a===pu)return o.HALF_FLOAT;if(a===Sy)return o.ALPHA;if(a===My)return o.RGB;if(a===Ki)return o.RGBA;if(a===iu)return o.DEPTH_COMPONENT;if(a===au)return o.DEPTH_STENCIL;if(a===Ey)return o.RED;if(a===zm)return o.RED_INTEGER;if(a===Ty)return o.RG;if(a===Im)return o.RG_INTEGER;if(a===Bm)return o.RGBA_INTEGER;if(a===ef||a===nf||a===af||a===rf)if(c===Ie)if(l=t.get("WEBGL_compressed_texture_s3tc_srgb"),l!==null){if(a===ef)return l.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(a===nf)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(a===af)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(a===rf)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(l=t.get("WEBGL_compressed_texture_s3tc"),l!==null){if(a===ef)return l.COMPRESSED_RGB_S3TC_DXT1_EXT;if(a===nf)return l.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(a===af)return l.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(a===rf)return l.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(a===Bp||a===Fp||a===Hp||a===Gp)if(l=t.get("WEBGL_compressed_texture_pvrtc"),l!==null){if(a===Bp)return l.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(a===Fp)return l.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(a===Hp)return l.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(a===Gp)return l.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(a===Vp||a===kp||a===Xp)if(l=t.get("WEBGL_compressed_texture_etc"),l!==null){if(a===Vp||a===kp)return c===Ie?l.COMPRESSED_SRGB8_ETC2:l.COMPRESSED_RGB8_ETC2;if(a===Xp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:l.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(a===Wp||a===qp||a===Yp||a===jp||a===Zp||a===Kp||a===Qp||a===Jp||a===$p||a===tm||a===em||a===nm||a===im||a===am)if(l=t.get("WEBGL_compressed_texture_astc"),l!==null){if(a===Wp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:l.COMPRESSED_RGBA_ASTC_4x4_KHR;if(a===qp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:l.COMPRESSED_RGBA_ASTC_5x4_KHR;if(a===Yp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:l.COMPRESSED_RGBA_ASTC_5x5_KHR;if(a===jp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:l.COMPRESSED_RGBA_ASTC_6x5_KHR;if(a===Zp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:l.COMPRESSED_RGBA_ASTC_6x6_KHR;if(a===Kp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:l.COMPRESSED_RGBA_ASTC_8x5_KHR;if(a===Qp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:l.COMPRESSED_RGBA_ASTC_8x6_KHR;if(a===Jp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:l.COMPRESSED_RGBA_ASTC_8x8_KHR;if(a===$p)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:l.COMPRESSED_RGBA_ASTC_10x5_KHR;if(a===tm)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:l.COMPRESSED_RGBA_ASTC_10x6_KHR;if(a===em)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:l.COMPRESSED_RGBA_ASTC_10x8_KHR;if(a===nm)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:l.COMPRESSED_RGBA_ASTC_10x10_KHR;if(a===im)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:l.COMPRESSED_RGBA_ASTC_12x10_KHR;if(a===am)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:l.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(a===rm||a===sm||a===om)if(l=t.get("EXT_texture_compression_bptc"),l!==null){if(a===rm)return c===Ie?l.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:l.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(a===sm)return l.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(a===om)return l.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(a===lm||a===um||a===cm||a===fm)if(l=t.get("EXT_texture_compression_rgtc"),l!==null){if(a===lm)return l.COMPRESSED_RED_RGTC1_EXT;if(a===um)return l.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(a===cm)return l.COMPRESSED_RED_GREEN_RGTC2_EXT;if(a===fm)return l.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return a===nu?o.UNSIGNED_INT_24_8:o[a]!==void 0?o[a]:null}return{convert:e}}const dC=`
void main() {
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var ry,Tr,Ro,a_,fs,sy,r_,S2=function(){return typeof window<"u"},Wa={},ss=180/Math.PI,wo=Math.PI/180,vo=Math.atan2,oy=1e8,s_=/([A-Z])/g,M2=/(left|right|width|margin|padding|x)/i,E2=/[\s,\(]\S/,fa={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},Am=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},T2=function(t,e){return e.set(e.t,e.p,t===1?e.e:Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},b2=function(t,e){return e.set(e.t,e.p,t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},A2=function(t,e){var a=e.s+e.c*t;e.set(e.t,e.p,~~(a+(a<0?-.5:.5))+e.u,e)},IS=function(t,e){return e.set(e.t,e.p,t?e.e:e.b,e)},BS=function(t,e){return e.set(e.t,e.p,t!==1?e.b:e.e,e)},R2=function(t,e,a){return t.style[e]=a},w2=function(t,e,a){return t.style.setProperty(e,a)},C2=function(t,e,a){return t._gsap[e]=a},D2=function(t,e,a){return t._gsap.scaleX=t._gsap.scaleY=a},U2=function(t,e,a,r,l){var c=t._gsap;c.scaleX=c.scaleY=a,c.renderTransform(l,c)},L2=function(t,e,a,r,l){var c=t._gsap;c[e]=a,c.renderTransform(l,c)},Je="transform",oi=Je+"Origin",O2=function o(t,e){var a=this,r=this.target,l=r.style,c=r._gsap;if(t in Wa&&l){if(this.tfm=this.tfm||{},t!=="transform")t=fa[t]||t,~t.indexOf(",")?t.split(",").forEach(function(f){return a.tfm[f]=Ba(r,f)}):this.tfm[t]=c.x?c[t]:Ba(r,t),t===oi&&(this.tfm.zOrigin=c.zOrigin);else return fa.transform.split(",").forEach(function(f){return o.call(a,f,e)});if(this.props.indexOf(Je)>=0)return;c.svg&&(this.svgo=r.getAttribute("data-svg-origin"),this.props.push(oi,e,"")),t=Je}(l||e)&&this.props.push(t,e,l[t])},FS=function(t){t.translate&&(t.removeProperty("translate"),t.removeProperty("scale"),t.removeProperty("rotate"))},N2=function(){var t=this.props,e=this.target,a=e.style,r=e._gsap,l,c;for(l=0;l<t.length;l+=3)t[l+1]?t[l+1]===2?e[t[l]](t[l+2]):e[t[l]]=t[l+2]:t[l+2]?a[t[l]]=t[l+2]:a.removeProperty(t[l].substr(0,2)==="--"?t[l]:t[l].replace(s_,"-$1").toLowerCase());if(this.tfm){for(c in this.tfm)r[c]=this.tfm[c];r.svg&&(r.renderTransform(),e.setAttribute("data-svg-origin",this.svgo||"")),l=r_(),(!l||!l.isStart)&&!a[Je]&&(FS(a),r.zOrigin&&a[oi]&&(a[oi]+=" "+r.zOrigin+"px",r.zOrigin=0,r.renderTransform()),r.uncache=1)}},HS=function(t,e){var a={target:t,props:[],revert:N2,save:O2};return t._gsap||li.core.getCache(t),e&&t.style&&t.nodeType&&e.split(",").forEach(function(r){return a.save(r)}),a},GS,Rm=function(t,e){var a=Tr.createElementNS?Tr.createElementNS((e||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),t):Tr.createElement(t);return a&&a.style?a:Tr.createElement(t)},Hi=function o(t,e,a){var r=getComputedStyle(t);return r[e]||r.getPropertyValue(e.replace(s_,"-$1").toLowerCase())||r.getPropertyValue(e)||!a&&o(t,Fo(e)||e,1)||""},ly="O,Moz,ms,Ms,Webkit".split(","),Fo=function(t,e,a){var r=e||fs,l=r.style,c=5;if(t in l&&!a)return t;for(t=t.charAt(0).toUpperCase()+t.substr(1);c--&&!(ly[c]+t in l););return c<0?null:(c===3?"ms":c>=0?ly[c]:"")+t},wm=function(){S2()&&window.document&&(ry=window,Tr=ry.document,Ro=Tr.documentElement,fs=Rm("div")||{style:{}},Rm("div"),Je=Fo(Je),oi=Je+"Origin",fs.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",GS=!!Fo("perspective"),r_=li.core.reverting,a_=1)},uy=function(t){var e=t.ownerSVGElement,a=Rm("svg",e&&e.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),r=t.cloneNode(!0),l;r.style.display="block",a.appendChild(r),Ro.appendChild(a);try{l=r.getBBox()}catch{}return a.removeChild(r),Ro.removeChild(a),l},cy=function(t,e){for(var a=e.length;a--;)if(t.hasAttribute(e[a]))return t.getAttribute(e[a])},VS=function(t){var e,a;try{e=t.getBBox()}catch{e=uy(t),a=1}return e&&(e.width||e.height)||a||(e=uy(t)),e&&!e.width&&!e.x&&!e.y?{x:+cy(t,["x","cx","x1"])||0,y:+cy(t,["y","cy","y1"])||0,width:0,height:0}:e},kS=function(t){return!!(t.getCTM&&(!t.parentNode||t.ownerSVGElement)&&VS(t))},xs=function(t,e){if(e){var a=t.style,r;e in Wa&&e!==oi&&(e=Je),a.removeProperty?(r=e.substr(0,2),(r==="ms"||e.substr(0,6)==="webkit")&&(e="-"+e),a.removeProperty(r==="--"?e:e.replace(s_,"-$1").toLowerCase())):a.removeAttribute(e)}},br=function(t,e,a,r,l,c){var f=new si(t._pt,e,a,0,1,c?BS:IS);return t._pt=f,f.b=r,f.e=l,t._props.push(a),f},fy={deg:1,rad:1,turn:1},P2={grid:1,flex:1},Ur=function o(t,e,a,r){var l=parseFloat(a)||0,c=(a+"").trim().substr((l+"").length)||"px",f=fs.style,p=M2.test(e),h=t.tagName.toLowerCase()==="svg",m=(h?"client":"offset")+(p?"Width":"Height"),g=100,v=r==="px",x=r==="%",E,M,S,y;if(r===c||!l||fy[r]||fy[c])return l;if(c!=="px"&&!v&&(l=o(t,e,a,"px")),y=t.getCTM&&kS(t),(x||c==="%")&&(Wa[e]||~e.indexOf("adius")))return E=y?t.getBBox()[p?"width":"height"]:t[m],un(x?l/E*g:l/100*E);if(f[p?"width":"height"]=g+(v?c:r),M=r!=="rem"&&~e.indexOf("adius")||r==="em"&&t.appendChild&&!h?t:t.parentNode,y&&(M=(t.ownerSVGElement||{}).parentNode),(!M||M===Tr||!M.appendChild)&&(M=Tr.body),S=M._gsap,S&&x&&S.width&&p&&S.time===xi.time&&!S.uncache)return un(l/S.width*g);if(x&&(e==="height"||e==="width")){var D=t.style[e];t.style[e]=g+r,E=t[m],D?t.style[e]=D:xs(t,e)}else(x||c==="%")&&!P2[Hi(M,"display")]&&(f.position=Hi(t,"position")),M===t&&(f.position="static"),M.appendChild(fs),E=fs[m],M.removeChild(fs),f.position="absolute";return p&&x&&(S=hs(M),S.time=xi.time,S.width=M[m]),un(v?E*l/g:E&&l?g/E*l:0)},Ba=function(t,e,a,r){var l;return a_||wm(),e in fa&&e!=="transform"&&(e=fa[e],~e.indexOf(",")&&(e=e.split(",")[0])),Wa[e]&&e!=="transform"?(l=du(t,r),l=e!=="transformOrigin"?l[e]:l.svg?l.origin:Tf(Hi(t,oi))+" "+l.zOrigin+"px"):(l=t.style[e],(!l||l==="auto"||r||~(l+"").indexOf("calc("))&&(l=Ef[e]&&Ef[e](t,e,a)||Hi(t,e)||rS(t,e)||(e==="opacity"?1:0))),a&&!~(l+"").trim().indexOf(" ")?Ur(t,e,l,a)+a:l},z2=function(t,e,a,r){if(!a||a==="none"){var l=Fo(e,t,1),c=l&&Hi(t,l,1);c&&c!==a?(e=l,a=c):e==="borderColor"&&(a=Hi(t,"borderTopColor"))}var f=new si(this._pt,t.style,e,0,1,NS),p=0,h=0,m,g,v,x,E,M,S,y,D,U,A,L;if(f.b=a,f.e=r,a+="",r+="",r.substring(0,6)==="var(--"&&(r=Hi(t,r.substring(4,r.indexOf(")")))),r==="auto"&&(M=t.style[e],t.style[e]=r,r=Hi(t,e)||r,M?t.style[e]=M:xs(t,e)),m=[a,r],TS(m),a=m[0],r=m[1],v=a.match(Mo)||[],L=r.match(Mo)||[],L.length){for(;g=Mo.exec(r);)S=g[0],D=r.substring(p,g.index),E?E=(E+1)%5:(D.substr(-5)==="rgba("||D.substr(-5)==="hsla(")&&(E=1),S!==(M=v[h++]||"")&&(x=parseFloat(M)||0,A=M.substr((x+"").length),S.charAt(1)==="="&&(S=Ao(x,S)+A),y=parseFloat(S),U=S.substr((y+"").length),p=Mo.lastIndex-U.length,U||(U=U||Ei.units[e]||A,p===r.length&&(r+=U,f.e+=U)),A!==U&&(x=Ur(t,e,M,U)||0),f._pt={_next:f._pt,p:D||h===1?D:",",s:x,c:y-x,m:E&&E<4||e==="zIndex"?Math.round:0});f.c=p<r.length?r.substring(p,r.length):""}else f.r=e==="display"&&r==="none"?BS:IS;return $y.test(r)&&(f.e=0),this._pt=f,f},hy={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},I2=function(t){var e=t.split(" "),a=e[0],r=e[1]||"50%";return(a==="top"||a==="bottom"||r==="left"||r==="right")&&(t=a,a=r,r=t),e[0]=hy[a]||a,e[1]=hy[r]||r,e.join(" ")},B2=function(t,e){if(e.tween&&e.tween._time===e.tween._dur){var a=e.t,r=a.style,l=e.u,c=a._gsap,f,p,h;if(l==="all"||l===!0)r.cssText="",p=1;else for(l=l.split(","),h=l.length;--h>-1;)f=l[h],Wa[f]&&(p=1,f=f==="transformOrigin"?oi:Je),xs(a,f);p&&(xs(a,Je),c&&(c.svg&&a.removeAttribute("transform"),r.scale=r.rotate=r.translate="none",du(a,1),c.uncache=1,FS(r)))}},Ef={clearProps:function(t,e,a,r,l){if(l.data!=="isFromStart"){var c=t._pt=new si(t._pt,e,a,0,0,B2);return c.u=r,c.pr=-10,c.tween=l,t._props.push(a),1}}},hu=[1,0,0,1,0,0],XS={},WS=function(t){return t==="matrix(1, 0, 0, 1, 0, 0)"||t==="none"||!t},dy=function(t){var e=Hi(t,Je);return WS(e)?hu:e.substr(7).match(Jy).map(un)},o_=function(t,e){var a=t._gsap||hs(t),r=t.style,l=dy(t),c,f,p,h;return a.svg&&t.getAttribute("transform")?(p=t.transform.baseVal.consolidate().matrix,l=[p.a,p.b,p.c,p.d,p.e,p.f],l.join(",")==="1,0,0,1,0,0"?hu:l):(l===hu&&!t.offsetParent&&t!==Ro&&!a.svg&&(p=r.display,r.display="block",c=t.parentNode,(!c||!t.offsetParent&&!t.getBoundingClientRect().width)&&(h=1,f=t.nextElementSibling,Ro.appendChild(t)),l=dy(t),p?r.display=p:xs(t,"display"),h&&(f?c.insertBefore(t,f):c?c.appendChild(t):Ro.removeChild(t))),e&&l.length>6?[l[0],l[1],l[4],l[5],l[12],l[13]]:l)},Cm=function(t,e,a,r,l,c){var f=t._gsap,p=l||o_(t,!0),h=f.xOrigin||0,m=f.yOrigin||0,g=f.xOffset||0,v=f.yOffset||0,x=p[0],E=p[1],M=p[2],S=p[3],y=p[4],D=p[5],U=e.split(" "),A=parseFloat(U[0])||0,L=parseFloat(U[1])||0,P,z,F,b;a?p!==hu&&(z=x*S-E*M)&&(F=A*(S/z)+L*(-M/z)+(M*D-S*y)/z,b=A*(-E/z)+L*(x/z)-(x*D-E*y)/z,A=F,L=b):(P=VS(t),A=P.x+(~U[0].indexOf("%")?A/100*P.width:A),L=P.y+(~(U[1]||U[0]).indexOf("%")?L/100*P.height:L)),r||r!==!1&&f.smooth?(y=A-h,D=L-m,f.xOffset=g+(y*x+D*M)-y,f.yOffset=v+(y*E+D*S)-D):f.xOffset=f.yOffset=0,f.xOrigin=A,f.yOrigin=L,f.smooth=!!r,f.origin=e,f.originIsAbsolute=!!a,t.style[oi]="0px 0px",c&&(br(c,f,"xOrigin",h,A),br(c,f,"yOrigin",m,L),br(c,f,"xOffset",g,f.xOffset),br(c,f,"yOffset",v,f.yOffset)),t.setAttribute("data-svg-origin",A+" "+L)},du=function(t,e){var a=t._gsap||new wS(t);if("x"in a&&!e&&!a.uncache)return a;var r=t.style,l=a.scaleX<0,c="px",f="deg",p=getComputedStyle(t),h=Hi(t,oi)||"0",m,g,v,x,E,M,S,y,D,U,A,L,P,z,F,b,O,k,j,tt,ct,rt,B,G,X,pt,N,Q,ft,yt,Tt,Nt;return m=g=v=M=S=y=D=U=A=0,x=E=1,a.svg=!!(t.getCTM&&kS(t)),p.translate&&((p.translate!=="none"||p.scale!=="none"||p.rotate!=="none")&&(r[Je]=(p.translate!=="none"?"translate3d("+(p.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(p.rotate!=="none"?"rotate("+p.rotate+") ":"")+(p.scale!=="none"?"scale("+p.scale.split(" ").join(",")+") ":"")+(p[Je]!=="none"?p[Je]:"")),r.scale=r.rotate=r.translate="none"),z=o_(t,a.svg),a.svg&&(a.uncache?(X=t.getBBox(),h=a.xOrigin-X.x+"px "+(a.yOrigin-X.y)+"px",G=""):G=!e&&t.getAttribute("data-svg-origin"),Cm(t,G||h,!!G||a.originIsAbsolute,a.smooth!==!1,z)),L=a.xOrigin||0,P=a.yOrigin||0,z!==hu&&(k=z[0],j=z[1],tt=z[2],ct=z[3],m=rt=z[4],g=B=z[5],z.length===6?(x=Math.sqrt(k*k+j*j),E=Math.sqrt(ct*ct+tt*tt),M=k||j?vo(j,k)*ss:0,D=tt||ct?vo(tt,ct)*ss+M:0,D&&(E*=Math.abs(Math.cos(D*wo))),a.svg&&(m-=L-(L*k+P*tt),g-=P-(L*j+P*ct))):(Nt=z[6],yt=z[7],N=z[8],Q=z[9],ft=z[10],Tt=z[11],m=z[12],g=z[13],v=z[14],F=vo(Nt,ft),S=F*ss,F&&(b=Math.cos(-F),O=Math.sin(-F),G=rt*b+N*O,X=B*b+Q*O,pt=Nt*b+ft*O,N=rt*-O+N*b,Q=B*-O+Q*b,ft=Nt*-O+ft*b,Tt=yt*-O+Tt*b,rt=G,B=X,Nt=pt),F=vo(-tt,ft),y=F*ss,F&&(b=Math.cos(-F),O=Math.sin(-F),G=k*b-N*O,X=j*b-Q*O,pt=tt*b-ft*O,Tt=ct*O+Tt*b,k=G,j=X,tt=pt),F=vo(j,k),M=F*ss,F&&(b=Math.cos(F),O=Math.sin(F),G=k*b+j*O,X=rt*b+B*O,j=j*b-k*O,B=B*b-rt*O,k=G,rt=X),S&&Math.abs(S)+Math.abs(M)>359.9&&(S=M=0,y=180-y),x=un(Math.sqrt(k*k+j*j+tt*tt)),E=un(Math.sqrt(B*B+Nt*Nt)),F=vo(rt,B),D=Math.abs(F)>2e-4?F*ss:0,A=Tt?1/(Tt<0?-Tt:Tt):0),a.svg&&(G=t.getAttribute("transform"),a.forceCSS=t.setAttribute("transform","")||!WS(Hi(t,Je)),G&&t.setAttribute("transform",G))),Math.abs(D)>90&&Math.abs(D)<270&&(l?(x*=-1,D+=M<=0?180:-180,M+=M<=0?180:-180):(E*=-1,D+=D<=0?180:-180)),e=e||a.uncache,a.x=m-((a.xPercent=m&&(!e&&a.xPercent||(Math.round(t.offsetWidth/2)===Math.round(-m)?-50:0)))?t.offsetWidth*a.xPercent/100:0)+c,a.y=g-((a.yPercent=g&&(!e&&a.yPercent||(Math.round(t.offsetHeight/2)===Math.round(-g)?-50:0)))?t.offsetHeight*a.yPercent/100:0)+c,a.z=v+c,a.scaleX=un(x),a.scaleY=un(E),a.rotation=un(M)+f,a.rotationX=un(S)+f,a.rotationY=un(y)+f,a.skewX=D+f,a.skewY=U+f,a.transformPerspective=A+c,(a.zOrigin=parseFloat(h.split(" ")[2])||!e&&a.zOrigin||0)&&(r[oi]=Tf(h)),a.xOffset=a.yOffset=0,a.force3D=Ei.force3D,a.renderTransform=a.svg?H2:GS?qS:F2,a.uncache=0,a},Tf=function(t){return(t=t.split(" "))[0]+" "+t[1]},bp=function(t,e,a){var r=Vn(e);return un(parseFloat(e)+parseFloat(Ur(t,"x",a+"px",r)))+r},F2=function(t,e){e.z="0px",e.rotationY=e.rotationX="0deg",e.force3D=0,qS(t,e)},ns="0deg",Wl="0px",is=") ",qS=function(t,e){var a=e||this,r=a.xPercent,l=a.yPercent,c=a.x,f=a.y,p=a.z,h=a.rotation,m=a.rotationY,g=a.rotationX,v=a.skewX,x=a.skewY,E=a.scaleX,M=a.scaleY,S=a.transformPerspective,y=a.force3D,D=a.target,U=a.zOrigin,A="",L=y==="auto"&&t&&t!==1||y===!0;if(U&&(g!==ns||m!==ns)){var P=parseFloat(m)*wo,z=Math.sin(P),F=Math.cos(P),b;P=parseFloat(g)*wo,b=Math.cos(P),c=bp(D,c,z*b*-U),f=bp(D,f,-Math.sin(P)*-U),p=bp(D,p,F*b*-U+U)}S!==Wl&&(A+="perspective("+S+is),(r||l)&&(A+="translate("+r+"%, "+l+"%) "),(L||c!==Wl||f!==Wl||p!==Wl)&&(A+=p!==Wl||L?"translate3d("+c+", "+f+", "+p+") ":"translate("+c+", "+f+is),h!==ns&&(A+="rotate("+h+is),m!==ns&&(A+="rotateY("+m+is),g!==ns&&(A+="rotateX("+g+is),(v!==ns||x!==ns)&&(A+="skew("+v+", "+x+is),(E!==1||M!==1)&&(A+="scale("+E+", "+M+is),D.style[Je]=A||"translate(0, 0)"},H2=function(t,e){var a=e||this,r=a.xPercent,l=a.yPercent,c=a.x,f=a.y,p=a.rotation,h=a.skewX,m=a.skewY,g=a.scaleX,v=a.scaleY,x=a.target,E=a.xOrigin,M=a.yOrigin,S=a.xOffset,y=a.yOffset,D=a.forceCSS,U=parseFloat(c),A=parseFloat(f),L,P,z,F,b;p=parseFloat(p),h=parseFloat(h),m=parseFloat(m),m&&(m=parseFloat(m),h+=m,p+=m),p||h?(p*=wo,h*=wo,L=Math.cos(p)*g,P=Math.sin(p)*g,z=Math.sin(p-h)*-v,F=Math.cos(p-h)*v,h&&(m*=wo,b=Math.tan(h-m),b=Math.sqrt(1+b*b),z*=b,F*=b,m&&(b=Math.tan(m),b=Math.sqrt(1+b*b),L*=b,P*=b)),L=un(L),P=un(P),z=un(z),F=un(F)):(L=g,F=v,P=z=0),(U&&!~(c+"").indexOf("px")||A&&!~(f+"").indexOf("px"))&&(U=Ur(x,"x",c,"px"),A=Ur(x,"y",f,"px")),(E||M||S||y)&&(U=un(U+E-(E*L+M*z)+S),A=un(A+M-(E*P+M*F)+y)),(r||l)&&(b=x.getBBox(),U=un(U+r/100*b.width),A=un(A+l/100*b.height)),b="matrix("+L+","+P+","+z+","+F+","+U+","+A+")",x.setAttribute("transform",b),D&&(x.style[Je]=b)},G2=function(t,e,a,r,l){var c=360,f=Cn(l),p=parseFloat(l)*(f&&~l.indexOf("rad")?ss:1),h=p-r,m=r+h+"deg",g,v;return f&&(g=l.split("_")[1],g==="short"&&(h%=c,h!==h%(c/2)&&(h+=h<0?c:-c)),g==="cw"&&h<0?h=(h+c*oy)%c-~~(h/c)*c:g==="ccw"&&h>0&&(h=(h-c*oy)%c-~~(h/c)*c)),t._pt=v=new si(t._pt,e,a,r,h,T2),v.e=m,v.u="deg",t._props.push(a),v},py=function(t,e){for(var a in e)t[a]=e[a];return t},V2=function(t,e,a){var r=py({},a._gsap),l="perspective,force3D,transformOrigin,svgOrigin",c=a.style,f,p,h,m,g,v,x,E;r.svg?(h=a.getAttribute("transform"),a.setAttribute("transform",""),c[Je]=e,f=du(a,1),xs(a,Je),a.setAttribute("transform",h)):(h=getComputedStyle(a)[Je],c[Je]=e,f=du(a,1),c[Je]=h);for(p in Wa)h=r[p],m=f[p],h!==m&&l.indexOf(p)<0&&(x=Vn(h),E=Vn(m),g=x!==E?Ur(a,p,h,E):parseFloat(h),v=parseFloat(m),t._pt=new si(t._pt,f,p,g,v-g,Am),t._pt.u=E||0,t._props.push(p));py(f,r)};ri("padding,margin,Width,Radius",function(o,t){var e="Top",a="Right",r="Bottom",l="Left",c=(t<3?[e,a,r,l]:[e+l,e+a,r+a,r+l]).map(function(f){return t<2?o+f:"border"+f+o});Ef[t>1?"border"+o:o]=function(f,p,h,m,g){var v,x;if(arguments.length<4)return v=c.map(function(E){return Ba(f,E,h)}),x=v.join(" "),x.split(v[0]).length===5?v[0]:x;v=(m+"").split(" "),x={},c.forEach(function(E,M){return x[E]=v[M]=v[M]||v[(M-1)/2|0]}),f.init(p,x,g)}});var YS={name:"css",register:wm,targetTest:function(t){return t.style&&t.nodeType},init:function(t,e,a,r,l){var c=this._props,f=t.style,p=a.vars.startAt,h,m,g,v,x,E,M,S,y,D,U,A,L,P,z,F;a_||wm(),this.styles=this.styles||HS(t),F=this.styles.props,this.tween=a;for(M in e)if(M!=="autoRound"&&(m=e[M],!(vi[M]&&CS(M,e,a,r,t,l)))){if(x=typeof m,E=Ef[M],x==="function"&&(m=m.call(a,r,t,l),x=typeof m),x==="string"&&~m.indexOf("random(")&&(m=uu(m)),E)E(this,t,M,m,a)&&(z=1);else if(M.substr(0,2)==="--")h=(getComputedStyle(t).getPropertyValue(M)+"").trim(),m+="",Cr.lastIndex=0,Cr.test(h)||(S=Vn(h),y=Vn(m)),y?S!==y&&(h=Ur(t,M,h,y)+y):S&&(m+=S),this.add(f,"setProperty",h,m,r,l,0,0,M),c.push(M),F.push(M,0,f[M]);else if(x!=="undefined"){if(p&&M in p?(h=typeof p[M]=="function"?p[M].call(a,r,t,l):p[M],Cn(h)&&~h.indexOf("random(")&&(h=uu(h)),Vn(h+"")||h==="auto"||(h+=Ei.units[M]||Vn(Ba(t,M))||""),(h+"").charAt(1)==="="&&(h=Ba(t,M))):h=Ba(t,M),v=parseFloat(h),D=x==="string"&&m.charAt(1)==="="&&m.substr(0,2),D&&(m=m.substr(2)),g=parseFloat(m),M in fa&&(M==="autoAlpha"&&(v===1&&Ba(t,"visibility")==="hidden"&&g&&(v=0),F.push("visibility",0,f.visibility),br(this,f,"visibility",v?"inherit":"hidden",g?"inherit":"hidden",!g)),M!=="scale"&&M!=="transform"&&(M=fa[M],~M.indexOf(",")&&(M=M.split(",")[0]))),U=M in Wa,U){if(this.styles.save(M),x==="string"&&m.substring(0,6)==="var(--"&&(m=Hi(t,m.substring(4,m.indexOf(")"))),g=parseFloat(m)),A||(L=t._gsap,L.renderTransform&&!e.parseTransform||du(t,e.parseTransform),P=e.smoothOrigin!==!1&&L.smooth,A=this._pt=new si(this._pt,f,Je,0,1,L.renderTransform,L,0,-1),A.dep=1),M==="scale")this._pt=new si(this._pt,L,"scaleY",L.scaleY,(D?Ao(L.scaleY,D+g):g)-L.scaleY||0,Am),this._pt.u=0,c.push("scaleY",M),M+="X";else if(M==="transformOrigin"){F.push(oi,0,f[oi]),m=I2(m),L.svg?Cm(t,m,0,P,0,this):(y=parseFloat(m.split(" ")[2])||0,y!==L.zOrigin&&br(this,L,"zOrigin",L.zOrigin,y),br(this,f,M,Tf(h),Tf(m)));continue}else if(M==="svgOrigin"){Cm(t,m,1,P,0,this);continue}else if(M in XS){G2(this,L,M,v,D?Ao(v,D+m):m);continue}else if(M==="smoothOrigin"){br(this,L,"smooth",L.smooth,m);continue}else if(M==="force3D"){L[M]=m;continue}else if(M==="transform"){V2(this,m,t);continue}}else M in f||(M=Fo(M)||M);if(U||(g||g===0)&&(v||v===0)&&!E2.test(m)&&M in f)S=(h+"").substr((v+"").length),g||(g=0),y=Vn(m)||(M in Ei.units?Ei.units[M]:S),S!==y&&(v=Ur(t,M,h,y)),this._pt=new si(this._pt,U?L:f,M,v,(D?Ao(v,D+g):g)-v,!U&&(y==="px"||M==="zIndex")&&e.autoRound!==!1?A2:Am),this._pt.u=y||0,S!==y&&y!=="%"&&(this._pt.b=h,this._pt.r=b2);else if(M in f)z2.call(this,t,M,h,D?D+m:m);else if(M in t)this.add(t,M,h||t[M],D?D+m:m,r,l);else if(M!=="parseTransform"){jm(M,m);continue}U||(M in f?F.push(M,0,f[M]):typeof t[M]=="function"?F.push(M,2,t[M]()):F.push(M,1,h||t[M])),c.push(M)}}z&&PS(this)},render:function(t,e){if(e.tween._time||!r_())for(var a=e._pt;a;)a.r(t,a.d),a=a._next;else e.styles.revert()},get:Ba,aliases:fa,getSetter:function(t,e,a){var r=fa[e];return r&&r.indexOf(",")<0&&(e=r),e in Wa&&e!==oi&&(t._gsap.x||Ba(t,"x"))?a&&sy===a?e==="scale"?D2:C2:(sy=a||{})&&(e==="scale"?U2:L2):t.style&&!Wm(t.style[e])?R2:~e.indexOf("-")?w2:n_(t,e)},core:{_removeProperty:xs,_getMatrix:o_}};li.utils.checkPrefix=Fo;li.core.getStyleSaver=HS;(function(o,t,e,a){var r=ri(o+","+t+","+e,function(l){Wa[l]=1});ri(t,function(l){Ei.units[l]="deg",XS[l]=1}),fa[r[13]]=o+","+t,ri(a,function(l){var c=l.split(":");fa[c[1]]=r[c[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");ri("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(o){Ei.units[o]="px"});li.registerPlugin(YS);var ff=li.registerPlugin(YS)||li;ff.core.Tween;function k2(){const o=tu.useRef(null);return tu.useEffect(()=>{const t=o.current,e=t.clientWidth,a=t.clientHeight,r=new Sb,l=new Ii(45,e/a,.1,1e3);l.position.z=5;const c=new yC({antialias:!0,alpha:!0});c.setSize(e,a),c.setPixelRatio(Math.min(window.devicePixelRatio,2)),c.setClearColor(0,0),t.appendChild(c.domElement);const f=new xo;r.add(f),console.log("Starting to load model files..."),fetch("/models/test_cube.mtl").then(G=>{if(console.log("MTL file fetch response:",G.status,G.statusText),!G.ok)throw new Error(`MTL file not found: ${G.status}`);return G.text()}).then(G=>(console.log("MTL file content loaded, size:",G.length),fetch("/models/test_cube.obj"))).then(G=>{if(console.log("OBJ file fetch response:",G.status,G.statusText),!G.ok)throw new Error(`OBJ file not found: ${G.status}`);console.log("OBJ file is accessible, proceeding with Three.js loaders...");const X=new RC,pt=new Fy;pt.onLoad=()=>console.log("All resources loaded"),pt.onError=N=>console.error("Error loading:",N),X.manager=pt,X.load("/models/test_cube.mtl",N=>{console.log("MTL loaded successfully with Three.js:",N),N.preload();const Q=new AC;Q.manager=pt,Q.setMaterials(N),Q.load("/models/test_cube.obj",ft=>{console.log("OBJ loaded successfully:",ft);const yt=new Go().setFromObject(ft),Tt=yt.getSize(new it),Nt=yt.getCenter(new it);console.log("Model size:",Tt),console.log("Model center:",Nt);const At=2/Math.max(Tt.x,Tt.y,Tt.z);ft.scale.setScalar(At),ft.position.copy(Nt.multiplyScalar(-At)),ft.traverse(kt=>{kt.isMesh&&(kt.castShadow=!0,kt.receiveShadow=!0,kt.material&&(kt.material.needsUpdate=!0))}),f.add(ft),console.log("Model successfully added to scene")},ft=>{const yt=ft.loaded/ft.total*100;console.log("OBJ loading progress:",yt+"%")},ft=>{console.error("Three.js OBJ loading error:",ft),p("red","OBJ loading failed")})},N=>{console.log("MTL loading progress:",N.loaded/N.total*100+"%")},N=>{console.error("Three.js MTL loading error:",N),p("orange","MTL loading failed")})}).catch(G=>{console.error("File accessibility test failed:",G),p("blue","Files not accessible")});function p(G,X){console.log(`Adding ${G} fallback cube - ${X}`);const pt=new vs(1,1,1),N=G==="red"?16711680:G==="orange"?16746496:G==="blue"?255:8947848,Q=new yx({color:N}),ft=new yi(pt,Q);f.add(ft)}const h=new vs(.1,.1,.1),m=new yx({transparent:!0,opacity:0});new yi(h,m);const g=new Ob(16777215,1);g.position.set(5,5,5),r.add(g);const v=new Nb(4210752,.6);r.add(v);const x=50;let E=0,M=0,S=0,y=0;const D=new Ti,U=new Float32Array(x*3),A=new Float32Array(x);for(let G=0;G<x;G++)U[G*3]=0,U[G*3+1]=0,U[G*3+2]=0,A[G]=(x-G)/x;D.setAttribute("position",new Mi(U,3)),D.setAttribute("opacity",new Mi(A,1));const L=new ka({uniforms:{time:{value:0},color:{value:new ce(8956671)}},vertexShader:`
