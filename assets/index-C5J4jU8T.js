 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var zv;function $E(){if(zv)return ue;zv=1;var o=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),e=Symbol.for("react.fragment"),a=Symbol.for("react.strict_mode"),r=Symbol.for("react.profiler"),l=Symbol.for("react.consumer"),c=Symbol.for("react.context"),f=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),h=Symbol.for("react.memo"),m=Symbol.for("react.lazy"),g=Symbol.iterator;function v(O){return O===null||typeof O!="object"?null:(O=g&&O[g]||O["@@iterator"],typeof O=="function"?O:null)}var x={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},E=Object.assign,M={};function S(O,Y,ht){this.props=O,this.context=Y,this.refs=M,this.updater=ht||x}S.prototype.isReactComponent={},S.prototype.setState=function(O,Y){if(typeof O!="object"&&typeof O!="function"&&O!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,O,Y,"setState")},S.prototype.forceUpdate=function(O){this.updater.enqueueForceUpdate(this,O,"forceUpdate")};function y(){}y.prototype=S.prototype;function L(O,Y,ht){this.props=O,this.context=Y,this.refs=M,this.updater=ht||x}var U=L.prototype=new y;U.constructor=L,E(U,S.prototype),U.isPureReactComponent=!0;var A=Array.isArray,D={H:null,A:null,T:null,S:null,V:null},P=Object.prototype.hasOwnProperty;function z(O,Y,ht,ut,Et,Rt){return ht=Rt.ref,{$$typeof:o,type:O,key:Y,ref:ht!==void 0?ht:null,props:Rt}}function F(O,Y){return z(O.type,Y,void 0,void 0,void 0,O.props)}function b(O){return typeof O=="object"&&O!==null&&O.$$typeof===o}function N(O){var Y={"=":"=0",":":"=2"};return"$"+O.replace(/[=:]/g,function(ht){return Y[ht]})}var G=/\/+/g;function j(O,Y){return typeof O=="object"&&O!==null&&O.key!=null?N(""+O.key):Y.toString(36)}function et(){}function ft(O){switch(O.status){case"fulfilled":return O.value;case"rejected":throw O.reason;default:switch(typeof O.status=="string"?O.then(et,et):(O.status="pending",O.then(function(Y){O.status==="pending"&&(O.status="fulfilled",O.value=Y)},function(Y){O.status==="pending"&&(O.status="rejected",O.reason=Y)})),O.status){case"fulfilled":return O.value;case"rejected":throw O.reason}}throw O}function rt(O,Y,ht,ut,Et){var Rt=typeof O;(Rt==="undefined"||Rt==="boolean")&&(O=null);var $=!1;if(O===null)$=!0;else switch(Rt){case"bigint":case"string":case"number":$=!0;break;case"object":switch(O.$$typeof){case o:case t:$=!0;break;case m:return $=O._init,rt($(O._payload),Y,ht,ut,Et)}}if($)return Et=Et(O),$=ut===""?"."+j(O,0):ut,A(Et)?(ht="",$!=null&&(ht=$.replace(G,"$&/")+"/"),rt(Et,Y,ht,"",function(Zt){return Zt})):Et!=null&&(b(Et)&&(Et=F(Et,ht+(Et.key==null||O&&O.key===Et.key?"":(""+Et.key).replace(G,"$&/")+"/")+$)),Y.push(Et)),1;$=0;var _t=ut===""?".":ut+":";if(A(O))for(var At=0;At<O.length;At++)ut=O[At],Rt=_t+j(ut,At),$+=rt(ut,Y,ht,Rt,Et);else if(At=v(O),typeof At=="function")for(O=At.call(O),At=0;!(ut=O.next()).done;)ut=ut.value,Rt=_t+j(ut,At++),$+=rt(ut,Y,ht,Rt,Et);else if(Rt==="object"){if(typeof O.then=="function")return rt(ft(O),Y,ht,ut,Et);throw Y=String(O),Error("Objects are not valid as a React child (found: "+(Y==="[object Object]"?"object with keys {"+Object.keys(O).join(", ")+"}":Y)+"). If you meant to render a collection of children, use an array instead.")}return $}function B(O,Y,ht){if(O==null)return O;var ut=[],Et=0;return rt(O,ut,"","",function(Rt){return Y.call(ht,Rt,Et++)}),ut}function W(O){if(O._status===-1){var Y=O._result;Y=Y(),Y.then(function(ht){(O._status===0||O._status===-1)&&(O._status=1,O._result=ht)},function(ht){(O._status===0||O._status===-1)&&(O._status=2,O._result=ht)}),O._status===-1&&(O._status=0,O._result=Y)}if(O._status===1)return O._result.default;throw O._result}var q=typeof reportError=="function"?reportError:function(O){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var Y=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof O=="object"&&O!==null&&typeof O.message=="string"?String(O.message):String(O),error:O});if(!window.dispatchEvent(Y))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",O);return}console.error(O)};function yt(){}return ue.Children={map:B,forEach:function(O,Y,ht){B(O,function(){Y.apply(this,arguments)},ht)},count:function(O){var Y=0;return B(O,function(){Y++}),Y},toArray:function(O){return B(O,function(Y){return Y})||[]},only:function(O){if(!b(O))throw Error("React.Children.only expected to receive a single React element child.");return O}},ue.Component=S,ue.Fragment=e,ue.Profiler=r,ue.PureComponent=L,ue.StrictMode=a,ue.Suspense=p,ue.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=D,ue.__COMPILER_RUNTIME={__proto__:null,c:function(O){return D.H.useMemoCache(O)}},ue.cache=function(O){return function(){return O.apply(null,arguments)}},ue.cloneElement=function(O,Y,ht){if(O==null)throw Error("The argument must be a React element, but you passed "+O+".");var ut=E({},O.props),Et=O.key,Rt=void 0;if(Y!=null)for($ in Y.ref!==void 0&&(Rt=void 0),Y.key!==void 0&&(Et=""+Y.key),Y)!P.call(Y,$)||$==="key"||$==="__self"||$==="__source"||$==="ref"&&Y.ref===void 0||(ut[$]=Y[$]);var $=arguments.length-2;if($===1)ut.children=ht;else if(1<$){for(var _t=Array($),At=0;At<$;At++)_t[At]=arguments[At+2];ut.children=_t}return z(O.type,Et,void 0,void 0,Rt,ut)},ue.createContext=function(O){return O={$$typeof:c,_currentValue:O,_currentValue2:O,_threadCount:0,Provider:null,Consumer:null},O.Provider=O,O.Consumer={$$typeof:l,_context:O},O},ue.createElement=function(O,Y,ht){var ut,Et={},Rt=null;if(Y!=null)for(ut in Y.key!==void 0&&(Rt=""+Y.key),Y)P.call(Y,ut)&&ut!=="key"&&ut!=="__self"&&ut!=="__source"&&(Et[ut]=Y[ut]);var $=arguments.length-2;if($===1)Et.children=ht;else if(1<$){for(var _t=Array($),At=0;At<$;At++)_t[At]=arguments[At+2];Et.children=_t}if(O&&O.defaultProps)for(ut in $=O.defaultProps,$)Et[ut]===void 0&&(Et[ut]=$[ut]);return z(O,Rt,void 0,void 0,null,Et)},ue.createRef=function(){return{current:null}},ue.forwardRef=function(O){return{$$typeof:f,render:O}},ue.isValidElement=b,ue.lazy=function(O){return{$$typeof:m,_payload:{_status:-1,_result:O},_init:W}},ue.memo=function(O,Y){return{$$typeof:h,type:O,compare:Y===void 0?null:Y}},ue.startTransition=function(O){var Y=D.T,ht={};D.T=ht;try{var ut=O(),Et=D.S;Et!==null&&Et(ht,ut),typeof ut=="object"&&ut!==null&&typeof ut.then=="function"&&ut.then(yt,q)}catch(Rt){q(Rt)}finally{D.T=Y}},ue.unstable_useCacheRefresh=function(){return D.H.useCacheRefresh()},ue.use=function(O){return D.H.use(O)},ue.useActionState=function(O,Y,ht){return D.H.useActionState(O,Y,ht)},ue.useCallback=function(O,Y){return D.H.useCallback(O,Y)},ue.useContext=function(O){return D.H.useContext(O)},ue.useDebugValue=function(){},ue.useDeferredValue=function(O,Y){return D.H.useDeferredValue(O,Y)},ue.useEffect=function(O,Y,ht){var ut=D.H;if(typeof ht=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return ut.useEffect(O,Y)},ue.useId=function(){return D.H.useId()},ue.useImperativeHandle=function(O,Y,ht){return D.H.useImperativeHandle(O,Y,ht)},ue.useInsertionEffect=function(O,Y){return D.H.useInsertionEffect(O,Y)},ue.useLayoutEffect=function(O,Y){return D.H.useLayoutEffect(O,Y)},ue.useMemo=function(O,Y){return D.H.useMemo(O,Y)},ue.useOptimistic=function(O,Y){return D.H.useOptimistic(O,Y)},ue.useReducer=function(O,Y,ht){return D.H.useReducer(O,Y,ht)},ue.useRef=function(O){return D.H.useRef(O)},ue.useState=function(O){return D.H.useState(O)},ue.useSyncExternalStore=function(O,Y,ht){return D.H.useSyncExternalStore(O,Y,ht)},ue.useTransition=function(){return D.H.useTransition()},ue.version="19.1.1",ue}var Iv;function Dm(){return Iv||(Iv=1,Od.exports=$E()),Od.exports}var tu=Dm(),Nd={exports:{}},Bl={},Pd={exports:{}},zd={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Bv;function tT(){return Bv||(Bv=1,(function(o){function t(B,W){var q=B.length;B.push(W);t:for(;0<q;){var yt=q-1>>>1,O=B[yt];if(0<r(O,W))B[yt]=W,B[q]=O,q=yt;else break t}}function e(B){return B.length===0?null:B[0]}function a(B){if(B.length===0)return null;var W=B[0],q=B.pop();if(q!==W){B[0]=q;t:for(var yt=0,O=B.length,Y=O>>>1;yt<Y;){var ht=2*(yt+1)-1,ut=B[ht],Et=ht+1,Rt=B[Et];if(0>r(ut,q))Et<O&&0>r(Rt,ut)?(B[yt]=Rt,B[Et]=q,yt=Et):(B[yt]=ut,B[ht]=q,yt=ht);else if(Et<O&&0>r(Rt,q))B[yt]=Rt,B[Et]=q,yt=Et;else break t}}return W}function r(B,W){var q=B.sortIndex-W.sortIndex;return q!==0?q:B.id-W.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var l=performance;o.unstable_now=function(){return l.now()}}else{var c=Date,f=c.now();o.unstable_now=function(){return c.now()-f}}var p=[],h=[],m=1,g=null,v=3,x=!1,E=!1,M=!1,S=!1,y=typeof setTimeout=="function"?setTimeout:null,L=typeof clearTimeout=="function"?clearTimeout:null,U=typeof setImmediate<"u"?setImmediate:null;function A(B){for(var W=e(h);W!==null;){if(W.callback===null)a(h);else if(W.startTime<=B)a(h),W.sortIndex=W.expirationTime,t(p,W);else break;W=e(h)}}function D(B){if(M=!1,A(B),!E)if(e(p)!==null)E=!0,P||(P=!0,j());else{var W=e(h);W!==null&&rt(D,W.startTime-B)}}var P=!1,z=-1,F=5,b=-1;function N(){return S?!0:!(o.unstable_now()-b<F)}function G(){if(S=!1,P){var B=o.unstable_now();b=B;var W=!0;try{t:{E=!1,M&&(M=!1,L(z),z=-1),x=!0;var q=v;try{e:{for(A(B),g=e(p);g!==null&&!(g.expirationTime>B&&N());){var yt=g.callback;if(typeof yt=="function"){g.callback=null,v=g.priorityLevel;var O=yt(g.expirationTime<=B);if(B=o.unstable_now(),typeof O=="function"){g.callback=O,A(B),W=!0;break e}g===e(p)&&a(p),A(B)}else a(p);g=e(p)}if(g!==null)W=!0;else{var Y=e(h);Y!==null&&rt(D,Y.startTime-B),W=!1}}break t}finally{g=null,v=q,x=!1}W=void 0}}finally{W?j():P=!1}}}var j;if(typeof U=="function")j=function(){U(G)};else if(typeof MessageChannel<"u"){var et=new MessageChannel,ft=et.port2;et.port1.onmessage=G,j=function(){ft.postMessage(null)}}else j=function(){y(G,0)};function rt(B,W){z=y(function(){B(o.unstable_now())},W)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(B){B.callback=null},o.unstable_forceFrameRate=function(B){0>B||125<B?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):F=0<B?Math.floor(1e3/B):5},o.unstable_getCurrentPriorityLevel=function(){return v},o.unstable_next=function(B){switch(v){case 1:case 2:case 3:var W=3;break;default:W=v}var q=v;v=W;try{return B()}finally{v=q}},o.unstable_requestPaint=function(){S=!0},o.unstable_runWithPriority=function(B,W){switch(B){case 1:case 2:case 3:case 4:case 5:break;default:B=3}var q=v;v=B;try{return W()}finally{v=q}},o.unstable_scheduleCallback=function(B,W,q){var yt=o.unstable_now();switch(typeof q=="object"&&q!==null?(q=q.delay,q=typeof q=="number"&&0<q?yt+q:yt):q=yt,B){case 1:var O=-1;break;case 2:O=250;break;case 5:O=1073741823;break;case 4:O=1e4;break;default:O=5e3}return O=q+O,B={id:m++,callback:W,priorityLevel:B,startTime:q,expirationTime:O,sortIndex:-1},q>yt?(B.sortIndex=q,t(h,B),e(p)===null&&B===e(h)&&(M?(L(z),z=-1):M=!0,rt(D,q-yt))):(B.sortIndex=O,t(p,B),E||x||(E=!0,P||(P=!0,j()))),B},o.unstable_shouldYield=N,o.unstable_wrapCallback=function(B){var W=v;return function(){var q=v;v=W;try{return B.apply(this,arguments)}finally{v=q}}}})(zd)),zd}var Fv;function eT(){return Fv||(Fv=1,Pd.exports=tT()),Pd.exports}var Id={exports:{}},Fn={};/**
 * @license React
...
`),tt=w.split(`
`);for(d=u=0;u<H.length&&!H[u].includes("DetermineComponentFrameRoot");)u++;for(;d<tt.length&&!tt[d].includes("DetermineComponentFrameRoot");)d++;if(u===H.length||d===tt.length)for(u=H.length-1,d=tt.length-1;1<=u&&0<=d&&H[u]!==tt[d];)d--;for(;1<=u&&0<=d;u--,d--)if(H[u]!==tt[d]){if(u!==1||d!==1)do if(u--,d--,0>d||H[u]!==tt[d]){var pt=`
...
`)+`
`+y);const U=L+S+c,A=L+y+f,D=Bx(r,r.VERTEX_SHADER,U),P=Bx(r,r.FRAGMENT_SHADER,A);r.attachShader(M,D),r.attachShader(M,P),e.index0AttributeName!==void 0?r.bindAttribLocation(M,0,e.index0AttributeName):e.morphTargets===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M);function z(G){if(o.debug.checkShaderErrors){const j=r.getProgramInfoLog(M)||"",et=r.getShaderInfoLog(D)||"",ft=r.getShaderInfoLog(P)||"",rt=j.trim(),B=et.trim(),W=ft.trim();let q=!0,yt=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if(q=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(r,M,D,P);else{const O=Hx(r,D,"vertex"),Y=Hx(r,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`
...
}`;function lC(o,t,e){let a=new Vm;const r=new Te,l=new Te,c=new sn,f=new Ab({depthPacking:FT}),p=new Rb,h={},m=e.maxTextureSize,g={[Va]:ii,[ii]:Va,[Fa]:Fa},v=new ka({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Te},radius:{value:4}},vertexShader:sC,fragmentShader:oC}),x=v.clone();x.defines.HORIZONTAL_PASS=1;const E=new Ti;E.setAttribute("position",new Mi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new yi(E,v),S=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=my;let y=this.type;this.render=function(P,z,F){if(S.enabled===!1||S.autoUpdate===!1&&S.needsUpdate===!1||P.length===0)return;const b=o.getRenderTarget(),N=o.getActiveCubeFace(),G=o.getActiveMipmapLevel(),j=o.state;j.setBlending(Ar),j.buffers.depth.getReversed()===!0?j.buffers.color.setClear(0,0,0,0):j.buffers.color.setClear(1,1,1,1),j.buffers.depth.setTest(!0),j.setScissorTest(!1);const et=y!==za&&this.type===za,ft=y===za&&this.type!==za;for(let rt=0,B=P.length;rt<B;rt++){const W=P[rt],q=W.shadow;if(q===void 0){console.warn("THREE.WebGLShadowMap:",W,"has no shadow.");continue}if(q.autoUpdate===!1&&q.needsUpdate===!1)continue;r.copy(q.mapSize);const yt=q.getFrameExtents();if(r.multiply(yt),l.copy(q.mapSize),(r.x>m||r.y>m)&&(r.x>m&&(l.x=Math.floor(m/yt.x),r.x=l.x*yt.x,q.mapSize.x=l.x),r.y>m&&(l.y=Math.floor(m/yt.y),r.y=l.y*yt.y,q.mapSize.y=l.y)),q.map===null||et===!0||ft===!0){const Y=this.type!==za?{minFilter:Qi,magFilter:Qi}:{};q.map!==null&&q.map.dispose(),q.map=new gs(r.x,r.y,Y),q.map.texture.name=W.name+".shadowMap",q.camera.updateProjectionMatrix()}o.setRenderTarget(q.map),o.clear();const O=q.getViewportCount();for(let Y=0;Y<O;Y++){const ht=q.getViewport(Y);c.set(l.x*ht.x,l.y*ht.y,l.x*ht.z,l.y*ht.w),j.viewport(c),q.updateMatrices(W,Y),a=q.getFrustum(),A(z,F,q.camera,W,this.type)}q.isPointLightShadow!==!0&&this.type===za&&L(q,F),q.needsUpdate=!1}y=this.type,S.needsUpdate=!1,o.setRenderTarget(b,N,G)};function L(P,z){const F=t.update(M);v.defines.VSM_SAMPLES!==P.blurSamples&&(v.defines.VSM_SAMPLES=P.blurSamples,x.defines.VSM_SAMPLES=P.blurSamples,v.needsUpdate=!0,x.needsUpdate=!0),P.mapPass===null&&(P.mapPass=new gs(r.x,r.y)),v.uniforms.shadow_pass.value=P.map.texture,v.uniforms.resolution.value=P.mapSize,v.uniforms.radius.value=P.radius,o.setRenderTarget(P.mapPass),o.clear(),o.renderBufferDirect(z,null,F,v,M,null),x.uniforms.shadow_pass.value=P.mapPass.texture,x.uniforms.resolution.value=P.mapSize,x.uniforms.radius.value=P.radius,o.setRenderTarget(P.map),o.clear(),o.renderBufferDirect(z,null,F,x,M,null)}function U(P,z,F,b){let N=null;const G=F.isPointLight===!0?P.customDistanceMaterial:P.customDepthMaterial;if(G!==void 0)N=G;else if(N=F.isPointLight===!0?p:f,o.localClippingEnabled&&z.clipShadows===!0&&Array.isArray(z.clippingPlanes)&&z.clippingPlanes.length!==0||z.displacementMap&&z.displacementScale!==0||z.alphaMap&&z.alphaTest>0||z.map&&z.alphaTest>0||z.alphaToCoverage===!0){const j=N.uuid,et=z.uuid;let ft=h[j];ft===void 0&&(ft={},h[j]=ft);let rt=ft[et];rt===void 0&&(rt=N.clone(),ft[et]=rt,z.addEventListener("dispose",D)),N=rt}if(N.visible=z.visible,N.wireframe=z.wireframe,b===za?N.side=z.shadowSide!==null?z.shadowSide:z.side:N.side=z.shadowSide!==null?z.shadowSide:g[z.side],N.alphaMap=z.alphaMap,N.alphaTest=z.alphaToCoverage===!0?.5:z.alphaTest,N.map=z.map,N.clipShadows=z.clipShadows,N.clippingPlanes=z.clippingPlanes,N.clipIntersection=z.clipIntersection,N.displacementMap=z.displacementMap,N.displacementScale=z.displacementScale,N.displacementBias=z.displacementBias,N.wireframeLinewidth=z.wireframeLinewidth,N.linewidth=z.linewidth,F.isPointLight===!0&&N.isMeshDistanceMaterial===!0){const j=o.properties.get(N);j.light=F}return N}function A(P,z,F,b,N){if(P.visible===!1)return;if(P.layers.test(z.layers)&&(P.isMesh||P.isLine||P.isPoints)&&(P.castShadow||P.receiveShadow&&N===za)&&(!P.frustumCulled||a.intersectsObject(P))){P.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,P.matrixWorld);const et=t.update(P),ft=P.material;if(Array.isArray(ft)){const rt=et.groups;for(let B=0,W=rt.length;B<W;B++){const q=rt[B],yt=ft[q.materialIndex];if(yt&&yt.visible){const O=U(P,yt,b,N);P.onBeforeShadow(o,P,z,F,et,O,q),o.renderBufferDirect(F,null,et,O,P,q),P.onAfterShadow(o,P,z,F,et,O,q)}}}else if(ft.visible){const rt=U(P,ft,b,N);P.onBeforeShadow(o,P,z,F,et,rt,null),o.renderBufferDirect(F,null,et,rt,P,null),P.onAfterShadow(o,P,z,F,et,rt,null)}}const j=P.children;for(let et=0,ft=j.length;et<ft;et++)A(j[et],z,F,b,N)}function D(P){P.target.removeEventListener("dispose",D);for(const F in h){const b=h[F],N=P.target.uuid;N in b&&(b[N].dispose(),delete b[N])}}}const uC={[wp]:Cp,[Dp]:Op,[Up]:Np,[Co]:Lp,[Cp]:wp,[Op]:Dp,[Np]:Up,[Lp]:Co};function cC(o,t){function e(){let X=!1;const bt=new sn;let Ct=null;const It=new sn(0,0,0,0);return{setMask:function(Mt){Ct!==Mt&&!X&&(o.colorMask(Mt,Mt,Mt,Mt),Ct=Mt)},setLocked:function(Mt){X=Mt},setClear:function(Mt,xt,Ht,ae,Ce){Ce===!0&&(Mt*=ae,xt*=ae,Ht*=ae),bt.set(Mt,xt,Ht,ae),It.equals(bt)===!1&&(o.clearColor(Mt,xt,Ht,ae),It.copy(bt))},reset:function(){X=!1,Ct=null,It.set(-1,0,0,0)}}}function a(){let X=!1,bt=!1,Ct=null,It=null,Mt=null;return{setReversed:function(xt){if(bt!==xt){const Ht=t.get("EXT_clip_control");xt?Ht.clipControlEXT(Ht.LOWER_LEFT_EXT,Ht.ZERO_TO_ONE_EXT):Ht.clipControlEXT(Ht.LOWER_LEFT_EXT,Ht.NEGATIVE_ONE_TO_ONE_EXT),bt=xt;const ae=Mt;Mt=null,this.setClear(ae)}},getReversed:function(){return bt},setTest:function(xt){xt?_t(o.DEPTH_TEST):At(o.DEPTH_TEST)},setMask:function(xt){Ct!==xt&&!X&&(o.depthMask(xt),Ct=xt)},setFunc:function(xt){if(bt&&(xt=uC[xt]),It!==xt){switch(xt){case wp:o.depthFunc(o.NEVER);break;case Cp:o.depthFunc(o.ALWAYS);break;case Dp:o.depthFunc(o.LESS);break;case Co:o.depthFunc(o.LEQUAL);break;case Up:o.depthFunc(o.EQUAL);break;case Lp:o.depthFunc(o.GEQUAL);break;case Op:o.depthFunc(o.GREATER);break;case Np:o.depthFunc(o.NOTEQUAL);break;default:o.depthFunc(o.LEQUAL)}It=xt}},setLocked:function(xt){X=xt},setClear:function(xt){Mt!==xt&&(bt&&(xt=1-xt),o.clearDepth(xt),Mt=xt)},reset:function(){X=!1,Ct=null,It=null,Mt=null,bt=!1}}}function r(){let X=!1,bt=null,Ct=null,It=null,Mt=null,xt=null,Ht=null,ae=null,Ce=null;return{setTest:function(be){X||(be?_t(o.STENCIL_TEST):At(o.STENCIL_TEST))},setMask:function(be){bt!==be&&!X&&(o.stencilMask(be),bt=be)},setFunc:function(be,Gi,gn){(Ct!==be||It!==Gi||Mt!==gn)&&(o.stencilFunc(be,Gi,gn),Ct=be,It=Gi,Mt=gn)},setOp:function(be,Gi,gn){(xt!==be||Ht!==Gi||ae!==gn)&&(o.stencilOp(be,Gi,gn),xt=be,Ht=Gi,ae=gn)},setLocked:function(be){X=be},setClear:function(be){Ce!==be&&(o.clearStencil(be),Ce=be)},reset:function(){X=!1,bt=null,Ct=null,It=null,Mt=null,xt=null,Ht=null,ae=null,Ce=null}}}const l=new e,c=new a,f=new r,p=new WeakMap,h=new WeakMap;let m={},g={},v=new WeakMap,x=[],E=null,M=!1,S=null,y=null,L=null,U=null,A=null,D=null,P=null,z=new fe(0,0,0),F=0,b=!1,N=null,G=null,j=null,et=null,ft=null;const rt=o.getParameter(o.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let B=!1,W=0;const q=o.getParameter(o.VERSION);q.indexOf("WebGL")!==-1?(W=parseFloat(/^WebGL (\d)/.exec(q)[1]),B=W>=1):q.indexOf("OpenGL ES")!==-1&&(W=parseFloat(/^OpenGL ES (\d)/.exec(q)[1]),B=W>=2);let yt=null,O={};const Y=o.getParameter(o.SCISSOR_BOX),ht=o.getParameter(o.VIEWPORT),ut=new sn().fromArray(Y),Et=new sn().fromArray(ht);function Rt(X,bt,Ct,It){const Mt=new Uint8Array(4),xt=o.createTexture();o.bindTexture(X,xt),o.texParameteri(X,o.TEXTURE_MIN_FILTER,o.NEAREST),o.texParameteri(X,o.TEXTURE_MAG_FILTER,o.NEAREST);for(let Ht=0;Ht<Ct;Ht++)X===o.TEXTURE_3D||X===o.TEXTURE_2D_ARRAY?o.texImage3D(bt,0,o.RGBA,1,1,It,0,o.RGBA,o.UNSIGNED_BYTE,Mt):o.texImage2D(bt+Ht,0,o.RGBA,1,1,0,o.RGBA,o.UNSIGNED_BYTE,Mt);return xt}const $={};$[o.TEXTURE_2D]=Rt(o.TEXTURE_2D,o.TEXTURE_2D,1),$[o.TEXTURE_CUBE_MAP]=Rt(o.TEXTURE_CUBE_MAP,o.TEXTURE_CUBE_MAP_POSITIVE_X,6),$[o.TEXTURE_2D_ARRAY]=Rt(o.TEXTURE_2D_ARRAY,o.TEXTURE_2D_ARRAY,1,1),$[o.TEXTURE_3D]=Rt(o.TEXTURE_3D,o.TEXTURE_3D,1,1),l.setClear(0,0,0,1),c.setClear(1),f.setClear(0),_t(o.DEPTH_TEST),c.setFunc(Co),ne(!1),Pt(Xv),_t(o.CULL_FACE),Le(Ar);function _t(X){m[X]!==!0&&(o.enable(X),m[X]=!0)}function At(X){m[X]!==!1&&(o.disable(X),m[X]=!1)}function Zt(X,bt){return g[X]!==bt?(o.bindFramebuffer(X,bt),g[X]=bt,X===o.DRAW_FRAMEBUFFER&&(g[o.FRAMEBUFFER]=bt),X===o.FRAMEBUFFER&&(g[o.DRAW_FRAMEBUFFER]=bt),!0):!1}function kt(X,bt){let Ct=x,It=!1;if(X){Ct=v.get(bt),Ct===void 0&&(Ct=[],v.set(bt,Ct));const Mt=X.textures;if(Ct.length!==Mt.length||Ct[0]!==o.COLOR_ATTACHMENT0){for(let xt=0,Ht=Mt.length;xt<Ht;xt++)Ct[xt]=o.COLOR_ATTACHMENT0+xt;Ct.length=Mt.length,It=!0}}else Ct[0]!==o.BACK&&(Ct[0]=o.BACK,It=!0);It&&o.drawBuffers(Ct)}function le(X){return E!==X?(o.useProgram(X),E=X,!0):!1}const Ve={[os]:o.FUNC_ADD,[fT]:o.FUNC_SUBTRACT,[hT]:o.FUNC_REVERSE_SUBTRACT};Ve[dT]=o.MIN,Ve[pT]=o.MAX;const V={[mT]:o.ZERO,[_T]:o.ONE,[gT]:o.SRC_COLOR,[Ap]:o.SRC_ALPHA,[ET]:o.SRC_ALPHA_SATURATE,[ST]:o.DST_COLOR,[xT]:o.DST_ALPHA,[vT]:o.ONE_MINUS_SRC_COLOR,[Rp]:o.ONE_MINUS_SRC_ALPHA,[MT]:o.ONE_MINUS_DST_COLOR,[yT]:o.ONE_MINUS_DST_ALPHA,[TT]:o.CONSTANT_COLOR,[bT]:o.ONE_MINUS_CONSTANT_COLOR,[AT]:o.CONSTANT_ALPHA,[RT]:o.ONE_MINUS_CONSTANT_ALPHA};function Le(X,bt,Ct,It,Mt,xt,Ht,ae,Ce,be){if(X===Ar){M===!0&&(At(o.BLEND),M=!1);return}if(M===!1&&(_t(o.BLEND),M=!0),X!==cT){if(X!==S||be!==b){if((y!==os||A!==os)&&(o.blendEquation(o.FUNC_ADD),y=os,A=os),be)switch(X){case To:o.blendFuncSeparate(o.ONE,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case hf:o.blendFunc(o.ONE,o.ONE);break;case Wv:o.blendFuncSeparate(o.ZERO,o.ONE_MINUS_SRC_COLOR,o.ZERO,o.ONE);break;case qv:o.blendFuncSeparate(o.DST_COLOR,o.ONE_MINUS_SRC_ALPHA,o.ZERO,o.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",X);break}else switch(X){case To:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case hf:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE,o.ONE,o.ONE);break;case Wv:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case qv:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",X);break}L=null,U=null,D=null,P=null,z.set(0,0,0),F=0,S=X,b=be}return}Mt=Mt||bt,xt=xt||Ct,Ht=Ht||It,(bt!==y||Mt!==A)&&(o.blendEquationSeparate(Ve[bt],Ve[Mt]),y=bt,A=Mt),(Ct!==L||It!==U||xt!==D||Ht!==P)&&(o.blendFuncSeparate(V[Ct],V[It],V[xt],V[Ht]),L=Ct,U=It,D=xt,P=Ht),(ae.equals(z)===!1||Ce!==F)&&(o.blendColor(ae.r,ae.g,ae.b,Ce),z.copy(ae),F=Ce),S=X,b=!1}function re(X,bt){X.side===Fa?At(o.CULL_FACE):_t(o.CULL_FACE);let Ct=X.side===ii;bt&&(Ct=!Ct),ne(Ct),X.blending===To&&X.transparent===!1?Le(Ar):Le(X.blending,X.blendEquation,X.blendSrc,X.blendDst,X.blendEquationAlpha,X.blendSrcAlpha,X.blendDstAlpha,X.blendColor,X.blendAlpha,X.premultipliedAlpha),c.setFunc(X.depthFunc),c.setTest(X.depthTest),c.setMask(X.depthWrite),l.setMask(X.colorWrite);const It=X.stencilWrite;f.setTest(It),It&&(f.setMask(X.stencilWriteMask),f.setFunc(X.stencilFunc,X.stencilRef,X.stencilFuncMask),f.setOp(X.stencilFail,X.stencilZFail,X.stencilZPass)),Gt(X.polygonOffset,X.polygonOffsetFactor,X.polygonOffsetUnits),X.alphaToCoverage===!0?_t(o.SAMPLE_ALPHA_TO_COVERAGE):At(o.SAMPLE_ALPHA_TO_COVERAGE)}function ne(X){N!==X&&(X?o.frontFace(o.CW):o.frontFace(o.CCW),N=X)}function Pt(X){X!==oT?(_t(o.CULL_FACE),X!==G&&(X===Xv?o.cullFace(o.BACK):X===lT?o.cullFace(o.FRONT):o.cullFace(o.FRONT_AND_BACK))):At(o.CULL_FACE),G=X}function ke(X){X!==j&&(B&&o.lineWidth(X),j=X)}function Gt(X,bt,Ct){X?(_t(o.POLYGON_OFFSET_FILL),(et!==bt||ft!==Ct)&&(o.polygonOffset(bt,Ct),et=bt,ft=Ct)):At(o.POLYGON_OFFSET_FILL)}function se(X){X?_t(o.SCISSOR_TEST):At(o.SCISSOR_TEST)}function Ze(X){X===void 0&&(X=o.TEXTURE0+rt-1),yt!==X&&(o.activeTexture(X),yt=X)}function Ke(X,bt,Ct){Ct===void 0&&(yt===null?Ct=o.TEXTURE0+rt-1:Ct=yt);let It=O[Ct];It===void 0&&(It={type:void 0,texture:void 0},O[Ct]=It),(It.type!==X||It.texture!==bt)&&(yt!==Ct&&(o.activeTexture(Ct),yt=Ct),o.bindTexture(X,bt||$[X]),It.type=X,It.texture=bt)}function I(){const X=O[yt];X!==void 0&&X.type!==void 0&&(o.bindTexture(X.type,null),X.type=void 0,X.texture=void 0)}function R(){try{o.compressedTexImage2D(...arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function nt(){try{o.compressedTexImage3D(...arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function dt(){try{o.texSubImage2D(...arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function gt(){try{o.texSubImage3D(...arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function ct(){try{o.compressedTexSubImage2D(...arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function zt(){try{o.compressedTexSubImage3D(...arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function wt(){try{o.texStorage2D(...arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function Xt(){try{o.texStorage3D(...arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function qt(){try{o.texImage2D(...arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function St(){try{o.texImage3D(...arguments)}catch(X){console.error("THREE.WebGLState:",X)}}function Lt(X){ut.equals(X)===!1&&(o.scissor(X.x,X.y,X.z,X.w),ut.copy(X))}function jt(X){Et.equals(X)===!1&&(o.viewport(X.x,X.y,X.z,X.w),Et.copy(X))}function Vt(X,bt){let Ct=h.get(bt);Ct===void 0&&(Ct=new WeakMap,h.set(bt,Ct));let It=Ct.get(X);It===void 0&&(It=o.getUniformBlockIndex(bt,X.name),Ct.set(X,It))}function Dt(X,bt){const It=h.get(bt).get(X);p.get(bt)!==It&&(o.uniformBlockBinding(bt,It,X.__bindingPointIndex),p.set(bt,It))}function oe(){o.disable(o.BLEND),o.disable(o.CULL_FACE),o.disable(o.DEPTH_TEST),o.disable(o.POLYGON_OFFSET_FILL),o.disable(o.SCISSOR_TEST),o.disable(o.STENCIL_TEST),o.disable(o.SAMPLE_ALPHA_TO_COVERAGE),o.blendEquation(o.FUNC_ADD),o.blendFunc(o.ONE,o.ZERO),o.blendFuncSeparate(o.ONE,o.ZERO,o.ONE,o.ZERO),o.blendColor(0,0,0,0),o.colorMask(!0,!0,!0,!0),o.clearColor(0,0,0,0),o.depthMask(!0),o.depthFunc(o.LESS),c.setReversed(!1),o.clearDepth(1),o.stencilMask(4294967295),o.stencilFunc(o.ALWAYS,0,4294967295),o.stencilOp(o.KEEP,o.KEEP,o.KEEP),o.clearStencil(0),o.cullFace(o.BACK),o.frontFace(o.CCW),o.polygonOffset(0,0),o.activeTexture(o.TEXTURE0),o.bindFramebuffer(o.FRAMEBUFFER,null),o.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),o.bindFramebuffer(o.READ_FRAMEBUFFER,null),o.useProgram(null),o.lineWidth(1),o.scissor(0,0,o.canvas.width,o.canvas.height),o.viewport(0,0,o.canvas.width,o.canvas.height),m={},yt=null,O={},g={},v=new WeakMap,x=[],E=null,M=!1,S=null,y=null,L=null,U=null,A=null,D=null,P=null,z=new fe(0,0,0),F=0,b=!1,N=null,G=null,j=null,et=null,ft=null,ut.set(0,0,o.canvas.width,o.canvas.height),Et.set(0,0,o.canvas.width,o.canvas.height),l.reset(),c.reset(),f.reset()}return{buffers:{color:l,depth:c,stencil:f},enable:_t,disable:At,bindFramebuffer:Zt,drawBuffers:kt,useProgram:le,setBlending:Le,setMaterial:re,setFlipSided:ne,setCullFace:Pt,setLineWidth:ke,setPolygonOffset:Gt,setScissorTest:se,activeTexture:Ze,bindTexture:Ke,unbindTexture:I,compressedTexImage2D:R,compressedTexImage3D:nt,texImage2D:qt,texImage3D:St,updateUBOMapping:Vt,uniformBlockBinding:Dt,texStorage2D:wt,texStorage3D:Xt,texSubImage2D:dt,texSubImage3D:gt,compressedTexSubImage2D:ct,compressedTexSubImage3D:zt,scissor:Lt,viewport:jt,reset:oe}}function fC(o,t,e,a,r,l,c){const f=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,p=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),h=new Te,m=new WeakMap;let g;const v=new WeakMap;let x=!1;try{x=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function E(I,R){return x?new OffscreenCanvas(I,R):ru("canvas")}function M(I,R,nt){let dt=1;const gt=Ke(I);if((gt.width>nt||gt.height>nt)&&(dt=nt/Math.max(gt.width,gt.height)),dt<1)if(typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&I instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&I instanceof ImageBitmap||typeof VideoFrame<"u"&&I instanceof VideoFrame){const ct=Math.floor(dt*gt.width),zt=Math.floor(dt*gt.height);g===void 0&&(g=E(ct,zt));const wt=R?E(ct,zt):g;return wt.width=ct,wt.height=zt,wt.getContext("2d").drawImage(I,0,0,ct,zt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+gt.width+"x"+gt.height+") to ("+ct+"x"+zt+")."),wt}else return"data"in I&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+gt.width+"x"+gt.height+")."),I;return I}function S(I){return I.generateMipmaps}function y(I){o.generateMipmap(I)}function L(I){return I.isWebGLCubeRenderTarget?o.TEXTURE_CUBE_MAP:I.isWebGL3DRenderTarget?o.TEXTURE_3D:I.isWebGLArrayRenderTarget||I.isCompressedArrayTexture?o.TEXTURE_2D_ARRAY:o.TEXTURE_2D}function U(I,R,nt,dt,gt=!1){if(I!==null){if(o[I]!==void 0)return o[I];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+I+"'")}let ct=R;if(R===o.RED&&(nt===o.FLOAT&&(ct=o.R32F),nt===o.HALF_FLOAT&&(ct=o.R16F),nt===o.UNSIGNED_BYTE&&(ct=o.R8)),R===o.RED_INTEGER&&(nt===o.UNSIGNED_BYTE&&(ct=o.R8UI),nt===o.UNSIGNED_SHORT&&(ct=o.R16UI),nt===o.UNSIGNED_INT&&(ct=o.R32UI),nt===o.BYTE&&(ct=o.R8I),nt===o.SHORT&&(ct=o.R16I),nt===o.INT&&(ct=o.R32I)),R===o.RG&&(nt===o.FLOAT&&(ct=o.RG32F),nt===o.HALF_FLOAT&&(ct=o.RG16F),nt===o.UNSIGNED_BYTE&&(ct=o.RG8)),R===o.RG_INTEGER&&(nt===o.UNSIGNED_BYTE&&(ct=o.RG8UI),nt===o.UNSIGNED_SHORT&&(ct=o.RG16UI),nt===o.UNSIGNED_INT&&(ct=o.RG32UI),nt===o.BYTE&&(ct=o.RG8I),nt===o.SHORT&&(ct=o.RG16I),nt===o.INT&&(ct=o.RG32I)),R===o.RGB_INTEGER&&(nt===o.UNSIGNED_BYTE&&(ct=o.RGB8UI),nt===o.UNSIGNED_SHORT&&(ct=o.RGB16UI),nt===o.UNSIGNED_INT&&(ct=o.RGB32UI),nt===o.BYTE&&(ct=o.RGB8I),nt===o.SHORT&&(ct=o.RGB16I),nt===o.INT&&(ct=o.RGB32I)),R===o.RGBA_INTEGER&&(nt===o.UNSIGNED_BYTE&&(ct=o.RGBA8UI),nt===o.UNSIGNED_SHORT&&(ct=o.RGBA16UI),nt===o.UNSIGNED_INT&&(ct=o.RGBA32UI),nt===o.BYTE&&(ct=o.RGBA8I),nt===o.SHORT&&(ct=o.RGBA16I),nt===o.INT&&(ct=o.RGBA32I)),R===o.RGB&&(nt===o.UNSIGNED_INT_5_9_9_9_REV&&(ct=o.RGB9_E5),nt===o.UNSIGNED_INT_10F_11F_11F_REV&&(ct=o.R11F_G11F_B10F)),R===o.RGBA){const zt=gt?pf:ye.getTransfer(dt);nt===o.FLOAT&&(ct=o.RGBA32F),nt===o.HALF_FLOAT&&(ct=o.RGBA16F),nt===o.UNSIGNED_BYTE&&(ct=zt===Ie?o.SRGB8_ALPHA8:o.RGBA8),nt===o.UNSIGNED_SHORT_4_4_4_4&&(ct=o.RGBA4),nt===o.UNSIGNED_SHORT_5_5_5_1&&(ct=o.RGB5_A1)}return(ct===o.R16F||ct===o.R32F||ct===o.RG16F||ct===o.RG32F||ct===o.RGBA16F||ct===o.RGBA32F)&&t.get("EXT_color_buffer_float"),ct}function A(I,R){let nt;return I?R===null||R===_s||R===nu?nt=o.DEPTH24_STENCIL8:R===Ha?nt=o.DEPTH32F_STENCIL8:R===eu&&(nt=o.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):R===null||R===_s||R===nu?nt=o.DEPTH_COMPONENT24:R===Ha?nt=o.DEPTH_COMPONENT32F:R===eu&&(nt=o.DEPTH_COMPONENT16),nt}function D(I,R){return S(I)===!0||I.isFramebufferTexture&&I.minFilter!==Qi&&I.minFilter!==ua?Math.log2(Math.max(R.width,R.height))+1:I.mipmaps!==void 0&&I.mipmaps.length>0?I.mipmaps.length:I.isCompressedTexture&&Array.isArray(I.image)?R.mipmaps.length:1}function P(I){const R=I.target;R.removeEventListener("dispose",P),F(R),R.isVideoTexture&&m.delete(R)}function z(I){const R=I.target;R.removeEventListener("dispose",z),N(R)}function F(I){const R=a.get(I);if(R.__webglInit===void 0)return;const nt=I.source,dt=v.get(nt);if(dt){const gt=dt[R.__cacheKey];gt.usedTimes--,gt.usedTimes===0&&b(I),Object.keys(dt).length===0&&v.delete(nt)}a.remove(I)}function b(I){const R=a.get(I);o.deleteTexture(R.__webglTexture);const nt=I.source,dt=v.get(nt);delete dt[R.__cacheKey],c.memory.textures--}function N(I){const R=a.get(I);if(I.depthTexture&&(I.depthTexture.dispose(),a.remove(I.depthTexture)),I.isWebGLCubeRenderTarget)for(let dt=0;dt<6;dt++){if(Array.isArray(R.__webglFramebuffer[dt]))for(let gt=0;gt<R.__webglFramebuffer[dt].length;gt++)o.deleteFramebuffer(R.__webglFramebuffer[dt][gt]);else o.deleteFramebuffer(R.__webglFramebuffer[dt]);R.__webglDepthbuffer&&o.deleteRenderbuffer(R.__webglDepthbuffer[dt])}else{if(Array.isArray(R.__webglFramebuffer))for(let dt=0;dt<R.__webglFramebuffer.length;dt++)o.deleteFramebuffer(R.__webglFramebuffer[dt]);else o.deleteFramebuffer(R.__webglFramebuffer);if(R.__webglDepthbuffer&&o.deleteRenderbuffer(R.__webglDepthbuffer),R.__webglMultisampledFramebuffer&&o.deleteFramebuffer(R.__webglMultisampledFramebuffer),R.__webglColorRenderbuffer)for(let dt=0;dt<R.__webglColorRenderbuffer.length;dt++)R.__webglColorRenderbuffer[dt]&&o.deleteRenderbuffer(R.__webglColorRenderbuffer[dt]);R.__webglDepthRenderbuffer&&o.deleteRenderbuffer(R.__webglDepthRenderbuffer)}const nt=I.textures;for(let dt=0,gt=nt.length;dt<gt;dt++){const ct=a.get(nt[dt]);ct.__webglTexture&&(o.deleteTexture(ct.__webglTexture),c.memory.textures--),a.remove(nt[dt])}a.remove(I)}let G=0;function j(){G=0}function et(){const I=G;return I>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+I+" texture units while this GPU supports only "+r.maxTextures),G+=1,I}function ft(I){const R=[];return R.push(I.wrapS),R.push(I.wrapT),R.push(I.wrapR||0),R.push(I.magFilter),R.push(I.minFilter),R.push(I.anisotropy),R.push(I.internalFormat),R.push(I.format),R.push(I.type),R.push(I.generateMipmaps),R.push(I.premultiplyAlpha),R.push(I.flipY),R.push(I.unpackAlignment),R.push(I.colorSpace),R.join()}function rt(I,R){const nt=a.get(I);if(I.isVideoTexture&&se(I),I.isRenderTargetTexture===!1&&I.isExternalTexture!==!0&&I.version>0&&nt.__version!==I.version){const dt=I.image;if(dt===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(dt.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{$(nt,I,R);return}}else I.isExternalTexture&&(nt.__webglTexture=I.sourceTexture?I.sourceTexture:null);e.bindTexture(o.TEXTURE_2D,nt.__webglTexture,o.TEXTURE0+R)}function B(I,R){const nt=a.get(I);if(I.isRenderTargetTexture===!1&&I.version>0&&nt.__version!==I.version){$(nt,I,R);return}e.bindTexture(o.TEXTURE_2D_ARRAY,nt.__webglTexture,o.TEXTURE0+R)}function W(I,R){const nt=a.get(I);if(I.isRenderTargetTexture===!1&&I.version>0&&nt.__version!==I.version){$(nt,I,R);return}e.bindTexture(o.TEXTURE_3D,nt.__webglTexture,o.TEXTURE0+R)}function q(I,R){const nt=a.get(I);if(I.version>0&&nt.__version!==I.version){_t(nt,I,R);return}e.bindTexture(o.TEXTURE_CUBE_MAP,nt.__webglTexture,o.TEXTURE0+R)}const yt={[df]:o.REPEAT,[us]:o.CLAMP_TO_EDGE,[Ip]:o.MIRRORED_REPEAT},O={[Qi]:o.NEAREST,[IT]:o.NEAREST_MIPMAP_NEAREST,[wc]:o.NEAREST_MIPMAP_LINEAR,[ua]:o.LINEAR,[Bd]:o.LINEAR_MIPMAP_NEAREST,[cs]:o.LINEAR_MIPMAP_LINEAR},Y={[GT]:o.NEVER,[YT]:o.ALWAYS,[VT]:o.LESS,[by]:o.LEQUAL,[kT]:o.EQUAL,[qT]:o.GEQUAL,[XT]:o.GREATER,[WT]:o.NOTEQUAL};function ht(I,R){if(R.type===Ha&&t.has("OES_texture_float_linear")===!1&&(R.magFilter===ua||R.magFilter===Bd||R.magFilter===wc||R.magFilter===cs||R.minFilter===ua||R.minFilter===Bd||R.minFilter===wc||R.minFilter===cs)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),o.texParameteri(I,o.TEXTURE_WRAP_S,yt[R.wrapS]),o.texParameteri(I,o.TEXTURE_WRAP_T,yt[R.wrapT]),(I===o.TEXTURE_3D||I===o.TEXTURE_2D_ARRAY)&&o.texParameteri(I,o.TEXTURE_WRAP_R,yt[R.wrapR]),o.texParameteri(I,o.TEXTURE_MAG_FILTER,O[R.magFilter]),o.texParameteri(I,o.TEXTURE_MIN_FILTER,O[R.minFilter]),R.compareFunction&&(o.texParameteri(I,o.TEXTURE_COMPARE_MODE,o.COMPARE_REF_TO_TEXTURE),o.texParameteri(I,o.TEXTURE_COMPARE_FUNC,Y[R.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(R.magFilter===Qi||R.minFilter!==wc&&R.minFilter!==cs||R.type===Ha&&t.has("OES_texture_float_linear")===!1)return;if(R.anisotropy>1||a.get(R).__currentAnisotropy){const nt=t.get("EXT_texture_filter_anisotropic");o.texParameterf(I,nt.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(R.anisotropy,r.getMaxAnisotropy())),a.get(R).__currentAnisotropy=R.anisotropy}}}function ut(I,R){let nt=!1;I.__webglInit===void 0&&(I.__webglInit=!0,R.addEventListener("dispose",P));const dt=R.source;let gt=v.get(dt);gt===void 0&&(gt={},v.set(dt,gt));const ct=ft(R);if(ct!==I.__cacheKey){gt[ct]===void 0&&(gt[ct]={texture:o.createTexture(),usedTimes:0},c.memory.textures++,nt=!0),gt[ct].usedTimes++;const zt=gt[I.__cacheKey];zt!==void 0&&(gt[I.__cacheKey].usedTimes--,zt.usedTimes===0&&b(R)),I.__cacheKey=ct,I.__webglTexture=gt[ct].texture}return nt}function Et(I,R,nt){return Math.floor(Math.floor(I/nt)/R)}function Rt(I,R,nt,dt){const ct=I.updateRanges;if(ct.length===0)e.texSubImage2D(o.TEXTURE_2D,0,0,0,R.width,R.height,nt,dt,R.data);else{ct.sort((St,Lt)=>St.start-Lt.start);let zt=0;for(let St=1;St<ct.length;St++){const Lt=ct[zt],jt=ct[St],Vt=Lt.start+Lt.count,Dt=Et(jt.start,R.width,4),oe=Et(Lt.start,R.width,4);jt.start<=Vt+1&&Dt===oe&&Et(jt.start+jt.count-1,R.width,4)===Dt?Lt.count=Math.max(Lt.count,jt.start+jt.count-Lt.start):(++zt,ct[zt]=jt)}ct.length=zt+1;const wt=o.getParameter(o.UNPACK_ROW_LENGTH),Xt=o.getParameter(o.UNPACK_SKIP_PIXELS),qt=o.getParameter(o.UNPACK_SKIP_ROWS);o.pixelStorei(o.UNPACK_ROW_LENGTH,R.width);for(let St=0,Lt=ct.length;St<Lt;St++){const jt=ct[St],Vt=Math.floor(jt.start/4),Dt=Math.ceil(jt.count/4),oe=Vt%R.width,X=Math.floor(Vt/R.width),bt=Dt,Ct=1;o.pixelStorei(o.UNPACK_SKIP_PIXELS,oe),o.pixelStorei(o.UNPACK_SKIP_ROWS,X),e.texSubImage2D(o.TEXTURE_2D,0,oe,X,bt,Ct,nt,dt,R.data)}I.clearUpdateRanges(),o.pixelStorei(o.UNPACK_ROW_LENGTH,wt),o.pixelStorei(o.UNPACK_SKIP_PIXELS,Xt),o.pixelStorei(o.UNPACK_SKIP_ROWS,qt)}}function $(I,R,nt){let dt=o.TEXTURE_2D;(R.isDataArrayTexture||R.isCompressedArrayTexture)&&(dt=o.TEXTURE_2D_ARRAY),R.isData3DTexture&&(dt=o.TEXTURE_3D);const gt=ut(I,R),ct=R.source;e.bindTexture(dt,I.__webglTexture,o.TEXTURE0+nt);const zt=a.get(ct);if(ct.version!==zt.__version||gt===!0){e.activeTexture(o.TEXTURE0+nt);const wt=ye.getPrimaries(ye.workingColorSpace),Xt=R.colorSpace===Mr?null:ye.getPrimaries(R.colorSpace),qt=R.colorSpace===Mr||wt===Xt?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,R.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,R.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,R.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,qt);let St=M(R.image,!1,r.maxTextureSize);St=Ze(R,St);const Lt=l.convert(R.format,R.colorSpace),jt=l.convert(R.type);let Vt=U(R.internalFormat,Lt,jt,R.colorSpace,R.isVideoTexture);ht(dt,R);let Dt;const oe=R.mipmaps,X=R.isVideoTexture!==!0,bt=zt.__version===void 0||gt===!0,Ct=ct.dataReady,It=D(R,St);if(R.isDepthTexture)Vt=A(R.format===au,R.type),bt&&(X?e.texStorage2D(o.TEXTURE_2D,1,Vt,St.width,St.height):e.texImage2D(o.TEXTURE_2D,0,Vt,St.width,St.height,0,Lt,jt,null));else if(R.isDataTexture)if(oe.length>0){X&&bt&&e.texStorage2D(o.TEXTURE_2D,It,Vt,oe[0].width,oe[0].height);for(let Mt=0,xt=oe.length;Mt<xt;Mt++)Dt=oe[Mt],X?Ct&&e.texSubImage2D(o.TEXTURE_2D,Mt,0,0,Dt.width,Dt.height,Lt,jt,Dt.data):e.texImage2D(o.TEXTURE_2D,Mt,Vt,Dt.width,Dt.height,0,Lt,jt,Dt.data);R.generateMipmaps=!1}else X?(bt&&e.texStorage2D(o.TEXTURE_2D,It,Vt,St.width,St.height),Ct&&Rt(R,St,Lt,jt)):e.texImage2D(o.TEXTURE_2D,0,Vt,St.width,St.height,0,Lt,jt,St.data);else if(R.isCompressedTexture)if(R.isCompressedArrayTexture){X&&bt&&e.texStorage3D(o.TEXTURE_2D_ARRAY,It,Vt,oe[0].width,oe[0].height,St.depth);for(let Mt=0,xt=oe.length;Mt<xt;Mt++)if(Dt=oe[Mt],R.format!==Ki)if(Lt!==null)if(X){if(Ct)if(R.layerUpdates.size>0){const Ht=Ex(Dt.width,Dt.height,R.format,R.type);for(const ae of R.layerUpdates){const Ce=Dt.data.subarray(ae*Ht/Dt.data.BYTES_PER_ELEMENT,(ae+1)*Ht/Dt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,Mt,0,0,ae,Dt.width,Dt.height,1,Lt,Ce)}R.clearLayerUpdates()}else e.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,Mt,0,0,0,Dt.width,Dt.height,St.depth,Lt,Dt.data)}else e.compressedTexImage3D(o.TEXTURE_2D_ARRAY,Mt,Vt,Dt.width,Dt.height,St.depth,0,Dt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else X?Ct&&e.texSubImage3D(o.TEXTURE_2D_ARRAY,Mt,0,0,0,Dt.width,Dt.height,St.depth,Lt,jt,Dt.data):e.texImage3D(o.TEXTURE_2D_ARRAY,Mt,Vt,Dt.width,Dt.height,St.depth,0,Lt,jt,Dt.data)}else{X&&bt&&e.texStorage2D(o.TEXTURE_2D,It,Vt,oe[0].width,oe[0].height);for(let Mt=0,xt=oe.length;Mt<xt;Mt++)Dt=oe[Mt],R.format!==Ki?Lt!==null?X?Ct&&e.compressedTexSubImage2D(o.TEXTURE_2D,Mt,0,0,Dt.width,Dt.height,Lt,Dt.data):e.compressedTexImage2D(o.TEXTURE_2D,Mt,Vt,Dt.width,Dt.height,0,Dt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):X?Ct&&e.texSubImage2D(o.TEXTURE_2D,Mt,0,0,Dt.width,Dt.height,Lt,jt,Dt.data):e.texImage2D(o.TEXTURE_2D,Mt,Vt,Dt.width,Dt.height,0,Lt,jt,Dt.data)}else if(R.isDataArrayTexture)if(X){if(bt&&e.texStorage3D(o.TEXTURE_2D_ARRAY,It,Vt,St.width,St.height,St.depth),Ct)if(R.layerUpdates.size>0){const Mt=Ex(St.width,St.height,R.format,R.type);for(const xt of R.layerUpdates){const Ht=St.data.subarray(xt*Mt/St.data.BYTES_PER_ELEMENT,(xt+1)*Mt/St.data.BYTES_PER_ELEMENT);e.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,xt,St.width,St.height,1,Lt,jt,Ht)}R.clearLayerUpdates()}else e.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,0,St.width,St.height,St.depth,Lt,jt,St.data)}else e.texImage3D(o.TEXTURE_2D_ARRAY,0,Vt,St.width,St.height,St.depth,0,Lt,jt,St.data);else if(R.isData3DTexture)X?(bt&&e.texStorage3D(o.TEXTURE_3D,It,Vt,St.width,St.height,St.depth),Ct&&e.texSubImage3D(o.TEXTURE_3D,0,0,0,0,St.width,St.height,St.depth,Lt,jt,St.data)):e.texImage3D(o.TEXTURE_3D,0,Vt,St.width,St.height,St.depth,0,Lt,jt,St.data);else if(R.isFramebufferTexture){if(bt)if(X)e.texStorage2D(o.TEXTURE_2D,It,Vt,St.width,St.height);else{let Mt=St.width,xt=St.height;for(let Ht=0;Ht<It;Ht++)e.texImage2D(o.TEXTURE_2D,Ht,Vt,Mt,xt,0,Lt,jt,null),Mt>>=1,xt>>=1}}else if(oe.length>0){if(X&&bt){const Mt=Ke(oe[0]);e.texStorage2D(o.TEXTURE_2D,It,Vt,Mt.width,Mt.height)}for(let Mt=0,xt=oe.length;Mt<xt;Mt++)Dt=oe[Mt],X?Ct&&e.texSubImage2D(o.TEXTURE_2D,Mt,0,0,Lt,jt,Dt):e.texImage2D(o.TEXTURE_2D,Mt,Vt,Lt,jt,Dt);R.generateMipmaps=!1}else if(X){if(bt){const Mt=Ke(St);e.texStorage2D(o.TEXTURE_2D,It,Vt,Mt.width,Mt.height)}Ct&&e.texSubImage2D(o.TEXTURE_2D,0,0,0,Lt,jt,St)}else e.texImage2D(o.TEXTURE_2D,0,Vt,Lt,jt,St);S(R)&&y(dt),zt.__version=ct.version,R.onUpdate&&R.onUpdate(R)}I.__version=R.version}function _t(I,R,nt){if(R.image.length!==6)return;const dt=ut(I,R),gt=R.source;e.bindTexture(o.TEXTURE_CUBE_MAP,I.__webglTexture,o.TEXTURE0+nt);const ct=a.get(gt);if(gt.version!==ct.__version||dt===!0){e.activeTexture(o.TEXTURE0+nt);const zt=ye.getPrimaries(ye.workingColorSpace),wt=R.colorSpace===Mr?null:ye.getPrimaries(R.colorSpace),Xt=R.colorSpace===Mr||zt===wt?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,R.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,R.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,R.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,Xt);const qt=R.isCompressedTexture||R.image[0].isCompressedTexture,St=R.image[0]&&R.image[0].isDataTexture,Lt=[];for(let xt=0;xt<6;xt++)!qt&&!St?Lt[xt]=M(R.image[xt],!0,r.maxCubemapSize):Lt[xt]=St?R.image[xt].image:R.image[xt],Lt[xt]=Ze(R,Lt[xt]);const jt=Lt[0],Vt=l.convert(R.format,R.colorSpace),Dt=l.convert(R.type),oe=U(R.internalFormat,Vt,Dt,R.colorSpace),X=R.isVideoTexture!==!0,bt=ct.__version===void 0||dt===!0,Ct=gt.dataReady;let It=D(R,jt);ht(o.TEXTURE_CUBE_MAP,R);let Mt;if(qt){X&&bt&&e.texStorage2D(o.TEXTURE_CUBE_MAP,It,oe,jt.width,jt.height);for(let xt=0;xt<6;xt++){Mt=Lt[xt].mipmaps;for(let Ht=0;Ht<Mt.length;Ht++){const ae=Mt[Ht];R.format!==Ki?Vt!==null?X?Ct&&e.compressedTexSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht,0,0,ae.width,ae.height,Vt,ae.data):e.compressedTexImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht,oe,ae.width,ae.height,0,ae.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):X?Ct&&e.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht,0,0,ae.width,ae.height,Vt,Dt,ae.data):e.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht,oe,ae.width,ae.height,0,Vt,Dt,ae.data)}}}else{if(Mt=R.mipmaps,X&&bt){Mt.length>0&&It++;const xt=Ke(Lt[0]);e.texStorage2D(o.TEXTURE_CUBE_MAP,It,oe,xt.width,xt.height)}for(let xt=0;xt<6;xt++)if(St){X?Ct&&e.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,0,0,0,Lt[xt].width,Lt[xt].height,Vt,Dt,Lt[xt].data):e.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,0,oe,Lt[xt].width,Lt[xt].height,0,Vt,Dt,Lt[xt].data);for(let Ht=0;Ht<Mt.length;Ht++){const Ce=Mt[Ht].image[xt].image;X?Ct&&e.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht+1,0,0,Ce.width,Ce.height,Vt,Dt,Ce.data):e.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht+1,oe,Ce.width,Ce.height,0,Vt,Dt,Ce.data)}}else{X?Ct&&e.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,0,0,0,Vt,Dt,Lt[xt]):e.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,0,oe,Vt,Dt,Lt[xt]);for(let Ht=0;Ht<Mt.length;Ht++){const ae=Mt[Ht];X?Ct&&e.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht+1,0,0,Vt,Dt,ae.image[xt]):e.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+xt,Ht+1,oe,Vt,Dt,ae.image[xt])}}}S(R)&&y(o.TEXTURE_CUBE_MAP),ct.__version=gt.version,R.onUpdate&&R.onUpdate(R)}I.__version=R.version}function At(I,R,nt,dt,gt,ct){const zt=l.convert(nt.format,nt.colorSpace),wt=l.convert(nt.type),Xt=U(nt.internalFormat,zt,wt,nt.colorSpace),qt=a.get(R),St=a.get(nt);if(St.__renderTarget=R,!qt.__hasExternalTextures){const Lt=Math.max(1,R.width>>ct),jt=Math.max(1,R.height>>ct);gt===o.TEXTURE_3D||gt===o.TEXTURE_2D_ARRAY?e.texImage3D(gt,ct,Xt,Lt,jt,R.depth,0,zt,wt,null):e.texImage2D(gt,ct,Xt,Lt,jt,0,zt,wt,null)}e.bindFramebuffer(o.FRAMEBUFFER,I),Gt(R)?f.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,dt,gt,St.__webglTexture,0,ke(R)):(gt===o.TEXTURE_2D||gt>=o.TEXTURE_CUBE_MAP_POSITIVE_X&&gt<=o.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&o.framebufferTexture2D(o.FRAMEBUFFER,dt,gt,St.__webglTexture,ct),e.bindFramebuffer(o.FRAMEBUFFER,null)}function Zt(I,R,nt){if(o.bindRenderbuffer(o.RENDERBUFFER,I),R.depthBuffer){const dt=R.depthTexture,gt=dt&&dt.isDepthTexture?dt.type:null,ct=A(R.stencilBuffer,gt),zt=R.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,wt=ke(R);Gt(R)?f.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,wt,ct,R.width,R.height):nt?o.renderbufferStorageMultisample(o.RENDERBUFFER,wt,ct,R.width,R.height):o.renderbufferStorage(o.RENDERBUFFER,ct,R.width,R.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,zt,o.RENDERBUFFER,I)}else{const dt=R.textures;for(let gt=0;gt<dt.length;gt++){const ct=dt[gt],zt=l.convert(ct.format,ct.colorSpace),wt=l.convert(ct.type),Xt=U(ct.internalFormat,zt,wt,ct.colorSpace),qt=ke(R);nt&&Gt(R)===!1?o.renderbufferStorageMultisample(o.RENDERBUFFER,qt,Xt,R.width,R.height):Gt(R)?f.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,qt,Xt,R.width,R.height):o.renderbufferStorage(o.RENDERBUFFER,Xt,R.width,R.height)}}o.bindRenderbuffer(o.RENDERBUFFER,null)}function kt(I,R){if(R&&R.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(o.FRAMEBUFFER,I),!(R.depthTexture&&R.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const dt=a.get(R.depthTexture);dt.__renderTarget=R,(!dt.__webglTexture||R.depthTexture.image.width!==R.width||R.depthTexture.image.height!==R.height)&&(R.depthTexture.image.width=R.width,R.depthTexture.image.height=R.height,R.depthTexture.needsUpdate=!0),rt(R.depthTexture,0);const gt=dt.__webglTexture,ct=ke(R);if(R.depthTexture.format===iu)Gt(R)?f.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,gt,0,ct):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,gt,0);else if(R.depthTexture.format===au)Gt(R)?f.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,gt,0,ct):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,gt,0);else throw new Error("Unknown depthTexture format")}function le(I){const R=a.get(I),nt=I.isWebGLCubeRenderTarget===!0;if(R.__boundDepthTexture!==I.depthTexture){const dt=I.depthTexture;if(R.__depthDisposeCallback&&R.__depthDisposeCallback(),dt){const gt=()=>{delete R.__boundDepthTexture,delete R.__depthDisposeCallback,dt.removeEventListener("dispose",gt)};dt.addEventListener("dispose",gt),R.__depthDisposeCallback=gt}R.__boundDepthTexture=dt}if(I.depthTexture&&!R.__autoAllocateDepthBuffer){if(nt)throw new Error("target.depthTexture not supported in Cube render targets");const dt=I.texture.mipmaps;dt&&dt.length>0?kt(R.__webglFramebuffer[0],I):kt(R.__webglFramebuffer,I)}else if(nt){R.__webglDepthbuffer=[];for(let dt=0;dt<6;dt++)if(e.bindFramebuffer(o.FRAMEBUFFER,R.__webglFramebuffer[dt]),R.__webglDepthbuffer[dt]===void 0)R.__webglDepthbuffer[dt]=o.createRenderbuffer(),Zt(R.__webglDepthbuffer[dt],I,!1);else{const gt=I.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,ct=R.__webglDepthbuffer[dt];o.bindRenderbuffer(o.RENDERBUFFER,ct),o.framebufferRenderbuffer(o.FRAMEBUFFER,gt,o.RENDERBUFFER,ct)}}else{const dt=I.texture.mipmaps;if(dt&&dt.length>0?e.bindFramebuffer(o.FRAMEBUFFER,R.__webglFramebuffer[0]):e.bindFramebuffer(o.FRAMEBUFFER,R.__webglFramebuffer),R.__webglDepthbuffer===void 0)R.__webglDepthbuffer=o.createRenderbuffer(),Zt(R.__webglDepthbuffer,I,!1);else{const gt=I.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,ct=R.__webglDepthbuffer;o.bindRenderbuffer(o.RENDERBUFFER,ct),o.framebufferRenderbuffer(o.FRAMEBUFFER,gt,o.RENDERBUFFER,ct)}}e.bindFramebuffer(o.FRAMEBUFFER,null)}function Ve(I,R,nt){const dt=a.get(I);R!==void 0&&At(dt.__webglFramebuffer,I,I.texture,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,0),nt!==void 0&&le(I)}function V(I){const R=I.texture,nt=a.get(I),dt=a.get(R);I.addEventListener("dispose",z);const gt=I.textures,ct=I.isWebGLCubeRenderTarget===!0,zt=gt.length>1;if(zt||(dt.__webglTexture===void 0&&(dt.__webglTexture=o.createTexture()),dt.__version=R.version,c.memory.textures++),ct){nt.__webglFramebuffer=[];for(let wt=0;wt<6;wt++)if(R.mipmaps&&R.mipmaps.length>0){nt.__webglFramebuffer[wt]=[];for(let Xt=0;Xt<R.mipmaps.length;Xt++)nt.__webglFramebuffer[wt][Xt]=o.createFramebuffer()}else nt.__webglFramebuffer[wt]=o.createFramebuffer()}else{if(R.mipmaps&&R.mipmaps.length>0){nt.__webglFramebuffer=[];for(let wt=0;wt<R.mipmaps.length;wt++)nt.__webglFramebuffer[wt]=o.createFramebuffer()}else nt.__webglFramebuffer=o.createFramebuffer();if(zt)for(let wt=0,Xt=gt.length;wt<Xt;wt++){const qt=a.get(gt[wt]);qt.__webglTexture===void 0&&(qt.__webglTexture=o.createTexture(),c.memory.textures++)}if(I.samples>0&&Gt(I)===!1){nt.__webglMultisampledFramebuffer=o.createFramebuffer(),nt.__webglColorRenderbuffer=[],e.bindFramebuffer(o.FRAMEBUFFER,nt.__webglMultisampledFramebuffer);for(let wt=0;wt<gt.length;wt++){const Xt=gt[wt];nt.__webglColorRenderbuffer[wt]=o.createRenderbuffer(),o.bindRenderbuffer(o.RENDERBUFFER,nt.__webglColorRenderbuffer[wt]);const qt=l.convert(Xt.format,Xt.colorSpace),St=l.convert(Xt.type),Lt=U(Xt.internalFormat,qt,St,Xt.colorSpace,I.isXRRenderTarget===!0),jt=ke(I);o.renderbufferStorageMultisample(o.RENDERBUFFER,jt,Lt,I.width,I.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+wt,o.RENDERBUFFER,nt.__webglColorRenderbuffer[wt])}o.bindRenderbuffer(o.RENDERBUFFER,null),I.depthBuffer&&(nt.__webglDepthRenderbuffer=o.createRenderbuffer(),Zt(nt.__webglDepthRenderbuffer,I,!0)),e.bindFramebuffer(o.FRAMEBUFFER,null)}}if(ct){e.bindTexture(o.TEXTURE_CUBE_MAP,dt.__webglTexture),ht(o.TEXTURE_CUBE_MAP,R);for(let wt=0;wt<6;wt++)if(R.mipmaps&&R.mipmaps.length>0)for(let Xt=0;Xt<R.mipmaps.length;Xt++)At(nt.__webglFramebuffer[wt][Xt],I,R,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+wt,Xt);else At(nt.__webglFramebuffer[wt],I,R,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+wt,0);S(R)&&y(o.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(zt){for(let wt=0,Xt=gt.length;wt<Xt;wt++){const qt=gt[wt],St=a.get(qt);let Lt=o.TEXTURE_2D;(I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(Lt=I.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),e.bindTexture(Lt,St.__webglTexture),ht(Lt,qt),At(nt.__webglFramebuffer,I,qt,o.COLOR_ATTACHMENT0+wt,Lt,0),S(qt)&&y(Lt)}e.unbindTexture()}else{let wt=o.TEXTURE_2D;if((I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(wt=I.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),e.bindTexture(wt,dt.__webglTexture),ht(wt,R),R.mipmaps&&R.mipmaps.length>0)for(let Xt=0;Xt<R.mipmaps.length;Xt++)At(nt.__webglFramebuffer[Xt],I,R,o.COLOR_ATTACHMENT0,wt,Xt);else At(nt.__webglFramebuffer,I,R,o.COLOR_ATTACHMENT0,wt,0);S(R)&&y(wt),e.unbindTexture()}I.depthBuffer&&le(I)}function Le(I){const R=I.textures;for(let nt=0,dt=R.length;nt<dt;nt++){const gt=R[nt];if(S(gt)){const ct=L(I),zt=a.get(gt).__webglTexture;e.bindTexture(ct,zt),y(ct),e.unbindTexture()}}}const re=[],ne=[];function Pt(I){if(I.samples>0){if(Gt(I)===!1){const R=I.textures,nt=I.width,dt=I.height;let gt=o.COLOR_BUFFER_BIT;const ct=I.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,zt=a.get(I),wt=R.length>1;if(wt)for(let qt=0;qt<R.length;qt++)e.bindFramebuffer(o.FRAMEBUFFER,zt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+qt,o.RENDERBUFFER,null),e.bindFramebuffer(o.FRAMEBUFFER,zt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+qt,o.TEXTURE_2D,null,0);e.bindFramebuffer(o.READ_FRAMEBUFFER,zt.__webglMultisampledFramebuffer);const Xt=I.texture.mipmaps;Xt&&Xt.length>0?e.bindFramebuffer(o.DRAW_FRAMEBUFFER,zt.__webglFramebuffer[0]):e.bindFramebuffer(o.DRAW_FRAMEBUFFER,zt.__webglFramebuffer);for(let qt=0;qt<R.length;qt++){if(I.resolveDepthBuffer&&(I.depthBuffer&&(gt|=o.DEPTH_BUFFER_BIT),I.stencilBuffer&&I.resolveStencilBuffer&&(gt|=o.STENCIL_BUFFER_BIT)),wt){o.framebufferRenderbuffer(o.READ_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.RENDERBUFFER,zt.__webglColorRenderbuffer[qt]);const St=a.get(R[qt]).__webglTexture;o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,St,0)}o.blitFramebuffer(0,0,nt,dt,0,0,nt,dt,gt,o.NEAREST),p===!0&&(re.length=0,ne.length=0,re.push(o.COLOR_ATTACHMENT0+qt),I.depthBuffer&&I.resolveDepthBuffer===!1&&(re.push(ct),ne.push(ct),o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,ne)),o.invalidateFramebuffer(o.READ_FRAMEBUFFER,re))}if(e.bindFramebuffer(o.READ_FRAMEBUFFER,null),e.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),wt)for(let qt=0;qt<R.length;qt++){e.bindFramebuffer(o.FRAMEBUFFER,zt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+qt,o.RENDERBUFFER,zt.__webglColorRenderbuffer[qt]);const St=a.get(R[qt]).__webglTexture;e.bindFramebuffer(o.FRAMEBUFFER,zt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+qt,o.TEXTURE_2D,St,0)}e.bindFramebuffer(o.DRAW_FRAMEBUFFER,zt.__webglMultisampledFramebuffer)}else if(I.depthBuffer&&I.resolveDepthBuffer===!1&&p){const R=I.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT;o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,[R])}}}function ke(I){return Math.min(r.maxSamples,I.samples)}function Gt(I){const R=a.get(I);return I.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&R.__useRenderToTexture!==!1}function se(I){const R=c.render.frame;m.get(I)!==R&&(m.set(I,R),I.update())}function Ze(I,R){const nt=I.colorSpace,dt=I.format,gt=I.type;return I.isCompressedTexture===!0||I.isVideoTexture===!0||nt!==Lo&&nt!==Mr&&(ye.getTransfer(nt)===Ie?(dt!==Ki||gt!==ha)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",nt)),R}function Ke(I){return typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement?(h.width=I.naturalWidth||I.width,h.height=I.naturalHeight||I.height):typeof VideoFrame<"u"&&I instanceof VideoFrame?(h.width=I.displayWidth,h.height=I.displayHeight):(h.width=I.width,h.height=I.height),h}this.allocateTextureUnit=et,this.resetTextureUnits=j,this.setTexture2D=rt,this.setTexture2DArray=B,this.setTexture3D=W,this.setTextureCube=q,this.rebindTextures=Ve,this.setupRenderTarget=V,this.updateRenderTargetMipmap=Le,this.updateMultisampleRenderTarget=Pt,this.setupDepthRenderbuffer=le,this.setupFrameBufferTexture=At,this.useMultisampledRTT=Gt}function hC(o,t){function e(a,r=Mr){let l;const c=ye.getTransfer(r);if(a===ha)return o.UNSIGNED_BYTE;if(a===Nm)return o.UNSIGNED_SHORT_4_4_4_4;if(a===Pm)return o.UNSIGNED_SHORT_5_5_5_1;if(a===xy)return o.UNSIGNED_INT_5_9_9_9_REV;if(a===yy)return o.UNSIGNED_INT_10F_11F_11F_REV;if(a===gy)return o.BYTE;if(a===vy)return o.SHORT;if(a===eu)return o.UNSIGNED_SHORT;if(a===Om)return o.INT;if(a===_s)return o.UNSIGNED_INT;if(a===Ha)return o.FLOAT;if(a===pu)return o.HALF_FLOAT;if(a===Sy)return o.ALPHA;if(a===My)return o.RGB;if(a===Ki)return o.RGBA;if(a===iu)return o.DEPTH_COMPONENT;if(a===au)return o.DEPTH_STENCIL;if(a===Ey)return o.RED;if(a===zm)return o.RED_INTEGER;if(a===Ty)return o.RG;if(a===Im)return o.RG_INTEGER;if(a===Bm)return o.RGBA_INTEGER;if(a===ef||a===nf||a===af||a===rf)if(c===Ie)if(l=t.get("WEBGL_compressed_texture_s3tc_srgb"),l!==null){if(a===ef)return l.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(a===nf)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(a===af)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(a===rf)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(l=t.get("WEBGL_compressed_texture_s3tc"),l!==null){if(a===ef)return l.COMPRESSED_RGB_S3TC_DXT1_EXT;if(a===nf)return l.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(a===af)return l.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(a===rf)return l.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(a===Bp||a===Fp||a===Hp||a===Gp)if(l=t.get("WEBGL_compressed_texture_pvrtc"),l!==null){if(a===Bp)return l.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(a===Fp)return l.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(a===Hp)return l.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(a===Gp)return l.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(a===Vp||a===kp||a===Xp)if(l=t.get("WEBGL_compressed_texture_etc"),l!==null){if(a===Vp||a===kp)return c===Ie?l.COMPRESSED_SRGB8_ETC2:l.COMPRESSED_RGB8_ETC2;if(a===Xp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:l.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(a===Wp||a===qp||a===Yp||a===jp||a===Zp||a===Kp||a===Qp||a===Jp||a===$p||a===tm||a===em||a===nm||a===im||a===am)if(l=t.get("WEBGL_compressed_texture_astc"),l!==null){if(a===Wp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:l.COMPRESSED_RGBA_ASTC_4x4_KHR;if(a===qp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:l.COMPRESSED_RGBA_ASTC_5x4_KHR;if(a===Yp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:l.COMPRESSED_RGBA_ASTC_5x5_KHR;if(a===jp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:l.COMPRESSED_RGBA_ASTC_6x5_KHR;if(a===Zp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:l.COMPRESSED_RGBA_ASTC_6x6_KHR;if(a===Kp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:l.COMPRESSED_RGBA_ASTC_8x5_KHR;if(a===Qp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:l.COMPRESSED_RGBA_ASTC_8x6_KHR;if(a===Jp)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:l.COMPRESSED_RGBA_ASTC_8x8_KHR;if(a===$p)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:l.COMPRESSED_RGBA_ASTC_10x5_KHR;if(a===tm)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:l.COMPRESSED_RGBA_ASTC_10x6_KHR;if(a===em)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:l.COMPRESSED_RGBA_ASTC_10x8_KHR;if(a===nm)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:l.COMPRESSED_RGBA_ASTC_10x10_KHR;if(a===im)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:l.COMPRESSED_RGBA_ASTC_12x10_KHR;if(a===am)return c===Ie?l.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:l.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(a===rm||a===sm||a===om)if(l=t.get("EXT_texture_compression_bptc"),l!==null){if(a===rm)return c===Ie?l.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:l.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(a===sm)return l.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(a===om)return l.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(a===lm||a===um||a===cm||a===fm)if(l=t.get("EXT_texture_compression_rgtc"),l!==null){if(a===lm)return l.COMPRESSED_RED_RGTC1_EXT;if(a===um)return l.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(a===cm)return l.COMPRESSED_RED_GREEN_RGTC2_EXT;if(a===fm)return l.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return a===nu?o.UNSIGNED_INT_24_8:o[a]!==void 0?o[a]:null}return{convert:e}}const dC=`
void main() {
...
}`;class mC{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e){if(this.texture===null){const a=new Iy(t.texture);(t.depthNear!==e.depthNear||t.depthFar!==e.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=a}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,a=new ka({vertexShader:dC,fragmentShader:pC,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new yi(new Af(20,20),a)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class _C extends Ho{constructor(t,e){super();const a=this;let r=null,l=1,c=null,f="local-floor",p=1,h=null,m=null,g=null,v=null,x=null,E=null;const M=typeof XRWebGLBinding<"u",S=new mC,y={},L=e.getContextAttributes();let U=null,A=null;const D=[],P=[],z=new Te;let F=null;const b=new Ii;b.viewport=new sn;const N=new Ii;N.viewport=new sn;const G=[b,N],j=new zb;let et=null,ft=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function($){let _t=D[$];return _t===void 0&&(_t=new op,D[$]=_t),_t.getTargetRaySpace()},this.getControllerGrip=function($){let _t=D[$];return _t===void 0&&(_t=new op,D[$]=_t),_t.getGripSpace()},this.getHand=function($){let _t=D[$];return _t===void 0&&(_t=new op,D[$]=_t),_t.getHandSpace()};function rt($){const _t=P.indexOf($.inputSource);if(_t===-1)return;const At=D[_t];At!==void 0&&(At.update($.inputSource,$.frame,h||c),At.dispatchEvent({type:$.type,data:$.inputSource}))}function B(){r.removeEventListener("select",rt),r.removeEventListener("selectstart",rt),r.removeEventListener("selectend",rt),r.removeEventListener("squeeze",rt),r.removeEventListener("squeezestart",rt),r.removeEventListener("squeezeend",rt),r.removeEventListener("end",B),r.removeEventListener("inputsourceschange",W);for(let $=0;$<D.length;$++){const _t=P[$];_t!==null&&(P[$]=null,D[$].disconnect(_t))}et=null,ft=null,S.reset();for(const $ in y)delete y[$];t.setRenderTarget(U),x=null,v=null,g=null,r=null,A=null,Rt.stop(),a.isPresenting=!1,t.setPixelRatio(F),t.setSize(z.width,z.height,!1),a.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function($){l=$,a.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function($){f=$,a.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return h||c},this.setReferenceSpace=function($){h=$},this.getBaseLayer=function(){return v!==null?v:x},this.getBinding=function(){return g===null&&M&&(g=new XRWebGLBinding(r,e)),g},this.getFrame=function(){return E},this.getSession=function(){return r},this.setSession=async function($){if(r=$,r!==null){if(U=t.getRenderTarget(),r.addEventListener("select",rt),r.addEventListener("selectstart",rt),r.addEventListener("selectend",rt),r.addEventListener("squeeze",rt),r.addEventListener("squeezestart",rt),r.addEventListener("squeezeend",rt),r.addEventListener("end",B),r.addEventListener("inputsourceschange",W),L.xrCompatible!==!0&&await e.makeXRCompatible(),F=t.getPixelRatio(),t.getSize(z),M&&"createProjectionLayer"in XRWebGLBinding.prototype){let At=null,Zt=null,kt=null;L.depth&&(kt=L.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,At=L.stencil?au:iu,Zt=L.stencil?nu:_s);const le={colorFormat:e.RGBA8,depthFormat:kt,scaleFactor:l};g=this.getBinding(),v=g.createProjectionLayer(le),r.updateRenderState({layers:[v]}),t.setPixelRatio(1),t.setSize(v.textureWidth,v.textureHeight,!1),A=new gs(v.textureWidth,v.textureHeight,{format:Ki,type:ha,depthTexture:new zy(v.textureWidth,v.textureHeight,Zt,void 0,void 0,void 0,void 0,void 0,void 0,At),stencilBuffer:L.stencil,colorSpace:t.outputColorSpace,samples:L.antialias?4:0,resolveDepthBuffer:v.ignoreDepthValues===!1,resolveStencilBuffer:v.ignoreDepthValues===!1})}else{const At={antialias:L.antialias,alpha:!0,depth:L.depth,stencil:L.stencil,framebufferScaleFactor:l};x=new XRWebGLLayer(r,e,At),r.updateRenderState({baseLayer:x}),t.setPixelRatio(1),t.setSize(x.framebufferWidth,x.framebufferHeight,!1),A=new gs(x.framebufferWidth,x.framebufferHeight,{format:Ki,type:ha,colorSpace:t.outputColorSpace,stencilBuffer:L.stencil,resolveDepthBuffer:x.ignoreDepthValues===!1,resolveStencilBuffer:x.ignoreDepthValues===!1})}A.isXRRenderTarget=!0,this.setFoveation(p),h=null,c=await r.requestReferenceSpace(f),Rt.setContext(r),Rt.start(),a.isPresenting=!0,a.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return S.getDepthTexture()};function W($){for(let _t=0;_t<$.removed.length;_t++){const At=$.removed[_t],Zt=P.indexOf(At);Zt>=0&&(P[Zt]=null,D[Zt].disconnect(At))}for(let _t=0;_t<$.added.length;_t++){const At=$.added[_t];let Zt=P.indexOf(At);if(Zt===-1){for(let le=0;le<D.length;le++)if(le>=P.length){P.push(At),Zt=le;break}else if(P[le]===null){P[le]=At,Zt=le;break}if(Zt===-1)break}const kt=D[Zt];kt&&kt.connect(At)}}const q=new it,yt=new it;function O($,_t,At){q.setFromMatrixPosition(_t.matrixWorld),yt.setFromMatrixPosition(At.matrixWorld);const Zt=q.distanceTo(yt),kt=_t.projectionMatrix.elements,le=At.projectionMatrix.elements,Ve=kt[14]/(kt[10]-1),V=kt[14]/(kt[10]+1),Le=(kt[9]+1)/kt[5],re=(kt[9]-1)/kt[5],ne=(kt[8]-1)/kt[0],Pt=(le[8]+1)/le[0],ke=Ve*ne,Gt=Ve*Pt,se=Zt/(-ne+Pt),Ze=se*-ne;if(_t.matrixWorld.decompose($.position,$.quaternion,$.scale),$.translateX(Ze),$.translateZ(se),$.matrixWorld.compose($.position,$.quaternion,$.scale),$.matrixWorldInverse.copy($.matrixWorld).invert(),kt[10]===-1)$.projectionMatrix.copy(_t.projectionMatrix),$.projectionMatrixInverse.copy(_t.projectionMatrixInverse);else{const Ke=Ve+se,I=V+se,R=ke-Ze,nt=Gt+(Zt-Ze),dt=Le*V/I*Ke,gt=re*V/I*Ke;$.projectionMatrix.makePerspective(R,nt,dt,gt,Ke,I),$.projectionMatrixInverse.copy($.projectionMatrix).invert()}}function Y($,_t){_t===null?$.matrixWorld.copy($.matrix):$.matrixWorld.multiplyMatrices(_t.matrixWorld,$.matrix),$.matrixWorldInverse.copy($.matrixWorld).invert()}this.updateCamera=function($){if(r===null)return;let _t=$.near,At=$.far;S.texture!==null&&(S.depthNear>0&&(_t=S.depthNear),S.depthFar>0&&(At=S.depthFar)),j.near=N.near=b.near=_t,j.far=N.far=b.far=At,(et!==j.near||ft!==j.far)&&(r.updateRenderState({depthNear:j.near,depthFar:j.far}),et=j.near,ft=j.far),j.layers.mask=$.layers.mask|6,b.layers.mask=j.layers.mask&3,N.layers.mask=j.layers.mask&5;const Zt=$.parent,kt=j.cameras;Y(j,Zt);for(let le=0;le<kt.length;le++)Y(kt[le],Zt);kt.length===2?O(j,b,N):j.projectionMatrix.copy(b.projectionMatrix),ht($,j,Zt)};function ht($,_t,At){At===null?$.matrix.copy(_t.matrixWorld):($.matrix.copy(At.matrixWorld),$.matrix.invert(),$.matrix.multiply(_t.matrixWorld)),$.matrix.decompose($.position,$.quaternion,$.scale),$.updateMatrixWorld(!0),$.projectionMatrix.copy(_t.projectionMatrix),$.projectionMatrixInverse.copy(_t.projectionMatrixInverse),$.isPerspectiveCamera&&($.fov=hm*2*Math.atan(1/$.projectionMatrix.elements[5]),$.zoom=1)}this.getCamera=function(){return j},this.getFoveation=function(){if(!(v===null&&x===null))return p},this.setFoveation=function($){p=$,v!==null&&(v.fixedFoveation=$),x!==null&&x.fixedFoveation!==void 0&&(x.fixedFoveation=$)},this.hasDepthSensing=function(){return S.texture!==null},this.getDepthSensingMesh=function(){return S.getMesh(j)},this.getCameraTexture=function($){return y[$]};let ut=null;function Et($,_t){if(m=_t.getViewerPose(h||c),E=_t,m!==null){const At=m.views;x!==null&&(t.setRenderTargetFramebuffer(A,x.framebuffer),t.setRenderTarget(A));let Zt=!1;At.length!==j.cameras.length&&(j.cameras.length=0,Zt=!0);for(let V=0;V<At.length;V++){const Le=At[V];let re=null;if(x!==null)re=x.getViewport(Le);else{const Pt=g.getViewSubImage(v,Le);re=Pt.viewport,V===0&&(t.setRenderTargetTextures(A,Pt.colorTexture,Pt.depthStencilTexture),t.setRenderTarget(A))}let ne=G[V];ne===void 0&&(ne=new Ii,ne.layers.enable(V),ne.viewport=new sn,G[V]=ne),ne.matrix.fromArray(Le.transform.matrix),ne.matrix.decompose(ne.position,ne.quaternion,ne.scale),ne.projectionMatrix.fromArray(Le.projectionMatrix),ne.projectionMatrixInverse.copy(ne.projectionMatrix).invert(),ne.viewport.set(re.x,re.y,re.width,re.height),V===0&&(j.matrix.copy(ne.matrix),j.matrix.decompose(j.position,j.quaternion,j.scale)),Zt===!0&&j.cameras.push(ne)}const kt=r.enabledFeatures;if(kt&&kt.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&M){g=a.getBinding();const V=g.getDepthInformation(At[0]);V&&V.isValid&&V.texture&&S.init(V,r.renderState)}if(kt&&kt.includes("camera-access")&&M){t.state.unbindTexture(),g=a.getBinding();for(let V=0;V<At.length;V++){const Le=At[V].camera;if(Le){let re=y[Le];re||(re=new Iy,y[Le]=re);const ne=g.getCameraImage(Le);re.sourceTexture=ne}}}}for(let At=0;At<D.length;At++){const Zt=P[At],kt=D[At];Zt!==null&&kt!==void 0&&kt.update(Zt,_t,h||c)}ut&&ut($,_t),_t.detectedPlanes&&a.dispatchEvent({type:"planesdetected",data:_t}),E=null}const Rt=new Xy;Rt.setAnimationLoop(Et),this.setAnimationLoop=function($){ut=$},this.dispose=function(){}}}const es=new Ji,gC=new tn;function vC(o,t){function e(S,y){S.matrixAutoUpdate===!0&&S.updateMatrix(),y.value.copy(S.matrix)}function a(S,y){y.color.getRGB(S.fogColor.value,Oy(o)),y.isFog?(S.fogNear.value=y.near,S.fogFar.value=y.far):y.isFogExp2&&(S.fogDensity.value=y.density)}function r(S,y,L,U,A){y.isMeshBasicMaterial||y.isMeshLambertMaterial?l(S,y):y.isMeshToonMaterial?(l(S,y),g(S,y)):y.isMeshPhongMaterial?(l(S,y),m(S,y)):y.isMeshStandardMaterial?(l(S,y),v(S,y),y.isMeshPhysicalMaterial&&x(S,y,A)):y.isMeshMatcapMaterial?(l(S,y),E(S,y)):y.isMeshDepthMaterial?l(S,y):y.isMeshDistanceMaterial?(l(S,y),M(S,y)):y.isMeshNormalMaterial?l(S,y):y.isLineBasicMaterial?(c(S,y),y.isLineDashedMaterial&&f(S,y)):y.isPointsMaterial?p(S,y,L,U):y.isSpriteMaterial?h(S,y):y.isShadowMaterial?(S.color.value.copy(y.color),S.opacity.value=y.opacity):y.isShaderMaterial&&(y.uniformsNeedUpdate=!1)}function l(S,y){S.opacity.value=y.opacity,y.color&&S.diffuse.value.copy(y.color),y.emissive&&S.emissive.value.copy(y.emissive).multiplyScalar(y.emissiveIntensity),y.map&&(S.map.value=y.map,e(y.map,S.mapTransform)),y.alphaMap&&(S.alphaMap.value=y.alphaMap,e(y.alphaMap,S.alphaMapTransform)),y.bumpMap&&(S.bumpMap.value=y.bumpMap,e(y.bumpMap,S.bumpMapTransform),S.bumpScale.value=y.bumpScale,y.side===ii&&(S.bumpScale.value*=-1)),y.normalMap&&(S.normalMap.value=y.normalMap,e(y.normalMap,S.normalMapTransform),S.normalScale.value.copy(y.normalScale),y.side===ii&&S.normalScale.value.negate()),y.displacementMap&&(S.displacementMap.value=y.displacementMap,e(y.displacementMap,S.displacementMapTransform),S.displacementScale.value=y.displacementScale,S.displacementBias.value=y.displacementBias),y.emissiveMap&&(S.emissiveMap.value=y.emissiveMap,e(y.emissiveMap,S.emissiveMapTransform)),y.specularMap&&(S.specularMap.value=y.specularMap,e(y.specularMap,S.specularMapTransform)),y.alphaTest>0&&(S.alphaTest.value=y.alphaTest);const L=t.get(y),U=L.envMap,A=L.envMapRotation;U&&(S.envMap.value=U,es.copy(A),es.x*=-1,es.y*=-1,es.z*=-1,U.isCubeTexture&&U.isRenderTargetTexture===!1&&(es.y*=-1,es.z*=-1),S.envMapRotation.value.setFromMatrix4(gC.makeRotationFromEuler(es)),S.flipEnvMap.value=U.isCubeTexture&&U.isRenderTargetTexture===!1?-1:1,S.reflectivity.value=y.reflectivity,S.ior.value=y.ior,S.refractionRatio.value=y.refractionRatio),y.lightMap&&(S.lightMap.value=y.lightMap,S.lightMapIntensity.value=y.lightMapIntensity,e(y.lightMap,S.lightMapTransform)),y.aoMap&&(S.aoMap.value=y.aoMap,S.aoMapIntensity.value=y.aoMapIntensity,e(y.aoMap,S.aoMapTransform))}function c(S,y){S.diffuse.value.copy(y.color),S.opacity.value=y.opacity,y.map&&(S.map.value=y.map,e(y.map,S.mapTransform))}function f(S,y){S.dashSize.value=y.dashSize,S.totalSize.value=y.dashSize+y.gapSize,S.scale.value=y.scale}function p(S,y,L,U){S.diffuse.value.copy(y.color),S.opacity.value=y.opacity,S.size.value=y.size*L,S.scale.value=U*.5,y.map&&(S.map.value=y.map,e(y.map,S.uvTransform)),y.alphaMap&&(S.alphaMap.value=y.alphaMap,e(y.alphaMap,S.alphaMapTransform)),y.alphaTest>0&&(S.alphaTest.value=y.alphaTest)}function h(S,y){S.diffuse.value.copy(y.color),S.opacity.value=y.opacity,S.rotation.value=y.rotation,y.map&&(S.map.value=y.map,e(y.map,S.mapTransform)),y.alphaMap&&(S.alphaMap.value=y.alphaMap,e(y.alphaMap,S.alphaMapTransform)),y.alphaTest>0&&(S.alphaTest.value=y.alphaTest)}function m(S,y){S.specular.value.copy(y.specular),S.shininess.value=Math.max(y.shininess,1e-4)}function g(S,y){y.gradientMap&&(S.gradientMap.value=y.gradientMap)}function v(S,y){S.metalness.value=y.metalness,y.metalnessMap&&(S.metalnessMap.value=y.metalnessMap,e(y.metalnessMap,S.metalnessMapTransform)),S.roughness.value=y.roughness,y.roughnessMap&&(S.roughnessMap.value=y.roughnessMap,e(y.roughnessMap,S.roughnessMapTransform)),y.envMap&&(S.envMapIntensity.value=y.envMapIntensity)}function x(S,y,L){S.ior.value=y.ior,y.sheen>0&&(S.sheenColor.value.copy(y.sheenColor).multiplyScalar(y.sheen),S.sheenRoughness.value=y.sheenRoughness,y.sheenColorMap&&(S.sheenColorMap.value=y.sheenColorMap,e(y.sheenColorMap,S.sheenColorMapTransform)),y.sheenRoughnessMap&&(S.sheenRoughnessMap.value=y.sheenRoughnessMap,e(y.sheenRoughnessMap,S.sheenRoughnessMapTransform))),y.clearcoat>0&&(S.clearcoat.value=y.clearcoat,S.clearcoatRoughness.value=y.clearcoatRoughness,y.clearcoatMap&&(S.clearcoatMap.value=y.clearcoatMap,e(y.clearcoatMap,S.clearcoatMapTransform)),y.clearcoatRoughnessMap&&(S.clearcoatRoughnessMap.value=y.clearcoatRoughnessMap,e(y.clearcoatRoughnessMap,S.clearcoatRoughnessMapTransform)),y.clearcoatNormalMap&&(S.clearcoatNormalMap.value=y.clearcoatNormalMap,e(y.clearcoatNormalMap,S.clearcoatNormalMapTransform),S.clearcoatNormalScale.value.copy(y.clearcoatNormalScale),y.side===ii&&S.clearcoatNormalScale.value.negate())),y.dispersion>0&&(S.dispersion.value=y.dispersion),y.iridescence>0&&(S.iridescence.value=y.iridescence,S.iridescenceIOR.value=y.iridescenceIOR,S.iridescenceThicknessMinimum.value=y.iridescenceThicknessRange[0],S.iridescenceThicknessMaximum.value=y.iridescenceThicknessRange[1],y.iridescenceMap&&(S.iridescenceMap.value=y.iridescenceMap,e(y.iridescenceMap,S.iridescenceMapTransform)),y.iridescenceThicknessMap&&(S.iridescenceThicknessMap.value=y.iridescenceThicknessMap,e(y.iridescenceThicknessMap,S.iridescenceThicknessMapTransform))),y.transmission>0&&(S.transmission.value=y.transmission,S.transmissionSamplerMap.value=L.texture,S.transmissionSamplerSize.value.set(L.width,L.height),y.transmissionMap&&(S.transmissionMap.value=y.transmissionMap,e(y.transmissionMap,S.transmissionMapTransform)),S.thickness.value=y.thickness,y.thicknessMap&&(S.thicknessMap.value=y.thicknessMap,e(y.thicknessMap,S.thicknessMapTransform)),S.attenuationDistance.value=y.attenuationDistance,S.attenuationColor.value.copy(y.attenuationColor)),y.anisotropy>0&&(S.anisotropyVector.value.set(y.anisotropy*Math.cos(y.anisotropyRotation),y.anisotropy*Math.sin(y.anisotropyRotation)),y.anisotropyMap&&(S.anisotropyMap.value=y.anisotropyMap,e(y.anisotropyMap,S.anisotropyMapTransform))),S.specularIntensity.value=y.specularIntensity,S.specularColor.value.copy(y.specularColor),y.specularColorMap&&(S.specularColorMap.value=y.specularColorMap,e(y.specularColorMap,S.specularColorMapTransform)),y.specularIntensityMap&&(S.specularIntensityMap.value=y.specularIntensityMap,e(y.specularIntensityMap,S.specularIntensityMapTransform))}function E(S,y){y.matcap&&(S.matcap.value=y.matcap)}function M(S,y){const L=t.get(y).light;S.referencePosition.value.setFromMatrixPosition(L.matrixWorld),S.nearDistance.value=L.shadow.camera.near,S.farDistance.value=L.shadow.camera.far}return{refreshFogUniforms:a,refreshMaterialUniforms:r}}function xC(o,t,e,a){let r={},l={},c=[];const f=o.getParameter(o.MAX_UNIFORM_BUFFER_BINDINGS);function p(L,U){const A=U.program;a.uniformBlockBinding(L,A)}function h(L,U){let A=r[L.id];A===void 0&&(E(L),A=m(L),r[L.id]=A,L.addEventListener("dispose",S));const D=U.program;a.updateUBOMapping(L,D);const P=t.render.frame;l[L.id]!==P&&(v(L),l[L.id]=P)}function m(L){const U=g();L.__bindingPointIndex=U;const A=o.createBuffer(),D=L.__size,P=L.usage;return o.bindBuffer(o.UNIFORM_BUFFER,A),o.bufferData(o.UNIFORM_BUFFER,D,P),o.bindBuffer(o.UNIFORM_BUFFER,null),o.bindBufferBase(o.UNIFORM_BUFFER,U,A),A}function g(){for(let L=0;L<f;L++)if(c.indexOf(L)===-1)return c.push(L),L;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function v(L){const U=r[L.id],A=L.uniforms,D=L.__cache;o.bindBuffer(o.UNIFORM_BUFFER,U);for(let P=0,z=A.length;P<z;P++){const F=Array.isArray(A[P])?A[P]:[A[P]];for(let b=0,N=F.length;b<N;b++){const G=F[b];if(x(G,P,b,D)===!0){const j=G.__offset,et=Array.isArray(G.value)?G.value:[G.value];let ft=0;for(let rt=0;rt<et.length;rt++){const B=et[rt],W=M(B);typeof B=="number"||typeof B=="boolean"?(G.__data[0]=B,o.bufferSubData(o.UNIFORM_BUFFER,j+ft,G.__data)):B.isMatrix3?(G.__data[0]=B.elements[0],G.__data[1]=B.elements[1],G.__data[2]=B.elements[2],G.__data[3]=0,G.__data[4]=B.elements[3],G.__data[5]=B.elements[4],G.__data[6]=B.elements[5],G.__data[7]=0,G.__data[8]=B.elements[6],G.__data[9]=B.elements[7],G.__data[10]=B.elements[8],G.__data[11]=0):(B.toArray(G.__data,ft),ft+=W.storage/Float32Array.BYTES_PER_ELEMENT)}o.bufferSubData(o.UNIFORM_BUFFER,j,G.__data)}}}o.bindBuffer(o.UNIFORM_BUFFER,null)}function x(L,U,A,D){const P=L.value,z=U+"_"+A;if(D[z]===void 0)return typeof P=="number"||typeof P=="boolean"?D[z]=P:D[z]=P.clone(),!0;{const F=D[z];if(typeof P=="number"||typeof P=="boolean"){if(F!==P)return D[z]=P,!0}else if(F.equals(P)===!1)return F.copy(P),!0}return!1}function E(L){const U=L.uniforms;let A=0;const D=16;for(let z=0,F=U.length;z<F;z++){const b=Array.isArray(U[z])?U[z]:[U[z]];for(let N=0,G=b.length;N<G;N++){const j=b[N],et=Array.isArray(j.value)?j.value:[j.value];for(let ft=0,rt=et.length;ft<rt;ft++){const B=et[ft],W=M(B),q=A%D,yt=q%W.boundary,O=q+yt;A+=yt,O!==0&&D-O<W.storage&&(A+=D-O),j.__data=new Float32Array(W.storage/Float32Array.BYTES_PER_ELEMENT),j.__offset=A,A+=W.storage}}}const P=A%D;return P>0&&(A+=D-P),L.__size=A,L.__cache={},this}function M(L){const U={boundary:0,storage:0};return typeof L=="number"||typeof L=="boolean"?(U.boundary=4,U.storage=4):L.isVector2?(U.boundary=8,U.storage=8):L.isVector3||L.isColor?(U.boundary=16,U.storage=12):L.isVector4?(U.boundary=16,U.storage=16):L.isMatrix3?(U.boundary=48,U.storage=48):L.isMatrix4?(U.boundary=64,U.storage=64):L.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",L),U}function S(L){const U=L.target;U.removeEventListener("dispose",S);const A=c.indexOf(U.__bindingPointIndex);c.splice(A,1),o.deleteBuffer(r[U.id]),delete r[U.id],delete l[U.id]}function y(){for(const L in r)o.deleteBuffer(r[L]);c=[],r={},l={}}return{bind:p,update:h,dispose:y}}class yC{constructor(t={}){const{canvas:e=ZT(),context:a=null,depth:r=!0,stencil:l=!1,alpha:c=!1,antialias:f=!1,premultipliedAlpha:p=!0,preserveDrawingBuffer:h=!1,powerPreference:m="default",failIfMajorPerformanceCaveat:g=!1,reversedDepthBuffer:v=!1}=t;this.isWebGLRenderer=!0;let x;if(a!==null){if(typeof WebGLRenderingContext<"u"&&a instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");x=a.getContextAttributes().alpha}else x=c;const E=new Uint32Array(4),M=new Int32Array(4);let S=null,y=null;const L=[],U=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Rr,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const A=this;let D=!1;this._outputColorSpace=Nn;let P=0,z=0,F=null,b=-1,N=null;const G=new sn,j=new sn;let et=null;const ft=new fe(0);let rt=0,B=e.width,W=e.height,q=1,yt=null,O=null;const Y=new sn(0,0,B,W),ht=new sn(0,0,B,W);let ut=!1;const Et=new Vm;let Rt=!1,$=!1;const _t=new tn,At=new it,Zt=new sn,kt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let le=!1;function Ve(){return F===null?q:1}let V=a;function Le(C,Z){return e.getContext(C,Z)}try{const C={alpha:!0,depth:r,stencil:l,antialias:f,premultipliedAlpha:p,preserveDrawingBuffer:h,powerPreference:m,failIfMajorPerformanceCaveat:g};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${Um}`),e.addEventListener("webglcontextlost",Ct,!1),e.addEventListener("webglcontextrestored",It,!1),e.addEventListener("webglcontextcreationerror",Mt,!1),V===null){const Z="webgl2";if(V=Le(Z,C),V===null)throw Le(Z)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(C){throw console.error("THREE.WebGLRenderer: "+C.message),C}let re,ne,Pt,ke,Gt,se,Ze,Ke,I,R,nt,dt,gt,ct,zt,wt,Xt,qt,St,Lt,jt,Vt,Dt,oe;function X(){re=new DR(V),re.init(),Vt=new hC(V,re),ne=new ER(V,re,t,Vt),Pt=new cC(V,re),ne.reversedDepthBuffer&&v&&Pt.buffers.depth.setReversed(!0),ke=new OR(V),Gt=new Qw,se=new fC(V,re,Pt,Gt,ne,Vt,ke),Ze=new bR(A),Ke=new CR(A),I=new Fb(V),Dt=new SR(V,I),R=new UR(V,I,ke,Dt),nt=new PR(V,R,I,ke),St=new NR(V,ne,se),wt=new TR(Gt),dt=new Kw(A,Ze,Ke,re,ne,Dt,wt),gt=new vC(A,Gt),ct=new $w,zt=new rC(re),qt=new yR(A,Ze,Ke,Pt,nt,x,p),Xt=new lC(A,nt,ne),oe=new xC(V,ke,ne,Pt),Lt=new MR(V,re,ke),jt=new LR(V,re,ke),ke.programs=dt.programs,A.capabilities=ne,A.extensions=re,A.properties=Gt,A.renderLists=ct,A.shadowMap=Xt,A.state=Pt,A.info=ke}X();const bt=new _C(A,V);this.xr=bt,this.getContext=function(){return V},this.getContextAttributes=function(){return V.getContextAttributes()},this.forceContextLoss=function(){const C=re.get("WEBGL_lose_context");C&&C.loseContext()},this.forceContextRestore=function(){const C=re.get("WEBGL_lose_context");C&&C.restoreContext()},this.getPixelRatio=function(){return q},this.setPixelRatio=function(C){C!==void 0&&(q=C,this.setSize(B,W,!1))},this.getSize=function(C){return C.set(B,W)},this.setSize=function(C,Z,ot=!0){if(bt.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}B=C,W=Z,e.width=Math.floor(C*q),e.height=Math.floor(Z*q),ot===!0&&(e.style.width=C+"px",e.style.height=Z+"px"),this.setViewport(0,0,C,Z)},this.getDrawingBufferSize=function(C){return C.set(B*q,W*q).floor()},this.setDrawingBufferSize=function(C,Z,ot){B=C,W=Z,q=ot,e.width=Math.floor(C*ot),e.height=Math.floor(Z*ot),this.setViewport(0,0,C,Z)},this.getCurrentViewport=function(C){return C.copy(G)},this.getViewport=function(C){return C.copy(Y)},this.setViewport=function(C,Z,ot,lt){C.isVector4?Y.set(C.x,C.y,C.z,C.w):Y.set(C,Z,ot,lt),Pt.viewport(G.copy(Y).multiplyScalar(q).round())},this.getScissor=function(C){return C.copy(ht)},this.setScissor=function(C,Z,ot,lt){C.isVector4?ht.set(C.x,C.y,C.z,C.w):ht.set(C,Z,ot,lt),Pt.scissor(j.copy(ht).multiplyScalar(q).round())},this.getScissorTest=function(){return ut},this.setScissorTest=function(C){Pt.setScissorTest(ut=C)},this.setOpaqueSort=function(C){yt=C},this.setTransparentSort=function(C){O=C},this.getClearColor=function(C){return C.copy(qt.getClearColor())},this.setClearColor=function(){qt.setClearColor(...arguments)},this.getClearAlpha=function(){return qt.getClearAlpha()},this.setClearAlpha=function(){qt.setClearAlpha(...arguments)},this.clear=function(C=!0,Z=!0,ot=!0){let lt=0;if(C){let Q=!1;if(F!==null){const Tt=F.texture.format;Q=Tt===Bm||Tt===Im||Tt===zm}if(Q){const Tt=F.texture.type,Ut=Tt===ha||Tt===_s||Tt===eu||Tt===nu||Tt===Nm||Tt===Pm,Bt=qt.getClearColor(),Ot=qt.getClearAlpha(),Jt=Bt.r,te=Bt.g,Wt=Bt.b;Ut?(E[0]=Jt,E[1]=te,E[2]=Wt,E[3]=Ot,V.clearBufferuiv(V.COLOR,0,E)):(M[0]=Jt,M[1]=te,M[2]=Wt,M[3]=Ot,V.clearBufferiv(V.COLOR,0,M))}else lt|=V.COLOR_BUFFER_BIT}Z&&(lt|=V.DEPTH_BUFFER_BIT),ot&&(lt|=V.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),V.clear(lt)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",Ct,!1),e.removeEventListener("webglcontextrestored",It,!1),e.removeEventListener("webglcontextcreationerror",Mt,!1),qt.dispose(),ct.dispose(),zt.dispose(),Gt.dispose(),Ze.dispose(),Ke.dispose(),nt.dispose(),Dt.dispose(),oe.dispose(),dt.dispose(),bt.dispose(),bt.removeEventListener("sessionstart",gn),bt.removeEventListener("sessionend",vn),en.stop()};function Ct(C){C.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),D=!0}function It(){console.log("THREE.WebGLRenderer: Context Restored."),D=!1;const C=ke.autoReset,Z=Xt.enabled,ot=Xt.autoUpdate,lt=Xt.needsUpdate,Q=Xt.type;X(),ke.autoReset=C,Xt.enabled=Z,Xt.autoUpdate=ot,Xt.needsUpdate=lt,Xt.type=Q}function Mt(C){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",C.statusMessage)}function xt(C){const Z=C.target;Z.removeEventListener("dispose",xt),Ht(Z)}function Ht(C){ae(C),Gt.remove(C)}function ae(C){const Z=Gt.get(C).programs;Z!==void 0&&(Z.forEach(function(ot){dt.releaseProgram(ot)}),C.isShaderMaterial&&dt.releaseShaderCache(C))}this.renderBufferDirect=function(C,Z,ot,lt,Q,Tt){Z===null&&(Z=kt);const Ut=Q.isMesh&&Q.matrixWorld.determinant()<0,Bt=qa(C,Z,ot,lt,Q);Pt.setMaterial(lt,Ut);let Ot=ot.index,Jt=1;if(lt.wireframe===!0){if(Ot=R.getWireframeAttribute(ot),Ot===void 0)return;Jt=2}const te=ot.drawRange,Wt=ot.attributes.position;let he=te.start*Jt,Ae=(te.start+te.count)*Jt;Tt!==null&&(he=Math.max(he,Tt.start*Jt),Ae=Math.min(Ae,(Tt.start+Tt.count)*Jt)),Ot!==null?(he=Math.max(he,0),Ae=Math.min(Ae,Ot.count)):Wt!=null&&(he=Math.max(he,0),Ae=Math.min(Ae,Wt.count));const qe=Ae-he;if(qe<0||qe===1/0)return;Dt.setup(Q,lt,Bt,ot,Ot);let Oe,de=Lt;if(Ot!==null&&(Oe=I.get(Ot),de=jt,de.setIndex(Oe)),Q.isMesh)lt.wireframe===!0?(Pt.setLineWidth(lt.wireframeLinewidth*Ve()),de.setMode(V.LINES)):de.setMode(V.TRIANGLES);else if(Q.isLine){let Qt=lt.linewidth;Qt===void 0&&(Qt=1),Pt.setLineWidth(Qt*Ve()),Q.isLineSegments?de.setMode(V.LINES):Q.isLineLoop?de.setMode(V.LINE_LOOP):de.setMode(V.LINE_STRIP)}else Q.isPoints?de.setMode(V.POINTS):Q.isSprite&&de.setMode(V.TRIANGLES);if(Q.isBatchedMesh)if(Q._multiDrawInstances!==null)su("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),de.renderMultiDrawInstances(Q._multiDrawStarts,Q._multiDrawCounts,Q._multiDrawCount,Q._multiDrawInstances);else if(re.get("WEBGL_multi_draw"))de.renderMultiDraw(Q._multiDrawStarts,Q._multiDrawCounts,Q._multiDrawCount);else{const Qt=Q._multiDrawStarts,We=Q._multiDrawCounts,ge=Q._multiDrawCount,zn=Ot?I.get(Ot).bytesPerElement:1,Vi=Gt.get(lt).currentProgram.getUniforms();for(let Xn=0;Xn<ge;Xn++)Vi.setValue(V,"_gl_DrawID",Xn),de.render(Qt[Xn]/zn,We[Xn])}else if(Q.isInstancedMesh)de.renderInstances(he,qe,Q.count);else if(ot.isInstancedBufferGeometry){const Qt=ot._maxInstanceCount!==void 0?ot._maxInstanceCount:1/0,We=Math.min(ot.instanceCount,Qt);de.renderInstances(he,qe,We)}else de.render(he,qe)};function Ce(C,Z,ot){C.transparent===!0&&C.side===Fa&&C.forceSinglePass===!1?(C.side=ii,C.needsUpdate=!0,ta(C,Z,ot),C.side=Va,C.needsUpdate=!0,ta(C,Z,ot),C.side=Fa):ta(C,Z,ot)}this.compile=function(C,Z,ot=null){ot===null&&(ot=C),y=zt.get(ot),y.init(Z),U.push(y),ot.traverseVisible(function(Q){Q.isLight&&Q.layers.test(Z.layers)&&(y.pushLight(Q),Q.castShadow&&y.pushShadow(Q))}),C!==ot&&C.traverseVisible(function(Q){Q.isLight&&Q.layers.test(Z.layers)&&(y.pushLight(Q),Q.castShadow&&y.pushShadow(Q))}),y.setupLights();const lt=new Set;return C.traverse(function(Q){if(!(Q.isMesh||Q.isPoints||Q.isLine||Q.isSprite))return;const Tt=Q.material;if(Tt)if(Array.isArray(Tt))for(let Ut=0;Ut<Tt.length;Ut++){const Bt=Tt[Ut];Ce(Bt,ot,Q),lt.add(Bt)}else Ce(Tt,ot,Q),lt.add(Tt)}),y=U.pop(),lt},this.compileAsync=function(C,Z,ot=null){const lt=this.compile(C,Z,ot);return new Promise(Q=>{function Tt(){if(lt.forEach(function(Ut){Gt.get(Ut).currentProgram.isReady()&&lt.delete(Ut)}),lt.size===0){Q(C);return}setTimeout(Tt,10)}re.get("KHR_parallel_shader_compile")!==null?Tt():setTimeout(Tt,10)})};let be=null;function Gi(C){be&&be(C)}function gn(){en.stop()}function vn(){en.start()}const en=new Xy;en.setAnimationLoop(Gi),typeof self<"u"&&en.setContext(self),this.setAnimationLoop=function(C){be=C,bt.setAnimationLoop(C),C===null?en.stop():en.start()},bt.addEventListener("sessionstart",gn),bt.addEventListener("sessionend",vn),this.render=function(C,Z){if(Z!==void 0&&Z.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(D===!0)return;if(C.matrixWorldAutoUpdate===!0&&C.updateMatrixWorld(),Z.parent===null&&Z.matrixWorldAutoUpdate===!0&&Z.updateMatrixWorld(),bt.enabled===!0&&bt.isPresenting===!0&&(bt.cameraAutoUpdate===!0&&bt.updateCamera(Z),Z=bt.getCamera()),C.isScene===!0&&C.onBeforeRender(A,C,Z,F),y=zt.get(C,U.length),y.init(Z),U.push(y),_t.multiplyMatrices(Z.projectionMatrix,Z.matrixWorldInverse),Et.setFromProjectionMatrix(_t,ca,Z.reversedDepth),$=this.localClippingEnabled,Rt=wt.init(this.clippingPlanes,$),S=ct.get(C,L.length),S.init(),L.push(S),bt.enabled===!0&&bt.isPresenting===!0){const Tt=A.xr.getDepthSensingMesh();Tt!==null&&$i(Tt,Z,-1/0,A.sortObjects)}$i(C,Z,0,A.sortObjects),S.finish(),A.sortObjects===!0&&S.sort(yt,O),le=bt.enabled===!1||bt.isPresenting===!1||bt.hasDepthSensing()===!1,le&&qt.addToRenderList(S,C),this.info.render.frame++,Rt===!0&&wt.beginShadows();const ot=y.state.shadowsArray;Xt.render(ot,C,Z),Rt===!0&&wt.endShadows(),this.info.autoReset===!0&&this.info.reset();const lt=S.opaque,Q=S.transmissive;if(y.setupLights(),Z.isArrayCamera){const Tt=Z.cameras;if(Q.length>0)for(let Ut=0,Bt=Tt.length;Ut<Bt;Ut++){const Ot=Tt[Ut];xu(lt,Q,C,Ot)}le&&qt.render(C);for(let Ut=0,Bt=Tt.length;Ut<Bt;Ut++){const Ot=Tt[Ut];Ss(S,C,Ot,Ot.viewport)}}else Q.length>0&&xu(lt,Q,C,Z),le&&qt.render(C),Ss(S,C,Z);F!==null&&z===0&&(se.updateMultisampleRenderTarget(F),se.updateRenderTargetMipmap(F)),C.isScene===!0&&C.onAfterRender(A,C,Z),Dt.resetDefaultState(),b=-1,N=null,U.pop(),U.length>0?(y=U[U.length-1],Rt===!0&&wt.setGlobalState(A.clippingPlanes,y.state.camera)):y=null,L.pop(),L.length>0?S=L[L.length-1]:S=null};function $i(C,Z,ot,lt){if(C.visible===!1)return;if(C.layers.test(Z.layers)){if(C.isGroup)ot=C.renderOrder;else if(C.isLOD)C.autoUpdate===!0&&C.update(Z);else if(C.isLight)y.pushLight(C),C.castShadow&&y.pushShadow(C);else if(C.isSprite){if(!C.frustumCulled||Et.intersectsSprite(C)){lt&&Zt.setFromMatrixPosition(C.matrixWorld).applyMatrix4(_t);const Ut=nt.update(C),Bt=C.material;Bt.visible&&S.push(C,Ut,Bt,ot,Zt.z,null)}}else if((C.isMesh||C.isLine||C.isPoints)&&(!C.frustumCulled||Et.intersectsObject(C))){const Ut=nt.update(C),Bt=C.material;if(lt&&(C.boundingSphere!==void 0?(C.boundingSphere===null&&C.computeBoundingSphere(),Zt.copy(C.boundingSphere.center)):(Ut.boundingSphere===null&&Ut.computeBoundingSphere(),Zt.copy(Ut.boundingSphere.center)),Zt.applyMatrix4(C.matrixWorld).applyMatrix4(_t)),Array.isArray(Bt)){const Ot=Ut.groups;for(let Jt=0,te=Ot.length;Jt<te;Jt++){const Wt=Ot[Jt],he=Bt[Wt.materialIndex];he&&he.visible&&S.push(C,Ut,he,ot,Zt.z,Wt)}}else Bt.visible&&S.push(C,Ut,Bt,ot,Zt.z,null)}}const Tt=C.children;for(let Ut=0,Bt=Tt.length;Ut<Bt;Ut++)$i(Tt[Ut],Z,ot,lt)}function Ss(C,Z,ot,lt){const Q=C.opaque,Tt=C.transmissive,Ut=C.transparent;y.setupLightsView(ot),Rt===!0&&wt.setGlobalState(A.clippingPlanes,ot),lt&&Pt.viewport(G.copy(lt)),Q.length>0&&Ms(Q,Z,ot),Tt.length>0&&Ms(Tt,Z,ot),Ut.length>0&&Ms(Ut,Z,ot),Pt.buffers.depth.setTest(!0),Pt.buffers.depth.setMask(!0),Pt.buffers.color.setMask(!0),Pt.setPolygonOffset(!1)}function xu(C,Z,ot,lt){if((ot.isScene===!0?ot.overrideMaterial:null)!==null)return;y.state.transmissionRenderTarget[lt.id]===void 0&&(y.state.transmissionRenderTarget[lt.id]=new gs(1,1,{generateMipmaps:!0,type:re.has("EXT_color_buffer_half_float")||re.has("EXT_color_buffer_float")?pu:ha,minFilter:cs,samples:4,stencilBuffer:l,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ye.workingColorSpace}));const Tt=y.state.transmissionRenderTarget[lt.id],Ut=lt.viewport||G;Tt.setSize(Ut.z*A.transmissionResolutionScale,Ut.w*A.transmissionResolutionScale);const Bt=A.getRenderTarget(),Ot=A.getActiveCubeFace(),Jt=A.getActiveMipmapLevel();A.setRenderTarget(Tt),A.getClearColor(ft),rt=A.getClearAlpha(),rt<1&&A.setClearColor(16777215,.5),A.clear(),le&&qt.render(ot);const te=A.toneMapping;A.toneMapping=Rr;const Wt=lt.viewport;if(lt.viewport!==void 0&&(lt.viewport=void 0),y.setupLightsView(lt),Rt===!0&&wt.setGlobalState(A.clippingPlanes,lt),Ms(C,ot,lt),se.updateMultisampleRenderTarget(Tt),se.updateRenderTargetMipmap(Tt),re.has("WEBGL_multisampled_render_to_texture")===!1){let he=!1;for(let Ae=0,qe=Z.length;Ae<qe;Ae++){const Oe=Z[Ae],de=Oe.object,Qt=Oe.geometry,We=Oe.material,ge=Oe.group;if(We.side===Fa&&de.layers.test(lt.layers)){const zn=We.side;We.side=ii,We.needsUpdate=!0,Xo(de,ot,lt,Qt,We,ge),We.side=zn,We.needsUpdate=!0,he=!0}}he===!0&&(se.updateMultisampleRenderTarget(Tt),se.updateRenderTargetMipmap(Tt))}A.setRenderTarget(Bt,Ot,Jt),A.setClearColor(ft,rt),Wt!==void 0&&(lt.viewport=Wt),A.toneMapping=te}function Ms(C,Z,ot){const lt=Z.isScene===!0?Z.overrideMaterial:null;for(let Q=0,Tt=C.length;Q<Tt;Q++){const Ut=C[Q],Bt=Ut.object,Ot=Ut.geometry,Jt=Ut.group;let te=Ut.material;te.allowOverride===!0&&lt!==null&&(te=lt),Bt.layers.test(ot.layers)&&Xo(Bt,Z,ot,Ot,te,Jt)}}function Xo(C,Z,ot,lt,Q,Tt){C.onBeforeRender(A,Z,ot,lt,Q,Tt),C.modelViewMatrix.multiplyMatrices(ot.matrixWorldInverse,C.matrixWorld),C.normalMatrix.getNormalMatrix(C.modelViewMatrix),Q.onBeforeRender(A,Z,ot,lt,C,Tt),Q.transparent===!0&&Q.side===Fa&&Q.forceSinglePass===!1?(Q.side=ii,Q.needsUpdate=!0,A.renderBufferDirect(ot,Z,lt,Q,C,Tt),Q.side=Va,Q.needsUpdate=!0,A.renderBufferDirect(ot,Z,lt,Q,C,Tt),Q.side=Fa):A.renderBufferDirect(ot,Z,lt,Q,C,Tt),C.onAfterRender(A,Z,ot,lt,Q,Tt)}function ta(C,Z,ot){Z.isScene!==!0&&(Z=kt);const lt=Gt.get(C),Q=y.state.lights,Tt=y.state.shadowsArray,Ut=Q.state.version,Bt=dt.getParameters(C,Q.state,Tt,Z,ot),Ot=dt.getProgramCacheKey(Bt);let Jt=lt.programs;lt.environment=C.isMeshStandardMaterial?Z.environment:null,lt.fog=Z.fog,lt.envMap=(C.isMeshStandardMaterial?Ke:Ze).get(C.envMap||lt.environment),lt.envMapRotation=lt.environment!==null&&C.envMap===null?Z.environmentRotation:C.envMapRotation,Jt===void 0&&(C.addEventListener("dispose",xt),Jt=new Map,lt.programs=Jt);let te=Jt.get(Ot);if(te!==void 0){if(lt.currentProgram===te&&lt.lightsStateVersion===Ut)return ma(C,Bt),te}else Bt.uniforms=dt.getUniforms(C),C.onBeforeCompile(Bt,A),te=dt.acquireProgram(Bt,Ot),Jt.set(Ot,te),lt.uniforms=Bt.uniforms;const Wt=lt.uniforms;return(!C.isShaderMaterial&&!C.isRawShaderMaterial||C.clipping===!0)&&(Wt.clippingPlanes=wt.uniform),ma(C,Bt),lt.needsLights=Ya(C),lt.lightsStateVersion=Ut,lt.needsLights&&(Wt.ambientLightColor.value=Q.state.ambient,Wt.lightProbe.value=Q.state.probe,Wt.directionalLights.value=Q.state.directional,Wt.directionalLightShadows.value=Q.state.directionalShadow,Wt.spotLights.value=Q.state.spot,Wt.spotLightShadows.value=Q.state.spotShadow,Wt.rectAreaLights.value=Q.state.rectArea,Wt.ltc_1.value=Q.state.rectAreaLTC1,Wt.ltc_2.value=Q.state.rectAreaLTC2,Wt.pointLights.value=Q.state.point,Wt.pointLightShadows.value=Q.state.pointShadow,Wt.hemisphereLights.value=Q.state.hemi,Wt.directionalShadowMap.value=Q.state.directionalShadowMap,Wt.directionalShadowMatrix.value=Q.state.directionalShadowMatrix,Wt.spotShadowMap.value=Q.state.spotShadowMap,Wt.spotLightMatrix.value=Q.state.spotLightMatrix,Wt.spotLightMap.value=Q.state.spotLightMap,Wt.pointShadowMap.value=Q.state.pointShadowMap,Wt.pointShadowMatrix.value=Q.state.pointShadowMatrix),lt.currentProgram=te,lt.uniformsList=null,te}function Es(C){if(C.uniformsList===null){const Z=C.currentProgram.getUniforms();C.uniformsList=of.seqWithValue(Z.seq,C.uniforms)}return C.uniformsList}function ma(C,Z){const ot=Gt.get(C);ot.outputColorSpace=Z.outputColorSpace,ot.batching=Z.batching,ot.batchingColor=Z.batchingColor,ot.instancing=Z.instancing,ot.instancingColor=Z.instancingColor,ot.instancingMorph=Z.instancingMorph,ot.skinning=Z.skinning,ot.morphTargets=Z.morphTargets,ot.morphNormals=Z.morphNormals,ot.morphColors=Z.morphColors,ot.morphTargetsCount=Z.morphTargetsCount,ot.numClippingPlanes=Z.numClippingPlanes,ot.numIntersection=Z.numClipIntersection,ot.vertexAlphas=Z.vertexAlphas,ot.vertexTangents=Z.vertexTangents,ot.toneMapping=Z.toneMapping}function qa(C,Z,ot,lt,Q){Z.isScene!==!0&&(Z=kt),se.resetTextureUnits();const Tt=Z.fog,Ut=lt.isMeshStandardMaterial?Z.environment:null,Bt=F===null?A.outputColorSpace:F.isXRRenderTarget===!0?F.texture.colorSpace:Lo,Ot=(lt.isMeshStandardMaterial?Ke:Ze).get(lt.envMap||Ut),Jt=lt.vertexColors===!0&&!!ot.attributes.color&&ot.attributes.color.itemSize===4,te=!!ot.attributes.tangent&&(!!lt.normalMap||lt.anisotropy>0),Wt=!!ot.morphAttributes.position,he=!!ot.morphAttributes.normal,Ae=!!ot.morphAttributes.color;let qe=Rr;lt.toneMapped&&(F===null||F.isXRRenderTarget===!0)&&(qe=A.toneMapping);const Oe=ot.morphAttributes.position||ot.morphAttributes.normal||ot.morphAttributes.color,de=Oe!==void 0?Oe.length:0,Qt=Gt.get(lt),We=y.state.lights;if(Rt===!0&&($===!0||C!==N)){const nn=C===N&&lt.id===b;wt.setState(lt,C,nn)}let ge=!1;lt.version===Qt.__version?(Qt.needsLights&&Qt.lightsStateVersion!==We.state.version||Qt.outputColorSpace!==Bt||Q.isBatchedMesh&&Qt.batching===!1||!Q.isBatchedMesh&&Qt.batching===!0||Q.isBatchedMesh&&Qt.batchingColor===!0&&Q.colorTexture===null||Q.isBatchedMesh&&Qt.batchingColor===!1&&Q.colorTexture!==null||Q.isInstancedMesh&&Qt.instancing===!1||!Q.isInstancedMesh&&Qt.instancing===!0||Q.isSkinnedMesh&&Qt.skinning===!1||!Q.isSkinnedMesh&&Qt.skinning===!0||Q.isInstancedMesh&&Qt.instancingColor===!0&&Q.instanceColor===null||Q.isInstancedMesh&&Qt.instancingColor===!1&&Q.instanceColor!==null||Q.isInstancedMesh&&Qt.instancingMorph===!0&&Q.morphTexture===null||Q.isInstancedMesh&&Qt.instancingMorph===!1&&Q.morphTexture!==null||Qt.envMap!==Ot||lt.fog===!0&&Qt.fog!==Tt||Qt.numClippingPlanes!==void 0&&(Qt.numClippingPlanes!==wt.numPlanes||Qt.numIntersection!==wt.numIntersection)||Qt.vertexAlphas!==Jt||Qt.vertexTangents!==te||Qt.morphTargets!==Wt||Qt.morphNormals!==he||Qt.morphColors!==Ae||Qt.toneMapping!==qe||Qt.morphTargetsCount!==de)&&(ge=!0):(ge=!0,Qt.__version=lt.version);let zn=Qt.currentProgram;ge===!0&&(zn=ta(lt,Z,Q));let Vi=!1,Xn=!1,En=!1;const Be=zn.getUniforms(),Wn=Qt.uniforms;if(Pt.useProgram(zn.program)&&(Vi=!0,Xn=!0,En=!0),lt.id!==b&&(b=lt.id,Xn=!0),Vi||N!==C){Pt.buffers.depth.getReversed()&&C.reversedDepth!==!0&&(C._reversedDepth=!0,C.updateProjectionMatrix()),Be.setValue(V,"projectionMatrix",C.projectionMatrix),Be.setValue(V,"viewMatrix",C.matrixWorldInverse);const Dn=Be.map.cameraPosition;Dn!==void 0&&Dn.setValue(V,At.setFromMatrixPosition(C.matrixWorld)),ne.logarithmicDepthBuffer&&Be.setValue(V,"logDepthBufFC",2/(Math.log(C.far+1)/Math.LN2)),(lt.isMeshPhongMaterial||lt.isMeshToonMaterial||lt.isMeshLambertMaterial||lt.isMeshBasicMaterial||lt.isMeshStandardMaterial||lt.isShaderMaterial)&&Be.setValue(V,"isOrthographic",C.isOrthographicCamera===!0),N!==C&&(N=C,Xn=!0,En=!0)}if(Q.isSkinnedMesh){Be.setOptional(V,Q,"bindMatrix"),Be.setOptional(V,Q,"bindMatrixInverse");const nn=Q.skeleton;nn&&(nn.boneTexture===null&&nn.computeBoneTexture(),Be.setValue(V,"boneTexture",nn.boneTexture,se))}Q.isBatchedMesh&&(Be.setOptional(V,Q,"batchingTexture"),Be.setValue(V,"batchingTexture",Q._matricesTexture,se),Be.setOptional(V,Q,"batchingIdTexture"),Be.setValue(V,"batchingIdTexture",Q._indirectTexture,se),Be.setOptional(V,Q,"batchingColorTexture"),Q._colorsTexture!==null&&Be.setValue(V,"batchingColorTexture",Q._colorsTexture,se));const In=ot.morphAttributes;if((In.position!==void 0||In.normal!==void 0||In.color!==void 0)&&St.update(Q,ot,zn),(Xn||Qt.receiveShadow!==Q.receiveShadow)&&(Qt.receiveShadow=Q.receiveShadow,Be.setValue(V,"receiveShadow",Q.receiveShadow)),lt.isMeshGouraudMaterial&&lt.envMap!==null&&(Wn.envMap.value=Ot,Wn.flipEnvMap.value=Ot.isCubeTexture&&Ot.isRenderTargetTexture===!1?-1:1),lt.isMeshStandardMaterial&&lt.envMap===null&&Z.environment!==null&&(Wn.envMapIntensity.value=Z.environmentIntensity),Xn&&(Be.setValue(V,"toneMappingExposure",A.toneMappingExposure),Qt.needsLights&&Or(Wn,En),Tt&&lt.fog===!0&&gt.refreshFogUniforms(Wn,Tt),gt.refreshMaterialUniforms(Wn,lt,q,W,y.state.transmissionRenderTarget[C.id]),of.upload(V,Es(Qt),Wn,se)),lt.isShaderMaterial&&lt.uniformsNeedUpdate===!0&&(of.upload(V,Es(Qt),Wn,se),lt.uniformsNeedUpdate=!1),lt.isSpriteMaterial&&Be.setValue(V,"center",Q.center),Be.setValue(V,"modelViewMatrix",Q.modelViewMatrix),Be.setValue(V,"normalMatrix",Q.normalMatrix),Be.setValue(V,"modelMatrix",Q.matrixWorld),lt.isShaderMaterial||lt.isRawShaderMaterial){const nn=lt.uniformsGroups;for(let Dn=0,Ts=nn.length;Dn<Ts;Dn++){const Qn=nn[Dn];oe.update(Qn,zn),oe.bind(Qn,zn)}}return zn}function Or(C,Z){C.ambientLightColor.needsUpdate=Z,C.lightProbe.needsUpdate=Z,C.directionalLights.needsUpdate=Z,C.directionalLightShadows.needsUpdate=Z,C.pointLights.needsUpdate=Z,C.pointLightShadows.needsUpdate=Z,C.spotLights.needsUpdate=Z,C.spotLightShadows.needsUpdate=Z,C.rectAreaLights.needsUpdate=Z,C.hemisphereLights.needsUpdate=Z}function Ya(C){return C.isMeshLambertMaterial||C.isMeshToonMaterial||C.isMeshPhongMaterial||C.isMeshStandardMaterial||C.isShadowMaterial||C.isShaderMaterial&&C.lights===!0}this.getActiveCubeFace=function(){return P},this.getActiveMipmapLevel=function(){return z},this.getRenderTarget=function(){return F},this.setRenderTargetTextures=function(C,Z,ot){const lt=Gt.get(C);lt.__autoAllocateDepthBuffer=C.resolveDepthBuffer===!1,lt.__autoAllocateDepthBuffer===!1&&(lt.__useRenderToTexture=!1),Gt.get(C.texture).__webglTexture=Z,Gt.get(C.depthTexture).__webglTexture=lt.__autoAllocateDepthBuffer?void 0:ot,lt.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(C,Z){const ot=Gt.get(C);ot.__webglFramebuffer=Z,ot.__useDefaultFramebuffer=Z===void 0};const fn=V.createFramebuffer();this.setRenderTarget=function(C,Z=0,ot=0){F=C,P=Z,z=ot;let lt=!0,Q=null,Tt=!1,Ut=!1;if(C){const Ot=Gt.get(C);if(Ot.__useDefaultFramebuffer!==void 0)Pt.bindFramebuffer(V.FRAMEBUFFER,null),lt=!1;else if(Ot.__webglFramebuffer===void 0)se.setupRenderTarget(C);else if(Ot.__hasExternalTextures)se.rebindTextures(C,Gt.get(C.texture).__webglTexture,Gt.get(C.depthTexture).__webglTexture);else if(C.depthBuffer){const Wt=C.depthTexture;if(Ot.__boundDepthTexture!==Wt){if(Wt!==null&&Gt.has(Wt)&&(C.width!==Wt.image.width||C.height!==Wt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");se.setupDepthRenderbuffer(C)}}const Jt=C.texture;(Jt.isData3DTexture||Jt.isDataArrayTexture||Jt.isCompressedArrayTexture)&&(Ut=!0);const te=Gt.get(C).__webglFramebuffer;C.isWebGLCubeRenderTarget?(Array.isArray(te[Z])?Q=te[Z][ot]:Q=te[Z],Tt=!0):C.samples>0&&se.useMultisampledRTT(C)===!1?Q=Gt.get(C).__webglMultisampledFramebuffer:Array.isArray(te)?Q=te[ot]:Q=te,G.copy(C.viewport),j.copy(C.scissor),et=C.scissorTest}else G.copy(Y).multiplyScalar(q).floor(),j.copy(ht).multiplyScalar(q).floor(),et=ut;if(ot!==0&&(Q=fn),Pt.bindFramebuffer(V.FRAMEBUFFER,Q)&&lt&&Pt.drawBuffers(C,Q),Pt.viewport(G),Pt.scissor(j),Pt.setScissorTest(et),Tt){const Ot=Gt.get(C.texture);V.framebufferTexture2D(V.FRAMEBUFFER,V.COLOR_ATTACHMENT0,V.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Ot.__webglTexture,ot)}else if(Ut){const Ot=Z;for(let Jt=0;Jt<C.textures.length;Jt++){const te=Gt.get(C.textures[Jt]);V.framebufferTextureLayer(V.FRAMEBUFFER,V.COLOR_ATTACHMENT0+Jt,te.__webglTexture,ot,Ot)}}else if(C!==null&&ot!==0){const Ot=Gt.get(C.texture);V.framebufferTexture2D(V.FRAMEBUFFER,V.COLOR_ATTACHMENT0,V.TEXTURE_2D,Ot.__webglTexture,ot)}b=-1},this.readRenderTargetPixels=function(C,Z,ot,lt,Q,Tt,Ut,Bt=0){if(!(C&&C.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ot=Gt.get(C).__webglFramebuffer;if(C.isWebGLCubeRenderTarget&&Ut!==void 0&&(Ot=Ot[Ut]),Ot){Pt.bindFramebuffer(V.FRAMEBUFFER,Ot);try{const Jt=C.textures[Bt],te=Jt.format,Wt=Jt.type;if(!ne.textureFormatReadable(te)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ne.textureTypeReadable(Wt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}Z>=0&&Z<=C.width-lt&&ot>=0&&ot<=C.height-Q&&(C.textures.length>1&&V.readBuffer(V.COLOR_ATTACHMENT0+Bt),V.readPixels(Z,ot,lt,Q,Vt.convert(te),Vt.convert(Wt),Tt))}finally{const Jt=F!==null?Gt.get(F).__webglFramebuffer:null;Pt.bindFramebuffer(V.FRAMEBUFFER,Jt)}}},this.readRenderTargetPixelsAsync=async function(C,Z,ot,lt,Q,Tt,Ut,Bt=0){if(!(C&&C.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ot=Gt.get(C).__webglFramebuffer;if(C.isWebGLCubeRenderTarget&&Ut!==void 0&&(Ot=Ot[Ut]),Ot)if(Z>=0&&Z<=C.width-lt&&ot>=0&&ot<=C.height-Q){Pt.bindFramebuffer(V.FRAMEBUFFER,Ot);const Jt=C.textures[Bt],te=Jt.format,Wt=Jt.type;if(!ne.textureFormatReadable(te))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ne.textureTypeReadable(Wt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const he=V.createBuffer();V.bindBuffer(V.PIXEL_PACK_BUFFER,he),V.bufferData(V.PIXEL_PACK_BUFFER,Tt.byteLength,V.STREAM_READ),C.textures.length>1&&V.readBuffer(V.COLOR_ATTACHMENT0+Bt),V.readPixels(Z,ot,lt,Q,Vt.convert(te),Vt.convert(Wt),0);const Ae=F!==null?Gt.get(F).__webglFramebuffer:null;Pt.bindFramebuffer(V.FRAMEBUFFER,Ae);const qe=V.fenceSync(V.SYNC_GPU_COMMANDS_COMPLETE,0);return V.flush(),await KT(V,qe,4),V.bindBuffer(V.PIXEL_PACK_BUFFER,he),V.getBufferSubData(V.PIXEL_PACK_BUFFER,0,Tt),V.deleteBuffer(he),V.deleteSync(qe),Tt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(C,Z=null,ot=0){const lt=Math.pow(2,-ot),Q=Math.floor(C.image.width*lt),Tt=Math.floor(C.image.height*lt),Ut=Z!==null?Z.x:0,Bt=Z!==null?Z.y:0;se.setTexture2D(C,0),V.copyTexSubImage2D(V.TEXTURE_2D,ot,0,0,Ut,Bt,Q,Tt),Pt.unbindTexture()};const yu=V.createFramebuffer(),Su=V.createFramebuffer();this.copyTextureToTexture=function(C,Z,ot=null,lt=null,Q=0,Tt=null){Tt===null&&(Q!==0?(su("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Tt=Q,Q=0):Tt=0);let Ut,Bt,Ot,Jt,te,Wt,he,Ae,qe;const Oe=C.isCompressedTexture?C.mipmaps[Tt]:C.image;if(ot!==null)Ut=ot.max.x-ot.min.x,Bt=ot.max.y-ot.min.y,Ot=ot.isBox3?ot.max.z-ot.min.z:1,Jt=ot.min.x,te=ot.min.y,Wt=ot.isBox3?ot.min.z:0;else{const In=Math.pow(2,-Q);Ut=Math.floor(Oe.width*In),Bt=Math.floor(Oe.height*In),C.isDataArrayTexture?Ot=Oe.depth:C.isData3DTexture?Ot=Math.floor(Oe.depth*In):Ot=1,Jt=0,te=0,Wt=0}lt!==null?(he=lt.x,Ae=lt.y,qe=lt.z):(he=0,Ae=0,qe=0);const de=Vt.convert(Z.format),Qt=Vt.convert(Z.type);let We;Z.isData3DTexture?(se.setTexture3D(Z,0),We=V.TEXTURE_3D):Z.isDataArrayTexture||Z.isCompressedArrayTexture?(se.setTexture2DArray(Z,0),We=V.TEXTURE_2D_ARRAY):(se.setTexture2D(Z,0),We=V.TEXTURE_2D),V.pixelStorei(V.UNPACK_FLIP_Y_WEBGL,Z.flipY),V.pixelStorei(V.UNPACK_PREMULTIPLY_ALPHA_WEBGL,Z.premultiplyAlpha),V.pixelStorei(V.UNPACK_ALIGNMENT,Z.unpackAlignment);const ge=V.getParameter(V.UNPACK_ROW_LENGTH),zn=V.getParameter(V.UNPACK_IMAGE_HEIGHT),Vi=V.getParameter(V.UNPACK_SKIP_PIXELS),Xn=V.getParameter(V.UNPACK_SKIP_ROWS),En=V.getParameter(V.UNPACK_SKIP_IMAGES);V.pixelStorei(V.UNPACK_ROW_LENGTH,Oe.width),V.pixelStorei(V.UNPACK_IMAGE_HEIGHT,Oe.height),V.pixelStorei(V.UNPACK_SKIP_PIXELS,Jt),V.pixelStorei(V.UNPACK_SKIP_ROWS,te),V.pixelStorei(V.UNPACK_SKIP_IMAGES,Wt);const Be=C.isDataArrayTexture||C.isData3DTexture,Wn=Z.isDataArrayTexture||Z.isData3DTexture;if(C.isDepthTexture){const In=Gt.get(C),nn=Gt.get(Z),Dn=Gt.get(In.__renderTarget),Ts=Gt.get(nn.__renderTarget);Pt.bindFramebuffer(V.READ_FRAMEBUFFER,Dn.__webglFramebuffer),Pt.bindFramebuffer(V.DRAW_FRAMEBUFFER,Ts.__webglFramebuffer);for(let Qn=0;Qn<Ot;Qn++)Be&&(V.framebufferTextureLayer(V.READ_FRAMEBUFFER,V.COLOR_ATTACHMENT0,Gt.get(C).__webglTexture,Q,Wt+Qn),V.framebufferTextureLayer(V.DRAW_FRAMEBUFFER,V.COLOR_ATTACHMENT0,Gt.get(Z).__webglTexture,Tt,qe+Qn)),V.blitFramebuffer(Jt,te,Ut,Bt,he,Ae,Ut,Bt,V.DEPTH_BUFFER_BIT,V.NEAREST);Pt.bindFramebuffer(V.READ_FRAMEBUFFER,null),Pt.bindFramebuffer(V.DRAW_FRAMEBUFFER,null)}else if(Q!==0||C.isRenderTargetTexture||Gt.has(C)){const In=Gt.get(C),nn=Gt.get(Z);Pt.bindFramebuffer(V.READ_FRAMEBUFFER,yu),Pt.bindFramebuffer(V.DRAW_FRAMEBUFFER,Su);for(let Dn=0;Dn<Ot;Dn++)Be?V.framebufferTextureLayer(V.READ_FRAMEBUFFER,V.COLOR_ATTACHMENT0,In.__webglTexture,Q,Wt+Dn):V.framebufferTexture2D(V.READ_FRAMEBUFFER,V.COLOR_ATTACHMENT0,V.TEXTURE_2D,In.__webglTexture,Q),Wn?V.framebufferTextureLayer(V.DRAW_FRAMEBUFFER,V.COLOR_ATTACHMENT0,nn.__webglTexture,Tt,qe+Dn):V.framebufferTexture2D(V.DRAW_FRAMEBUFFER,V.COLOR_ATTACHMENT0,V.TEXTURE_2D,nn.__webglTexture,Tt),Q!==0?V.blitFramebuffer(Jt,te,Ut,Bt,he,Ae,Ut,Bt,V.COLOR_BUFFER_BIT,V.NEAREST):Wn?V.copyTexSubImage3D(We,Tt,he,Ae,qe+Dn,Jt,te,Ut,Bt):V.copyTexSubImage2D(We,Tt,he,Ae,Jt,te,Ut,Bt);Pt.bindFramebuffer(V.READ_FRAMEBUFFER,null),Pt.bindFramebuffer(V.DRAW_FRAMEBUFFER,null)}else Wn?C.isDataTexture||C.isData3DTexture?V.texSubImage3D(We,Tt,he,Ae,qe,Ut,Bt,Ot,de,Qt,Oe.data):Z.isCompressedArrayTexture?V.compressedTexSubImage3D(We,Tt,he,Ae,qe,Ut,Bt,Ot,de,Oe.data):V.texSubImage3D(We,Tt,he,Ae,qe,Ut,Bt,Ot,de,Qt,Oe):C.isDataTexture?V.texSubImage2D(V.TEXTURE_2D,Tt,he,Ae,Ut,Bt,de,Qt,Oe.data):C.isCompressedTexture?V.compressedTexSubImage2D(V.TEXTURE_2D,Tt,he,Ae,Oe.width,Oe.height,de,Oe.data):V.texSubImage2D(V.TEXTURE_2D,Tt,he,Ae,Ut,Bt,de,Qt,Oe);V.pixelStorei(V.UNPACK_ROW_LENGTH,ge),V.pixelStorei(V.UNPACK_IMAGE_HEIGHT,zn),V.pixelStorei(V.UNPACK_SKIP_PIXELS,Vi),V.pixelStorei(V.UNPACK_SKIP_ROWS,Xn),V.pixelStorei(V.UNPACK_SKIP_IMAGES,En),Tt===0&&Z.generateMipmaps&&V.generateMipmap(We),Pt.unbindTexture()},this.initRenderTarget=function(C){Gt.get(C).__webglFramebuffer===void 0&&se.setupRenderTarget(C)},this.initTexture=function(C){C.isCubeTexture?se.setTextureCube(C,0):C.isData3DTexture?se.setTexture3D(C,0):C.isDataArrayTexture||C.isCompressedArrayTexture?se.setTexture2DArray(C,0):se.setTexture2D(C,0),Pt.unbindTexture()},this.resetState=function(){P=0,z=0,F=null,Pt.reset(),Dt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ca}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=ye._getDrawingBufferColorSpace(t),e.unpackColorSpace=ye._getUnpackColorSpace()}}const SC=/^[og]\s*(.+)?/,MC=/^mtllib /,EC=/^usemtl /,TC=/^usemap /,jx=/\s+/,Zx=new it,gp=new it,Kx=new it,Qx=new it,Pi=new it,$c=new fe;function bC(){const o={objects:[],object:{},vertices:[],normals:[],colors:[],uvs:[],materials:{},materialLibraries:[],startObject:function(t,e){if(this.object&&this.object.fromDeclaration===!1){this.object.name=t,this.object.fromDeclaration=e!==!1;return}const a=this.object&&typeof this.object.currentMaterial=="function"?this.object.currentMaterial():void 0;if(this.object&&typeof this.object._finalize=="function"&&this.object._finalize(!0),this.object={name:t||"",fromDeclaration:e!==!1,geometry:{vertices:[],normals:[],colors:[],uvs:[],hasUVIndices:!1},materials:[],smooth:!0,startMaterial:function(r,l){const c=this._finalize(!1);c&&(c.inherited||c.groupCount<=0)&&this.materials.splice(c.index,1);const f={index:this.materials.length,name:r||"",mtllib:Array.isArray(l)&&l.length>0?l[l.length-1]:"",smooth:c!==void 0?c.smooth:this.smooth,groupStart:c!==void 0?c.groupEnd:0,groupEnd:-1,groupCount:-1,inherited:!1,clone:function(p){const h={index:typeof p=="number"?p:this.index,name:this.name,mtllib:this.mtllib,smooth:this.smooth,groupStart:0,groupEnd:-1,groupCount:-1,inherited:!1};return h.clone=this.clone.bind(h),h}};return this.materials.push(f),f},currentMaterial:function(){if(this.materials.length>0)return this.materials[this.materials.length-1]},_finalize:function(r){const l=this.currentMaterial();if(l&&l.groupEnd===-1&&(l.groupEnd=this.geometry.vertices.length/3,l.groupCount=l.groupEnd-l.groupStart,l.inherited=!1),r&&this.materials.length>1)for(let c=this.materials.length-1;c>=0;c--)this.materials[c].groupCount<=0&&this.materials.splice(c,1);return r&&this.materials.length===0&&this.materials.push({name:"",smooth:this.smooth}),l}},a&&a.name&&typeof a.clone=="function"){const r=a.clone(0);r.inherited=!0,this.object.materials.push(r)}this.objects.push(this.object)},finalize:function(){this.object&&typeof this.object._finalize=="function"&&this.object._finalize(!0)},parseVertexIndex:function(t,e){const a=parseInt(t,10);return(a>=0?a-1:a+e/3)*3},parseNormalIndex:function(t,e){const a=parseInt(t,10);return(a>=0?a-1:a+e/3)*3},parseUVIndex:function(t,e){const a=parseInt(t,10);return(a>=0?a-1:a+e/2)*2},addVertex:function(t,e,a){const r=this.vertices,l=this.object.geometry.vertices;l.push(r[t+0],r[t+1],r[t+2]),l.push(r[e+0],r[e+1],r[e+2]),l.push(r[a+0],r[a+1],r[a+2])},addVertexPoint:function(t){const e=this.vertices;this.object.geometry.vertices.push(e[t+0],e[t+1],e[t+2])},addVertexLine:function(t){const e=this.vertices;this.object.geometry.vertices.push(e[t+0],e[t+1],e[t+2])},addNormal:function(t,e,a){const r=this.normals,l=this.object.geometry.normals;l.push(r[t+0],r[t+1],r[t+2]),l.push(r[e+0],r[e+1],r[e+2]),l.push(r[a+0],r[a+1],r[a+2])},addFaceNormal:function(t,e,a){const r=this.vertices,l=this.object.geometry.normals;Zx.fromArray(r,t),gp.fromArray(r,e),Kx.fromArray(r,a),Pi.subVectors(Kx,gp),Qx.subVectors(Zx,gp),Pi.cross(Qx),Pi.normalize(),l.push(Pi.x,Pi.y,Pi.z),l.push(Pi.x,Pi.y,Pi.z),l.push(Pi.x,Pi.y,Pi.z)},addColor:function(t,e,a){const r=this.colors,l=this.object.geometry.colors;r[t]!==void 0&&l.push(r[t+0],r[t+1],r[t+2]),r[e]!==void 0&&l.push(r[e+0],r[e+1],r[e+2]),r[a]!==void 0&&l.push(r[a+0],r[a+1],r[a+2])},addUV:function(t,e,a){const r=this.uvs,l=this.object.geometry.uvs;l.push(r[t+0],r[t+1]),l.push(r[e+0],r[e+1]),l.push(r[a+0],r[a+1])},addDefaultUV:function(){const t=this.object.geometry.uvs;t.push(0,0),t.push(0,0),t.push(0,0)},addUVLine:function(t){const e=this.uvs;this.object.geometry.uvs.push(e[t+0],e[t+1])},addFace:function(t,e,a,r,l,c,f,p,h){const m=this.vertices.length;let g=this.parseVertexIndex(t,m),v=this.parseVertexIndex(e,m),x=this.parseVertexIndex(a,m);if(this.addVertex(g,v,x),this.addColor(g,v,x),f!==void 0&&f!==""){const E=this.normals.length;g=this.parseNormalIndex(f,E),v=this.parseNormalIndex(p,E),x=this.parseNormalIndex(h,E),this.addNormal(g,v,x)}else this.addFaceNormal(g,v,x);if(r!==void 0&&r!==""){const E=this.uvs.length;g=this.parseUVIndex(r,E),v=this.parseUVIndex(l,E),x=this.parseUVIndex(c,E),this.addUV(g,v,x),this.object.geometry.hasUVIndices=!0}else this.addDefaultUV()},addPointGeometry:function(t){this.object.geometry.type="Points";const e=this.vertices.length;for(let a=0,r=t.length;a<r;a++){const l=this.parseVertexIndex(t[a],e);this.addVertexPoint(l),this.addColor(l)}},addLineGeometry:function(t,e){this.object.geometry.type="Line";const a=this.vertices.length,r=this.uvs.length;for(let l=0,c=t.length;l<c;l++)this.addVertexLine(this.parseVertexIndex(t[l],a));for(let l=0,c=e.length;l<c;l++)this.addUVLine(this.parseUVIndex(e[l],r))}};return o.startObject("",!1),o}class AC extends Vo{constructor(t){super(t),this.materials=null}load(t,e,a,r){const l=this,c=new Gy(this.manager);c.setPath(this.path),c.setRequestHeader(this.requestHeader),c.setWithCredentials(this.withCredentials),c.load(t,function(f){try{e(l.parse(f))}catch(p){r?r(p):console.error(p),l.manager.itemError(t)}},a,r)}setMaterials(t){return this.materials=t,this}parse(t){const e=new bC;t.indexOf(`\r
`)!==-1&&(t=t.replace(/\r\n/g,`
`)),t.indexOf(`\\
`)!==-1&&(t=t.replace(/\\\n/g,""));const a=t.split(`
`);let r=[];for(let f=0,p=a.length;f<p;f++){const h=a[f].trimStart();if(h.length===0)continue;const m=h.charAt(0);if(m!=="#")if(m==="v"){const g=h.split(jx);switch(g[0]){case"v":e.vertices.push(parseFloat(g[1]),parseFloat(g[2]),parseFloat(g[3])),g.length>=7?($c.setRGB(parseFloat(g[4]),parseFloat(g[5]),parseFloat(g[6]),Nn),e.colors.push($c.r,$c.g,$c.b)):e.colors.push(void 0,void 0,void 0);break;case"vn":e.normals.push(parseFloat(g[1]),parseFloat(g[2]),parseFloat(g[3]));break;case"vt":e.uvs.push(parseFloat(g[1]),parseFloat(g[2]));break}}else if(m==="f"){const v=h.slice(1).trim().split(jx),x=[];for(let M=0,S=v.length;M<S;M++){const y=v[M];if(y.length>0){const L=y.split("/");x.push(L)}}const E=x[0];for(let M=1,S=x.length-1;M<S;M++){const y=x[M],L=x[M+1];e.addFace(E[0],y[0],L[0],E[1],y[1],L[1],E[2],y[2],L[2])}}else if(m==="l"){const g=h.substring(1).trim().split(" ");let v=[];const x=[];if(h.indexOf("/")===-1)v=g;else for(let E=0,M=g.length;E<M;E++){const S=g[E].split("/");S[0]!==""&&v.push(S[0]),S[1]!==""&&x.push(S[1])}e.addLineGeometry(v,x)}else if(m==="p"){const v=h.slice(1).trim().split(" ");e.addPointGeometry(v)}else if((r=SC.exec(h))!==null){const g=(" "+r[0].slice(1).trim()).slice(1);e.startObject(g)}else if(EC.test(h))e.object.startMaterial(h.substring(7).trim(),e.materialLibraries);else if(MC.test(h))e.materialLibraries.push(h.substring(7).trim());else if(TC.test(h))console.warn('THREE.OBJLoader: Rendering identifier "usemap" not supported. Textures must be defined in MTL files.');else if(m==="s"){if(r=h.split(" "),r.length>1){const v=r[1].trim().toLowerCase();e.object.smooth=v!=="0"&&v!=="off"}else e.object.smooth=!0;const g=e.object.currentMaterial();g&&(g.smooth=e.object.smooth)}else{if(h==="\0")continue;console.warn('THREE.OBJLoader: Unexpected line: "'+h+'"')}}e.finalize();const l=new xo;if(l.materialLibraries=[].concat(e.materialLibraries),!(e.objects.length===1&&e.objects[0].geometry.vertices.length===0)===!0)for(let f=0,p=e.objects.length;f<p;f++){const h=e.objects[f],m=h.geometry,g=h.materials,v=m.type==="Line",x=m.type==="Points";let E=!1;if(m.vertices.length===0)continue;const M=new Ti;M.setAttribute("position",new jn(m.vertices,3)),m.normals.length>0&&M.setAttribute("normal",new jn(m.normals,3)),m.colors.length>0&&(E=!0,M.setAttribute("color",new jn(m.colors,3))),m.hasUVIndices===!0&&M.setAttribute("uv",new jn(m.uvs,2));const S=[];for(let L=0,U=g.length;L<U;L++){const A=g[L],D=A.name+"_"+A.smooth+"_"+E;let P=e.materials[D];if(this.materials!==null){if(P=this.materials.create(A.name),v&&P&&!(P instanceof sf)){const z=new sf;da.prototype.copy.call(z,P),z.color.copy(P.color),P=z}else if(x&&P&&!(P instanceof yo)){const z=new yo({size:10,sizeAttenuation:!1});da.prototype.copy.call(z,P),z.color.copy(P.color),z.map=P.map,P=z}}P===void 0&&(v?P=new sf:x?P=new yo({size:1,sizeAttenuation:!1}):P=new By,P.name=A.name,P.flatShading=!A.smooth,P.vertexColors=E,e.materials[D]=P),S.push(P)}let y;if(S.length>1){for(let L=0,U=g.length;L<U;L++){const A=g[L];M.addGroup(A.groupStart,A.groupCount,L)}v?y=new gx(M,S):x?y=new Zl(M,S):y=new yi(M,S)}else v?y=new gx(M,S[0]):x?y=new Zl(M,S[0]):y=new yi(M,S[0]);y.name=h.name,l.add(y)}else if(e.vertices.length>0){const f=new yo({size:1,sizeAttenuation:!1}),p=new Ti;p.setAttribute("position",new jn(e.vertices,3)),e.colors.length>0&&e.colors[0]!==void 0&&(p.setAttribute("color",new jn(e.colors,3)),f.vertexColors=!0);const h=new Zl(p,f);l.add(h)}return l}}class RC extends Vo{constructor(t){super(t)}load(t,e,a,r){const l=this,c=this.path===""?Pb.extractUrlBase(t):this.path,f=new Gy(this.manager);f.setPath(this.path),f.setRequestHeader(this.requestHeader),f.setWithCredentials(this.withCredentials),f.load(t,function(p){try{e(l.parse(p,c))}catch(h){r?r(h):console.error(h),l.manager.itemError(t)}},a,r)}setMaterialOptions(t){return this.materialOptions=t,this}parse(t,e){const a=t.split(`
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var ry,Tr,Ro,a_,fs,sy,r_,S2=function(){return typeof window<"u"},Wa={},ss=180/Math.PI,wo=Math.PI/180,vo=Math.atan2,oy=1e8,s_=/([A-Z])/g,M2=/(left|right|width|margin|padding|x)/i,E2=/[\s,\(]\S/,fa={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},Am=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},T2=function(t,e){return e.set(e.t,e.p,t===1?e.e:Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},b2=function(t,e){return e.set(e.t,e.p,t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},A2=function(t,e){var a=e.s+e.c*t;e.set(e.t,e.p,~~(a+(a<0?-.5:.5))+e.u,e)},IS=function(t,e){return e.set(e.t,e.p,t?e.e:e.b,e)},BS=function(t,e){return e.set(e.t,e.p,t!==1?e.b:e.e,e)},R2=function(t,e,a){return t.style[e]=a},w2=function(t,e,a){return t.style.setProperty(e,a)},C2=function(t,e,a){return t._gsap[e]=a},D2=function(t,e,a){return t._gsap.scaleX=t._gsap.scaleY=a},U2=function(t,e,a,r,l){var c=t._gsap;c.scaleX=c.scaleY=a,c.renderTransform(l,c)},L2=function(t,e,a,r,l){var c=t._gsap;c[e]=a,c.renderTransform(l,c)},$e="transform",oi=$e+"Origin",O2=function o(t,e){var a=this,r=this.target,l=r.style,c=r._gsap;if(t in Wa&&l){if(this.tfm=this.tfm||{},t!=="transform")t=fa[t]||t,~t.indexOf(",")?t.split(",").forEach(function(f){return a.tfm[f]=Ba(r,f)}):this.tfm[t]=c.x?c[t]:Ba(r,t),t===oi&&(this.tfm.zOrigin=c.zOrigin);else return fa.transform.split(",").forEach(function(f){return o.call(a,f,e)});if(this.props.indexOf($e)>=0)return;c.svg&&(this.svgo=r.getAttribute("data-svg-origin"),this.props.push(oi,e,"")),t=$e}(l||e)&&this.props.push(t,e,l[t])},FS=function(t){t.translate&&(t.removeProperty("translate"),t.removeProperty("scale"),t.removeProperty("rotate"))},N2=function(){var t=this.props,e=this.target,a=e.style,r=e._gsap,l,c;for(l=0;l<t.length;l+=3)t[l+1]?t[l+1]===2?e[t[l]](t[l+2]):e[t[l]]=t[l+2]:t[l+2]?a[t[l]]=t[l+2]:a.removeProperty(t[l].substr(0,2)==="--"?t[l]:t[l].replace(s_,"-$1").toLowerCase());if(this.tfm){for(c in this.tfm)r[c]=this.tfm[c];r.svg&&(r.renderTransform(),e.setAttribute("data-svg-origin",this.svgo||"")),l=r_(),(!l||!l.isStart)&&!a[$e]&&(FS(a),r.zOrigin&&a[oi]&&(a[oi]+=" "+r.zOrigin+"px",r.zOrigin=0,r.renderTransform()),r.uncache=1)}},HS=function(t,e){var a={target:t,props:[],revert:N2,save:O2};return t._gsap||li.core.getCache(t),e&&t.style&&t.nodeType&&e.split(",").forEach(function(r){return a.save(r)}),a},GS,Rm=function(t,e){var a=Tr.createElementNS?Tr.createElementNS((e||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),t):Tr.createElement(t);return a&&a.style?a:Tr.createElement(t)},Hi=function o(t,e,a){var r=getComputedStyle(t);return r[e]||r.getPropertyValue(e.replace(s_,"-$1").toLowerCase())||r.getPropertyValue(e)||!a&&o(t,Fo(e)||e,1)||""},ly="O,Moz,ms,Ms,Webkit".split(","),Fo=function(t,e,a){var r=e||fs,l=r.style,c=5;if(t in l&&!a)return t;for(t=t.charAt(0).toUpperCase()+t.substr(1);c--&&!(ly[c]+t in l););return c<0?null:(c===3?"ms":c>=0?ly[c]:"")+t},wm=function(){S2()&&window.document&&(ry=window,Tr=ry.document,Ro=Tr.documentElement,fs=Rm("div")||{style:{}},Rm("div"),$e=Fo($e),oi=$e+"Origin",fs.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",GS=!!Fo("perspective"),r_=li.core.reverting,a_=1)},uy=function(t){var e=t.ownerSVGElement,a=Rm("svg",e&&e.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),r=t.cloneNode(!0),l;r.style.display="block",a.appendChild(r),Ro.appendChild(a);try{l=r.getBBox()}catch{}return a.removeChild(r),Ro.removeChild(a),l},cy=function(t,e){for(var a=e.length;a--;)if(t.hasAttribute(e[a]))return t.getAttribute(e[a])},VS=function(t){var e,a;try{e=t.getBBox()}catch{e=uy(t),a=1}return e&&(e.width||e.height)||a||(e=uy(t)),e&&!e.width&&!e.x&&!e.y?{x:+cy(t,["x","cx","x1"])||0,y:+cy(t,["y","cy","y1"])||0,width:0,height:0}:e},kS=function(t){return!!(t.getCTM&&(!t.parentNode||t.ownerSVGElement)&&VS(t))},xs=function(t,e){if(e){var a=t.style,r;e in Wa&&e!==oi&&(e=$e),a.removeProperty?(r=e.substr(0,2),(r==="ms"||e.substr(0,6)==="webkit")&&(e="-"+e),a.removeProperty(r==="--"?e:e.replace(s_,"-$1").toLowerCase())):a.removeAttribute(e)}},br=function(t,e,a,r,l,c){var f=new si(t._pt,e,a,0,1,c?BS:IS);return t._pt=f,f.b=r,f.e=l,t._props.push(a),f},fy={deg:1,rad:1,turn:1},P2={grid:1,flex:1},Ur=function o(t,e,a,r){var l=parseFloat(a)||0,c=(a+"").trim().substr((l+"").length)||"px",f=fs.style,p=M2.test(e),h=t.tagName.toLowerCase()==="svg",m=(h?"client":"offset")+(p?"Width":"Height"),g=100,v=r==="px",x=r==="%",E,M,S,y;if(r===c||!l||fy[r]||fy[c])return l;if(c!=="px"&&!v&&(l=o(t,e,a,"px")),y=t.getCTM&&kS(t),(x||c==="%")&&(Wa[e]||~e.indexOf("adius")))return E=y?t.getBBox()[p?"width":"height"]:t[m],cn(x?l/E*g:l/100*E);if(f[p?"width":"height"]=g+(v?c:r),M=r!=="rem"&&~e.indexOf("adius")||r==="em"&&t.appendChild&&!h?t:t.parentNode,y&&(M=(t.ownerSVGElement||{}).parentNode),(!M||M===Tr||!M.appendChild)&&(M=Tr.body),S=M._gsap,S&&x&&S.width&&p&&S.time===xi.time&&!S.uncache)return cn(l/S.width*g);if(x&&(e==="height"||e==="width")){var L=t.style[e];t.style[e]=g+r,E=t[m],L?t.style[e]=L:xs(t,e)}else(x||c==="%")&&!P2[Hi(M,"display")]&&(f.position=Hi(t,"position")),M===t&&(f.position="static"),M.appendChild(fs),E=fs[m],M.removeChild(fs),f.position="absolute";return p&&x&&(S=hs(M),S.time=xi.time,S.width=M[m]),cn(v?E*l/g:E&&l?g/E*l:0)},Ba=function(t,e,a,r){var l;return a_||wm(),e in fa&&e!=="transform"&&(e=fa[e],~e.indexOf(",")&&(e=e.split(",")[0])),Wa[e]&&e!=="transform"?(l=du(t,r),l=e!=="transformOrigin"?l[e]:l.svg?l.origin:Tf(Hi(t,oi))+" "+l.zOrigin+"px"):(l=t.style[e],(!l||l==="auto"||r||~(l+"").indexOf("calc("))&&(l=Ef[e]&&Ef[e](t,e,a)||Hi(t,e)||rS(t,e)||(e==="opacity"?1:0))),a&&!~(l+"").trim().indexOf(" ")?Ur(t,e,l,a)+a:l},z2=function(t,e,a,r){if(!a||a==="none"){var l=Fo(e,t,1),c=l&&Hi(t,l,1);c&&c!==a?(e=l,a=c):e==="borderColor"&&(a=Hi(t,"borderTopColor"))}var f=new si(this._pt,t.style,e,0,1,NS),p=0,h=0,m,g,v,x,E,M,S,y,L,U,A,D;if(f.b=a,f.e=r,a+="",r+="",r.substring(0,6)==="var(--"&&(r=Hi(t,r.substring(4,r.indexOf(")")))),r==="auto"&&(M=t.style[e],t.style[e]=r,r=Hi(t,e)||r,M?t.style[e]=M:xs(t,e)),m=[a,r],TS(m),a=m[0],r=m[1],v=a.match(Mo)||[],D=r.match(Mo)||[],D.length){for(;g=Mo.exec(r);)S=g[0],L=r.substring(p,g.index),E?E=(E+1)%5:(L.substr(-5)==="rgba("||L.substr(-5)==="hsla(")&&(E=1),S!==(M=v[h++]||"")&&(x=parseFloat(M)||0,A=M.substr((x+"").length),S.charAt(1)==="="&&(S=Ao(x,S)+A),y=parseFloat(S),U=S.substr((y+"").length),p=Mo.lastIndex-U.length,U||(U=U||Ei.units[e]||A,p===r.length&&(r+=U,f.e+=U)),A!==U&&(x=Ur(t,e,M,U)||0),f._pt={_next:f._pt,p:L||h===1?L:",",s:x,c:y-x,m:E&&E<4||e==="zIndex"?Math.round:0});f.c=p<r.length?r.substring(p,r.length):""}else f.r=e==="display"&&r==="none"?BS:IS;return $y.test(r)&&(f.e=0),this._pt=f,f},hy={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},I2=function(t){var e=t.split(" "),a=e[0],r=e[1]||"50%";return(a==="top"||a==="bottom"||r==="left"||r==="right")&&(t=a,a=r,r=t),e[0]=hy[a]||a,e[1]=hy[r]||r,e.join(" ")},B2=function(t,e){if(e.tween&&e.tween._time===e.tween._dur){var a=e.t,r=a.style,l=e.u,c=a._gsap,f,p,h;if(l==="all"||l===!0)r.cssText="",p=1;else for(l=l.split(","),h=l.length;--h>-1;)f=l[h],Wa[f]&&(p=1,f=f==="transformOrigin"?oi:$e),xs(a,f);p&&(xs(a,$e),c&&(c.svg&&a.removeAttribute("transform"),r.scale=r.rotate=r.translate="none",du(a,1),c.uncache=1,FS(r)))}},Ef={clearProps:function(t,e,a,r,l){if(l.data!=="isFromStart"){var c=t._pt=new si(t._pt,e,a,0,0,B2);return c.u=r,c.pr=-10,c.tween=l,t._props.push(a),1}}},hu=[1,0,0,1,0,0],XS={},WS=function(t){return t==="matrix(1, 0, 0, 1, 0, 0)"||t==="none"||!t},dy=function(t){var e=Hi(t,$e);return WS(e)?hu:e.substr(7).match(Jy).map(cn)},o_=function(t,e){var a=t._gsap||hs(t),r=t.style,l=dy(t),c,f,p,h;return a.svg&&t.getAttribute("transform")?(p=t.transform.baseVal.consolidate().matrix,l=[p.a,p.b,p.c,p.d,p.e,p.f],l.join(",")==="1,0,0,1,0,0"?hu:l):(l===hu&&!t.offsetParent&&t!==Ro&&!a.svg&&(p=r.display,r.display="block",c=t.parentNode,(!c||!t.offsetParent&&!t.getBoundingClientRect().width)&&(h=1,f=t.nextElementSibling,Ro.appendChild(t)),l=dy(t),p?r.display=p:xs(t,"display"),h&&(f?c.insertBefore(t,f):c?c.appendChild(t):Ro.removeChild(t))),e&&l.length>6?[l[0],l[1],l[4],l[5],l[12],l[13]]:l)},Cm=function(t,e,a,r,l,c){var f=t._gsap,p=l||o_(t,!0),h=f.xOrigin||0,m=f.yOrigin||0,g=f.xOffset||0,v=f.yOffset||0,x=p[0],E=p[1],M=p[2],S=p[3],y=p[4],L=p[5],U=e.split(" "),A=parseFloat(U[0])||0,D=parseFloat(U[1])||0,P,z,F,b;a?p!==hu&&(z=x*S-E*M)&&(F=A*(S/z)+D*(-M/z)+(M*L-S*y)/z,b=A*(-E/z)+D*(x/z)-(x*L-E*y)/z,A=F,D=b):(P=VS(t),A=P.x+(~U[0].indexOf("%")?A/100*P.width:A),D=P.y+(~(U[1]||U[0]).indexOf("%")?D/100*P.height:D)),r||r!==!1&&f.smooth?(y=A-h,L=D-m,f.xOffset=g+(y*x+L*M)-y,f.yOffset=v+(y*E+L*S)-L):f.xOffset=f.yOffset=0,f.xOrigin=A,f.yOrigin=D,f.smooth=!!r,f.origin=e,f.originIsAbsolute=!!a,t.style[oi]="0px 0px",c&&(br(c,f,"xOrigin",h,A),br(c,f,"yOrigin",m,D),br(c,f,"xOffset",g,f.xOffset),br(c,f,"yOffset",v,f.yOffset)),t.setAttribute("data-svg-origin",A+" "+D)},du=function(t,e){var a=t._gsap||new wS(t);if("x"in a&&!e&&!a.uncache)return a;var r=t.style,l=a.scaleX<0,c="px",f="deg",p=getComputedStyle(t),h=Hi(t,oi)||"0",m,g,v,x,E,M,S,y,L,U,A,D,P,z,F,b,N,G,j,et,ft,rt,B,W,q,yt,O,Y,ht,ut,Et,Rt;return m=g=v=M=S=y=L=U=A=0,x=E=1,a.svg=!!(t.getCTM&&kS(t)),p.translate&&((p.translate!=="none"||p.scale!=="none"||p.rotate!=="none")&&(r[$e]=(p.translate!=="none"?"translate3d("+(p.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(p.rotate!=="none"?"rotate("+p.rotate+") ":"")+(p.scale!=="none"?"scale("+p.scale.split(" ").join(",")+") ":"")+(p[$e]!=="none"?p[$e]:"")),r.scale=r.rotate=r.translate="none"),z=o_(t,a.svg),a.svg&&(a.uncache?(q=t.getBBox(),h=a.xOrigin-q.x+"px "+(a.yOrigin-q.y)+"px",W=""):W=!e&&t.getAttribute("data-svg-origin"),Cm(t,W||h,!!W||a.originIsAbsolute,a.smooth!==!1,z)),D=a.xOrigin||0,P=a.yOrigin||0,z!==hu&&(G=z[0],j=z[1],et=z[2],ft=z[3],m=rt=z[4],g=B=z[5],z.length===6?(x=Math.sqrt(G*G+j*j),E=Math.sqrt(ft*ft+et*et),M=G||j?vo(j,G)*ss:0,L=et||ft?vo(et,ft)*ss+M:0,L&&(E*=Math.abs(Math.cos(L*wo))),a.svg&&(m-=D-(D*G+P*et),g-=P-(D*j+P*ft))):(Rt=z[6],ut=z[7],O=z[8],Y=z[9],ht=z[10],Et=z[11],m=z[12],g=z[13],v=z[14],F=vo(Rt,ht),S=F*ss,F&&(b=Math.cos(-F),N=Math.sin(-F),W=rt*b+O*N,q=B*b+Y*N,yt=Rt*b+ht*N,O=rt*-N+O*b,Y=B*-N+Y*b,ht=Rt*-N+ht*b,Et=ut*-N+Et*b,rt=W,B=q,Rt=yt),F=vo(-et,ht),y=F*ss,F&&(b=Math.cos(-F),N=Math.sin(-F),W=G*b-O*N,q=j*b-Y*N,yt=et*b-ht*N,Et=ft*N+Et*b,G=W,j=q,et=yt),F=vo(j,G),M=F*ss,F&&(b=Math.cos(F),N=Math.sin(F),W=G*b+j*N,q=rt*b+B*N,j=j*b-G*N,B=B*b-rt*N,G=W,rt=q),S&&Math.abs(S)+Math.abs(M)>359.9&&(S=M=0,y=180-y),x=cn(Math.sqrt(G*G+j*j+et*et)),E=cn(Math.sqrt(B*B+Rt*Rt)),F=vo(rt,B),L=Math.abs(F)>2e-4?F*ss:0,A=Et?1/(Et<0?-Et:Et):0),a.svg&&(W=t.getAttribute("transform"),a.forceCSS=t.setAttribute("transform","")||!WS(Hi(t,$e)),W&&t.setAttribute("transform",W))),Math.abs(L)>90&&Math.abs(L)<270&&(l?(x*=-1,L+=M<=0?180:-180,M+=M<=0?180:-180):(E*=-1,L+=L<=0?180:-180)),e=e||a.uncache,a.x=m-((a.xPercent=m&&(!e&&a.xPercent||(Math.round(t.offsetWidth/2)===Math.round(-m)?-50:0)))?t.offsetWidth*a.xPercent/100:0)+c,a.y=g-((a.yPercent=g&&(!e&&a.yPercent||(Math.round(t.offsetHeight/2)===Math.round(-g)?-50:0)))?t.offsetHeight*a.yPercent/100:0)+c,a.z=v+c,a.scaleX=cn(x),a.scaleY=cn(E),a.rotation=cn(M)+f,a.rotationX=cn(S)+f,a.rotationY=cn(y)+f,a.skewX=L+f,a.skewY=U+f,a.transformPerspective=A+c,(a.zOrigin=parseFloat(h.split(" ")[2])||!e&&a.zOrigin||0)&&(r[oi]=Tf(h)),a.xOffset=a.yOffset=0,a.force3D=Ei.force3D,a.renderTransform=a.svg?H2:GS?qS:F2,a.uncache=0,a},Tf=function(t){return(t=t.split(" "))[0]+" "+t[1]},bp=function(t,e,a){var r=Vn(e);return cn(parseFloat(e)+parseFloat(Ur(t,"x",a+"px",r)))+r},F2=function(t,e){e.z="0px",e.rotationY=e.rotationX="0deg",e.force3D=0,qS(t,e)},ns="0deg",Wl="0px",is=") ",qS=function(t,e){var a=e||this,r=a.xPercent,l=a.yPercent,c=a.x,f=a.y,p=a.z,h=a.rotation,m=a.rotationY,g=a.rotationX,v=a.skewX,x=a.skewY,E=a.scaleX,M=a.scaleY,S=a.transformPerspective,y=a.force3D,L=a.target,U=a.zOrigin,A="",D=y==="auto"&&t&&t!==1||y===!0;if(U&&(g!==ns||m!==ns)){var P=parseFloat(m)*wo,z=Math.sin(P),F=Math.cos(P),b;P=parseFloat(g)*wo,b=Math.cos(P),c=bp(L,c,z*b*-U),f=bp(L,f,-Math.sin(P)*-U),p=bp(L,p,F*b*-U+U)}S!==Wl&&(A+="perspective("+S+is),(r||l)&&(A+="translate("+r+"%, "+l+"%) "),(D||c!==Wl||f!==Wl||p!==Wl)&&(A+=p!==Wl||D?"translate3d("+c+", "+f+", "+p+") ":"translate("+c+", "+f+is),h!==ns&&(A+="rotate("+h+is),m!==ns&&(A+="rotateY("+m+is),g!==ns&&(A+="rotateX("+g+is),(v!==ns||x!==ns)&&(A+="skew("+v+", "+x+is),(E!==1||M!==1)&&(A+="scale("+E+", "+M+is),L.style[$e]=A||"translate(0, 0)"},H2=function(t,e){var a=e||this,r=a.xPercent,l=a.yPercent,c=a.x,f=a.y,p=a.rotation,h=a.skewX,m=a.skewY,g=a.scaleX,v=a.scaleY,x=a.target,E=a.xOrigin,M=a.yOrigin,S=a.xOffset,y=a.yOffset,L=a.forceCSS,U=parseFloat(c),A=parseFloat(f),D,P,z,F,b;p=parseFloat(p),h=parseFloat(h),m=parseFloat(m),m&&(m=parseFloat(m),h+=m,p+=m),p||h?(p*=wo,h*=wo,D=Math.cos(p)*g,P=Math.sin(p)*g,z=Math.sin(p-h)*-v,F=Math.cos(p-h)*v,h&&(m*=wo,b=Math.tan(h-m),b=Math.sqrt(1+b*b),z*=b,F*=b,m&&(b=Math.tan(m),b=Math.sqrt(1+b*b),D*=b,P*=b)),D=cn(D),P=cn(P),z=cn(z),F=cn(F)):(D=g,F=v,P=z=0),(U&&!~(c+"").indexOf("px")||A&&!~(f+"").indexOf("px"))&&(U=Ur(x,"x",c,"px"),A=Ur(x,"y",f,"px")),(E||M||S||y)&&(U=cn(U+E-(E*D+M*z)+S),A=cn(A+M-(E*P+M*F)+y)),(r||l)&&(b=x.getBBox(),U=cn(U+r/100*b.width),A=cn(A+l/100*b.height)),b="matrix("+D+","+P+","+z+","+F+","+U+","+A+")",x.setAttribute("transform",b),L&&(x.style[$e]=b)},G2=function(t,e,a,r,l){var c=360,f=Cn(l),p=parseFloat(l)*(f&&~l.indexOf("rad")?ss:1),h=p-r,m=r+h+"deg",g,v;return f&&(g=l.split("_")[1],g==="short"&&(h%=c,h!==h%(c/2)&&(h+=h<0?c:-c)),g==="cw"&&h<0?h=(h+c*oy)%c-~~(h/c)*c:g==="ccw"&&h>0&&(h=(h-c*oy)%c-~~(h/c)*c)),t._pt=v=new si(t._pt,e,a,r,h,T2),v.e=m,v.u="deg",t._props.push(a),v},py=function(t,e){for(var a in e)t[a]=e[a];return t},V2=function(t,e,a){var r=py({},a._gsap),l="perspective,force3D,transformOrigin,svgOrigin",c=a.style,f,p,h,m,g,v,x,E;r.svg?(h=a.getAttribute("transform"),a.setAttribute("transform",""),c[$e]=e,f=du(a,1),xs(a,$e),a.setAttribute("transform",h)):(h=getComputedStyle(a)[$e],c[$e]=e,f=du(a,1),c[$e]=h);for(p in Wa)h=r[p],m=f[p],h!==m&&l.indexOf(p)<0&&(x=Vn(h),E=Vn(m),g=x!==E?Ur(a,p,h,E):parseFloat(h),v=parseFloat(m),t._pt=new si(t._pt,f,p,g,v-g,Am),t._pt.u=E||0,t._props.push(p));py(f,r)};ri("padding,margin,Width,Radius",function(o,t){var e="Top",a="Right",r="Bottom",l="Left",c=(t<3?[e,a,r,l]:[e+l,e+a,r+a,r+l]).map(function(f){return t<2?o+f:"border"+f+o});Ef[t>1?"border"+o:o]=function(f,p,h,m,g){var v,x;if(arguments.length<4)return v=c.map(function(E){return Ba(f,E,h)}),x=v.join(" "),x.split(v[0]).length===5?v[0]:x;v=(m+"").split(" "),x={},c.forEach(function(E,M){return x[E]=v[M]=v[M]||v[(M-1)/2|0]}),f.init(p,x,g)}});var YS={name:"css",register:wm,targetTest:function(t){return t.style&&t.nodeType},init:function(t,e,a,r,l){var c=this._props,f=t.style,p=a.vars.startAt,h,m,g,v,x,E,M,S,y,L,U,A,D,P,z,F;a_||wm(),this.styles=this.styles||HS(t),F=this.styles.props,this.tween=a;for(M in e)if(M!=="autoRound"&&(m=e[M],!(vi[M]&&CS(M,e,a,r,t,l)))){if(x=typeof m,E=Ef[M],x==="function"&&(m=m.call(a,r,t,l),x=typeof m),x==="string"&&~m.indexOf("random(")&&(m=uu(m)),E)E(this,t,M,m,a)&&(z=1);else if(M.substr(0,2)==="--")h=(getComputedStyle(t).getPropertyValue(M)+"").trim(),m+="",Cr.lastIndex=0,Cr.test(h)||(S=Vn(h),y=Vn(m)),y?S!==y&&(h=Ur(t,M,h,y)+y):S&&(m+=S),this.add(f,"setProperty",h,m,r,l,0,0,M),c.push(M),F.push(M,0,f[M]);else if(x!=="undefined"){if(p&&M in p?(h=typeof p[M]=="function"?p[M].call(a,r,t,l):p[M],Cn(h)&&~h.indexOf("random(")&&(h=uu(h)),Vn(h+"")||h==="auto"||(h+=Ei.units[M]||Vn(Ba(t,M))||""),(h+"").charAt(1)==="="&&(h=Ba(t,M))):h=Ba(t,M),v=parseFloat(h),L=x==="string"&&m.charAt(1)==="="&&m.substr(0,2),L&&(m=m.substr(2)),g=parseFloat(m),M in fa&&(M==="autoAlpha"&&(v===1&&Ba(t,"visibility")==="hidden"&&g&&(v=0),F.push("visibility",0,f.visibility),br(this,f,"visibility",v?"inherit":"hidden",g?"inherit":"hidden",!g)),M!=="scale"&&M!=="transform"&&(M=fa[M],~M.indexOf(",")&&(M=M.split(",")[0]))),U=M in Wa,U){if(this.styles.save(M),x==="string"&&m.substring(0,6)==="var(--"&&(m=Hi(t,m.substring(4,m.indexOf(")"))),g=parseFloat(m)),A||(D=t._gsap,D.renderTransform&&!e.parseTransform||du(t,e.parseTransform),P=e.smoothOrigin!==!1&&D.smooth,A=this._pt=new si(this._pt,f,$e,0,1,D.renderTransform,D,0,-1),A.dep=1),M==="scale")this._pt=new si(this._pt,D,"scaleY",D.scaleY,(L?Ao(D.scaleY,L+g):g)-D.scaleY||0,Am),this._pt.u=0,c.push("scaleY",M),M+="X";else if(M==="transformOrigin"){F.push(oi,0,f[oi]),m=I2(m),D.svg?Cm(t,m,0,P,0,this):(y=parseFloat(m.split(" ")[2])||0,y!==D.zOrigin&&br(this,D,"zOrigin",D.zOrigin,y),br(this,f,M,Tf(h),Tf(m)));continue}else if(M==="svgOrigin"){Cm(t,m,1,P,0,this);continue}else if(M in XS){G2(this,D,M,v,L?Ao(v,L+m):m);continue}else if(M==="smoothOrigin"){br(this,D,"smooth",D.smooth,m);continue}else if(M==="force3D"){D[M]=m;continue}else if(M==="transform"){V2(this,m,t);continue}}else M in f||(M=Fo(M)||M);if(U||(g||g===0)&&(v||v===0)&&!E2.test(m)&&M in f)S=(h+"").substr((v+"").length),g||(g=0),y=Vn(m)||(M in Ei.units?Ei.units[M]:S),S!==y&&(v=Ur(t,M,h,y)),this._pt=new si(this._pt,U?D:f,M,v,(L?Ao(v,L+g):g)-v,!U&&(y==="px"||M==="zIndex")&&e.autoRound!==!1?A2:Am),this._pt.u=y||0,S!==y&&y!=="%"&&(this._pt.b=h,this._pt.r=b2);else if(M in f)z2.call(this,t,M,h,L?L+m:m);else if(M in t)this.add(t,M,h||t[M],L?L+m:m,r,l);else if(M!=="parseTransform"){jm(M,m);continue}U||(M in f?F.push(M,0,f[M]):typeof t[M]=="function"?F.push(M,2,t[M]()):F.push(M,1,h||t[M])),c.push(M)}}z&&PS(this)},render:function(t,e){if(e.tween._time||!r_())for(var a=e._pt;a;)a.r(t,a.d),a=a._next;else e.styles.revert()},get:Ba,aliases:fa,getSetter:function(t,e,a){var r=fa[e];return r&&r.indexOf(",")<0&&(e=r),e in Wa&&e!==oi&&(t._gsap.x||Ba(t,"x"))?a&&sy===a?e==="scale"?D2:C2:(sy=a||{})&&(e==="scale"?U2:L2):t.style&&!Wm(t.style[e])?R2:~e.indexOf("-")?w2:n_(t,e)},core:{_removeProperty:xs,_getMatrix:o_}};li.utils.checkPrefix=Fo;li.core.getStyleSaver=HS;(function(o,t,e,a){var r=ri(o+","+t+","+e,function(l){Wa[l]=1});ri(t,function(l){Ei.units[l]="deg",XS[l]=1}),fa[r[13]]=o+","+t,ri(a,function(l){var c=l.split(":");fa[c[1]]=r[c[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");ri("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(o){Ei.units[o]="px"});li.registerPlugin(YS);var ff=li.registerPlugin(YS)||li;ff.core.Tween;function k2(){const o=tu.useRef(null);return tu.useEffect(()=>{const t=o.current,e=t.clientWidth,a=t.clientHeight,r=new Sb,l=new Ii(45,e/a,.1,1e3);l.position.z=5;const c=new yC({antialias:!0,alpha:!0});c.setSize(e,a),c.setPixelRatio(Math.min(window.devicePixelRatio,2)),c.setClearColor(0,0),t.appendChild(c.domElement);const f=new xo;r.add(f),console.log("Starting to load model files...");const p="/Personal-Website",h=`${p}/models/test_cube.mtl`,m=`${p}/models/test_cube.obj`;console.log("Using paths:",{mtlPath:h,objPath:m}),fetch(h).then(O=>{if(console.log("MTL file fetch response:",O.status,O.statusText),!O.ok)throw new Error(`MTL file not found: ${O.status}`);return O.text()}).then(O=>(console.log("MTL file content loaded, size:",O.length),fetch(m))).then(O=>{if(console.log("OBJ file fetch response:",O.status,O.statusText),!O.ok)throw new Error(`OBJ file not found: ${O.status}`);console.log("OBJ file is accessible, proceeding with Three.js loaders...");const Y=new RC,ht=new Fy;ht.onLoad=()=>console.log("All resources loaded"),ht.onError=ut=>console.error("Error loading:",ut),Y.manager=ht,Y.load(h,ut=>{console.log("MTL loaded successfully with Three.js:",ut),ut.preload();const Et=new AC;Et.manager=ht,Et.setMaterials(ut),Et.load(m,Rt=>{console.log("OBJ loaded successfully:",Rt);const $=new Go().setFromObject(Rt),_t=$.getSize(new it),At=$.getCenter(new it);console.log("Model size:",_t),console.log("Model center:",At);const le=2/Math.max(_t.x,_t.y,_t.z);Rt.scale.setScalar(le),Rt.position.copy(At.multiplyScalar(-le)),Rt.traverse(Ve=>{Ve.isMesh&&(Ve.castShadow=!0,Ve.receiveShadow=!0,Ve.material&&(Ve.material.needsUpdate=!0))}),f.add(Rt),console.log("Model successfully added to scene")},Rt=>{const $=Rt.loaded/Rt.total*100;console.log("OBJ loading progress:",$+"%")},Rt=>{console.error("Three.js OBJ loading error:",Rt),g("red","OBJ loading failed")})},ut=>{console.log("MTL loading progress:",ut.loaded/ut.total*100+"%")},ut=>{console.error("Three.js MTL loading error:",ut),g("orange","MTL loading failed")})}).catch(O=>{console.error("File accessibility test failed:",O),g("blue","Files not accessible")});function g(O,Y){console.log(`Adding ${O} fallback cube - ${Y}`);const ht=new vs(1,1,1),ut=O==="red"?16711680:O==="orange"?16746496:O==="blue"?255:8947848,Et=new yx({color:ut}),Rt=new yi(ht,Et);f.add(Rt)}const v=new vs(.1,.1,.1),x=new yx({transparent:!0,opacity:0});new yi(v,x);const E=new Ob(16777215,1);E.position.set(5,5,5),r.add(E);const M=new Nb(4210752,.6);r.add(M);const S=50;let y=0,L=0,U=0,A=0;const D=new Ti,P=new Float32Array(S*3),z=new Float32Array(S);for(let O=0;O<S;O++)P[O*3]=0,P[O*3+1]=0,P[O*3+2]=0,z[O]=(S-O)/S;D.setAttribute("position",new Mi(P,3)),D.setAttribute("opacity",new Mi(z,1));const F=new ka({uniforms:{time:{value:0},color:{value:new fe(8956671)}},vertexShader:`
